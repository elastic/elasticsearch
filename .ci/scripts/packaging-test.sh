...
sudo -E env \
  ...
  ./gradlew -g $HOME/.gradle --console=plain --scan --parallel --build-cache --no-daemon -Dorg.elasticsearch.build.cache.url=https://gradle-enterprise.elastic.co/cache/ --continue $@

...
```sh
bin/plugin install elasticsearch/elasticsearch-analysis-kuromoji/2.4.2
```
...
| es-1.5        |  Build from source          | [2.5.0-SNAPSHOT](https://github.com/elasticsearch/elasticsearch-analysis-kuromoji/tree/es-1.5/#version-250-snapshot-for-elasticsearch-15)  |

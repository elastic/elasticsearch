...
```sh
bin/plugin -install elasticsearch/elasticsearch-analysis-phonetic/2.4.1
```
...
|    es-1.4              |     2.4.1         | [2.4.1](https://github.com/elasticsearch/elasticsearch-analysis-phonetic/tree/v2.4.1/#version-241-for-elasticsearch-14)                  |

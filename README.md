...
```sh
bin/plugin install elasticsearch/elasticsearch-cloud-azure/2.6.0
```
...
# Install the plugin
sudo /usr/share/elasticsearch/bin/plugin install elasticsearch/elasticsearch-cloud-azure/2.6.0

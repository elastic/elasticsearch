...
```sh
bin/plugin install elasticsearch/elasticsearch-mapper-attachments/2.4.2
```
...
|    es-1.4              |     2.4.2         | [2.4.2](https://github.com/elasticsearch/elasticsearch-mapper-attachments/tree/v2.4.2/#version-242-for-elasticsearch-14)                  |

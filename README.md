...
```sh
bin/plugin -install elasticsearch/elasticsearch-analysis-kuromoji/2.4.0
```
...
|    es-1.4              |     2.4.0         | [2.4.0](https://github.com/elasticsearch/elasticsearch-analysis-kuromoji/tree/v2.4.0/#version-240-for-elasticsearch-14)                  |

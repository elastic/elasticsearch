...
In order to install the plugin, simply run: `bin/plugin -install elasticsearch/elasticsearch-analysis-icu/1.10.0`.

    -----------------------------------------------
    | ICU Analysis Plugin      | ElasticSearch    |
    -----------------------------------------------
    | 1.11.0-SNAPSHOT (master) | 0.90.1 -> master |
    -----------------------------------------------
    | 1.10.0                   | 0.90.1 -> master |
    -----------------------------------------------
    | 1.9.0                    | 0.90.0           |
    -----------------------------------------------
    | 1.8.0                    | 0.90.0           |

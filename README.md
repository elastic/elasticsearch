...
```sh
bin/plugin -install elasticsearch/elasticsearch-mapper-attachments/2.4.0
```
...
|    es-1.4              |     2.4.0         | [2.4.0](https://github.com/elasticsearch/elasticsearch-mapper-attachments/tree/v2.4.0/#version-240-for-elasticsearch-14)                  |

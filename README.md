...
```sh
bin/plugin install elasticsearch/elasticsearch-cloud-azure/2.5.2
```
...
|    es-1.5              |     2.6.0         | [2.6.0](https://github.com/elastic/elasticsearch-cloud-azure/tree/v2.6.0/#version-260-for-elasticsearch-15)                  |
...
# Install the plugin
sudo /usr/share/elasticsearch/bin/plugin install elasticsearch/elasticsearch-cloud-azure/2.5.2

...
Elasticsearch is a near realtime search universal platform and generic technology that allows you to explore data at an incredible scale with ease. Elasticsearch is designed to help you try to make sense of your data by handling the storage and providing the analytics engine to organize and make it easily accessible.

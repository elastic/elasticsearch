...
For example to run a specific tests from the x-pack rolling upgrade from 7.16.0:
-------------------------------------------------
./gradlew :x-pack:qa:rolling-upgrade:v7.16.0#bwcTest \
 -Dtests.class=org.elasticsearch.upgrades.UpgradeClusterClientYamlTestSuiteIT \
 -Dtests.method="test {yaml=*/40_ml_datafeed_crud/*}"
-------------------------------------------------

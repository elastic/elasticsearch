...
If you try to run the unit tests from IntelliJ, you might suffer from a Jar Hell issue.

To fix it, add `idea.no.launcher=true` to your `idea.properties` and restart IntelliJ:

---------------------------------------------------------------------------
echo idea.no.launcher=true >> ~/Library/Preferences/IntelliJIdea2017.1/idea.properties
---------------------------------------------------------------------------

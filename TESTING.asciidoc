...
YAML RESTS tests that include x-pack specific APIs need to explicitly declare
...
YAML REST tests use the following command (plugin and modules may also include YAML REST tests):

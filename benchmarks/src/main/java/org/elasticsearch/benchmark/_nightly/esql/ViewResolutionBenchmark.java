...
/**
 * Benchmarks the overhead of ES|QL view resolution on query planning.
 * <p>
...
public class ViewResolutionBenchmark {
    ...
    public void setup() {
        ...
        // --- build the "test" index with fields used in filters ---
        ...
        // --- analyzer & optimizer (mirrors QueryPlanningBenchmark) ---
        ...
        // --- scenario-specific view metadata & query ---
     ...
     */
    private static ViewMetadata buildViewChain(int depth, boolean withFilter) {

...
/**
 * Benchmark for encoding counter-with-resets data patterns.
 *
 * <p>Parameterized by resetProbability to test how reset frequency affects
 * encoding performance. Lower probability means longer monotonic runs between
...
public class EncodeCounterWithResetsBenchmark {
    ...
    public EncodeCounterWithResetsBenchmark() {

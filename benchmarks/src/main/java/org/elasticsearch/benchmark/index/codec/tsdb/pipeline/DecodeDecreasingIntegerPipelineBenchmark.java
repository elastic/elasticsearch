...
public class DecodeDecreasingIntegerPipelineBenchmark {
    ...
    // NOTE: "full" is ES87-compatible; "decreasing" is optimal for this data pattern (skips gcd)
    @Param({ "full", "decreasing" })

...
public class DecodeGaugeLikePipelineBenchmark {
    ...
    // NOTE: "full" is ES87-compatible; "gaugeLike" is optimal for this data pattern (skips delta, gcd)
    @Param({ "full", "gaugeLike" })

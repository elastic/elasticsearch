...
public class DecodeNearConstantPipelineBenchmark {
    ...
    // NOTE: "full" is ES87-compatible; "nearConstant" is optimal for this data pattern (skips delta, gcd)
    @Param({ "full", "nearConstant" })

...
public class EncodeGaugeLikePipelineBenchmark {
    ...
    private GaugeLikeSupplier supplier;

    @Setup(Level.Trial)
    public void setupTrial() throws IOException {
        encode = new PipelineEncodeBenchmark(OptimalPipelines.byName(pipeline));
        supplier = GaugeLikeSupplier.builder(SEED, encode.getBlockSize()).withVarianceRatio(varianceRatio).build();

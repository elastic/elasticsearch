...
public class EncodeIncreasingIntegerPipelineBenchmark {
    ...
    // NOTE: "full" is ES87-compatible; "increasing" is optimal for this data pattern (skips gcd)
    @Param({ "full", "increasing" })

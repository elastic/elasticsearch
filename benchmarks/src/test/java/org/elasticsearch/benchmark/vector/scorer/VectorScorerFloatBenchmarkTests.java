...
public class VectorScorerFloatBenchmarkTests extends ESTestCase {
    ...
    public VectorScorerFloatBenchmarkTests(VectorSimilarityType function, int dims) {
    ...
    public void testScores() throws Exception {
        for (int i = 0; i < 100; i++) {
            ...
            for (var impl : VectorImplementation.values()) {
                var bench = new VectorScorerFloatBenchmark();
    ...
    public static Iterable<Object[]> parametersFactory() {
        try {
            String[] dims = VectorScorerFloatBenchmark.class.getField("dims").getAnnotationsByType(Param.class)[0].value();
            String[] functions = VectorScorerFloatBenchmark.class.getField("function").getAnnotationsByType(Param.class)[0].value();

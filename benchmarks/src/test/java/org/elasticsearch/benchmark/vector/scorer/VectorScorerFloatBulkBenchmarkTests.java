...
public class VectorScorerFloatBulkBenchmarkTests extends ESTestCase {
    ...
    public static Iterable<Object[]> parametersFactory() {
        String[] dims = Utils.possibleValues(VectorScorerFloatBulkBenchmark.class, "dims").toArray(new String[0]);
        String[] functions = Utils.possibleValues(VectorScorerFloatBulkBenchmark.class, "function").toArray(new String[0]);

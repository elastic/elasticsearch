...
rem have to be done before set JAVA_OPTS=%JAVA_OPTS% -XX:+UseParNewGC
...
rem parentheses causes that ES_JAVA_OPTS gets lost
if not "%ES_JAVA_OPTS%" == "" set JVM_OPTS=%JVM_OPTS%;%ES_JAVA_OPTS: =#%

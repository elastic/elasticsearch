...
class TransportClassesCoveragePluginFuncTest extends AbstractGradleInternalPluginFuncTest {
    ...
    def setup() {
        ...
        createClass("org.elasticsearch.common.io.stream.StreamInput")
        createClass("org.elasticsearch.common.io.stream.StreamOutput")

...
public abstract class CheckForbiddenApisTask extends DefaultTask implements PatternFilterable, VerificationTask, Constants {
    ...
    public void checkForbidden() {
        // The checker runs in the Gradle daemon, whose JVM is the Elasticsearch minimum runtime, so JDK
        // signatures resolve against the right bootclasspath without forking a worker.

...
public class GenerateReleaseNotesTask extends DefaultTask {
    ...
    public void executeTask() throws IOException {
        ...
        if (qualifiedVersion.isBefore(QualifiedVersion.of("8.1.0"))) {
            LOGGER.info("NOTE: skipping release highlights and migration guide since {} is before 8.1.0", qualifiedVersion);
        } else {

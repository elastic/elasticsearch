...
class OracleOpenJdkToolchainResolverSpec extends AbstractToolchainResolverSpec {
    ...
    def supportedRequests() {
        [[20, ORACLE, MAC_OS, X86_64, "https://download.oracle.com/java/GA/jdk20/bdc68b4b9cbc4ebcb30745c85038d91d/36/GPL/openjdk-20_macos-x64_bin.tar.gz"],
         ...
         // EA build
         [25, ORACLE, MAC_OS, X86_64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_macos-x64_bin.tar.gz"],
         [25, ORACLE, MAC_OS, AARCH64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_macos-aarch64_bin.tar.gz"],
         [25, ORACLE, LINUX, X86_64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_linux-x64_bin.tar.gz"],
         [25, ORACLE, LINUX, AARCH64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_linux-aarch64_bin.tar.gz"],
         [25, ORACLE, WINDOWS, X86_64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_windows-x64_bin.zip"],
         [25, anyVendor(), MAC_OS, X86_64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_macos-x64_bin.tar.gz"],
         [25, anyVendor(), MAC_OS, AARCH64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_macos-aarch64_bin.tar.gz"],
         [25, anyVendor(), LINUX, X86_64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_linux-x64_bin.tar.gz"],
         [25, anyVendor(), LINUX, AARCH64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_linux-aarch64_bin.tar.gz"],
         [25, anyVendor(), WINDOWS, X86_64, "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/25/openjdk-25-ea+3/openjdk-25-ea+3_windows-x64_bin.zip"]]
    }
    ...
    private static String urlPrefix(int i) {
        return "https://storage.googleapis.com/elasticsearch-jdk-archive/jdks/openjdk/" + i + "/"
    }

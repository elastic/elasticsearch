...
public class XmlReportMethodCoverageVerifierTests {
    ...
    public void test100percentageCoverage() throws IOException {
        ...
        XmlReportMethodCoverageVerifier verifier = new XmlReportMethodCoverageVerifier(Collections.emptySet(), minimumCoverage);
    ...
    public void testSingleLowCoverage() throws IOException {
        ...
        assertThat(
            ...
            Matchers.containsInAnyOrder(
                new XmlReportMethodCoverageVerifier.Failure("org/elasticsearch/aggregations/bucket/adjacency/InternalAdjacencyMatrix", 0.0)
            )
        );
    ...
    @Test
    public void testSumMethodsInClass() throws IOException {
        String xml = templateReport(
            Map.of(
                "element1InitMissed",
                10,
    ...
    public void testSkipClasses() throws IOException {
        ...
        XmlReportMethodCoverageVerifier verifier = new XmlReportMethodCoverageVerifier(classesToSkip, minimumCoverage);
        List<XmlReportMethodCoverageVerifier.Failure> failures = verifier.verifyReport(xml.getBytes());
        assertThat(
            failures,
            Matchers.contains(

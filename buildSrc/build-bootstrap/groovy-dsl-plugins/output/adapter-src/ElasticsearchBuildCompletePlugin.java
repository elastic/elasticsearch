...
/**
 * Precompiled elasticsearch.build-complete script plugin.
 **/
public class ElasticsearchBuildCompletePlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchBuildComplete").asSubclass(BasicScript.class);

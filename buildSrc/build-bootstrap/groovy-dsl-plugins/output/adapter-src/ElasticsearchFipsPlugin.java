...
/**
 * Precompiled elasticsearch.fips script plugin.
 **/
public class ElasticsearchFipsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchFips").asSubclass(BasicScript.class);

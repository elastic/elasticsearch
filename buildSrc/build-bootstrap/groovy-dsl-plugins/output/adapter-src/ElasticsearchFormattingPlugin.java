...
/**
 * Precompiled elasticsearch.formatting script plugin.
 **/
public class ElasticsearchFormattingPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchFormatting").asSubclass(BasicScript.class);

...
/**
 * Precompiled elasticsearch.local-distribution script plugin.
 **/
public class ElasticsearchLocalDistributionPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchLocalDistribution").asSubclass(BasicScript.class);

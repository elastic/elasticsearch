...
/**
 * Precompiled elasticsearch.run script plugin.
 **/
public class ElasticsearchRunPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ElasticsearchRun").asSubclass(BasicScript.class);

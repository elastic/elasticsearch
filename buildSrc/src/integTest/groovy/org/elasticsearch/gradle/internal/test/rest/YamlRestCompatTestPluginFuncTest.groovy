    ...
    def "transform task executes and works as configured"() {
        ...
        buildFile << """
            ...
            tasks.named("transformV7RestTests").configure({ task ->
              ...
              task.replaceKeyInDo("do.some.key_to_replace", "do.some.key_that_was_replaced")
              task.replaceKeyInMatch("match.some.key_to_replace", "match.some.key_that_was_replaced")
        ...
        "one":
          ...
          - match: { match.some.key_to_replace: true }
        ...
        - match:
            _source.junk: true
        - match:
            match.some.key_that_was_replaced: true

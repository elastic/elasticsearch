...
public class PrintGlobalBuildInfoTask extends DefaultTask {
    ...
    public void print() {
        ...
        // Since all tasks depend on this task, and it always runs for every build, this makes sure
        // that lifecycle tasks will still
        // correctly report as UP-TO-DATE, since the convention is a lifecycle task (i.e. assemble,
        // build, etc) will only be marked as

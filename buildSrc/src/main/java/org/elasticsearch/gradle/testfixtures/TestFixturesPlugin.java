...
public class TestFixturesPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        conditionTaskByType(
            tasks,
            extension,
            getTaskClass("org.elasticsearch.gradle.test.RestIntegTestTask")
        );
            ...
            task -> extension.fixtures.all(
                fixtureProject -> {
                    ...
                    configureServiceInfoForTask(
                        task,
                        fixtureProject,
                        (name, host) -> task.getExtensions()
                            .getByType(
                                SystemPropertyCommandLineArgumentProvider.class
                            )

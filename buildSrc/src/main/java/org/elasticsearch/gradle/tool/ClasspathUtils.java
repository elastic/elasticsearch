...
public class ClasspathUtils {
    ...
    static {
        // look for buildSrc marker file, if it exists then we are running in the context of the
        // elastic/elasticsearch build
    ...
    /**
     * Determine if we are running in the context of the `elastic/elasticsearch` project. This
     * method will return {@code false} when the build-tools project is pulled in as an external
     * dependency.
     *

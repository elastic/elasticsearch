...
class VersionCollectionTests extends GradleUnitTestCase {
    private final List<String> branchMaster_7_0_0 = [
    ...
    private final List<String> branch6_x_6_5 = [
    ...
    private final List<String> branch6_4_6_4_2 = [
            "5_0_0_alpha1", "5_0_0_alpha2", "5_0_0_alpha3", "5_0_0_alpha4", "5_0_0_alpha5", "5_0_0_beta1", "5_0_0_rc1",
    ...
    private final List<String> branch6_x_6_6 = [
            "5_0_0_alpha1", "5_0_0_alpha2", "5_0_0_alpha3", "5_0_0_alpha4", "5_0_0_alpha5", "5_0_0_beta1", "5_0_0_rc1",
            "5_0_0", "5_0_1", "5_0_2", "5_1_1", "5_1_2", "5_2_0", "5_2_1", "5_2_2", "5_3_0", "5_3_1", "5_3_2", "5_3_3",
            "5_4_0", "5_4_1", "5_4_2", "5_4_3", "5_5_0", "5_5_1", "5_5_2", "5_5_3", "5_6_0", "5_6_1", "5_6_2", "5_6_3",
            "5_6_4", "5_6_5", "5_6_6", "5_6_7", "5_6_8", "5_6_9", "5_6_10", "5_6_11", "5_6_12", "5_6_13",
    ...
    void testIndexCompatible() {
        // 7.0.0 on master
        assertCompatible(branchMaster_7_0_0, [
        ...
        assertCompatible(branch6_x_6_5, [
        ...
        // 6.4.2 on 6.4 branch
        assertCompatible(branch6_4_6_4_2, [
                "5.0.0", "5.0.1", "5.0.2", "5.1.1", "5.1.2", "5.2.0", "5.2.1", "5.2.2", "5.3.0", "5.3.1", "5.3.2", "5.3.3",
                "5.4.0", "5.4.1", "5.4.2", "5.4.3", "5.5.0", "5.5.1", "5.5.2", "5.5.3", "5.6.0", "5.6.1", "5.6.2", "5.6.3",
                "5.6.4", "5.6.5", "5.6.6", "5.6.7", "5.6.8", "5.6.9", "5.6.10", "5.6.11", "5.6.12", "5.6.13-SNAPSHOT",
                "6.0.0", "6.0.1", "6.1.0", "6.1.1", "6.1.2", "6.1.3", "6.1.4", "6.2.0", "6.2.1", "6.2.2", "6.2.3", "6.2.4",
        ...
        // 6.6 on the 6.x branch with 6.5 unreleased
        assertCompatible(branch6_x_6_6, [
                "5.0.0", "5.0.1", "5.0.2", "5.1.1", "5.1.2", "5.2.0", "5.2.1", "5.2.2", "5.3.0", "5.3.1", "5.3.2", "5.3.3",
                "5.4.0", "5.4.1", "5.4.2", "5.4.3", "5.5.0", "5.5.1", "5.5.2", "5.5.3", "5.6.0", "5.6.1", "5.6.2", "5.6.3",
                "5.6.4", "5.6.5", "5.6.6", "5.6.7", "5.6.8", "5.6.9", "5.6.10", "5.6.11", "5.6.12", "5.6.13-SNAPSHOT",
                "6.0.0", "6.0.1", "6.1.0", "6.1.1", "6.1.2", "6.1.3", "6.1.4", "6.2.0", "6.2.1", "6.2.2", "6.2.3", "6.2.4",
    ...
    @Test
    void testSnapshots() {
        VersionCollection branchMaster = new VersionCollection(branchMaster_7_0_0.collect({ formatVersion(it) }))
        assertEquals("6.5.0-SNAPSHOT", branchMaster.nextMinorSnapshot.toString())
        assertEquals("6.4.2-SNAPSHOT", branchMaster.nextBugfixSnapshot.toString())
        assertEquals(null, branchMaster.stagedMinorSnapshot)
        assertEquals(null, branchMaster.maintenanceBugfixSnapshot)

        VersionCollection branch6x = new VersionCollection(branch6_x_6_5.collect({ formatVersion(it) }))
        assertEquals(null, branch6x.nextMinorSnapshot)
        assertEquals("6.4.2-SNAPSHOT", branch6x.nextBugfixSnapshot.toString())
        assertEquals(null, branch6x.stagedMinorSnapshot)
        assertEquals("5.6.13-SNAPSHOT", branch6x.maintenanceBugfixSnapshot.toString())

        VersionCollection branch6_4 = new VersionCollection(branch6_4_6_4_2.collect({ formatVersion(it) }))
        assertEquals(null, branch6_4.nextMinorSnapshot)
        assertEquals(null, branch6_4.nextBugfixSnapshot)
        assertEquals(null, branch6_4.stagedMinorSnapshot)
        assertEquals("5.6.13-SNAPSHOT", branch6_4.maintenanceBugfixSnapshot.toString())

        // 6.5.0 from the 6.5 branch, before 6.6 is released.
        VersionCollection branch6_5 = new VersionCollection(branch6_x_6_6.collect({ formatVersion(it) }))
        assertEquals(null, branch6_5.nextMinorSnapshot)
        assertEquals("6.4.2-SNAPSHOT", branch6_5.nextBugfixSnapshot.toString())
        assertEquals("6.5.0-SNAPSHOT", branch6_5.stagedMinorSnapshot.toString())
        assertEquals("5.6.13-SNAPSHOT", branch6_5.maintenanceBugfixSnapshot.toString())
    }

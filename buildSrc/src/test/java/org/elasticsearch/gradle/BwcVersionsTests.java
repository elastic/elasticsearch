...
public class BwcVersionsTests extends GradleUnitTestCase {
    ...
    static {
        ...
        sampleVersions.put(
                "8.0.0", asList("7_0_0", "7_0_1", "7_1_0", "7_1_1", "7_2_0", "7_3_0", "8.0.0"));
        sampleVersions.put(
                "7.0.0-alpha1",
                asList(
                        "6_0_0_alpha1",
    ...
    public void testWireCompatible() {
        assertVersionsEquals(
                asList("6.5.0", "7.0.0"), getVersionCollection("7.0.0-alpha1").getWireCompatible());
        assertVersionsEquals(
                asList(
                        "5.6.0", "5.6.1", "5.6.2", "5.6.3", "5.6.4", "5.6.5", "5.6.6", "5.6.7",
                        "5.6.8", "5.6.9", "5.6.10", "5.6.11", "5.6.12", "5.6.13", "6.0.0", "6.0.1",
                        "6.1.0", "6.1.1", "6.1.2", "6.1.3", "6.1.4", "6.2.0", "6.2.1", "6.2.2",
                        "6.2.3", "6.2.4", "6.3.0", "6.3.1", "6.3.2", "6.4.0", "6.4.1", "6.4.2",
                        "6.5.0"),
        ...
        assertVersionsEquals(
                asList("7.3.0", "8.0.0"), getVersionCollection("8.0.0").getWireCompatible());
        assertVersionsEquals(
    ...
    public void testIndexCompatible() {
        assertVersionsEquals(
                asList(
                        "6.0.0", "6.0.1", "6.1.0", "6.1.1", "6.1.2", "6.1.3", "6.1.4", "6.2.0",
                        "6.2.1", "6.2.2", "6.2.3", "6.2.4", "6.3.0", "6.3.1", "6.3.2", "6.4.0",
                        "6.4.1", "6.4.2", "6.5.0", "7.0.0"),
                getVersionCollection("7.0.0-alpha1").getIndexCompatible());

        assertVersionsEquals(
                asList(
                        "5.0.0", "5.0.1", "5.0.2", "5.1.1", "5.1.2", "5.2.0", "5.2.1", "5.2.2",
                        "5.3.0", "5.3.1", "5.3.2", "5.3.3", "5.4.0", "5.4.1", "5.4.2", "5.4.3",
                        "5.5.0", "5.5.1", "5.5.2", "5.5.3", "5.6.0", "5.6.1", "5.6.2", "5.6.3",
                        "5.6.4", "5.6.5", "5.6.6", "5.6.7", "5.6.8", "5.6.9", "5.6.10", "5.6.11",
                        "5.6.12", "5.6.13", "6.0.0", "6.0.1", "6.1.0", "6.1.1", "6.1.2", "6.1.3",
                        "6.1.4", "6.2.0", "6.2.1", "6.2.2", "6.2.3", "6.2.4", "6.3.0", "6.3.1",
        ...
        assertVersionsEquals(
                asList(
                        ...
                        "5.6.12", "5.6.13", "6.0.0", "6.0.1", "6.1.0", "6.1.1", "6.1.2", "6.1.3",
                        "6.1.4", "6.2.0", "6.2.1", "6.2.2", "6.2.3", "6.2.4", "6.3.0", "6.3.1",
                        "6.3.2", "6.4.0", "6.4.1", "6.4.2", "6.5.0", "6.6.0"),
    ...
    public void testGetUnreleased() {
        ...
        assertVersionsEquals(
                asList("5.6.13", "6.4.2", "6.5.0"), getVersionCollection("6.5.0").getUnreleased());
        assertVersionsEquals(
                asList("5.6.13", "6.4.2"), getVersionCollection("6.4.2").getUnreleased());
        assertVersionsEquals(
                asList("5.6.13", "6.4.2", "6.5.0", "6.6.0"),
    ...
    public void testGetGradleProjectPath() {
        ...
        assertUnreleasedGradleProjectPaths(
                singletonList(":distribution:bwc:maintenance"), getVersionCollection("6.4.2"));
        assertUnreleasedGradleProjectPaths(
                asList(
    ...
    public void testCompareToAuthoritative() {
        List<String> listOfVersions =
                asList("7.0.0", "7.0.1", "7.1.0", "7.1.1", "7.2.0", "7.3.0", "8.0.0");
        List<Version> authoritativeReleasedVersions =
                Stream.of("7.0.0", "7.0.1", "7.1.0")
    ...
    public void testCompareToAuthoritativeUnreleasedActuallyReleased() {
        List<String> listOfVersions =
                asList("7.0.0", "7.0.1", "7.1.0", "7.1.1", "7.2.0", "7.3.0", "8.0.0");
        List<Version> authoritativeReleasedVersions =
                Stream.of("7.0.0", "7.0.1", "7.1.0", "7.1.1", "8.0.0")
                        .map(Version::fromString)
                        .collect(Collectors.toList());
    ...
    public void testCompareToAuthoritativeNotReallyRelesed() {
        List<String> listOfVersions =
                asList("7.0.0", "7.0.1", "7.1.0", "7.1.1", "7.2.0", "7.3.0", "8.0.0");
        List<Version> authoritativeReleasedVersions =
                Stream.of("7.0.0", "7.0.1").map(Version::fromString).collect(Collectors.toList());
        BwcVersions vc =
                new BwcVersions(
                        listOfVersions.stream()
                                .map(this::formatVersionToLine)
    ...
    private void assertUnreleasedGradleProjectPaths(
            List<String> expectedNAmes, BwcVersions bwcVersions) {
        List<String> actualNames = new ArrayList<>();
        bwcVersions.forPreviousUnreleased(
                unreleasedVersion -> actualNames.add(unreleasedVersion.gradleProjectPath));
        assertEquals(expectedNAmes, actualNames);
    }

    private void assertUnreleasedBranchNames(
            List<String> expectedBranches, BwcVersions bwcVersions) {
        List<String> actualBranches = new ArrayList<>();
        bwcVersions.forPreviousUnreleased(
                unreleasedVersionInfo -> actualBranches.add(unreleasedVersionInfo.branch));
    ...
    private void assertVersionsEquals(List<String> expected, List<Version> actual) {
        assertEquals(
                expected.stream().map(Version::fromString).collect(Collectors.toList()), actual);
    }

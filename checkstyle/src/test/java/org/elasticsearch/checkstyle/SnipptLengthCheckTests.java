...
public class SnipptLengthCheckTests extends ESTestCase {
    public void testNoSnippets() {
        SnippetLengthCheck.checkFile(failOnError(), randomInt(), "There a no snippets");
    }

    public void testEmptySnippet() {
        SnippetLengthCheck.checkFile(failOnError(), randomInt(),
            "// tag::foo",
            "// end::foo");
    }

    public void testSnippetWithSmallText() {
        SnippetLengthCheck.checkFile(failOnError(), 10,
            "// tag::foo",
            "some words",
            "// end::foo");
    }
    ...
    public void testSnippetBrokenLeadingSpaces() {
        ...
        SnippetLengthCheck.checkFile(collect(collection), 10,
            "  // tag::foo",
            "some words",
            "  // end::foo");
    ...
    public void testLotsOfErrors() {
        ...
        SnippetLengthCheck.checkFile(collect(collection), 10,
            ...
            "asdfadf",
            "  // end::foo");
        assertThat(collection, equalTo(Arrays.asList(

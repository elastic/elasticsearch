...
public class XContentAccessorTests extends ESTestCase {
    ...
    public void testEvaluateArrayAsRoot() throws Exception {
        ...
        xContentBuilder.endObject();
        xContentBuilder.endArray();
        XContentAccessor objectPath = XContentAccessor.createFromXContent(XContentFactory.xContent(XContentType.YAML),
                xContentBuilder.string());

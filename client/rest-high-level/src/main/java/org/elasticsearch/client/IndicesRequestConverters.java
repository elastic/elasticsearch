...
final class IndicesRequestConverters {
    ...
    static void addSearchRequestParams(RequestConverters.Params params, SearchRequest searchRequest) {
    ...
    static Request resize(ResizeRequest resizeRequest) throws IOException {

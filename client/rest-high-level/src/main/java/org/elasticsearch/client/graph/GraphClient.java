...
public class GraphClient {
    ...
    public GraphClient(CoreClient client) {
        this.client = client;
    }
    ...
    public final GraphExploreResponse explore(GraphExploreRequest graphExploreRequest,
        ...
        return client.performRequestAndParseEntity(graphExploreRequest, GraphRequestConverters::explore,
    ...
    public final void exploreAsync(GraphExploreRequest graphExploreRequest,
        ...
        client.performRequestAsyncAndParseEntity(graphExploreRequest, GraphRequestConverters::explore,

...
public class PutIndexTemplateRequest extends MasterNodeRequest<PutIndexTemplateRequest> implements IndicesRequest, ToXContent {
    ...
    public PutIndexTemplateRequest mapping(XContentBuilder source) {
        internalMapping(MapperService.SINGLE_MAPPING_NAME, XContentHelper.convertToMap(BytesReference.bytes(source), 
    ...
    /*
     * Returns true if the mapping uses custom types. Is used in the HighLevelRestClient to manage formatting of requests to a server
     */

...
public final class MachineLearningClient {
    ...
    public MachineLearningClient(CoreClient client) {
        this.client = client;
    }
    ...
    public PutJobResponse putJob(PutJobRequest request, RequestOptions options) throws IOException {
        return client.performRequestAndParseEntity(request,
    ...
    public void putJobAsync(PutJobRequest request, RequestOptions options, ActionListener<PutJobResponse> listener) {
        client.performRequestAsyncAndParseEntity(request,
                MLRequestConverters::putJob,
                options,
                PutJobResponse::fromXContent,
                listener,
     ...
     * A closed job cannot receive data or client.perform analysis operations, but you can still explore and navigate results.
     * <p>
     * For additional info

...
public class RegressionStats implements AnalysisStats {
    ...
    public static final ConstructingObjectParser<RegressionStats, Void> PARSER = new ConstructingObjectParser<>(
        NAME.getPreferredName(),
        true,
        a -> new RegressionStats((Instant) a[0], (Integer) a[1], (Hyperparameters) a[2], (TimingStats) a[3], (ValidationLoss) a[4])
    );

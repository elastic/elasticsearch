...
import org.elasticsearch.client.CoreClient;
...
public final class XPackClient {
    ...
    public XPackClient(CoreClient client) {
        this.client = client;
    }
    ...
    public XPackInfoResponse info(XPackInfoRequest request, RequestOptions options) throws IOException {
        return client.performRequestAndParseEntity(request, XPackRequestConverters::info, options,
    ...
    public void infoAsync(XPackInfoRequest request, RequestOptions options,
        ...
        client.performRequestAsyncAndParseEntity(request, XPackRequestConverters::info, options,
    ...
    public XPackUsageResponse usage(XPackUsageRequest request, RequestOptions options) throws IOException {
        return client.performRequestAndParseEntity(request, XPackRequestConverters::usage, options,
    ...
    public void usageAsync(XPackUsageRequest request, RequestOptions options, ActionListener<XPackUsageResponse> listener) {
        client.performRequestAsyncAndParseEntity(request, XPackRequestConverters::usage, options,

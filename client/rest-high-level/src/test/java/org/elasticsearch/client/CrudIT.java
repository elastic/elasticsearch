...
public class CrudIT extends ESRestHighLevelClientTestCase {
    ...
    public void testGetSource() throws IOException {
        ...
        }
        {
            ...
            assertEquals(RestStatus.NOT_FOUND, exception.status());
            assertEquals(
                "Elasticsearch exception [type=resource_not_found_exception, "
    ...
    public void testUpdate() throws IOException {
        {
            ...
            assertEquals(RestStatus.NOT_FOUND, exception.status());
            assertEquals(
                "Elasticsearch exception [type=document_missing_exception, reason=[_doc][does_not_exist]: document missing]",
                exception.getMessage()
            );
        }
        {

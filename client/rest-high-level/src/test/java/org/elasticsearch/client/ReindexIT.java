...
public class ReindexIT extends ESRestHighLevelClientTestCase {
    ...
    public void testReindexTask() throws Exception {
        ...
        }
        {
            ...
            CheckedRunnable<Exception> hasUpgradeCompleted = checkCompletionStatus(taskId);
            assertBusy(hasUpgradeCompleted);
        }
    }

    private CheckedRunnable<Exception> checkCompletionStatus(String taskId) {
        return () -> {
            try {

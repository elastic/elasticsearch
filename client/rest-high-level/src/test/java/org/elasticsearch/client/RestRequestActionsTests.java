...
public class RestRequestActionsTests extends ESTestCase {
    ...
    private RestRequestActions requestActions;

    @Before
    public void initClient() {
        restClient = mock(RestClient.class);
        requestActions = new RestRequestActions(restClient, RestClient::close, Collections.emptyList());
    }
    ...
    public void testRequestValidation() {
...

        {
            ActionRequestValidationException actualException = expectThrows(ActionRequestValidationException.class,
                    () -> requestActions.performRequest(request, null, RequestOptions.DEFAULT, null, null));
            assertSame(validationException, actualException);
        }
        {
            TrackingActionListener trackingActionListener = new TrackingActionListener();
            requestActions.performRequestAsync(request, null, RequestOptions.DEFAULT, null, trackingActionListener,
                null);
    ...
    public void testParseEntity() throws IOException {
        {
            IllegalStateException ise = expectThrows(IllegalStateException.class,
                () -> requestActions.parseEntity(null, null));
            assertEquals("Response body expected but not returned", ise.getMessage());
        }
        {
            IllegalStateException ise = expectThrows(IllegalStateException.class,
                    () -> requestActions.parseEntity(new StringEntity("", (ContentType) null), null));
        ...
        }
        {
            ...
            IllegalStateException ise = expectThrows(IllegalStateException.class,
                () -> requestActions.parseEntity(entity, null));
        ...
        }
        {
            ...
            assertEquals("value", requestActions.parseEntity(jsonEntity, entityParser));
            HttpEntity yamlEntity = new StringEntity("---\nfield: value\n", ContentType.create("application/yaml"));
            assertEquals("value", requestActions.parseEntity(yamlEntity, entityParser));
            HttpEntity smileEntity = createBinaryEntity(SmileXContent.contentBuilder(), ContentType.create("application/smile"));
            assertEquals("value", requestActions.parseEntity(smileEntity, entityParser));
            HttpEntity cborEntity = createBinaryEntity(CborXContent.contentBuilder(), ContentType.create("application/cbor"));
            assertEquals("value", requestActions.parseEntity(cborEntity, entityParser));
        }
    }
    ...
    public void testParseResponseException() throws IOException {
        {
            ...
            ElasticsearchException elasticsearchException =
                requestActions.parseResponseException(responseException);
    ...
    public void testPerformRequestOnSuccess() throws IOException {
        ...
        {
            Integer result = requestActions.performRequest(mainRequest, requestConverter, RequestOptions.DEFAULT,
                    response -> response.getStatusLine().getStatusCode(), Collections.emptySet());
            assertEquals(restStatus.getStatus(), result.intValue());
        }
        {
            IOException ioe = expectThrows(IOException.class, () -> requestActions.performRequest(mainRequest,
    ...
    public void testPerformRequestOnResponseExceptionWithoutEntity() throws IOException {
        ...
        ElasticsearchException elasticsearchException = expectThrows(ElasticsearchException.class,
                () -> requestActions.performRequest(mainRequest, requestConverter, RequestOptions.DEFAULT,
                        response -> response.getStatusLine().getStatusCode(), Collections.emptySet()));
        assertEquals(responseException.getMessage(), elasticsearchException.getMessage());
        assertEquals(restStatus, elasticsearchException.status());
        assertSame(responseException, elasticsearchException.getCause());
    ...
    public void testPerformRequestOnResponseExceptionWithIgnores() throws IOException {
        ...
        assertEquals(Integer.valueOf(404), requestActions.performRequest(mainRequest, requestConverter, 
    ...
    public void testWrapResponseListenerOnSuccess() {
        {
            TrackingActionListener trackingActionListener = new TrackingActionListener();
            ResponseListener responseListener = requestActions.wrapResponseListener(

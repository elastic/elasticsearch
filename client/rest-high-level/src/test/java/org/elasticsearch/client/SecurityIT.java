...
public class SecurityIT extends ESRestHighLevelClientTestCase {
    ...
    public void testAuthenticate() throws Exception {
        ...
        // Test the authenticate response for a service token
        {
            ...
            assertThat(user.getMetadata(), equalTo(org.elasticsearch.core.Map.of("_elastic_service_account", true)));
            ...
            assertThat(token, equalTo(org.elasticsearch.core.Map.of("name", "token1", "type", "_service_account_index")));
        }
    }

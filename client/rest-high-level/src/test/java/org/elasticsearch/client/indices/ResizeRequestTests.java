...
public class ResizeRequestTests extends AbstractRequestTestCase<ResizeRequest, org.elasticsearch.action.admin.indices.shrink.ResizeRequest> {
    ...
    @Override
    protected org.elasticsearch.action.admin.indices.shrink.ResizeRequest doParseToServerInstance(XContentParser parser) throws IOException {
    ...
    @Override
    protected void assertInstances(org.elasticsearch.action.admin.indices.shrink.ResizeRequest serverInstance, ResizeRequest clientTestInstance) {

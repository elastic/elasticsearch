...
public class IndexUpgradeSubmissionResponseTests extends ESTestCase {
    public void testFromXContent() throws IOException {
        xContentTester(
            ...
            this::toXContent,
            IndexUpgradeSubmissionResponse::fromXContent)
            .supportsUnknownFields(true)
            .test();
    }

    private void toXContent(IndexUpgradeSubmissionResponse response, XContentBuilder xContentBuilder) throws IOException {
        xContentBuilder.startObject();
        xContentBuilder.field("task", response.getTask().toString());
        xContentBuilder.endObject();
    }

    private IndexUpgradeSubmissionResponse createTestInstance() {

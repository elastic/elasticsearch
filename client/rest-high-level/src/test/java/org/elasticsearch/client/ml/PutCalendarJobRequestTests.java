...
public class PutCalendarJobRequestTests extends ESTestCase {
    ...
    public void testWithNullId() {
        NullPointerException ex = expectThrows(NullPointerException.class, () -> new PutCalendarJobRequest(null, "job1"));
    ...
    public void testSetJobIds() {
        ...
        NullPointerException ex = expectThrows(NullPointerException.class, () -> new PutCalendarJobRequest(calendarId, "job1", null));
        assertEquals("jobIds must not contain null values.", ex.getMessage());

        IllegalArgumentException illegalArgumentException = expectThrows(
            IllegalArgumentException.class,
            () -> new PutCalendarJobRequest(calendarId)
        );

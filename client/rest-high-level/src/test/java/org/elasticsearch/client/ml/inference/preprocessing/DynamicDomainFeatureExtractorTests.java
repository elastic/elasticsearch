...
public class DynamicDomainFeatureExtractorTests extends AbstractXContentTestCase<DynamicDomainFeatureExtractor> {

    @Override
    protected DynamicDomainFeatureExtractor doParseInstance(XContentParser parser) throws IOException {
        return DynamicDomainFeatureExtractor.fromXContent(parser);
    }
    ...
    public static DynamicDomainFeatureExtractor createRandom() {
        return new DynamicDomainFeatureExtractor(randomAlphaOfLength(10),
            ...
            randomAlphaOfLength(10),
            randomAlphaOfLength(10),
            Stream.generate(() -> randomAlphaOfLength(10)).limit(randomIntBetween(0, 10)).collect(Collectors.toSet()));
    }

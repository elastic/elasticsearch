            ...
            Map.of(
                ...
                Map.of(
                    ...
                    Map.of(
                        ...
                        List.of("all"),
                        "indices",
                        List.of(Map.of("names", List.of("ind-x"), "privileges", List.of("all"), "allow_restricted_indices", false)),
                        "metadata",
                        Map.of(),
                        "run_as",
                        List.of()
                    ...
                    Map.of(
                        ...
                        List.of("all"),
                        "indices",
                        List.of(Map.of("names", List.of("ind-y"), "privileges", List.of("all"), "allow_restricted_indices", false)),
                        "metadata",
                        Map.of(),
                        "run_as",
                        List.of()

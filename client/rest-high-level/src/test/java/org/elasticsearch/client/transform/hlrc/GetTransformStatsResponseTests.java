...
public class GetTransformStatsResponseTests extends AbstractResponseTestCase<
    ...
    protected void assertInstances(Response serverTestInstance, GetTransformStatsResponse clientInstance) {
        assertThat(serverTestInstance.getNodeFailures(), equalTo(clientInstance.getNodeFailures()));
        assertThat(serverTestInstance.getTaskFailures(), equalTo(clientInstance.getTaskFailures()));
        assertThat(serverTestInstance.getTransformsStats(), equalTo(clientInstance.getTransformsStats()));

...
public class HasAttributeNodePriorityStrategyTests extends RestClientTestCase {
    public void testHasAttribute() {
        ...
        List<List<Node>> nodeGroups = new HasAttributeNodePriorityStrategy("attr", "val").groupByPriority(nodes);

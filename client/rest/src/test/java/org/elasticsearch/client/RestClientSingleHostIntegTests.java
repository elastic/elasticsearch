...
import internal.org.apache.http.Consts;
...
/**
 * Integration test to check interaction between {@link RestClient} and {@link internal.org.apache.http.client.HttpClient}.
...
public class RestClientSingleHostIntegTests extends RestClientTestCase {
     ...
     * to set/add headers to the {@link internal.org.apache.http.client.HttpClient}.
     ...
     * out of the box by {@link internal.org.apache.http.client.HttpClient}.

 ...
 */
public class ElasticsearchHostsSnifferParseExampleTests extends RestClientTestCase {
    private void checkFile(String file, Node... expected) throws IOException {
        ...
        try {
            ...
            List<Node> nodes = ElasticsearchHostsSniffer.readHosts(entity, Scheme.HTTP, new JsonFactory());

            ...
            if (updateResult.success()) {
                ...
                switch (updateResult.result.operation()) {
                    ...
                    case INDEX:
                        ...
                        // add the response
                        IndexResponse indexResponse = result.response();
                        UpdateResponse updateResponse = new UpdateResponse(indexResponse.getShardInfo(), indexResponse.getShardId(), indexResponse.getType(), indexResponse.getId(), indexResponse.getVersion(), indexResponse.isCreated(), indexResponse.getTookInNanos());
                    ...
                    case DELETE:
                        ...
                        updateResponse = new UpdateResponse(response.getShardInfo(), response.getShardId(), response.getType(), response.getId(), response.getVersion(), false, response.getTookInNanos());

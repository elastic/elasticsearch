...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocumentRequest<IndexRequest> {
    ...
    public ActionRequestValidationException validate() {
        ...
        if (id == null && (versionType == VersionType.INTERNAL &&
            ...
            validationException = addValidationError("an id must be provided if version type or value are change", validationException);
        }
    ...
    /**
     * Returns <code>true</code> if this request has been send to a shard copy more than once.
     */
    ...
    /**
     * Returns <code>true</code> if the ID of this request is auto-generated
     */
    public boolean isAutoGeneratedID() {
        return autoGeneratedTimestamp >= 0;
    }

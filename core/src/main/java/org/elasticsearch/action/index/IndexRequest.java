...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocumentRequest<IndexRequest> {
    ...
    /**
     * Returns <code>true</code> if this request can have duplicates if {@link #isAutoGeneratedID()} is <code>true</code>.
     * This is possible in the case the request is sent to the same shards more than once due to retries or network hickups
     */

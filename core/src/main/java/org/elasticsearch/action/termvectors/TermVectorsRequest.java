    ...
    public static void parseRequest(TermVectorsRequest termVectorsRequest, XContentParser parser) throws IOException {
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            if (token == XContentParser.Token.FIELD_NAME) {
                ...
                } else if (OFFSETS.match(currentFieldName, parser.deprecationHandler())) {
                    termVectorsRequest.offsets(parser.booleanValue());
                } else if (POSITIONS.match(currentFieldName, parser.deprecationHandler())) {
                    termVectorsRequest.positions(parser.booleanValue());
                } else if (PAYLOADS.match(currentFieldName, parser.deprecationHandler())) {
                ...
                } else if (DFS.match(currentFieldName, parser.deprecationHandler())) {
                ...
                } else if (FILTER.match(currentFieldName, parser.deprecationHandler())) {
                    termVectorsRequest.filterSettings(readFilterSettings(parser));
                } else if (INDEX.match(currentFieldName, parser.deprecationHandler())) { // the following is important for multi request parsing.
                ...
                } else if (DOC.match(currentFieldName, parser.deprecationHandler())) {

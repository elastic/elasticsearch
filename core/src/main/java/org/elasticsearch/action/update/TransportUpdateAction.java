            ...
            case UPSERT:
                ...
                indexAction.execute(upsertRequest, new ActionListener<IndexResponse>() {
                    ...
                    public void onResponse(IndexResponse response) {
                        UpdateResponse update = new UpdateResponse(response.getShardInfo(), response.getShardId(), response.getType(), response.getId(), response.getVersion(), response.isCreated(), response.getTookInNanos());
            ...
            case DELETE:
                deleteAction.execute(result.action(), new ActionListener<DeleteResponse>() {
                    ...
                    public void onResponse(DeleteResponse response) {
                        UpdateResponse update = new UpdateResponse(response.getShardInfo(), response.getShardId(), response.getType(), response.getId(), response.getVersion(), false, response.getTookInNanos());

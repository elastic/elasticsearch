...
public interface RoutingChangesObserver {
     ...
     */
    void shardInitialized(ShardRouting unassignedShard, ShardRouting initializingShard);
    ...
    class DelegatingRoutingChangesObserver implements RoutingChangesObserver {
        ...
        public void shardInitialized(ShardRouting unassignedShard, ShardRouting initializingShard) {
            for (RoutingChangesObserver routingChangesObserver : routingChangesObservers) {
                routingChangesObserver.shardInitialized(unassignedShard, initializingShard);
            }
        }

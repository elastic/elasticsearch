...
public class DiskThresholdSettings {
    ...
    public DiskThresholdSettings(Settings settings, ClusterSettings clusterSettings) {
        ...
        final String floodStage = CLUSTER_ROUTING_ALLOCATION_DISK_FLOOD_STAGE_SETTING.get(settings);
        ...
        clusterSettings.addSettingsUpdateConsumer(CLUSTER_ROUTING_ALLOCATION_DISK_FLOOD_STAGE_SETTING, this::setFloodStageRaw);
    ...
    private void setFloodStageRaw(String floodStageRaw) {
        ...
        this.freeBytesThresholdFloodStage = thresholdBytesFromWatermark(floodStageRaw,
            CLUSTER_ROUTING_ALLOCATION_DISK_FLOOD_STAGE_SETTING.getKey());
    }

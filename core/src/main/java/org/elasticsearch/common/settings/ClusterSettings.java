...
public final class ClusterSettings extends AbstractScopedSettings {
    ...
    public static Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Collections.unmodifiableSet(new HashSet<>(
            Arrays.asList(AwarenessAllocationDecider.CLUSTER_ROUTING_ALLOCATION_AWARENESS_ATTRIBUTE_SETTING,
                    ...
                    HierarchyCircuitBreakerService.FIELDDATA_CIRCUIT_BREAKER_DEBUG_SETING,
                    HierarchyCircuitBreakerService.FIELDDATA_CIRCUIT_BREAKER_DEBUG_STACKTRACE_SETTING,
                    ...
                    HierarchyCircuitBreakerService.IN_FLIGHT_REQUESTS_CIRCUIT_BREAKER_DEBUG_SETTING,
                    HierarchyCircuitBreakerService.IN_FLIGHT_REQUESTS_CIRCUIT_BREAKER_DEBUG_STACKTRACE_SETTING,
                    HierarchyCircuitBreakerService.REQUEST_CIRCUIT_BREAKER_LIMIT_SETTING,
                    HierarchyCircuitBreakerService.REQUEST_CIRCUIT_BREAKER_OVERHEAD_SETTING,
                    HierarchyCircuitBreakerService.REQUEST_CIRCUIT_BREAKER_TYPE_SETTING,
                    HierarchyCircuitBreakerService.REQUEST_CIRCUIT_BREAKER_DEBUG_SETTING,
                    HierarchyCircuitBreakerService.REQUEST_CIRCUIT_BREAKER_DEBUG_STACKTRACE_SETTING,

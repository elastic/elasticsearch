...
final class CompositeIndexEventListener implements IndexEventListener {
    ...
    public void shardRoutingChanged(
            IndexShard indexShard, @Nullable ShardRouting oldRouting, ShardRouting newRouting) {
        listeners.forEach(
                listener -> {
                    try {
                                ...
                                (Supplier<?>)
                                        () ->
                                                new ParameterizedMessage(
                                                        "[{}] failed to invoke shard touring changed callback",
                    ...
                    try {
                        ...
                        logger.warn(
                                (Supplier<?>)
                                        () ->
                                                new ParameterizedMessage(
                                                        "[{}] failed to invoke after shard created callback",
                                                        indexShard.shardId().getId()),
                                e);
                        throw e;
                    }
                    ...
                    try {
                        ...
                        logger.warn(
                                (Supplier<?>)
                                        () ->
                                                new ParameterizedMessage(
                                                        "[{}] failed to invoke after shard started callback",
                                                        indexShard.shardId().getId()),
                                e);
                        throw e;
                    }
                    ...
                    try {
                        ...
                        logger.warn(
                                (Supplier<?>)
                                        () ->
                                                new ParameterizedMessage(
                                                        "[{}] failed to invoke before shard closed callback",
                                                        shardId.getId()),
                                e);
                        throw e;
                    }
                    ...
                    try {
                        ...
                        logger.warn(
                                (Supplier<?>)
                                        () ->
                                                new ParameterizedMessage(
                                                        "[{}] failed to invoke after shard closed callback",
                                                        shardId.getId()),
                                e);
                        throw e;
                    }
                    ...
                    try {
                        ...
                        logger.warn(
                                (Supplier<?>)
                                        () ->
                                                new ParameterizedMessage(
                                                        "[{}] failed to invoke on shard inactive callback",
                                                        indexShard.shardId().getId()),
                                e);
                        throw e;
                    }
    ...
    public void indexShardStateChanged(
        ...
        listeners.forEach(
                listener -> {
                    try {
                        listener.indexShardStateChanged(
                                indexShard, previousState, indexShard.state(), reason);
                    } catch (Exception e) {
                        logger.warn(
                                (Supplier<?>)
                                        () ->
                    ...
                    try {
                        ...
                        logger.warn(
                                (Supplier<?>)
                                        () ->
                                                new ParameterizedMessage(
                                                        "[{}] failed to invoke before shard created callback",
                                                        shardId),
                                e);
                        throw e;
                    }
    ...
    public void afterIndexRemoved(
            Index index, IndexSettings indexSettings, IndexRemovalReason reason) {
        listeners.forEach(
                listener -> {
                    try {
                    ...
                    try {
                        ...
                        logger.warn(
                                (Supplier<?>)
                                        () ->
                                                new ParameterizedMessage(
                                                        "[{}] failed to invoke before shard deleted callback",
                                                        shardId.getId()),
                                e);
                        throw e;
                    }
                    ...
                    try {
                        ...
                        logger.warn(
                                (Supplier<?>)
                                        () ->
                                                new ParameterizedMessage(
                                                        "[{}] failed to invoke after shard deleted callback",
                                                        shardId.getId()),
                                e);
                        throw e;
                    }

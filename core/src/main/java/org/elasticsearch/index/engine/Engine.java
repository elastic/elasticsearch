...
public abstract class Engine implements Closeable {
    ...
    public static class Index extends Operation {
        ...
        private final boolean isAutoGeneratedID;
        private final boolean canHaveDuplicates;
        private boolean created;

        public Index(Term uid, ParsedDocument doc, long version, VersionType versionType, Origin origin, long startTime, boolean isAutoGeneratedID, boolean canHaveDuplicates) {
            super(uid, version, versionType, origin, startTime);
            this.doc = doc;
            assert ((canHaveDuplicates == false && isAutoGeneratedID == false)
                || isAutoGeneratedID) : "canHaveDuplicates can only be true if isAutoGeneratedID is true as well: " + canHaveDuplicates + " " + isAutoGeneratedID;
        ...
        Index(Term uid, ParsedDocument doc, long version) {
            this(uid, doc, version, VersionType.INTERNAL, Origin.PRIMARY, System.nanoTime(), false, false);
        }
        ...
        /**
         * Returns <code>true</code> if the ID of this document is auto-generated by elasticsearch.
         * if this property is <code>true</code> indexing code might optimize the addition of this document
        ...
        /**
         * Returns <code>true</code> iff {@link #isAutoGeneratedID()} is <code>true</code> but the document has been sent to a shard more
         * than once such that it can have duplicates. This is necessary to signal de-optimizing the auto-generated ID / append only case
         * on the indexing layer.
         */

...
public final class EngineConfig {
    ...
    public EngineConfig(OpenMode openMode, ShardId shardId, ThreadPool threadPool,
                        ...
                        TranslogConfig translogConfig, TimeValue flushMergesAfter, RefreshListeners refreshListeners, long maxUnsafeAutoIdTimestamp) {
        if (openMode == null) {
     ...
     * The default is <code>true</code>.
     */
    private boolean getOptimizeAutoGeneratedIds() {
    ...
    public long getMaxUnsafeAutoIdTimestamp() {
        return getOptimizeAutoGeneratedIds() ? maxUnsafeAutoIdTimestamp : Long.MAX_VALUE;
    }
}

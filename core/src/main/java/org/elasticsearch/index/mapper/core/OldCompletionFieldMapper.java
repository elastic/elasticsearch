 ...
 *
 */
public class OldCompletionFieldMapper extends FieldMapper {
    ...
    public static class Builder extends FieldMapper.Builder<Builder, OldCompletionFieldMapper> {
        ...
        @Override
        public OldCompletionFieldMapper build(Mapper.BuilderContext context) {
            ...
            return new OldCompletionFieldMapper(name, fieldType, maxInputLength, context.indexSettings(), multiFieldsBuilder.build(this, context), copyTo);
        }
    ...
    public static class TypeParser implements Mapper.TypeParser {
        ...
        public Mapper.Builder<?, ?> parse(String name, Map<String, Object> node, ParserContext parserContext) throws MapperParsingException {
            OldCompletionFieldMapper.Builder builder = oldCompletionField(name);
    ...
    public OldCompletionFieldMapper(String simpleName, MappedFieldType fieldType, int maxInputLength, Settings indexSettings, MultiFields multiFields, CopyTo copyTo) {

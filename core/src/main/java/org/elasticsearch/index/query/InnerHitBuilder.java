...
public final class InnerHitBuilder extends ToXContentToBytes implements Writeable {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        if (out.getVersion().before(Version.V_6_0_0_alpha2)) {
            throw new IOException("Invalid output version, must >= " + Version.V_6_0_0_alpha2.toString());
        }
    ...
    protected void writeToNestedBWC(StreamOutput out, QueryBuilder query, String nestedPath) throws IOException {
        assert out.getVersion().before(Version.V_6_0_0_alpha2) :
            "invalid output version, must be < " + Version.V_6_0_0_alpha2.toString();

...
public class QueryShardContext extends QueryRewriteContext {
     ...
     * that could yield different results across executions like {@link #getTemplateBytes(ScriptInput)}
     */
    ...
    @Override
    public final BytesReference getTemplateBytes(ScriptInput template) {
        failIfFrozen();

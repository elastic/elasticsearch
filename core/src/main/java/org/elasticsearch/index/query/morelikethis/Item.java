 ...
 */
public final class Item implements ToXContent {
    ...
    public static Item parse(XContentParser parser, Item item) throws IOException {
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            if (token == XContentParser.Token.FIELD_NAME) {
                ...
                if (ParseFieldMatcher.STRICT.match(currentFieldName, Field.INDEX)) {
                    item.index = parser.text();
                } else if (ParseFieldMatcher.STRICT.match(currentFieldName, Field.TYPE)) {
                    item.type = parser.text();
                } else if (ParseFieldMatcher.STRICT.match(currentFieldName, Field.ID)) {
                    item.id = parser.text();
                } else if (ParseFieldMatcher.STRICT.match(currentFieldName, Field.DOC)) {
                ...
                } else if (ParseFieldMatcher.STRICT.match(currentFieldName, Field.PER_FIELD_ANALYZER)) {

...
public class IndexShard extends AbstractIndexShardComponent implements IndicesClusterStateService.Shard {
    ...
    public Engine.Index prepareIndexOnPrimary(SourceToParse source, long version, VersionType versionType, boolean autoGeneratedID,
                                              boolean canHaveDuplicates) {
        try {
            verifyPrimary();
            return prepareIndex(docMapper(source.type()), source, version, versionType, Engine.Operation.Origin.PRIMARY, autoGeneratedID,
                canHaveDuplicates);
        } catch (Exception e) {
            verifyNotClosed(e);
            throw e;
    ...
    public Engine.Index prepareIndexOnReplica(SourceToParse source, long version, VersionType versionType, boolean autoGeneratedID,
                                              boolean canHaveDuplicates) {
        try {
            verifyReplicationTarget();
            return prepareIndex(docMapper(source.type()), source, version, versionType, Engine.Operation.Origin.REPLICA, autoGeneratedID,
                canHaveDuplicates);
        } catch (Exception e) {
            verifyNotClosed(e);
            throw e;
    ...
    static Engine.Index prepareIndex(DocumentMapperForType docMapper, SourceToParse source, long version, VersionType versionType,
                                     Engine.Operation.Origin origin, boolean autoGeneratedID, boolean canHaveDuplicates) {
        ...
        return new Engine.Index(uid, doc, version, versionType, origin, startTime, autoGeneratedID, canHaveDuplicates);
    }

 ...
 */
public abstract class TranslogReader implements Comparable<TranslogReader> {
    ...
    public TranslogReader(long generation, FileChannel channel, Path path, long firstOperationOffset) {

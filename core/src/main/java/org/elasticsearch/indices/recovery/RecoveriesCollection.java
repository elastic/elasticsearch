...
public class RecoveriesCollection {
    ...
    public long startRecovery(IndexShard indexShard, DiscoveryNode sourceNode,
                              DiscoveryNode targetNode, RecoveryTargetService.RecoveryListener listener, TimeValue activityTimeout) {
        RecoveryTarget status = new RecoveryTarget(indexShard, sourceNode, targetNode, listener);

 ...
 */
public class StartLegacyRecoveryRequest extends StartRecoveryRequest {

    private Store.MetadataSnapshot metadataSnapshot;
    private boolean primaryRelocation;

    public StartLegacyRecoveryRequest() {
    }
     ...
     */
    public StartLegacyRecoveryRequest(final ShardId shardId,

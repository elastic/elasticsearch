            ...
            if (Strings.hasLength(template.getScript())) {
                ...
                try {
                    ...
                    if (isAnyScriptContextEnabled(scriptLang, scriptEngineService, ScriptType.INDEXED)) {
                        Object compiled = scriptEngineService.compile(template.getScript(), Collections.<String, String>emptyMap());
                        if (compiled == null) {
    ...
    private class ScriptChangesListener extends FileChangesListener {
        ...
        public void onFileDeleted(Path file) {
            ...
            if (scriptNameExt != null) {
                ...
                staticCache.remove(new CacheKey(engineService, scriptNameExt.v1(), null, Collections.<String, String>emptyMap()));
            }
        }

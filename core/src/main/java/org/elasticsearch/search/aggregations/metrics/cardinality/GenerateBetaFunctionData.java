...
public class GenerateBetaFunctionData {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int precision = 18; precision <= 25; precision++) {
            ...
            int initialStep = 10;
            File outFile = new File("/Users/colings86/dev/work/git/elasticsearch/gnuplot/coeffData" + precision + ".dat");
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(outFile))) {
                for (int testRun = 0; testRun < numTestRuns; testRun++) {
                    ...
                    System.out.println((testRun + 1) + " test runs complete for precision " + precision);
                }
            }
        }
    }

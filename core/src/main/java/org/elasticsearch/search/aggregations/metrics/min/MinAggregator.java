...
public class MinAggregator extends NumericMetricsAggregator.SingleValue {
    ...
    public static class Factory extends ValuesSourceAggregatorFactory.LeafOnly<ValuesSource.Numeric> {
        ...
        public Factory(String name) {
            super(name, InternalMin.TYPE.name(), ValuesSource.Numeric.class, ValueType.NUMERIC);
        }
        ...
        @Override
        protected ValuesSourceAggregatorFactory<Numeric> innerReadFrom(String name, Class<Numeric> valuesSourceType,

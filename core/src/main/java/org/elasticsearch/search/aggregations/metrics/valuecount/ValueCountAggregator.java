...
import org.elasticsearch.search.aggregations.metrics.sum.SumAggregatorFactory;
...
public class ValueCountAggregator extends NumericMetricsAggregator.SingleValue {
    ...
    public static class ValueCountAggregatorBuilder extends ValuesSourceAggregatorBuilder.LeafOnly<ValuesSource, ValueCountAggregatorBuilder> {
        ...
        @Override
        protected ValueCountAggregatorFactory doBuild(AggregationContext context, ValuesSourceConfig<ValuesSource> config) {

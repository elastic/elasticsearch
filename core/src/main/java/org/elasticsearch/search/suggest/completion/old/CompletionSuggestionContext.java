...
public class CompletionSuggestionContext extends SuggestionSearchContext.SuggestionContext {
    ...
    private OldCompletionFieldMapper.CompletionFieldType fieldType;
    ...
    public OldCompletionFieldMapper.CompletionFieldType fieldType() {
        return this.fieldType;
    }

    public void fieldType(OldCompletionFieldMapper.CompletionFieldType fieldType) {

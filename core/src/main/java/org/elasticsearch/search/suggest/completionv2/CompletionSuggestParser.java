...
public class CompletionSuggestParser implements SuggestContextParser {
    ...
    private org.elasticsearch.search.suggest.completion.CompletionSuggester oldCompletionSuggester;
    ...
    public SuggestionSearchContext.SuggestionContext parse(XContentParser parser, MapperService mapperService,
        ...
        if (mappedFieldType == null) {
            ...
            CompletionFieldMapper.CompletionFieldType fieldType = (CompletionFieldMapper.CompletionFieldType) mappedFieldType;
            ...
            if (fieldType != null) {
                if (fieldType.requiresContext()) {
                    if (contextParser == null) {
                        ...
                        contextParser.nextToken();
                        List<org.elasticsearch.search.suggest.context.ContextMapping.ContextQuery> contextQueries =
                                org.elasticsearch.search.suggest.context.ContextMapping.ContextQuery.parseQueries(fieldType.getContextMapping(), contextParser);
                        contextParser.close();

 ...
 * under the License.
 */
package org.elasticsearch.search.suggest.completionv2;
...
import org.elasticsearch.search.suggest.completionv2.CompletionSuggestion.Entry.Option;
...
public class CompletionSuggester extends Suggester<CompletionSuggestionContext> {
    ...
    private CompletionQuery toQuery(CompletionSuggestionContext suggestionContext) throws IOException {
        CompletionV2FieldMapper.CompletionFieldType fieldType = suggestionContext.fieldType();

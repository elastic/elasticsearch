...
public class CompletionSuggestionContext extends SuggestionSearchContext.SuggestionContext {
    ...
    private CompletionV2FieldMapper.CompletionFieldType fieldType;
    ...
    CompletionV2FieldMapper.CompletionFieldType fieldType() {
        return this.fieldType;
    }

    void fieldType(CompletionV2FieldMapper.CompletionFieldType fieldType) {

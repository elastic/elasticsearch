 ...
 * NOTE: This is a TestCase and abstract so it can be part of the test framework jar, so plugins
 * using the test framework can check the conventions, since they are using the same test runner config.
 */
public abstract class NamingConventionTestCase extends ESTestCase {

...
public class ActionWriteResponseTests extends ESTestCase {

    public void testShardInfoToString() {
        final int total = 5;
        final int successful = randomIntBetween(1, total);
        final ActionWriteResponse.ShardInfo shardInfo = new ActionWriteResponse.ShardInfo(total, successful);
        assertThat(
            shardInfo.toString(),

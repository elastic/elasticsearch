    ...
    private static NodeStats createNodeStats() {
        ...
        if (frequently()) {
            ...
            for (int i = 0; i < numBufferPools; i++) {
                bufferPoolList.add(new JvmStats.BufferPool(randomAlphaOfLengthBetween(3, 10), randomNonNegativeLong(), randomNonNegativeLong(),
                        randomNonNegativeLong()));
            }
        ...
        if (frequently()) {
            ...
            for (int i = 0; i < numDeviceStats; i++) {
                ...
                deviceStatsArray[i] = new FsInfo.DeviceStats(randomInt(), randomInt(), randomAlphaOfLengthBetween(3, 10),

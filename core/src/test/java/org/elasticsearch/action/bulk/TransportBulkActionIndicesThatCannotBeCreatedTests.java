...
public class TransportBulkActionIndicesThatCannotBeCreatedTests extends ESTestCase {
    public void testNonExceptional() {
        ...
        bulkRequest.add(new IndexRequest(randomAsciiOfLength(5)));
        bulkRequest.add(new IndexRequest(randomAsciiOfLength(5)));
        bulkRequest.add(new DeleteRequest(randomAsciiOfLength(5)));
        bulkRequest.add(new UpdateRequest(randomAsciiOfLength(5), randomAsciiOfLength(5), randomAsciiOfLength(5)));
    ...
    public void testAllFail() {
        ...
        bulkRequest.add(new UpdateRequest("nothin", randomAsciiOfLength(5), randomAsciiOfLength(5)));

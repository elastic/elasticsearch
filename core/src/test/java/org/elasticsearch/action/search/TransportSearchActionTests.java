...
public class TransportSearchActionTests extends ESTestCase {
    ...
    public void testProcessRemoteShards() throws IOException {
        try (TransportService transportService = MockTransportService.local(Settings.EMPTY, Version.CURRENT, threadPool,
            null)) {
            ...
            DiscoveryNode[] nodes = new DiscoveryNode[] {
                new DiscoveryNode("node1", LocalTransportAddress.buildUnique(), Version.CURRENT),
                new DiscoveryNode("node2",  LocalTransportAddress.buildUnique(), Version.CURRENT)
            };
            ...
            DiscoveryNode[] nodes2 = new DiscoveryNode[] {
                new DiscoveryNode("node3",  LocalTransportAddress.buildUnique(), Version.CURRENT)
            };

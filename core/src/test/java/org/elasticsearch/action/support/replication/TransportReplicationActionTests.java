...
public class TransportReplicationActionTests extends ESTestCase {
    ...
    */
    ...
    public void testSeqNoIsSetOnPrimary() throws Exception {
        ...
        Request request = new Request(shardId);
        PlainActionFuture<Response> listener = new PlainActionFuture<>();
        TransportReplicationAction<Request, Request, Response>.PrimaryPhase primaryPhase = action.new PrimaryPhase(request, createTransportChannel(listener));
        primaryPhase.doRun();
    ...
    * */
    ...
    class Action extends TransportReplicationAction<Request, Request, Response> {
        ...
        protected IndexShardReference getIndexShardOperationsCounterOnReplica(ShardId shardId, long opPrimaryTerm) {
            return createIndexShardReference(opPrimaryTerm);
        }

...
public class IndexCreationTaskTests extends ESTestCase {
    ...
    public void testExecute() throws Exception {
        ...
        final MetaDataCreateIndexService.IndexCreationTask task = new MetaDataCreateIndexService.IndexCreationTask(logger,
            allocationService, request, listener, indicesService, aliasValidator, xContentRegistry, settings, validator);

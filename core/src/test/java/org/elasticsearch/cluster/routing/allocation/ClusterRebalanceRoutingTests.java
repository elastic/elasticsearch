...
//            assertThat(routingTable.index("test1").shard(i).primaryShard().state(), equalTo(STARTED));
        ...
        assertThat(routingNodes.node("node3").get(0).shardId().index().getName(), equalTo("test1"));
    }
    ...
    public void testClusterAllActive1() {
        ...
        assertThat(routingNodes.node("node3").size(), equalTo(1));
        assertThat(routingNodes.node("node3").get(0).shardId().index().getName(), anyOf(equalTo("test1"), equalTo("test2")));
    }

...
public class DiscoveryModuleTests extends ESTestCase {
    ...
    public void setupDummyServices() {
        ...
        clusterService = new ClusterService(Settings.EMPTY, clusterSettings, threadPool);
    }

    @After
    public void clearDummyServices() throws IOException, InterruptedException {
        terminate(threadPool);
        IOUtils.close(transportService, clusterService, threadPool);

...
public class MembershipActionTests extends ESTestCase {
    ...
    public void testPreventJoinClusterWithUnsupportedNodeVersions() {
        ...
        builder.add(new DiscoveryNode(UUIDs.base64UUID(), LocalTransportAddress.buildUnique(), version));
        builder.add(new DiscoveryNode(UUIDs.base64UUID(), LocalTransportAddress.buildUnique(), randomCompatibleVersion(random(), version)));
        ...
        if (maxNodeVersion.onOrAfter(Version.V_5_0_0)) {
        ...
        if (minNodeVersion.before(Version.V_5_0_0_alpha1)) {

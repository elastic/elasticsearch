...
public class TokenCountFieldMapperIntegrationIT extends ESIntegTestCase {
    ...
    private void init() throws IOException {
        ...
        assertThat(prepareIndex("single", "I have four terms").get().getOperation(), equalTo(DocWriteResponse.Operation.CREATE));
        ...
        assertThat(prepareIndex("multi", "two terms", "wow now I have seven lucky terms").get().getOperation(),

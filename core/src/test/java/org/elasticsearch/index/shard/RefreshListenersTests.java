...
public class RefreshListenersTests extends ESTestCase {
    ...
    public void setupListeners() throws Exception {
        ...
        // Finally, we can listen to the engine
        listeners.listenTo(engine);
    }
    ...
    public void testTooMany() throws Exception {
        ...
        for (int i = 0; i < maxListeners; i++) {
            ...
            listeners.add(index.getTranslogLocation(), listener);
        }
        ...
        listeners.add(index.getTranslogLocation(), forcingListener);
    ...
    private Engine.Index index(String id, String testFieldValue) {
        ...
        ParsedDocument doc = new ParsedDocument(uidField, versionField, id, type, null, -1, -1, Arrays.asList(document), source, null); 

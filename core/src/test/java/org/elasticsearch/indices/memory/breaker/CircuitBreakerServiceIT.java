...
public class CircuitBreakerServiceIT extends ESIntegTestCase {
    ...
    private void reset() {
        ...
        Settings resetSettings = settingsBuilder()
                ...
                .put(HierarchyCircuitBreakerService.TOTAL_CIRCUIT_BREAKER_LIMIT_SETTING,
                        HierarchyCircuitBreakerService.DEFAULT_TOTAL_CIRCUIT_BREAKER_LIMIT)
                .build();
    ...
    public void testParentChecking() throws Exception {
        ...
        resetSettings = Settings.builder()
                .put(HierarchyCircuitBreakerService.TOTAL_CIRCUIT_BREAKER_LIMIT_SETTING, "500b")

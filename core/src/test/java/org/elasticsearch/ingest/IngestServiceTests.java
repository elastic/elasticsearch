...
public class IngestServiceTests extends ESTestCase {
    ...
    public void testIngestPlugin() {
        ...
        IngestService ingestService = new IngestService(Settings.EMPTY, tp, null, null, null, null,
                Collections.singletonList(DUMMY_PLUGIN));
        Map<String, Processor.Factory> factories = ingestService.getPipelineStore()
    ...
    public void testIngestPluginDuplicate() {
        ...
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () ->
                new IngestService(Settings.EMPTY, tp, null, null, null, null,

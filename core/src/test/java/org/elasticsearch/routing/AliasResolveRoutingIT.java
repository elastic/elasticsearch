...
public class AliasResolveRoutingIT extends ESIntegTestCase {
    public void testResolveIndexRouting() throws Exception {
        ...
        // Force the routing and ignore the alias.
        assertThat(clusterService().state().metaData().resolveIndexRouting(null, "1", "alias10"), equalTo("1"));
        ...
        // Force the routing and ignore the parent and the alias routing.
        assertThat(clusterService().state().metaData().resolveIndexRouting("1", "10", "alias10"), equalTo("10"));

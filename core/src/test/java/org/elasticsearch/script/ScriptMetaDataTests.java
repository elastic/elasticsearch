...
public class ScriptMetaDataTests extends AbstractSerializingTestCase<ScriptMetaData> {
    ...
    public void testFromXContentLoading() throws Exception {
        ...
        XContentParser parser0 = createParser(JsonXContent.jsonXContent, builder.bytes());
        ...
        XContentParser parser1 = createParser(JsonXContent.jsonXContent, builder.bytes());
        ...
        builder.startObject().field("lang0#id0", "script0").field("lang0#id1", "script1")
            ...
            .startObject("id0").field("lang", "lang1").field("source", "script1").endObject().endObject();
        XContentParser parser2 = createParser(JsonXContent.jsonXContent, builder.bytes());
        ...
        XContentParser parser3 = createParser(JsonXContent.jsonXContent, builder.bytes());

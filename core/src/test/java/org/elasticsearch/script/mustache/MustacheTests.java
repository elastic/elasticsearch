...
public class MustacheTests extends ESTestCase {
    ...
    public void testArrayAccess() throws Exception {
        ...
        CompiledScript mustache = new CompiledScript(ScriptService.ScriptType.INLINE, "inline", "mustache", engine.compile(template, Collections.<String, String>emptyMap()));
    ...
    public void testEscaping() {
        ...
        Map<String, String> params = randomBoolean() ? Collections.<String, String>emptyMap() : Collections.singletonMap(CONTENT_TYPE_PARAM, JSON_CONTENT_TYPE);
        Mustache mustache = (Mustache) engine.compile("{ \"field1\": \"{{value}}\"}", Collections.<String, String>emptyMap());

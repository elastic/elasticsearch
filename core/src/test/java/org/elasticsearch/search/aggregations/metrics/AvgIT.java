...
public class AvgIT extends AbstractNumericTestCase {
    ...
    public void testSingleValuedFieldWithValueScript() throws Exception {
        SearchResponse searchResponse = client().prepareSearch("idx")
                .setQuery(matchAllQuery())
                .addAggregation(avg("avg").field("value")
                        .script(ScriptInput.inline(FieldValueScriptEngine.NAME, "", emptyMap())))
                .execute().actionGet();
    ...
    public void testScriptSingleValued() throws Exception {
        SearchResponse searchResponse = client().prepareSearch("idx")
                ...
                .addAggregation(avg("avg")
                        .script(ScriptInput.inline(ExtractFieldScriptEngine.NAME, "value", emptyMap())))
                .execute().actionGet();
    ...
    public void testScriptMultiValued() throws Exception {
        SearchResponse searchResponse = client().prepareSearch("idx")
                .setQuery(matchAllQuery())
                .addAggregation(avg("avg")
                        .script(ScriptInput.inline(ExtractFieldScriptEngine.NAME, "values", emptyMap())))
                .execute().actionGet();
    ...
    public void testDontCacheScripts() throws Exception {
        ...
        SearchResponse r = client().prepareSearch("cache_test_idx").setSize(0)
                .addAggregation(avg("foo").field("d").script(ScriptInput.inline(FieldValueScriptEngine.NAME, "", emptyMap()))).get();

...
public class ExtendedStatsIT extends AbstractNumericTestCase {
    ...
    public void testScriptSingleValued() throws Exception {
        ...
        SearchResponse searchResponse = client().prepareSearch("idx")
                ...
                .addAggregation(
                        extendedStats("stats")
                                .script(ScriptInput.inline(AggregationTestScriptsPlugin.NAME, "doc['value'].value", Collections.emptyMap()))
                                .sigma(sigma))
                .execute().actionGet();
    ...
    public void testScriptMultiValuedWithParams() throws Exception {
        ...
        ScriptInput script = ScriptInput.inline(
            AggregationTestScriptsPlugin.NAME, "[ doc['value'].value, doc['value'].value - dec ]", params);

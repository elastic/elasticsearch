...
public class LocalReduceCardinalityIT extends ESIntegTestCase {
    ...
    public void setupSuiteScopeCluster() throws Exception {
        ...
        for (int i = 0; i < numDocs; ++i) {
            ...
            builders[i] = client().prepareIndex("idx", "type").setSource(jsonBuilder()
                    ...
                    .endObject());
            builders[i].setRouting("str_value");
        }
    ...
    @Test
    public void localSingleValuedString() throws Exception {
        final CardinalityBuilder localAggregation = cardinality("cardinality").precisionThreshold(precisionThreshold)
                    .isLocal(true).field("str_value");
        
        SearchResponse response = client().prepareSearch("idx").setTypes("type")
                .addAggregation(localAggregation)
                .execute().actionGet();

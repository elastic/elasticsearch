...
public class MaxIT extends AbstractNumericTestCase {
    ...
    public void testScriptSingleValued() throws Exception {
        SearchResponse searchResponse = client().prepareSearch("idx")
                .setQuery(matchAllQuery())
                .addAggregation(
                        max("max").script(ScriptInput.inline(AggregationTestScriptsPlugin.NAME, "doc['value'].value", emptyMap())))
                .execute().actionGet();
    ...
    public void testScriptMultiValued() throws Exception {
        SearchResponse searchResponse = client().prepareSearch("idx")
                ...
                .addAggregation(
                        max("max")
                                .script(ScriptInput.inline(AggregationTestScriptsPlugin.NAME, "doc['values'].values", emptyMap())))
                .get();
    ...
    public void testScriptMultiValuedWithParams() throws Exception {
        ...
        ScriptInput script =
            ScriptInput.inline(AggregationTestScriptsPlugin.NAME, "[ doc['value'].value, doc['value'].value + inc ]", params);
    ...
    public void testDontCacheScripts() throws Exception {
        ...
        SearchResponse r = client().prepareSearch("cache_test_idx").setSize(0).addAggregation(
                max("foo").field("d").script(ScriptInput.inline(AggregationTestScriptsPlugin.NAME, "_value + 1", emptyMap())))
                .get();

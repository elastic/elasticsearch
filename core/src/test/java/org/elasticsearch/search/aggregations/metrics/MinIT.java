...
public class MinIT extends AbstractNumericTestCase {
    ...
    public void testSingleValuedFieldWithValueScript() throws Exception {
        SearchResponse searchResponse = client().prepareSearch("idx")
                ...
                .addAggregation(
                        min("min")
                                .field("value")
                                .script(ScriptInput.inline(AggregationTestScriptsPlugin.NAME, "_value - 1", Collections.emptyMap())))
                .get();
    ...
    public void testSingleValuedFieldWithValueScriptWithParams() throws Exception {
        ...
        ScriptInput script = ScriptInput.inline(AggregationTestScriptsPlugin.NAME, "_value - dec", params);
    ...
    public void testDontCacheScripts() throws Exception {
        ...
        SearchResponse r = client().prepareSearch("cache_test_idx").setSize(0).addAggregation(
                min("foo").field("d").script(ScriptInput.inline(AggregationTestScriptsPlugin.NAME, "_value - 1", emptyMap())))
                .get();

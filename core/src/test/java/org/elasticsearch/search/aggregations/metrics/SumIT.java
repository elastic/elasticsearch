...
public class SumIT extends AbstractNumericTestCase {
    ...
    public void testSingleValuedFieldWithValueScript() throws Exception {
        SearchResponse searchResponse = client().prepareSearch("idx")
                ...
                .addAggregation(sum("sum").field("value").script(
                    ScriptInput.inline(FieldValueScriptEngine.NAME, "", emptyMap())))
                .execute().actionGet();
    ...
    public void testSingleValuedFieldWithValueScriptWithParams() throws Exception {
        ...
        SearchResponse searchResponse = client().prepareSearch("idx")
                .setQuery(matchAllQuery())
                .addAggregation(sum("sum").field("value").script(ScriptInput.inline(FieldValueScriptEngine.NAME, "", params)))
                .execute().actionGet();
    ...
    public void testScriptSingleValued() throws Exception {
        SearchResponse searchResponse = client().prepareSearch("idx")
                .setQuery(matchAllQuery())
                .addAggregation(sum("sum").script(ScriptInput.inline(ExtractFieldScriptEngine.NAME, "value", emptyMap())))
                .execute().actionGet();
    ...
    public void testScriptSingleValuedWithParams() throws Exception {
        ...
        SearchResponse searchResponse = client().prepareSearch("idx")
                .setQuery(matchAllQuery())
                .addAggregation(sum("sum").script(ScriptInput.inline(ExtractFieldScriptEngine.NAME, "value", params)))
                .execute().actionGet();
    ...
    public void testScriptMultiValued() throws Exception {
        SearchResponse searchResponse = client().prepareSearch("idx")
                .setQuery(matchAllQuery())
                .addAggregation(sum("sum").script(ScriptInput.inline(ExtractFieldScriptEngine.NAME, "values", emptyMap())))
                .execute().actionGet();
    ...
    public void testScriptMultiValuedWithParams() throws Exception {
        ...
        SearchResponse searchResponse = client().prepareSearch("idx")
                .setQuery(matchAllQuery())
                .addAggregation(
                        sum("sum").script(ScriptInput.inline(ExtractFieldScriptEngine.NAME, "values", params)))
                .execute().actionGet();
    ...
    public void testMultiValuedFieldWithValueScriptWithParams() throws Exception {
        ...
        params.put("increment", 1);
        SearchResponse searchResponse = client().prepareSearch("idx").setQuery(matchAllQuery())
                .addAggregation(sum("sum").field("values").script(ScriptInput.inline(FieldValueScriptEngine.NAME, "", params)))
                .execute().actionGet();
    ...
    public void testDontCacheScripts() throws Exception {
        ...
        SearchResponse r = client().prepareSearch("cache_test_idx").setSize(0)
                .addAggregation(sum("foo").field("d").script(ScriptInput.inline(FieldValueScriptEngine.NAME, "", emptyMap()))).get();

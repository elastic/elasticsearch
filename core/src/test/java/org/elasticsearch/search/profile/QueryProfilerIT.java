...
public class QueryProfilerIT extends ESIntegTestCase {
     ...
     * constructs 100-150 random queries and tries to profile them
     */
    public void testProfileQuery() throws Exception {
        ...
        for (int i = 0; i < iters; i++) {
            ...
            assertThat("Profile response should not be an empty list", resp.getProfileResults().size(), not(0));
    ...
    public void testSimpleMatch() throws Exception {
        ...
        assertNotNull(p);
        assertThat("Profile response should not be an empty list", p.size(), not(0));

...
import org.elasticsearch.search.suggest.CompletionV2SuggestSearchTests.CompletionMappingBuilder;
...
public class ContextCompletionV2SuggestSearchTests extends ElasticsearchIntegrationTest {
    ...
    public void testMultiContextFiltering() throws Exception {
        ...
        CompletionSuggestionBuilder catFilterSuggest = SuggestBuilders.completionV2Suggestion("foo").field(FIELD).prefix("sugg");
        ...
        CompletionSuggestionBuilder typeFilterSuggest = SuggestBuilders.completionV2Suggestion("foo").field(FIELD).prefix("sugg");
        ...
        CompletionSuggestionBuilder multiContextFilterSuggest = SuggestBuilders.completionV2Suggestion("foo").field(FIELD).prefix("sugg");
    ...
    public void testMultiContextBoosting() throws Exception {
        ...
        CompletionSuggestionBuilder catBoostSuggest = SuggestBuilders.completionV2Suggestion("foo").field(FIELD).prefix("sugg");
        ...
        CompletionSuggestionBuilder typeBoostSuggest = SuggestBuilders.completionV2Suggestion("foo").field(FIELD).prefix("sugg");
        ...
        CompletionSuggestionBuilder multiContextBoostSuggest = SuggestBuilders.completionV2Suggestion("foo").field(FIELD).prefix("sugg");
        // query context order should never matter
        if (randomBoolean()) {
    ...
    public void assertSuggestions(String suggestionName, SuggestBuilder.SuggestionBuilder suggestBuilder, String... suggestions) {
        ...
        CompletionV2SuggestSearchTests.assertSuggestions(suggestResponse, suggestionName, suggestions);
    }

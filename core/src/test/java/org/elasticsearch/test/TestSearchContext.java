...
public class TestSearchContext extends SearchContext {
    ...
    public TestSearchContext(ThreadPool threadPool, BigArrays bigArrays, IndexService indexService, QueryCache filterCache, IndexFieldDataService indexFieldDataService) {

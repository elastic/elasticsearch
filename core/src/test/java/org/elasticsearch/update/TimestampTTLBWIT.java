...
public class TimestampTTLBWIT extends ESIntegTestCase {
    ...
    public void testUpdate() throws Exception {
        ...
        try {
            client().prepareUpdate(indexOrAlias(), "type1", "1")
                    .setScript(ScriptInput.create(Script.ScriptType.INLINE, "field_inc", "field", null, null)).execute().actionGet();
            fail();
        ...
        // check TTL update
        client().prepareUpdate(indexOrAlias(), "type1", "2")
                .setScript(ScriptInput.create(Script.ScriptType.INLINE, "put_values", "", null,
    ...
    public void testContextVariables() throws Exception {
        ...
        UpdateResponse updateResponse = client().prepareUpdate("test", "subtype1", "id1")
                .setRouting("routing1")
                .setScript(ScriptInput.create(Script.ScriptType.INLINE, "extract_ctx", "", null, null))
                .execute().actionGet();

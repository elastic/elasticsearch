...
public class TimestampTTLBWIT extends ESIntegTestCase {
    ...
    public void testUpdate() throws Exception {
        ...
        try {
            client().prepareUpdate(indexOrAlias(), "type1", "1")
                    .setScript(new Script("field", Script.ScriptType.INLINE, "field_inc", null)).execute().actionGet();
            fail();
        ...
        // check TTL update
        client().prepareUpdate(indexOrAlias(), "type1", "2")
                .setScript(new Script("", Script.ScriptType.INLINE, "put_values",
    ...
    public void testContextVariables() throws Exception {
        ...
        UpdateResponse updateResponse = client().prepareUpdate("test", "subtype1", "id1")
                .setRouting("routing1")
                .setScript(new Script("", Script.ScriptType.INLINE, "extract_ctx", null))
                .execute().actionGet();

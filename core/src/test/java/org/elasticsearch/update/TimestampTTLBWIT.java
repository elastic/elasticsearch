...
public class TimestampTTLBWIT extends ESIntegTestCase {
    ...
    public void testUpdate() throws Exception {
        ...
        try {
            client().prepareUpdate(indexOrAlias(), "type1", "1")
                    .setScript(ScriptInput.inline("field_inc", "field", Collections.emptyMap())).execute().actionGet();
            fail();
        ...
        // check TTL update
        client().prepareUpdate(indexOrAlias(), "type1", "2")
                .setScript(ScriptInput.inline("put_values", "",
    ...
    public void testContextVariables() throws Exception {
        ...
        UpdateResponse updateResponse = client().prepareUpdate("test", "subtype1", "id1")
                .setRouting("routing1")
                .setScript(ScriptInput.inline("extract_ctx", "", Collections.emptyMap()))
                .execute().actionGet();

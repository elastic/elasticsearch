...
public class UpdateIT extends ESIntegTestCase {
    ...
    public static class PutFieldValuesScriptEngine implements ScriptEngineService {
        ...
        @Override
        public ExecutableScript executable(CompiledScript compiledScript, final Map<String, Object> originalParams) {
    ...
    public static class FieldIncrementScriptEngine implements ScriptEngineService {
        ...
        @Override
        public ExecutableScript executable(CompiledScript compiledScript, final Map<String, Object> params) {

...
public class UpdateIT extends ESIntegTestCase {
    ...
    public void testUpsert() throws Exception {
        ...
        UpdateResponse updateResponse = client().prepareUpdate(indexOrAlias(), "type1", "1")
                ...
                .setScript(ScriptInput.inline("field_inc", "field", Collections.emptyMap()))
                .execute().actionGet();
    ...
    public void testScriptedUpsert() throws Exception {
        ...
        UpdateResponse updateResponse = client().prepareUpdate(indexOrAlias(), "type1", "1")
                ...
                .setScript(ScriptInput.inline("scripted_upsert", "", params))
                .execute().actionGet();
        assertEquals(DocWriteResponse.Result.CREATED, updateResponse.getResult());
        assertThat(updateResponse.getIndex(), equalTo("test"));
    ...
    public void testUpsertFields() throws Exception {
        ...
        UpdateResponse updateResponse = client().prepareUpdate(indexOrAlias(), "type1", "1")
                ...
                .setScript(ScriptInput.inline("put_values", "", Collections.singletonMap("extra", "foo")))
                .setFetchSource(true)
                .execute().actionGet();
    ...
    public void testVersionedUpdate() throws Exception {
        ...
        assertThrows(client().prepareUpdate(indexOrAlias(), "type", "1")
                        .setScript(ScriptInput.inline("put_values", "", Collections.singletonMap("text", "v2"))).setVersion(2)
                        .execute(),
                VersionConflictEngineException.class);

        client().prepareUpdate(indexOrAlias(), "type", "1")
                .setScript(ScriptInput.inline("put_values", "", Collections.singletonMap("text", "v2"))).setVersion(1).get();
        assertThat(client().prepareGet("test", "type", "1").get().getVersion(), equalTo(2L));

        // and again with a higher version..
        client().prepareUpdate(indexOrAlias(), "type", "1")
                .setScript(ScriptInput.inline("put_values", "", Collections.singletonMap("text", "v3"))).setVersion(2).get();
        ...
        assertThrows(client().prepareUpdate("test", "type", "1")
                        .setScript(ScriptInput.inline("put_values", "", Collections.singletonMap("text", "v2"))).setVersion(3)
                        .execute(),
        ...
        client().prepareUpdate(indexOrAlias(), "type", "3")
                .setScript(ScriptInput.inline("put_values", "", Collections.singletonMap("text", "v2")))
    ...
    public void testUpdate() throws Exception {
        ...
        params.put("inc", 3);
        updateResponse = client().prepareUpdate(indexOrAlias(), "type1", "1")
                .setScript(ScriptInput.inline("field_inc", "field", params)).execute().actionGet();
        ...
        // check noop
        updateResponse = client().prepareUpdate(indexOrAlias(), "type1", "1")
                .setScript(ScriptInput.inline("put_values", "", Collections.singletonMap("_ctx", Collections.singletonMap("op", "none")))).execute().actionGet();
        assertThat(updateResponse.getVersion(), equalTo(3L));
        ...
        // check delete
        updateResponse = client().prepareUpdate(indexOrAlias(), "type1", "1")
                .setScript(ScriptInput.inline("put_values", "", Collections.singletonMap("_ctx", Collections.singletonMap("op", "delete")))).execute().actionGet();
        ...
        updateResponse = client().prepareUpdate(indexOrAlias(), "type1", "1")
            .setScript(ScriptInput.inline("field_inc", "field1", Collections.emptyMap()))

...
public class DockerRestApiSpecTests extends ESClientYamlSuiteTestCase {

    private static final String USER = "x_pack_rest_user";
    private static final String PASS = "x-pack-test-password";
    private static final String KEYSTORE_PASS = "testnode";

    public DockerRestApiSpecTests(ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }
    ...
    public static void getKeyStore() {
        try {
            keyStore = PathUtils.get(DockerRestApiSpecTests.class.getResource("/testnode.jks").toURI());

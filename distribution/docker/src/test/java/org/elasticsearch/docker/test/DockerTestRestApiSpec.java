...
public class DockerTestRestApiSpec extends ESClientYamlSuiteTestCase {

    private static final String USER = "x_pack_rest_user";
    private static final String PASS = "x-pack-test-password";
    private static final String KEYSTORE_PASS = "testnode";

    public DockerTestRestApiSpec(ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }
    ...
    public static void getKeyStore() {
        try {
            keyStore = PathUtils.get(DockerTestRestApiSpec.class.getResource("/testnode.jks").toURI());

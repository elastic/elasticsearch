...
@setlocal
for /F "usebackq delims=" %%a in (`CALL %JAVA% -cp "!ES_CLASSPATH!" "org.elasticsearch.tools.launchers.JvmOptionsParser" "!ES_JVM_OPTIONS!" "!ES_HOME!"/plugins ^|^| echo jvm_options_parser_failed`) do set JVM_OPTIONS=%%a

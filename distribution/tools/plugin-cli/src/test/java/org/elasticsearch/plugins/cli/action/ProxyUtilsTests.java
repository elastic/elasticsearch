...
public class ProxyUtilsTests extends ESTestCase {
    ...
    public void testBuildProxy_withInvalidHost() {
        Stream.of("blah_blah:1234", "-host.domain:1234", "host.-domain:1234", "tést:1234", ":1234").forEach(testCase -> {
            PluginSyncException e = expectThrows(PluginSyncException.class, () -> buildProxy(testCase));
    ...
    public void testBuildProxy_withNullValueAndSystemHttpProxy() throws Exception {
        ...
        try {
            ...
            assertThat(buildProxy(null), matchesProxy(Type.HTTP, "host.localhost", 1234));
        } finally {
    ...
    public void testBuildProxy_withNullValueAndSystemSocksProxy() throws Exception {
        ...
        try {
            ...
            assertThat(buildProxy(null), matchesProxy(Type.SOCKS, "host.localhost", 1234));
        } finally {

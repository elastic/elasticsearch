...
Rollup::
* In addition to grouping by index pattern, the GetRollupCapabilities API now allows
grouping by the concrete index that rollups are physically stored in ({pull}30401[#30401])

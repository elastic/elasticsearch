...
Rollup::
* Exceptions thrown when validating rollup job configs on job creation have been
specialized to `rollup_action_request_validation_exception`, to make it easier for
clients to handle/parse ({pull}30339[#30339])

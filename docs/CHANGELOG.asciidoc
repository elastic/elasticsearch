...
Stop setting connection request timeout in default low-level REST client configuration because it
causes unexpected timeout exceptions for successful requests ({pull}30384[#30384])

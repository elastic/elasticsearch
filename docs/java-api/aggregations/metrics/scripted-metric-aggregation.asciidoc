...
MetricsAggregationBuilder aggregation =
        AggregationBuilders
                ...
                .mapScript(ScriptInput.inline("if (doc['gender'].value == \"male\") " +
...
MetricsAggregationBuilder aggregation =
        AggregationBuilders
                .scriptedMetric("agg")
                .initScript(ScriptInput.inline("_agg['heights'] = []"))
                .mapScript(ScriptInput.inline("if (doc['gender'].value == \"male\") " +
                        "{ _agg.heights.add(doc['height'].value) } " +
                        "else " +
                        "{ _agg.heights.add(-1 * doc['height'].value) }"))
                .combineScript(ScriptInput.inline("heights_sum = 0; for (t in _agg.heights) { heights_sum += t }; return heights_sum"));
--------------------------------------------------
...
MetricsAggregationBuilder aggregation =
        AggregationBuilders
                ...
                .mapScript(ScriptInput.inline("if (doc['gender'].value == \"male\") " +
                        ...
                        "{ _agg.heights.add(-1 * doc['height'].value) }"))
                .combineScript(ScriptInput.inline("heights_sum = 0; for (t in _agg.heights) { heights_sum += t }; return heights_sum"))
                .reduceScript(ScriptInput.inline("heights_sum = 0; for (a in _aggs) { heights_sum += a }; return heights_sum"));
--------------------------------------------------

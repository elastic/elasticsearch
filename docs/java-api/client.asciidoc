...
deprecated::[6.0.0, The `TransportClient` is deprecated in favor of the
 {java-rest}/java-rest-high.html[Java High Level REST Client], which
 sends HTTP requests instead of using the transport layer.]

...
<4> Boolean indicating whether to wait until the follower has been restored from the leader. Restoring requires
copying all of the leader data to the follower which can be a time consuming process.

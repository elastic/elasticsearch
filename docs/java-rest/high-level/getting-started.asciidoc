...
All of the the methods accross the different clients exist in a traditional synchronous and 
...
in case of e.g. an error or in case you wish to abort the request. Cancelling

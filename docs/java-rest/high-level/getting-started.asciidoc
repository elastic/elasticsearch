...
asynchronous variant. The difference is that the asynchronous ones use asynchronous Apache 
...
The asynchronous calls are recognizable by the fact that they have the word "Async" in their name 

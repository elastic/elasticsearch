...
:doc-tests-it: {elasticsearch-root}/client/rest-high-level/src/javaRestTest/java/org/elasticsearch/client/documentation
:hlrc-tests: {elasticsearch-root}/client/rest-high-level/src/javaRestTest/java/org/elasticsearch/client

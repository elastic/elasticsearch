...
deprecated[7.15.0, The High Level REST Client is deprecated in favour of the 
https://www.elastic.co/guide/en/elasticsearch/client/java-api-client/current/index.html[Java API Client].

...
---------------------------------------------------
include-tagged::{doc-tests-it}/LicensingDocumentationIT.java[start-trial-execute]
---------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-it}/LicensingDocumentationIT.java[start-trial-response]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-it}/LicensingDocumentationIT.java[start-trial-execute-async]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-it}/LicensingDocumentationIT.java[start-trial-execute-listener]
--------------------------------------------------

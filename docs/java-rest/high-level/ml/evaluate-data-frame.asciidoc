...
<5> Fetching the number of classes that were not included in precision calculation
<6> Fetching recall metric by name
<7> Fetching the actual recall value
<8> Fetching the number of classes that were not included in recall calculation
<9> Fetching multiclass confusion matrix metric by name
<10> Fetching the contents of the confusion matrix
<11> Fetching the number of classes that were not included in the matrix

...
<4> Name of the field in the index. Its value denotes the predicted classes array. This field must be nested and contain objects of the format {"class_name": "cat", "class_probability": 0.95}.
<5> Name of the field in the index. Its value denotes the predicted class of the example. Must be nested under the predicted classes array.
<6> Name of the field in the index. Its value denotes the predicted probability of the example. Must be nested under the predicted classes array.
<7> The remaining parameters are the metrics to be calculated based on the two fields described above
<8> Accuracy
<9> Precision
<10> Recall
<11> Multiclass confusion matrix of size 3
<12> {wikipedia}/Receiver_operating_characteristic#Area_under_the_curve[AuC ROC] calculated for class "cat" treated as positive and the rest as negative

...
<4> Name of the field in the index. Its value denotes the predicted class of the example. Must be nested under the predicted classes array.
<5> Name of the field in the index. Its value denotes the predicted probability of the example. Must be nested under the predicted classes array.
<6> The remaining parameters are the metrics to be calculated based on the two fields described above
<7> Accuracy
<8> Precision
<9> Recall
<10> Multiclass confusion matrix of size 3
<11> {wikipedia}/Receiver_operating_characteristic#Area_under_the_curve[AuC ROC] calculated for class "cat" treated as positive and the rest as negative

...
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-basic]
--------------------------------------------------
...
[id="{mainid}-{api}-request-optional"]
===== Optional arguments
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-indices-types]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-routing]
--------------------------------------------------
<1> Set a routing parameter

["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-indicesOptions]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-preference]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-source-basics]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-source-setter]
--------------------------------------------------

[id="{mainid}-{api}-request-building-queries"]
===== Building queries
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-query-builder-ctor]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-query-builder-options]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-query-builders]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-query-setter]
--------------------------------------------------

The <<{mainid}-query-builders, Building Queries>> page gives a list of all available search queries with
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-source-sorting]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-source-filtering-off]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-source-filtering-includes]
--------------------------------------------------

[id="{mainid}-{api}-request-highlighting"]
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-highlighting]
--------------------------------------------------
...
Highlighted text fragments can <<{mainid}-{api}-response-highlighting,later be retrieved>> from the +{response}+.

[id="{mainid}-{api}-request-building-aggs"]
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-aggregations]
--------------------------------------------------

The <<{mainid}-aggregation-builders, Building Aggregations>> page gives a list of all available aggregations with
their corresponding `AggregationBuilder` objects and `AggregationBuilders` helper methods.

We will later see how to <<{mainid}-{api}-response-aggs,access aggregations>> in the +{response}+.
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-suggestion]
--------------------------------------------------
<1> Creates a new `TermSuggestionBuilder` for the `user` field and
the text `kmichy`
<2> Adds the suggestion builder and names it `suggest_user`

We will later see how to <<{mainid}-{api}-response-suggestions,retrieve suggestions>> from the
+{response}+.
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-profiling]
--------------------------------------------------

Once the +{request}+ is executed the corresponding +{response}+ will
<<{mainid}-{api}-response-profile,contain the profiling results>>.

include::../executions.asciidoc[]

[id="{mainid}-{api}-response"]
==== {response}
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-response-1]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-response-2]
--------------------------------------------------

[id="{mainid}-{api}-response-search-hits"]
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-hits-get]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-hits-info]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-hits-singleHit]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-hits-singleHit-properties]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-hits-singleHit-source]
--------------------------------------------------

[id="{mainid}-{api}-response-highlighting"]
===== Retrieving Highlighting

If <<{mainid}-{api}-request-highlighting,requested>>, highlighted text fragments can be retrieved from each `SearchHit` in the result. The hit object offers
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-aggregations-get]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-aggregations-asMap]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-aggregations-asList]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-aggregations-iterator]
--------------------------------------------------

[id="{mainid}-{api}-response-suggestions"]
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-suggestion-get]
--------------------------------------------------
...
[id="{mainid}-{api}-response-profile"]
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-profiling-get]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-profiling-queries]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-profiling-queries-results]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-profiling-queries-collectors]
--------------------------------------------------
...
["source","java",subs="attributes,callouts,macros"]
--------------------------------------------------
include-tagged::{doc-tests-file}[search-request-profiling-aggs]
--------------------------------------------------

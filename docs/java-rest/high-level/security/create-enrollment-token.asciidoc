...
Enrollment Token can be created using this API.
...
The returned +{response}+ contains a string that contains the enrollment token with which user can enroll a new node

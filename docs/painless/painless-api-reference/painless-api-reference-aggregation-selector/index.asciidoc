...
<<painless-api-reference-aggregation-selector-org-elasticsearch-xpack-unsignedlong, Expand details for org.elasticsearch.xpack.unsignedlong>>

* <<painless-api-reference-aggregation-selector-UnsignedLongScriptDocValues, UnsignedLongScriptDocValues>>

...
[role="exclude",id="painless-api-reference-aggregation-selector-org-elasticsearch-xpack-unsignedlong"]
=== Aggregation Selector API for package org.elasticsearch.xpack.unsignedlong
See the <<painless-api-reference-aggregation-selector, Aggregation Selector API>> for a high-level overview of all packages and classes.

[[painless-api-reference-aggregation-selector-UnsignedLongScriptDocValues]]

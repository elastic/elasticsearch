[role="exclude",id="painless-api-reference-aggregation-selector-java-util-regex"]
=== java.util.regex

[[painless-api-reference-aggregation-selector-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-aggregation-selector-java-util-regex-Pattern]]
==== Pattern

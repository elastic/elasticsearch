[role="exclude",id="painless-api-reference-aggs-combine-java-util-regex"]
=== java.util.regex

[[painless-api-reference-aggs-combine-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-aggs-combine-java-util-regex-Pattern]]
==== Pattern

[role="exclude",id="painless-api-reference-aggs-map-java-time-zone"]
=== java.time.zone

[[painless-api-reference-aggs-map-java-time-zone-ZoneOffsetTransition]]
...
[[painless-api-reference-aggs-map-java-time-zone-ZoneOffsetTransitionRule]]
...
[[painless-api-reference-aggs-map-java-time-zone-ZoneOffsetTransitionRule.TimeDefinition]]
...
[[painless-api-reference-aggs-map-java-time-zone-ZoneRules]]
==== ZoneRules
...
[[painless-api-reference-aggs-map-java-time-zone-ZoneRulesException]]
==== ZoneRulesException
...
[[painless-api-reference-aggs-map-java-time-zone-ZoneRulesProvider]]
==== ZoneRulesProvider

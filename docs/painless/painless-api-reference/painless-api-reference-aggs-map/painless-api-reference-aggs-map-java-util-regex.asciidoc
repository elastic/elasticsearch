[role="exclude",id="painless-api-reference-aggs-map-java-util-regex"]
=== java.util.regex

[[painless-api-reference-aggs-map-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-aggs-map-java-util-regex-Pattern]]
==== Pattern

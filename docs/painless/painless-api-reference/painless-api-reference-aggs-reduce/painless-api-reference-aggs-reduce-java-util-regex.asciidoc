[role="exclude",id="painless-api-reference-aggs-reduce-java-util-regex"]
=== java.util.regex

[[painless-api-reference-aggs-reduce-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-aggs-reduce-java-util-regex-Pattern]]
==== Pattern

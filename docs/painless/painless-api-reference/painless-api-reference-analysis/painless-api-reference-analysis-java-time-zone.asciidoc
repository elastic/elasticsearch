[role="exclude",id="painless-api-reference-analysis-java-time-zone"]
=== java.time.zone

[[painless-api-reference-analysis-java-time-zone-ZoneOffsetTransition]]
...
[[painless-api-reference-analysis-java-time-zone-ZoneOffsetTransitionRule]]
...
[[painless-api-reference-analysis-java-time-zone-ZoneOffsetTransitionRule.TimeDefinition]]
...
[[painless-api-reference-analysis-java-time-zone-ZoneRules]]
==== ZoneRules
...
[[painless-api-reference-analysis-java-time-zone-ZoneRulesException]]
==== ZoneRulesException
...
[[painless-api-reference-analysis-java-time-zone-ZoneRulesProvider]]
==== ZoneRulesProvider

[role="exclude",id="painless-api-reference-analysis-java-util-regex"]
=== java.util.regex

[[painless-api-reference-analysis-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-analysis-java-util-regex-Pattern]]
==== Pattern

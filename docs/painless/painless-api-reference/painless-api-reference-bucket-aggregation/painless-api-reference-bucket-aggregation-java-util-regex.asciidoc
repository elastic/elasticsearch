[role="exclude",id="painless-api-reference-bucket-aggregation-java-util-regex"]
=== java.util.regex

[[painless-api-reference-bucket-aggregation-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-bucket-aggregation-java-util-regex-Pattern]]
==== Pattern

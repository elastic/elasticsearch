[role="exclude",id="painless-api-reference-filter-java-math"]
=== java.math

[[painless-api-reference-filter-java-math-BigDecimal]]
==== BigDecimal
...
[[painless-api-reference-filter-java-math-BigInteger]]
==== BigInteger
...
[[painless-api-reference-filter-java-math-MathContext]]
==== MathContext
...
[[painless-api-reference-filter-java-math-RoundingMode]]
==== RoundingMode

[role="exclude",id="painless-api-reference-filter-java-util-regex"]
=== java.util.regex

[[painless-api-reference-filter-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-filter-java-util-regex-Pattern]]
==== Pattern

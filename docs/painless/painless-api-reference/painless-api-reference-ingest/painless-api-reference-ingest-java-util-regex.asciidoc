[role="exclude",id="painless-api-reference-ingest-java-util-regex"]
=== java.util.regex

[[painless-api-reference-ingest-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-ingest-java-util-regex-Pattern]]
==== Pattern

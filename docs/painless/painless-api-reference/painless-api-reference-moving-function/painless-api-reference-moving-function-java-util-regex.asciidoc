[role="exclude",id="painless-api-reference-moving-function-java-util-regex"]
=== java.util.regex

[[painless-api-reference-moving-function-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-moving-function-java-util-regex-Pattern]]
==== Pattern

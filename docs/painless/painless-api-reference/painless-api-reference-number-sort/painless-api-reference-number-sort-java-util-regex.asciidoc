[role="exclude",id="painless-api-reference-number-sort-java-util-regex"]
=== java.util.regex

[[painless-api-reference-number-sort-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-number-sort-java-util-regex-Pattern]]
==== Pattern

[role="exclude",id="painless-api-reference-processor-conditional-java-util-regex"]
=== java.util.regex

[[painless-api-reference-processor-conditional-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-processor-conditional-java-util-regex-Pattern]]
==== Pattern

...
==== org.elasticsearch.xpack.unsignedlong
<<painless-api-reference-score-org-elasticsearch-xpack-unsignedlong, Expand details for org.elasticsearch.xpack.unsignedlong>>

* <<painless-api-reference-score-UnsignedLongScriptDocValues, UnsignedLongScriptDocValues>>
...
==== org.elasticsearch.xpack.versionfield
<<painless-api-reference-score-org-elasticsearch-xpack-versionfield, Expand details for org.elasticsearch.xpack.versionfield>>

* <<painless-api-reference-score-VersionScriptDocValues, VersionScriptDocValues>>

[role="exclude",id="painless-api-reference-score-java-math"]
=== java.math

[[painless-api-reference-score-java-math-BigDecimal]]
==== BigDecimal
...
[[painless-api-reference-score-java-math-BigInteger]]
==== BigInteger
...
[[painless-api-reference-score-java-math-MathContext]]
==== MathContext
...
[[painless-api-reference-score-java-math-RoundingMode]]
==== RoundingMode

[role="exclude",id="painless-api-reference-score-java-text"]
=== java.text

[[painless-api-reference-score-java-text-Annotation]]
==== Annotation
...
[[painless-api-reference-score-java-text-AttributedCharacterIterator]]
...
[[painless-api-reference-score-java-text-AttributedCharacterIterator.Attribute]]
...
[[painless-api-reference-score-java-text-AttributedString]]
==== AttributedString
...
[[painless-api-reference-score-java-text-Bidi]]
==== Bidi
...
[[painless-api-reference-score-java-text-BreakIterator]]
==== BreakIterator
...
[[painless-api-reference-score-java-text-CharacterIterator]]
==== CharacterIterator
...
[[painless-api-reference-score-java-text-ChoiceFormat]]
==== ChoiceFormat
...
[[painless-api-reference-score-java-text-CollationElementIterator]]
...
[[painless-api-reference-score-java-text-CollationKey]]
==== CollationKey
...
[[painless-api-reference-score-java-text-Collator]]
==== Collator
...
[[painless-api-reference-score-java-text-DateFormat]]
==== DateFormat
...
[[painless-api-reference-score-java-text-DateFormat.Field]]
==== DateFormat.Field
...
[[painless-api-reference-score-java-text-DateFormatSymbols]]
==== DateFormatSymbols
...
[[painless-api-reference-score-java-text-DecimalFormat]]
==== DecimalFormat
...
[[painless-api-reference-score-java-text-DecimalFormatSymbols]]
...
[[painless-api-reference-score-java-text-FieldPosition]]
==== FieldPosition
...
[[painless-api-reference-score-java-text-Format]]
==== Format
* def {java11-javadoc}/java.base/java/text/Format.html#clone()[clone]()
* boolean {java11-javadoc}/java.base/java/lang/Object.html#equals(java.lang.Object)[equals](Object)
* String {java11-javadoc}/java.base/java/text/Format.html#format(java.lang.Object)[format](Object)
...
[[painless-api-reference-score-java-text-Format.Field]]
==== Format.Field
* boolean {java11-javadoc}/java.base/java/lang/Object.html#equals(java.lang.Object)[equals](Object)
* int {java11-javadoc}/java.base/java/lang/Object.html#hashCode()[hashCode]()
* String {java11-javadoc}/java.base/java/lang/Object.html#toString()[toString]()
...
[[painless-api-reference-score-java-text-MessageFormat]]
==== MessageFormat
...
[[painless-api-reference-score-java-text-MessageFormat.Field]]
==== MessageFormat.Field
...
[[painless-api-reference-score-java-text-Normalizer]]
==== Normalizer
...
[[painless-api-reference-score-java-text-Normalizer.Form]]
==== Normalizer.Form
...
[[painless-api-reference-score-java-text-NumberFormat]]
==== NumberFormat
...
[[painless-api-reference-score-java-text-NumberFormat.Field]]
==== NumberFormat.Field
...
[[painless-api-reference-score-java-text-ParseException]]
==== ParseException
...
[[painless-api-reference-score-java-text-ParsePosition]]
==== ParsePosition
...
[[painless-api-reference-score-java-text-RuleBasedCollator]]
==== RuleBasedCollator
...
[[painless-api-reference-score-java-text-SimpleDateFormat]]
==== SimpleDateFormat
...
[[painless-api-reference-score-java-text-StringCharacterIterator]]

[role="exclude",id="painless-api-reference-script-heuristic-java-util-regex"]
=== java.util.regex

[[painless-api-reference-script-heuristic-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-script-heuristic-java-util-regex-Pattern]]
==== Pattern

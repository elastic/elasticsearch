[role="exclude",id="painless-api-reference-similarity-weight-java-math"]
=== java.math

[[painless-api-reference-similarity-weight-java-math-BigDecimal]]
==== BigDecimal
...
[[painless-api-reference-similarity-weight-java-math-BigInteger]]
==== BigInteger
...
[[painless-api-reference-similarity-weight-java-math-MathContext]]
==== MathContext
...
[[painless-api-reference-similarity-weight-java-math-RoundingMode]]
==== RoundingMode

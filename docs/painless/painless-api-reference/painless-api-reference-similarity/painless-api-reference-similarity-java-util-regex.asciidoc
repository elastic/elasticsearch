[role="exclude",id="painless-api-reference-similarity-java-util-regex"]
=== java.util.regex

[[painless-api-reference-similarity-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-similarity-java-util-regex-Pattern]]
==== Pattern

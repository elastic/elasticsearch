[role="exclude",id="painless-api-reference-string-sort-java-util-regex"]
=== java.util.regex

[[painless-api-reference-string-sort-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-string-sort-java-util-regex-Pattern]]
==== Pattern

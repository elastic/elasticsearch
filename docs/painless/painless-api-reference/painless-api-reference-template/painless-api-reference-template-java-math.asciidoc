[role="exclude",id="painless-api-reference-template-java-math"]
=== java.math

[[painless-api-reference-template-java-math-BigDecimal]]
==== BigDecimal
...
[[painless-api-reference-template-java-math-BigInteger]]
==== BigInteger
...
[[painless-api-reference-template-java-math-MathContext]]
==== MathContext
...
[[painless-api-reference-template-java-math-RoundingMode]]
==== RoundingMode

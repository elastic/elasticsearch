[role="exclude",id="painless-api-reference-template-java-text"]
=== java.text

[[painless-api-reference-template-java-text-Annotation]]
==== Annotation
...
[[painless-api-reference-template-java-text-AttributedCharacterIterator]]
...
[[painless-api-reference-template-java-text-AttributedCharacterIterator.Attribute]]
...
[[painless-api-reference-template-java-text-AttributedString]]
==== AttributedString
...
[[painless-api-reference-template-java-text-Bidi]]
==== Bidi
...
[[painless-api-reference-template-java-text-BreakIterator]]
==== BreakIterator
...
[[painless-api-reference-template-java-text-CharacterIterator]]
==== CharacterIterator
...
[[painless-api-reference-template-java-text-ChoiceFormat]]
==== ChoiceFormat
...
[[painless-api-reference-template-java-text-CollationElementIterator]]
...
[[painless-api-reference-template-java-text-CollationKey]]
==== CollationKey
...
[[painless-api-reference-template-java-text-Collator]]
==== Collator
...
[[painless-api-reference-template-java-text-DateFormat]]
==== DateFormat
...
[[painless-api-reference-template-java-text-DateFormat.Field]]
==== DateFormat.Field
...
[[painless-api-reference-template-java-text-DateFormatSymbols]]
==== DateFormatSymbols
...
[[painless-api-reference-template-java-text-DecimalFormat]]
==== DecimalFormat
...
[[painless-api-reference-template-java-text-DecimalFormatSymbols]]
...
[[painless-api-reference-template-java-text-FieldPosition]]
==== FieldPosition
...
[[painless-api-reference-template-java-text-Format]]
==== Format
* def {java11-javadoc}/java.base/java/text/Format.html#clone()[clone]()
* boolean {java11-javadoc}/java.base/java/lang/Object.html#equals(java.lang.Object)[equals](Object)
* String {java11-javadoc}/java.base/java/text/Format.html#format(java.lang.Object)[format](Object)
...
[[painless-api-reference-template-java-text-Format.Field]]
==== Format.Field
* boolean {java11-javadoc}/java.base/java/lang/Object.html#equals(java.lang.Object)[equals](Object)
* int {java11-javadoc}/java.base/java/lang/Object.html#hashCode()[hashCode]()
* String {java11-javadoc}/java.base/java/lang/Object.html#toString()[toString]()
...
[[painless-api-reference-template-java-text-MessageFormat]]
==== MessageFormat
...
[[painless-api-reference-template-java-text-MessageFormat.Field]]
==== MessageFormat.Field
...
[[painless-api-reference-template-java-text-Normalizer]]
==== Normalizer
...
[[painless-api-reference-template-java-text-Normalizer.Form]]
==== Normalizer.Form
...
[[painless-api-reference-template-java-text-NumberFormat]]
==== NumberFormat
...
[[painless-api-reference-template-java-text-NumberFormat.Field]]
==== NumberFormat.Field
...
[[painless-api-reference-template-java-text-ParseException]]
==== ParseException
...
[[painless-api-reference-template-java-text-ParsePosition]]
==== ParsePosition
...
[[painless-api-reference-template-java-text-RuleBasedCollator]]
==== RuleBasedCollator
...
[[painless-api-reference-template-java-text-SimpleDateFormat]]
==== SimpleDateFormat
...
[[painless-api-reference-template-java-text-StringCharacterIterator]]

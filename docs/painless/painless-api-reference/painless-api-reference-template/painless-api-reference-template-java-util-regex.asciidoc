[role="exclude",id="painless-api-reference-template-java-util-regex"]
=== java.util.regex

[[painless-api-reference-template-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-template-java-util-regex-Pattern]]
==== Pattern

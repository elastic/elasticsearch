[role="exclude",id="painless-api-reference-terms-set-java-util-regex"]
=== java.util.regex

[[painless-api-reference-terms-set-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-terms-set-java-util-regex-Pattern]]
==== Pattern

[role="exclude",id="painless-api-reference-update-java-util-regex"]
=== java.util.regex

[[painless-api-reference-update-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-update-java-util-regex-Pattern]]
==== Pattern

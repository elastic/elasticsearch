...
[role="exclude",id="painless-api-reference-watcher-condition-org-elasticsearch-painless-api"]
=== Watcher Condition API for package org.elasticsearch.painless.api
See the <<painless-api-reference-watcher-condition, Watcher Condition API>> for a high-level overview of all packages and classes.

[[painless-api-reference-watcher-condition-Json]]
==== Json
* static String dump(def)
* static String dump(def, boolean)

[role="exclude",id="painless-api-reference-watcher-condition-java-util-regex"]
=== java.util.regex

[[painless-api-reference-watcher-condition-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-watcher-condition-java-util-regex-Pattern]]
==== Pattern

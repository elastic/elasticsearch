[role="exclude",id="painless-api-reference-xpack-template-java-math"]
=== java.math

[[painless-api-reference-xpack-template-java-math-BigDecimal]]
==== BigDecimal
...
[[painless-api-reference-xpack-template-java-math-BigInteger]]
==== BigInteger
...
[[painless-api-reference-xpack-template-java-math-MathContext]]
==== MathContext
...
[[painless-api-reference-xpack-template-java-math-RoundingMode]]
==== RoundingMode

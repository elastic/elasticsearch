[role="exclude",id="painless-api-reference-xpack-template-java-time-zone"]
=== java.time.zone

[[painless-api-reference-xpack-template-java-time-zone-ZoneOffsetTransition]]
...
[[painless-api-reference-xpack-template-java-time-zone-ZoneOffsetTransitionRule]]
...
[[painless-api-reference-xpack-template-java-time-zone-ZoneOffsetTransitionRule.TimeDefinition]]
...
[[painless-api-reference-xpack-template-java-time-zone-ZoneRules]]
==== ZoneRules
...
[[painless-api-reference-xpack-template-java-time-zone-ZoneRulesException]]
==== ZoneRulesException
...
[[painless-api-reference-xpack-template-java-time-zone-ZoneRulesProvider]]
==== ZoneRulesProvider

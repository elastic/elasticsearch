[role="exclude",id="painless-api-reference-xpack-template-java-util-regex"]
=== java.util.regex

[[painless-api-reference-xpack-template-java-util-regex-Matcher]]
==== Matcher
...
[[painless-api-reference-xpack-template-java-util-regex-Pattern]]
==== Pattern

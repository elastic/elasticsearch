...
Both string datetimes and complex datetimes have a modifiable timezone with a
default of `UTC`. Numeric datetimes do not have enough explicit information to
...
[source,Painless]
----
if (doc.containsKey('start_datetime') &&
        doc.containsKey('end_datetime')) { <1>

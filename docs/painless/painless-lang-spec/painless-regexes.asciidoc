...
WARNING: A poorly written regular expression can significantly slow search speed
and other operations. If possible, avoid using regular expressions, particularly
in frequently run scripts.

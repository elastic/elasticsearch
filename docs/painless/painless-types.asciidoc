...
<1> declare `int i`;
    assign `int 1` to `i`
<2> declare `double d`;
    assign the default value `double 0.0` to `d`
<3> declare `boolean b`;
...
<1> declare `int i`;
    assign `int 1` to `i`
<2> box `i` to `Integer`;
    return `String '1'` from call `toString`
...
<1> declare `List l`;
    ...
    assign to `l`
<2> call `add` on `l` with arguments `(box int 1)`
<3> declare `int i`;
    return `Integer 1` from call `get` on `l` with arguments `(int 0)`;
    unbox Integer `1`;
    add `int 1` and `int 2`;
    assign to `i`
+
...
<1> declare `List l0`;
    ...
    assign to `l0`
<2> declare `List l1`;
    assign shallow-copy of `l0` to `l1`
<3> call `add` on `l0` with arguments `(box int 1)`
<4> call `add` on `l1` with arguments `(box int 2)`
<5> note `l0` and `l1` refer to the same reference type instance;
    return `Integer 1` from call `get` on `l1` with arguments `(int 0)`;
    unbox `Integer 1`;
    return `Integer 2` from call get` on `l0` with arguments `(int 1)`;
    unbox `Integer 2`;
    add `int 1` and `int 2`;
    assign to `i`;
+

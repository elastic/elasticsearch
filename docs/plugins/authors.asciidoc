...
* a https://github.com/elastic/elasticsearch/tree/2.4/plugins/site-example[site plugin]
...
https://github.com/elastic/elasticsearch/blob/2.4/dev-tools/src/main/resources/plugin-metadata/plugin-descriptor.properties[`dev-tools/src/main/resources/plugin-metadata/plugin-descriptor.properties`].
...
instance, see
https://github.com/elastic/elasticsearch/blob/2.4/plugins/site-example/pom.xml[`plugins/site-example/pom.xml`].

...
* a https://github.com/elastic/elasticsearch/tree/2.0/plugins/site-example[site plugin]
...
instance, see
https://github.com/elastic/elasticsearch/blob/2.0/plugins/site-example/pom.xml[`plugins/site-example/pom.xml`].

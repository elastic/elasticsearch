...
* a https://github.com/elastic/elasticsearch/tree/2.x/plugins/site-example[site plugin]
...
instance, see
https://github.com/elastic/elasticsearch/blob/2.x/plugins/site-example/pom.xml[`plugins/site-example/pom.xml`].

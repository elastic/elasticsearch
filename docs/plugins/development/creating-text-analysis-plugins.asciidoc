...
You can also create text analysis plugins using the method described in
...
easier to develop and package plugins. The steps in this section assume you use this 

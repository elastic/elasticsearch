...
wget https://download.elasticsearch.org/elasticsearch/elasticsearch/elasticsearch-2.0.0.deb # TODO this obviously isn't correct
...
sudo dpkg -i elasticsearch-2.0.0.deb # TODO this obviously isn't correct
--------------------------------------------------

...
`properties` field. Note that you can use wildcards. If you want to extract all raw metadata but not any of the
fixed ones, you can simply set `"properties": [ "*" ]`.

If you also want to combine that with the fixed ones, add the ones you want to use:

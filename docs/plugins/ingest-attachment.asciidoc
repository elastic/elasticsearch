...
| `resource_name`        | no        |                  | The field containing the name of the resource to be decoded. If supplied, this is provided to
                                                          the underlying Tika library to enable https://tika.apache.org/1.24.1/detection.html#Resource_Name_Based_Detection[Resource Name Based Detection].
|======

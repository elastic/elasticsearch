...
The script processor allows you to have scripted fields when indexing documents. So you could easily add two fields or do complex calculations
beofre a document is indexed, instead of doing this on query time.

include::ingest-attachment.asciidoc[]

include::ingest-geoip.asciidoc[]

include::ingest-script.asciidoc[]

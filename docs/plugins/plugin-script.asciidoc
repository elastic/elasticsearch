...
[source,shell]
-----------------------------------
sudo bin/elasticsearch-plugin install https://<EXAMPLE_PLUGIN_HOST_URL>/plugin.zip
-----------------------------------
+
...
[source,shell]
-----------------------------------
sudo CLI_JAVA_OPTS="-Djavax.net.ssl.trustStore=/path/to/trustStore.jks" bin/elasticsearch-plugin install https://<MY_HOST_URL>/plugin.zip
-----------------------------------
--

...
=== Azure repository: Client settings

include::redirects.asciidoc[tag=azure-repo-migration]

[role="exclude",id="repository-azure-repository-settings"]
=== Azure repository: Repository settings

include::redirects.asciidoc[tag=azure-repo-migration]

[role="exclude",id="repository-azure-validation"]
=== Azure repository: Repository validation rules
...
=== Google Cloud Storage repository plugin: Getting started

include::redirects.asciidoc[tag=gcs-repo-migration]

[role="exclude",id="repository-gcs-client"]
=== Google Cloud Storage repository plugin: Client settings

include::redirects.asciidoc[tag=gcs-repo-migration]

[role="exclude",id="repository-gcs-repository"]
=== Google Cloud Storage repository plugin: Repository settings

...
To enable Azure repositories, you have first to set your azure storage settings in `elasticsearch.yaml` file:
...
# With two accounts defined in elasticsearch.yaml (my_account1 and my_account2)

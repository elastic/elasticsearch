...
If you are using any S3 api compatible service, you can set a global endpoint by setting `s3.client.default.endpoint` to your URL provider. Note that this setting will be used for all S3 repositories.

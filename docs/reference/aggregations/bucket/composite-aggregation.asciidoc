...
Like the `terms` aggregation it is also possible to use a
<<runtime,runtime field>> to create the values for the composite buckets:
...
Like the `histogram` aggregation it is also possible to use a
<<runtime,runtime field>> to create the values for the composite buckets:

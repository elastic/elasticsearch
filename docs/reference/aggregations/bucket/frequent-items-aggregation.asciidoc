...
calculated from the texful total price of the individual transactions. The 
runtime field then can be used in the frequent items aggfregation as a field to 
analyze.

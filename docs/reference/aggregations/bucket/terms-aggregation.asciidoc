...
`terms` aggregation. If your data has a lot of unique terms and you need them
all, use the
...
In an effort to get more accurate results the `terms` agg fetches more than
...
You can increase `shard_size` to improve the accuracy of the selection of top
terms to help in these disparate doc counts. It is much cheaper to increase

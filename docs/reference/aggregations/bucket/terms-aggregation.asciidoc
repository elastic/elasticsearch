...
If your data doesn't contain many unique terms, you can increase the `size` of
the `terms` aggregation to return them all. If your data has a lot of unique
terms and you need them all, use the

...
It turned out that the exam was way above the level of the students and a grade correction needs to be applied. We can average a <<runtime,runtime field>> to get a corrected average:

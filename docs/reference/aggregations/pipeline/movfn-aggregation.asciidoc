            ...
            "aggs":{
                ...
                "the_movavg": {
                    "moving_fn": {
                        "buckets_path": "the_sum",
                        "window": 10,
                        "script": "return values.toArray().length > 0 ? values.toArray()[0] : Double.NaN"
                    }
                }
            }
        }
            ...
            "aggs":{
                ...
                "the_moving_sum": {
                    "moving_fn": {
                        "buckets_path": "the_sum",
                        "window": 10,
                        "script": "MovingFunctions.windowStdDev(values, MovingFunctions.simpleMovAvg(values))"
                    }
                }
            }
        }

...
// tag::alias-multiple-actions-result-example[]
  ...
  "action_results": [
    {
      "action": "remove",
      "success": false,
      "error": "aliases_not_found_exception"
    },
    {
      "action": "add",
      "success": true
...
It may be more appropriate to use set `must_exist` to `true`, which will cause the entire action

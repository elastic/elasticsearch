...
TIP: We typically recommend using data streams to store time series data.
However, data streams are append-only. If you often need to update or delete
documents, you can use an index alias instead. See

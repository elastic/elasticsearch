...
TIP: We recommend using data streams to store append-only timestamped data. If
you frequently update or delete existing timestamped data, use an index alias

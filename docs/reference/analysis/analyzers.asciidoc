...
from the built in character filters, tokenizers, and token filters. There are 
also a number of https://github.com/elastic?query=elasticsearch-analysis[Elasticsearch analysis plugins] that add specialized text analysis options.

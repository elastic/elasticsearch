...
See the link:https://github.com/elastic/elasticsearch/blob/master/docs/reference/analysis/analyzers/stop-analyzer-language-support.asciidoc[Stop Analyzer Language Support] for more information about supported stop word languages

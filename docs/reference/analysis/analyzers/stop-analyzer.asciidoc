...
See the <<supported-stop-words>> for supported languages with links
to default stop words.
...
=== Supported stop words by language

include::stop-analyzer-language-support.asciidoc[]

...
The synonym file path needs to be included as part of your token filter using `synonyms_path` configuration:
...
Synonyms can be directly included in your token filter using the `synonyms` configuration:

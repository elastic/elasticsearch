...
beginning or end of a token. Replacement substrings can reference capture groups
from original token text using Java's
https://docs.oracle.com/javase/8/docs/api/java/util/regex/Matcher.html#appendReplacement-java.lang.StringBuffer-java.lang.String-[`$` reserved character].

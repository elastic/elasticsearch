...
https://lucene.apache.org/core/{lucene_version_path}/analyzers-common/org/apache/lucene/analysis/path/PathHierarchyTokenizer.html[PathHierarchyTokenizer]
underneath.
...
`reverse`::
    ...
    http://lucene.apache.org/core/{lucene_version_path}/analyzers-common/org/apache/lucene/analysis/path/ReversePathHierarchyTokenizer.html[ReversePathHierarchyTokenizer],

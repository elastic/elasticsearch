...
Date math name resolution lets you dynamically search a range of resources, such
as data streams or indices, that include a time or date component in their name.

For indices, this is a useful alternative to maintaining an index alias or
searching all indices in a cluster and filtering the results.

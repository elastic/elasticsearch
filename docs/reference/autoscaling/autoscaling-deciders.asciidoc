...
<<autoscaling-dedicated-masters-decider,Dedicated master nodes decider>>::
Computes whether or not dedicated masters are needed in the current cluster configuration.
...
include::deciders/dedicated-masters-decider.asciidoc[]

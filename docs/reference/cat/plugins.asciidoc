...
U7321H6 discovery-azure-arm     {version_qualified} The Azure ARM Discovery plugin allows to use Azure Resources Management API for the unicast discovery mechanism

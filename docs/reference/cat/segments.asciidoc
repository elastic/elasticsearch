...
--------------------------------------------------
index shard prirep ip        segment generation docs.count docs.deleted size committed searchable version compound
test  0     p      127.0.0.1 _0               0          1            0  3kb     false     true       {lucene_version}   true
test1 0     p      127.0.0.1 _0               0          1            0  3kb     false     true       {lucene_version}   true
--------------------------------------------------
// TESTRESPONSE[s/3kb/\\d+(\\.\\d+)?[mk]?b/ non_json]

[testenv="platinum"]
[[follow-request-body-settings]]`settings`::
...
[[follow-request-body-max_read_request_operation_count]]`max_read_request_operation_count`::
  (integer) The maximum number of operations to pull per read from the remote
  cluster.

[[follow-request-body-max_outstanding_read_requests]]`max_outstanding_read_requests`::
  (long) The maximum number of outstanding reads requests from the remote
  cluster.

[[follow-request-body-max_read_request_size]]`max_read_request_size`::
  (<<byte-units,byte value>>) The maximum size in bytes of per read of a batch
  of operations pulled from the remote cluster.

[[follow-request-body-max_write_request_operation_count]]`max_write_request_operation_count`::
  (integer) The maximum number of operations per bulk write request executed on
  the follower.

[[follow-request-body-max_write_request_size]]`max_write_request_size`::
  (<<byte-units,byte value>>) The maximum total bytes of operations per bulk write request
  executed on the follower.

[[follow-request-body-max_outstanding_write_requests]]`max_outstanding_write_requests`::
  (integer) The maximum number of outstanding write requests on the follower.

[[follow-request-body-max_write_buffer_count]]`max_write_buffer_count`::
...
[[follow-request-body-max_write_buffer_size]]`max_write_buffer_size`::
...
[[follow-request-body-max_retry_delay]]`max_retry_delay`::
...
[[follow-request-body-read_poll_timeout]]`read_poll_timeout`::

...
(long) Total document count difference between leader and follower indices
...
`follower_docs_count`::
(long) The number of docs on the follower shard

`leader_docs_count`::
(long) The number of docs on the leader shard
=====
//End shards
====
//End indices
...
// TESTRESPONSE[s/"follower_docs_count" : 0/"follower_docs_count" : $body.indices.0.shards.0.follower_docs_count/]
// TESTRESPONSE[s/"leader_docs_count" : 0/"leader_docs_count" : $body.indices.0.shards.0.leader_docs_count/]

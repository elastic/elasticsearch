    ...
    "indices" : [
      {
        ...
        "follower_to_leader_lagging_docs_count" : 0,
        "shards" : [
          {
            "remote_cluster" : "remote_cluster",
            "leader_index" : "leader_index",
...
// TESTRESPONSE[s/"follower_docs_count" : 0/"follower_docs_count" : $body.follow_stats.indices.0.shards.0.follower_docs_count/]
// TESTRESPONSE[s/"leader_docs_count" : 0/"leader_docs_count" : $body.follow_stats.indices.0.shards.0.leader_docs_count/]

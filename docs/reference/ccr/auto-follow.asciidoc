...
To pause and resume replication of auto-follow pattern collections, access {kib} on your _local_ cluster and go to *Management -> Stack Management*. In
...
To delete an auto-follow pattern collection, access {kib} on your _local_
cluster and go to *Management -> Stack Management*. In the left navigation,

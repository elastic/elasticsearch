[[cluster-allocation-explain-examples]]
=== Cluster allocation explain API examples
++++
<titleabbrev>Cluster allocation explain examples</titleabbrev>
++++

The following examples showcase the use of the <<cluster-allocation-explain>> 
API.

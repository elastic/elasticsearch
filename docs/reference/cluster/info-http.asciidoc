...
=== HTTP stats API
++++
<titleabbrev>HTTP stats</titleabbrev>
++++

Returns cluster HTTP statistics.

[[cluster-http-stats-api-request]]
==== {api-request-title}

`GET /_info/http` +

[[cluster-http-stats-api-prereqs]]
==== {api-prereq-title}
...
[[cluster-http-stats-api-desc]]
==== {api-description-title}

You can use the cluster HTTP stats API to retrieve https statistics in a cluster.

[role="child_attributes"]
[[cluster-http-stats-api-response-body]]
...
[[cluster-http-stats-api-response-body-http]]
`http`::
(object)
...
[[cluster-http-stats-api-example]]
==== {api-examples-title}

[source,console]
----
# returns the http stats of the cluster
GET /_info/http
----

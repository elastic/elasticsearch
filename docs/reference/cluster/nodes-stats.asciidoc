...
--
  ...
  `repository`::
      Statistics about read/write throttling in underlying repositories.
...
[[cluster-nodes-stats-api-response-body-repository]]
`repository`::
(object)
Contains throttling statistics for all repositories for the node.
+

...
(<<byte-units,byte value>>)
Estimated overhead size of mappings.

`total_estimated_overhead_in_bytes`::
(integer)
Estimated overhead size, in bytes, of mappings.
=======

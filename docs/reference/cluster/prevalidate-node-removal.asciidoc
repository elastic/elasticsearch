...
--
    ...
    * `contains_red_shard_copy`: The node might contain shard copies of some the red indices. The list of the shards that might be on the node are specified in the `message` field.
--
`message`::
...
--------------------------------------------------
{
  ...
  "nodes": [
    ...
    },
    {
      ...
      "result" : {
        "is_safe": false,
        "reason": "contains_red_shard_copy",

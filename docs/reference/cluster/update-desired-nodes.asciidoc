...
[source,console]
--------------------------------------------------
PUT /_cluster/desired_nodes/<history_id>/<version>
{
    "nodes" : [
        {
            "settings" : {
...
[[update-desired-nodes-api-examples]]
==== {api-examples-title}

In this example, desired nodes

[source,console]
--------------------------------------------------
PUT /_cluster/desired_nodes/Ywkh3INLQcuPT49f6kcppA/100
{
    "nodes" : [
        {
            "settings" : {

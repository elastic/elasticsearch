...
Returns and changes cluster-wide settings. 
...
defined, but can also <<cluster-get-settings,include the default settings>>.

Updates to settings can be persistent, meaning they apply across restarts, or 

...
`<hard>`::
(Optional, boolean) If `true`, the connector doc is deleted. If `false`, connector doc is marked as deleted but doc stays in index (soft deletion). Defaults to `false`.

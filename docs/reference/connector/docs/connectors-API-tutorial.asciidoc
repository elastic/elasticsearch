...
* <<mongodb-start,Elastic hosted connector tutorial>>. Set up a native MongoDB connector, fully managed in Elastic Cloud.
* <<postgresql-connector-client-tutorial,self-managed connector tutorial>>. Set up a self-managed PostgreSQL connector.
====

[discrete#connectors-tutorial-api-prerequisites]
==== Prerequisites
...
[discrete#connectors-tutorial-api-setup-es]
==== Set up {es}
...
[discrete#connectors-tutorial-api-setup-postgres]
...
[discrete#connectors-tutorial-api-create-connector]
==== Create a connector
...
[discrete#connectors-tutorial-api-deploy-connector]
...
[discrete#connectors-tutorial-api-create-api-key]
===== Create an API key
...
[discrete#connectors-tutorial-api-prepare-configuration-file]
...
[discrete#connectors-tutorial-api-run-connector-service]
...
[discrete#connectors-tutorial-api-update-connector-configuration]
==== Configure connector
...
[discrete#connectors-tutorial-api-sync]
==== Sync data
...
[discrete#connectors-tutorial-api-check-sync-status]
===== Check sync status
...
[discrete#connectors-tutorial-api-troubleshooting]
=== Troubleshooting
...
[discrete#connectors-tutorial-api-cleanup]
==== Cleaning up
...
[discrete#connectors-tutorial-api-next-steps]
==== Next steps

...
The _Elastic Google Drive connector_ is a <<connectors,connector>> for https://www.google.com/drive[Google Drive^].
...
[discrete#connectors-google-drive-native-connector-reference]
...
[discrete#connectors-google-drive-availability-and-prerequisites]
...
[discrete#connectors-google-drive-usage]
=== Usage
...
[discrete#connectors-google-drive-connector-authentication-prerequisites]
...
[discrete#connectors-google-drive-additional-prerequisites-for-domain-wide-delegation]
...
[discrete#connectors-google-drive-configuration]
=== Configuration
...
[discrete#connectors-google-drive-documents-and-syncs]
=== Documents and syncs
...
You must first enable <<connectors-google-drive-document-level-security,DLS>>.
...
[discrete#connectors-google-drive-sync-types]
==== Sync types
...
[discrete#connectors-google-drive-sync-rules]
=== Sync rules
...
[discrete#connectors-google-drive-document-level-security]
=== Document level security

Document level security (DLS) enables you to restrict access to documents based on a user’s permissions.
Refer to <<connectors-google-drive-configuration,configuration>> on this page for how to enable DLS for this connector.
...
[discrete#connectors-google-drive-content-extraction]
=== Content extraction

See <<connectors-content-extraction>> for more information.

[discrete#connectors-google-drive-known-issues]
=== Known issues

There are currently no known issues for this connector.

[discrete#connectors-google-drive-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-google-drive-security]
=== Security
...
[discrete#connectors-google-drive-connector-client-reference]
...
[discrete#connectors-google-drive-client-availability-and-prerequisites]
=== Availability and prerequisites

This connector is available as a self-managed *connector client*. To use this connector, satisfy all <<build-connector,connector client requirements>>.

[discrete#connectors-google-drive-client-usage]
=== Usage

To use this connector as a *connector client*, see <<build-connector>>
For additional usage operations, see <<connectors-usage>>.

[discrete#connectors-google-drive-client-connector-authentication-prerequisites]
=== Connector authentication prerequisites
...
[discrete#connectors-google-drive-client-additional-prerequisites-for-domain-wide-delegation]
==== Additional authentication prerequisites for domain-wide delegation
...
[discrete#connectors-google-drive-client-configuration]
=== Configuration

[TIP]
====
When using the <<build-connector, connector client>> workflow, initially these fields will use the default configuration set in the {connectors-python}/connectors/sources/google_drive.py[connector source code^].
...
[discrete#connectors-google-drive-client-deployment-using-docker]
=== Deployment using Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-google-drive-client-documents-and-syncs]
=== Documents and syncs
...
* Permissions are not synced by default.
You must first enable <<connectors-google-drive-client-document-level-security,DLS>>.
Otherwise, *all documents* indexed to an Elastic deployment will be visible to *all users with access* to that Elastic Deployment.
====

[discrete#connectors-google-drive-client-sync-types]
==== Sync types
...
[discrete#connectors-google-drive-client-sync-rules]
=== Sync rules
...
[discrete#connectors-google-drive-client-document-level-security]
=== Document level security

Document level security (DLS) enables you to restrict access to documents based on a user’s permissions.
Refer to <<connectors-google-drive-client-configuration,configuration>> on this page for how to enable DLS for this connector.
...
[discrete#connectors-google-drive-client-content-extraction]
=== Content extraction

See <<connectors-content-extraction>> for more information.

[discrete#connectors-google-drive-client-end-to-end-testing]
=== End-to-end testing

The connector framework enables operators to run functional tests against a real data source. Refer to <<build-connector-testing>> for more details.
...
[discrete#connectors-google-drive-client-known-issues]
=== Known issues

There are currently no known issues for this connector.

[discrete#connectors-google-drive-client-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-google-drive-client-security]
=== Security

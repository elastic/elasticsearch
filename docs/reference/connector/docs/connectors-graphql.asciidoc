...
[discrete#connectors-graphql-connector-availability-and-prerequisites]
...
[discrete#connectors-graphql-connector-usage]
== Usage
...
[discrete#connectors-graphql-connector-docker]
== Deploy with Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-graphql-connector-configuration]
== Configuration

[discrete#connectors-graphql-connector-configure-graphql-connector]
...
[discrete#connectors-graphql-connector-documents-and-syncs]
== Documents and syncs

The connector syncs the objects and entities based on GraphQL Query and GraphQL Object List.

[discrete#connectors-graphql-connector-sync-types]
== Sync types

https://www.elastic.co/guide/en/enterprise-search/current/connectors-sync-types.html#connectors-sync-types-full[Full syncs] are supported by default for all connectors.

This connector currently does not support https://www.elastic.co/guide/en/enterprise-search/current/connectors-sync-types.html#connectors-sync-types-incremental[incremental syncs].

[discrete#connectors-graphql-connector-sync-rules]
== Sync rules
...
[discrete#connectors-graphql-connector-advanced-sync-rules]
== Advanced Sync Rules

Advanced sync rules are not available for this connector in the present version.

[discrete#connectors-graphql-connector-connector-client-operations]
== Connector Client operations

[discrete#connectors-graphql-connector-end-to-end-testing]
=== End-to-end Testing
...
[discrete#connectors-graphql-connector-known-issues]
== Known issues
...
[discrete#connectors-graphql-connector-troubleshooting]
== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-graphql-connector-security]
== Security

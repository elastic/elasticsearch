...
The _Elastic Jira connector_ is a <<connectors,connector>> for https://www.atlassian.com/software/jira[Atlassian Jira^].
...
[discrete#connectors-jira-native-connector-reference]
...
[discrete#connectors-jira-availability-prerequisites]
...
[discrete#connectors-jira-create-native-connector]
=== Create a {service-name} connector
include::_connectors-create-native.asciidoc[]

[discrete#connectors-jira-usage]
=== Usage
...
[discrete#connectors-jira-compatability]
=== Compatibility

* Jira Cloud, Jira Server, and Jira Data Center *versions 7 or later*.

[discrete#connectors-jira-configuration]
=== Configuration
...
[discrete#connectors-jira-documents-syncs]
=== Documents and syncs
...
You must first enable <<connectors-jira-document-level-security,DLS>>.
...
[discrete#connectors-jira-sync-types]
==== Sync types
...
[discrete#connectors-jira-sync-rules]
=== Sync rules
...
[discrete#connectors-jira-sync-rules-examples]
...
[discrete#connectors-jira-document-level-security]
=== Document level security

Document level security (DLS) enables you to restrict access to documents based on a user’s permissions.
Refer to <<connectors-jira-configuration,configuration>> on this page for how to enable DLS for this connector.
...
[discrete#connectors-jira-content-extraction]
=== Content Extraction

See <<connectors-content-extraction>>.

[discrete#connectors-jira-known-issues]
=== Known issues
...
[discrete#connectors-jira-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-jira-security]
=== Security
...
[discrete#connectors-jira-connector-client-reference]
...
[discrete#connectors-jira-client-availability-prerequisites]
=== Availability and prerequisites
...
[discrete#connectors-jira-create-connector-client]
=== Create a {service-name} connector
include::_connectors-create-client.asciidoc[]

[discrete#connectors-jira-client-usage]
=== Usage

To use this connector as a *connector client*, see <<build-connector>>
For additional usage operations, see <<connectors-usage>>.

[discrete#connectors-jira-client-compatability]
=== Compatibility

* Jira Cloud, Jira Server, and Jira Data Center *versions 7 or later*.

[discrete#connectors-jira-client-configuration]
=== Configuration

[TIP]
====
When using the <<build-connector, connector client>> workflow, initially these fields will use the default configuration set in the {connectors-python}/connectors/sources/jira.py[connector source code^].
...
[discrete#connectors-jira-client-docker]
=== Deployment using Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-jira-client-documents-syncs]
=== Documents and syncs
...
* Permissions are not synced by default.
You must first enable <<connectors-jira-client-document-level-security,DLS>>.
Otherwise, *all documents* indexed to an Elastic deployment will be visible to *all users with access* to that Elastic Deployment.
====

[discrete#connectors-jira-client-sync-types]
==== Sync types
...
[discrete#connectors-jira-client-sync-rules]
=== Sync rules
...
[discrete#connectors-jira-client-sync-rules-examples]
==== Advanced sync rules example
...
[discrete#connectors-jira-client-document-level-security]
=== Document level security

Document level security (DLS) enables you to restrict access to documents based on a user’s permissions.
Refer to <<connectors-jira-client-configuration,configuration>> on this page for how to enable DLS for this connector.
...
[discrete#connectors-jira-client-content-extraction]
=== Content Extraction

See <<connectors-content-extraction>>.

[discrete#connectors-jira-client-connector-client-operations]
=== Connector client operations

[discrete#connectors-jira-client-testing]
=== End-to-end testing
...
[discrete#connectors-jira-client-known-issues]
=== Known issues
...
[discrete#connectors-jira-client-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-jira-client-security]
=== Security

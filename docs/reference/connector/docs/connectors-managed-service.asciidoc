...
You can convert a hosted connector to a self-managed self-managed connector to be run on your own infrastructure.
You'll find instructions in the UI on the connector index's overview page.

[WARNING]
====
Converting a hosted connector to a self-managed self-managed connector is an irreversible operation!
====

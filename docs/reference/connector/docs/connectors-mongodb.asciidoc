...
The _Elastic MongoDB connector_ is a <<connectors,connector>> for https://www.mongodb.com[MongoDB^] data sources.
...
[discrete#connectors-mongodb-native-connector-reference]
...
[discrete#connectors-mongodb-prerequisites]
...
[discrete#connectors-mongodb-compatibility]
=== Compatibility
...
[discrete#connectors-mongodb-configuration]
=== Configuration
...
[discrete#connectors-mongodb-create-native-connector]
=== Create a {service-name} connector
include::_connectors-create-native.asciidoc[]

[discrete#connectors-mongodb-usage]
=== Usage
...
[discrete#connectors-mongodb-example]
=== Example

An example is available for this connector.
See <<mongodb-start>>.

[discrete#connectors-mongodb-known-issues]
=== Known issues

[discrete#connectors-mongodb-known-issues-ssl-tls-812]
...
[discrete#connectors-mongodb-known-issues-expressions-and-variables-in-aggregation-pipelines]
...
[discrete#connectors-mongodb-known-issues-tls-with-invalid-cert]
...
[discrete#connectors-mongodb-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-mongodb-security]
=== Security

See <<connectors-security>>.

[discrete#connectors-mongodb-syncs]
=== Documents and syncs
...
[discrete#connectors-mongodb-sync-rules]
=== Sync rules
...
<<sync-rules-advanced,Advanced rules>> for MongoDB can be used to express either `find` queries or aggregation pipelines.
They can also be used to tune options available when issuing these queries/pipelines.

[discrete#connectors-mongodb-sync-rules-find]
==== `find` queries
...
[discrete#connectors-mongodb-sync-rules-aggregation]
...
[discrete#connectors-mongodb-migration-from-ruby]
...
If your MongoDB connector stopped working after migrating from 8.7.x to 8.8.x, read the workaround outlined in <<connectors-known-issues>>.
...
[discrete#connectors-mongodb-connector-client-reference]
...
[discrete#connectors-mongodb-client-prerequisites]
=== Availability and prerequisites
...
[discrete#connectors-mongodb-client-compatibility]
=== Compatibility
...
[discrete#connectors-mongodb-client-configuration]
=== Configuration
...
[discrete#connectors-mongodb-create-connector-client]
=== Create a {service-name} connector
include::_connectors-create-client.asciidoc[]

[discrete#connectors-mongodb-client-usage]
=== Usage

To use this connector as a *connector client*, see <<build-connector>>
For additional usage operations, see <<connectors-usage>>.

[discrete#connectors-mongodb-client-example]
=== Example

An example is available for this connector.
See <<mongodb-start>>.

[discrete#connectors-mongodb-client-known-issues]
=== Known issues

[discrete#connectors-mongodb-client-known-issues-ssl-tls-812]
==== SSL must be enabled for MongoDB Atlas
...
[discrete#connectors-mongodb-client-known-issues-expressions-and-variables-in-aggregation-pipelines]
==== Expressions and variables in aggregation pipelines
...
[discrete#connectors-mongodb-client-known-issues-tls-with-invalid-cert]
==== Connecting with self-signed or custom CA TLS Cert
...
[discrete#connectors-mongodb-known-issues-docker-image-fails]
...
** This bug does not affect native connectors.

See <<connectors-known-issues>> for any issues affecting all connectors.

[discrete#connectors-mongodb-client-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-mongodb-client-security]
=== Security

See <<connectors-security>>.

[discrete#connectors-mongodb-client-docker]
=== Deployment using Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-mongodb-client-syncs]
=== Documents and syncs
...
[discrete#connectors-mongodb-client-sync-rules]
=== Sync rules
...
[discrete#connectors-mongodb-client-sync-rules-find]
==== `find` queries
...
[discrete#connectors-mongodb-client-sync-rules-aggregation]
==== Aggregation pipelines
...
[discrete#connectors-mongodb-client-migration-from-ruby]
=== Migrating from the Ruby connector framework

...
The _Elastic Microsoft SQL connector_ is a <<connectors,connector>> for https://learn.microsoft.com/en-us/sql/[Microsoft SQL^] databases.
...
[discrete#connectors-ms-sql-native-connector-reference]
...
[discrete#connectors-ms-sql-availability-prerequisites]
=== Availability and prerequisites

This connector is available as a *native connector* in Elastic versions *8.8.0 and later*.
...
[discrete#connectors-{service_type}-create-native-connector]
=== Create a {service-name} connector
include::_connectors-create-native.asciidoc[]

[discrete#connectors-ms-sql-usage]
=== Usage

To use this connector as a *native connector*, use the *Connector* workflow.
...
[discrete#connectors-ms-sql-compatability]
=== Compatibility
...
[discrete#connectors-ms-sql-configuration]
=== Configuration
...
[discrete#connectors-ms-sql-documents-syncs]
=== Documents and syncs
...
[discrete#connectors-ms-sql-sync-rules]
=== Sync rules

<<sync-rules-basic,Basic sync rules>> are identical for all connectors and are available by default.
For more information read <<sync-rules-types,sync rules>>.

[discrete#connectors-ms-sql-sync-rules-advanced]
==== Advanced sync rules
...
[discrete#connectors-ms-sql-sync-rules-advanced-queries]
===== Example: Two queries
...
[discrete#connectors-ms-sql-sync-rules-example-one-where]
...
[discrete#connectors-ms-sql-sync-rules-example-one-join]
...
[discrete#connectors-ms-sql-connector-client-reference]
...
[discrete#connectors-ms-sql-client-availability-prerequisites]
=== Availability and prerequisites
...
[discrete#connectors-{service_type}-create-connector-client]
=== Create a {service-name} connector
include::_connectors-create-client.asciidoc[]

[discrete#connectors-ms-sql-client-usage]
=== Usage
...
[discrete#connectors-ms-sql-client-compatability]
=== Compatibility
...
[discrete#connectors-ms-sql-client-configuration]
=== Configuration

[TIP]
====
When using the <<build-connector, connector client>> workflow, initially these fields will use the default configuration set in the {connectors-python}/connectors/sources/generic_database.py[connector source code^].
...
[discrete#connectors-ms-sql-client-docker]
=== Deployment using Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-ms-sql-client-documents-syncs]
=== Documents and syncs
...
[discrete#connectors-ms-sql-client-sync-rules]
=== Sync rules

<<sync-rules-basic,Basic sync rules>> are identical for all connectors and are available by default.
For more information read <<sync-rules-types,sync rules>>.

[discrete#connectors-ms-sql-client-sync-rules-advanced]
==== Advanced sync rules
...
[discrete#connectors-ms-sql-client-sync-rules-advanced-queries]
===== Example: Two queries
...
[discrete#connectors-ms-sql-client-sync-rules-example-one-where]
===== Example: One WHERE query
...
[discrete#connectors-ms-sql-client-sync-rules-example-one-join]
===== Example: One JOIN query
...
[discrete#connectors-ms-sql-client-client-operations-testing]
=== End-to-end testing
...
[discrete#connectors-ms-sql-client-known-issues]
=== Known issues

There are no known issues for this connector.
See <<connectors-known-issues>> for any issues affecting all connectors.

[discrete#connectors-ms-sql-client-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-ms-sql-client-security]
=== Security

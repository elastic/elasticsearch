...
*******************************
Are you using a managed connector on Elastic Cloud or a self-managed self-managed connector? Expand the documentation based on your deployment method.
*******************************
...
==== *Managed connector (Elastic Cloud)*

.View *managed connector* reference
...
==== *Self-managed connector (self-managed)*

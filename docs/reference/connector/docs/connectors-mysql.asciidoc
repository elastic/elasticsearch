...
The _Elastic MySQL connector_ is a <<connectors,connector>> for https://www.mysql.com[MySQL^] data sources.
...
[discrete#connectors-mysql-native-connector-reference]
...
[discrete#connectors-mysql-prerequisites]
=== Availability and prerequisites

This connector is available as a *native connector* in Elastic versions *8.5.0 and later*.
...
[discrete#connectors-mysql-compatibility]
=== Compatibility
...
[discrete#connectors-mysql-create-native-connector]
=== Create a {service-name} connector
include::_connectors-create-native.asciidoc[]

[discrete#connectors-mysql-usage]
=== Usage
...
[discrete#connectors-mysql-configuration]
=== Configuration
...
[discrete#connectors-mysql-known-issues]
=== Known issues
...
The auxilliary information needed for the configuration will then be automatically added by by the connector client.
+
[source,console]
----
...
[discrete#connectors-mysql-syncs]
=== Documents and syncs

The following describes the default syncing behavior for this connector.
Use <<sync-rules,sync rules>> and {ref}/ingest-pipeline-search.html[ingest pipelines] to customize syncing for specific indices.
...
[discrete#connectors-mysql-sync-rules]
=== Sync rules
...
<<sync-rules-advanced,Advanced rules>> for MySQL can be used to pass arbitrary SQL statements to a MySQL instance.
...
[discrete#connectors-mysql-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-mysql-security]
=== Security
...
[discrete#connectors-mysql-connector-client-reference]
...
[discrete#connectors-mysql-client-prerequisites]
=== Availability and prerequisites

This connector is available as a *native connector* in Elastic versions *8.5.0 and later*.
To use this connector natively in Elastic Cloud, satisfy all <<native-connectors,native connector requirements>>.

This connector is also available as a *connector client* from the *Elastic connector framework*.
To use this connector as a connector client, satisfy all <<build-connector,connector client requirements>>.

This connector has no additional prerequisites beyond the shared requirements, linked above.

[discrete#connectors-mysql-create-connector-client]
=== Create a {service-name} connector
include::_connectors-create-client.asciidoc[]

[discrete#connectors-mysql-client-usage]
=== Usage
...
[discrete#connectors-mysql-client-compatibility]
=== Compatibility
...
[discrete#connectors-mysql-client-configuration]
=== Configuration
...
[discrete#connectors-mysql-client-known-issues]
=== Known issues
...
[discrete#connectors-mysql-client-syncs]
=== Documents and syncs
...
[discrete#connectors-mysql-client-docker]
=== Deployment using Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-mysql-client-sync-rules]
=== Sync rules
...
[discrete#connectors-mysql-client-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-mysql-client-security]
=== Security

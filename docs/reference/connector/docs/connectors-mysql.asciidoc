...
To use this connector natively in Elastic Cloud, satisfy all <<es-native-connectors,native connector requirements>>.
...
To use this connector as a connector client, satisfy all <<es-build-connector,connector client requirements>>.
...
To use this connector as a *connector client*, see <<es-build-connector>>.

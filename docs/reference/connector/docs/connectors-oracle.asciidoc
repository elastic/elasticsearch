...
[discrete#connectors-oracle-native-connector-reference]
== *Native connector reference (managed service)*
...
[discrete#connectors-oracle-availability-prerequisites]
...
[discrete#connectors-oracle-create-native-connector]
=== Create a {service-name} connector
include::_connectors-create-native.asciidoc[]

[discrete#connectors-oracle-usage]
=== Usage
...
[discrete#connectors-oracle-usage-secure-connection]
==== Secure connection
...
[discrete#connectors-oracle-compatability]
=== Compatibility

This connector is compatible with Oracle Database versions *18c*, *19c* and *21c*.

[discrete#connectors-oracle-configuration]
=== Configuration
...
[discrete#connectors-oracle-documents-syncs]
=== Documents and syncs
...
[discrete#connectors-oracle-sync-rules]
=== Sync rules
...
[discrete#connectors-oracle-known-issues]
=== Known issues
...
[discrete#connectors-oracle-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-oracle-security]
=== Security

See <<connectors-security>>.

[discrete#connectors-oracle-source]
...
[discrete#connectors-oracle-connector-client-reference]
== *Connector client reference (self-managed)*
...
[discrete#connectors-oracle-client-availability-prerequisites]
=== Availability and prerequisites
...
[discrete#connectors-oracle-create-connector-client]
=== Create a {service-name} connector
include::_connectors-create-client.asciidoc[]

[discrete#connectors-oracle-client-usage]
=== Usage
...
[discrete#connectors-oracle-client-usage-secure-connection]
==== Secure connection
...
[discrete#connectors-oracle-client-compatability]
=== Compatibility

Oracle Database versions *18c*, *19c* and *21c* are compatible with Elastic connector frameworks.

[discrete#connectors-oracle-client-configuration]
=== Configuration

[TIP]
====
When using the <<build-connector, connector client>> workflow, these fields will use the default configuration set in the https://github.com/elastic/connectors/blob/{branch}/connectors/sources/generic_database.py[connector source code^].
...
[discrete#connectors-oracle-client-docker]
=== Deployment using Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-oracle-client-documents-syncs]
=== Documents and syncs
...
[discrete#connectors-oracle-client-sync-rules]
=== Sync rules
...
[discrete#connectors-oracle-client-operations]
=== Connector client operations

[discrete#connectors-oracle-client-operations-testing]
==== End-to-end testing
...
[discrete#connectors-oracle-client-known-issues]
=== Known issues
...
[discrete#connectors-oracle-client-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-oracle-client-security]
=== Security

See <<connectors-security>>.

[discrete#connectors-oracle-client-source]
=== Framework and source

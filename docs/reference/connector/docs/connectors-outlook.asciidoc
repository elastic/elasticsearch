...
The Elastic Outlook connector is built with the Elastic connector framework and is available as a self-managed <<es-build-connector, connector client>>.
...
Refer to <<es-connectors-content-extraction>> in the official docs.

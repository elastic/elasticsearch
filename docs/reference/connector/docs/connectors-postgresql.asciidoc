...
[discrete#connectors-postgresql-connector-client-reference]
...
[discrete#connectors-postgresql-client-availability-prerequisites]
...
[discrete#connectors-postgresql-create-connector-client]
=== Create a {service-name} connector
include::_connectors-create-client.asciidoc[]

[discrete#connectors-postgresql-client-usage]
=== Usage
...
[discrete#connectors-postgresql-client-compatibility]
=== Compatibility

PostgreSQL versions 11 to 15 are compatible with Elastic connector frameworks.

[discrete#connectors-postgresql-client-configuration]
=== Configuration

[TIP]
====
When using the //build-connector, connector client workflow, initially these fields will use the default configuration set in the https://github.com/elastic/connectors-python/blob/{branch}/connectors/sources/postgresql.py[connector source code^].
...
[discrete#connectors-postgresql-client-docker]
=== Deployment using Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-postgresql-client-documents-syncs]
=== Documents and syncs
...
[discrete#connectors-postgresql-client-sync-rules]
=== Sync rules

//sync-rules-basic,Basic sync rules are identical for all connectors and are available by default.

[discrete#connectors-postgresql-client-sync-rules-advanced]
==== Advanced sync rules
...
[discrete#connectors-postgresql-client-sync-rules-advanced-example-data]
===== Example data

Here is some example data that will be used in the following examples.

[discrete#connectors-postgresql-client-sync-rules-advanced-example-data-1]
====== `employee` table
...
[discrete#connectors-postgresql-client-sync-rules-advanced-example-2]
====== `customer` table
...
[discrete#connectors-postgresql-client-sync-rules-advanced-examples]
===== Advanced sync rules examples

[discrete#connectors-postgresql-client-sync-rules-advanced-examples-1]
...
[discrete#connectors-postgresql-client-sync-rules-advanced-examples-1-id-columns]
...
[discrete#connectors-postgresql-client-sync-rules-advanced-examples-2]
...
[discrete#connectors-postgresql-client-sync-rules-advanced-examples-3]
====== `JOIN` operations
...
[discrete#connectors-postgresql-client-client-operations-testing]
=== End-to-end testing
...
[discrete#connectors-postgresql-client-known-issues]
=== Known issues
...
[discrete#connectors-postgresql-client-troubleshooting]
=== Troubleshooting

See //connectors-troubleshooting.

[discrete#connectors-postgresql-client-security]
=== Security

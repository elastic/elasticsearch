...
The _Elastic Salesforce connector_ is a <<connectors,connector>> for https://www.salesforce.com/[Salesforce^] data sources.
...
[discrete#connectors-salesforce-native-connector-reference]
== *Native connector reference (managed service)*
...
[discrete#connectors-salesforce-availability-prerequisites]
=== Availability and prerequisites

This connector is available as a *native connector* in Elastic Cloud since *8.12.0*.
To use this connector, satisfy all <<build-connector,connector client requirements>>.

[discrete#connectors-salesforce-compatability]
=== Compatibility
...
[discrete#connectors-salesforce-connected-app]
...
[discrete#connectors-salesforce-admin-prerequisites]
...
[TIP]
====
If using <<sync-rules-advanced,advanced sync rules>> you'll need to assign `Read` access for that specific object in the profile.
====
+
...
[discrete#connectors-salesforce-configuration]
=== Configuration
...
Refer to the <<connectors-salesforce-client-dls,DLS section>> for more information, including how to set various Salesforce permission types.
+
When enabled:
...
[discrete#connectors-salesforce-configuration-credentials]
...
[discrete#connectors-salesforce-dls]
=== Document level security (DLS)

<<dls, Document level security (DLS)>> enables you to restrict access to documents based on a user'­s permissions.
...
[discrete#connectors-salesforce-dls-profiles]
...
[discrete#connectors-salesforce-dls-permission-sets]
...
[discrete#connectors-salesforce-dls-permission-set-groups]
...
[discrete#connectors-salesforce-dls-assign-permissions]
...
[discrete#connectors-salesforce-sync-rules]
=== Sync rules
...
[discrete#connectors-salesforce-sync-rules-advanced]
==== Advanced sync rules
...
[discrete#connectors-salesforce-sync-rules-advanced-fetch-query-language]
...
[discrete#connectors-salesforce-sync-rules-advanced-fetch-objects]
...
[discrete#connectors-salesforce-sync-rules-advanced-fetch-standard-custom-fields]
...
[discrete#connectors-salesforce-documents-syncs]
=== Documents and syncs
...
[discrete#connectors-salesforce-sync-types]
==== Sync types
...
[discrete#connectors-salesforce-content-extraction]
=== Content Extraction
...
See <<connectors-salesforce-documents-syncs,documents and syncs>> for a list of supported object types.
...
See <<connectors-content-extraction,content extraction>> for more specifics on content extraction.

[discrete#connectors-salesforce-known-issues]
=== Known issues

There are currently no known issues for this connector.
Refer to <<connectors-known-issues,connector known issues>> for a list of known issues for all connectors.

[discrete#connectors-salesforce-security]
=== Security

See <<connectors-security,connectors security>>.

[discrete#connectors-salesforce-source]
...
[discrete#connectors-salesforce-connector-client-reference]
== *Connector client reference (self-managed)*
...
[discrete#connectors-salesforce-client-availability-prerequisites]
=== Availability and prerequisites
...
[discrete#connectors-salesforce-client-compatability]
=== Compatibility
...
[discrete#connectors-salesforce-create-connector-client]
=== Create a {service-name} connector
include::_connectors-create-client.asciidoc[]

[discrete#connectors-salesforce-client-usage]
=== Usage
...
[discrete#connectors-salesforce-client-connected-app]
==== Create a Salesforce connected app
...
[discrete#connectors-client-salesforce-admin-prerequisites]
=== Salesforce admin requirements
...
[discrete#connectors-salesforce-client-docker]
...
[discrete#connectors-salesforce-client-configuration]
=== Configuration
...
Toggle to enable document level security (DLS).
Optional, disabled by default.
Refer to the <<connectors-salesforce-dls,DLS section>> for more information, including how to set various Salesforce permission types.
+
When enabled:
...
[discrete#connectors-salesforce-client-configuration-credentials]
==== Finding the Client ID and Client Secret
...
[discrete#connectors-salesforce-client-dls]
=== Document level security (DLS)
...
[discrete#connectors-salesforce-client-dls-profiles]
==== Set Permissions using Profiles

Refer to the https://help.salesforce.com/s/articleView?id=sf.admin_userprofiles.htm&type=5[Salesforce documentation] for setting permissions via Profiles.

[discrete#connectors-salesforce-client-dls-permission-sets]
==== Set Permissions using Permissions Set

Refer to the https://help.salesforce.com/s/articleView?id=sf.perm_sets_overview.htm&language=en_US&type=5[Salesforce documentation] for setting permissions via Permissions Sets.

[discrete#connectors-salesforce-client-dls-permission-set-groups]
==== Set Permissions using Permissions Set group

Refer to the https://help.salesforce.com/s/articleView?id=sf.perm_set_groups.htm&type=5[Salesforce documentation] for setting permissions via Permissions Set Groups.

[discrete#connectors-salesforce-client-dls-assign-permissions]
==== Assign Profiles, Permission Set and Permission Set Groups to the User
...
[discrete#connectors-salesforce-client-sync-rules]
=== Sync rules
...
[discrete#connectors-salesforce-client-sync-rules-advanced]
==== Advanced sync rules
...
[discrete#connectors-salesforce-client-sync-rules-advanced-fetch-query-language]
===== Fetch documents based on the query and language specified
...
[discrete#connectors-salesforce-client-sync-rules-advanced-fetch-objects]
===== Fetch standard and custom objects using SOQL and SOSL queries
...
[discrete#connectors-salesforce-client-sync-rules-advanced-fetch-standard-custom-fields]
===== Fetch documents with standard and custom fields
...
[discrete#connectors-salesforce-client-documents-syncs]
=== Documents and syncs
...
[discrete#connectors-salesforce-client-sync-types]
==== Sync types
...
[discrete#connectors-salesforce-client-content-extraction]
=== Content Extraction
...
This means that the connector will not ingest any Content Documents you have that are _not_ attached to a supported Salesforce object.
See <<connectors-salesforce-client-documents-syncs,documents and syncs>> for a list of supported object types.
...
[discrete#connectors-salesforce-client-known-issues]
=== Known issues

There are currently no known issues for this connector.
Refer to <<connectors-known-issues,connector known issues>> for a list of known issues for all connectors.

[discrete#connectors-salesforce-client-security]
=== Security

See <<connectors-security,connectors security>>.

[discrete#connectors-salesforce-client-source]
=== Framework and source

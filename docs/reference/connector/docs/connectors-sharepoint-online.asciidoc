...
[TIP]
====
Looking for the SharePoint *Server* connector? See <<connectors-sharepoint,SharePoint Server reference>>.
====

The _Elastic SharePoint Online connector_ is a <<connectors,connector>> for https://www.microsoft.com/en-ww/microsoft-365/sharepoint/[Microsoft SharePoint Online^].
...
[discrete#connectors-sharepoint-online-native-connector-reference]
...
[discrete#connectors-sharepoint-online-availability-prerequisites]
=== Availability and prerequisites

This connector is available as a *native connector* in Elastic versions *8.9.0 and later*.
To use this connector natively in Elastic Cloud, satisfy all <<native-connectors,native connector requirements>>.

[NOTE]
====
This connector requires a <<license-management,subscription>>.
...
[discrete#connectors-sharepoint-online-usage]
=== Usage
...
[discrete#connectors-sharepoint-online-sharepoint-prerequisites]
=== SharePoint prerequisites

[discrete#connectors-sharepoint-online-oauth-app-create]
...
You'll collect values (`client ID`, `tenant ID`, and `client secret`) during this process that you'll need for the <<connectors-sharepoint-online-configuration,configuration step>> in Kibana.
...
[discrete#connectors-sharepoint-online-oauth-app-permissions]
...
[discrete#connectors-sharepoint-online-compatability]
=== Compatibility

This connector is compatible with SharePoint Online.

[discrete#connectors-sharepoint-online-configuration]
=== Configuration
...
[discrete#connectors-sharepoint-online-documents-syncs]
=== Documents and syncs
...
* Permissions are not synced by default. Enable <<dls, document-level security (DLS)>> to sync permissions.
====
...
[discrete#connectors-sharepoint-online-documents-syncs-limitations]
==== Limitations

* The connector does not currently sync content from Teams-connected sites.

[discrete#connectors-sharepoint-online-sync-rules]
=== Sync rules
...
[discrete#connectors-sharepoint-online-sync-rules-advanced]
==== Advanced sync rules
...
<<sync-rules-advanced,Advanced rules>> for the Sharepoint Online connector enable you to avoid extracting and syncing older data that might no longer be relevant for search.
...
[discrete#connectors-sharepoint-online-sync-rules-limitations]
===== Limitations of sync rules with incremental syncs

Changing sync rules after Sharepoint Online content has already been indexed can bring unexpected results, when using <<connectors-sync-types-incremental,incremental syncs>>.
...
[discrete#connectors-sharepoint-online-sync-rules-limitations-restrictive-added]
...
[discrete#connectors-sharepoint-online-sync-rules-limitations-restrictive-removed]
...
[discrete#connectors-sharepoint-online-sync-rules-limitations-restrictive-changed]
...
[discrete#connectors-sharepoint-online-dls]
...
Refer to <<connectors-sharepoint-online-configuration,configuration>> on this page for how to enable DLS for this connector.

[TIP]
====
Refer to <<dls-e2e-guide,DLS in Search Applications>> to learn how to ingest data from SharePoint Online with DLS enabled, when building a search application.
====

[discrete#connectors-sharepoint-online-content-extraction]
=== Content extraction

[discrete#connectors-sharepoint-online-content-extraction-pipeline]
...
[discrete#connectors-sharepoint-online-content-extraction-local]
==== Local content extraction (for large files)

The SharePoint Online connector client supports large file content extraction (> *100MB*).
This requires:
...
Refer to <<connectors-content-extraction-local, local content extraction>> for more information.

[discrete#connectors-sharepoint-online-known-issues]
=== Known issues
...
[discrete#connectors-sharepoint-online-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-sharepoint-onlinesecurity]
=== Security
...
[discrete#connectors-sharepoint-online-connector-client-reference]
...
[discrete#connectors-sharepoint-online-client-availability-prerequisites]
=== Availability and prerequisites
...
[discrete#connectors-sharepoint-online-client-usage]
=== Usage

To use this connector as a *connector client*, see <<build-connector>>
For additional operations, see <<connectors-usage>>.

[discrete#connectors-sharepoint-online-client-sharepoint-prerequisites]
=== SharePoint prerequisites

[discrete#connectors-sharepoint-online-client-oauth-app-create]
==== Create SharePoint OAuth app

Before you can configure the connector, you must create an **OAuth App** in the SharePoint Online platform.
Your connector will authenticate to SharePoint as the registered OAuth application/client.
You'll collect values (`client ID`, `tenant ID`, and `client secret`) during this process that you'll need for the <<connectors-sharepoint-online-client-configuration,configuration step>> in Kibana.
...
[discrete#connectors-sharepoint-online-client-oauth-app-permissions]
==== SharePoint permissions
...
[discrete#connectors-sharepoint-online-client-compatability]
=== Compatibility

This connector is compatible with SharePoint Online.

[discrete#connectors-sharepoint-online-client-configuration]
=== Configuration

[TIP]
====
When using the <<build-connector, connector client>> workflow, initially these fields will use the default configuration set in the {connectors-python}/connectors/sources/sharepoint_online.py[connector source code^].
...
[discrete#connectors-sharepoint-online-client-docker]
=== Deployment using Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-sharepoint-online-client-documents-syncs]
=== Documents and syncs
...
[discrete#connectors-sharepoint-online-client-documents-syncs-limitations]
==== Limitations

* The connector does not currently sync content from Teams-connected sites.

[discrete#connectors-sharepoint-online-client-sync-rules]
=== Sync rules

_Basic_ sync rules are identical for all connectors and are available by default.
For more information read <<sync-rules-types>>.

[discrete#connectors-sharepoint-online-client-sync-rules-advanced]
==== Advanced sync rules
...
[discrete#connectors-sharepoint-online-client-sync-rules-limitations]
===== Limitations of sync rules with incremental syncs
...
[discrete#connectors-sharepoint-online-client-sync-rules-limitations-restrictive-added]
====== Example: Restrictive basic sync rule added after a full sync
...
[discrete#connectors-sharepoint-online-client-sync-rules-limitations-restrictive-removed]
====== Example: Restrictive basic sync rules removed after a full sync
...
[discrete#connectors-sharepoint-online-client-sync-rules-limitations-restrictive-changed]
====== Example: Advanced sync rules edge case
...
[discrete#connectors-sharepoint-online-client-dls]
=== Document-level security

Document-level security (DLS) enables you to restrict access to documents based on a user's permissions.
This feature is available by default for this connector.

Refer to <<connectors-sharepoint-online-client-configuration,configuration>> on this page for how to enable DLS for this connector.
...
[discrete#connectors-sharepoint-online-client-content-extraction]
=== Content extraction

[discrete#connectors-sharepoint-online-client-content-extraction-pipeline]
==== Default content extraction
...
[discrete#connectors-sharepoint-online-client-content-extraction-local]
==== Local content extraction (for large files)
...
[discrete#connectors-sharepoint-online-client-testing]
=== End-to-end testing
...
[discrete#connectors-sharepoint-online-client-known-issues]
=== Known issues
...
[discrete#connectors-sharepoint-online-client-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-sharepoint-online-client-security]
=== Security

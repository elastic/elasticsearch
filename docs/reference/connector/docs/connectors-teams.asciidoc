...
[discrete#connectors-teams-native-connector-reference]
== *Native connector reference (managed service)*
...
[discrete#connectors-microsoft-teams-native-availability-and-prerequisites]
...
[discrete#connectors-teams-create-connector-native]
=== Create a {service-name} connector
include::_connectors-create-native.asciidoc[]

[discrete#connectors-microsoft-teams-native-usage]
=== Usage
...
[discrete#connectors-microsoft-teams-native-connecting-to-microsoft-teams]
...
[discrete#connectors-microsoft-teams-native-configuration]
=== Configuration
...
[discrete#connectors-microsoft-teams-native-content-extraction]
==== Content Extraction

Refer to <<connectors-content-extraction>>.

[discrete#connectors-microsoft-teams-native-documents-and-syncs]
=== Documents and syncs
...
[discrete#connectors-microsoft-teams-native-sync-types]
==== Sync types
...
[discrete#connectors-microsoft-teams-native-sync-rules]
=== Sync rules

<<sync-rules-basic, Basic sync rules>> are identical for all connectors and are available by default.

[discrete#connectors-microsoft-teams-native-advanced-sync-rules]
=== Advanced Sync Rules

Advanced sync rules are not available for this connector in the present version.

[discrete#connectors-microsoft-teams-native-known-issues]
=== Known issues
...
[discrete#connectors-microsoft-teams-native-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-microsoft-teams-native-security]
=== Security
...
[discrete#connectors-teams-connector-client-reference]
== *Connector client reference (self-managed)*
...
[discrete#connectors-microsoft-teams-availability-and-prerequisites]
=== Availability and prerequisites
...
[discrete#connectors-teams-client-create-connector-client]
=== Create a {service-name} connector
include::_connectors-create-client.asciidoc[]

[discrete#connectors-microsoft-teams-usage]
=== Usage
...
[discrete#connectors-microsoft-teams-connecting-to-microsoft-teams]
=== Connecting to Microsoft Teams
...
[discrete#connectors-microsoft-teams-configuration]
=== Configuration
...
[discrete#connectors-microsoft-teams-client-docker]
==== Deployment using Docker

include::_connectors-docker-instructions.asciidoc[]

[discrete#connectors-microsoft-teams-content-extraction]
==== Content Extraction

Refer to <<connectors-content-extraction>>.

[discrete#connectors-microsoft-teams-documents-and-syncs]
=== Documents and syncs
...
[discrete#connectors-microsoft-teams-sync-types]
==== Sync types
...
[discrete#connectors-microsoft-teams-sync-rules]
=== Sync rules

<<sync-rules-basic, Basic sync rules>> are identical for all connectors and are available by default.

[discrete#connectors-microsoft-teams-advanced-sync-rules]
=== Advanced Sync Rules

Advanced sync rules are not available for this connector in the present version.

[discrete#connectors-microsoft-teams-end-to-end-testing]
=== End-to-end Testing
...
[discrete#connectors-microsoft-teams-known-issues]
=== Known issues
...
[discrete#connectors-microsoft-teams-troubleshooting]
=== Troubleshooting

See <<connectors-troubleshooting>>.

[discrete#connectors-microsoft-teams-security]
=== Security

...
****
Please note that the connectors documentation lived in the Enterprise Search documentation prior to version 8.16.0.
****
...
See <<es-native-connectors>> for details on how to configure and use Elastic managed connectors.

.*Expand* to see list of available Elastic managed connectors
[%collapsible]
====

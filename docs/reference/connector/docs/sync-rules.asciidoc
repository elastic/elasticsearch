...
Sync rules apply to <<native-connectors,native connectors>> and <<build-connector,connector clients>>.

[discrete#sync-rules-availability-prerequisites]
...
Learn more in the <<connectors, individual connector's reference documentation>>.

[discrete#sync-rules-types]
== Types of sync rule
...
[discrete#sync-rules-general-filtering]
...
[discrete#sync-rules-general-filtering-pipeline]
=== Pipeline filtering
...
[discrete#sync-rules-basic-examples]
=== Basic sync rules examples

[discrete#sync-rules-basic-examples-1]
==== Example 1
...
[discrete#sync-rules-basic-examples-2]
==== Example 2
...
[discrete#sync-rules-performance-implications]
...
Keep in mind that custom community-built connector clients may not have these performance optimizations.
====
...
Refer to the documentation for <<connectors,each connector>> for details.

[discrete#interplay-basic-rules-advanced-rules]
...
[discrete#example-interplay-basic-rules-advanced-rules]
=== Example
...
[discrete#example-interplay-basic-rules]
==== Basic sync rules examples
...
[discrete#example-interplay-advanced-rules]

...
on continuous {dataframe-transforms}. Additionally, all settings except description to not
take effect until after the {dataframe-transform} reaches the next checkpoint. This is

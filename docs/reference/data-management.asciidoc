...
* Timestamped data: a stream of continuously-generated timestamped data, such as log entries
...
Timestamped data keeps accumulating over time, so you need strategies for 

...
preview:[]
* <<data-streams-put-global-retention,Update the global retention settings for data stream lifecycle managed data streams>>
preview:[]
* <<data-streams-get-global-retention,Get the global retention settings for data stream lifecycle managed data streams>>
preview:[]
* <<data-streams-delete-global-retention,Delete the global retention settings for data stream lifecycle managed data streams>>
preview:[]

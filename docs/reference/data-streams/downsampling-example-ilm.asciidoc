...
<<downsampling-example-manual,Run downsampling manually>> example.
...
You can use the data stream stats API get statistics for the data stream,
including the storage size.

...
For the example you need a sample data set. Go `FIX ME -> https://download.elastic.co/demos/logstash/gettingstarted/logstash-tutorial.log.gz[here]` to

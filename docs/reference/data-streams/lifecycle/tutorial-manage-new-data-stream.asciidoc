...
setting the `lifecycle` field in the index template the same you do for mappings and index settings. You can define an
...
[source,console]
--------------------------------------------------
PUT .ds-my-data-stream-*/my-data-stream
--------------------------------------------------
// TEST[continued]

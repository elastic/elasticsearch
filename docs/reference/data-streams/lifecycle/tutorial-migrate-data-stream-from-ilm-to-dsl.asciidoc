...
<3> The retention desired by the user, meaning the user desired their data to be
kept for at least "7d".
<4> The effective retention is the least amount of time data will be kept by {es}.
<5> This field displays which configuration determined the effective retention. In this case
it was the desired retention defined by the user.

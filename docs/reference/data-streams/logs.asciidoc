...
With regard to ordering, `host.name` and `@timestamp` are sorted in ascending and descending order respectively,
prioritizing the latest data.
...
the sort configuration and the nature of the logged data - we've observed 20% storage reductions in our benchmarks,

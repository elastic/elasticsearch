...
The following template maps the `@timestamp` field as a `date_nanos` field data
type.
...
<1> Maps the `@timestamp` field as a `date_nanos` field data type. You can
include other supported mapping parameters in this field mapping.
====

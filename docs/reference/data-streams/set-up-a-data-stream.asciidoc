...
While optional, we recommend using {ilm-init} and an index lifecycle policy to
automate the management of your data stream's backing indices.
...
PUT _component_template/my-mappings
{
  ...
  "_meta": {
    "description": "My optional, arbitrary metadata",

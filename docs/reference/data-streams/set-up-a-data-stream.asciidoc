...
from zero or more component templates. You typically use separate component
templates for mappings and index settings that you intend to reuse from multiple index templates.

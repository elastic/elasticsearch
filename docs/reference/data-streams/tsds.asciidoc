...
For a flattened field, instead, you mark a set of fields as dimensions using an array
of strings `time_series_dimensions`. For details see <<flattened-params,`flattened`>>.

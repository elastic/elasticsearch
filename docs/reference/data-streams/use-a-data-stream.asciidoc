...
data stream. However, you cannot send update or deletion requests for existing
documents to a data stream.
...
<<optimistic-concurrency-control,`if_seq_no` and `if_primary_term`>> arguments.

...
* If the {es} {security-features} are enabled, you must have the `manage` <<privileges-list-indices,index privilege>>
or the `manage_dlm` index privilege or both to use this API. For more information, see <<security-privileges>>.

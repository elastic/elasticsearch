...
Sets the lifecycle of the targeted data streams.
...
Sets the lifecycle of the specified data streams. If multiple data streams are provided but at least one of them

...
To remove the lifecycle of a data stream you can use the <<dlm-delete-lifecycle-request,delete lifecycle API>>, as consequence,
...
You can then use the <<dlm-explain-lifecycle, explain API>> again to see that the indices are no longer managed.

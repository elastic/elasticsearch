...
{"took":7, "errors": false, "items_omitted": false, "items":[{"index":{"_index":"test","_id":"1","_version":1,"result":"created","forced_refresh":false}}]}
--------------------------------------------------
// NOTCONSOLE
...
include::{docdir}/rest-api/common-parms.asciidoc[tag=no_items_on_success]
...
`items_omitted`::
(boolean) indicates the `no_items_on_success` parameter took effect and `items` is an empty array
because `errors` is `false`

...
NOTE: NOTE: You cannot send deletion requests for existing documents to a data
stream. To delete a document in a data stream, you must target the backing index

...
// TODO: Check references below.
`PUT /<target>/<type>/<_id>`

`POST /<target>/<type>/<_id>`

`POST /<target>/<type>`

`PUT /<target>/<type>/<_id>/_create`

`POST /<target>/<type>/<_id>/_create`
...
`<type>`::
deprecated:[7.0, Mapping types are deprecated. See <<removal-of-types>>.]
(Optional, string) <<removal-of-types,Mapping type>> for the document.

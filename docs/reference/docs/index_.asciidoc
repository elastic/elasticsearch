...
`_id`::
The unique identifier for the added document. By default, maximum length
of `_id` is limited to 512 bytes. You can change this limit using
the <<index-max-doc-id-length, `index.max_doc_id_length`>> setting.

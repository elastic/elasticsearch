...
[source,js]
--------------------------------------------------
PUT twitter/_doc/1?include_type_name=false
{
    "user" : "kimchy",
...
[source,js]
--------------------------------------------------
PUT twitter/_doc/1?version=2&include_type_name=false
{
...
[source,js]
--------------------------------------------------
PUT twitter/_doc/1?op_type=create&include_type_name=false
{
    "user" : "kimchy",
    "post_date" : "2009-11-15T14:12:12",
    "message" : "trying out Elasticsearch"
...
[source,js]
--------------------------------------------------
POST twitter/_doc?include_type_name=false
{
    "user" : "kimchy",
    "post_date" : "2009-11-15T14:12:12",
    "message" : "trying out Elasticsearch"
...
[source,js]
--------------------------------------------------
PUT twitter/_doc/1?timeout=5m&include_type_name=false
{
    "user" : "kimchy",
    "post_date" : "2009-11-15T14:12:12",
    "message" : "trying out Elasticsearch"

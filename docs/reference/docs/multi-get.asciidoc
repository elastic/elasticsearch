...
[source,js]
--------------------------------------------------
curl -XPOST 'localhost:9200/test/_mget' -d '{
    "docs" : [
        {
            "_type" : "type",
            "_id" : "1"
...
[source,js]
--------------------------------------------------
curl -XPOST 'localhost:9200/test/type/_mget' -d '{
    "docs" : [
        {
            "_id" : "1"
        },
...
[source,js]
--------------------------------------------------
curl -XPOST 'localhost:9200/test/type/_mget?fields=field1,field2' -d '{
    "docs" : [
        {
            "_id" : "1" <1>
        },
...
[source,js]
--------------------------------------------------
curl -XPOST 'localhost:9200/_mget?routing=key1' -d '{
    "docs" : [
        {
            "_index" : "test",
            "_type" : "type",

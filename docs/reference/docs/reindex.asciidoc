...
NOTE:: Should be set to `true` to perform reindexing from remote when index name is prefixed with remote cluster alias.

[source,console]
--------------------------------------------------
POST _reindex?ignore_unavailable=true
{
  "source": {
    "index": "remote_cluster_alias:source"
  },
  "dest": {
    "index": "dest",
  }

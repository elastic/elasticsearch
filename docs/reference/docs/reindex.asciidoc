...
The source can be any existing index, alias, or <<data-streams,data stream>>.
The destination must differ from the source. For example, you cannot reindex a
data stream into itself.

...
computed on the fly added[1.4.0.Beta1]. The following request returns all information and statistics for the
...
Additionally, term vectors can also be generated for artificial documents added[1.4.0.Beta1],

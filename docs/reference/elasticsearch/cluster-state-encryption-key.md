...
Configure one yourself with [`elasticsearch-keystore`](/reference/elasticsearch/command-line-tools/elasticsearch-keystore.md) if the aumatic security setup is not executed.

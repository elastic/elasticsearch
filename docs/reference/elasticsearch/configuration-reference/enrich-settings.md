...
`enrich.max_policy_size` {applies_to}`stack: ga 9.6` ![logo cloud](https://doc-icons.s3.us-east-2.amazonaws.com/logo_cloud.svg "Supported on Elastic Cloud Hosted")
...
`enrich.max_total_metadata_size` {applies_to}`stack: ga 9.6` ![logo cloud](https://doc-icons.s3.us-east-2.amazonaws.com/logo_cloud.svg "Supported on Elastic Cloud Hosted")

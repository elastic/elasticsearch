...
::::{warning}
The {{es}} Monitoring plugin is deprecated and will be removed in 10.0.0. Choose one of the following replacements to monitor your {{es}} cluster:

* **[AutoOps](docs-content://deploy-manage/monitor/autoops.md)** (recommended): Simplifies cluster management through performance recommendations, resource utilization visibility, and real-time issue detection with resolution paths.
* **Stack monitoring with [{{agent}}](docs-content://deploy-manage/monitor/stack-monitoring/collecting-monitoring-data-with-elastic-agent.md) or [{{metricbeat}}](docs-content://deploy-manage/monitor/stack-monitoring/collecting-monitoring-data-with-metricbeat.md)**: Collect logs and metrics from {{es}} and ship them to a monitoring cluster for visualization in {{kib}}.

To help you decide, refer to the [AutoOps and Stack Monitoring comparison](docs-content://deploy-manage/monitor/autoops-vs-stack-monitoring.md).
::::
...
`xpack.monitoring.enabled` {applies_to}`stack: deprecated 7.8`
:   ([Static](docs-content://deploy-manage/stack-settings.md#static-cluster-setting)) This setting has no effect.
...
`xpack.monitoring.collection.enabled` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Dynamic](docs-content://deploy-manage/stack-settings.md#dynamic-cluster-setting)) Set to `true` to enable the collection of monitoring data. When this setting is `false` (default), {{es}} monitoring data is not collected and all monitoring data from other sources such as {{kib}}, Beats, and {{ls}} is ignored.
...
:   ([Dynamic](docs-content://deploy-manage/stack-settings.md#dynamic-cluster-setting)) Controls whether statistics about your {{es}} cluster should be collected. Defaults to `true`. This is different from `xpack.monitoring.collection.enabled`, which allows you to enable or disable all monitoring collection. However, this setting simply disables the collection of {{es}} data while still allowing other data (e.g., {{kib}}, {{ls}}, Beats, or APM Server monitoring data) to pass through this cluster.

`xpack.monitoring.collection.cluster.stats.timeout` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Dynamic](docs-content://deploy-manage/stack-settings.md#dynamic-cluster-setting)) Timeout for collecting the cluster statistics, in [time units](/reference/elasticsearch/rest-apis/api-conventions.md#time-units). Defaults to `10s`.

`xpack.monitoring.collection.node.stats.timeout` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Dynamic](docs-content://deploy-manage/stack-settings.md#dynamic-cluster-setting)) Timeout for collecting the node statistics, in [time units](/reference/elasticsearch/rest-apis/api-conventions.md#time-units). Defaults to `10s`.

`xpack.monitoring.collection.indices` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Dynamic](docs-content://deploy-manage/stack-settings.md#dynamic-cluster-setting)) Controls which indices the {{monitor-features}} collect data from. Defaults to all indices. Specify the index names as a comma-separated list, for example `test1,test2,test3`. Names can include wildcards, for example `test*`. You can explicitly exclude indices by prepending `-`. For example `test*,-test3` will monitor all indexes that start with `test` except for `test3`. System indices like .security* or .kibana* always start with a `.` and generally should be monitored. Consider adding `.*` to the list of indices ensure monitoring of system indices. For example: `.*,test*,-test3`

`xpack.monitoring.collection.index.stats.timeout` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Dynamic](docs-content://deploy-manage/stack-settings.md#dynamic-cluster-setting)) Timeout for collecting index statistics, in [time units](/reference/elasticsearch/rest-apis/api-conventions.md#time-units). Defaults to `10s`.

`xpack.monitoring.collection.index.recovery.active_only` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Dynamic](docs-content://deploy-manage/stack-settings.md#dynamic-cluster-setting)) Controls whether or not all recoveries are collected. Set to `true` to collect only active recoveries. Defaults to `false`.
...
:   ([Dynamic](docs-content://deploy-manage/stack-settings.md#dynamic-cluster-setting)) Retention duration beyond which the indices created by a monitoring exporter are automatically deleted, in [time units](/reference/elasticsearch/rest-apis/api-conventions.md#time-units). Defaults to `7d` (7 days).
...
`host` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`auth.username` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   The username is required if `auth.secure_password` is supplied.

`auth.secure_password` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`connection.timeout` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`connection.read_timeout` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`ssl` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`proxy.base_path` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`headers` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`cluster_alerts.management.blacklist` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.supported_protocols` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.verification_mode` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.cipher_suites` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.key` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.key_passphrase` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Static](docs-content://deploy-manage/stack-settings.md#static-cluster-setting)) The passphrase that is used to decrypt the private key. Since the key might not be encrypted, this value is optional. Prefer `ssl.secure_key_passphrase` instead.

    You cannot use this setting and `ssl.secure_key_passphrase` at the same time.


`xpack.monitoring.exporters.$NAME.ssl.secure_key_passphrase` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.certificate` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.certificate_authorities` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.keystore.path` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.keystore.password` {applies_to}`stack: deprecated 7.17, removed 10.0`
:   ([Static](docs-content://deploy-manage/stack-settings.md#static-cluster-setting)) The password for the keystore. Prefer `ssl.keystore.secure_password` instead.

`xpack.monitoring.exporters.$NAME.ssl.keystore.secure_password` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Secure](docs-content://deploy-manage/security/secure-settings.md)) The password for the keystore.

`xpack.monitoring.exporters.$NAME.ssl.keystore.key_password` {applies_to}`stack: deprecated 7.17, removed 10.0`
:   ([Static](docs-content://deploy-manage/stack-settings.md#static-cluster-setting)) The password for the key in the keystore. The default is the keystore password. Prefer `ssl.keystore.secure_key_password` instead.

    You cannot use this setting and `ssl.keystore.secure_password` at the same time.


`xpack.monitoring.exporters.$NAME.ssl.keystore.secure_key_password` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.truststore.path` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.truststore.password` {applies_to}`stack: deprecated 7.17, removed 10.0`
:   ([Static](docs-content://deploy-manage/stack-settings.md#static-cluster-setting)) The password for the truststore. Prefer `ssl.truststore.secure_password` instead.

    You cannot use this setting and `ssl.truststore.secure_password` at the same time.


`xpack.monitoring.exporters.$NAME.ssl.truststore.secure_password` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.keystore.type` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.keystore.password` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Static](docs-content://deploy-manage/stack-settings.md#static-cluster-setting)) The password for the keystore. Prefer `ssl.keystore.secure_password` instead.
...
`xpack.monitoring.exporters.$NAME.ssl.truststore.type` {applies_to}`stack: deprecated 7.16, removed 10.0`
...
`xpack.monitoring.exporters.$NAME.ssl.truststore.password` {applies_to}`stack: deprecated 7.16, removed 10.0`
:   ([Static](docs-content://deploy-manage/stack-settings.md#static-cluster-setting)) The password for the truststore. Prefer `ssl.truststore.secure_password` instead.

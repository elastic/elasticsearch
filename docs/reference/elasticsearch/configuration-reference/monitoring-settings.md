...
:   :::{admonition} Deprecated in 7.16.0
    This setting was deprecated in 7.16.0 and will be removed in 10.0.0.
    :::
...
:   :::{admonition} Deprecated in 6.3.0
    This setting was deprecated in 6.3.0 and will be removed in 10.0.0.
    :::
...
:   :::{admonition} Deprecated in 7.16.0
    ...
    This setting was deprecated in 7.17.0 and will be removed in 10.0.0, prefer `ssl.secure_key_passphrase` instead.
    :::
...
:   :::{admonition} Deprecated in 7.17.0
    This setting was deprecated in 7.17.0 and will be removed in 10.0.0, prefer `ssl.keystore.secure_password` instead.
    :::
...
:   :::{admonition} Deprecated in 7.17.0
    This setting was deprecated in 7.17.0 and will be removed in 10.0.0, prefer `ssl.keystore.secure_key_password` instead.
    :::
...
:   :::{admonition} Deprecated in 7.17.0
    This setting was deprecated in 7.17.0 and will be removed in 10.0.0, prefer `ssl.truststore.secure_password` instead.
    :::

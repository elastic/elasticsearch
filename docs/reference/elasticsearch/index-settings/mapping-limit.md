...
:   The maximum number of fields in an index. Field and object mappings, as well as field aliases count towards this limit. Mapped runtime fields count towards this limit as well. The default value is `1000`. Attempting to surpass this limit will return error `Limit of total fields [X] in index [Y] has been exceeded`.

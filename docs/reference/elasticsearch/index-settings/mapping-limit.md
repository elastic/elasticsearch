...
:   The maximum number of fields in an index. Field and object mappings, field aliases, and mapped runtime fields all count towards this limit. The default value is `1000`. Beyond this limit, Elasticsearch returns the error `Limit of total fields [X] in index [Y] has been exceeded`.

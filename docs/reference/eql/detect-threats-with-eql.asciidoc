...
find a match. However, the sequence query isn't overfit to the specific command.
Instead, it looks for a pattern of suspicious behavior while still being generic
enough to detect similar threats in the future.

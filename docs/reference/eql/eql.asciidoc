...
The detailed documentation of EQL Circuit breaker settings can be accessed [here](https://www.elastic.co/guide/en/elasticsearch/reference/current/circuit-breaker.html#eql-circuit-breaker).

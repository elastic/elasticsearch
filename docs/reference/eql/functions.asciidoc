...
--
(Optional, integer or `null`)
Radix or base used to convert the string. Defaults to base `10`. If the
`<string>` begins with `0x`, this parameter defaults to `16` (hexadecimal), even
if a `null` argument is specified. Otherwise, if a `null` argument is specified,
the function returns `null`.

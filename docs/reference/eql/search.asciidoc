...
[discrete]
[[eql-search-specify-tiebreaker-field]]
=== Specify a sort tiebreaker field
...
can use the `tie_breaker_field` parameter to specify another field.

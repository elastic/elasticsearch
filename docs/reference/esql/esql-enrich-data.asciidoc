...
The `ENRICH` commands adds new columns to a table, with data from {es} indices.
...
After the policy has been executed, you can use the `ENRICH` command to enrich
your data. Refer to <<esql-enrich>> for the syntax.

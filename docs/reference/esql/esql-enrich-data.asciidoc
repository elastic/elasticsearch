...
The {esql}'s <<esql-enrich>> processing command combines at query-time
 data from one or more source indexes with field-value combinations found in {es} enrich indexes.

...
`enable_dangerous_snapshot_features`::
(Optional, boolean) Do not enable snapshot features unless you fully
understand the risks. Snapshot features are unstable, can be removed without
notice, and may break your cluster or cause data loss. This parameter may also

...
query API. When creating the query, using triple quotes (`"""`) lets you 
automatically escape double quotes (`"`) inside the query string as well 
as run multi-line requests:

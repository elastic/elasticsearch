...
----
include::{esql-specs}/spatial.csv-spec[tag=st_contains-airport_city_boundaries]
----
[%header.monospaced.styled,format=dsv,separator=|]
|===
include::{esql-specs}/spatial.csv-spec[tag=st_contains-airport_city_boundaries-results]
|===

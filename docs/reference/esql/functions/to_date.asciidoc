...
----
include::{esql-specs}/date.csv-spec[tag=to_date-str]
----
[%header.monospaced.styled,format=dsv,separator=|]
|===
include::{esql-specs}/date.csv-spec[tag=to_date-str-result]
|===
...
[source.merge.styled,esql]
----
include::{esql-specs}/date.csv-spec[tag=to_date-int]
----
[%header.monospaced.styled,format=dsv,separator=|]
|===
include::{esql-specs}/date.csv-spec[tag=to_date-int-result]
|===

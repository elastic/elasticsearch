...
include::../functions/examples/like.asciidoc[tag=example]

include::../functions/examples/rlike.asciidoc[tag=example]

include::../functions/examples/in.asciidoc[tag=example]

...
appropriate cURL command and submit the request to a local {es} instance from
...
+
TIP: When you're ready to start using {es} in your own applications, you'll want to
check out the

...
[source,js]
--------------------------------------------------
PUT /customer?pretty&include_type_name=false
GET /_cat/indices?v
--------------------------------------------------
// CONSOLE
...
[source,js]
--------------------------------------------------
PUT /customer/_doc/1?pretty&include_type_name=false
{
  "name": "John Doe"
}
--------------------------------------------------
...
[source,js]
--------------------------------------------------
GET /customer/_doc/1?pretty&include_type_name=false
--------------------------------------------------
// CONSOLE
// TEST[continued]
...
[source,js]
--------------------------------------------------
PUT /customer?include_type_name=false
PUT /customer/_doc/1?include_type_name=false
{
  "name": "John Doe"
}
GET /customer/_doc/1?include_type_name=false
DELETE /customer
--------------------------------------------------
// CONSOLE
...
[source,js]
--------------------------------------------------
PUT /customer/_doc/2?pretty&include_type_name=false
{
  "name": "Jane Doe"
}
--------------------------------------------------
...
[source,js]
--------------------------------------------------
POST /customer/_doc?pretty&include_type_name=false
{
  "name": "Jane Doe"
}
--------------------------------------------------
...
[source,js]
--------------------------------------------------
POST /customer/_doc/1/_update?pretty&include_type_name=false
{
  "doc": { "name": "Jane Doe" }
}
--------------------------------------------------
...
[source,js]
--------------------------------------------------
DELETE /customer/_doc/2?pretty&include_type_name=false
--------------------------------------------------
// CONSOLE
// TEST[continued]
...
[source,js]
--------------------------------------------------
POST /customer/_bulk?pretty&include_type_name=false
{"index":{"_id":"1"}}
{"name": "John Doe" }
{"index":{"_id":"2"}}
{"name": "Jane Doe" }
...
[source,sh]
--------------------------------------------------
curl -H "Content-Type: application/json" -XPOST "localhost:9200/bank/_bulk?pretty&refresh&include_type_name=false" --data-binary "@accounts.json"
...
[source,js]
--------------------------------------------------
GET /bank/_search?q=*&sort=account_number:asc&pretty&include_type_name=false
--------------------------------------------------
// CONSOLE
// TEST[continued]
...
[source,js]
--------------------------------------------------
GET /bank/_search?include_type_name=false
{
  "query": { "match_all": {} },
  "sort": [
    { "account_number": "asc" }

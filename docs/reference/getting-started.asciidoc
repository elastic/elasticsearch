...
--------------------------------------------------
// TESTRESPONSE[s/1565052807 00:53:27  elasticsearch/\\d+ \\d+:\\d+:\\d+ docs_integTestCluster/]
...
green open   bank  l7sSYV2cQXmu6_4rJWVIww   5   1       1000            0    949.3kb        474.6kb
--------------------------------------------------
// TESTRESPONSE[s/green/.+/]
// TESTRESPONSE[s/l7sSYV2cQXmu6_4rJWVIww/.+/]
// TESTRESPONSE[s/949.3kb/\\d+(\\.\\d+)?[mk]?b/]
// TESTRESPONSE[s/474.6kb/\\d+(\\.\\d+)?[mk]?b/]
// TESTRESPONSE[non_json]

...
within an index. See the {ref}/mapping-id-field.html[`_id` field].
// end::id-def[]
...
When you index a <<glossary-document,document>>, {es} adds a document to primary
shards before <<glossary-replica-shard,replica shards>>. See
{ref}/scalability.html[Clusters, nodes, and shards].

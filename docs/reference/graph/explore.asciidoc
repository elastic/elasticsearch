...
[discrete]
[[graph-explore-api-path-params]]
==== {api-path-parms-title}

`<index>`::
(Optional, string) Comma-separated list of indices to search. To search all
indices, omit this parameter or use `*` or `_all`.

`<type>`::
deprecated:[7.0, Mapping types are deprecated. See <<removal-of-types>>.]
(Optional, string) Comma-separated list of <<removal-of-types,napping types>> to
search.

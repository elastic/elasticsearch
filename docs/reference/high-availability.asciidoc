...
[partintro]
--
Your data is important to you, and keeping it safe and available is important
to {es}. Sometimes your cluster may experience hardware failure or a power
loss, and you must plan for this. Fortunately {es} offers a number of features

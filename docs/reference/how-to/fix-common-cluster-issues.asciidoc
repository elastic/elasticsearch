...
To get a more in-depth explanation of each unassigned shard's allocation status,
...
You can often use details in the response to resolve the issue. If the cluster

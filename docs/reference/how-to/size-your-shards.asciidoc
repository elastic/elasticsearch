...
name, encoded using UTF-8. Usually this is not noticeable, but you may need to
account for this overhead if you have very long field names or high field
counts in any of your mappings, or if any of your shards have high segment
counts.

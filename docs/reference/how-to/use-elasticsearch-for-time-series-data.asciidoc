...
== Use {es} for timestamped data

{es} offers features to help you store, manage, and search timestamped data,
...
The content tier is not typically used for timestamped data. However, it's

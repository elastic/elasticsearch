...
When one of the allocation steps fails, {ilm-init} waits for the period in
<<index-lifecycle-step-wait-time-threshold,`index.lifecycle.step.wait_time_threshold`>>.
This period lets the cluster resolve any issues causing the allocation failure
normally. By default, the threshold period is 12 hours. 

...
This enables the shrink and rollover actions to be be performed safely on follower indices.
...
<<ilm-rollover-action, rollover>> and <<ilm-shrink-action, shrink>> actions 

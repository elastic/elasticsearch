...
https://www.elastic.co/blog/managing-and-troubleshooting-elasticsearch-memory[Managing and Troubleshooting Elasticsearch].
...
Create some breathing room for your cluster by adding resources, removing unneeded indices,
or deleting document data.  
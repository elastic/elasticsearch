...
and involve multiple operations against an index, each of these operations are
done in isolation in a unit called a step. This provides better visibility into
the execution of the phases. The

...
indexes in the cold phase should have the lowest values. The recommended values
are 100 for the hot phase, 50 for the warm phase, and 0 for the cold phase.

...
In some cases, `index.lifecycle.indexing_complete` may be set automatically by
other components of Elasticsearch or the Elastic Stack which need to handle
rollover in a particular way.
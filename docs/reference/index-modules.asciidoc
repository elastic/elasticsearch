...
[[index-max-doc-id-length]]
 `index.max_doc_id_length`::
    The maximum byte length of `_id` field of this index. Defaults to 512. This max
    `_id` field length setting is limited by Lucene's maximum term length which is 32766.

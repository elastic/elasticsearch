...
coming[1.4.0.Beta,Prior to 1.4.0 there was only a single circuit breaker for fielddata]
...
`indices.fielddata.breaker.limit`::
    deprecated[1.4.0.Beta,Replaced by `indices.breaker.fielddata.limit`]

`indices.fielddata.breaker.overhead`::
    deprecated[1.4.0.Beta,Replaced by `indices.breaker.fielddata.overhead`]

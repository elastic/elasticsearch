...
If you use <<approximate-knn, approximate k-nearest neighbor search>>,
you might want to set it to vector search files: `["vec", "vex", "vem"]`
...
`["nvd", "dvd", "tim", "doc", "dim", "vec", "vex", "vem"]`, which will preload norms,
doc values, terms dictionaries, postings lists, points, and vector search data
which are the most important parts of the index for search and aggregations.

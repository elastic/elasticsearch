...
TIP: Deleting an index deletes it and its sub-children (e.g. shards, documents). It does 
not delete related objects like index patterns, Kibana visualizations/dashboards.

Deletes an existing index or multiple indices via wildcard.

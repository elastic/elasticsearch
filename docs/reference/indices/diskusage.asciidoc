...
index (or the latest backing index of a data streams) as the API consumes
...
API, this parameter must `true`. Defaults to `false`.
...
--------------------------------------------------
{
    ...
    "my-index-000001": {
        ...
        "all_fields": {
            ...
            "inverted_index": "107.8mb",
            "inverted_index_in_bytes": 113128526,
        ...
        "fields": {
            "_id": {
                ...
                "inverted_index": "29.7mb",
                "inverted_index_in_bytes": 31172745,
            ...
            "context": {
                ...
                "inverted_index": "22mb",
                "inverted_index_in_bytes": 23090908,
                "stored_fields": "0b",

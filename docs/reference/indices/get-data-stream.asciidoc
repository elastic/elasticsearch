...
include::{es-repo-dir}/rest-api/common-parms.asciidoc[tag=include-defaults] experimental:[]
...
`lifecycle`::
(object)
experimental:[] Contains the configuration for the data lifecycle management of this data stream.
+

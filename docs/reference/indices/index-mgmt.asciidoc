...
If you want to explore the documents within an index or data stream, click the compass symbol next to the index or data stream name to open the {kibana-ref}/discover.html[Discover] dashboard.

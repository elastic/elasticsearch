...
To view and explore the documents within an index, click the compass symbol next to the index name to open the {kibana-ref}/discover.html[Discover] dashboard.
...
To view and explore the data within a data stream, click the compass symbol next to the data stream name to open the {kibana-ref}/discover.html[Discover] dashboard.

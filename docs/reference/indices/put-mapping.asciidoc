...
`POST /<target>/_mapping`

deprecated:[7.0]
`PUT /<target>/_mappings`

deprecated:[7.0]
`POST /<target>/_mappings`

{type-dep} `PUT /<target>/<type>/_mapping`

{type-dep} `POST /<target>/<type>/_mapping`

{type-dep} `PUT /<target>/_mapping/<type>`

{type-dep} `POST /<target>/_mapping/<type>`

{type-dep} `PUT /<target>/<type>/_mappings`

{type-dep} `POST /<target>/<type>/_mappings`

{type-dep} `PUT /<target>/_mappings/<type>`

{type-dep} `POST /<target>/_mappings/<type>`

{type-dep} `PUT /_mappings/<type>`

{type-dep} `POST /_mappings/<type>`
...
`<type>`::
{type-dep} (Optional, string) <<removal-of-types,Mapping type>>.

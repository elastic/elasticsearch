...
consider adding an <<alias, `alias`>> field to the index.
// end::rename-field[]
...
While you cannot rename the `user_identifier`,
you can add an alias field
that creates an alternate field name.

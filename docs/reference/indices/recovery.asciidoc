...
--------------------------------------------------
// CONSOLE
// TEST[s/^/POST \/_snapshot\/my_repository\/snap_1\/_restore\?wait_for_completion=true\n/]
// TEST[s/^/DELETE index1\n/]
// TEST[s/^/PUT \/_snapshot\/my_repository\/snap_1\?wait_for_completion=true\n/]
// TEST[s/^/PUT \/_snapshot\/my_repository\n{"type": "fs","settings": {"location": "recovery_asciidoc" }}\n/]

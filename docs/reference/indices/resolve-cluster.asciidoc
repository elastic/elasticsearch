...
will show the cluster as not connected and show an error message for that cluster
indicating that it did not respond. The default is unset and the query can take

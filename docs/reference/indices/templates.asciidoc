...
[settings](https://www.elastic.co/guide/en/elasticsearch/reference/5.5/index-modules.html) 
and [mappings](https://www.elastic.co/guide/en/elasticsearch/reference/current/mapping.html),

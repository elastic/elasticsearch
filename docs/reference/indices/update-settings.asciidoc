...
WARNING: Changing index settings on an automatically closed index using the `reopen`
parameter could result in incorrect settings that are impossible to rectify without

...
manual deployment and apply it to your data at ingestiion time through
...
Finally, use <<semantic-search-semantic-text, semantic text>> to perform
<<emantic-search, semantic search>> on your data.

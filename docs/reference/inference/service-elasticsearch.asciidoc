...
request will automatically download the model if it isn't downloaded yet.
...
The API request below will automatically download and deploy the E5 model if it
isn't already downloaded and deployed.

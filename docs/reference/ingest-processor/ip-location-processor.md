...
If your cluster can’t connect to the Elastic GeoIP endpoint or you want to manage your own updates, see [Manage your own IP geolocation database updates](/reference/ingest-processor/geoip-processor.md#manage-geoip-database-updates).

...
ingest pipeline. Name your pipeline `logs-<dataset-name>-default`. This follows
{fleet}'s naming convention and makes tracking the pipeline for each integration
easier.
+
--

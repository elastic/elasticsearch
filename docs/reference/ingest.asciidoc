...
for the field `address` (if this field does not exist in the index). Note that 
this processor overrides only the `_dynamic_templates` of the field `address`
but leaves the settings of other fields intact.

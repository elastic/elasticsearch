...
The enrich coordinator is an ingest node component that manages and performs the
searches required to enrich documents. It combines searches from all enrich

...
The GeoIP processor includes by default the GeoLite2 data created by MaxMind, available from http://www.maxmind.com[http://www.maxmind
.com]. The databases are licensed under the
http://creativecommons.org/licenses/by-sa/4.0/[Creative Commons Attribution-ShareAlike 4.0 International License].

This processor can run with other geoip2 databases from Maxmind. The files must be copied into the geoip config directory,
...
| `database_file`        | no        | GeoLite2-City.mmdb                                                                 | The database
filename in the geoip config directory. The GeoIP processor ships with the GeoLite2-City.mmdb.gz and GeoLite2-Country.mmdb.gz files.
...
this database is included within Elasticsearch. So this:
...
Note that these settings are node settings and apply to all GeoIP processors, i.e.

...
| `error_distance_in_meters`  | no        | -        | The difference between the resulting inscribed distance from center to side and the circle's radius
include::common-options.asciidoc[]
|======


image:images/spatial/error_distance_in_meters.png[]
...
--------------------------------------------------
{
  ...
  "_primary_term": 1,
  "_source": {
    "circle": "polygon ((30.000365257263184 10.0, 30.000111397193788 9.99965715469059, 29.999706043744222 9.999786428278805, 29.999706043744222 10.000213571721195, 30.000111397193788 10.00034284530941, 30.000365257263184 10.0))"
  }
}
--------------------------------------------------
...
Accuracy of the polygon that represents the circle is defined as `error_distance_in_meters`. The smaller this
...
[options="header"]
|======
| error_distance_in_meters | radius in meters   | number of sides of polygon
| 0.01                     | 0.001              | 4
| 0.01                     | 0.1                | 14
| 0.01                     | 1.0                | 45
| 0.01                     | 10.0               | 141

...
Specifying `mac` will set the target field to the value of `field` if t contains a valid 48-bit MAC Address. Moreover, it would convert the MAC Address in RFC 7042 format.

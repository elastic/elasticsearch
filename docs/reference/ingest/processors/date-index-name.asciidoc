...
[source,console]
--------------------------------------------------
PUT /my-index-000001/_doc/1?pipeline=monthlyindex
{
...
The above request will not index this document into the `my-index-000001` index, but into the `my-index-2016-04-01` index because

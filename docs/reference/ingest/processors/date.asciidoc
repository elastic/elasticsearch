...
| `output_format`        | no        | `yyyy-MM-dd'T'HH:mm:ss.SSSXXX` | The format of the date written to `target_field`. Can be a <<mapping-date-format,java time pattern>> or one of the following formats: ISO8601, UNIX, UNIX_MS, or TAI64N.

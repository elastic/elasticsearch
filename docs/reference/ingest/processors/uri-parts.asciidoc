...
{
  "_source": {
    "input_field": "http://myusername:mypassword@<example-domain>:80/foo.gif?key1=val1&key2=val2#fragment"
  }
}
--------------------------------------------------
// NOTCONSOLE
...
"_source" : {
  ...
  "url" : {
    ...
    "extension" : "gif",
    "password" : "mypassword",
    "original" : "http://myusername:mypassword@<example-domain>:80/foo.gif?key1=val1&key2=val2#fragment",
    "scheme" : "http",
    "port" : 80,

...
* {kibana-ref}/connect-to-elasticsearch.html#upload-data-kibana[File upload]: Use the {kib} file uploader to upload and index various file formats, including CSV, JSON, and log files. The GUI guides you through the index setup process, making it easier to prepare your data for search and exploration."
...
https://www.elastic.co/guide/en/elasticsearch/client/index.html[language client]

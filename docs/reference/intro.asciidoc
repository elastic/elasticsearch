...
* {kibana-ref}/connect-to-elasticsearch.html#upload-data-kibana[File upload]: Use the {kib} file uploader to index single CSV, JSON, or log files for testing and exploration. The GUI guides you through setting up your index and field mappings.

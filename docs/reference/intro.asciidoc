...
as a control center for managing a cluster. Features like
<<index-lifecycle-management,index lifecycle management>> and
<<downsampling,downsampling>> help you to intelligently manage your data over
time.
...
data ingest faster. You can add fields to existing documents without reindexing
your data and calculate field values dynamically at search time.
...
include::mapping/settings-mapping-explosion.asciidoc[]

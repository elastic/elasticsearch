...
<<mapping-shard-field,`_shard`>>::

    A field that stores the shard id of the shard that the document was indexed into.
...
<<mapping-seq-no-field,`_seq_no`>>::

    An internal field that stores a sequence number.

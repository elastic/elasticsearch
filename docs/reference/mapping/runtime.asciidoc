...
parameter to `continue` will have the effect or silently ignoring all errors on
this runtime field. The default setting of `fail` will fail the whole shard request
and is visible in the shard failures in the response.

...
Field types are grouped by _family_. Types in the same family are guaranteed to
support the same search functionality, but may have different space usage or

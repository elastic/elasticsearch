...
Synthetic source always sorts alphabetically and de-duplicates keyword fields.
For example:
[source,console,id=synthetic-source-flattened-example]
----
PUT idx
{
  "mappings": {
...
{
  "keywords": {
    "apple", "apple", "banana", "avocado", "10", "200", "AVOCADO", "Banana", "Tangerine"
  }
}
----
...
----
{
  "keywords": ["10", "200", "AVOCADO", "Banana", "Tangerine", "apple", "avocado", "banana"]
}
----
// TEST[s/^/{"_source":/ s/\n$/}/]
...
Will become (note the nested objects instead of the "keywords" array):
[source,console-result]
----
{
  "keywords": {

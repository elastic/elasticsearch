...
// tag::geoshape-dateline-orientation[]
Geoshapes that cross the international dateline (+/-180° longitude) must use a
`RIGHT` or equivalent `orientation`. Otherwise, `geo_shape` queries that match
the geoshape may return unexpected results.
// end::geoshape-dateline-orientation[]
| `RIGHT`

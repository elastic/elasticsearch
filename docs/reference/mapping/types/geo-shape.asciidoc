...
<<geo-shape-mapping-options,`orientation` mapping parameter>>. The WKT
specification doesn't specify or enforce a default orientation.

GeoJSON polygons use a default orientation of `RIGHT`, regardless of
`orientation` mapping parameter. The

...
`script`::
    ...
    Configures the field to index values generated by this script, rather
    than reading the values directly from the source.  Scripts are in the
    same format as their <<runtime-mapping-fields,runtime equivalent>>.

...
[source,js]
--------------------------------------------------
PUT my_index/_doc/match_value?include_type_name=false
{
    "query" : {
        "match" : {
            "field" : "value"
...
PUT queries/_doc/1?refresh&include_type_name=false
{
  "query" : {
    "match" : {
...
[source,js]
--------------------------------------------------
PUT new_index?include_type_name=false
{
  "mappings": {
    "properties": {
      "query" : {
...
[source,js]
--------------------------------------------------
GET /queries/_search?include_type_name=false
{
  "query": {
    "percolate" : {
      "field" : "query",
...
[source,js]
--------------------------------------------------
PUT /test_index?include_type_name=false
{
  "settings": {
    "analysis": {
      "analyzer": {
...
[source,js]
--------------------------------------------------
PUT /test_index/_doc/1?refresh&include_type_name=false
{
  "query" : {
    "match" : {
      "body" : {
...
[source,js]
--------------------------------------------------
PUT my_queries1?include_type_name=false
{
  "settings": {
    "analysis": {
      "analyzer": {
...
[source,js]
--------------------------------------------------
PUT /my_queries1/_doc/1?refresh&include_type_name=false
{
  "query": {
    "term": {
      "my_field.prefix": "abc"
...
[source,js]
--------------------------------------------------
GET /my_queries1/_search?include_type_name=false
{
  "query": {
    "percolate": {
      "field": "query",
...
[source,js]
--------------------------------------------------
PUT my_queries2?include_type_name=false
{
  "settings": {
    "analysis": {
      "analyzer": {
...
[source,js]
--------------------------------------------------
PUT /my_queries2/_doc/2?refresh&include_type_name=false
{
  "query": {
    "match": { <1>
      "my_field.suffix": "xyz"
...
[source,js]
--------------------------------------------------
GET /my_queries2/_search?include_type_name=false
{
  "query": {
    "percolate": {
      "field": "query",

...
Use the `wildcard` type if you plan to regularly search the field for partial
character sequences using a <<query-dsl-wildcard-query,`wildcard`>> or
<<query-dsl-regexp-query,`regexp`>> query and meet one of the following
criteria:

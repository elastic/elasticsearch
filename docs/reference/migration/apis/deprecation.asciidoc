  ...
  "cluster_settings" : [
    {
      ...
      "url" : "{ref-60}/breaking-changes-7.0.html#_literal_literal_is_no_longer_allowed_in_cluster_name",
    ...
    "logs:apache" : [
      {
        ...
        "url" : "{ref-60}/breaking-changes-7.0.html#_literal_literal_is_no_longer_allowed_in_index_name",

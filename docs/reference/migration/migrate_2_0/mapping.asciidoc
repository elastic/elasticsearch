...
Fields of type `attachment` used to index their content in the "main"
multi-field -- a sub-field with the same name as the main field, e.g.
`my_attachment.my_attachment`.  This sub-field will be renamed to
`my_attachment.content`.   Any mapping settings (e.g. `analyzer`) on the old
`my_attachment.my_attachment` field will be lost. In this case, the index

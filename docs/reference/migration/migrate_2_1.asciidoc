...
The MoreLikeThis builders have been moved to their own org.elasticsearch.index.query.morelikethis
package. MoreLikeThisQueryBuilder.Item has been moved to its own class.

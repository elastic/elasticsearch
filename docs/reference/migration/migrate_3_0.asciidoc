...
The directory structure inside the zip has changed. The zip must contain a top-level folder titled `elasticsearch` and
only one sub-folder titled after the name of the plugin. If you use the gradle build, this structure is automatically
generated.

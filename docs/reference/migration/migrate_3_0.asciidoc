...
`-E es.name.of.property=value.of.property`. Note that in all cases the
name of the property must be prefixed with `es.`.
...
setting settings via `--name.of.property value.of.property`. This feature

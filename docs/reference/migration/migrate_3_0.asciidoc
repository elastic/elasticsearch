...
The `string` field type is not supported anymore. Instead, a `text` field should be
used when an `analyzed` string field was used before, and a `keyword` field should
be used in the `not_anayzed` case.

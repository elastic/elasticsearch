...
The default scripting language for Elasticsearch is now Painless.  Painless is a language similar to Groovy, except
faster and more secure.  Many Groovy scripts will be identitical to Painless scripts to help make the transition
between languages as simple as possible.
...
One common difference to note between Groovy and Painless is the user of parameters -- all parameters in Painless

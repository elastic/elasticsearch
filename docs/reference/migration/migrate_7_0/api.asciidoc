...
+
Use the <<indices-get-index,get index API>> with the `human` parameter to get
the version in which an index was created:
+
--
.*API Example*
[%collapsible]
...
// TESTRESPONSE[s/"created_string": "6.0.0"/"created_string": $body.my-index-000001.settings.index.version.created_string/]
// TESTRESPONSE[s/"created": "6000099"/"created": $body.my-index-000001.settings.index.version.created/]

<1> This index was created in {es} 6.0.0.
====
--

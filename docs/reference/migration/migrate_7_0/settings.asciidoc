...
newer TLS versions, this setting is required. 
...
connects does not support newer TLS versions, this setting is required.
...
TLS versions, this setting is required.
...
to connect to a remote authorization server which does not support newer TLS
versions, this setting is required.
...
equipment which inspects TLS packets between your nodes, this setting is
required.

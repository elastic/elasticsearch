...
connects does not support newer TLS versions, tyou must update this setting.
...
equipment which inspects TLS packets between your nodes, you must update this
setting.

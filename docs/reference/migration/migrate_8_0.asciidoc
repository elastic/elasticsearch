...
====
*Details* +
The setting `max_merge_at_once_explicit` is deprecated as this setting has
been removed in Lucene 9.

*Impact* +
You should remove the setting `max_merge_at_once_explicit` from your
configuration.
====
...
*Impact* +
You should remove the setting `indices.query.bool.max_clause_count` from
your configuration.
====

...
*Impact* +
Refer to {ref}/filesystem-repository-settings.html[Shared file system repository
settings] for information on the `compress` setting. Use the repository specific
`compress` setting to enable compression. See

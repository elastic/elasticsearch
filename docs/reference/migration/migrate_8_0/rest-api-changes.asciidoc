...
IMPORTANT: For the {ref}/eql-search-api.html[EQL search API] specific limitations apply,
see {ref}/eql-search-api.html#run-eql-search-across-clusters[Run an EQL search across clusters]

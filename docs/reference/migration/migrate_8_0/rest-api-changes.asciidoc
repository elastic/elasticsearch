...
in the previous major version. However, such searches can result in undefined
behavior, particularly if the search uses a recent feature that's unsupported

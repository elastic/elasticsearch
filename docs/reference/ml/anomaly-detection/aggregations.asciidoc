...
the field it operates on. You can define the aggregated fields in the 
`analysis_config` object of the {anomaly-job}. The job analyzes only the fields 
that you provided in the configuration.

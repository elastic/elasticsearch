...
----
{
  ...
  "limits" : {
    "current_effective_max_model_memory_limit": "28961mb"
  }
}
----
...
// TESTRESPONSE[s/"current_effective_max_model_memory_limit": "28961mb"/"current_effective_max_model_memory_limit": "$body.limits.current_effective_max_model_memory_limit"/]

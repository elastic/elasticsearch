...
deprecated:[7.11.0, "Posting data directly to anomaly detection jobs is deprecated, in a future major version a <<ml-put-datafeed-request-body,{dfeed}>> will be required."]

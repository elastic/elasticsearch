...
which enables you to configure the {dfeed} to look in the past for delayed data.
Every 15 minutes or every `check_window`, whichever is smaller, the {dfeed}
...
action to consider is to increase the `query_delay` of the {dfeed}. This

...
still significantly less than your total number of documents, use <<search-aggregations-bucket-composite-aggregation,composite
aggregations>>
...
aggregations. See <<composite aggregations and pipeline aggs,search-aggregations-bucket-composite-aggregation.html#_pipeline_aggregations>>

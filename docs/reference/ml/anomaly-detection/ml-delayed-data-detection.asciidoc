...
`Datafeed has missed XXXX documents due to ingest latency`, check whether your 
ingest pipeline delays indexing. If your ingest pipeline works as expected, 
consider increasing the valuse of `query_delay`.

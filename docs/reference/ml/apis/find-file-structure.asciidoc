...
`line_merge_size_limit`::
  ...
  merged to form messages while analyzing semi-structured files. The default is
  10000. If you have extremely long messages you may need to increase this, but

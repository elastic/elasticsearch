...
`end`::
  (string) Optional. The time that the {dfeed} should end. This value is
  exclusive. The default value is an empty string.

`start`::
  (string) Optional. The time that the {dfeed} should begin. This value is
  inclusive. The default value is an empty string.

`timeout`::
  (time) Optional. Controls the amount of time to wait until a {dfeed} starts.

...
When {security-features} are enabled, your {dfeed} will remember which roles the
last user to create or update it had at the time of creation/update, and run the

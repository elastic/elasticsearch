...
{classification}, {oldetection}, or {regression}.
//include::{docdir}/ml/ml-shared.asciidoc[tag=analysis]

`analysis`.`classification`:::
(Required, object)footnote:disclaimer[The analysis object must contain only one type of analysis: classification, regression, or outlier_detection.]
...
(Required, object)footnote:disclaimer[]
The configuration information necessary to perform

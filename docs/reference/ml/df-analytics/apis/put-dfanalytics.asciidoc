...
`dest`::
  ...
  `index`:::
    (Required, string) The _destination index_ for the {dfanalytics}.
...
`source`::
  ...
  `query`::
    ...
    search POST body. All the options that are supported by {es} can be used, as 
    this object is passed verbatim to {es}. By default, this property has the 

...
When the load is less than 85% of the current capacity, a model allocation is automatically removed (respecting the value of `min_number_of_allocations` if it's set).

...
training times.
//TBD: but potentially reduce accuracy?
Values must be greater than or equal to zero. By default, this value is calculated during hyperparameter optimization.
end::dfas-alpha[]
...
individual trees in the forest. A high gamma value causes training to prefer 
small trees. A small gamma value results in larger individual trees and slower 
training. By default, this value is calculated during hyperparameter optimization.
end::gamma[]

...
deprecated:[8.1, "Setting `bucket_span` to a value that is neither an integral multiple
nor divisor of a day is deprecated and will be disallowed in a future major version."]
end::bucket-span[]

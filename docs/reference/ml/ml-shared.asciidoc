...
the value most likely to replace `[MASK]`. In this instance, hopefully the
...
`classification_labels` Inside-Outside-Beginning formatted labels. Also, only
person, organization, location, and miscilaneous are supported.

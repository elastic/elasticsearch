...
`input`:::
(object)
Object containing the input fields of the model.

`input.field_names`:::
(array)
Collection of objects containing field names and their type.

   `input.field_names.field_name`::::
   (string)
   The input field name

   `input.field_names.field_type`::::
   (string)
   The input field type. Can be one of: `scalar`, `categorical`, `vector`, `text`.

[role="xpack"]
[[ml-update-trained-model-deployment]]
...
[[ml-update-trained-model-deployment-request]]
== {api-request-title}

`POST _ml/trained_models/<model_id>/deployment/_update`


[[ml-update-trained-model-deployments-prereqs]]
== {api-prereq-title}

Requires the `manage_ml` cluster privilege. This privilege is included in the
`machine_learning_admin` built-in role.

[[ml-update-trained-model-deployment-desc]]
...
[[ml-update-trained-model-deployments-path-parms]]
...
[[ml-update-trained-model-deployment-request-body]]
== {api-request-body-title}

The following property can be updated after the trained model deployment is started:
...
[[ml-update-trained-model-deployment-example]]
== {api-examples-title}

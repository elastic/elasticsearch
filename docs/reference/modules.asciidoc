...
<<modules-cluster-coordination,Cluster coordination>>::

    How the cluster elects a master node and manages the cluster state
...
include::modules/coordination.asciidoc[]

...
deprecated::[9.0.0,"Certificate based authentication is deprecated.
Configure <<remote-clusters-api-key,API key authentication>> instead or follow a guide on how to

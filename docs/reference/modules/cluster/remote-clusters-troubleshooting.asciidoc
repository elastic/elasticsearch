...
----
[2023-06-28T16:36:47,264][WARN ][o.e.t.ProxyConnectionStrategy] [node] failed to open any proxy connections to cluster [my]
org.elasticsearch.transport.ConnectTransportException: [][127.0.0.1:9400] *connect_exception*
----

When the remote cluster is configured using sniff mode:
[source,txt,subs=+quotes]
----
[2023-06-28T16:38:37,731][WARN ][o.e.t.SniffConnectionStrategy] [node] fetching nodes from external cluster [my] failed
org.elasticsearch.transport.ConnectTransportException: [][127.0.0.1:9400] *connect_exception*
----
...
[source,txt,subs=+quotes]
----
[2023-06-28T12:48:46,575][WARN ][o.e.c.s.DiagnosticTrustManager] [node] *failed to establish trust with server* at [127.0.0.1]; the server provided a certificate with subject name [CN=transport], fingerprint [c43e628be2a8aaaa4092b82d78f2bc206c492322], no keyUsage and no extendedKeyUsage; the certificate is valid between [2023-01-29T12:05:53Z] and [2032-08-29T12:05:53Z] (current time is [2023-06-28T02:48:46.574738Z], certificate dates are valid); the session uses cipher suite [TLS_AES_256_GCM_SHA384] and protocol [TLSv1.3]; the certificate has subject alternative names [DNS:localhost,DNS:localhost6.localdomain6,IP:127.0.0.1,IP:0:0:0:0:0:0:0:1,DNS:localhost4,DNS:localhost6,DNS:localhost.localdomain,DNS:localhost4.localdomain4]; the certificate is issued by [CN=Elastic Auto Transport CA] but the server did not provide a copy of the issuing certificate in the certificate chain; this ssl context ([xpack.security.remote_cluster_client.ssl (with trust configuration: PEM-trust{/rcs2/ssl/remote-cluster-ca.crt})]) is not configured to trust that issuer, it only trusts the issuer [CN=Elastic Auto RemoteCluster CA] with fingerprint [ba2350661f66e46c746c1629f0c4b645a2587ff4]
...
[source,txt,subs=+quotes]
----
[2023-06-28T12:48:46,584][WARN ][o.e.x.c.s.t.n.SecurityNetty4Transport] [node-9] *client did not trust this server's certificate*, closing connection Netty4TcpChannel{localAddress=/127.0.0.1:9309, remoteAddress=/127.0.0.1:60810, profile=default}
----
...
[source,txt,subs=+quotes]
----
[2023-06-28T12:43:30,705][WARN ][o.e.t.TcpTransport       ] [node] exception caught on transport layer [Netty4TcpChannel{localAddress=/127.0.0.1:60738, remoteAddress=/127.0.0.1:9309, profile=_remote_cluster}], closing connection
...
[source,txt,subs=+quotes]
----
[2023-06-28T12:43:30,772][WARN ][o.e.t.TcpTransport       ] [node-9] exception caught on transport layer [Netty4TcpChannel{localAddress=/127.0.0.1:9309, remoteAddress=/127.0.0.1:60783, profile=default}], closing connection
...
[source,txt,subs=+quotes]
----
[2023-06-28T13:04:52,710][WARN ][o.e.t.ProxyConnectionStrategy] [node] failed to open any proxy connections to cluster [my]
org.elasticsearch.transport.RemoteTransportException: [node-9][127.0.0.1:9309][cluster:internal/remote_cluster/handshake]
...
[source,txt,subs=+quotes]
----
[2023-06-28T13:09:52,031][WARN ][o.e.t.ProxyConnectionStrategy] [node] failed to open any proxy connections to cluster [my]
org.elasticsearch.transport.RemoteTransportException: [node-9][127.0.0.1:9309][cluster:internal/remote_cluster/handshake]
...
[source,txt,subs=+quotes]
----
[2023-06-28T12:52:16,914][WARN ][o.e.x.c.s.t.n.SecurityNetty4Transport] [node-9] *client did not trust this server's certificate*, closing connection Netty4TcpChannel{localAddress=/127.0.0.1:9400, remoteAddress=/127.0.0.1:60981, profile=_remote_cluster}
----
...
[source,txt,subs=+quotes]
----
[2023-06-29T09:40:55,465][WARN ][o.e.c.s.DiagnosticTrustManager] [node] *failed to establish trust with server* at [127.0.0.1]; the server provided a certificate with subject name [CN=remote_cluster], fingerprint [529de35e15666ffaa26afa50876a2a48119db03a], no keyUsage and no extendedKeyUsage; the certificate is valid between [2023-01-29T12:08:37Z] and [2032-08-29T12:08:37Z] (current time is [2023-08-16T23:40:55.464275Z], certificate dates are valid); the session uses cipher suite [TLS_AES_256_GCM_SHA384] and protocol [TLSv1.3]; the certificate has subject alternative names [DNS:localhost,DNS:localhost6.localdomain6,IP:127.0.0.1,IP:0:0:0:0:0:0:0:1,DNS:localhost4,DNS:localhost6,DNS:localhost.localdomain,DNS:localhost4.localdomain4]; the certificate is issued by [CN=Elastic Auto RemoteCluster CA] but the server did not provide a copy of the issuing certificate in the certificate chain; this ssl context ([(shared) (with trust configuration: JDK-trusted-certs)]) is not configured to trust that issuer but trusts [97] other issuers
sun.security.validator.ValidatorException: PKIX path building failed: sun.security.provider.certpath.SunCertPathBuilderException: unable to find valid certification path to requested target
----
...
[source,txt,subs=+quotes]
----
[2023-06-29T09:40:55,478][WARN ][o.e.x.c.s.t.n.SecurityNetty4Transport] [node-9] *client did not trust this server's certificate*, closing connection Netty4TcpChannel{localAddress=/127.0.0.1:9400, remoteAddress=/127.0.0.1:57305, profile=_remote_cluster}
----
...
Often, the issue is on the local cluster. Fix it by either configuring necessary
trusted CAs (`xpack.security.remote_cluster_client.ssl.certificate_authorities`)
or adjusting the verification mode
...
[source,txt,subs=+quotes]
----
[2023-06-28T13:26:53,962][WARN ][o.e.t.ProxyConnectionStrategy] [node] failed to open any proxy connections to cluster [my]
org.elasticsearch.transport.RemoteTransportException: [node-9][127.0.0.1:9400][cluster:internal/remote_cluster/handshake]
...
[source,txt,subs=+quotes]
----
[2023-06-28T13:22:58,264][WARN ][o.e.t.ProxyConnectionStrategy] [node] failed to open any proxy connections to cluster [my]
org.elasticsearch.transport.RemoteTransportException: [node-9][127.0.0.1:9400][cluster:internal/remote_cluster/handshake]
...
[source,txt,subs=+quotes]
----
[2023-06-28T13:24:38,744][WARN ][o.e.x.s.a.ApiKeyAuthenticator] [node-9] *Authentication using apikey failed* - invalid credentials for API key [agZXJocBmA2beJfq2yKu]
----
...
[source,console-result,subs=+quotes]
----
{

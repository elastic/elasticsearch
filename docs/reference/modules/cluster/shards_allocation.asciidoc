...
default values are generally good, and although different values may improve the current
balance it is possible that they create problems in the future if the cluster or
workload changes.

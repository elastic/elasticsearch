...
[source,js]
--------------------------------------------------
# Allow the selected nodes back into the voting configuration by removing their
# tombstones
...
{
  "master_nodes":[
    {"id":"gAMDNeJRTX6A_VelgSb84g","name":"master-a"},
    {"id":"t3LZCVGxTf-idQIC8z4A1A","name":"master-b"},
    {"id":"GfwXZYVVSFCOWNT0zcDixQ","name":"master-c"}
  ]
}
--------------------------------------------------
// CONSOLE

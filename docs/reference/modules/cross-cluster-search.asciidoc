...
| 7.8.0             | 7.3.0        | 7.8.0     | During the upgrade
| 7.8.0             | 7.8.0        | 7.3.0     | During the upgrade
| 7.8.0             | 6.8.10       | 7.8.0     | During the upgrade
| 7.8.0             | 7.8.0        | 6.8.10    | During the upgrade
| 6.8.10            | 7.last       | 8.0.0     | No
| 8.0.0             | 7.last       | 6.8.10    | No
|====

WARNING: "Chaining" major versions is not supported. An 8.0.0 coordinating node
         can talk to a 7.last gateway node without any trouble. And a 7.last
         gateway node can talk to a 6.8.10 data node. But playing
         https://en.wikipedia.org/wiki/Chinese_whispers[telephone] across all
         three nodes versions is not supported. We don't check for and forbid
         it so it *may* work for some requests but it is totally untested.
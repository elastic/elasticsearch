...
[source,js]
--------------------------------------------------
POST /cluster_two:twitter,twitter/tweet/_search
{
  "query": {
    "match_all": {}
  }
...
--------------------------------------------------
// TESTRESPONSE[s/"took": 89,/"took": "$body.took",/]
<1> The `clusters` section gets returned indicating that one cluster was unavailable and got skipped

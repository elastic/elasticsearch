...
(<<static-cluster-setting,Static>>)
Sets the interval of the check that warns that seed hosts (see
`discovery.seed_providers` and `discovery.seed_hosts`) have been defined for a
fully-formed single-node cluster. The default value is `30s`.

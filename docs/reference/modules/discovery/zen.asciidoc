...
for all nodes to respond added[0.90.6], up to a timeout, before going ahead
processing the next updates in the queue. The `discovery.zen.publish_timeout`
is set by default to 30 seconds added[0.90.8, previously set to 5 seconds].

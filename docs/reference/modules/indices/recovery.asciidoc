...
(<<cluster-update-settings,Dynamic>>, Expert) The name of the repository to use
when `indices.recovery.use_snapshots` is enabled. Defaults to `null` which
means to search all registered repositories for a suitable snapshot.

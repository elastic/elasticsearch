...
[role="xpack"]
<<machine-learning-node,Machine learning node>>image:images/xpackicon.png[X-Pack,title="X-Pack"]::
...
=== Machine learning node image:images/xpackicon.png[X-Pack,title="X-Pack"]

...
standalone master-eligible node when {xpack} is installed, see <<modules-node-xpack>>.
endif::include-xpack[]
...
ifdef::include-xpack[]
NOTE: These settings apply only when {xpack} is not installed. To create a
dedicated data node when {xpack} is installed, see <<modules-node-xpack>>.
endif::include-xpack[]
...
ifdef::include-xpack[]
NOTE: These settings apply only when {xpack} is not installed. To create a
dedicated ingest node when {xpack} is installed, see <<modules-node-xpack>>.
endif::include-xpack[]
...
ifdef::include-xpack[]
NOTE: These settings apply only when {xpack} is not installed. To create a
dedicated coordinating node when {xpack} is installed, see <<modules-node-xpack>>.
endif::include-xpack[]

...
If you are still using elasticsearch 1.3.0 or lesser, plugin script uses older deprecated options:

[source,shell]
-----------------------------------
# Before 1.4.0, install was --install
...
# Before 1.4.0, uninstall was --remove

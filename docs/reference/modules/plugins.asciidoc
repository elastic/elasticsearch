...
==== Misc ElasticSearch Clients

.Supported by the community

* https://github.com/reachkrishnaraj/kafka-elasticsearch-standalone-consumer[Kafka ElasticSearch Standalone Consumer]: (by Krishna Raj)

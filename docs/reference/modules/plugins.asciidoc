...
be found under the https://github.com/elastic/elasticsearch[elasticsearch]
...
* https://github.com/OlegKunitsyn/elasticsearch-browser[Elasticsearch Browser Plugin] (by Oleg Kunitsyn)

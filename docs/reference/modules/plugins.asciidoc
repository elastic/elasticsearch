...
If you are still using elasticsearch before 2.0.0, plugin script uses older deprecated options:

[source,shell]
-----------------------------------
# Before 2.0.0, install was --install
...
# Before 2.0.0, uninstall was --remove

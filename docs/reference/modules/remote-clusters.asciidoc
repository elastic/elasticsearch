...
communicate with 6.7. 

IMPORTANT: Individual cross-cluster features may impose stricter compatibility 
constraints.  See <<ccs-supported-configurations>> and <<ccr-cluster-compatibility>>.

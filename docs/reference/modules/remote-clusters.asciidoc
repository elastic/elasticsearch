...
major version. Note that in the 6.x series, both 6.7 and 6.8 can communicate
with any 7.x node, rather than only 6.8, as 6.8 was released after 7.0. Version
compatibility  is symmetric, meaning that if 6.7 can communicate with 7.0, 7.0
can also communicate with 6.7. The matrix below summarizes compatibility as
described above.

[cols="^,^,^,^,^,^"]
|====
| Compatibility | 5.0->5.5 | 5.6 | 6.0->6.6 | 6.7->6.8 | 7.0->7.x
| 5.0->5.5      |    Yes   | Yes |    No    |    No    |    No
| 5.6           |    Yes   | Yes |    Yes   |    Yes   |    No
| 6.0->6.6      |    No    | Yes |    Yes   |    Yes   |    No
| 6.7->6.8      |    No    | Yes |    Yes   |    Yes   |    Yes
| 7.0->7.x      |    No    | No  |    No    |    Yes   |    Yes
|====

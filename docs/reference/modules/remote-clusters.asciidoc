...
version can communicate with nodes on the following major version: 6.7 can
communicate with 7.0, as well as any 7.x node, while 6.6 or earlier cannot
talk to any 7.x node; note that 7.1, which was released after 7.0, cannot
talk to 7.0 but rather to 7.1 and later. Note that version compatibility
...
| 6.7           |    No    | Yes |    Yes   | Yes | Yes | Yes |    Yes
| 6.8           |    No    | Yes |    Yes   | Yes | Yes | No  |    Yes
| 7.0           |    No    | No  |    No    | Yes | No  | Yes |    Yes
| 7.1->7.x      |    No    | No  |    No    | Yes | Yes | Yes |    Yes
|====

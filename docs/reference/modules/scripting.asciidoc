...
used in `script_score`, `script_fields` and numeric aggregation scripts.

See the link:http://lucene.apache.org/core/4_9_0/expressions/index.html?org/apache/lucene/expressions/package-summary.html[expressions module documentation]

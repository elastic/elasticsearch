...
as part of the setting will be allowed to be executed.
...
By default all script contexts are allowed to be executed.  This can modified using the
setting `script.allowed_contexts`.  Should this setting be used, only the contexts specified
as part of the setting will be allowed to be executed.

...
|`transport.ping_schedule` | Schedule a regular pinger message to ensure that connections are kept alive. Defaults to `5s` in the transport client and `-1` (disabled) elsewhere.

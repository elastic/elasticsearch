...
IMPORTANT: Ensure the current master elected is being monitored. Monitoring page in Kibana won't show the production cluster metrics unless metricbeat in the master node is sending data. 

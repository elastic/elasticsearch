...
If you are interested in similar capabilities,
https://support.elastic.co/customers/s/login/[Elastic Support portal][contact
Elastic Support] to discuss available options.
====

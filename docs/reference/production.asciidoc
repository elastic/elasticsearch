...
// these could be rearranged by "type" of security concern, but there are a LOT of topics to list if we split them that way
...
| {ece-ref}/Elastic-Cloud-Enterprise-overview.html[*Elastic Cloud Enterprise*]
| {ece-ref}/ece-securing-ece.html[Secure your clusters]
...
| {ece-ref}/Elastic-Cloud-Enterprise-overview.html[*Elastic Cloud Enterprise*]
| {ece-ref}/ece-securing-ece.html[Securing your installation]
...
https://www.elastic.co/guide/en/cloud-enterprise/current/ece-monitoring-ece.html[Monitor Elastic Cloud Enterprise]
https://www.elastic.co/guide/en/cloud-enterprise/current/ece-enable-logging-and-monitoring.html[Enable logging and monitoring in Elastic Cloud Enterprise]


https://www.elastic.co/guide/en/cloud/current/ec-monitoring.html[Monitor Elastic Cloud Hosted]


https://www.elastic.co/guide/en/cloud-on-k8s/master/k8s-stack-monitoring.html[Monitor Elastic Cloud on Kubernetes]
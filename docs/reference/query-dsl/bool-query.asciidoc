...
queries to track which queries matched documents returned by a search. If named
queries are used, the response includes a `matched_queries` property for each
hit.

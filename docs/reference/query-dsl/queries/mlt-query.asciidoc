...
coming[1.2.0,The ability to run the `mlt` query on multiple docs is only available from 1.2.0 onwards]
...
|`ids` or `docs` | coming[1.2.0] A list of documents following the same syntax as the

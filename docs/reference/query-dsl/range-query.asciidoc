...
+
--
Rounds up to the first nanosecond not covered by the rounded date.
...
+
--
Rounds down to the first nanosecond.
...
+
--
Rounds down to the first nanosecond before the rounded value.
...
+
--
Rounds up to the lastest nanosecond.

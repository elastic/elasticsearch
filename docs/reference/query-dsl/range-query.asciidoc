...
When a millisecond part will not be provided, it will be rounded to `999`.
...
A date `2020-01-01T12:00:00Z` will have a fraction of a second part defaulted to `2020-01-01T12:00:00.999_999_999Z`.

...
By default {es} is rounding dates when date fields are not present. For instance when a millisecond part will not be provided, will be rounded to `999`.
For instance:
```
"datetime": {
...
```
A date `2020-01-01T12:00:00Z` will be rounded to `2020-01-01T12:00:00.999_999_999Z`

...
--------------------------------------------------
{
  "query": {
    "script_score": {
      ...
      "script": {
        "source": "dotProduct(params.queryVector, doc['my_dense_vector'].value)",
        "params": {
...
--------------------------------------------------
{
  "query": {
    "script_score": {
      ...
      "script": {
        "source": "dotProductSparse(params.queryVector, doc['my_sparse_vector'].value)",
        "params": {
          "queryVector": {"2": -0.5, "10" : 111.3, "50": -13.0, "113": 14.8, "4545": -156.0}
        }
      }
...
Be aware, if a document doesn't have a value for a vector field on which
a distance function is executed, an error will be thrown. You can
guard against missing values as shown below, and provide your own
custom score for this case.
...
--------------------------------------------------
{
  "query": {
    "script_score": {
      ...
      "script": {
        "source": "doc['my_dense_vector'].value == null ? 0 : cosineSimilarity(params.query_vector, doc['my_dense_vector'].value)",
        "params": {
          "queryVector": [4, 3.4, -1.2]
        }
      }

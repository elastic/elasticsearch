...
<<query-dsl-vector-similarity-query,`vector_similarity` query>>::
A query that finds documents with vector values with at least the provided
similarity.
...
include::vector-similarity-query.asciidoc[]

...
::::{note}
{{esql}} respects [runtime fields](/reference/elasticsearch/mapping-reference/runtime-fields.md) defined in the index mapping, but does not support defining new runtime fields at search time. Use `EVAL` to create computed columns at query time instead.
::::

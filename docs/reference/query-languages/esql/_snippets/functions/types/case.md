...
| boolean | histogram {applies_to}`stack: preview 9.3.0, ga 9.4.0` | histogram {applies_to}`stack: preview 9.3.0, ga 9.4.0` | histogram |
| boolean | histogram {applies_to}`stack: preview 9.3.0, ga 9.4.0` | | histogram |
...
| boolean | long | | long |
| boolean | tdigest {applies_to}`stack: preview 9.3.0, ga 9.4.0` | tdigest {applies_to}`stack: preview 9.3.0, ga 9.4.0` | tdigest |
| boolean | tdigest {applies_to}`stack: preview 9.3.0, ga 9.4.0` | | tdigest |

...
| exponential_histogram {applies_to}`stack: preview 9.3.0` | time_duration {applies_to}`stack: preview 9.3.0` | double |
| integer | time_duration {applies_to}`stack: preview 9.3.0` | long |
| long | time_duration {applies_to}`stack: preview 9.3.0` | long |
| tdigest {applies_to}`stack: preview 9.3.0` | time_duration {applies_to}`stack: preview 9.3.0` | double |

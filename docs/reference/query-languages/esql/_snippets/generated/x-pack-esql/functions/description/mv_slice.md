...
[`SPLIT`](/reference/query-languages/esql/functions-operators/string-functions/split.md) or [`MV_SORT`](/reference/query-languages/esql/functions-operators/mv-functions/mv_sort.md).

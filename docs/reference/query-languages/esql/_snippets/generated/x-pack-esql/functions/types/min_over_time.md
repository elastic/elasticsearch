...
| exponential_histogram {applies_to}`stack: preview 9.3.0, ga 9.4.0` | time_duration {applies_to}`stack: preview 9.3.0` | double |
...
| tdigest {applies_to}`stack: preview 9.3.0, ga 9.4.0` | time_duration {applies_to}`stack: preview 9.3.0` | double |

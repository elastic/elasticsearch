* [`ABSENT`](../../functions-operators/aggregation-functions/absent.md) {applies_to}`stack: ga 9.2`
...
* [`EARLIEST`](../../functions-operators/aggregation-functions.md#esql-earliest) {applies_to}`stack: ga 9.4` {applies_to}`serverless: preview`
...
* [`LATEST`](../../functions-operators/aggregation-functions.md#esql-latest) {applies_to}`stack: ga 9.4` {applies_to}`serverless: preview`
...
* [`SUM`](../../functions-operators/aggregation-functions/sum.md)
* [`TOP`](../../functions-operators/aggregation-functions/top.md)

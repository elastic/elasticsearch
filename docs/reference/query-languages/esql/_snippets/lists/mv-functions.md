...
* [`MV_GREATER`](../../functions-operators/mv-functions/mv_greater.md) {applies_to}`stack: preview 9.6` {applies_to}`serverless: preview`
...
* [`MV_LESS`](../../functions-operators/mv-functions/mv_less.md) {applies_to}`stack: preview 9.6` {applies_to}`serverless: preview`

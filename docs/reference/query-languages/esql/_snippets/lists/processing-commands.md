...
* [`METRICS_INFO`](/reference/query-languages/esql/commands/metrics-info.md) {applies_to}`stack: preview 9.4` {applies_to}`serverless: preview`
...
* [`TS_INFO`](/reference/query-languages/esql/commands/ts-info.md) {applies_to}`stack: preview 9.4` {applies_to}`serverless: preview`

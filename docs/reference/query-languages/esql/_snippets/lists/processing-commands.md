...
* [`DENSE_VECTOR`](/reference/query-languages/esql/commands/dense-vector.md) {applies_to}`stack: preview 9.6` {applies_to}`serverless: preview`
...
* [`SAMPLE`](/reference/query-languages/esql/commands/sample.md) {applies_to}`stack: preview 9.1-9.4` {applies_to}`stack: ga 9.5`

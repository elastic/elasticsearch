...
* [`PERCENTILE_OVER_TIME`](../../functions-operators/time-series-aggregation-functions.md#esql-percentile_over_time) {applies_to}`stack: preview 9.2` {applies_to}`serverless: preview`

...
* [`DELTA`](../../functions-operators/time-series-aggregation-functions.md#delta) {applies_to}`stack: preview 9.2` {applies_to}`serverless: preview`
...
* [`IDELTA`](../../functions-operators/time-series-aggregation-functions.md#idelta) {applies_to}`stack: preview 9.2` {applies_to}`serverless: preview`
* [`INCREASE`](../../functions-operators/time-series-aggregation-functions.md#increase) {applies_to}`stack: preview 9.2` {applies_to}`serverless: preview`
* [`IRATE`](../../functions-operators/time-series-aggregation-functions.md#irate) {applies_to}`stack: preview 9.2` {applies_to}`serverless: preview`

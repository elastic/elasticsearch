...
* [Filter rows with IN subqueries](/reference/query-languages/esql/esql-in-subquery.md): Learn how to filter rows in the `WHERE` command using the results of another query. {applies_to}`stack: preview 9.5.0` {applies_to}`serverless: preview`

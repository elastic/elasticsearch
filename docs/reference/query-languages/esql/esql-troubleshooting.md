...
- [Query logging](docs-content://deploy-manage/monitor/logging-configuration/query-logs.md): Log all query types, including {{esql}}, with a managed data stream (recommended)

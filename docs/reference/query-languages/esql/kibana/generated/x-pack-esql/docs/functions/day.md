...
### DAY
Extracts the day of month (1-31) from a date, using the [query time zone](https://www.elastic.co/docs/reference/query-languages/esql/directives/set#esql-time_zone).

...
### MONTH
Extracts the month of year (1-12) from a date, using the [query time zone](https://www.elastic.co/docs/reference/query-languages/esql/directives/set#esql-time_zone).

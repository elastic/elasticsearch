...
![Gaussian](/reference/query-languages/images/Gaussian.png "")

where ![sigma](/reference/query-languages/images/sigma.png "") is computed to assure that the score takes the value `decay` at distance `scale` from `origin`+-`offset`

![sigma calc](/reference/query-languages/images/sigma_calc.png "")
...
![Exponential](/reference/query-languages/images/Exponential.png "")

where again the parameter ![lambda](/reference/query-languages/images/lambda.png "") is computed to assure that the score takes the value `decay` at distance `scale` from `origin`+-`offset`

![lambda calc](/reference/query-languages/images/lambda_calc.png "")
...
![Linear](/reference/query-languages/images/Linear.png "").
...
![s calc](/reference/query-languages/images/s_calc.png "")
...
![decay 2d](/reference/query-languages/images/decay_2d.png "")
...
:::{image} /reference/query-languages/images/normal-decay-keyword-gauss-1.png
:::

:::{image} /reference/query-languages/images/normal-decay-keyword-gauss-2.png
:::
...
:::{image} /reference/query-languages/images/exponential-decay-keyword-exp-1.png
:::

:::{image} /reference/query-languages/images/exponential-decay-keyword-exp-2.png
:::
...
:::{image} /reference/query-languages/images/linear-decay-keyword-linear-1.png
:::

:::{image} /reference/query-languages/images/linear-decay-keyword-linear-2.png
:::

...
----
// TEST[continued]
// TEST[s/"took": 2/"took": $body.took/]
// TEST[s/"total": 5/"total": $body._shards.total/]
// TEST[s/"successful": 5/"successful": $body._shards.successful/]
// TEST[s/0.39556286/$body.hits.max_score/]

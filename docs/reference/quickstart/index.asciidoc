...
* <<esql-getting-started, {esql} basics>>: Learn how to query and aggregate your data using {esql}.
* <<esql-for-search, {esql} for search>>: Learn how to use {esql} for search use cases, including full-text search, semantic search, and hybrid search.
...
include::esql-search-tutorial.asciidoc[]

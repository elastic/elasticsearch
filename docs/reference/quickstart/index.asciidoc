...
* <<full-text-tutorial, Basics: Full-text search>>. Learn about text analysis, different options for querying data, and relevance scoring.
...
include::full-text-tutorial.asciidoc[]

...
[role="exclude",id="proxy-mode"]
==== Proxy mode

Refer to <<proxy-mode-remote,Proxy mode>>.

[role="exclude",id="sniff-mode"]
==== Sniff mode

Refer to <<sniff-mode-remote,Sniff mode>>.

[role="exclude",id="gateway-nodes-selection"]
==== Gateway node selection

Refer to <<gateway-node-selection,Gateway nodes>>.

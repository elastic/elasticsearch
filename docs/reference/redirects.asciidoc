...
[role="exclude",id="data-rollup-transform"]
=== Roll up or transform your data

For information about transforming your data, refer to <<transforms>>.

To reduce storage volumes for time series data, refer to <<downsampling>>.
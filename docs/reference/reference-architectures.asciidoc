...
image:reference-architectures/images/three-availability-zone.png[Image showing a three Availability zone architecture]
...
include::reference-architectures/components.asciidoc[]
...
include::reference-architectures/three-availability-zones.asciidoc[]

...
NOT CLASSIFIED::
* [TEST] Remove create special case in yaml test client {pull}21030[#21030] (issue: {issue}20924[#20924])
* introduce test plugin to inject random search ext elements in search request tests {pull}20521[#20521] (issue: {issue}17685[#17685])
...
NOT CLASSIFIED::
* Upgrade to lucene-6.3.0-snapshot-ed102d6 {pull}21150[#21150]

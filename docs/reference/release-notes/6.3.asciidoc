...
* [ML] Wait for aliases in multi-node tests {pull}32086[#32086] (issue: {issue}32034[#32034])

Mapping::
* Fix put mappings java API documentation {pull}31955[#31955] (issue: {issue}31906[#31906])

Monitoring::
* [CI] XPackRestIT "monitoring/bulk/10_basic/Bulk indexing of monitoring data" [OPEN] [ISSUE] {pull}30935[#30935]
...
* Watcher: Increase HttpClient parallel sent requests {pull}31859[#31859] (issue: {issue}30130[#30130])

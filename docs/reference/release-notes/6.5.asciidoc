...
* [ML] Prevent potential NPE when reading the model memory limit {pull}35827[#35827]

SQL::
* SQL: IS NULL and IS NOT NULL doesn't behave correctly when used in HAVING clause [OPEN] [ISSUE] {pull}35139[#35139]

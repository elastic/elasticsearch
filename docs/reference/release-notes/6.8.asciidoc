...
* SQL: Interval arithmetics failure {pull}42014[#42014] (issue: {issue}41200[#41200])
...
Machine Learning::
* [DOCS] Adds allow no datafeeds query param to the GET, GET stats and STOP datafeed APIs (7.2-6.1) {pull}44864[#44864]

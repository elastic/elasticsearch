...
* Multi-bucket aggregator wrapper is slow and uses a ton of memory {es-pull}56487[#56487]
...
Features/CAT APIs::
* Adding Hit counts and Miss counts for QueryCache exposed through REST api. This resolves:#48645 {es-pull}60114[#60114] (issue: {es-issue}48645[#48645])
...
* Write deprecation logs to a data stream {es-pull}58924[#58924] (issue: {es-issue}46106[#46106])
...
Infra/Scripting::
* Scripting: Augment String with sha1 and sha256 {es-pull}59671[#59671] (issue: {es-issue}59633[#59633])
* Scripting: Converts casting and def support {es-pull}61350[#61350] (issue: {es-issue}59647[#59647])

Machine Learning::
* Add a "verbose" option to the data frame analytics stats endpoint {es-pull}59589[#59589] (issue: {es-issue}59125[#59125])
* Add new include flag to GET inference/<model_id> API for model training metadata {es-pull}61922[#61922]
* Adds new feature_processors field for data frame analytics {es-pull}60528[#60528] (issue: {es-issue}59327[#59327])
* Adds new n_gram_encoding custom processor {es-pull}61578[#61578]
* Create new dynamic domain feature extractor processor {es-pull}61874[#61874]
* Make MlDailyMaintenanceService delete jobs that are in deleting state anyway {es-pull}60121[#60121] (issue: {es-issue}42840[#42840])
...
* QL: Wildcard support {es-pull}59753[#59753]
...
* Make multi search tasks cancellable {es-pull}44494[#44494]
* ParametrizedFieldMapper to run validators against default value {es-pull}60042[#60042] (issue: {es-issue}59332[#59332])
* Search - add case insensitive flag for "term" family of queries {es-pull}61596[#61596] (issue: {es-issue}61546[#61546])
* Search - add case insensitive support for regex queries. {es-pull}59441[#59441]
...
Task Management::
* Support task cancellation cross clusters {es-pull}55779[#55779]
...
* [client] Handle non-default port in Cloud-Id {es-pull}61581[#61581]
...
* DFA Get Stats can return multiple responses if more than one error {es-pull}60900[#60900] (issue: {es-issue}60876[#60876])
* Do not mark the DFA job as FAILED when a failure occurs after the node is shutdown {es-pull}61331[#61331] (issue: {es-issue}60596[#60596])
* Improve handling of exception while starting DFA process {es-pull}61838[#61838] (issue: {es-issue}61704[#61704])
...
* In field retrieval, skip values that can't be parsed. {es-pull}60943[#60943]

...
QL::
* QL: handle IP type fields extraction with ignore_malformed property {es-pull}66622[#66622] (issue: {es-issue}66675[#66675])
...
* QL: Verify filter's condition type {es-pull}66268[#66268] (issue: {es-issue}66254[#66254])

...
Templates::
* Composable index templates with data streams can no longer contain alias definitions.
  This also applies for any component templates that is referred by composable index templates
  that contain data streams. The reason why this was allowed in ES 7.9 and 7.10 is a bug. {es-pull}67886[#67886]

...
Machine Learning::
* Add deprecation check for job model snapshots that need upgraded {es-pull}66062[#66062] (issue: {es-issue}64154[#64154])
...
Query Languages::
* Implement support for `date_nanos` ES type {es-pull}67666[#67666] (issue: {es-issue}38562[#38562])
...
* Sort field tiebreaker for PIT (point in time) readers {es-pull}66093[#66093] (issue: {es-issue}56828[#56828])
...
* Automatic management for ML system indices {es-pull}68044[#68044]
* Expand regression/classification hyperparameters {es-pull}67950[#67950]
...
* Preserve inference progress upon starting data frame analytics {es-pull}68222[#68222]

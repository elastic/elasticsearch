...
Authentication::
* Deprecate the behaviour of implicitly disabling file/native realm {es-pull}69320[#69320] (issue: {es-issue}50892[#50892])
...
* Add put and delete trained model alias APIs to rest high-level client {es-pull}69214[#69214]
...
* Do not create ML annotations index in upgrade mode {es-pull}71175[#71175]
* Do not track ML usage when collecting monitoring {es-pull}71314[#71314]

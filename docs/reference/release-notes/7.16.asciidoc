...
Machine Learning::
* [ML] Text/Log categorization multi-bucket aggregation {es-pull}71752[#71752]
...
* Adding new `defer_definition_decompression` parameter to put trained model API {es-pull}77189[#77189] (issue: {es-issue}77132[#77132])
...
* Audit job open failures and stop any corresponding datafeed {es-pull}80665[#80665] (issues: {es-issue}48934[#48934], {es-issue}80621[#80621])
...
* Respect timeout parameters in all API's {es-pull}79468[#79468] (issue: {es-issue}79268[#79268])

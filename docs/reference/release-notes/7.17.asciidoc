...
These issues will impact any subsequent upgrade to v8.0, and are fixed in
v7.17.1. We strongly recommend that all users upgrade to a later patch
release of v7.17 before upgrading to v8.0.

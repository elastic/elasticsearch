...
Mapping::
* Wildcard field optimised for wildcard queries {pull}49993[#49993] (issue: {issue}48852[#48852])
...
* QL: constant_keyword support {pull}53241[#53241] (issue: {issue}53016[#53016])
...
* Introduce system index APIs for Kibana {pull}52385[#52385]
...
* Add SPI jvm option to SystemJvmOptions {pull}50916[#50916] (issue: {issue}48349[#48349])
* Remove Xlint exclusions from gradle files {pull}52542[#52542] (issue: {issue}40366[#40366])
...
* [ML][Inference] adds new default_field_map field to trained models {pull}53294[#53294]
...
* [ML][Inference] Add support for multi-value leaves to the tree model {pull}52531[#52531]
...
* [ML][Inference] add tags url param to GET {pull}51330[#51330]
...
* Script_score query errors on negative scores {pull}53133[#53133] (issue: {issue}52478[#52478])
...
* Async search: prevent users from overriding pre_filter_shard_size {pull}54088[#54088]
* Async search response: output start and expiration time as time fields {pull}54084[#54084]
* Async Search: replicas to auto expand from 0 to 1 {pull}53964[#53964]
* Async search: remove version from response {pull}53960[#53960]
...
* Submit async search to work only with POST {pull}53368[#53368] (issue: {issue}49931[#49931])

...
Infra/Plugins::
* Add xpack setting deprecations to deprecation API [OPEN] {pull}56290[#56290] (issue: {issue}54745[#54745])
...
Features/Indices APIs::
* Fix simulating index templates without specified index [OPEN] {pull}56295[#56295] (issues: {issue}53101[#53101], {issue}56255[#56255])

...
* Persist progress when setting DFA task to failed {es-pull}61782[#61782]
...
Transform::
* Disable optimizations when using scripts in group_by {es-pull}60724[#60724] (issues: {es-issue}57332[#57332], {es-issue}59591[#59591])

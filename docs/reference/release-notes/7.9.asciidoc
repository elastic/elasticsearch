...
* Pass SearchLookup through to fielddataBuilder {es-pull}58527[#58527]
* Store parsed mapping settings in IndexSettings {es-pull}57492[#57492] (issue: {es-issue}57395[#57395])
* Support null_value for wildcard field type. [ISSUE] {es-pull}55701[#55701]
...
SQL::
* Implement DATE_PARSE function for parsing strings into DATE values [OPEN] {es-pull}57391[#57391] (issue: {es-issue}54962[#54962])
...
* Executes incremental reduce in the search thread pool [OPEN] {es-pull}58461[#58461] (issues: {es-issue}51857[#51857], {es-issue}53411[#53411])
...
Aggregations::
* Bad aggregation name complains about "unknown BaseAggregationBuilder" instead of "unknown Aggregation" [ISSUE] {es-pull}28950[#28950]

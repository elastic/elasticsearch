...
* Handle null value of `FieldCapabilitiesResponse` {es-pull}64327[#64327] (issue: {es-issue}868[#868])
...
Transform::
* [ML][DataFrame] Fix compile error in `DataFrameTransformProgressIT` {es-pull}43099[#43099]
...
* Merge the pytorch-inference feature branch {es-pull}73660[#73660] (issues: {es-issue}70713[#70713], {es-issue}71035[#71035], {es-issue}71177[#71177], {es-issue}71323[#71323], {es-issue}71679[#71679], {es-issue}72218[#72218], {es-issue}73523[#73523])

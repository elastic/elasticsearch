...
* If you are using {ml}, it is not safe to perform a rolling upgrade from 7.16.x 
  to 8.0.0-beta1. It may lead cluster state propagation issues in the mixed 
...
* [ML] optimize source extraction for `categorize_text` aggregation {es-pull}79099[#79099]
...
Machine Learning::
* Add timeout parameter for DELETE `trained_models` API {es-pull}79739[#79739] (issue: {es-issue}77070[#77070])

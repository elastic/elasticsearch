...
* Downsampling persistent tasks fail to load, preventing upgraded nodes from joining the cluster and thus failing the upgrade (issue: {es-issue}106880[#106880])
+

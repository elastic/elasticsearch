...
* Downsampling persistent state fails to load, preventing upgraded nodes from joining the cluster (issue: {es-issue}106880[#106880])
+
...
* The OpenAI model parameter should be in service settings not task settings.
Move the configuration field to service settings {es-pull}105458[#105458]

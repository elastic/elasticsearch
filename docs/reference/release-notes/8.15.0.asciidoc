...
You can also reduce the likelihood of users triggering the issue by changing the default data view in Discover to a smaller set of indices
and/or one with fewer mapping conflicts.

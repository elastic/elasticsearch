...
[IMPORTANT]
====
The 8.17.0 release contains a fix for a potential security vulnerability. Please see our https://discuss.elastic.co/c/announcements/security-announcements/31[security advisory] for more details.
====

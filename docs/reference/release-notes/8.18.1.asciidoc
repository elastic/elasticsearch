...
* Revert enabling madvise by default to fix vector search performance degradation on Linux with MGLRU enabled {es-pull}126308[#126308] (issue: {es-issue}124499[#124499])

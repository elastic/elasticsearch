...
Autoscaling::
* Autoscaling after clone fix {es-pull}89768[#89768] (issue: {es-issue}89758[#89758])

Health::
* Fixing the conditions for fetching remote master history {es-pull}89472[#89472] (issue: {es-issue}89431[#89431])
...
* Fix deadlock bug exposed by the test {es-pull}89934[#89934]

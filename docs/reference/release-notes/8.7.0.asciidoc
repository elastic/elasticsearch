...
Health::
* Health API fix the reporting of initializing shards {es-pull}93502[#93502] (issue: {es-issue}90327[#90327])
...
* [H3] Compute destination point from distance and azimuth using planar 3d math {es-pull}93084[#93084]

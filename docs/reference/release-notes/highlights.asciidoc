...
[discrete]
[[release_time_series_index_settings_data_stream_as_ga]]
=== Release time series index settings and data stream as GA
The time series (TSDB) mode on indexes has been in tech preview, and is now released as GA.
This also includes support for time series data stream and ingest.

{es-pull}91519[#91519]

[discrete]
[[release_time_series_down_sampling_as_ga]]
=== Release time series down-sampling as GA
Time series (TSDB) down-sampling has been in tech preview, and is now released as GA.

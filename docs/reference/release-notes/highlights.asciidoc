...
The frozen tier and partially mounted indices for {search-snaps}, formerly known
as shared-cache {search-snaps}, are now generally available. We these features
as technical previews in 7.12. See the

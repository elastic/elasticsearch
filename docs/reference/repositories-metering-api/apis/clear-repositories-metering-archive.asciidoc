...
Removes the archived repositories meterings present in the cluster.
...
`<max_version_to_clear>`::
    (long) Specifies the maximum <<get-repositories-metering-api-response-body, cluster_version>> to be cleared from the archive.
...
Returns the deleted archived repositories meterings.

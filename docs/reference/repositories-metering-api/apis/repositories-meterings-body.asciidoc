...
======
`GetBlobProperties`::
(long) Number of https://learn.microsoft.com/en-us/rest/api/storageservices/get-blob-properties[Get Blob Properties] requests.
`GetBlob`::
(long) Number of https://learn.microsoft.com/en-us/rest/api/storageservices/get-blob[Get Blob] requests.
`ListBlobs`::
(long) Number of https://learn.microsoft.com/en-us/rest/api/storageservices/list-blobs[List Blobs] requests.
`PutBlob`::
(long) Number of https://learn.microsoft.com/en-us/rest/api/storageservices/put-blob[Put Blob] requests.
`PutBlock`::
(long) Number of https://learn.microsoft.com/en-us/rest/api/storageservices/put-block[Put Block].
`PutBlockList`::
(long) Number of https://learn.microsoft.com/en-us/rest/api/storageservices/put-block-list[Put Block List] requests.
`DeleteBlob`::
(long) Number of https://learn.microsoft.com/en-us/rest/api/storageservices/delete-blob[Delete Blob] requests.

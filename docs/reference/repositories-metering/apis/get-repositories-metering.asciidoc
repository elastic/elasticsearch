...
++++
<titleabbrev>Repositories metering API</titleabbrev>
++++

Returns cluster repositories metering.
...
[[get-repositories-metering-api-query-params]]
...
[%collapsible%open]
======
Google Cloud Platform storage https://cloud.google.com/storage/pricing[pricing].
`storage.objects.get`::

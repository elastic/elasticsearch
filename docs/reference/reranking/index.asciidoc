...
Models can be hosted directly in your {es} cluster, or you can use <<inference-apis,inference endpoints>> to call models provided by third-party services. Enables out-of-the-box semantic search capabilities on existing full-text search indices.

...
When using the following advanced re-ranking pipelines, early retrieval mechanisms effectively generate a set of candidates.
These candidates are funneled into a late stage reranker that performs more computationally expensive re-ranking tasks.

...
--------------------------------------------------
{
  "my-index-000001" : {
    "settings": {
      ...
      "index.transport.version.created": ...,
...
// TESTRESPONSE[s/"index.transport.version.created": \.\.\./"index.transport.version.created": $body.my-index-000001.settings.index\\\\.transport\\\\.version\\\\.created/]

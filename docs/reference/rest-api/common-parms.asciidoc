...
NOTE: {transforms-cap} support <<modules-cross-cluster-search,{ccs}>>.
...
example, `["my-index-*", "my-other-index-*"]`.
...
Definitions of search-time runtime fields that can be used by the transform. If 
you use <<modules-cross-cluster-search,{ccs}>>, the version of the remote 
cluster must be newer than 7.12.

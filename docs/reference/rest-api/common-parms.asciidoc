...
Available values are: `minmax`, `identity`. Defaults to `identity`.

See also <<retrievers-examples-linear-retriever, a hybrid search example>> using a linear retriever on how to

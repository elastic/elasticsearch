...
`field_statistics`::
(Optional, boolean) Whether document count, sum of document frequencies, and 
...
tag::offsets[]
`<offsets>`::
(Optional, boolean) Whether term offsets should be returned.
Defaults to `true`.
end::offsets[]
...
tag::payloads[]
`payloads`::
(Optional, boolean) Whether term payloads should be returned.
Defaults to `true`.
end::payloads[]

tag::positions[]
`positions`::
(Optional, boolean) Whether term positions should be returned.
Defaults to `true`.
end::positions[]
...
tag::realtime[]
`realtime`::
(Optional, boolean) Whether the request is real-time as opposed to near-real-time. 
Defaults to `true`.
end::realtime[]
...
tag::term_statistics[]
`term_statistics`::
(Optional, boolean) Whether total term frequency and document frequency should be returned. 
Defaults to `false`.
end::term_statistics[]

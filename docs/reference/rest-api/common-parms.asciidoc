...
`timeout`::
(Optional, <<time-units, time units>>)
Period to wait for a response from relevant nodes in the cluster. When specified,
only information from nodes that responded in time will be returned. When
unspecified, downstream requests will never timeout.

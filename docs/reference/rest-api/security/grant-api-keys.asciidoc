...
`access_token`::
(Required*, string)
The user's {es} access token or JWT. If you specify the `access_token` grant type, this
...
JWT, this specifies the client authentication for <<JWT access tokens, jwt-realm-oauth2>>

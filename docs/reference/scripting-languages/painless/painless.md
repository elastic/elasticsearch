...
* [**Language specifications:**](/reference/scripting-languages/painless/painless-language-specification.md) syntax, operators, data types, and compilation semantics
...
* **Advanced use cases:** Complex implementations, ingest processing, and API examples  
* **Debugging & Troubleshooting:** Debugging techniques, common errors, and solutions

<!--
For step-by-step tutorials and real-world examples, refer to [How to write scripts](/explore-analyze/scripting/modules-scripting-using.md) and [Common scripting use cases](/explore-analyze/scripting/common-script-uses.md) in the Explore and Analyze section.
-->
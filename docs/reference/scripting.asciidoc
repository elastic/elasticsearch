...
could use a script to return fields as part of a search request or
...
Scripts can't make use of {es}'s index structures or related optimizations,
which can sometimes result in slower search speeds.

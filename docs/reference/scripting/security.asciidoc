...
By default both script types are allowed to be executed. This can be modified using the
...
allow both types again, set `script.allowed_types: null` or `script.allowed_types: inline, stored`.

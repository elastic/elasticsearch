...
=== Shorten your script
Using syntactic sugar that is native to Painless, you can reduce verbosity in
your scripts and make them shorter. In the shortened form, `script` is
represented by a string that contains the script source instead of an object.
...
This script removes several components to achieve greater brevity:

...
We provide an [example configuration file](https://raw.githubusercontent.com/elastic/connectors/refs/heads/main/app/connectors_service/config.yml.example) in the `elastic/connectors` repository for reference.

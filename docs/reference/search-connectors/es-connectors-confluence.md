...
:   The username of the account for Confluence Data Center. This field is only available for `Basic authentication`.

`data_center_password`
:   The password of the account to be used for the Confluence Data Center. This field is only available for `Basic authentication`.

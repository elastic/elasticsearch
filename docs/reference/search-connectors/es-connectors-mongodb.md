...
View the [**source code** for this connector](https://github.com/elastic/connectors/tree/main/connectors/sources/mongo.py) (branch *main*, compatible with Elastic *9.0*).

...
```sh
curl https://raw.githubusercontent.com/elastic/connectors/refs/heads/main/app/connectors_service/config.yml.example --output </absolute/path/to>/connectors-config/config.yml
```
% NOTCONSOLE

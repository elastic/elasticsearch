...
was a significant term. This may be true but if you want some more focused terms you could use a `backgroundFilter` 
...
scope can be narrowed through the use of a `backgroundFilter` to focus in on significant terms within a narrower
context: 

...
[[search-aggregations-bucket-terms-aggregation-track-missing]]
===== Track Missing
added[1.2.0]
...
of the created `missing` aggregation is derived from the name of this `terms` aggregations (e.g. if this `terms` aggregation
is called `tags`, the name of the corresponding `missing` aggregation will be named `tags_missing`. It is
...
<1> 4 documents are not associated with tags

If `term_missing` is set to a string value, say `"doc_without_tags"`, the response would then be:

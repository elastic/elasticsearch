...
In addition to `keep_alive`, we can also specify the `allow_partial_search_results` parameter
...
as well as how many of those were successful in creating the PIT.

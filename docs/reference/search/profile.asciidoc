            ...
            "children" : [
              {
                ...
                "breakdown" : {
                  ...
                  "collect" : 94052,
                  "collect_count" : 4,
                  "multi_bucket_aggregator_wrapper": true
                }
              }
            ]
          }
...
All other parts of the breakdown are extra debugging information specific to
the particular aggregation. They expose details of the aggregation implementation
that are helpful in debugging issues with the aggregation and might change from
version to version.

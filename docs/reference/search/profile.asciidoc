...
CancellableCollector wraps a CompositeCollector which holds the normal scoring
SimpleCollector used to collect top hits, as well as BucketCollector to run
all scoped aggregations.

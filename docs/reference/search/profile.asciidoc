...
--------------------------------------------------
{
  ...
  "profile": {
    "coordinator": {
        ...
        "breakdown": {
            "retriever_rewrite_count" : 0,
            "inference_rerank_time_count" : 0,
            "inference_rerank_time" : 0,
            "retriever_rewrite" : 0
        }
    },
    "shards": [
...
// TESTRESPONSE[s/"node_id": "q2aE02wS1R8qQFnYu6vDVQ",/"node_id": "$body.profile.coordinator.node_id",/]
...
// TESTRESPONSE[s/"node_id": "P6xvulHtQRWuD4YnubWb7A",/"node_id": "$body.profile.coordinator.node_id",/]

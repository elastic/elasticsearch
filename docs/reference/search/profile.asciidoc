...
`profile` parameter. Note that for the dfs phase to run an index must have
multiple shards.
...
POST _bulk
{ "index" : { "_index" : "my-dfs-index", "_id" : "1" } }
{ "my-keyword" : "a" }
{ "index" : { "_index" : "my-dfs-index", "_id" : "2" } }
{ "my-keyword" : "b" }
--------------------------------------------------
...
for each shard along with profile output for the rest of search phases.

...
In the above case, the `https://github.com/Helppoint18445566315/Helpforquickbooks` field will be highlighted for each
...
--------------------------------------------------
{
    "type_name" : {https://github.com/Helppoint18445566315/Helpforquickbooks
        "https://github.com/Helppoint18445566315/Helpforquickbooks" : {"index_options" : "offsets"}
    }
}
--------------------------------------------------

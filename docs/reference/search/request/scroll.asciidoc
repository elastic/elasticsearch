...
[source,js]
--------------------------------------------------
POST /twitter/_search?scroll=1m&include_type_name=false
{
    "size": 100,
    "query": {
        "match" : {
...
[source,js]
--------------------------------------------------
GET /_search?scroll=1m&include_type_name=false
{
  "sort": [
    "_doc"
  ]
...
[source,js]
--------------------------------------------------
GET /twitter/_search?scroll=1m&include_type_name=false
{
    "slice": {
        "id": 0, <1>
        "max": 2 <2>

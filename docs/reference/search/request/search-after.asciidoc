...
results. It is not recommended to use the <<mapping-id-field,`_id` field>>
field for this purpose because it requires to load a lot of data in memory.
Instead it is advised to duplicate the content of the _id field in another

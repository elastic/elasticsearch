...
[TIP]
====
Refer to <<retrievers-overview>> for a high level overview of the retrievers abstraction, and to <<retrievers-examples>> for detailed examples on combining and using retrievers.
====

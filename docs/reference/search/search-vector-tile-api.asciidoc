...
IMPORTANT: You can specify several options for this API using a query parameter
or request body parameter. If both parameters are specified, the query parameter
takes precedence.

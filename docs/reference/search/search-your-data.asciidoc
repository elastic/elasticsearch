...
To set a cluster-wide default timeout for all search requests, configure the
...
in the request. If the global search timeout expires before the search request
finishes, the request is cancelled using <<task-cancellation,task

...
To use quantization, you must provide a `quantization_options` object in the `dense_vector` mapping.
    ...
    "query": {
      "rescore_query": {
        "script_score": {
          ...
          "script": {
            "source": "cosineSimilarity(params.query_vector, doc['image-vector']) + 1.0",
            "params": {
              "query_vector": [0.1, -2]
            }
          }

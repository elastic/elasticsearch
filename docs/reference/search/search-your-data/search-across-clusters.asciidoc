...
to search the other clusters. For example, if you have 7.14 and 8.0 clusters,
you can maintain a dedicated 7.14 cluster to use as the local cluster for {ccs}.

...
use compatible versions of {es}. Elastic only supports searches from a local
cluster to a remote cluster running:
...
+
For example, if you have 7.14 and 8.0 clusters, you can maintain a 7.13
cluster to run cross-cluster searches on them.

...
Amazon Bedrock examples use the `amazon.titan-embed-text-v1` model fom https://docs.aws.amazon.com/bedrock/latest/userguide/model-ids.html[the Amazon Bedrock base models].

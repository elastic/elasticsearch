...
The Google Vertex AI example uses the `text-embedding-004` model from https://cloud.google.com/vertex-ai/generative-ai/docs/model-reference/text-embeddings-api#generative-ai-get-text-embedding-python_vertex_ai_sdk[the Vertex AI text embedding models].

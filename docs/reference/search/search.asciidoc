...
[source,console]
----
GET /my-index-000001/_search?q=source.ip:127.0.0.1
----
// TEST[setup:my_index]
    ...
    "hits": [
      {
        ...
        "_source": {
          ...
          "message": "GET /login HTTP/1.1 200 1070000",
          "user": {
            "id": "kimchy"
          }
        }
...
[source,console]
----
GET /my-index-000001,my-index-000002/_search?q=source.ip:127.0.0.1
----
// TEST[setup:my_index]
...
[source,console]
----
GET /_search?q=source.ip:127.0.0.1
----
// TEST[setup:my_index]
...
[source,console]
----
GET /_all/_search?q=source.ip:127.0.0.1
----
// TEST[setup:my_index]

...
[source,console]
----
GET /my_logs-000001/_search?q=user.name:kimchy
----
// TEST[setup:my_logs]
...
[source,console]
----
GET /my_logs-000001,my_logs-000002/_search?q=user.name:kimchy
----
// TEST[setup:my_logs]
// TEST[s/^/PUT my_logs-000002\n/]
...
[source,console]
----
GET /_search?q=user.name:kimchy
----
// TEST[setup:my_logs]
...
[source,console]
----
GET /_all/_search?q=user.name:kimchy
----
// TEST[setup:my_logs]

...
matching the `query` request body parameter are not returned. To make use of GET
and the full Elasticsearch Query DSL, you can pass the request body as the

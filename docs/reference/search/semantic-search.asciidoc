...
include::{es-repo-dir}/search/search-your-data/semantic-search-concept.asciidoc[tag=semantic-def]
...
Requires the `read` <<privileges-list-indices,index privilege>> for the target 

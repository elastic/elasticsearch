...
[source,js]
--------------------------------------------------
PUT music?include_type_name=false
{
    "mappings": {
        "properties" : {
            "suggest" : {
...
[source,js]
--------------------------------------------------
PUT music/_doc/1?refresh&include_type_name=false
{
    "suggest" : {
...
[source,js]
--------------------------------------------------
POST music/_search?pretty&include_type_name=false
{
    "suggest": {
        "song-suggest" : {
            "prefix" : "nir", <1>
...
[source,js]
--------------------------------------------------
POST music/_search?include_type_name=false
{
    "_source": "suggest", <1>
    "suggest": {
        "song-suggest" : {

...
[source,js]
--------------------------------------------------
PUT place?include_type_name=false
{
    "mappings": {
        "properties" : {
            "suggest" : {
...
PUT place_path_category?include_type_name=false
{
    "mappings": {
        "properties" : {
            "suggest" : {
...
[source,js]
--------------------------------------------------
PUT place/_doc/1?include_type_name=false
{
    "suggest": {
...
[source,js]
--------------------------------------------------
PUT place_path_category/_doc/1?include_type_name=false
{
...
[source,js]
--------------------------------------------------
POST place/_search?pretty&include_type_name=false
{
    "suggest": {
        "place_suggestion" : {
            "prefix" : "tim",
...
[source,js]
--------------------------------------------------
POST place/_search?include_type_name=false
{
    "suggest": {
        "place_suggestion" : {
            "prefix" : "tim",

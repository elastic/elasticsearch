...
experimental::[]
+
(Optional, Boolean) If `false`, each node holding a shard of the searchable
snapshot index restores a full copy of the shard to its local storage. If
`true`, the shard is not fully restored. Defaults to `false`.

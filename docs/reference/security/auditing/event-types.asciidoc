...
indicate whether that event type is required. In such cases, `security_config_change` 
needs to **_replace_** any related event actions in 
<<xpack-sa-lf-events-include,`xpack.security.audit.logfile.events.include`>>.

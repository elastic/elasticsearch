...
These settings enable fine grained control over which audit events
are eventually printed to the log file. See {xpack-ref}/audit-log-output.html#audit-log-ignore-policy[Logfile Audit Events Ignore Policies]

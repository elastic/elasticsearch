...
If an event matches all of the conditions specified for a specific policy, it
will not be printed, it is ignored.
...
roles, some of which are *not* covered by the policy, then the policy will

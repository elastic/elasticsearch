...
Specifies whether to include the {ref}/node.name.html[node name] as a field in
each audit event.
...
Unlike {ref}/node.name.html[node name], whose value might change if the administrator

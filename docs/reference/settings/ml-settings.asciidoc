...
`xpack.ml.max_anomaly_records`:: (<<cluster-update-settings,Dynamic>>) TBD
...
`xpack.ml.max_percent_date_errors`:: (<<cluster-update-settings,Dynamic>>) TBD

`xpack.ml.max_percent_out_of_order_errors`:: (<<cluster-update-settings,Dynamic>>) TBD

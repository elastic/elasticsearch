...
The detailed documentation of Model Inference (ML) Circuit breaker settings can be accessed [here](https://www.elastic.co/guide/en/elasticsearch/reference/current/circuit-breaker.html#model-inference-circuit-breaker).

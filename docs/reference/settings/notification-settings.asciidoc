...
via email, see <<configuring-email-actions,Configuring email>>.
...
[[email-account-attributes]]
  ...
  <<email-action-attributes,Email action attributes>> for the supported
  attributes.
...
<<email-html-sanitization,Configuring HTML sanitization options>>. You can
...
`elasticsearch.yml`. For more information about sending notifications
via Slack, see <<configuring-slack-actions,Configuring Slack>>.
...
to create issues in Jira, see <<configuring-jira-actions,Configuring Jira>>.
...
`elasticsearch.yml`. For more information about sending notifications
via PagerDuty, see <<configuring-pagerduty-actions,Configuring PagerDuty>>.

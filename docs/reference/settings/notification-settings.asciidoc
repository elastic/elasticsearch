...
[[hipchat-account-attributes]]
  ...
  `auth_token`;;
  deprecated[6.6.0] The authentication token to use to access the HipChat API.
  Use `secure_auth_token` instead.
...
[[slack-account-attributes]]
  ...
  `url`;;
  deprecated[6.6.0] The Incoming Webhook URL to use to post messages to Slack.
  Use `secure_url` instead.
...
[[jira-account-attributes]]
  ...
  `url`;;
  deprecated[6.6.0] The URL of the Jira Software server. Use `secure_url`
  instead.
  ...
  `user`;;
  deprecated[6.6.0] The name of the user to connect to the Jira Software server.
  Use `secure_user` instead.

  `secure_user` (<<secure-settings,Secure>>);;
  The name of the user to connect to the Jira Software server. Required.

  `password`;;
  deprecated[6.6.0] The password of the user to connect to the Jira Software
  server. Use `secure_password` instead.
...
`service_api_key`;;
deprecated[6.6.0] The
https://developer.pagerduty.com/documentation/rest/authentication[PagerDuty API key]
to use to access PagerDuty. Use `secure_service_api_key` instead.

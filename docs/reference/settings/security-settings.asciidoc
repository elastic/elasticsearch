...
"api/security/v1/oidc" endpoint of your {kib} server if you want to use the authorization code flow or the "api/security/v1/oidc/implicit" endpoint for the implicit flow.

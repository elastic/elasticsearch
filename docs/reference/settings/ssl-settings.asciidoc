...
include::{docdir}/settings/common-defs.asciidoc[tag=ssl-truststore-path-jks]
...
//TBD: Should this occurrence use the ssl-keystore-type-pkcs11 or ssl-keystore-type-pkcs12 definition and default values?
...
//TBD: Is the default value `jks` per ssl-keystore-type-pkcs11 definition?

...
You can
{ref}/configuring-stack-security.html#stack-enroll-nodes[enroll additional nodes]
on your local
machine to experiment with how an {es} cluster with multiple nodes behaves. 

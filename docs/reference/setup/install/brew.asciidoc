...
To install the default distribution of _all_ Elastic products at once,
specify:
...
This installs Elasticsearch, Logstash, Kibana, Auditbeat, Filebeat, Heartbeat, Metricbeat, Packetbeat, and APM server. 

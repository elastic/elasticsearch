...
[source,sh]
-------------------------
brew install elastic/elastic-stack/elasticsearch
-------------------------
...
`elastic/elastic-stack/elasticsearch@6.8`. To install the OSS distribution,
specify `elastic/elastic-stack/elasticsearch-oss`.

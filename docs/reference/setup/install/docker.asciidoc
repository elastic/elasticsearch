...
[source,sh,subs="attributes"]
----
docker run --name es02 --net elastic -p 9201:9200 -it -e ES_JAVA_OPTS="-Xms1g -Xmx1g" -e ENROLLMENT_TOKEN="<token>" docker.elastic.co/elasticsearch/elasticsearch:{docker-image}
----

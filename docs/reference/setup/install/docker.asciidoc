...
The `vm.max_map_count` setting must be set in your %USERPROFILE%\.wslconfig as follows:
...
This will cause all WSL2 VMs to have that setting assigned at boot time.

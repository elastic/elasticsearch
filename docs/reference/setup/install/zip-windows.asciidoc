...
["source","sh",subs="attributes"]
----
C:\Program Files\elasticsearch-{version}>.\bin\elasticsearch-service.bat start
----
+
...
["source","sh",subs="attributes"]
----
C:\Program Files\elasticsearch-{version}>.\bin\elasticsearch-reset-password.bat -u elastic
----

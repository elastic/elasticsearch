...
However if a JSON document contains exception, it will be formatted as a multiline.
First line will contain regular properties and subsequent lines will contain

...
The  {kib-refers}/snapshot-repositories.html[Snapshot and Restore UI] makes it easy to 
...
You can create and manage roles to assign these privileges through the {kibana} Management UI.

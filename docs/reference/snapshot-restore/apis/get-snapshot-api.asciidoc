...
`search`::
(string)
A search string to filter snapshots by. The search string can specify a query against the fields `repository` (repository name),
`name` (snapshot name) or `policy` (the SLM policy name that created the snapshot if it was created by SLM).
Supported operations are `=` for exact text match and `:` for partial text match. Starting the query string on a `-`, means that all
snapshots matching it should be excluded from the results.
By default if this parameter is omitted then no search string filtering is applied.

NOTE: The search string filtering is applied after the repository and snapshot name patterns in the url path.
  ...
  "snapshots": [
    {
      ...
      "end_time": "2020-07-06T21:55:18.133Z",
      "end_time_in_millis": 1593093628853,
...
// TESTRESPONSE[s/"end_time": "2020-07-06T21:55:18.133Z"/"end_time": $body.snapshots.0.end_time/]
// TESTRESPONSE[s/"end_time_in_millis": 1593093628853/"end_time_in_millis": $body.snapshots.0.end_time_in_millis/]
// TESTRESPONSE[s/"duration_in_millis": 2/"duration_in_millis": $body.snapshots.0.duration_in_millis/]
  ...
  "snapshots": [
    {
      ...
      "end_time": "2020-07-06T21:55:18.131Z",
...
// TESTRESPONSE[s/"version": <version>/"version": $body.snapshots.0.version/]
// TESTRESPONSE[s/"start_time": "2020-07-06T21:55:18.130Z"/"start_time": $body.snapshots.0.start_time/]
// TESTRESPONSE[s/"start_time": "2020-07-06T21:55:18.131Z"/"start_time": $body.snapshots.1.start_time/]
...
// TESTRESPONSE[s/"end_time": "2020-07-06T21:55:18.131Z"/"end_time": $body.snapshots.0.end_time/]
// TESTRESPONSE[s/"end_time": "2020-07-06T21:55:18.133Z"/"end_time": $body.snapshots.1.end_time/]
// TESTRESPONSE[s/"end_time_in_millis": 1593093628851/"end_time_in_millis": $body.snapshots.0.end_time_in_millis/]
// TESTRESPONSE[s/"end_time_in_millis": 1593093628853/"end_time_in_millis": $body.snapshots.1.end_time_in_millis/]
// TESTRESPONSE[s/"duration_in_millis": 1/"duration_in_millis": $body.snapshots.0.duration_in_millis/]
// TESTRESPONSE[s/"duration_in_millis": 2/"duration_in_millis": $body.snapshots.1.duration_in_millis/]
  ...
  "snapshots": [
    {
      ...
      "include_global_state": true,
      "state": "SUCCESS",
      "start_time": "2020-07-06T21:55:18.132Z",
      "start_time_in_millis": 1593093628852,
      "end_time": "2020-07-06T21:55:18.135Z",
      "end_time_in_millis": 1593093628855,
...
----
// TESTRESPONSE[s/"uuid": "gvLCxSketdRctdKb54xw67"/"uuid": $body.snapshots.0.uuid/]
// TESTRESPONSE[s/"version_id": <version_id>/"version_id": $body.snapshots.0.version_id/]
// TESTRESPONSE[s/"version": <version>/"version": $body.snapshots.0.version/]
// TESTRESPONSE[s/"start_time": "2020-07-06T21:55:18.132Z"/"start_time": $body.snapshots.0.start_time/]
// TESTRESPONSE[s/"start_time_in_millis": 1593093628852/"start_time_in_millis": $body.snapshots.0.start_time_in_millis/]
// TESTRESPONSE[s/"end_time": "2020-07-06T21:55:18.135Z"/"end_time": $body.snapshots.0.end_time/]
// TESTRESPONSE[s/"end_time_in_millis": 1593093628855/"end_time_in_millis": $body.snapshots.0.end_time_in_millis/]
// TESTRESPONSE[s/"duration_in_millis": 3/"duration_in_millis": $body.snapshots.0.duration_in_millis/]
...
The following request returns information for all snapshots in all repositories whose names do not contain the string "_2".

[source,console]
----
GET /_snapshot/*/*?search=-name:_2
----
  ...
  "snapshots": [
    {
      ...
      "end_time_in_millis": 1593093628849,
...
----
// TESTRESPONSE[s/"uuid": "IQo3ahn7Sbe6vcnnbSOtiQ"/"uuid": $body.snapshots.0.uuid/]
// TESTRESPONSE[s/"uuid": "dKb54xw67gvdRctLCxSket"/"uuid": $body.snapshots.1.uuid/]
// TESTRESPONSE[s/"uuid": "gvLCxSketdRctdKb54xw67"/"uuid": $body.snapshots.2.uuid/]
// TESTRESPONSE[s/"version_id": <version_id>/"version_id": $body.snapshots.0.version_id/]
// TESTRESPONSE[s/"version": <version>/"version": $body.snapshots.0.version/]
...
// TESTRESPONSE[s/"start_time": "2020-07-06T21:55:18.132Z"/"start_time": $body.snapshots.2.start_time/]
...
// TESTRESPONSE[s/"end_time": "2020-07-06T21:55:18.131Z"/"end_time": $body.snapshots.1.end_time/]
// TESTRESPONSE[s/"end_time": "2020-07-06T21:55:18.135Z"/"end_time": $body.snapshots.2.end_time/]
// TESTRESPONSE[s/"end_time_in_millis": 1593093628849/"end_time_in_millis": $body.snapshots.0.end_time_in_millis/]
// TESTRESPONSE[s/"end_time_in_millis": 1593093628851/"end_time_in_millis": $body.snapshots.1.end_time_in_millis/]
// TESTRESPONSE[s/"end_time_in_millis": 1593093628855/"end_time_in_millis": $body.snapshots.2.end_time_in_millis/]
...
// TESTRESPONSE[s/"duration_in_millis": 3/"duration_in_millis": $body.snapshots.2.duration_in_millis/]

...
Any data stream or index you restore from a snapshot must be compatible with the
current cluster's version. If you try to restore an index created in an

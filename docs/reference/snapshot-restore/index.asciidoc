...
with the current cluster's version.
//end::index-compat[]
If you try to restore an index created in an incompatible version, the restore
attempt will fail.
...
//tag::restore-reindex-workaround[]
...
//end::restore-reindex-workaround[]

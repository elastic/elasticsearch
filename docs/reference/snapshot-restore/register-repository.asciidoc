...
instance, https://minio.io[MinIO] provides an alternative compatible
implementation of the AWS S3 API so you can use MinIO with the
<<repository-s3,`s3` repository type>>.

...
IMPORTANT: The symlink must be readable by the `elasticsearch` user. By default, {es} runs
as user `elasticsearch` using uid:gid `1000:0`.

If the symlink exists, it will be used by default for all S3 repositories that don't have specific

...
may be rare and hard to reproduce. Their resolution often require to analyze
the requests and responses exchanged between Elasticsearch and the S3-compatible
service, which can be done by enabling low-level logging in the

...
As a result, indices adopting synthetic source or indices whose index mode adopts synthetic source cannot be
restored. When you restore a source-only snapshot:

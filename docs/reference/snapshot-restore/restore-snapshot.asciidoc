...
You can rename indices and data streams you restore. You typically use this
method to compare existing data to historical data from a snapshot. This method
doesn't require the deletion or overwrite of existing data.

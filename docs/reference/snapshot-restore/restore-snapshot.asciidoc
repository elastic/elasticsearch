...
You can rename indices and data streams you restore. This method doesn't require
the deletion or overwrite of any existing data. You typically use this method to
compare existing data to historical data from a snapshot.

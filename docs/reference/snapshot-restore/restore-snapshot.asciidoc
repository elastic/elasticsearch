...
You can rename indices and data streams you restore. Use this method if you want
to avoid deleting existing data. This lets you compare existing data to
historical data from a snapshot.

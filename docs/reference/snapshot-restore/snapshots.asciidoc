...
include::snapshots-register-repository.asciidoc[]
include::snapshots-take-snapshot.asciidoc[]
include::snapshots-restore-snapshot.asciidoc[]
include::snapshots-monitor-snapshot-restore.asciidoc[]

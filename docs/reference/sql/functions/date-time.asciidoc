...
If first argument is `week` and second argument is an interval, an error is thrown since week unit for intervals is not supported because months usually have fractional weeks.

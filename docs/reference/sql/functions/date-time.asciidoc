...
<1> date expression as a string. If `null`, the function returns `null`.
<2> parsing pattern. If `null`, the function returns `null`.
...
<2> format pattern. If `null`, the function returns `null`.
...
<1> datetime expression as a string. If `null`, the function returns `null`.
<2> parsing pattern. If `null`, the function returns `null`.
...
<1> time expression as a string. If `null`, the function returns `null`.
<2> parsing pattern. If `null`, the function returns `null`.

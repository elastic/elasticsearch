...
Synonyms Management APIs let you create and manage synonym sets.
...
Once a synonym set is used in a synonym token filter, these token filters can be used as part of a <<search-analyzer,search analyzers>>.

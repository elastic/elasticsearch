...
that can be collocated on a node in the cluster in order to get all shards assigned. 
...
. Open your deployment's side navigation (placed under the Elastic logo in the upper left corner)

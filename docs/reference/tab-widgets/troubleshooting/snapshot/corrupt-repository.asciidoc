...
Only one deployment must be writing to a repository. Let's call the deployment 
...
Let's first mark the repository as read-only on the secondary deployments:

...
the {transform}. If the destination index is an alias, then the alias's backing
write index will be deleted. The default value is `false`, meaning that the
destination index will not be deleted.

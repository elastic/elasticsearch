...
(Optional, Boolean) When `true`, the auto-created destination index is deleted
together with the {transform} that created the index. The default value is
`false`, meaning that the destination index will not be deleted.

...
created. Note that as of {es} version 8.10.0 a new version number has been introduced to
track changes to configuration and state in the machine learning plugin. This

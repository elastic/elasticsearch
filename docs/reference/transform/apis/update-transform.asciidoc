...
`sync`::
(Optional, object)
include::{docdir}/rest-api/common-parms.asciidoc[tag=synch]
  
`synch`.`time`:::
(Required, object)
include::{docdir}/rest-api/common-parms.asciidoc[tag=synch-time]

`synch`.`time`.`delay`::::
(Optional, <<time-units, time units>>)
include::{docdir}/rest-api/common-parms.asciidoc[tag=synch-time-delay]

`synch`.`time`.`field`::::
(Required, string)
include::{docdir}/rest-api/common-parms.asciidoc[tag=synch-time-field]
+
--

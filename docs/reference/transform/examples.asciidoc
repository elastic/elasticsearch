...
copies the most recent documents from the source index to the destination index
...
For applying a retention policy, specify a date field that is used to calculate 

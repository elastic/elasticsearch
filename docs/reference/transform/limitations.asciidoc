...
>>>>>>> a6c517a96e2... [DOCS] Changes wording to move away from data frame terminology in the ES repo (#47093)
...
upgrade from 7.2 to 7.3, and {transforms} have been created in 7.2, 

...
* {transforms-cap} deduce index mappings for output fields except if the fields 
  are created by a script. In this case, you might want to create the mappings 
  of the destination index yourself.

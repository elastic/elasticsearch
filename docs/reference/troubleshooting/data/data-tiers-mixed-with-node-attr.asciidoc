...
Elasticsearch standardised the implementation of https://www.elastic.co/blog/elasticsearch-data-lifecycle-management-with-data-tiers[hot-warm-cold architectures]
...
and mix the new way of implemetning the hot-warm-cold architecture with the 
<<shard-allocation-filtering, legacy way>> based on node attributes.

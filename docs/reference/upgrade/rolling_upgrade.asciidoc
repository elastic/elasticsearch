...
can continue to move between the phases and ensure version
compatibility.

You can get the list of nodes from specific tiers by `GET 
/_nodes/data_frozen:true/_none`, `GET /_nodes/data_cold:true/_none` etc.

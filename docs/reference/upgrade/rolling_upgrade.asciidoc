...
.. If you are using data tiers or node attributes with hot-warm-cold architectures, you should upgrade the nodes by tier, completing one tier at a time, in this order: frozen, cold, warm and finally hot tier.

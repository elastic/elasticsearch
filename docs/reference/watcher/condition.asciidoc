...
:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/condition/always.asciidoc
include::condition/always.asciidoc[]

:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/condition/never.asciidoc
include::condition/never.asciidoc[]

:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/condition/compare.asciidoc
include::condition/compare.asciidoc[]

:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/condition/array-compare.asciidoc
include::condition/array-compare.asciidoc[]

:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/condition/script.asciidoc

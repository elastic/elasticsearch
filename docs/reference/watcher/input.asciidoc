...
:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/input/simple.asciidoc
include::input/simple.asciidoc[]

:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/input/search.asciidoc
include::input/search.asciidoc[]

:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/input/http.asciidoc
include::input/http.asciidoc[]

:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/input/chain.asciidoc

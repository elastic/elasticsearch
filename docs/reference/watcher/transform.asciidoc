...
:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/transform/search.asciidoc
include::transform/search.asciidoc[]

:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/transform/script.asciidoc
include::transform/script.asciidoc[]

:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/docs/reference/watcher/transform/chain.asciidoc

...
* The `bbq_disk` index format was introduced in 9.2.0 without appropriate license enforcement.

  Upon upgrading to 9.3+ indices created on 9.2 will still be available for updates and queries.

...
to create new scenarios. We have taken over the scenarios tested so far and added them to our testing infrastructure. Of course
as the system evolves, new scenarios can come up that are not yet covered. We are committed to investigate them and report the issues
we find, both here in in our github repository.
...
testing farm and are passing. We are also working on running Jepsen independently and verify no failures are found.

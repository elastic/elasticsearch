...
public class UsagePersisterTests extends ESTestCase {
    ...
    public void testPersistUsageCounts() throws ParseException {
        ...
        assertEquals(Arrays.asList("ml-usage", AnomalyDetectorsIndex.jobResultsIndexName("job1")), indexCaptor.getAllValues());
        ...
        assertEquals("ml-usage", indexCaptor.getAllValues().get(0));

...
public @interface EntitlementTest {
     ...
     * {@code toString()}. The test infrastructure will verify the returned value matches this
     * when running in a denied context.
     ...
     * Mutually exclusive with {@link #expectedDefaultIfDenied()}.
     */

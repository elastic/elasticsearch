...
/**
 * Functional interface for functions with two parameters that return a value.
 * <p>
 ...
 */
public interface Call2<R, A, B> extends Serializable, VarargCallAdapter<R> {
    /**
     ...
     */
    R call(A arg0, B arg1) throws Exception;
    ...
    default VarargCall<R> asVarargCall() {
        return args -> call((A) args[0], (B) args[1]);
    }
}

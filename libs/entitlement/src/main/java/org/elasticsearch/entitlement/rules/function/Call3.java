...
/**
 * Functional interface for functions with three parameters that return a value.
 * <p>
 ...
 */
public interface Call3<R, A, B, C> extends Serializable, VarargCallAdapter<R> {
    /**
     * Invokes the function with three arguments.
     *
     ...
     */
    R call(A arg0, B arg1, C arg2) throws Exception;
    ...
    default VarargCall<R> asVarargCall() {
        return args -> call((A) args[0], (B) args[1], (C) args[2]);
    }
}

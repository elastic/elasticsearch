...
/**
 * Functional interface for functions with six parameters that return a value.
 * <p>
 ...
 */
public interface Call6<R, A, B, C, D, E, F> extends Serializable, VarargCallAdapter<R> {
    /**
     ...
     */
    R call(A arg0, B arg1, C arg2, D arg3, E arg4, F arg5) throws Exception;
    ...
    default VarargCall<R> asVarargCall() {
        return args -> call((A) args[0], (B) args[1], (C) args[2], (D) args[3], (E) args[4], (F) args[5]);
    }
}

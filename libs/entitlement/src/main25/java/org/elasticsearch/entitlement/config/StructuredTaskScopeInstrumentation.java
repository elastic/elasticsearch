...
public class StructuredTaskScopeInstrumentation implements InstrumentationConfig {
    ...
    public void init(InternalInstrumentationRegistry registry) {
        ...
        builder.on(StructuredTaskScope.class, rule -> {
            ...
            rule.callingStatic(StructuredTaskScope::open, new TypeToken<StructuredTaskScope.Joiner<?, ?>>() {})
                .enforce(Policies::manageThreads)
                .elseThrowNotEntitled();
            rule.callingStatic(
                StructuredTaskScope::open,
                new TypeToken<StructuredTaskScope.Joiner<?, ?>>() {},
                new TypeToken<Function<StructuredTaskScope.Configuration, StructuredTaskScope.Configuration>>() {}

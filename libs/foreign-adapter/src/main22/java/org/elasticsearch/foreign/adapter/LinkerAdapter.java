...
public class LinkerAdapter {
    ...
    /**
     * On JDK 22+ {@code Linker.Option.critical(true)} already lets the raw downcall accept heap
     * segments, so the fallback adapter is never needed. This method is an identity pass-through
     * that mirrors the JDK 21 signature so generated bytecode resolves on both releases.
     */

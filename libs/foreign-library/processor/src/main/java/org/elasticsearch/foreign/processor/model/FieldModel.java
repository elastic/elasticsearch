 ...
 * of the method that returns the element count.
 *
 ...
 * @param lengthFieldName   name of the count method; {@code null} for scalar fields
 */
public record FieldModel(String name, NativeType type, String elementSimpleName, String lengthFieldName) {

    public boolean isArray() {
        return elementSimpleName != null;
    }

    public static FieldModel scalar(String name, NativeType type) {
        return new FieldModel(name, type, null, null);
    }

    public static FieldModel array(String name, String elementSimpleName, String lengthFieldName) {
        return new FieldModel(name, NativeType.ADDRESS, elementSimpleName, lengthFieldName);
    }
}

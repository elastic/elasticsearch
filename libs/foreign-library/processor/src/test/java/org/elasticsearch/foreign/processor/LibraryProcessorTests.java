...
public class LibraryProcessorTests extends ProcessorTestCase {
    ...
    /**
     * A plain {@code @Critical} binding compiles cleanly and the {@code $Impl} is generated. The
     * generated downcall is wired with {@code Linker.Option.critical(true)}; no fallback adapter is needed.
     */
    public void testCriticalCompilesAndGeneratesImpl() throws Exception {
        String source = """
            package test;
        ...
        assertNotNull(result.loadClassNoInit("test.CritLib$Impl"));
    }

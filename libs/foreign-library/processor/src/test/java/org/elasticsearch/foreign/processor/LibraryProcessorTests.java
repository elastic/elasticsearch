...
public class LibraryProcessorTests extends ProcessorTestCase {
    ...
    /**
     * A plain {@code @Critical} binding compiles cleanly and produces a loadable {@code $Impl}. The
     * annotation is a marker with no attributes; the generated downcall carries
     * {@code Linker.Option.critical(true)}.
     */
    public void testCriticalCompilesClean() throws Exception {
        String source = """
            package test;

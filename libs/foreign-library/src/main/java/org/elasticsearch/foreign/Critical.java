 ...
 * }</pre>
 *
 * <p>The processor wires the generated downcall with {@code Linker.Option.critical(true)} so the
 * linker accepts heap-backed {@link java.lang.foreign.MemorySegment} arguments directly.
 */

...
public class PolygonTests extends BaseGeometryTestCase<Polygon> {
    ...
    public void testInitValidation() {
        ...
        ex = expectThrows(IllegalArgumentException.class, () -> StandardValidator.get(false).validate(
    ...
    public void testWKTValidation() {
        IllegalArgumentException ex = expectThrows(IllegalArgumentException.class,
            () -> WellKnownText.fromWKT(GeographyValidator.get(true), false, "polygon ((3 1 5, 4 2 4, 5 3 3))"));
        ...
        ex = expectThrows(IllegalArgumentException.class,
            () -> WellKnownText.fromWKT(GeographyValidator.get(false), randomBoolean(), "polygon ((3 1 5, 4 2 4, 5 3 3, 3 1 5))"));
        assertEquals("found Z value [5.0] but [ignore_z_value] parameter is [false]", ex.getMessage());

        ex = expectThrows(IllegalArgumentException.class,
            () ->  WellKnownText.fromWKT(GeographyValidator.get(randomBoolean()), false,

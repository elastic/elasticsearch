 ...
 * Taken from org.elasticsearch.logging.impl.JsonThrowablePatternConverter</li>
 * </ul>
 * <p>
 ...
 * <p>
 * The value taken from org.elasticsearch.logging.impl.ESLogMessage has to be a simple escaped JSON value.
...
public class ESJsonLayout extends AbstractStringLayout {
    ...
    public static class Builder<B extends ESJsonLayout.Builder<B>> extends AbstractStringLayout.Builder<B>
        ...
        public ESJsonLayout build() {
            String[] split = Util.isNullOrEmpty(overrideFields) ? new String[] {} : overrideFields.split(",");
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("org.elasticsearch.logging.impl.ESJsonLayout{");

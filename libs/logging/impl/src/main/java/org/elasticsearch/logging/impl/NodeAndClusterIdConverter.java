 ...
 */
@Plugin(category = PatternConverter.CATEGORY, name = "org.elasticsearch.logging.impl.NodeAndClusterIdConverter")
...
public final class NodeAndClusterIdConverter extends LogEventPatternConverter {
    ...
    public static void  init() {
        Log4JBootstrapSupportImpl.initPlugins(PatternConverter.CATEGORY, NodeAndClusterIdConverter.class, "org.elasticsearch.logging.impl.NodeAndClusterIdConverter", new PluginEntry());
    }
    ...
    public void format(LogEvent event, StringBuilder toAppendTo) {
        String nodeId = ServerSupport.INSTANCE.nodeId();
        String clusterId = ServerSupport.INSTANCE.clusterId();

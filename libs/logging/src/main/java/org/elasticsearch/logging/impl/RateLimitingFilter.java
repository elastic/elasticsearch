...
import static org.elasticsearch.logging.impl.Util.isNullOrEmpty;
...
public class RateLimitingFilter extends AbstractFilter implements org.elasticsearch.logging.core.RateLimitingFilter {
    ...
    @Override
    public Result filter(org.elasticsearch.logging.core.LogEvent logEvent) {

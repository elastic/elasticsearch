 ...
 */
public class ESLogMessageImpl extends MapMessage<ESLogMessageImpl, Object> {
    private final List<Object> arguments = new ArrayList<>();
    private String messagePattern;

    public ESLogMessageImpl(String messagePattern, Object... args) {
    ...
    public ESLogMessageImpl() {
        super(new LinkedHashMap<>());
    }

    public ESLogMessageImpl argAndField(String key, Object value) {
        this.arguments.add(value);
        super.with(key, value);
        return this;
    }

    public ESLogMessageImpl field(String key, Object value) {
        super.with(key, value);
        return this;
    }

    public ESLogMessageImpl withFields(Map<String, Object> prepareMap) {

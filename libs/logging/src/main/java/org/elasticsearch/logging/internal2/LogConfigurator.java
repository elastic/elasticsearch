...
public class LogConfigurator {
     ...
     */
    public static void configureWithoutConfig(
    ...
    public enum ConsoleAppenderMode {
        ENABLE,
        DISABLE
    }

    public static final Consumer<ConsoleAppenderMode> consoleAppender() {
        return mode -> {
            ...
            if (mode == ConsoleAppenderMode.ENABLE) {
    ...
    private static void configureImpl(
        String clusterName,
        String nodeName,
        Optional<org.elasticsearch.logging.Level> defaultLogLevel,
        Map<String, org.elasticsearch.logging.Level> logLevelSettingsMap,

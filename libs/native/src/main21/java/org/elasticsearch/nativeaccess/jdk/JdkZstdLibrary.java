...
public class JdkZstdLibrary implements ZstdLibrary {
    ...
    private static final MethodHandle compress$mh = downcallHandle("ZSTD_compress", FunctionDescriptor.of(JAVA_LONG, ADDRESS, JAVA_INT, ADDRESS, JAVA_INT, JAVA_INT));
    ...
    private static final MethodHandle decompress$mh = downcallHandle("ZSTD_decompress", FunctionDescriptor.of(JAVA_LONG, ADDRESS, JAVA_INT, ADDRESS, JAVA_INT));

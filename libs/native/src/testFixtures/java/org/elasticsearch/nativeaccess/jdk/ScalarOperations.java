...
public class ScalarOperations {
    ...
    static float similarity(VectorSimilarityFunctions.SimilarityFunction function, byte[] a, byte[] b) {
    ...
    static float similarity(VectorSimilarityFunctions.SimilarityFunction function, float[] a, float[] b) {
        return switch (function) {
            case DOT_PRODUCT -> dotProduct(a, b);
            case SQUARE_DISTANCE -> squareDistance(a, b);
    ...
    static void bulk(VectorSimilarityFunctions.SimilarityFunction function, byte[] query, byte[][] data, float[] scores) {
    ...
    static void bulk(VectorSimilarityFunctions.SimilarityFunction function, float[] query, float[][] data, float[] scores) {

...
static inline void sqrf32_inner_bulk(
    ...
    for (; c + 7 < count; c += 8) {
        ...
        const f32_t* a4 = mapper(a, c + 4, offsets, vec_size);
        const f32_t* a5 = mapper(a, c + 5, offsets, vec_size);
        const f32_t* a6 = mapper(a, c + 6, offsets, vec_size);
        const f32_t* a7 = mapper(a, c + 7, offsets, vec_size);

...
static inline float32_t hsum_f32_8(const __m256 v) {
...
EXPORT float32_t cosf32(const float32_t *a, const float32_t *b, const int32_t elementCount) {
    ...
    float32_t dot_result = hsum_f32_8(dot_total);
    float32_t norm_a_result = hsum_f32_8(norm_a_total);
    float32_t norm_b_result = hsum_f32_8(norm_b_total);
    ...
    float32_t denom = sqrtf(norm_a_result) * sqrtf(norm_b_result);
    if (denom == 0.0f) {
        return 0.0f;
    }
...
EXPORT float32_t dotf32(const float32_t *a, const float32_t *b, const int32_t elementCount) {
    ...
    float32_t result = hsum_f32_8(total_sum);

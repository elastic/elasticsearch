...
EXPORT int64_t vec_doti1i4_2(const int8_t* a, const int8_t* query, const int32_t length) {
...
EXPORT void vec_doti1i4_bulk_2(
    const int8_t* a,
    const int8_t* query,
    const int32_t length,
    const int32_t count,
...
EXPORT void vec_doti1i4_bulk_offsets_2(
    const int8_t* a,
    const int8_t* query,
    const int32_t length,
    const int32_t pitch,

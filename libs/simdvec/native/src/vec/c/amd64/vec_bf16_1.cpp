...
EXPORT void vec_dotDbf16Qf32_bulk(
    ...
    bf16_bulk_inner<bf16_t, f32_t, sequential_mapper, load_f32, _mm256_fmadd_ps, dot_scalar, vec_dotDbf16Qf32>(
...
EXPORT void vec_dotDbf16Qbf16_bulk(
    ...
    bf16_bulk_inner<bf16_t, bf16_t, sequential_mapper, load_bf16, _mm256_fmadd_ps, dot_scalar, vec_dotDbf16Qbf16>(
        a, b, dims, dims, NULL, count, results);
}
...
EXPORT void vec_dotDbf16Qf32_bulk_sparse(
    ...
    bf16_bulk_inner<const bf16_t*, f32_t, sparse_mapper, load_f32, _mm256_fmadd_ps, dot_scalar, vec_dotDbf16Qf32>(
...
EXPORT void vec_dotDbf16Qbf16_bulk_sparse(
    ...
    bf16_bulk_inner<const bf16_t*, bf16_t, sparse_mapper, load_bf16, _mm256_fmadd_ps, dot_scalar, vec_dotDbf16Qbf16>(
        (const bf16_t* const*)addresses, query, length, 0, NULL, count, results);
}
...
EXPORT void vec_dotDbf16Qf32_bulk_offsets(
    ...
    const int32_t count,
    f32_t* results) {
    bf16_bulk_inner<bf16_t, f32_t, offsets_mapper, load_f32, _mm256_fmadd_ps, dot_scalar, vec_dotDbf16Qf32>(
...
EXPORT void vec_dotDbf16Qbf16_bulk_offsets(
    ...
    const int32_t count,
    f32_t* results) {
    bf16_bulk_inner<bf16_t, bf16_t, offsets_mapper, load_bf16, _mm256_fmadd_ps, dot_scalar, vec_dotDbf16Qbf16>(
        a, b, dims, pitch / sizeof(bf16_t), offsets, count, results);
}

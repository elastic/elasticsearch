...
//     * classes that cannot directly implement {@code MemorySegmentAccessInput} can still
//     * provide zero-copy access to mmap'd data through {@code DirectAccessInput.withByteBufferSlice}.
//     *
...
//
//    /**
//     * Bulk variant of {@link #withByteBufferSlice}. Resolves {@code count} ranges from
//     * the given {@link MemorySegmentAccessInput} to read-only {@link ByteBuffer}s and
//     * passes them to the action. Returns {@code true} if all ranges were available and
//     * the action was invoked, {@code false} otherwise.
//     *

...
public class Similarities {
    ...
    static final MethodHandle DOT_PRODUCT_I4I4 = DISTANCE_FUNCS.getHandle(Function.DOT_PRODUCT, BBQType.I4I4, Operation.SINGLE);
    static final MethodHandle DOT_PRODUCT_I4I4_BULK = DISTANCE_FUNCS.getHandle(Function.DOT_PRODUCT, BBQType.I4I4, Operation.BULK);
    static final MethodHandle DOT_PRODUCT_I4I4_BULK_WITH_OFFSETS = DISTANCE_FUNCS.getHandle(
        Function.DOT_PRODUCT,
        BBQType.I4I4,
        Operation.BULK_OFFSETS
    );
    ...
    public static long dotProductI4I4(MemorySegment a, MemorySegment query, int length) {
        try {
            return (long) DOT_PRODUCT_I4I4.invokeExact(a, query, length);
        } catch (Throwable e) {
            throw rethrow(e);
        }
    }

    public static void dotProductI4I4Bulk(MemorySegment a, MemorySegment query, int length, int count, MemorySegment scores) {
        try {
            DOT_PRODUCT_I4I4_BULK.invokeExact(a, query, length, count, scores);
        } catch (Throwable e) {
            throw rethrow(e);
        }
    }

    static void dotProductI4I4BulkWithOffsets(
        MemorySegment a,
        MemorySegment query,
        int length,
        int pitch,
        ...
        try {
            DOT_PRODUCT_I4I4_BULK_WITH_OFFSETS.invokeExact(a, query, length, pitch, offsets, count, scores);
        } catch (Throwable e) {
            throw rethrow(e);
        }
    }

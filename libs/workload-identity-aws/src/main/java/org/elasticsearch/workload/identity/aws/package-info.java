...
/**
 * Fully asynchronous, non-blocking implementations of the AWS SDK v2 credential-provider contract
 * ({@link software.amazon.awssdk.auth.credentials.AwsCredentialsProvider} /
 * {@link software.amazon.awssdk.identity.spi.IdentityProvider}) intended for use with the AWS async
 ...
 * override {@code resolveIdentity()} to return a {@link java.util.concurrent.CompletableFuture}

...
/**
 * Superclass for {@link ConstructingObjectParser} and {@link InstantiatingObjectParser}.
 *
 * Defines most of the parsing methods so they can be shared. The building methods are different.
 */
public abstract class AbstractConstructingObjectParser<Value, Context> extends AbstractObjectParser<Value, Context> {
    /**
     ...
     */
    public AbstractConstructingObjectParser(String name, boolean ignoreUnknownFields) {
     ...
     * {@link #build} and the order that missing arguments are reported to the user if any are missing. When all of these parameters are
    ...
    protected abstract Value build(Object[] args, Context context);
    ...
    /**
     * The target of the {@linkplain AbstractConstructingObjectParser}. One of these is built every time you call
     * {@linkplain AbstractConstructingObjectParser#apply(XContentParser, Object)} Note that it is not static so it inherits
     * {@linkplain AbstractConstructingObjectParser}'s type parameters.
     */
    private class Target {
        /**
         * Array of constructor args to be passed to the {@link AbstractConstructingObjectParser#build}.
         */
        ...
        /**
         * The parse context that is used for this invocation. Stored here so that it can be passed to the {@link #build}.
         */
        ...
        private void buildTarget() {
            try {
                targetObject = build(constructorArgs, context);

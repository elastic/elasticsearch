...
public interface XContentGenerator extends Closeable, Flushable {
     ...
     * the writer must a valid JSON value (e.g., string is properly escaped and quoted)
     */
    void writeFieldDirectly(String name, CheckedConsumer<OutputStream, IOException> writer) throws IOException;

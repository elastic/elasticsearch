    ...
    private abstract static class TokenIterator {
        ...
        TokenIterator processValue(Object value) {
            if (value instanceof Map) {
                ...
                // this allows to use arrays of doubles instead of list of doubles in the object representation
                List<Object> list = Arrays.stream(doubles).boxed().collect(Collectors.toUnmodifiableList());
                return new ArrayIterator(this, childName(), list).next();

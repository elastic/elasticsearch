...
public class TimeSeriesAggregatorTests extends AggregationTestCase {
    ...
    public void testMultiBucketAggregationAsSubAggregation() throws IOException {
        ...
        Consumer<InternalTimeSeries> verifier = ts -> {
            ...
            assertThat(ts.getBucketByKey("C0uMhZuLQSpAQ5ipTZFLMhL_RWtkZqXKUU-L12Qrh1jJj2DTLJtLqg").docCount, equalTo(4L));
            InternalDateHistogram byTimeStampBucket = ts.getBucketByKey("C0uMhZuLQSpAQ5ipTZFLMhL_RWtkZqXKUU-L12Qrh1jJj2DTLJtLqg")
                .getAggregations()
                .get("by_timestamp");
            assertThat(
            ...
            assertThat(ts.getBucketByKey("C0uMhZuLQSpAQ5ipTZFLMmPM3J-Az1W934hGmwK9c1PmP91fi3PSqA").docCount, equalTo(2L));
            byTimeStampBucket = ts.getBucketByKey("C0uMhZuLQSpAQ5ipTZFLMmPM3J-Az1W934hGmwK9c1PmP91fi3PSqA")
                .getAggregations()
                .get("by_timestamp");
            assertThat(
                byTimeStampBucket.getBuckets(),

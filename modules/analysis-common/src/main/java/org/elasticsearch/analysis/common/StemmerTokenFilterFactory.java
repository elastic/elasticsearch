...
public class StemmerTokenFilterFactory extends AbstractTokenFilterFactory {
    ...
    public TokenStream create(TokenStream tokenStream) {
        if ("arabic".equalsIgnoreCase(language)) {
            ...
            // NOCOMMIT KPStemmer has been removed, what is the migration path for users relying on it?
            ...
            || "kstem".equalsIgnoreCase(language)) {
                ...
                // NOCOMMIT LovinsStemmer has been removed, what is the migration path for users relying on it?
                throw new UnsupportedOperationException();
                ...
                // NOCOMMIT how about bw comp for users relying on german2 stemmer that is now folded into german stemmer?
                return new SnowballFilter(tokenStream, new GermanStemmer());

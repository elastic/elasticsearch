...
public class APM extends Plugin implements NetworkPlugin, TelemetryPlugin {
    ...
    public List<Setting<?>> getSettings() {
        return List.of(
            ...
            OtelSdkExportMeterSupplier.TELEMETRY_OTEL_METRICS_ENDPOINT,
            OtelSdkExportMeterSupplier.TELEMETRY_OTEL_METRICS_INTERVAL,
            OtelSdkExportMeterSupplier.TELEMETRY_OTEL_METRICS_ENABLED,
            // Tracing

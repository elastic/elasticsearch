...
import org.elasticsearch.telemetry.apm.internal.export.otelsdk.OtelSdkExportSettings;
...
public class APM extends Plugin implements NetworkPlugin, TelemetryPlugin {
    ...
    public List<Setting<?>> getSettings() {
        return List.of(
            ...
            OtelSdkExportSettings.TELEMETRY_OTEL_METRICS_ENDPOINT,
            OtelSdkExportSettings.TELEMETRY_OTEL_METRICS_INTERVAL,
            OtelSdkExportSettings.TELEMETRY_OTEL_METRICS_ENABLED,
            // Tracing

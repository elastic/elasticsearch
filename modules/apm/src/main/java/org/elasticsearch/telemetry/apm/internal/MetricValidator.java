...
public class MetricValidator {
    ...
    private static class Attributes {
        ...
        static final Map<String, Set<String>> SKIP_VALIDATION = Map.ofEntries(
            ...
            Map.entry("es.allocator.shards.unassigned_to_initializing.duration.histogram", Set.of("primary", "reason", "delayed")),
            Map.entry("es.allocator.shards.unassigned_to_started.duration.histogram", Set.of("primary", "reason", "delayed")),

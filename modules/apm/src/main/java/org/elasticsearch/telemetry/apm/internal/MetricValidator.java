...
public class MetricValidator {
    ...
    private static class Attributes {
        ...
        static final Set<String> REPO_RETRIES_ATTRIBUTES = Sets.addToCopy(REPO_ATTRIBUTES, "action");
        ...
        static final Map<String, Set<String>> SKIP_VALIDATION = Map.ofEntries(
            ...
            Map.entry("es.repositories.input_stream.retry.success.total", REPO_RETRIES_ATTRIBUTES),
            Map.entry("es.repositories.input_stream.retry.event.total", REPO_RETRIES_ATTRIBUTES),
            Map.entry("es.repositories.input_stream.retry.attempts.histogram", REPO_RETRIES_ATTRIBUTES),

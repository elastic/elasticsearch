...
import org.elasticsearch.telemetry.apm.internal.metrics.internal.APMTelemetryProvider;
...
public class APM extends Plugin implements NetworkPlugin, TelemetryPlugin {
    ...
    public Collection<Object> createComponents(
        ...
        final MeterService apmMeter = telemetryProvider.get().getMeterService();

...
public class APMTracer extends AbstractLifecycleComponent implements org.elasticsearch.telemetry.tracing.Tracer {
    ...
    public APMTracer(Settings settings) {
        this.includeNames = APMAgentSettings.APM_TRACING_NAMES_INCLUDE_SETTING.get(settings);
        this.excludeNames = APMAgentSettings.APM_TRACING_NAMES_EXCLUDE_SETTING.get(settings);
        this.labelFilters = APMAgentSettings.APM_TRACING_SANITIZE_FIELD_NAMES.get(settings);
        ...
        this.enabled = APMAgentSettings.APM_ENABLED_SETTING.get(settings);
    }

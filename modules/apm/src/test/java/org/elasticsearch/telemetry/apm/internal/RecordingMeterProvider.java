...
public class RecordingMeterProvider implements Meter {
    ...
    // TODO(stu): handle closed
    private final List<Consumer<ObservableDoubleMeasurement>> doubleCallbacks = new ArrayList<>();
    private final List<Consumer<ObservableLongMeasurement>> longCallbacks = new ArrayList<>();

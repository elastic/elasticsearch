...
public class ArrowBulkIncrementalParserTests extends ESTestCase {
    ...
    public void testDictionaryEncoding() throws Exception {
        ...
        try (
            ...
            dictVector.setSafe(0, new Text("aa"));
            dictVector.setSafe(1, new Text("bb"));
            dictVector.setSafe(2, new Text("cc"));
            ...
            vector.setSafe(0, new Text("bb"));
            vector.setSafe(1, new Text("bb"));
            vector.setSafe(2, new Text("cc"));
            vector.setSafe(3, new Text("aa"));

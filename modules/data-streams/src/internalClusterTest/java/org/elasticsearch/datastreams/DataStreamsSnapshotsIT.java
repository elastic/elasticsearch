...
public class DataStreamsSnapshotsIT extends AbstractSnapshotIntegTestCase {
    ...
    public void setup() throws Exception {
        ...
        fsFailureIndexName = dataStreamInfos.get(2).getDataStream().getFailureComponent().getIndices().get(0).getName();
    ...
    public void testSnapshotAndRestoreAllDataStreamsInPlace() throws Exception {
        ...
        List<Index> failureIndices = dataStreamInfos.get(2).getDataStream().getFailureComponent().getIndices();
    ...
    public void testFailureStoreSnapshotAndRestore() throws Exception {
...

        {
            ...
            assertEquals(fsFailureIndexName, dataStreamInfos.get(0).getDataStream().getFailureComponent().getIndices().get(0).getName());
        }
        {
            // With rename pattern
            RestoreSnapshotResponse restoreSnapshotResponse = client.admin()
            ...
            assertEquals(fs2FailureIndexName, dataStreamInfos.get(0).getDataStream().getFailureComponent().getIndices().get(0).getName());
        }
    }
    ...
    public void testSnapshotAndRestoreAll() throws Exception {
        ...
        assertEquals(1, dataStreamInfos.get(2).getDataStream().getFailureComponent().getIndices().size());
        assertEquals(fsFailureIndexName, dataStreamInfos.get(2).getDataStream().getFailureComponent().getIndices().get(0).getName());
    ...
    public void testExcludeDSFromSnapshotWhenExcludingAnyOfItsIndices() {
        ...
        // Exclude only failure store indices
        {
            ...
            assertThat(dataStream.getDataStream().getFailureComponent().getIndices(), empty());
        }
    }

...
public abstract class DataStreamLifecycleServiceTestCase extends ESTestCase {
    ...
    protected static ForceMergeRequestWrapper copyForceMergeRequestWrapperRequest(ForceMergeRequestWrapper original) {
        return new ForceMergeRequestWrapper(original);
    }

    protected static ForceMergeRequestWrapper mutateForceMergeRequestWrapper(ForceMergeRequestWrapper original) {

...
import static org.elasticsearch.index.query.GeoShapeQueryBuilders.geoIntersectionQuery;
import static org.elasticsearch.index.query.GeoShapeQueryBuilders.geoShapeQuery;
...
public class GeoShapeQueryTests extends ESSingleNodeTestCase {
    ...
    public void testShapeFetchingPath() throws Exception {
        ...
        GeoShapeQueryBuilder filter = GeoShapeQueryBuilders.geoShapeQuery("location", "1", "type").relation(ShapeRelation.INTERSECTS)
        ...
        filter = GeoShapeQueryBuilders.geoShapeQuery("location", "1", "type").relation(ShapeRelation.INTERSECTS)
                .indexedShapeIndex("shapes")
        ...
        GeoShapeQueryBuilder query = GeoShapeQueryBuilders.geoShapeQuery("location", "1", "type")
                .indexedShapeIndex("shapes")
                .indexedShapePath("location");
        result = client().prepareSearch("test").setQuery(query).get();
        assertSearchResponse(result);
        assertHitCount(result, 1);
        query = GeoShapeQueryBuilders.geoShapeQuery("location", "1", "type")
                .indexedShapeIndex("shapes")
                .indexedShapePath("1.location");
        result = client().prepareSearch("test").setQuery(query).get();
        assertSearchResponse(result);
    ...
    public void testShapeFilterWithRandomGeoCollection() throws Exception {
        ...
        GeoShapeQueryBuilder filter = GeoShapeQueryBuilders.geoShapeQuery("location", filterShape);
    ...
    public void testContainsShapeQuery() throws Exception {
        ...
        EnvelopeBuilder env = new EnvelopeBuilder(
                new Coordinate(mbr.getMinX(), mbr.getMaxY()), new Coordinate(mbr.getMaxX(), mbr.getMinY()));
    ...
    public void testShapeFilterWithDefinedGeoCollection() throws Exception {
        ...
        GeoShapeQueryBuilder filter = GeoShapeQueryBuilders.geoShapeQuery(
                "location",
                ShapeBuilders.newGeometryCollection()
                        .polygon(
                                ShapeBuilders.newPolygon(
                                        new CoordinatesBuilder().coordinate(99.0, -1.0).coordinate(99.0, 3.0).coordinate(103.0, 3.0)
                                        .coordinate(103.0, -1.0).coordinate(99.0, -1.0)))).relation(ShapeRelation.INTERSECTS);
        SearchResponse result = client().prepareSearch("test").setTypes("type").setQuery(QueryBuilders.matchAllQuery())
                .setPostFilter(filter).get();
        assertSearchResponse(result);
        assertHitCount(result, 1);
        filter = GeoShapeQueryBuilders.geoShapeQuery(
                "location",
                ShapeBuilders.newGeometryCollection().polygon(
                        ShapeBuilders.newPolygon(new CoordinatesBuilder().coordinate(199.0, -11.0).coordinate(199.0, 13.0)
                                .coordinate(193.0, 13.0).coordinate(193.0, -11.0).coordinate(199.0, -11.0))))
                .relation(ShapeRelation.INTERSECTS);
        result = client().prepareSearch("test").setTypes("type").setQuery(QueryBuilders.matchAllQuery())
                .setPostFilter(filter).get();
        assertSearchResponse(result);
        assertHitCount(result, 0);
        filter = GeoShapeQueryBuilders.geoShapeQuery("location", ShapeBuilders.newGeometryCollection()
                .polygon(ShapeBuilders.newPolygon(new CoordinatesBuilder().coordinate(99.0, -1.0).coordinate(99.0, 3.0)
                        .coordinate(103.0, 3.0).coordinate(103.0, -1.0).coordinate(99.0, -1.0)))
                        .polygon(
                                ShapeBuilders.newPolygon(new CoordinatesBuilder().coordinate(199.0, -11.0).coordinate(199.0, 13.0)

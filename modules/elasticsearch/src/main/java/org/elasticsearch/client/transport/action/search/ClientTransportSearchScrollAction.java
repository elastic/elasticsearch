...
package org.elasticsearch.client.transport.action.search;
...
public class ClientTransportSearchScrollAction extends BaseClientTransportAction<SearchScrollRequest, SearchResponse> {
    ...
    @Inject public ClientTransportSearchScrollAction(Settings settings, TransportService transportService) {
        super(settings, transportService, SearchResponse.class);
    }

    @Override protected String action() {
        return TransportActions.SEARCH_SCROLL;
    }
}
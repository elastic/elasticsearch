...
public class NodeAliasesUpdatedAction extends AbstractComponent {
    ...
    private void innerNodeAliasesUpdated(NodeAliasesUpdatedResponse response) {
        for (Listener listener : listeners) {
            if (listener.expectedVersion() <= response.version) {
    ...
    private class NodeMappingCreatedTransportHandler extends BaseTransportRequestHandler<NodeAliasesUpdatedResponse> {

 ...
 */
@MBean(objectName = "service=threadpool,threadpoolType=fixed", description = "Fixed Thread Pool")
public class FixedThreadPoolManagement {

    private final FixedThreadPool threadPool;

    @Inject public FixedThreadPoolManagement(ThreadPool threadPool) {
        this.threadPool = (FixedThreadPool) threadPool;
    }

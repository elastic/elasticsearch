...
public class TShortStack {
    ...
    public static final int DEFAULT_CAPACITY = TShortArrayList.DEFAULT_CAPACITY;

    /**
     * Creates a new <code>TShortStack</code> instance with the default
     * capacity.
     */
    public TShortStack() {
    ...
    /**
     * Creates a new <code>TShortStack</code> instance with the
     * specified capacity.
     *

...
class InjectorImpl implements Injector, Lookups {
   ...
   * @throws org.elasticsearch.util.guice.inject.internal.ErrorsException if there was an error resolving the binding
   */
   ...
   * </ol>
   *
   * @throws org.elasticsearch.util.guice.inject.internal.ErrorsException if the binding cannot be created.
   */

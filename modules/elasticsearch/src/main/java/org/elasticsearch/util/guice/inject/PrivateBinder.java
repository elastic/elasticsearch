 ...
 * {@link org.elasticsearch.util.guice.inject.PrivateModule PrivateModule} for details.
 * 
...
public interface PrivateBinder extends Binder {
   ...
   * org.elasticsearch.util.guice.inject.binder.AnnotatedElementBuilder#annotatedWith(Class) annotatedWith()} to expose {@code type} with a
   * binding annotation.
   */

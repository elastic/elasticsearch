...
import org.elasticsearch.util.guice.inject.spi.TypeConverter;
 ...
 * org.elasticsearch.util.guice.inject.Provides Provides} bindings can be exposed with the {@literal @}{@link
 * Exposed} annotation:
 *
 * <pre>
...
public abstract class PrivateModule implements Module {
  ...
  /**
   * @see Binder#convertToTypes(org.elasticsearch.util.guice.inject.matcher.Matcher, org.elasticsearch.util.guice.inject.spi.TypeConverter)
   */
  ...
  /**
   * @see Binder#bindListener(org.elasticsearch.util.guice.inject.matcher.Matcher, org.elasticsearch.util.guice.inject.spi.TypeListener)
   */

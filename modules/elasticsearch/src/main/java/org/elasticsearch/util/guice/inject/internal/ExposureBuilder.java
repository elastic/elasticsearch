...
public class ExposureBuilder<T> implements AnnotatedElementBuilder {
  ...
  public void annotatedWith(Class<? extends Annotation> annotationType) {
    org.elasticsearch.util.guice.inject.internal.Preconditions.checkNotNull(annotationType, "annotationType");
    checkNotAnnotated();
    key = Key.get(key.getTypeLiteral(), annotationType);
  }

  public void annotatedWith(Annotation annotation) {
    org.elasticsearch.util.guice.inject.internal.Preconditions.checkNotNull(annotation, "annotation");
    checkNotAnnotated();

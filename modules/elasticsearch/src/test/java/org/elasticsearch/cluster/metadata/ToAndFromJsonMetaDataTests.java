...
public class ToAndFromJsonMetaDataTests {
    ...
    public void testSimpleJsonFromAndTo() throws IOException {
        MetaData metaData = newMetaDataBuilder()
                ...
                .put(newIndexMetaDataBuilder("test7")
                        ...
                        .putMapping("mapping1", MAPPING_SOURCE1)
                        .putMapping("mapping2", MAPPING_SOURCE2)
                        .putAlias(newAliasMetaDataBuilder("alias1").source(ALIAS_SOURCE1))
                        .putAlias(newAliasMetaDataBuilder("alias2"))
                        .putAlias(newAliasMetaDataBuilder("alias4").source(ALIAS_SOURCE2)))
                .build();
        ...
        assertThat(indexMetaData.aliases().get("alias1").alias(), equalTo("alias1"));
        assertThat(indexMetaData.aliases().get("alias1").source().string(), equalTo(ALIAS_SOURCE1));
        assertThat(indexMetaData.aliases().get("alias2").alias(), equalTo("alias2"));
        assertThat(indexMetaData.aliases().get("alias2").source(), nullValue());
        assertThat(indexMetaData.aliases().get("alias3").alias(), equalTo("alias3"));
        assertThat(indexMetaData.aliases().get("alias3").source(), nullValue());
        assertThat(indexMetaData.aliases().get("alias4").alias(), equalTo("alias4"));
        assertThat(indexMetaData.aliases().get("alias4").source().string(), equalTo(ALIAS_SOURCE2));
    }
    ...
    private static final String ALIAS_SOURCE1 = "{\"field1\":\"value1\"}";
    private static final String ALIAS_SOURCE2 = "{\"field2\":\"value2\"}";
}

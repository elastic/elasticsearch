...
public final class GrokProcessor extends AbstractProcessor {
    ...
    GrokProcessor(String tag, Map<String, String> patternBank, List<String> matchPatterns, String matchField,
                  boolean traceMatch, boolean ignoreMissing, ThreadInterrupter threadInterrupter) {
        super(tag);
        this.matchField = matchField;
        this.matchPatterns = matchPatterns;
        this.grok = new Grok(patternBank, combinePatterns(matchPatterns, traceMatch), threadInterrupter);
    ...
    public static final class Factory implements Processor.Factory {
        ...
        public Factory(Map<String, String> builtinPatterns, ThreadInterrupter threadInterrupter) {

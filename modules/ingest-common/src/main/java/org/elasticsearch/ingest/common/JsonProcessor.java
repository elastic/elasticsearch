...
public final class JsonProcessor extends AbstractProcessor {
    ...
    public static Object apply(Object fieldValue, boolean allowDuplicateKeys) {
        ...
        try (InputStream stream = bytesRef.streamInput();
             JsonXContentParser parser = (JsonXContentParser) JsonXContent.jsonXContent
    ...
    @SuppressWarnings("unchecked")
    public static void merge(Map<String, Object> target, Map<String, Object> from) {
        for (String key : from.keySet()) {
            if (target.containsKey(key)) {
                Object targetValue = target.get(key);
                Object fromValue = from.get(key);
                if (targetValue instanceof Map && fromValue instanceof Map) {
                    merge((Map<String, Object>) targetValue, (Map<String, Object>) fromValue);
                } else {

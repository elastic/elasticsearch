...
public class CommunityIdProcessorFactoryTests extends ESTestCase {
    ...
    public void testCreate() throws Exception {
        ...
        CommunityIdProcessor processor = factory.create(null, tag, null, config);
    ...
    public void testSeed() throws Exception {
        ...
        ElasticsearchException e = expectThrows(ElasticsearchException.class, () -> factory.create(null, tag, null, config));
        ...
        e = expectThrows(ElasticsearchException.class, () -> factory.create(null, tag, null, config));
        assertThat(e.getMessage(), containsString("must be a value between 0 and 65535"));
    ...
    public void testRequiredFields() throws Exception {
        String tag = randomAlphaOfLength(10);
        CommunityIdProcessor processor = factory.create(null, tag, null, new HashMap<>());
        assertThat(processor.getTag(), equalTo(tag));

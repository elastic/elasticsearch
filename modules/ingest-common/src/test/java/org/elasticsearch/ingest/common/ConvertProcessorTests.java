...
public class ConvertProcessorTests extends ESTestCase {
    ...
    public void testConvertInt() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, fieldName, Type.INTEGER, false, false);
    ...
    public void testConvertLong() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, fieldName, Type.LONG, false, false);
        processor.execute(ingestDocument);
    ...
    public void testConvertDouble() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, fieldName, Type.DOUBLE, false, false);
        processor.execute(ingestDocument);
    ...
    public void testConvertFloat() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, fieldName, Type.FLOAT, false, false);
        processor.execute(ingestDocument);
    ...
    public void testConvertBoolean() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, fieldName, Type.BOOLEAN, false, false);
        processor.execute(ingestDocument);
    ...
    public void testConvertIpV4() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, targetField, Type.IP, false, false);
        processor.execute(ingestDocument);
        ...
        Processor processor2 = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, targetField, Type.IP, false, false);
    ...
    public void testConvertIpList() throws Exception {
        ...
        String fieldName = RandomDocumentPicks.addRandomField(random(), ingestDocument, fieldValue);
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, fieldName, Type.IP, false, false);
        processor.execute(ingestDocument);
        assertThat(ingestDocument.getFieldValue(fieldName, List.class), equalTo(expectedList));
    }
    ...
    public void testConvertString() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, fieldName, Type.STRING, false, false);
        processor.execute(ingestDocument);
    ...
    public void testConvertNonExistingField() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, fieldName, type, false, false);
        try {
            processor.execute(ingestDocument);
            fail("processor execute should have failed");
        } catch (IllegalArgumentException e) {
    ...
    public void testConvertNullField() throws Exception {
        ...
        Type type = randomFrom(Type.values());
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, "field", "field", type, false, false);
        try {
            processor.execute(ingestDocument);
            fail("processor execute should have failed");
        } catch (IllegalArgumentException e) {
    ...
    public void testConvertNonExistingFieldWithIgnoreMissing() throws Exception {
        ...
        String fieldName = RandomDocumentPicks.randomFieldName(random());
        Type type = randomFrom(Type.values());
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, fieldName, type, true, false);
        processor.execute(ingestDocument);
    ...
    public void testConvertNullFieldWithIgnoreMissing() throws Exception {
        ...
        IngestDocument ingestDocument = new IngestDocument(originalIngestDocument);
        Type type = randomFrom(Type.values());
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, "field", "field", type, true, false);
        processor.execute(ingestDocument);
        assertIngestDocument(originalIngestDocument, ingestDocument);
    }
    ...
    public void testAutoConvertNotString() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, "field", "field", Type.AUTO, false, false);
        processor.execute(ingestDocument);
    ...
    public void testTargetField() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAlphaOfLength(10), null, fieldName, targetField, Type.INTEGER, false, false);
        processor.execute(ingestDocument);
    ...
    public void testConvertSkipFailures() throws Exception {
        ...
        for (int j = 0; j < numItems; j++) {
            ...
            if (randomBoolean()) {
                ...
                expectedValue = randomInt;
            }

            fieldValue.add(actualValue);

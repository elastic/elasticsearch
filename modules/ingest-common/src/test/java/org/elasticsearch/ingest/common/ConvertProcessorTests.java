...
public class ConvertProcessorTests extends ESTestCase {
    ...
    public void testConvertLong() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAsciiOfLength(10), fieldName, fieldName, Type.LONG, false);
        processor.execute(ingestDocument);
    ...
    public void testConvertDouble() throws Exception {
        ...
        Processor processor = new ConvertProcessor(randomAsciiOfLength(10), fieldName, fieldName, Type.DOUBLE, false);
        processor.execute(ingestDocument);

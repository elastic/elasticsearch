...
public class RegisteredDomainProcessorTests extends ESTestCase {
    ...
    public void testUseRoot() throws Exception {
        ...
        RegisteredDomainProcessor processor = new RegisteredDomainProcessor(null, null, "domain", "", false);
    ...
    private void testRegisteredDomainProcessor(
        ...
        RegisteredDomainProcessor processor = new RegisteredDomainProcessor(null, null, "domain", "url", ignoreMissing);

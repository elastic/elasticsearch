...
public class SetProcessorTests extends ESTestCase {
    ...
    public void testSetMetadataExceptVersion() throws Exception {
        Metadata randomMetadata = randomFrom(
            IngestSourceAndMetadata.Metadata.INDEX,
            IngestSourceAndMetadata.Metadata.ID,
            IngestSourceAndMetadata.Metadata.ROUTING
        );
    ...
    public void testSetMetadataVersion() throws Exception {
        ...
        processor.execute(ingestDocument);
        assertThat(
            ingestDocument.getFieldValue(IngestSourceAndMetadata.Metadata.VERSION.getFieldName(), Long.class),
    ...
    public void testSetMetadataVersionType() throws Exception {
        ...
        Processor processor = createSetProcessor(
            IngestSourceAndMetadata.Metadata.VERSION_TYPE.getFieldName(),
            versionType,
            null,
            true,
            false
        ...
        processor.execute(ingestDocument);
        assertThat(
            ingestDocument.getFieldValue(IngestSourceAndMetadata.Metadata.VERSION_TYPE.getFieldName(), String.class),
            Matchers.equalTo(versionType)
        );
    }
    ...
    public void testSetMetadataIfSeqNo() throws Exception {
        ...
        processor.execute(ingestDocument);
        assertThat(
            ingestDocument.getFieldValue(IngestSourceAndMetadata.Metadata.IF_SEQ_NO.getFieldName(), Long.class),
            Matchers.equalTo(ifSeqNo)
        );
    }
    ...
    public void testSetMetadataIfPrimaryTerm() throws Exception {
        ...
        Processor processor = createSetProcessor(
            IngestSourceAndMetadata.Metadata.IF_PRIMARY_TERM.getFieldName(),
            ifPrimaryTerm,
            null,
            true,
            false
        ...
        processor.execute(ingestDocument);
        assertThat(
            ingestDocument.getFieldValue(IngestSourceAndMetadata.Metadata.IF_PRIMARY_TERM.getFieldName(), Long.class),
            Matchers.equalTo(ifPrimaryTerm)
        );
    }
    ...
    public void testSetDynamicTemplates() throws Exception {
        ...
        for (int i = 0; i < iters; i++) {
            ...
            Processor processor = createSetProcessor(
                IngestSourceAndMetadata.Metadata.DYNAMIC_TEMPLATES.getFieldName(),
                dynamicTemplates,
                null,
                true,
                false
            ...
            processor.execute(ingestDocument);
            assertThat(
                ingestDocument.getFieldValue(IngestSourceAndMetadata.Metadata.DYNAMIC_TEMPLATES.getFieldName(), Map.class),
                equalTo(dynamicTemplates)
            );
        }
    }

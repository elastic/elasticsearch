...
public class EnterpriseGeoIpDownloader extends AllocatedPersistentTask {
    ...
    void updateDatabases() throws IOException {
        ...
        var geoipIndex = projectMetadata.getIndicesLookup().get(EnterpriseGeoIpDownloader.DATABASES_INDEX);
        if (geoipIndex != null) {
        ...
        IngestGeoIpMetadata geoIpMeta = projectMetadata.custom(IngestGeoIpMetadata.TYPE, IngestGeoIpMetadata.EMPTY);

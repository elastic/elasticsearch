...
public class GeoIpProcessorTests extends ESTestCase {
    ...
    public void testCity() throws Exception {
        GeoIpProcessor processor = new GeoIpProcessor(
            ...
            () -> true,
            "target_field",
            geoDataLookupAll(Database.City),
            false,
            false,
            "filename"
        );
    ...
    public void testCountry() throws Exception {
        GeoIpProcessor processor = new GeoIpProcessor(
            ...
            () -> true,
            "target_field",
            geoDataLookupAll(Database.Country),
            false,
            false,
            "filename"
        );
    ...
    public void testAnonymmousIp() throws Exception {
        ...
        GeoIpProcessor processor = new GeoIpProcessor(
            ...
            () -> true,
            "target_field",
            geoDataLookupAll(Database.AnonymousIp),
            false,
            false,
            "filename"
        );
    ...
    public void testConnectionType() throws Exception {
        ...
        GeoIpProcessor processor = new GeoIpProcessor(
            ...
            () -> true,
            "target_field",
            geoDataLookupAll(Database.ConnectionType),
            false,
            false,
            "filename"
        );
    ...
    public void testDomain() throws Exception {
        ...
        GeoIpProcessor processor = new GeoIpProcessor(
            ...
            () -> true,
            "target_field",
            geoDataLookupAll(Database.Domain),
            false,
            false,
            "filename"
        );
    ...
    public void testEnterprise() throws Exception {
        ...
        GeoIpProcessor processor = new GeoIpProcessor(
            ...
            () -> true,
            "target_field",
            geoDataLookupAll(Database.Enterprise),
            false,
            false,
            "filename"
        );
    ...
    public void testListDatabaseReferenceCounting() throws Exception {
        ...
        GeoIpProcessor processor = new GeoIpProcessor(randomAlphaOfLength(10), null, "source_field", () -> {
            loader.preLookup();
            return loader;
        }, () -> true, "target_field", geoDataLookupAll(Database.City), false, false, "filename");

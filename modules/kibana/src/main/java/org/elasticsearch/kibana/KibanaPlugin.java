...
public class KibanaPlugin extends Plugin implements SystemIndexPlugin {
     ...
     * {@linkplain org.elasticsearch.indices.SystemDataStreamDescriptor system data streams} registered in
     * {@link #getSystemDataStreamDescriptors()} ({@value #WORKFLOWS_EVENTS_DATA_STREAM_NAME} and
     * {@value #WORKFLOWS_EXECUTION_LOGS_DATA_STREAM_NAME}).
     * <p>
     ...
     * a {@link org.elasticsearch.indices.SystemDataStreamDescriptor} (see {@code checkForOverlappingPatterns}). Uses the same
     * complement style as Fleet's {@code .fleet-actions~(-results*)}; see {@link SystemIndexDescriptor} for pattern syntax.
     */

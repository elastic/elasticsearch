...
public class CustomMustacheFactoryTests extends ESTestCase {
    ...
    public void testJsonEscapeEncoder() {
        ...
        ExecutableScript.Factory factory = engine.compile(null, "{\"field\": \"{{value}}\"}", ExecutableScript.CONTEXT, params);

        ExecutableScript executable = factory.newInstance(singletonMap("value", "a \"value\""));
    ...
    public void testUrlEncoder() {
        ...
        ExecutableScript executable = factory.newInstance(singletonMap("value", "tilde~ AND date:[2016 FROM*]"));

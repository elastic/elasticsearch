...
public class MultiSearchTemplateRequestTests extends ESTestCase {
    ...
    public void testParseRequest() throws Exception {
        ...
        assertEquals(Script.ScriptType.INLINE, request.requests().get(0).getScriptType());
        assertEquals(Script.ScriptType.INLINE, request.requests().get(1).getScriptType());
        assertEquals(Script.ScriptType.INLINE, request.requests().get(2).getScriptType());

...
public class NoImportAnnotation {
    ...
    private static class NoImportAnnotationParser implements WhitelistAnnotationParser {
    ...
    public static final NoImportAnnotationParser PARSER = new NoImportAnnotationParser();

 ...
 * override on the rare breach path to log and raise the limit error, keeping the generated bytecode small. Recording an
 * execution's total is not done here: that goes to {@link AllocationMetrics.ContextRecorder#recordExecutionAllocation(long)}.
 */

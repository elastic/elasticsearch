 ...
 * {@code PainlessPlugin#createComponents} installs the node instance on {@link PainlessScriptEngine} via
 * {@link PainlessScriptEngine#setAllocationMetrics}; a node without telemetry keeps {@link #NOOP}.
 */

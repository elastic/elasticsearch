...
final class Compiler {
    ...
    static Executable compile(final Loader loader, final String name, final String source,
        ...
        final Variables variables = new Variables(settings, definition, special);
    ...
    private static Executable createExecutable(final Loader loader, final Definition definition,
        ...
        try {
            ...
            //try {
            //    FileOutputStream f = new FileOutputStream(new File("/Users/jdconrad/test/test.class"), false);
            //    f.write(bytes);
            //    f.close();
            //} catch (Exception e) {

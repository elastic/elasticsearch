...
final class Compiler {
    ...
    static final class Loader extends SecureClassLoader {
         ...
         * @return A Class object extending {@link AbstractPainlessScript}.
         */
        Class<? extends AbstractPainlessScript> define(String name, byte[] bytes) {
            return defineClass(name, bytes, 0, bytes.length, CODESOURCE).asSubclass(AbstractPainlessScript.class);
        }
    }
    ...
    static <T> T compile(Loader loader, Class<T> iface, String name, String source, CompilerSettings settings) {
        ...
        try {
            Class<? extends AbstractPainlessScript> clazz = loader.define(CLASS_NAME, root.getBytes());
            java.lang.reflect.Constructor<? extends AbstractPainlessScript> constructor =

...
public final class CompilerSettings {
    ...
    /** Sentinel {@code -1b} for {@link #MAX_ALLOCATION_BYTES} meaning tracking is disabled (no bytecode emitted). */
    public static final ByteSizeValue MAX_ALLOCATION_BYTES_DISABLED = ByteSizeValue.MINUS_ONE;

    /** Upper bound for a positive {@link #MAX_ALLOCATION_BYTES} limit; widen here if a real need arises. */
    public static final ByteSizeValue MAX_ALLOCATION_BYTES_UPPER_BOUND = ByteSizeValue.ofGb(1);

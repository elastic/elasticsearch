...
public final class PainlessPlugin extends Plugin implements ScriptPlugin, ExtensiblePlugin, ActionPlugin {
    ...
    public Collection<?> createComponents(PluginServices services) {
        // Install the node's allocation metrics before any script can run. AllocationMetrics is held statically because its
        // recorder is called from generated bytecode, which has no object to carry a reference on; a node without telemetry
        // keeps the no-op instance.

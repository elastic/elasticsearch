...
import org.elasticsearch.painless.tree.analyzer.Analyzer;
...
import org.elasticsearch.painless.tree.writer.Writer;
...
import static org.elasticsearch.painless.tree.writer.Constants.CLASS_NAME;
...
public final class Compiler {
    ...
    public static class Loader extends SecureClassLoader {
         ...
         */
        public Class<? extends Executable> define(final String name, final byte[] bytes) {
     ...
     */
    public static Executable compile(final Loader loader, final String name, final String source,

...
abstract class AStoreable extends AExpression {
     ...
     */
    abstract void setup(ClassWriter classWriter, MethodWriter writer);

    /**
     * Called to load a storable used for compound assignments.
     */
    abstract void load(ClassWriter classWriter, MethodWriter writer);

    /**
     * Called to store a storabable to local memory.
     */
    abstract void store(ClassWriter classWriter, MethodWriter writer);

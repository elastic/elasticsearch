...
public final class ELambda extends AExpression implements ILambda {
    ...
    void analyze(Locals locals) {
        ...
        if (expected == null) {
            ...
            if (interfaceMethod.arguments.size() != paramTypeStrs.size())
                throw new IllegalArgumentException("Incorrect number of parameters for [" + interfaceMethod.name +
                        "] in [" + PainlessLookupUtility.painlessTypeToPainlessTypeName(expected) + "]");
        ...
        for (Variable var : captures) {
            paramTypes.add(PainlessLookupUtility.painlessTypeToPainlessTypeName(var.clazz));
        ...
        desugared = new SFunction(reserved, location, PainlessLookupUtility.painlessTypeToPainlessTypeName(returnType), name,

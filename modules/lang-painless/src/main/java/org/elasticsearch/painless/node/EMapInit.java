...
public final class EMapInit extends AExpression {
    ...
    void analyze(Locals locals) {
        ...
        constructor =
                locals.getPainlessLookup().getPainlessClassFromJavaClass(actual).constructors
        ...
        method = locals.getPainlessLookup().getPainlessClassFromJavaClass(actual).methods

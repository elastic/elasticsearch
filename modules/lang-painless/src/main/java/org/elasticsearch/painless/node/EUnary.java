        ...
        if ((operation == Operation.SUB || operation == Operation.ADD) &&
            ...
            if (childNode instanceof ENumeric) {
                ...
                if (operation == Operation.SUB) {
                    ...
                    childOutput = childNode.analyze(classNode, scriptScope, semanticScope, childInput);
                }
            ...
            if (operation == Operation.NOT) {
                ...
                childOutput = analyze(childNode, classNode, scriptScope, semanticScope, childInput);
                ...
                childOutput = analyze(childNode, classNode, scriptScope, semanticScope, new Input());

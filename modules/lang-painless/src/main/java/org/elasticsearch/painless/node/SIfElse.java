...
public class SIfElse extends AStatement {
    ...
    Output analyze(ClassNode classNode, ScriptScope scriptScope, SematicScope sematicScope, Input input) {
        ...
        Output ifblockOutput = ifblockNode.analyze(classNode, scriptScope, sematicScope.newLocalScope(), ifblockInput);
        ...
        Output elseblockOutput = elseblockNode.analyze(classNode, scriptScope, sematicScope.newLocalScope(), elseblockInput);

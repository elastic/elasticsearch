...
public class DefaultIRTreeToASMBytesPhase implements IRTreeVisitor<WriteScope> {
    ...
    public void visitForEachSubIterableLoop(ForEachSubIterableNode irForEachSubIterableNode, WriteScope writeScope) {
        ...
        PainlessMethod painlessMethod = irForEachSubIterableNode.getMethod();

        Variable variable = writeScope.defineVariable(
            irForEachSubIterableNode.getVariableType(),
            irForEachSubIterableNode.getVariableName()
        );
        Variable iterator = writeScope.defineInternalVariable(
            irForEachSubIterableNode.getIterableType(),
            irForEachSubIterableNode.getIterableName()
        );
    ...
    public void visitDeclaration(DeclarationNode irDeclarationNode, WriteScope writeScope) {
        ...
        Class<?> variableType = irDeclarationNode.getDeclarationType();
        String variableName = irDeclarationNode.getName();
    ...
    public void visitCatch(CatchNode irCatchNode, WriteScope writeScope) {
        ...
        Class<?> exceptionType = irCatchNode.getExceptionType();
        String exceptionName = irCatchNode.getSymbol();
    ...
    public void visitUnaryMath(UnaryMathNode irUnaryMathNode, WriteScope writeScope) {
        ...
        if (operation == Operation.NOT) {
            ...
            int flags = irUnaryMathNode.getFlags();
                    ...
                    if (unaryType == int.class) {
                        ...
                        throw new IllegalStateException(
                            Strings.format(
                                ...
                                operation,
                                irUnaryMathNode.getExpressionCanonicalTypeName()
                            )
                        );
                    }
    ...
    public void visitBinaryMath(BinaryMathNode irBinaryMathNode, WriteScope writeScope) {
        ...
        if (operation == Operation.FIND || operation == Operation.MATCH) {
            ...
            if (operation == Operation.FIND) {
                ...
                throw new IllegalStateException(
                    Strings.format(
                        ...
                        operation,
                        irBinaryMathNode.getExpressionCanonicalTypeName()
                    )
                );
            }
        } else {
            ...
            if (irBinaryMathNode.getBinaryType() == def.class || irBinaryMathNode.getShiftType() == def.class) {
    ...
    public void visitBoolean(BooleanNode irBooleanNode, WriteScope writeScope) {
        ...
        if (operation == Operation.AND) {
            ...
            throw new IllegalStateException(
                "unexpected boolean operation [" + operation + "] " + "for type [" + irBooleanNode.getExpressionCanonicalTypeName() + "]"
            );
        }
    }
        ...
        if (comparisonType == void.class || comparisonType == byte.class || comparisonType == short.class || comparisonType == char.class) {
            throw new IllegalStateException(
                Strings.format(
                    ...
                    operation,
                    irComparisonNode.getExpressionCanonicalTypeName()
                )
            );
    ...
    public void visitNewArray(NewArrayNode irNewArrayNode, WriteScope writeScope) {
        ...
        if (irNewArrayNode.isInitialize()) {
    ...
    public void visitConstant(ConstantNode irConstantNode, WriteScope writeScope) {
        ...
        if (constant instanceof String) methodWriter.push((String) constant);
             ...
             */
            String fieldName = irConstantNode.getConstantFieldName();
    ...
    public void visitDefInterfaceReference(DefInterfaceReferenceNode irDefInterfaceReferenceNode, WriteScope writeScope) {
        ...
        if (irDefInterfaceReferenceNode.hasInstanceCapture()) {
        ...
        List<String> captureNames = irDefInterfaceReferenceNode.getCaptureNames();
        boolean captureBox = irDefInterfaceReferenceNode.hasCaptureBox();
    ...
    public void visitTypedInterfaceReference(TypedInterfaceReferenceNode irTypedInterfaceReferenceNode, WriteScope writeScope) {
        ...
        if (irTypedInterfaceReferenceNode.hasInstanceCapture()) {
            Variable capturedThis = writeScope.getInternalVariable("this");
            methodWriter.visitVarInsn(CLASS_TYPE.getOpcode(Opcodes.ILOAD), capturedThis.getSlot());
        }

        List<String> captureNames = irTypedInterfaceReferenceNode.getCaptureNames();
        boolean captureBox = irTypedInterfaceReferenceNode.hasCaptureBox();
    ...
    public void visitTypedCaptureReference(TypedCaptureReferenceNode irTypedCaptureReferenceNode, WriteScope writeScope) {
        ...
        String methodName = irTypedCaptureReferenceNode.getName();
        Variable captured = writeScope.getVariable(irTypedCaptureReferenceNode.getCaptureNames().get(0));
        Class<?> expressionType = irTypedCaptureReferenceNode.getExpressionType();
        String expressionCanonicalTypeName = irTypedCaptureReferenceNode.getExpressionCanonicalTypeName();

        methodWriter.visitVarInsn(captured.getAsmType().getOpcode(Opcodes.ILOAD), captured.getSlot());

        if (irTypedCaptureReferenceNode.hasCaptureBox()) {
    ...
    public void visitLoadDotDef(LoadDotDefNode irLoadDotDefNode, WriteScope writeScope) {
        ...
        Type methodType = Type.getMethodType(MethodWriter.getType(irLoadDotDefNode.getExpressionType()), MethodWriter.getType(def.class));
    ...
    public void visitLoadDotShortcut(LoadDotShortcutNode irDotSubShortcutNode, WriteScope writeScope) {
        ...
        PainlessMethod getterPainlessMethod = irDotSubShortcutNode.getMethod();
    ...
    public void visitLoadListShortcut(LoadListShortcutNode irLoadListShortcutNode, WriteScope writeScope) {
        ...
        PainlessMethod getterPainlessMethod = irLoadListShortcutNode.getMethod();
        methodWriter.invokeMethodCall(getterPainlessMethod);
    ...
    public void visitLoadMapShortcut(LoadMapShortcutNode irLoadMapShortcutNode, WriteScope writeScope) {
        ...
        PainlessMethod getterPainlessMethod = irLoadMapShortcutNode.getMethod();
        methodWriter.invokeMethodCall(getterPainlessMethod);
    ...
    public void visitStoreDotShortcut(StoreDotShortcutNode irDotSubShortcutNode, WriteScope writeScope) {
        ...
        methodWriter.writeDebugInfo(irDotSubShortcutNode.getLocation());
        methodWriter.invokeMethodCall(irDotSubShortcutNode.getMethod());
        methodWriter.writePop(MethodWriter.getType(irDotSubShortcutNode.getMethod().returnType()).getSize());
    }
    ...
    public void visitStoreListShortcut(StoreListShortcutNode irStoreListShortcutNode, WriteScope writeScope) {
        ...
        methodWriter.invokeMethodCall(irStoreListShortcutNode.getMethod());
        methodWriter.writePop(MethodWriter.getType(irStoreListShortcutNode.getMethod().returnType()).getSize());
    }
    ...
    public void visitStoreMapShortcut(StoreMapShortcutNode irStoreMapShortcutNode, WriteScope writeScope) {
        ...
        methodWriter.invokeMethodCall(irStoreMapShortcutNode.getMethod());
        methodWriter.writePop(MethodWriter.getType(irStoreMapShortcutNode.getMethod().returnType()).getSize());
    }
    ...
    public void visitInvokeCallDef(InvokeCallDefNode irInvokeCallDefNode, WriteScope writeScope) {
        ...
        for (int i = 0; i < irInvokeCallDefNode.getArgumentNodes().size(); ++i) {
            ...
            if (irArgumentNode instanceof DefInterfaceReferenceNode defInterfaceReferenceNode) {
                List<String> captureNames = defInterfaceReferenceNode.getCaptureNames();
                boostrapArguments.add(defInterfaceReferenceNode.getDefReferenceEncoding().toString());

                if (defInterfaceReferenceNode.hasInstanceCapture()) {
                    capturedCount++;
        ...
        String methodName = irInvokeCallDefNode.getName();
    ...
    public void visitInvokeCallMember(InvokeCallMemberNode irInvokeCallMemberNode, WriteScope writeScope) {
        ...
        LocalFunction localFunction = irInvokeCallMemberNode.getFunction();
        PainlessMethod thisMethod = irInvokeCallMemberNode.getThisMethod();
        PainlessMethod importedMethod = irInvokeCallMemberNode.getMethod();
        ...
        if (localFunction != null) {
            ...
            int classBindingOffset = irInvokeCallMemberNode.isStatic() ? 0 : 1;
            int javaConstructorParameterCount = classBinding.javaConstructor().getParameterCount() - classBindingOffset;
            String bindingName = irInvokeCallMemberNode.getName();
    ...
    public void visitDup(DupNode irDupNode, WriteScope writeScope) {
        ...
        int size = irDupNode.getSize();
        int depth = irDupNode.getDepth();

...
public class AugmentationTests extends ScriptTestCase {
    ...
    protected Map<ScriptContext<?>, List<Whitelist>> scriptContexts() {
        ...
        List<Whitelist> digestWhitelist = new ArrayList<>(PainlessPlugin.baseWhiteList());
    ...
    public void testFeatureTest() {
        ...
        assertEquals(
            5,
            exec("def ft = new org.elasticsearch.painless.FeatureTestObject();" + " ft.setX(3); ft.setY(2); return ft.getTotal()")
        );
        assertEquals(
            8,
            exec(
        ...
        assertEquals(
            8,
            exec("def ft = new org.elasticsearch.painless.FeatureTestObject();" + " ft.setX(3); ft.setY(2); return ft.addToTotal(3)")
        );
    }

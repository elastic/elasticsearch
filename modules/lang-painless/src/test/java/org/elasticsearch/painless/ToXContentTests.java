...
public class ToXContentTests extends ScriptTestCase {
     ...
     */
    private static class UserTreeToXContent extends UserTreeBaseVisitor<ScriptScope> {
        public final XContentBuilderWrapper builder;

        UserTreeToXContent(XContentBuilder builder) {
        ...
        public void visitBooleanComp(EBooleanComp userBooleanCompNode, ScriptScope scope) {
            ...
            binaryOperation(
                userBooleanCompNode.getOperation(),
                userBooleanCompNode.getLeftNode(),
                userBooleanCompNode.getRightNode(),
                scope
            );
        ...
        private void decorations(ANode node, ScriptScope scope) {
            ...
            Map<Class<? extends Decorator.Decoration>, Decorator.Decoration> decorations = scope.getAllDecorations(node.getIdentifier());

...
public class UnaryTests extends ScriptTestCase {
    ...
    public void testBasics() {
        ...
        expectScriptThrows(ClassCastException.class, () -> exec("double x = (Double)-1.0; return +x"));
        expectScriptThrows(ClassCastException.class, () -> exec("double x = (ArrayList)-1.0; return +x"));
    }

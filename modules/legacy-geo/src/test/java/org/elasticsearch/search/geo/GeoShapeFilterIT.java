...
public class GeoShapeFilterIT extends ESIntegTestCase {
    ...
    public void testShapeRelations() throws Exception {
        ...
        SearchResponse result = client().prepareSearch()
                ...
                .setPostFilter(GeoShapeQueryBuilders.geoIntersectionQuery("area", ShapeBuilders.newPoint(3, 3)))
                .execute().actionGet();
        ...
        result = client().prepareSearch()
                .setQuery(matchAllQuery())
                .setPostFilter(GeoShapeQueryBuilders.geoIntersectionQuery("area", ShapeBuilders.newPoint(4.5, 4.5)))
                .execute().actionGet();
        ...
        result = client().prepareSearch()
                .setQuery(matchAllQuery())
                .setPostFilter(GeoShapeQueryBuilders.geoIntersectionQuery("area", ShapeBuilders.newPoint(10.0, 5.0)))
                .execute().actionGet();
        assertHitCount(result, 1);
        assertFirstHit(result, hasId("1"));
        ...
        result = client().prepareSearch()
                .setQuery(matchAllQuery())
                .setPostFilter(GeoShapeQueryBuilders.geoIntersectionQuery("area", ShapeBuilders.newPoint(5.0, 2.0)))
                .execute().actionGet();
        assertHitCount(result, 1);
        assertFirstHit(result, hasId("1"));
        ...
        if (disjointSupport) {
            ...
            result = client().prepareSearch()
                    .setQuery(matchAllQuery())
                    .setPostFilter(GeoShapeQueryBuilders.geoDisjointQuery("area", ShapeBuilders.newPoint(3, 3)))
                    .execute().actionGet();
            assertHitCount(result, 0);
            ...
            result = client().prepareSearch()
                    .setQuery(matchAllQuery())
                    .setPostFilter(GeoShapeQueryBuilders.geoDisjointQuery("area", ShapeBuilders.newPoint(4.5, 4.5)))
                    .execute().actionGet();
            assertHitCount(result, 1);
            assertFirstHit(result, hasId("1"));
        }
        ...
        if (withinSupport) {
            ...
            result = client().prepareSearch()
                    .setQuery(matchAllQuery())
                    .setPostFilter(GeoShapeQueryBuilders.geoWithinQuery("area", builder))
                    .execute().actionGet();
        ...
        builder = ShapeBuilders.newPolygon(new CoordinatesBuilder()
                .coordinate(170, -10).coordinate(190, -10).coordinate(190, 10).coordinate(170, 10).close())
                    .hole(new LineStringBuilder(
                            new CoordinatesBuilder().coordinate(175, -5).coordinate(185, -5).coordinate(185, 5).coordinate(175, 5)
                            .close()));
        ...
        result = client().prepareSearch()
                .setQuery(matchAllQuery())
                .setPostFilter(GeoShapeQueryBuilders.geoIntersectionQuery("area", ShapeBuilders.newPoint(174, -4)))
                .execute().actionGet();
        assertHitCount(result, 1);
        ...
        result = client().prepareSearch()
                .setQuery(matchAllQuery())
                .setPostFilter(GeoShapeQueryBuilders.geoIntersectionQuery("area", ShapeBuilders.newPoint(180, -4)))
                .execute().actionGet();
        assertHitCount(result, 0);

        result = client().prepareSearch()
                .setQuery(matchAllQuery())
                .setPostFilter(GeoShapeQueryBuilders.geoIntersectionQuery("area", ShapeBuilders.newPoint(180, -6)))
                .execute().actionGet();
        assertHitCount(result, 1);
    }
    ...
    public void testBulk() throws Exception {
        ...
        client().admin().indices().prepareCreate("countries")
    ...
    protected static boolean testRelationSupport(SpatialOperation relation) {
        ...
        try {
            ...
            ESLoggerFactory
                .getLogger(GeoShapeFilterIT.class.getName())

...
public class FeatureVectorFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testDefaults() throws Exception {
        ...
        ParsedDocument doc1 = mapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference
    ...
    public void testRejectMultiValuedFields() throws MapperParsingException, IOException {
        ...
        MapperParsingException e = expectThrows(MapperParsingException.class,
                () -> mapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference
                        .bytes(XContentFactory.jsonBuilder()
                                .startObject()
                                .startObject("field")

...
public class ScaledFloatFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testDefaults() throws Exception {
        ...
        ParsedDocument doc = mapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference
    ...
    public void testCoerce() throws Exception {
        ...
        ThrowingRunnable runnable = () -> mapper2.parse(SourceToParse.source("test", "type", "1", null, BytesReference
                .bytes(XContentFactory.jsonBuilder()
                        .startObject()
                        .field("field", "123")
                        .endObject()),
    ...
    private void doTestIgnoreMalformed(String value, String exceptionMessageContains) throws Exception {
        ...
        ThrowingRunnable runnable = () -> mapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference
                .bytes(XContentFactory.jsonBuilder()
                        .startObject()
                        .field("field", value)
                        .endObject()),
        ...
        ParsedDocument doc = mapper2.parse(SourceToParse.source("test", "type", "1", null, BytesReference
                .bytes(XContentFactory.jsonBuilder()
                        .startObject()
                        .field("field", value)
                        .endObject()),
    ...
    public void testNullValue() throws IOException {
        ...
        doc = mapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference
                .bytes(XContentFactory.jsonBuilder()
                        .startObject()
                        .nullField("field")
                        .endObject()),

...
public class ScaledFloatFieldTypeTests extends FieldTypeTestCase<MappedFieldType> {
    ...
    public void testFieldData() throws IOException {
        ...
        try (DirectoryReader reader = DirectoryReader.open(w)) {
            ...
            IndexNumericFieldData fielddata = (IndexNumericFieldData) f1.fielddataBuilder("index", () -> null)
            ...
            fielddata = (IndexNumericFieldData) f2.fielddataBuilder("index", () -> null).build(indexSettings, f2, null, null, null);

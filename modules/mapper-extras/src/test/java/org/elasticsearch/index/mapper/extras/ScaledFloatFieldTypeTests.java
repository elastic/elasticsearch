...
public class ScaledFloatFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testRoundsUpperBoundCorrectly() {
        ...
        assertEquals(
            "IndexOrDocValuesQuery(indexQuery=scaled_float:[-9223372036854775808 TO 9], "
                + "dvQuery=scaled_float:[-9223372036854775808 TO 9])",
            scaledFloatQ.toString()
        );
        scaledFloatQ = ft.rangeQuery(null, 0.1, true, true, MOCK_CONTEXT);
        assertEquals(
            "IndexOrDocValuesQuery(indexQuery=scaled_float:[-9223372036854775808 TO 10], "
                + "dvQuery=scaled_float:[-9223372036854775808 TO 10])",
            scaledFloatQ.toString()
        );
        ...
        assertEquals(
            "IndexOrDocValuesQuery(indexQuery=scaled_float:[-9223372036854775808 TO 7999], "
                + "dvQuery=scaled_float:[-9223372036854775808 TO 7999])",
            scaledFloatQ.toString()
        );
    }
    ...
    public void testRoundsLowerBoundCorrectly() {
        ...
        assertEquals(
            "IndexOrDocValuesQuery(indexQuery=scaled_float:[-9 TO 9223372036854775807], "
                + "dvQuery=scaled_float:[-9 TO 9223372036854775807])",
            scaledFloatQ.toString()
        );
        scaledFloatQ = ft.rangeQuery(-0.1, null, true, true, MOCK_CONTEXT);
        assertEquals(
            "IndexOrDocValuesQuery(indexQuery=scaled_float:[-10 TO 9223372036854775807], "
                + "dvQuery=scaled_float:[-10 TO 9223372036854775807])",
            scaledFloatQ.toString()
        );

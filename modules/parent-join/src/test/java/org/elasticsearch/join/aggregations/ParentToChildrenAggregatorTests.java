...
public class ParentToChildrenAggregatorTests extends AggregatorTestCase {
    ...
    protected Map<String, MappedFieldType> getAdditionalFieldTypes() {
        ...
        return Map.of("_parent_join", metaJoinFieldType, "join_field",
            joinFieldMapper.fieldType(), "join_field#" + PARENT_TYPE,
            new ParentIdFieldMapper.ParentIdFieldType("join_field#" + PARENT_TYPE, false));
    }

...
public class ParentIdFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        MappedField mappedField = new ParentIdFieldMapper("field#parent", true).field();

        Map<String, String> parentValue = Map.of("relation", "parent");
        assertEquals(List.of(), fetchSourceValue(mappedField, parentValue));

        Map<String, String> childValue = Map.of("relation", "child", "parent", "1");
        assertEquals(List.of(), fetchSourceValue(mappedField, childValue));
    }
}

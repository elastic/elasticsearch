...
public class CandidateQueryTests extends ESSingleNodeTestCase {
    ...
    public void testDuel() throws Exception {
        ...
        List<org.elasticsearch.index.mapper.Document> documents = new ArrayList<>();
    ...
    public void testRangeQueries() throws Exception {
        List<org.elasticsearch.index.mapper.Document> docs = new ArrayList<>();
    ...
    private void addQuery(Query query, List<org.elasticsearch.index.mapper.Document> docs) {
        ...
        org.elasticsearch.index.mapper.Document queryDocument = parseContext.doc();

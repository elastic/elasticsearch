...
public class PercolatorMatchedSlotSubFetchPhaseTests extends ESTestCase {
    ...
    private static ValuesLookup EMPTY_LOOKUP = ValuesLookup.sourceOnly(Collections.emptyMap());
    ...
    public void testHitsExecute() throws Exception {
        try (Directory directory = newDirectory()) {
            ...
            try (DirectoryReader reader = DirectoryReader.open(directory)) {
                ...
                // A match:
                {
                    HitContext hit = new HitContext(new SearchHit(0), EMPTY_LOOKUP, context, 0);

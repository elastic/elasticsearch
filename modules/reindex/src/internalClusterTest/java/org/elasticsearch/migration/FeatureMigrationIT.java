...
public class FeatureMigrationIT extends AbstractFeatureMigrationIntegTest {
    ...
    public void testMigrateInternalManagedSystemIndex() throws Exception {
        ...
        getPlugin(TestPlugin.class).postMigrationHook.set((clusterState, metadata) -> {
            ...
            FeatureMigrationResults currentResults = clusterState.metadata().projectMetadata.custom(FeatureMigrationResults.TYPE);
        ...
        FeatureMigrationResults currentResults = finalMetadata.projectMetadata.custom(FeatureMigrationResults.TYPE);

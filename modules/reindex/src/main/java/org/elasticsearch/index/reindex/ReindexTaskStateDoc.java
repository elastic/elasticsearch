...
public class ReindexTaskStateDoc implements ToXContentObject {
    ...
    public static final ConstructingObjectParser<ReindexTaskStateDoc, Void> PARSER =
        new ConstructingObjectParser<>("reindex/index_state", a -> new ReindexTaskStateDoc((ReindexRequest) a[0],
            (Map<String, String>) a[1], (Long) a[2], (BulkByScrollResponse) a[3], (ElasticsearchException) a[4], (Integer) a[5],
    ...
    public ReindexTaskStateDoc(ReindexRequest reindexRequest, Map<String, String> headers) {
        this(reindexRequest, headers, null, null, null, (RestStatus) null, null);
    }

    private ReindexTaskStateDoc(ReindexRequest reindexRequest, Map<String, String> headers, @Nullable Long allocationId,
        ...
        this(reindexRequest, headers, allocationId, reindexResponse, exception,
    ...
    private ReindexTaskStateDoc(ReindexRequest reindexRequest, Map<String, String> headers, @Nullable Long allocationId,
        ...
        this(reindexRequest, headers, allocationId, reindexResponse, exception, exception != null ? exception.status() : null, checkpoint);
    }
    ...
    public ReindexTaskStateDoc withCheckpoint(ScrollableHitSource.Checkpoint checkpoint, BulkByScrollTask.Status status) {
        ...
        return new ReindexTaskStateDoc(reindexRequest, headers, allocationId, reindexResponse, exception, failureStatusCode, checkpoint);
    }

    public ReindexTaskStateDoc withNewAllocation(long newAllocationId) {
        return new ReindexTaskStateDoc(reindexRequest, headers, newAllocationId, reindexResponse, exception, failureStatusCode, checkpoint);
    }

    public ReindexTaskStateDoc withFinishedState(@Nullable BulkByScrollResponse reindexResponse,
                                                 @Nullable ElasticsearchException exception) {
        return new ReindexTaskStateDoc(reindexRequest, headers, allocationId, reindexResponse, exception, checkpoint);
    }
}

...
public class Reindexer {
    ...
    public Reindexer(Settings settings, ClusterService clusterService, Client client, ThreadPool threadPool,
                     IndexNameExpressionResolver resolver, AutoCreateIndex autoCreateIndex, ScriptService scriptService,

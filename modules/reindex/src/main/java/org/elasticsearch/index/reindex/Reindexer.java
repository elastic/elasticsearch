...
public class Reindexer {
    ...
    public Reindexer(Settings settings, ClusterService clusterService, IndexNameExpressionResolver indexNameExpressionResolver,
                     AutoCreateIndex autoCreateIndex) {
        remoteWhitelist = buildRemoteWhitelist(TransportReindexAction.REMOTE_CLUSTER_WHITELIST.get(settings));
        this.clusterService = clusterService;
        this.indexNameExpressionResolver = indexNameExpressionResolver;
        this.autoCreateIndex = autoCreateIndex;
    }

    public void initial(ReindexRequest request) {

...
public class AsyncDeleteByQueryAction extends AbstractAsyncBulkByScrollAction<DeleteByQueryRequest, TransportDeleteByQueryAction> {
    ...
    @Override
    protected boolean accept(HitSource.Hit doc) {
    ...
    @Override
    protected RequestWrapper<DeleteRequest> buildRequest(HitSource.Hit doc) {
     ...
     */
    @Override
    protected RequestWrapper<?> copyMetadata(RequestWrapper<?> request, HitSource.Hit doc) {

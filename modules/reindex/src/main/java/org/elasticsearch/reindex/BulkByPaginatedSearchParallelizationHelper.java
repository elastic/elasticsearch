...
class BulkByPaginatedSearchParallelizationHelper {
     ...
     */
    static <Request extends AbstractBulkBySearchRequest<Request>> void startSlicedAction(
        Request request,
     ...
     */
    static <Request extends AbstractBulkBySearchRequest<Request>> void executeSlicedAction(
        BulkByScrollTask task,
        Request request,
        ActionType<BulkByScrollResponse> action,
        ActionListener<BulkByScrollResponse> listener,
     ...
     */
    static <Request extends AbstractBulkBySearchRequest<Request>> void initTaskState(
        BulkByScrollTask task,
        Request request,
        Client client,
    ...
    private static <Request extends AbstractBulkBySearchRequest<Request>> void setWorkerCount(
        Request request,
        BulkByScrollTask task,
        int slices
    ) {
    ...
    private static <Request extends AbstractBulkBySearchRequest<Request>> void sendSubRequests(
        Client client,
        ActionType<BulkByScrollResponse> action,
        String localNodeId,
        BulkByScrollTask task,

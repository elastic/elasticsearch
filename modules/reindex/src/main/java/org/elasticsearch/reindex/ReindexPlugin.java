...
public class ReindexPlugin extends Plugin implements ActionPlugin {
    ...
    public List<RestHandler> getRestHandlers(RestHandlerParameters parameters) {
        return Arrays.asList(
            new RestReindexAction(parameters.namedWriteableRegistry()),
            new RestUpdateByQueryAction(parameters.namedWriteableRegistry()),
            new RestDeleteByQueryAction(parameters.namedWriteableRegistry()),
            new RestRethrottleAction(parameters.nodesInCluster())
        );
    }

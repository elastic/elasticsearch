...
public class RetryTests extends ESIntegTestCase {
    ...
    public void testReindexFromRemote() throws Exception {
        Function<Client, AbstractBulkBySearchRequestBuilder<?, ?>> function = client -> {
            /*
    ...
    private void testCase(
        String action,
        Function<Client, AbstractBulkBySearchRequestBuilder<?, ?>> request,
        ...
        AbstractBulkBySearchRequestBuilder<?, ?> builder = request.apply(internalCluster().masterClient());

...
class GoogleCloudStorageBlobStore implements BlobStore {
    ...
    GoogleCloudStorageBlobStore(
        ...
        final GoogleCloudStorageClientSettings clientSettings = storageService.clientSettings(projectId, clientName);
        this.tenaciousRetriesEnabled = clientSettings.getTenaciousRetriesEnabled();
        this.largeBlobThresholdInBytes = clientSettings.getResumableUploadThreshold().getBytes();
    ...
    OptionalInt getResumableWriteBufferSize() {
        return storageService.clientSettings(projectId, clientName).getResumableWriteBufferSize();
    }
            ...
            try (ReleasableBytesStreamOutput buffer = new ReleasableBytesStreamOutput(bigArrays)) {
                ...
                writer.accept(new OutputStream() {
                    ...
                    private void initResumableStream() throws IOException {
                        final OptionalInt resumableWriteBufferSize = getResumableWriteBufferSize();

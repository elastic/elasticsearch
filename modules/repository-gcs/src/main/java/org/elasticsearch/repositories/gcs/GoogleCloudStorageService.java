...
public class GoogleCloudStorageService {
    ...
    static StorageRetryStrategy storageRetryStrategy() {
        // It's fine to use the legacy lenient retry strategy, since we implement our own retry logic on top of the GCS API

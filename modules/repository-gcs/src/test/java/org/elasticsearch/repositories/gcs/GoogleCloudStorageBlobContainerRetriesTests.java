        ...
        httpServer.createContext("/upload/storage/v1/b/bucket/o", safeHandler(exchange -> {
            ...
            if (countDown.countDown()) {
                ...
                if (Objects.deepEquals(bytes, BytesReference.toBytes(content.get().v2()))) {
                    byte[] response = org.elasticsearch.core.Strings.format("""
        ...
        httpServer.createContext("/upload/storage/v1/b/bucket/o", safeHandler(exchange -> {
            ...
            if ("POST".equals(exchange.getRequestMethod())) {
                ...
                if (range.equals("bytes */*")) {
                    ...
                    if (receivedSoFar > 0) {
                        exchange.getResponseHeaders().add("Range", org.elasticsearch.core.Strings.format("bytes=0-%d", receivedSoFar));
                    }
                ...
                if (countUploads.decrementAndGet() % 2 == 0) {
                    ...
                    if (limit != null) {
                        ...
                        exchange.getResponseHeaders()
                            .add("Range", org.elasticsearch.core.Strings.format("bytes=%d/%d", rangeStart, rangeEnd));
                        exchange.getResponseHeaders().add("Content-Length", "0");
                        exchange.sendResponseHeaders(308 /* Resume Incomplete */, -1);
                        return;
                    }

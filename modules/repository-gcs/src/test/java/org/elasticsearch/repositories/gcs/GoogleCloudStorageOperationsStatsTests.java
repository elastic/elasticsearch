...
import static org.elasticsearch.repositories.gcs.GoogleCloudStorageOperationsStats.Operation.GET;
import static org.elasticsearch.repositories.gcs.GoogleCloudStorageOperationsStats.Operation.LIST;
import static org.elasticsearch.repositories.gcs.GoogleCloudStorageOperationsStats.Operation.POST;
...
public class GoogleCloudStorageOperationsStatsTests extends ESTestCase {
    ...
    public void testToMap() {
        ...
        stats.trackOperation(SNAPSHOT_DATA, POST);
        stats.trackRequest(SNAPSHOT_DATA, POST);
        stats.trackOperation(SNAPSHOT_DATA, GET);
        stats.trackRequest(CLUSTER_STATE, LIST);

        assertEquals(
            new StatsMap().add(SNAPSHOT_DATA, POST, 1, 1).add(SNAPSHOT_DATA, GET, 1, 0).add(CLUSTER_STATE, LIST, 0, 1),
            stats.toMap()
        );
    }

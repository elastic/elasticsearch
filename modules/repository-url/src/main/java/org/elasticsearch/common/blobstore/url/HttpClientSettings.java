...
class HttpClientSettings {
    ...
    public static final int DEFAULT_CONNECTION_POOL_TIMEOUT = (int) TimeUnit.SECONDS.toMillis(10);
    public static final int DEFAULT_CONNECTION_TIMEOUT = (int) TimeUnit.SECONDS.toMillis(10);
    public static final int DEFAULT_SOCKET_TIMEOUT = (int) TimeUnit.SECONDS.toMillis(50);

    private int maxRetries = DEFAULT_MAX_RETRIES;
    private int connectionPoolTimeoutMs = DEFAULT_CONNECTION_POOL_TIMEOUT;

...
public class RepositoryURLRestApiSpecTests extends ESClientYamlSuiteTestCase {

    public RepositoryURLRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class RepositoryURLRestTestsYaml extends ESClientYamlSuiteTestCase {

    public RepositoryURLRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

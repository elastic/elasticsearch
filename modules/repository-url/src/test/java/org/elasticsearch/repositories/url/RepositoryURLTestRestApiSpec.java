...
public class RepositoryURLTestRestApiSpec extends ESClientYamlSuiteTestCase {

    public RepositoryURLTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class RestDeleteByQueryActionV7Tests extends RestActionTestCase {
    private RestDeleteByQueryActionV7 action;

    @Before
    public void setUpAction() {
        action = new RestDeleteByQueryActionV7();
    ...
    public void testParseEmpty() throws IOException {
        DeleteByQueryRequest request = action.buildRequest(

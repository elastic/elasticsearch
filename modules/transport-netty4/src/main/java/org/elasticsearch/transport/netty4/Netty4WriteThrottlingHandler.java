...
public final class Netty4WriteThrottlingHandler extends ChannelDuplexHandler {
    ...
    private static final int MAX_BYTES_PER_WRITE = 1 << 18;
    ...
    private static GenericFutureListener<Future<? super Void>> forwardFailureListener(ChannelHandlerContext ctx, ChannelPromise promise) {
        return future -> {

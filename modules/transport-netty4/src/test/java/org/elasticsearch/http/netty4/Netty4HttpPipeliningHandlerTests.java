...
//    }
//
//    private class WorkEmulatorHandler extends SimpleChannelInboundHandler<HttpPipelinedRequest2> {
//
//        @Override
//        protected void channelRead0(final ChannelHandlerContext ctx, HttpPipelinedRequest2 pipelinedRequest) {
//            LastHttpContent request = pipelinedRequest.getDelegateRequest();

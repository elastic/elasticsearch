...
public final class NioHttpChannel extends AbstractRestChannel {
     ...
     */
    public NioHttpChannel(Netty4HttpRequest request, HttpPipelinedRequest pipelinedRequest, boolean detailedErrorsEnabled,
    ...
    public void sendResponse(RestResponse response) {
        ...
        Netty4CorsHandler.setCorsResponseHeaders(nettyRequest, resp, corsConfig);

...
public class SimpleNetty4TransportTests extends AbstractSimpleTransportTestCase {
    ...
    private void checkDefaultKeepAliveOptions(TcpChannel channel) throws IOException {
        assertThat(channel, instanceOf(Netty5TcpChannel.class));
        Netty5TcpChannel nettyChannel = (Netty5TcpChannel) channel;
        assertThat(nettyChannel.getNettyChannel(), instanceOf(Netty5NioSocketChannel.class));
        Netty5NioSocketChannel netty5NioSocketChannel = (Netty5NioSocketChannel) nettyChannel.getNettyChannel();
        SocketChannel socketChannel = netty5NioSocketChannel.javaChannel();

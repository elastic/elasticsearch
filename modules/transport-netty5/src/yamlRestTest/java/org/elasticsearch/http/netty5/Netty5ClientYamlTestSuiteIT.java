...
public class Netty5ClientYamlTestSuiteIT extends ESClientYamlSuiteTestCase {

    public Netty5ClientYamlTestSuiteIT(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

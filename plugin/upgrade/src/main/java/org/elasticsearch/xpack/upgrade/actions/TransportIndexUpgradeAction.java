...
public class TransportIndexUpgradeAction extends TransportMasterNodeAction<IndexUpgradeAction.Request,
        BulkByScrollResponse> {

    private final IndexUpgradeService indexUpgradeService;

    @Inject
    public TransportIndexUpgradeAction(Settings settings, TransportService transportService,
        ...
        super(settings, IndexUpgradeAction.NAME, transportService, clusterService, threadPool, actionFilters,
                indexNameExpressionResolver, IndexUpgradeAction.Request::new);

...
public class BootStrapTests extends AbstractWatcherIntegrationTestCase {
    ...
    public void testLoadMalformedWatchRecord() throws Exception {
        ...
        client().prepareIndex(index, HistoryStoreField.DOC_TYPE, wid.value())
                .setSource(jsonBuilder().startObject()
    ...
    public void testMixedTriggeredWatchLoading() throws Exception {
        ...
        for (int i = 0; i < numRecords; i++) {
            ...
            bulkRequestBuilder.add(
                    client().prepareIndex(TriggeredWatchStoreField.INDEX_NAME, TriggeredWatchStoreField.DOC_TYPE, triggeredWatch.id().value())
    ...
    public void testWatchRecordSavedTwice() throws Exception {
        ...
        for (int i = 0; i < numRecords; i++) {
            ...
            bulkRequestBuilder.add(client().prepareIndex(watchRecordIndex, HistoryStoreField.DOC_TYPE, watchRecord.id().value())

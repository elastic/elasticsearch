...
public class ICUCollationKeywordFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        ICUCollationKeywordFieldMapper mapper = new ICUCollationKeywordFieldMapper.Builder("field", IndexMode.STANDARD, false).build(
        ...
        ICUCollationKeywordFieldMapper ignoreAboveMapper = new ICUCollationKeywordFieldMapper.Builder("field", IndexMode.STANDARD, false)
            .ignoreAbove(4)
        ...
        ICUCollationKeywordFieldMapper nullValueMapper = new ICUCollationKeywordFieldMapper.Builder("field", IndexMode.STANDARD, false)
            .nullValue("NULL")
            .build(MapperBuilderContext.root(false, false));

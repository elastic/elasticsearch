...
final class AzureClientSettings {
     ...
     */
    static final Setting<TimeValue> REFRESH_SETTING =
     ...
     */
    static final Setting<HostType> HOST_TYPE_SETTING =
     ...
     */
    static final Setting<String> HOST_NAME_SETTING = Setting.simpleString("discovery.azure-arm.host.name",
        Property.NodeScope, Property.Dynamic);
     ...
     */
    static final Setting<String> HOST_RESOURCE_GROUP_SETTING = Setting.simpleString("discovery.azure-arm.host.resource_group",
        Property.NodeScope, Property.Dynamic);
     ...
     */
    static final Setting<String> REGION_SETTING = Setting.simpleString("discovery.azure-arm.region",
        Property.NodeScope, Property.Dynamic);
}

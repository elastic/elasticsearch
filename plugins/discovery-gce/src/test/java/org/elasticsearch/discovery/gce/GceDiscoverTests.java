        ...
        protected GceInstancesService createGceInstancesService() {
            return new GceInstancesService() {
                ...
                public Collection<Instance> instances() {
                    ...
                    return AccessController.doPrivileged((PrivilegedAction<List<Instance>>) () -> {
                        ...
                        for (DiscoveryNode discoveryNode : nodes.values()) {
                            ...
                            TransportAddress transportAddress = discoveryNode.getAddress();
                            NetworkInterface networkInterface = new NetworkInterface();
                            if (transportAddress instanceof LocalTransportAddress) {
                                networkInterface.setNetworkIP(((LocalTransportAddress) transportAddress).id());
                            } else {
                                networkInterface.setNetworkIP(transportAddress.toString());
                            }

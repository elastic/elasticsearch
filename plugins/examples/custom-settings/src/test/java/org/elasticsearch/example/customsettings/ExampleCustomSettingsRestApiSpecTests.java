...
/**
 * {@link ExampleCustomSettingsRestApiSpecTests} executes the plugin's REST API integration tests.
 * <p>
 ...
 * </p>
 */
public class ExampleCustomSettingsRestApiSpecTests extends ESClientYamlSuiteTestCase {

    public ExampleCustomSettingsRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

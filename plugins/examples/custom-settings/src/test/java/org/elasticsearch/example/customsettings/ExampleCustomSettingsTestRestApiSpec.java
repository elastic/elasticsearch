...
/**
 * {@link ExampleCustomSettingsTestRestApiSpec} executes the plugin's REST API integration tests.
 * <p>
 ...
 * </p>
 */
public class ExampleCustomSettingsTestRestApiSpec extends ESClientYamlSuiteTestCase {

    public ExampleCustomSettingsTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
/**
 * {@link ExampleRestHandlerRestApiSpecTests} executes the plugin's REST API integration tests.
 * <p>
 ...
 * </p>
 */
public class ExampleRestHandlerRestApiSpecTests extends ESClientYamlSuiteTestCase {

    public ExampleRestHandlerRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

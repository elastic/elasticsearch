...
/**
 * {@link ExampleRestHandlerRestTestsYaml} executes the plugin's REST API integration tests.
 * <p>
 ...
 * </p>
 */
public class ExampleRestHandlerRestTestsYaml extends ESClientYamlSuiteTestCase {

    public ExampleRestHandlerRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

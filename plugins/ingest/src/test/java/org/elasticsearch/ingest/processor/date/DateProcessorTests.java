...
public class DateProcessorTests extends ESTestCase {
    ...
    public void testJodaPattern() {
        ...
        assertThat(data.getProperty("date_as_date", String.class), equalTo("2010-06-12T11:05:15.000+02:00"));
    }
    ...
    public void testJodaPatternMultipleFormats() {
        ...
        Data data = new Data("index", "type", "id", document);
        dateProcessor.execute(data);
        assertThat(data.getProperty("date_as_date", String.class), equalTo("2010-06-12T00:00:00.000+02:00"));
    ...
    public void testJodaPatternDefaultYear() {
        ...
        Data data = new Data("index", "type", "id", document);
        dateProcessor.execute(data);
        assertThat(data.getProperty("date_as_date", String.class), equalTo(DateTime.now().getYear() + "-06-12T00:00:00.000+02:00"));
    }
    ...
    public void testTAI64N() {
        ...
        Data data = new Data("index", "type", "id", document);
        dateProcessor.execute(data);
        assertThat(data.getProperty("date_as_date", String.class), equalTo("2012-12-22T03:00:46.767+02:00"));
    }
    ...
    public void testUnixMs() {
        ...
        Data data = new Data("index", "type", "id", document);
        dateProcessor.execute(data);
        assertThat(data.getProperty("date_as_date", String.class), equalTo("1970-01-01T00:16:40.500Z"));
    }

...
public class JavaScriptScriptEngineTests extends ESTestCase {
    ...
    public void testSimpleEquation() {
        ...
        Object o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testSimpleEquation", "js", se.compile(null, "1 + 2", Collections.emptyMap())), vars).run();
        assertThat(((Number) o).intValue(), equalTo(3));
    }

    public void testNullVars() {
        CompiledScript script = new CompiledScript(Script.ScriptType.INLINE, "testSimpleEquation", "js",
    ...
    public void testMapAccess() {
        ...
        vars.put("obj1", obj1);
        Object o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testMapAccess", "js", se.compile(null, "obj1", Collections.emptyMap())), vars).run();
        ...
        o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testMapAccess", "js", se.compile(null, "obj1.l[0]", Collections.emptyMap())), vars).run();
    ...
    public void testJavaScriptObjectToMap() {
        Map<String, Object> vars = new HashMap<String, Object>();
        Object o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testJavaScriptObjectToMap", "js",
    ...
    public void testJavaScriptObjectMapInter() {
        ...
        ExecutableScript executable = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testJavaScriptObjectMapInter", "js",
    ...
    public void testJavaScriptInnerArrayCreation() {
        ...
        ExecutableScript script = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testJavaScriptInnerArrayCreation", "js",
    ...
    public void testAccessListInScript() {
        ...
        Object o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testAccessInScript", "js",
                se.compile(null, "l.length", Collections.emptyMap())), vars).run();
        assertThat(((Number) o).intValue(), equalTo(4));

        o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testAccessInScript", "js",
    ...
    public void testChangingVarsCrossExecution1() {
        ...
        ExecutableScript script = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testChangingVarsCrossExecution1", "js",
                compiledScript), vars);
        ctx.put("value", 1);
        Object o = script.run();
    ...
    public void testChangingVarsCrossExecution2() {
        ...
        ExecutableScript script = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testChangingVarsCrossExecution2", "js",
                compiledScript), vars);

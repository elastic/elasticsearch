...
public class PythonScriptEngineTests extends ESTestCase {
    ...
    public void testSimpleEquation() {
        ...
        Object o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testSimpleEquation", "python", se.compile(null, "1 + 2", Collections.emptyMap())), vars).run();
    ...
    public void testMapAccess() {
        ...
        vars.put("obj1", obj1);
        Object o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testMapAccess", "python", se.compile(null, "obj1", Collections.emptyMap())), vars).run();
        ...
        o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testMapAccess", "python", se.compile(null, "obj1['l'][0]", Collections.emptyMap())), vars).run();
    ...
    public void testObjectMapInter() {
        ...
        ExecutableScript executable = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testObjectInterMap", "python",
...
//        assertThat(((Number) o).intValue(), equalTo(4));
        ...
        Object o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testAccessListInScript", "python", se.compile(null, "l[0]", Collections.emptyMap())), vars).run();
        assertThat(((String) o), equalTo("1"));

        o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testAccessListInScript", "python", se.compile(null, "l[3]", Collections.emptyMap())), vars).run();
        obj1 = (Map<String, Object>) o;
        assertThat((String) obj1.get("prop1"), equalTo("value1"));
        assertThat((String) ((Map<String, Object>) obj1.get("obj2")).get("prop2"), equalTo("value2"));

        o = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testAccessListInScript", "python", se.compile(null, "l[3]['prop1']", Collections.emptyMap())), vars).run();
    ...
    public void testChangingVarsCrossExecution1() {
        ...
        ExecutableScript script = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testChangingVarsCrossExecution1", "python", compiledScript), vars);
        ctx.put("value", 1);
        Object o = script.run();
    ...
    public void testChangingVarsCrossExecution2() {
        ...
        ExecutableScript script = se.executable(new CompiledScript(Script.ScriptType.INLINE, "testChangingVarsCrossExecution2", "python", compiledScript), vars);

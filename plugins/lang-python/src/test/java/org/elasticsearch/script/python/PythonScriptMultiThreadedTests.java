...
public class PythonScriptMultiThreadedTests extends ESTestCase {
    ...
    public void testExecutableNoRuntimeParams() throws Exception {
        ...
        final CompiledScript compiledScript = new CompiledScript(Script.ScriptType.INLINE, "testExecutableNoRuntimeParams", "python", compiled);
...
//    }
    ...
    public void testExecute() throws Exception {
        final PythonScriptEngineService se = new PythonScriptEngineService(Settings.Builder.EMPTY_SETTINGS);
        final Object compiled = se.compile(null, "x + y", Collections.emptyMap());
        final CompiledScript compiledScript = new CompiledScript(Script.ScriptType.INLINE, "testExecute", "python", compiled);
        final AtomicBoolean failed = new AtomicBoolean();

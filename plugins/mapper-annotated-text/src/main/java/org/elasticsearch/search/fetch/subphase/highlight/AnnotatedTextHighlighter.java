...
public class AnnotatedTextHighlighter extends UnifiedHighlighter {
    ...
    public HighlightField highlight(HighlighterContext highlighterContext) {
        ...
        try {
            ...
            AnnotatedHighlighterAnalyzer annotatedHighlighter = new AnnotatedHighlighterAnalyzer(fieldValuesAsString, analyzer);
            fieldValues = Arrays.asList((Object[])annotatedHighlighter.getPlainTextValuesForHighlighter());
            
            
            // use the wrapped analyzer that holds marked-up text
            analyzer = annotatedHighlighter;
            PassageFormatter passageFormatter = new AnnotatedPassageFormatter(annotatedHighlighter, encoder);

...
public class GoogleCloudStorageThirdPartyTests extends ESSingleNodeTestCase {
    ...
    public void testCleanup() {
        ...
        final GoogleCloudStorageRepository repo =
            (GoogleCloudStorageRepository) getInstanceFromNode(RepositoriesService.class).repository("test-repo");

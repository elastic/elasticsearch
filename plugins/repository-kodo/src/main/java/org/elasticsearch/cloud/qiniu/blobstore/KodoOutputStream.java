 ...
 */
public abstract class KodoOutputStream extends OutputStream {
    ...
    KodoOutputStream(KodoBlobStore blobStore, String bucketName, String blobName, int bufferSizeInBytes, int numberOfRetries) {
    ...
    public KodoBlobStore getBlobStore() {
        return blobStore;
    }

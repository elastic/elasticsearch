    ...
    interface CLOUD_S3 {
        ...
        Setting<Integer> PROXY_PORT_SETTING =
            new Setting<>("cloud.aws.s3.proxy.port", AwsS3Service.PROXY_PORT_SETTING,
                s -> Setting.parseInt(s, 0, 1<<16, "cloud.aws.s3.proxy.port"), SettingsProperty.ClusterScope);
        /**
        ...
        Setting<String> SIGNER_SETTING =
            new Setting<>("cloud.aws.s3.signer", AwsS3Service.SIGNER_SETTING, Function.identity(), SettingsProperty.ClusterScope);
        /**
         ...
         */
        Setting<String> ENDPOINT_SETTING = Setting.simpleString("cloud.aws.s3.endpoint", SettingsProperty.ClusterScope);
    }

...
public class S3BlobStoreRepositoryTests extends ESMockAPIBasedRepositoryIntegTestCase {
    ...
    public void testEnforcedCooldownPeriod() throws IOException {
        ...
        client().admin().cluster().prepareDeleteSnapshots(repoName, new String[]{newSnapshotName}).get();
        ...
        client().admin().cluster().prepareDeleteSnapshots(repoName, new String[]{fakeOldSnapshot.getName()}).get();

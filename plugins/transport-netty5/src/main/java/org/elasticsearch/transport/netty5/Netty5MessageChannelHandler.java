 ...
 */
final class Netty5MessageChannelHandler extends ChannelHandlerAdapter {

    private final Netty5Transport transport;
    ...
    Netty5MessageChannelHandler(Netty5Transport transport, Recycler<BytesRef> recycler) {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        ...
        Netty5TcpChannel tcpChannel = ctx.channel().attr(Netty5Transport.CHANNEL_KEY).get();

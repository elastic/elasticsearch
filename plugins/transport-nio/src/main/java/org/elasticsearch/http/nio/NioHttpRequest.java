...
public class NioHttpRequest extends RestRequest {
    ...
    public NioHttpRequest(NamedXContentRegistry xContentRegistry, FullHttpRequest request) {
    ...
    public NioHttpRequest(NamedXContentRegistry xContentRegistry, Map<String, String> params, String uri, FullHttpRequest request) {

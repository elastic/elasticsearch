...
public class PercolatorFieldIndexMigrationIT extends ESRestTestCase {
    private static final Logger logger = LogManager.getLogger(PercolatorFieldIndexMigrationIT.class);

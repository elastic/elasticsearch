...
public class CCSDuelIT extends ESRestTestCase {
    ...
    private static SearchSourceBuilder buildTermsAggsSource() {
        ...
        TermsAggregationBuilder cluster = new TermsAggregationBuilder("cluster123", null).userValueTypeHint(ValueType.STRING);
        cluster.field("_index");
        TermsAggregationBuilder type = new TermsAggregationBuilder("type", null).userValueTypeHint(ValueType.STRING);
        ...
        TermsAggregationBuilder tags = new TermsAggregationBuilder("tags", null).userValueTypeHint(ValueType.STRING);
        tags.field("tags.keyword");
        tags.showTermDocCountError(true);
        tags.size(100);
        sourceBuilder.aggregation(tags);

        TermsAggregationBuilder tags2 = new TermsAggregationBuilder("tags", null).userValueTypeHint(ValueType.STRING);
        ...
        TermsAggregationBuilder answerPerQuestion = new TermsAggregationBuilder("answer_per_question", null)
        ...
        TermsAggregationBuilder answerPerUser = new TermsAggregationBuilder("answer_per_user", null).userValueTypeHint(ValueType.STRING);

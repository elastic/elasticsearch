    ...
    public void test20HostnameSubstitution() throws Exception {
        ...
        withCustomConfig(confPath -> {
            ...
            if (distribution.isPackage()) {
                ...
                ServerUtils.removeSettingFromExistingConfiguration(installation, "cluster.initial_master_nodes");
                ServerUtils.addSettingToExistingConfiguration(installation, "cluster.initial_master_nodes", "[\"mytesthost\"]");
            }

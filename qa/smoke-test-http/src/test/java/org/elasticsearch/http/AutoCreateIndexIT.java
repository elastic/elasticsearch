...
public class AutoCreateIndexIT extends ESRestTestCase {
     ...
     */
    public void testCanAutoCreateTemplateWhenAllowedByTemplate() throws IOException {
        configureAutoCreateIndex(false);
     ...
     */
    public void testCannotAutoCreateTemplateWhenDisallowedByTemplate() throws IOException {

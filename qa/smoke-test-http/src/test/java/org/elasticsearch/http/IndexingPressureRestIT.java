...
public class IndexingPressureRestIT extends HttpSmokeTestCase {
    ...
    public void testIndexingPressureStats() throws IOException {
        ...
        Integer node1CombinedBytes = node1.get("indexing_pressure.total.memory.combined_coordinating_and_primary_in_bytes");
        Integer node1PrimaryBytes = node1.get("indexing_pressure.total.memory.primary_in_bytes");
        Integer node1ReplicaBytes = node1.get("indexing_pressure.total.memory.replica_in_bytes");
        Integer node1CoordinatingRejections = node1.get("indexing_pressure.total.memory.coordinating_rejections");
        Integer node1PrimaryRejections = node1.get("indexing_pressure.total.memory.primary_rejections");
        XContentTestUtils.JsonMapView node2 = new XContentTestUtils.JsonMapView((Map<String, Object>) values.get(1));
        Integer node2IndexingBytes = node2.get("indexing_pressure.total.memory.combined_coordinating_and_primary_in_bytes");
        Integer node2PrimaryBytes = node2.get("indexing_pressure.total.memory.primary_in_bytes");
        Integer node2ReplicaBytes = node2.get("indexing_pressure.total.memory.replica_in_bytes");
        Integer node2CoordinatingRejections = node2.get("indexing_pressure.total.memory.coordinating_rejections");
        Integer node2PrimaryRejections = node2.get("indexing_pressure.total.memory.primary_rejections");
        ...
        node1CoordinatingRejections = node1AfterRejection.get("indexing_pressure.total.memory.coordinating_rejections");
        node1PrimaryRejections = node1.get("indexing_pressure.total.memory.primary_rejections");
        XContentTestUtils.JsonMapView node2AfterRejection = new XContentTestUtils.JsonMapView((Map<String, Object>) values2.get(1));
        node2CoordinatingRejections = node2AfterRejection.get("indexing_pressure.total.memory.coordinating_rejections");
        node2PrimaryRejections = node2AfterRejection.get("indexing_pressure.total.memory.primary_rejections");

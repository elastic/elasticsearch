...
public class SystemIndicesQA extends Plugin implements SystemIndexPlugin, ActionPlugin {
    ...
    public List<RestHandler> getRestHandlers(
        ...
        return org.elasticsearch.core.List.of(new CreateNetNewSystemIndexHandler(), new IndexDocHandler());
    }
    ...
    private static class CreateNetNewSystemIndexHandler extends BaseRestHandler {
        ...
        public List<Route> routes() {
            return org.elasticsearch.core.List.of(Route.builder(Method.PUT, "/_net_new_sys_index/_create").build());
        }
    ...
    private static class IndexDocHandler extends BaseRestHandler {
        ...
        @Override
        public List<Route> routes() {
            return org.elasticsearch.core.List.of(new Route(POST, "/_net_new_sys_index/{id}"), new Route(PUT, "/_net_new_sys_index/{id}"));
        }

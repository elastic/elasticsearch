...
verify_package_installation() {
    ...
    assert_file "$ESCONFIG/elasticsearch.yml" f root elasticsearch 640
    assert_file "$ESCONFIG/jvm.options" f root elasticsearch 640
    assert_file "$ESCONFIG/log4j2.properties" f root elasticsearch 640
    ...
    if is_dpkg; then
        # Env file
        assert_file "/etc/default/elasticsearch" f root root 640
    ...
    if is_rpm; then
        # Env file
        assert_file "/etc/sysconfig/elasticsearch" f root root 640
        # License file

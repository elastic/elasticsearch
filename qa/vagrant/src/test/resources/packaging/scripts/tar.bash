...
verify_archive_installation() {
    ...
    assert_file "$ESCONFIG/elasticsearch.yml" f elasticsearch elasticsearch 640
    assert_file "$ESCONFIG/jvm.options" f elasticsearch elasticsearch 640
    assert_file "$ESCONFIG/log4j2.properties" f elasticsearch elasticsearch 640

...
public class PartitionDataGeneratorTests extends ESTestCase {
    ...
    public void testUniformDistribution() {
        ...
        var generator = new PartitionDataGenerator(numDocs, 8, numPartitions, DatasetConfig.PartitionDistribution.UNIFORM, 42L, false);
    ...
    public void testZipfDistribution() {
        int numDocs = 1000;
        int numPartitions = 10;
        var generator = new PartitionDataGenerator(numDocs, 8, numPartitions, DatasetConfig.PartitionDistribution.ZIPF, 42L, false);

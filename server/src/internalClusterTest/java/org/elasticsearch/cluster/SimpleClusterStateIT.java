...
public class SimpleClusterStateIT extends ESIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return Collections.singletonList(PrivateSectionPlugin.class);
    }
    ...
    private static class TestSection extends AbstractNamedDiffable<ClusterState.Custom> implements ClusterState.Custom {

        private final int value;

        TestSection(int value) {
            this.value = value;
        }

        TestSection(StreamInput in) throws IOException {
    ...
    public static class PrivateSectionPlugin extends Plugin implements ClusterPlugin {

        public PrivateSectionPlugin() {}

        @Override
        public List<NamedWriteableRegistry.Entry> getNamedWriteables() {
            List<NamedWriteableRegistry.Entry> entries = new ArrayList<>();
            entries.add(new NamedWriteableRegistry.Entry(ClusterState.Custom.class, "test", TestSection::new));
            entries.add(new NamedWriteableRegistry.Entry(NamedDiff.class, "test", TestSection::readDiffFrom));
            return entries;
        }
                                ...
                                new ClusterStateUpdateTask(Priority.URGENT) {
                                    ...
                                    public ClusterState execute(ClusterState currentState) {
                                        if (currentState.custom("test") == null) {
                                            ...
                                            builder.putCustom("test", new TestSection(42));

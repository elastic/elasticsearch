    ...
    public void testRerouteIsCalledWhenHotSpotAppears() {
        ...
        MockLog.awaitLogger(
            ...
            new MockLog.SeenEventExpectation(
                ...
                Level.DEBUG,
                Strings.format("""
                    Nodes [[{%s} ({%s})]] are hot-spotting, of 3 total ingest nodes. Reroute for hot-spotting has never previously \
                    been called. Previously hot-spotting nodes are [0 nodes]. The write thread pool queue latency threshold is [%s]. \
                    Triggering reroute.
        ...
        MockLog.awaitLogger(
            ...
            new MockLog.SeenEventExpectation(
                ...
                Strings.format("""
                    ...
                    Reroute for hot-spotting was last called [*] ago. Previously hot-spotting nodes are [[{%s} ({%s})]]. \

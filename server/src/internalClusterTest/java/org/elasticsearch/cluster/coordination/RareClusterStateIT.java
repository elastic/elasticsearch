...
public class RareClusterStateIT extends ESIntegTestCase {
    ...
    public void testDelayedMappingPropagationOnReplica() throws Exception {
        ...
        final ActionFuture<IndexResponse> docIndexResponse = client().prepareIndex("index", "_doc", "1").setSource("field", 42).execute();

        assertBusy(() -> assertTrue(client().prepareGet("index", "_doc", "1").get().isExists()));
        ...
        assertBusy(() -> assertTrue(client().prepareGet("index", "_doc", "2").get().isExists()));

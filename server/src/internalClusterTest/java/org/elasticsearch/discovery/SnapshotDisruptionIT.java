        ...
        clusterService.addListener(new ClusterStateListener() {
            ...
            public void clusterChanged(ClusterChangedEvent event) {
                ...
                if (snapshots != null && snapshots.isEmpty() == false) {
                    final SnapshotsInProgress.SnapshotInProgressEntry snapshotEntry = snapshots.forRepo(repoName).get(0);
                    if (snapshotEntry.state() == SnapshotsInProgress.SnapshotInProgressState.SUCCESS) {

...
public class SystemIndexManagerIT extends ESIntegTestCase {
    ...
    public static class TestSystemIndexDescriptor extends SystemIndexDescriptor {
        ...
        TestSystemIndexDescriptor() {
            super(INDEX_NAME + "*", PRIMARY_INDEX_NAME, "Test system index", null, settings, INDEX_NAME, 0, "version", "stack", MapperService.SINGLE_MAPPING_NAME);
        }
        ...
        public static String getOldMappings() {
            try {
                ...
                builder.startObject();
                {
                    Version previousMajor = Version.fromId((Version.CURRENT.major - 1) * 1000000 + 99);

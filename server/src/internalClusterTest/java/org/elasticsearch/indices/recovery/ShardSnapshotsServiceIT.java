...
public class ShardSnapshotsServiceIT extends ESIntegTestCase {
    ...
    public void testReturnsEmptyListWhenThereAreNotAvailableRepositories() throws Exception {
        ...
        List<ShardSnapshotsService.ShardSnapshotData> shardSnapshotData = getShardSnapshotDataForShard(shardId);
    ...
    public void testFailingReposAreTreatedAsNonExistingShardSnapshots() throws Exception {
        ...
        List<ShardSnapshotsService.ShardSnapshotData> shardSnapshotDataForShard = getShardSnapshotDataForShard(shardId);

        assertThat(shardSnapshotDataForShard.size(), is(equalTo(numberOfWorkingRepositories)));
        for (ShardSnapshotsService.ShardSnapshotData shardSnapshotData : shardSnapshotDataForShard) {
    ...
    private List<ShardSnapshotsService.ShardSnapshotData> getShardSnapshotDataForShard(ShardId shardId) throws Exception {
        ...
        PlainActionFuture<List<ShardSnapshotsService.ShardSnapshotData>> future = PlainActionFuture.newFuture();

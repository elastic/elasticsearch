...
public class PersistentTaskInitializationFailureIT extends ESIntegTestCase {
    ...
    public void testPersistentTasksThatFailDuringInitializationAreRemovedFromClusterState() throws Exception {
        ...
        PlainActionFuture<PersistentTasksMetadataSection.PersistentTask<FailingInitializationTaskParams>> startPersistentTaskFuture =
        ...
        assertBusy(() -> {
            ...
            List<PersistentTasksMetadataSection.PersistentTask<?>> tasks = findTasks(
    ...
    static class FailingInitializationPersistentTaskExecutor extends PersistentTasksExecutor<FailingInitializationTaskParams> {
        ...
        protected AllocatedPersistentTask createTask(
            ...
            String action,
            TaskId parentTaskId,
            PersistentTasksMetadataSection.PersistentTask<FailingInitializationTaskParams> taskInProgress,

...
public class SumIT extends AbstractNumericTestCase {
    ...
    public void setupSuiteScopeCluster() throws Exception {
        ...
        builders.add(prepareIndex("old_index").setSource("transit_mode", "train", "distance", 42.0));
        builders.add(prepareIndex("old_index").setSource("transit_mode", "bus", "distance", 50.5));
    ...
    public void testScriptCaching() throws Exception {
        ...
        assertNoFailures(prepareSearch("cache_test_idx").setSize(0).addAggregation(sum("foo").field("d")));

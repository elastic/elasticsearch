...
public class TDigestPercentileRanksIT extends AbstractNumericTestCase {
    ...
    public void testScriptCaching() throws Exception {
        ...
        IndexRequestBuilder indexRequestBuilder1 = prepareIndex("cache_test_idx").setId("1").setSource("s", 1);
        IndexRequestBuilder indexRequestBuilder2 = prepareIndex("cache_test_idx").setId("2").setSource("s", 2);

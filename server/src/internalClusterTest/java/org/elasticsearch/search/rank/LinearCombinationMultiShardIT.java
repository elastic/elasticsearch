...
public class LinearCombinationMultiShardIT extends ESIntegTestCase {
    ...
    public void testBM25AndKnn() {
        ...
        assertEquals(Set.of(491.0, 492.0, 493.0, 494.0, 495.0, 496.0, 497.0, 498.0, 499.0, 500.0, 501.0), vectors);
    }

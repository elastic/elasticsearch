...
public class RepositoriesIT extends AbstractSnapshotIntegTestCase {
    public void testRepositoryCreation() throws Exception {
        ...
        RepositoriesMetadata repositoriesMetadata = metadata.projectCustom(RepositoriesMetadata.TYPE);
        ...
        repositoriesMetadata = metadata.projectCustom(RepositoriesMetadata.TYPE);
        assertThat(repositoriesMetadata, notNullValue());

...
public class SharedClusterSnapshotRestoreIT extends AbstractSnapshotIntegTestCase {
    ...
    public void testRestoreIncreasesPrimaryTerms() {
        ...
        assertThat(indexMetadata.getSettings().get(IndexMetadata.SETTING_RESTORE_UUID), nullValue());
        ...
        assertThat(restoredIndexMetadata.getSettings().get(IndexMetadata.SETTING_RESTORE_UUID), notNullValue());
    }

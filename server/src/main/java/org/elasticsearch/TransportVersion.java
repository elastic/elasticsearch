...
public record TransportVersion(int id) implements Comparable<TransportVersion> {
    ...
    public static final TransportVersion V_8_500_028 = registerTransportVersion(8_500_026, "b72d7f12-8ed3-4a5b-8e6a-4910ea10e0d7");

    private static class CurrentHolder {
        private static final TransportVersion CURRENT = findCurrent(V_8_500_028);

...
public record TransportVersion(int id) implements Comparable<TransportVersion> {
    ...
    public static final TransportVersion V_8_500_009 = registerTransportVersion(8_500_009, "651216c9-d54f-4189-9fe1-48d82d276863");

    /**
     * Reference to the most recent transport version.
     * This should be the transport version with the highest id.
     */
    public static final TransportVersion CURRENT = V_8_500_009;

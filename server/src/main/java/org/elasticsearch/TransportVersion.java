...
public record TransportVersion(int id) implements VersionId<TransportVersion> {
    ...
    // TODO: modify to current+1 once PR is ready to be merged
    public static final TransportVersion V_8_500_999 = registerTransportVersion(8_500_999, "89b61a69-fb38-4472-9590-e25b8e1a8cf7");

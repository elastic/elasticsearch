...
public record TransportVersion(int id) implements Comparable<TransportVersion> {
    ...
    // Operator field in AuthenticateResponse
    public static final TransportVersion V_8_500_025 = registerTransportVersion(8_500_025, "a6592d08-15cb-4e1a-b9b4-b2ba24058444");

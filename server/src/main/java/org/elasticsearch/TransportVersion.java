...
public record TransportVersion(int id) implements Comparable<TransportVersion> {
    ...
    public static final TransportVersion V_8_500_041 = registerTransportVersion(8_500_041, "763b4801-a4fc-47c4-aff5-7f5a757b8a07");

    private static class CurrentHolder {
        private static final TransportVersion CURRENT = findCurrent(V_8_500_041);

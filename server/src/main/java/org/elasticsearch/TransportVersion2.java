...
// * the version of any single node. The {@link TransportVersion2} of a connection is negotiated between the nodes via some logic that is not
...
// * different version value. If you need to know whether the cluster as a whole speaks a new enough {@link TransportVersion2} to understand a

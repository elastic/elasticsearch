...
public class TransportVersions {
    ...
    public static final TransportVersion ML_INFERENCE_AMAZON_BEDROCK_ADDED = def(8_701_00_0);
    public static final TransportVersion VERSIONED_MASTER_NODE_REQUESTS = def(8_702_00_0);

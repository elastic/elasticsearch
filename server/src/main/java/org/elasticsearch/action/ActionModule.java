...
import org.elasticsearch.action.search.TransportCloseSearchContextAction;
...
import org.elasticsearch.rest.action.search.RestCloseSearchContextAction;
import org.elasticsearch.rest.action.search.RestClearScrollAction;
import org.elasticsearch.rest.action.search.RestCountAction;
import org.elasticsearch.rest.action.search.RestExplainAction;
import org.elasticsearch.rest.action.search.RestMultiSearchAction;
import org.elasticsearch.rest.action.search.RestOpenSearchContextAction;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(TransportOpenSearchContextAction.INSTANCE, TransportOpenSearchContextAction.class);
        actions.register(CloseSearchContextAction.INSTANCE, TransportCloseSearchContextAction.class);
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(new RestOpenSearchContextAction());
        registerHandler.accept(new RestCloseSearchContextAction());

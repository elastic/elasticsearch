...
import org.elasticsearch.action.admin.indices.stats.rrc.ShardStatsAction;
import org.elasticsearch.action.admin.indices.stats.rrc.TransportShardStatsAction;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(ShardStatsAction.INSTANCE, TransportShardStatsAction.class);

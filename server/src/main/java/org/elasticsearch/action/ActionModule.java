...
import org.elasticsearch.action.admin.cluster.coordination.MasterHistoryTransportAction;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(MasterHistoryAction.INSTANCE, MasterHistoryTransportAction.class);

...
public class ActionModule extends AbstractModule {
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(new org.elasticsearch.rest.action.document.RestCountAction(restController));
        ...
        registerHandler.accept(new RestIndicesAction(restController, indexNameExpressionResolver));
        ...
        registerHandler.accept(new org.elasticsearch.rest.action.cat.RestRecoveryAction(restController));

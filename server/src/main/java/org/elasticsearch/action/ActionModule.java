...
import org.elasticsearch.action.admin.indices.stats.rrc.ShardStatsRRCAction;
import org.elasticsearch.action.admin.indices.stats.rrc.TransportShardStatsRRCAction;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(ShardStatsRRCAction.INSTANCE, TransportShardStatsRRCAction.class);

...
/**
 * A record that holds an index expression that may contain remote indices, along with its resolved local and remote parts.
 ...
 * @param remoteExpressions the resolved remote part of the expression, each entry in "canonical" CCS form, e.g. "remote:index".
 *                          This is a list instead of a record since remote expressions are not expanded, and we therefore don't need to
 *                          track expansion results or errors.
 */

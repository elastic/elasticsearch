...
import org.elasticsearch.action.ActionListenerImplementations.NotifyOnceActionListener;
...
public final class StepListener<Response> extends NotifyOnceActionListener<Response> {
    ...
    StepListener(ActionListener<Response> delegate, ListenableFuture<Response> delegate1) {
        super(delegate);

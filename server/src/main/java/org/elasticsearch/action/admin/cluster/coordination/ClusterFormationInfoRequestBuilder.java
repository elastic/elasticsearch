...
public class ClusterFormationInfoRequestBuilder extends NodesOperationRequestBuilder<
    ...
    ClusterFormationInfoRequestBuilder> {


    public ClusterFormationInfoRequestBuilder(ElasticsearchClient client, ClusterFormationInfoAction action) {
        super(client, action, new ClusterFormationInfoRequest());
    }
}

...
public class NodeInfo extends BaseNodeResponse {
    ...
    public NodeInfo(StreamInput in) throws IOException {
        ...
        if (in.getTransportVersion().onOrAfter(TransportVersions.V_8_12_0)) {
            ...
            if (in.getTransportVersion().onOrAfter(TransportVersions.ADD_COMPATIBILITY_VERSIONS_TO_NODE_INFO)) {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getTransportVersion().onOrAfter(TransportVersions.ADD_COMPATIBILITY_VERSIONS_TO_NODE_INFO)) {

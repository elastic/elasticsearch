...
public class NodeStats extends BaseNodeResponse implements ToXContentFragment {
    ...
    @Nullable
    private ScriptContextStats scriptContextStats;
    ...
    public NodeStats(StreamInput in) throws IOException {
        ...
        if (in.getVersion().after(Version.V_7_7_0)) {
            scriptContextStats = in.readOptionalWriteable(ScriptContextStats::new);
        } else {
            scriptContextStats = null;
        }
    }
    ...
    public NodeStats(DiscoveryNode node, long timestamp, @Nullable NodeIndicesStats indices,
                     ...
                     @Nullable ScriptContextStats scriptContextStats) {
        super(node);
        ...
        this.scriptContextStats = scriptContextStats;
    }
    ...
    @Nullable
    public ScriptContextStats getScriptContextStats() {
        return scriptContextStats;
    }
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getVersion().after(Version.V_7_7_0)) {
            out.writeOptionalWriteable(scriptContextStats);
        }
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (getScriptContextStats() != null) {
            getScriptContextStats().toXContent(builder, params);
        }
        return builder;
    }
}

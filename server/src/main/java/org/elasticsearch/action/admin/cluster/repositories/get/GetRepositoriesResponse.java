...
public class GetRepositoriesResponse extends ActionResponse implements ToXContentObject {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        builder.startObject();
        repositories.toXContent(builder, new DelegatingMapParams(Map.of(RepositoriesMetadata.HIDE_GENERATIONS_PARAM, "true",
                RepositoriesMetadata.HIDE_TRANSIENT_SETTINGS_PARAM, "true"), params));
        builder.endObject();
        return builder;
    }

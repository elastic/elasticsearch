...
public class TransportSnapshotsStatusAction extends TransportMasterNodeAction<SnapshotsStatusRequest, SnapshotsStatusResponse> {
    ...
    @Override
    protected void masterOperation(SnapshotsStatusRequest request, ClusterState state, ActionListener<SnapshotsStatusResponse> listener)
        throws Exception {
        ...
        repositoryDataListener.whenComplete(repositoryData -> {
            ...
            if (snapshotIdsToLoad.isEmpty()) {
                ...
                repositoriesService.repository(repositoryName)
                    ...
                    }, listener.map(v -> new SnapshotsStatusResponse(org.elasticsearch.core.List.copyOf(threadSafeBuilder)))));
            }
        }, listener::onFailure);
    }

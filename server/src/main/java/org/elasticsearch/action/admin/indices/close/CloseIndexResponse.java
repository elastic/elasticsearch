...
public class CloseIndexResponse extends AcknowledgedResponse {
    ...
    public CloseIndexResponse(final List<IndexResult> indices) {
        super(indices.stream().noneMatch(IndexResult::hasFailures));
    ...
    public static class IndexResult implements Writeable, ToXContentFragment {
        ...
        private @Nullable final Exception exception;
        private @Nullable final ShardResult[] shards;

        ...
        private final class CreateIndexTask implements ClusterStateTaskListener {
            ...
            ClusterState execute(
                ...
                if (isDataStream) {
                    ...
                    final var indexNames = dataStream.getFailureComponent().getIndices().isEmpty()
                        ? List.of(backingIndexName)
                        : List.of(backingIndexName, dataStream.getFailureComponent().getIndices().get(0).getName());

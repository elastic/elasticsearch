...
import org.elasticsearch.action.support.replication.TransportReplicationWithUnpromotablesAction;
...
public class TransportShardRefreshAction extends TransportReplicationWithUnpromotablesAction<
    ...
    @Override
    protected void shardOperationOnUnpromotableReplica(
        RefreshReplicationRequest request,
        IndexShard replica,
        ActionListener<ReplicaResult> responseListener
    ) {
    ...
    @Override
    protected ReplicationOperation.ReplicaForwardOptions getReplicaForwardOptions() {
        return ReplicationOperation.ReplicaForwardOptions.PROMOTABLE_AND_UNPROMOTABLE_REPLICAS;
    }
}

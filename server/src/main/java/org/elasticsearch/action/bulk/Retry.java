...
public class Retry {
    ...
    static class RetryHandler extends ActionListener.Delegating<BulkResponse, BulkResponse> {
        ...
        // IndexRequest keeps state that can't be unset (autoGeneratedTimestamp),
        // resending the same instance upon a retry can cause validation errors.
        private static IndexRequest copyBulkItemRequest(IndexRequest orginal) {

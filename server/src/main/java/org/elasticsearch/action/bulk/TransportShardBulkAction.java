...
public class TransportShardBulkAction extends TransportWriteAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
    ...
    static boolean executeBulkItemRequest(
        ...
        if (result.getResultType() == Engine.Result.Type.MAPPING_UPDATE_REQUIRED) {
            ...
            try {
                ...
                onComplete(exceptionToResult(e, primary, isDelete, version, result.getId()), context, updateResult, isSimulated);
                return true;
            }
            ...
            onComplete(result, context, updateResult, isSimulated);
        }
        return true;
    }
    ...
    private static void onComplete(
        ...
        context.markOperationAsExecuted(r, isSimulated);

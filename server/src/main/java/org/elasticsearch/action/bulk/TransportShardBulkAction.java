...
public class TransportShardBulkAction extends TransportWriteAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
    ...
    private static void executeIndexRequestOnPrimary(BulkPrimaryExecutionContext context,
        ...
        final Function<Exception, Engine.IndexResult> exceptionToResult = e -> primary.getFailedIndexResult(e, request.version());
        final Consumer<Engine.IndexResult> onComplete = r -> {
    ...
    private static void executeDeleteRequestOnPrimary(BulkPrimaryExecutionContext context,
        ...
        final IndexShard primary = context.getPrimary();
        final Function<Exception, Engine.DeleteResult> exceptionToResult = e -> primary.getFailedDeleteResult(e, request.version());
        final Consumer<Engine.DeleteResult> onComplete = r -> {
            context.markOperationAsExecuted(r);
            completionListener.onResponse(null);
        };
        executeOnPrimaryWhileHandlingMappingUpdates(
    ...
    private static <T extends Engine.Result> void executeOnPrimaryWhileHandlingMappingUpdates(CheckedSupplier<T, IOException> toExecute,

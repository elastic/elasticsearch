...
public class TransportShardBulkAction extends TransportWriteAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
        ...
        switch (docWriteRequest.opType()) {
            ...
            case INDEX:
                ...
                final SourceToParse sourceToParse =
                    SourceToParse.source(shardId.getIndexName(), indexRequest.type(), indexRequest.id(), indexRequest.routing(),
    ...
    private static void executeIndexRequestOnPrimary(BulkPrimaryExecutionContext context,
        ...
        final SourceToParse sourceToParse = SourceToParse.source(request.index(), request.type(), request.id(), request.routing(),
            request.source(), request.getContentType());

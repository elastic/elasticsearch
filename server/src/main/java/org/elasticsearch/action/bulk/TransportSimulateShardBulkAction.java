 ...
 * refresh is performed. Since this is just a simulation and will not actually impact shards, we don't technically need for this to be a
 * TransportReplicationAction. It could just be a TransportAction. But being a TransportReplication action keeps it more similar to
 * TransportShardBulkAction, and lets us reuse more of the logic from TransportShardBulkAction.
 */
public class TransportSimulateShardBulkAction extends TransportReplicationAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
    ...
    private final PostWriteRefresh noOpPostWriteRefresh;
    ...
    public TransportSimulateShardBulkAction(
        ...
        this.noOpPostWriteRefresh = new PostWriteRefresh(transportService) {
            @Override
    ...
    protected void shardOperationOnPrimary(
        ...
        TransportShardBulkAction.dispatchedShardOperationOnPrimary(
            ...
            threadPool,
            updateHelper,
            null, // no mapping updates are allowed in simulate mode
            noOpPostWriteRefresh,
            Runnable::run,

...
/**
 * Thrown when ES|QL detects datasets during cross-cluster field resolution.
...
public class RemoteDatasetNotSupportedException extends ElasticsearchException {
    ...
    public static final TransportVersion REMOTE_DATASET_NOT_SUPPORTED_EXCEPTION_VERSION = TransportVersion.fromName(

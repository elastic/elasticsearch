...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocWriteRequest<IndexRequest>, CompositeIndicesRequest {
    ...
    private long casSeqNo = SequenceNumbers.UNASSIGNED_SEQ_NO;
    ...
    public ActionRequestValidationException validate() {
        ...
        if (opType() == OpType.CREATE) {
            ...
            if (casSeqNo != SequenceNumbers.UNASSIGNED_SEQ_NO || casPrimaryTerm != 0) {
        ...
        if (casSeqNo != SequenceNumbers.UNASSIGNED_SEQ_NO && (
    ...
    public void process(Version indexCreatedVersion, @Nullable MappingMetaData mappingMd, String concreteIndex) {
        ...
        if (id == null) {
            ...
            assert casSeqNo == SequenceNumbers.UNASSIGNED_SEQ_NO;
    ...
    public void readFrom(StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(Version.V_7_0_0_alpha1)) {
            ...
            casSeqNo = SequenceNumbers.UNASSIGNED_SEQ_NO;
            casPrimaryTerm = SequenceNumbers.UNASSIGNED_SEQ_NO;
        }
    }
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getVersion().onOrAfter(Version.V_7_0_0_alpha1)) {
            ...
            assert false : "compareAndSet [" + casSeqNo + "], currentDocTem [" + casPrimaryTerm + "]";

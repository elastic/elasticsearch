...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocWriteRequest<IndexRequest>, CompositeIndicesRequest {
    ...
    public IndexRequest(StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(Version.V_8_0_0)) {
            isForwardedRequest = in.readBoolean();
        }
    ...
    /**
     * Sets if this request has been forwarded by the coordinating node.
     *
     * @param isForwardedRequest true if the request has been forwarded to an ingest node by the coordinating node
     * @return the request
     */
    ...
    /**
     * Returns whether or not this request has been forwarded by the coordinating node.
     *
     * @return true if the request has been forwarded to an ingest node by the coordinating node
     */
    public boolean isForwardedRequest() {
        return this.isForwardedRequest;
    }
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getVersion().onOrAfter(Version.V_8_0_0)) {
            out.writeBoolean(isForwardedRequest);
        }

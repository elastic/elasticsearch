...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocWriteRequest<IndexRequest>, CompositeIndicesRequest {
    ...
    public ActionRequestValidationException validate() {
        ...
        if (opType() == OpType.CREATE) {
            ...
            if (compareAndWriteSeqNo != SequenceNumbers.UNASSIGNED_SEQ_NO || compareAndWriteTerm != 0) {
    ...
    public IndexRequest compareAndWrite(long seqNo, long term) {
        if (seqNo < 0) {
    ...
    public void process(Version indexCreatedVersion, @Nullable MappingMetaData mappingMd, String concreteIndex) {
        ...
        if (id == null) {
            ...
            assert compareAndWriteSeqNo == SequenceNumbers.UNASSIGNED_SEQ_NO;
    ...
    public void readFrom(StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(Version.V_7_0_0_alpha1)) {
            ...
            compareAndWriteTerm = SequenceNumbers.UNASSIGNED_SEQ_NO;
        }
    }

...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocWriteRequest<IndexRequest>, CompositeIndicesRequest {
    ...
    public ActionRequestValidationException validate() {
        ...
        if (opType() == OpType.CREATE) {
            ...
            if (ifSeqNo != UNASSIGNED_SEQ_NO || ifPrimaryTerm != 0) {
        ...
        if (ifPrimaryTerm == UNASSINGED_PRIMARY_TERM && ifSeqNo != UNASSIGNED_SEQ_NO) {
            validationException = addValidationError("ifSeqNo is set, but primary term is [0]", validationException);
        }
        if (ifPrimaryTerm != 0 && ifSeqNo == UNASSIGNED_SEQ_NO) {
            validationException =
    ...
    public void process(Version indexCreatedVersion, @Nullable MappingMetaData mappingMd, String concreteIndex) {
        ...
        if (id == null) {
            ...
            assert ifPrimaryTerm == UNASSINGED_PRIMARY_TERM;
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        } else if (ifSeqNo != UNASSIGNED_SEQ_NO || ifPrimaryTerm != 0) {

                ...
                try (InputStream stream = data.slice(from, nextMarker - from).streamInput();
                    ...
                    for (Map.Entry<String, Object> entry : source.entrySet()) {
                        ...
                        if ("index".equals(entry.getKey()) || "indices".equals(entry.getKey())) {
                            ...
                            parser.getDeprecationHandler().deprecated(
                                    "key [{}] is not supported in the metadata section and will be rejected in 7.x", entry.getKey());
                        }

                    }
                    defaultOptions = IndicesOptions
                            .fromParameters(expandWildcards, ignoreUnavailable, allowNoIndices, ignoreThrottled, defaultOptions);
                }
            }

...
public class SearchTransportAPMMetrics {
    ...
    public static final String QUERY_CAN_MATCH_NODE_METRIC = "shards_can_match"; // TODO: Not sure how to test.
    ...
    public static final String FREE_CONTEXT_ACTION_METRIC = "shard_release_context"; // TODO: Not sure how to test.
    ...
    public static final String QUERY_FETCH_SCROLL_ACTION_METRIC = "scroll/shard_query_and_fetch_phase"; // TODO: Not sure how to test.
    public static final String FREE_CONTEXT_SCROLL_ACTION_METRIC = "scroll/shard_release_context";
    public static final String CLEAR_SCROLL_CONTEXTS_ACTION_METRIC = "scroll/shard_release_contexts"; // TODO: Not sure how to test.

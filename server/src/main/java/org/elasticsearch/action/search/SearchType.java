...
public enum SearchType {
    ...
    /**
     * The query is executed against as many shards as required to provide enough results to return some data(preview).
     */
    HEAD((byte) 4);
     ...
     */
    public static final SearchType[] CURRENTLY_SUPPORTED = { QUERY_THEN_FETCH, DFS_QUERY_THEN_FETCH, HEAD };
    ...
    public static SearchType fromString(String searchType) {
        ...
        } else if ("head".equals(searchType)) {
            return SearchType.HEAD;
        } else {

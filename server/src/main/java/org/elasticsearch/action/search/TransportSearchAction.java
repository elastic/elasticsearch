            ...
            remoteClusterClient.search(ccsSearchRequest, new ActionListener<SearchResponse>() {
                ...
                public void onResponse(SearchResponse searchResponse) {
                    ...
                    listener.onResponse(new SearchResponse(internalSearchResponse, searchResponse.getScrollId(),
                        ...
                        timeProvider.buildTookInMillis(), searchResponse.getShardFailures(), new SearchResponse.Clusters(1, 1, 0),searchResponse.getWaitTime(),searchResponse.getExecTime(),searchResponse.getNumTask()));
                }

...
public class SubscribableListener<T> implements ActionListener<T> {
     ...
     * already complete then {@code fn} is invoked on the thread calling {@link #andThenCompleteWith} and in its thread context, but if this
     ...
     */
    public <U> SubscribableListener<U> andThenCompleteWith(CheckedFunction<T, U, Exception> fn) {

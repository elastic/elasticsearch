...
public class ReplicationOperation<
    ...
    private void markUnavailableShardsAsStale(ReplicaRequest replicaRequest, ReplicationGroup replicationGroup) {
        ...
        for (String allocationId : replicationGroup.getUnavailableInSyncShards()) {
            ...
            replicasProxy.markShardCopyAsStaleIfNeeded(replicaRequest.shardId(), allocationId, new ShardStateAction.Listener() {
                @Override
    ...
    private void performOnReplica(final ShardRouting shard, final ReplicaRequest replicaRequest,
        ...
        replicasProxy.performOn(shard, replicaRequest, globalCheckpoint, maxSeqNoOfUpdatesOrDeletes, new ActionListener<ReplicaResponse>() {
            ...
            public void onFailure(Exception replicaException) {
                ...
                replicasProxy.failShardIfNeeded(shard, message, replicaException, new ShardStateAction.Listener() {
                    @Override
                    public void onSuccess() {
                        decPendingAndFinishIfNeeded();
                    }
    ...
    public interface Replicas<RequestT extends ReplicationRequest<RequestT>> {
         ...
         */
        void failShardIfNeeded(ShardRouting replica, String message, Exception exception, ShardStateAction.Listener listener);
         ...
         * @param listener     a listener that will be notified when the failing shard has been removed from the in-sync set
         */
        void markShardCopyAsStaleIfNeeded(ShardId shardId, String allocationId, ShardStateAction.Listener listener);
    }

...
import static org.elasticsearch.bootstrap.ConsoleCtrlHandler.CTRL_CLOSE_EVENT;
...
class Elasticsearch {
     ...
     */
    static void initializeNatives(final boolean mlockAll, final boolean systemCallFilter, final boolean ctrlHandler) {
        ...
        if (ctrlHandler) {
            NativeAccess.instance().addConsoleCtrlHandler(code -> {

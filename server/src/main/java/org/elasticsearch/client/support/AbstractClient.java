...
public abstract class AbstractClient implements Client {
    ...
    static class IndicesAdmin implements IndicesAdminClient {
        ...
        @Override
        public ActionFuture<AnalyzeResponse> analyze(final AnalyzeAction.Request request) {
            return execute(AnalyzeAction.INSTANCE, request);
        }

        @Override
        public void analyze(final AnalyzeAction.Request request, final ActionListener<AnalyzeResponse> listener) {

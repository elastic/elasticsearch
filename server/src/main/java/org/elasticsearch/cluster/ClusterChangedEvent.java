...
public class ClusterChangedEvent {
    ...
    public Set<String> changedCustomMetadataSet() {
        ...
        Map<String, MetadataExtension> currentCustoms = state.metadata().customs();
        Map<String, MetadataExtension> previousCustoms = previousState.metadata().customs();
        if (currentCustoms.equals(previousCustoms) == false) {
            for (Map.Entry<String, MetadataExtension> currentCustomMetadata : currentCustoms.entrySet()) {
            ...
            for (Map.Entry<String, MetadataExtension> previousCustomMetadata : previousCustoms.entrySet()) {

...
/**
 * Record of a node's thread pool usage stats. Maps thread pool stats by thread pool name.
 *
...
public record NodeExecutionLoad(String nodeId, Map<String, ThreadPoolUsageStats> threadPoolUsageStatsMap) implements Writeable {
    ...
    public NodeExecutionLoad(StreamInput in) throws IOException {
    ...
    public boolean equals(Object o) {
        ...
        NodeExecutionLoad other = (NodeExecutionLoad) o;
    ...
    /**
     * Record representing an estimate of a node's thread pool usage.
     *

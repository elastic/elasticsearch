 ...
 * they are purged.
 */
public final class IndexGraveyard implements MetadataExtension {
    ...
    @Override
    public Diff<MetadataExtension> diff(final MetadataExtension previous) {
        return new IndexGraveyardDiff((IndexGraveyard) previous, this);
    }

    public static NamedDiff<MetadataExtension> readDiffFrom(final StreamInput in) throws IOException {
     ...
     */
    public static final class IndexGraveyardDiff implements NamedDiff<MetadataExtension> {
        ...
        @Override
        public IndexGraveyard apply(final MetadataExtension previous) {

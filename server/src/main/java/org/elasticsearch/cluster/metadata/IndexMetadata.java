...
public class IndexMetadata implements Diffable<IndexMetadata>, ToXContentFragment {
    ...
    public static IndexMetadata readFrom(StreamInput in, @Nullable Function<String, MappingMetadata> mappingLookup) throws IOException {
        ...
        if (mappingsSize == 1) {
            if (mappingLookup != null && in.getTransportVersion().onOrAfter(ProjectMetadata.MAPPINGS_AS_HASH_VERSION)) {
    ...
    public void writeTo(StreamOutput out, boolean mappingsAsHash) throws IOException {
        ...
        if (mapping == null) {
            ...
            out.writeVInt(1);
            if (mappingsAsHash && out.getTransportVersion().onOrAfter(ProjectMetadata.MAPPINGS_AS_HASH_VERSION)) {

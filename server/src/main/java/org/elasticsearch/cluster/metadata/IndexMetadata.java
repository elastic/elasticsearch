...
public class IndexMetadata implements Diffable<IndexMetadata>, ToXContentFragment {
    ...
    @Nullable
    private final boolean timeSeriesUseAutoGeneratedId;
    @Nullable
    ...
    private IndexMetadata(
        ...
        @Nullable final boolean timeSeriesUseAutoGeneratedId,
        ...
        this.timeSeriesUseAutoGeneratedId = timeSeriesUseAutoGeneratedId;
        this.stats = stats;
    ...
    IndexMetadata withMappingMetadata(MappingMetadata mapping) {
        ...
        return new IndexMetadata(
            ...
            this.timeSeriesEnd,
            this.timeSeriesUseAutoGeneratedId,
    ...
    public boolean getTimeSeriesUseAutoGeneratedId() {
        return timeSeriesUseAutoGeneratedId;
    }
    ...
    public static class Builder {
        ...
        IndexMetadata build(boolean repair) {
            ...
            return new IndexMetadata(
                ...
                isTsdb ? IndexSettings.TIME_SERIES_USE_AUTO_GENERATED_ID.get(settings) : false,

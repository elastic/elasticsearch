        ...
        submitUnbatchedTask(
            ...
            new AckedClusterStateUpdateTask(
                ...
                public ClusterState execute(ClusterState currentState) throws Exception {
                    ...
                    if (createdDataStream.getFailureComponent().getIndices().isEmpty() == false) {
                        firstFailureStoreRef.set(createdDataStream.getFailureComponent().getIndices().get(0).getName());
                    }
                    return clusterState;
                }
            }

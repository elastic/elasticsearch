...
public class MetadataUpdateSettingsService {
    ...
    private final ClusterStateTaskExecutor<MetadataUpdateSettingsTask> executor;
    ...
    public MetadataUpdateSettingsService(
        ...
        this.executor = new MetadataUpdateSettingsExecutor();
    }

    private class MetadataUpdateSettingsExecutor implements ClusterStateTaskExecutor<MetadataUpdateSettingsTask> {
        @Override
        public ClusterState execute(ClusterState currentState, List<TaskContext<MetadataUpdateSettingsTask>> taskContexts)
            ...
            for (final var taskContext : taskContexts) {
                try {
                    ...
                    state = updateSettings(state, task);
        ...
        private ClusterState updateSettings(ClusterState currentState, MetadataUpdateSettingsTask metadataUpdateSettingsTask) {
            UpdateSettingsClusterStateUpdateRequest request = metadataUpdateSettingsTask.request;
    ...
    record MetadataUpdateSettingsTask(UpdateSettingsClusterStateUpdateRequest request, ActionListener<AcknowledgedResponse> listener)
        implements
    ...
    public void updateSettings(final UpdateSettingsClusterStateUpdateRequest request, final ActionListener<AcknowledgedResponse> listener) {
        ...
        clusterService.submitStateUpdateTask(
            ...
            new MetadataUpdateSettingsTask(request, actionListener),

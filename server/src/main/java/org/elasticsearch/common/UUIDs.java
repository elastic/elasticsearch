...
public class UUIDs {
    ...
    private static final UUIDSource SOURCE = ExtensionLoader.loadSingleton(ServiceLoader.load(UUIDSource.class))
        .orElseGet(() -> new TimeBasedUUIDSource(DEFAULT_TIMESTAMP_SUPPLIER, DEFAULT_SEQUENCE_ID_SUPPLIER, DEFAULT_MAC_ADDRESS_SUPPLIER));
    ...
    public static String base64UUID() {
        return SOURCE.base64UUID();
    }

    public static String base64TimeBasedKOrderedUUIDWithHash(OptionalInt hash) {
        return SOURCE.base64TimeBasedKOrderedUUIDWithHash(hash);
    }

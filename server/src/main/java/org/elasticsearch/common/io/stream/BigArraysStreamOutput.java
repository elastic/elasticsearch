 ...
 */
public class BigArraysStreamOutput extends BytesStream implements Releasable {
    ...
    public BigArraysStreamOutput(BigArrays bigArrays) {
        this(PageCacheRecycler.PAGE_SIZE_IN_BYTES, bigArrays);
    }

    public BigArraysStreamOutput(int expectedSize, BigArrays bigArrays) {

...
public class Lucene {
    ...
    public static TopDocs readTopDocsWithoutMaxScore(StreamInput in) throws IOException {
    ...
    public static void writeTopDocsWithoutMaxScore(StreamOutput out, TopDocs topDocs) throws IOException {

...
public final class ClusterSettings extends AbstractScopedSettings {
    ...
    public static Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Set.of(
        ...
        RecoverySettings.MAX_BYTES_PER_SEC_USER_FACTOR_SETTING,
        RecoverySettings.MAX_BYTES_PER_SEC_USER_FACTOR_READS_SETTING,
        RecoverySettings.MAX_BYTES_PER_SEC_USER_FACTOR_WRITES_SETTING,
        RecoverySettings.MAX_BYTES_PER_SEC_OPERATOR_FACTOR_SETTING,
        RecoverySettings.MAX_BYTES_PER_SEC_OPERATOR_FACTOR_READS_SETTING,
        RecoverySettings.MAX_BYTES_PER_SEC_OPERATOR_FACTOR_WRITES_SETTING,
        RecoverySettings.NODE_DISK_AVAILABLE_WRITE_BANDWIDTH_SETTING,
        RecoverySettings.NODE_DISK_AVAILABLE_READ_BANDWIDTH_SETTING,
        RecoverySettings.NODE_NETWORK_AVAILABLE_BANDWIDTH_SETTING,

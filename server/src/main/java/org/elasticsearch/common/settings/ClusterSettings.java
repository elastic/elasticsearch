...
public final class ClusterSettings extends AbstractScopedSettings {
    ...
    public static final Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Stream.of(
        ...
        BalancedShardsAllocator.INDEXING_TIER_SHARD_BALANCE_FACTOR_SETTING,
        BalancedShardsAllocator.SEARCH_TIER_SHARD_BALANCE_FACTOR_SETTING,
        BalancedShardsAllocator.WRITE_LOAD_BALANCE_FACTOR_SETTING,
        BalancedShardsAllocator.INDEXING_TIER_WRITE_LOAD_BALANCE_FACTOR_SETTING,
        BalancedShardsAllocator.SEARCH_TIER_WRITE_LOAD_BALANCE_FACTOR_SETTING,

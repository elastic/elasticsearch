...
public final class ClusterSettings extends AbstractScopedSettings {
    ...
    public static final Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Stream.of(
        ...
        ThreadPoolMergeExecutorService.INDICES_MERGE_DISK_FLOOD_STAGE_WATERMARK_SETTING,
        ThreadPoolMergeExecutorService.INDICES_MERGE_DISK_FLOOD_STAGE_MAX_HEADROOM_SETTING,

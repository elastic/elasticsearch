...
public final class ClusterSettings extends AbstractScopedSettings {
    ...
    static {
        Set<Setting<?>> buildInClusterSettings = Set.of(
        ...
        Set<Setting<?>> behindFeatureFlag = HealthNode.isEnabled()
            ? Set.of(
                HealthNodeTaskExecutor.ENABLED_SETTING,
                HealthDiskThresholdSettings.CLUSTER_HEALTH_DISK_YELLOW_THRESHOLD_SETTING,
                HealthDiskThresholdSettings.CLUSTER_HEALTH_DISK_RED_THRESHOLD_SETTING
            )
            : Set.of();
        BUILT_IN_CLUSTER_SETTINGS = Sets.union(buildInClusterSettings, behindFeatureFlag);
    }
}

...
public final class IndexScopedSettings extends AbstractScopedSettings {
    ...
    private static final Set<Setting<?>> ALWAYS_ENABLED_BUILT_IN_INDEX_SETTINGS = Set.of(
        ...
        IndexModule.INDEX_STORE_USE_DIRECT_IO_FOR_MERGES_SETTING,
        IndexModule.INDEX_STORE_USE_DIRECT_IO_FOR_SNAPSHOTS_SETTING,
        IndexModule.INDEX_STORE_DIRECT_IO_DEFAULT_MERGE_BUFFER_SIZE_SETTING,
        IndexModule.INDEX_STORE_DIRECT_IO_DEFAULT_MIN_BYTES_DIRECT_SETTING,

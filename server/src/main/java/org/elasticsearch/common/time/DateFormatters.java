...
public class DateFormatters {
    ...
    private static final DateFormatter STRICT_DATE_OPTIONAL_TIME = new JavaDateFormatter(
        ...
        new JavaTimeDateTimeParser(STRICT_DATE_OPTIONAL_TIME_FORMATTER)
    );
    ...
    private static final DateFormatter STRICT_DATE_OPTIONAL_TIME_NANOS = new JavaDateFormatter(
        ...
        new JavaTimeDateTimeParser(STRICT_DATE_OPTIONAL_TIME_FORMATTER_WITH_NANOS)
    );
    ...
    private static final DateFormatter STRICT_BASIC_WEEK_DATE = new JavaDateFormatter(
        ...
        new JavaTimeDateTimePrinter(STRICT_BASIC_WEEK_DATE_PRINTER),
        new JavaTimeDateTimeParser(STRICT_BASIC_WEEK_DATE_FORMATTER)
    );
    ...
    private static final DateFormatter STRICT_HOUR_MINUTE_SECOND_MILLIS = new JavaDateFormatter(
        ...
        new JavaTimeDateTimePrinter(STRICT_HOUR_MINUTE_SECOND_MILLIS_PRINTER),
        new JavaTimeDateTimeParser(STRICT_HOUR_MINUTE_SECOND_MILLIS_FORMATTER)
    );
     ...
     * digit year and three digit dayOfYear (uuuu-DDD).
     */
    private static final DateFormatter ORDINAL_DATE = new JavaDateFormatter(
        "ordinal_date",
        new JavaTimeDateTimePrinter(ORDINAL_DATE_PRINTER),
        new JavaTimeDateTimeParser(ORDINAL_DATE_FORMATTER)
    );
    ...
    private static final DateFormatter DATE_HOUR = new JavaDateFormatter(
        "date_hour",
        new JavaTimeDateTimePrinter(DateTimeFormatter.ofPattern("uuuu-MM-dd'T'HH", Locale.ROOT)),
        new JavaTimeDateTimeParser(
            new DateTimeFormatterBuilder().append(DATE_FORMATTER)
                .appendLiteral("T")
                .appendValue(HOUR_OF_DAY, 1, 2, SignStyle.NOT_NEGATIVE)
    ...
    private static final DateFormatter DATE_HOUR_MINUTE = new JavaDateFormatter(
        "date_hour_minute",
        new JavaTimeDateTimePrinter(DateTimeFormatter.ofPattern("uuuu-MM-dd'T'HH:mm", Locale.ROOT)),
        new JavaTimeDateTimeParser(
            new DateTimeFormatterBuilder().append(DATE_FORMATTER)
                .appendLiteral("T")
    ...
    private static final DateFormatter BASIC_WEEK_DATE = new JavaDateFormatter(
        "basic_week_date",
        new JavaTimeDateTimePrinter(STRICT_BASIC_WEEK_DATE_PRINTER),
        new JavaTimeDateTimeParser(BASIC_WEEK_DATE_FORMATTER)
    );
    ...
    private static final DateFormatter DATE = new JavaDateFormatter(
        "date",
        new JavaTimeDateTimePrinter(DateTimeFormatter.ISO_LOCAL_DATE.withResolverStyle(ResolverStyle.STRICT)),
        new JavaTimeDateTimeParser(DATE_FORMATTER)
    );
    ...
    private static final DateFormatter DATE_TIME_NO_MILLIS = new JavaDateFormatter(
        "date_time_no_millis",
        new JavaTimeDateTimePrinter(DATE_TIME_NO_MILLIS_PRINTER),
        new JavaTimeDateTimeParser(
    ...
    private static final DateFormatter HOUR_MINUTE_SECOND_MILLIS = new JavaDateFormatter(
        ...
        new JavaTimeDateTimePrinter(STRICT_HOUR_MINUTE_SECOND_MILLIS_PRINTER),
        new JavaTimeDateTimeParser(HOUR_MINUTE_SECOND_MILLIS_FORMATTER)
    );

    private static final DateFormatter HOUR_MINUTE_SECOND_FRACTION = new JavaDateFormatter(
        "hour_minute_second_fraction",
        new JavaTimeDateTimePrinter(STRICT_HOUR_MINUTE_SECOND_MILLIS_PRINTER),
        new JavaTimeDateTimeParser(HOUR_MINUTE_SECOND_FRACTION_FORMATTER)
    );
    ...
    private static final DateFormatter HOUR_MINUTE = new JavaDateFormatter(
        "hour_minute",
        new JavaTimeDateTimePrinter(DateTimeFormatter.ofPattern("HH:mm", Locale.ROOT)),
        new JavaTimeDateTimeParser(HOUR_MINUTE_FORMATTER)
    );
    ...
    private static final DateFormatter HOUR_MINUTE_SECOND = new JavaDateFormatter(
        "hour_minute_second",
        new JavaTimeDateTimePrinter(STRICT_HOUR_MINUTE_SECOND_FORMATTER),
        new JavaTimeDateTimeParser(
    ...
    private static final DateFormatter HOUR = new JavaDateFormatter(
        "hour",
        new JavaTimeDateTimePrinter(DateTimeFormatter.ofPattern("HH", Locale.ROOT)),
        new JavaTimeDateTimeParser(
    ...
    private static final DateFormatter YEAR_MONTH_DAY = new JavaDateFormatter(
        "year_month_day",
        new JavaTimeDateTimePrinter(STRICT_YEAR_MONTH_DAY_FORMATTER),
        new JavaTimeDateTimeParser(
            new DateTimeFormatterBuilder().appendValue(ChronoField.YEAR)
                .appendLiteral("-")
                .appendValue(MONTH_OF_YEAR)
     ...
     * week of weekyear, and one digit day of week (YYYY-'W'ww-e).
     */
    private static final DateFormatter WEEK_DATE = new JavaDateFormatter(
        "week_date",
        new JavaTimeDateTimePrinter(ISO_WEEK_DATE),
        new JavaTimeDateTimeParser(WEEK_DATE_FORMATTER)
    );
    ...
    private static final DateFormatter WEEKYEAR_WEEK = new JavaDateFormatter(
        "weekyear_week",
        new JavaTimeDateTimePrinter(STRICT_WEEKYEAR_WEEK_FORMATTER),
        new JavaTimeDateTimeParser(
            new DateTimeFormatterBuilder().appendValue(WEEK_FIELDS_ROOT.weekBasedYear())
                .appendLiteral("-W")

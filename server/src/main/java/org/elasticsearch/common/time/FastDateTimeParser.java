...
class FastDateTimeParser implements DateTimeParser {
    ...
    private FastDateTimeParser(Engine parser, ZoneId timezone, Locale locale) {
        this.parser = parser;
    ...
    /**
     * Parses datetimes in ISO8601 format (and subsequences thereof), as well as some substantially similar
     * (but not technically 8601) formats.
     * <p>
    ...
    private static class Engine {
         ...
         */
        private static final int[] NANO_MULTIPLICANDS = new int[] {
            1,
            10,
            100,
            1_000,
        ...
        private ParseResult parse(CharSequence str, @Nullable ZoneId defaultTimezone) {
            ...
            if (checkDecimalSeparator(str.charAt(19)) == false || maxAllowedField == ChronoField.SECOND_OF_MINUTE) return ParseResult.error(
                19
            );

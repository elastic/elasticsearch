...
public enum FormatNames {
    ...
    STRICT_DATE_OPTIONALTIME_NANOS("strictDateOptionalTimeNanos", "strict_date_optional_time_nanos"),
    ...
    STRICTT_TIME("strictTTime", "strict_t_time"),
    ...
    STRICT_WEEK_YEAR("strictWeekyear", "strict_weekyear"),

...
public class SizeValue implements Writeable, Comparable<SizeValue> {
    ...
    public static SizeValue parseSizeValue(String sValue) throws ParsingException {
        return parseSizeValue(sValue, null);
    }

    public static SizeValue parseSizeValue(String sValue, SizeValue defaultValue) throws ParsingException {
        if (sValue == null) {
            return defaultValue;
        }
        long singles;

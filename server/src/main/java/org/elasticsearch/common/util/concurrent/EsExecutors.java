...
public class EsExecutors {
     ...
     * available to Elasticsearch (e.g., because of CPU limits). Note that this setting accepts floating point processors, so it should not
     * be used directly, use always {@link EsExecutors#allocatedProcessors(Settings)} to obtain a rounded number of processors.
     */

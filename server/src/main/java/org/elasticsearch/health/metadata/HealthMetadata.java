    ...
    public record Disk(
        ...
        public static final ConstructingObjectParser<Disk, Void> PARSER = new ConstructingObjectParser<>(
            ...
            (args) -> new Disk(
                ...
                ByteSizeValue.parseBytesSizeValue((String) args[1], HIGH_MAX_HEADROOM_FIELD.getPreferredName()),
                RelativeByteSizeValue.parseRelativeByteSizeValue((String) args[2], FLOOD_STAGE_WATERMARK_FIELD.getPreferredName()),
                ByteSizeValue.parseBytesSizeValue((String) args[3], FLOOD_STAGE_MAX_HEADROOM_FIELD.getPreferredName()),
                RelativeByteSizeValue.parseRelativeByteSizeValue((String) args[4], FROZEN_FLOOD_STAGE_WATERMARK_FIELD.getPreferredName()),
                ByteSizeValue.parseBytesSizeValue((String) args[5], FROZEN_FLOOD_STAGE_MAX_HEADROOM_FIELD.getPreferredName())
            )
        );
        ...
        public static class Builder {
            ...
            Disk.Builder highMaxHeadroom(ByteSizeValue highMaxHeadroom) {
                this.highMaxHeadroom = highMaxHeadroom;
                return this;
            }

            Disk.Builder highMaxHeadroom(String highMaxHeadroom, String setting) {
            ...
            Disk.Builder floodStageMaxHeadroom(ByteSizeValue floodStageMaxHeadroom) {
                this.floodStageMaxHeadroom = floodStageMaxHeadroom;
                return this;
            }

            Disk.Builder floodStageMaxHeadroom(String floodStageMaxHeadroom, String setting) {

...
public enum IndexMode {
    STANDARD("standard") {
        ...
        @Override
        public IdFieldMapper idFieldMapperWithoutFieldData(boolean autoGeneratedId) {
            return ProvidedIdFieldMapper.NO_FIELD_DATA;
        }

        @Override
        public IdFieldMapper buildIdFieldMapper(boolean autoGenerateId, BooleanSupplier fieldDataEnabled) {
    ...
    TIME_SERIES("time_series") {
        ...
        public IdFieldMapper idFieldMapperWithoutFieldData(boolean autoGeneratedId) {
            return autoGeneratedId ? ProvidedIdFieldMapper.NO_FIELD_DATA : TsidExtractingIdFieldMapper.INSTANCE;
        }

        @Override
        public IdFieldMapper buildIdFieldMapper(boolean autoGenerateId, BooleanSupplier fieldDataEnabled) {
            // We don't support field data on TSDB's _id
            return autoGenerateId ? ProvidedIdFieldMapper.NO_FIELD_DATA : TsidExtractingIdFieldMapper.INSTANCE;
        }
     ...
     */
    public abstract IdFieldMapper buildIdFieldMapper(boolean autoGenerateId, BooleanSupplier fieldDataEnabled);

    /**
     * Get the singleton {@link FieldMapper} for {@code _id}. It can never support
     * field data.
     */
    public abstract IdFieldMapper idFieldMapperWithoutFieldData(boolean autoGeneratedId);

...
public class IndexService extends AbstractIndexComponent implements IndicesClusterStateService.AllocatedIndex<IndexShard> {
     ...
     */
    public QueryShardContext newQueryShardContext(int shardId, IndexSearcher indexSearcher, LongSupplier nowInMillis, String clusterAlias) {
        return new QueryShardContext(
            shardId, indexSettings, bigArrays, indexCache.bitsetFilterCache(), indexFieldData::getForField, mapperService(),
            similarityService(), scriptService, xContentRegistry, namedWriteableRegistry, client, indexSearcher, nowInMillis, clusterAlias);
    }

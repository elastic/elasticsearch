...
public class IndexVersions {
    ...
    // Lucene drops Version.LUCENE_N_* constants two majors later. Parse historical 8.x / 9.x
    // versions so V7 / V8 IndexVersion rows keep the Lucene version those indices were written with.
    ...
    public static final IndexVersion V_8_5_3 = def(8_05_03_99, parseUnchecked("9.4.2"));
    ...
    public static final IndexVersion NEW_INDEXVERSION_FORMAT = def(8_501_0_00, parseUnchecked("9.9.1"));
    public static final IndexVersion UPGRADE_LUCENE_9_9_2 = def(8_502_0_00, parseUnchecked("9.9.2"));
    public static final IndexVersion TIME_SERIES_ID_HASHING = def(8_502_0_01, parseUnchecked("9.9.2"));
    public static final IndexVersion UPGRADE_TO_LUCENE_9_10 = def(8_503_0_00, parseUnchecked("9.10.0"));
    public static final IndexVersion TIME_SERIES_ROUTING_HASH_IN_ID = def(8_504_0_00, parseUnchecked("9.10.0"));
    public static final IndexVersion DEFAULT_DENSE_VECTOR_TO_INT8_HNSW = def(8_505_0_00, parseUnchecked("9.10.0"));
    public static final IndexVersion DOC_VALUES_FOR_IGNORED_META_FIELD = def(8_505_0_01, parseUnchecked("9.10.0"));
    public static final IndexVersion SOURCE_MAPPER_LOSSY_PARAMS_CHECK = def(8_506_0_00, parseUnchecked("9.10.0"));
    public static final IndexVersion SEMANTIC_TEXT_FIELD_TYPE = def(8_507_0_00, parseUnchecked("9.10.0"));
    public static final IndexVersion UPGRADE_TO_LUCENE_9_11 = def(8_508_0_00, parseUnchecked("9.11.0"));
    public static final IndexVersion UNIQUE_TOKEN_FILTER_POS_FIX = def(8_509_0_00, parseUnchecked("9.11.0"));
    public static final IndexVersion ADD_SECURITY_MIGRATION = def(8_510_0_00, parseUnchecked("9.11.0"));
    public static final IndexVersion UPGRADE_TO_LUCENE_9_11_1 = def(8_511_0_00, parseUnchecked("9.11.1"));
    public static final IndexVersion INDEX_SORTING_ON_NESTED = def(8_512_0_00, parseUnchecked("9.11.1"));
    public static final IndexVersion LENIENT_UPDATEABLE_SYNONYMS = def(8_513_0_00, parseUnchecked("9.11.1"));
    public static final IndexVersion ENABLE_IGNORE_MALFORMED_LOGSDB = def(8_514_0_00, parseUnchecked("9.11.1"));
    public static final IndexVersion MERGE_ON_RECOVERY_VERSION = def(8_515_0_00, parseUnchecked("9.11.1"));
    public static final IndexVersion UPGRADE_TO_LUCENE_9_12 = def(8_516_0_00, parseUnchecked("9.12.0"));
    public static final IndexVersion ENABLE_IGNORE_ABOVE_LOGSDB = def(8_517_0_00, parseUnchecked("9.12.0"));
    public static final IndexVersion ADD_ROLE_MAPPING_CLEANUP_MIGRATION = def(8_518_0_00, parseUnchecked("9.12.0"));
    public static final IndexVersion LOGSDB_DEFAULT_IGNORE_DYNAMIC_BEYOND_LIMIT_BACKPORT = def(8_519_0_00, parseUnchecked("9.12.0"));
    public static final IndexVersion TIME_BASED_K_ORDERED_DOC_ID_BACKPORT = def(8_520_0_00, parseUnchecked("9.12.0"));
    public static final IndexVersion V8_DEPRECATE_SOURCE_MODE_MAPPER = def(8_521_0_00, parseUnchecked("9.12.0"));
    public static final IndexVersion USE_SYNTHETIC_SOURCE_FOR_RECOVERY_BACKPORT = def(8_522_0_00, parseUnchecked("9.12.0"));

...
public final class SearchSlowLog implements SearchOperationListener {
    ...
    static final class SearchSlowLogMessage {
        ...
        private static Map<String, Object> prepareMap(SearchContext context, long tookInNanos) {
            ...
            if (context.queryResult().getSingleQueryResults().get(0).getTotalHits() != null) { // TODO: multi query?
                messageFields.put("elasticsearch.slowlog.total_hits", context.queryResult().getSingleQueryResults().get(0).getTotalHits());
            } else {

...
public class PerFieldMapperCodecDefaultCompression extends Elasticsearch93DefaultCompressionLucene103 {
    private final PerFieldFormatSupplier formatSupplier;

    public PerFieldMapperCodecDefaultCompression(Lucene103Codec.Mode compressionMode, MapperService mapperService, BigArrays bigArrays) {
        super(compressionMode);
        this.formatSupplier = new PerFieldFormatSupplier(mapperService, bigArrays, new ESLucene90StoredFieldsFormat(compressionMode));

 ...
 *       <p>When the postings are long enough, Lucene84PostingsFormat will try to encode most
 ...
 *             DocFreq is not smaller than SkipMinimum (i.e. 128 in Lucene84PostingsFormat).
 ...
 *             However, in Lucene84PostingsFormat, the skip data is saved for
...
public class Lucene84PostingsFormat extends PostingsFormat {
    ...
    static final String TERMS_CODEC = "Lucene84PostingsWriterTerms";
    static final String DOC_CODEC = "Lucene84PostingsWriterDoc";
    static final String POS_CODEC = "Lucene84PostingsWriterPos";
    static final String PAY_CODEC = "Lucene84PostingsWriterPay";

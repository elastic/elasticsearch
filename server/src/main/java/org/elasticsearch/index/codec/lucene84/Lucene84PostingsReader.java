...
import static org.elasticsearch.index.codec.lucene84.ForUtil.BLOCK_SIZE;
import static org.elasticsearch.index.codec.lucene84.Lucene84PostingsFormat.DOC_CODEC;
import static org.elasticsearch.index.codec.lucene84.Lucene84PostingsFormat.MAX_SKIP_LEVELS;
import static org.elasticsearch.index.codec.lucene84.Lucene84PostingsFormat.PAY_CODEC;
import static org.elasticsearch.index.codec.lucene84.Lucene84PostingsFormat.POS_CODEC;
import static org.elasticsearch.index.codec.lucene84.Lucene84PostingsFormat.TERMS_CODEC;
import static org.elasticsearch.index.codec.lucene84.Lucene84PostingsFormat.VERSION_COMPRESSED_TERMS_DICT_IDS;
import static org.elasticsearch.index.codec.lucene84.Lucene84PostingsFormat.VERSION_CURRENT;
import static org.elasticsearch.index.codec.lucene84.Lucene84PostingsFormat.VERSION_START;
...
public final class Lucene84PostingsReader extends PostingsReaderBase {
    ...
    public void init(IndexInput termsIn, SegmentReadState state) throws IOException {
        ...
        if (indexBlockSize != ForUtil.BLOCK_SIZE) {
            throw new IllegalStateException(
                "index-time BLOCK_SIZE (" + indexBlockSize + ") != read-time BLOCK_SIZE (" + ForUtil.BLOCK_SIZE + ")"
            );
        }
    }
        ...
        public int advance(int target) throws IOException {
            ...
            if (docFreq > BLOCK_SIZE && target > nextSkipDoc) {
                ...
                if (skipper == null) {
                    ...
                    skipper = new Lucene84SkipReader(docIn.clone(), MAX_SKIP_LEVELS, indexHasPos, indexHasOffsets, indexHasPayloads);
                }
    ...
    final class EverythingEnum extends PostingsEnum {
        ...
        public int advance(int target) throws IOException {
            if (target > nextSkipDoc) {
                if (skipper == null) {
                    // Lazy init: first time this enum has ever been used for skipping
                    skipper = new Lucene84SkipReader(docIn.clone(), MAX_SKIP_LEVELS, true, indexHasOffsets, indexHasPayloads);
                }
    ...
    final class BlockImpactsDocsEnum extends ImpactsEnum {
        ...
        public BlockImpactsDocsEnum(FieldInfo fieldInfo, IntBlockTermState termState) throws IOException {
            ...
            skipper = new Lucene84ScoreSkipReader(docIn.clone(), MAX_SKIP_LEVELS, indexHasPositions, indexHasOffsets, indexHasPayloads);
            skipper.init(
    ...
    final class BlockImpactsPostingsEnum extends ImpactsEnum {
        ...
        public BlockImpactsPostingsEnum(FieldInfo fieldInfo, IntBlockTermState termState) throws IOException {
            ...
            skipper = new Lucene84ScoreSkipReader(docIn.clone(), MAX_SKIP_LEVELS, true, indexHasOffsets, indexHasPayloads);
    ...
    final class BlockImpactsEverythingEnum extends ImpactsEnum {
        ...
        public BlockImpactsEverythingEnum(FieldInfo fieldInfo, IntBlockTermState termState, int flags) throws IOException {
            ...
            skipper = new Lucene84ScoreSkipReader(docIn.clone(), MAX_SKIP_LEVELS, indexHasPos, indexHasOffsets, indexHasPayloads);
            skipper.init(docTermStartFP + termState.skipOffset, docTermStartFP, posTermStartFP, payTermStartFP, docFreq);

...
public class ES817TSDBDocValuesFormat extends org.apache.lucene.codecs.DocValuesFormat {
    ...
    static final String CODEC_NAME = "ES817TSDB";
    static final String DATA_CODEC = "ES817TSDBDocValuesData";
    static final String DATA_EXTENSION = "dvd";
    static final String META_CODEC = "ES817TSDBDocValuesMetadata";
    ...
    public DocValuesConsumer fieldsConsumer(SegmentWriteState state) throws IOException {
        return new ES817TSDBDocValuesConsumer(state, skipIndexIntervalSize, DATA_CODEC, DATA_EXTENSION, META_CODEC, META_EXTENSION);
    }

    @Override
    public DocValuesProducer fieldsProducer(SegmentReadState state) throws IOException {
        return new ES817TSDBDocValuesProducer(state, DATA_CODEC, DATA_EXTENSION, META_CODEC, META_EXTENSION);
    }
}

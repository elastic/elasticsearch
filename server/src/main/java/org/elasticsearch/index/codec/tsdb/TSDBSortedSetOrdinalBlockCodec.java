...
/**
 * Baseline {@link SortedSetOrdinalBlockCodec} that encodes SORTED_SET ordinal value blocks with
 ...
 */
public class TSDBSortedSetOrdinalBlockCodec implements SortedSetOrdinalBlockCodec {

    /** Creates a new codec that uses {@link TSDBDocValuesEncoder} for block encoding. */
    public TSDBSortedSetOrdinalBlockCodec() {}

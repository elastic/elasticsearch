...
public class TSDBSyntheticIdPostingsFormat extends PostingsFormat {
    ...
    public FieldsProducer fieldsProducer(SegmentReadState state) throws IOException {
        ...
        try {
            ...
            BloomFilter bloomFilter = BloomFilter.maybeGetBloomFilterForField(IdFieldMapper.NAME, state);
            ...
            success = true;
            return bloomFilter == null ? fieldsProducer : new BloomFilterFieldsProducer(fieldsProducer, bloomFilter);
        } finally {
            if (success == false) {

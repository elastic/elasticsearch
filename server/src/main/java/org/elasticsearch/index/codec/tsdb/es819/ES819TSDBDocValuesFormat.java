...
public class ES819TSDBDocValuesFormat extends org.apache.lucene.codecs.DocValuesFormat {
    ...
    static final int VERSION_BINARY_DV_COMPRESS_OFFSETS_USING_BIT_PACKING = 3;
    static final int VERSION_CURRENT = VERSION_BINARY_DV_COMPRESS_OFFSETS_USING_BIT_PACKING;

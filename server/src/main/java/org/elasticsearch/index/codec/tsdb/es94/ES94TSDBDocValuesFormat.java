 ...
 * </ul>
 */
public class ES94TSDBDocValuesFormat extends org.apache.lucene.codecs.DocValuesFormat {
    ...
    static final String OPTIMIZED_MERGE_ENABLED_NAME = ES94TSDBDocValuesConsumer.class.getName() + ".enableOptimizedMerge";
    ...
    public ES94TSDBDocValuesFormat(BinaryDVCompressionMode binaryDVCompressionMode) {
        this(
            DEFAULT_SKIP_INDEX_INTERVAL_SIZE,
            ORDINAL_RANGE_ENCODING_MIN_DOC_PER_ORDINAL,
            OPTIMIZED_MERGE_ENABLE_DEFAULT,
    ...
    public ES94TSDBDocValuesFormat(BinaryDVCompressionMode binaryDVCompressionMode, boolean enablePerBlockCompression) {
        this(
            DEFAULT_SKIP_INDEX_INTERVAL_SIZE,
            ORDINAL_RANGE_ENCODING_MIN_DOC_PER_ORDINAL,
            OPTIMIZED_MERGE_ENABLE_DEFAULT,

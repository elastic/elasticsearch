...
final class ES94TSDBDocValuesProducer extends DocValuesProducer {
    ...
    ES94TSDBDocValuesProducer(SegmentReadState state, String dataCodec, String dataExtension, String metaCodec, String metaExtension)
        ...
        int version = -1;
        int blockShift = ES94TSDBDocValuesFormat.NUMERIC_BLOCK_SHIFT;
        ...
        try (ChecksumIndexInput in = state.directory.openChecksumInput(metaName)) {
            ...
            try {
                version = CodecUtil.checkIndexHeader(
                    in,
                    metaCodec,
                    ES94TSDBDocValuesFormat.VERSION_START,
                    ES94TSDBDocValuesFormat.VERSION_CURRENT,
    ...
    private ES94TSDBDocValuesProducer(

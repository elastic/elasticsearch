 ...
 *
 * <p>Ordinal fields are encoded with the format-level block size and carry no per-field block
 * metadata. An in-development version once wrote a per-field {@code blockShift} byte here, removed
 * at {@link org.elasticsearch.index.codec.tsdb.TSDBDocValuesFormatConfig#VERSION_REMOVE_ORDINAL_BLOCK_SHIFT}.
 */

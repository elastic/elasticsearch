...
public final class AlpDoubleDecodeStage implements PayloadDecoder {
    ...
    public AlpDoubleDecodeStage(int blockSize) {
    ...
    // Packed data is bulk-decoded first, then exceptions overwrite specific
    // positions in-place — no separate exception buffer needed.
    @Override
    public int decode(final long[] values, final DataInput in, final DecodingContext context) throws IOException {
        ...
        if (mode == MODE_RAW) {
            ...
            throw new IOException("Unknown AlpDouble mode: 0x" + Integer.toHexString(mode));
        }
    }
    ...
    public boolean equals(Object o) {
        return this == o || (o instanceof AlpDoubleDecodeStage that && blockSize == that.blockSize);
    }
    ...
    public String toString() {
        return "AlpDoubleDecodeStage{blockSize=" + blockSize + "}";
    }
}

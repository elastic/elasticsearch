...
public final class FpcDoubleTransformDecodeStage implements TransformDecoder {
    ...
    public FpcDoubleTransformDecodeStage(int blockSize) {
        this(blockSize, FpcDoubleTransformEncodeStage.DEFAULT_TABLE_SIZE);
    }

    public FpcDoubleTransformDecodeStage(int blockSize, int tableSize) {
    ...
    // Each selector bit selects FCM (0) or DFCM (1) prediction. The decoder maintains
    ...
    public int decode(final long[] values, int valueCount, final DecodingContext context) throws IOException {
        ...
        final long firstValue = metadata.readLong();
    ...
    public static int decodeStatic(
        final FpcDoubleTransformDecodeStage stage,
        final long[] values,
        int valueCount,
    ...
    public boolean equals(Object o) {
        return this == o || (o instanceof FpcDoubleTransformDecodeStage that && tableMask == that.tableMask);
    }
    ...
    public String toString() {
        return "FpcDoubleTransformDecodeStage{tableSize=" + (tableMask + 1) + "}";
    }
}

...
import static org.elasticsearch.index.codec.vectors.es910.ES910BinaryQuantizedVectorsFormat.VERSION_START;

/**
 * Copied from Lucene, replace with Lucene's implementation sometime after Lucene 10
 */
@SuppressForbidden(reason = "Lucene classes")
public class ES910BinaryQuantizedVectorsReader extends FlatVectorsReader implements OffHeapStats {

    private static final long SHALLOW_SIZE = RamUsageEstimator.shallowSizeOfInstance(ES910BinaryQuantizedVectorsReader.class);

    private final Map<String, FieldEntry> fields = new HashMap<>();
    private final IndexInput quantizedVectorData;
    private final FlatVectorsReader rawVectorsReader;
    private final ES910BinaryFlatVectorsScorer vectorScorer;

    @SuppressWarnings("this-escape")
    ES910BinaryQuantizedVectorsReader(
    ...
    static void validateFieldEntry(FieldInfo info, FieldEntry fieldEntry) {
        ...
        long numQuantizedVectorBytes = Math.multiplyExact((dimension + (Float.BYTES * 3) + Short.BYTES), (long) fieldEntry.size);

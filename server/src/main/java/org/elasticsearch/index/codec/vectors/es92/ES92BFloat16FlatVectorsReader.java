...
public final class ES92BFloat16FlatVectorsReader extends FlatVectorsReader {

    private static final long SHALLOW_SIZE = RamUsageEstimator.shallowSizeOfInstance(ES92BFloat16FlatVectorsReader.class);
        ...
        try (ChecksumIndexInput meta = state.directory.openChecksumInput(metaFileName)) {
            ...
            try {
                versionMeta = CodecUtil.checkIndexHeader(
                    ...
                    ES92BFloat16FlatVectorsFormat.VERSION_START,
    ...
    public long ramBytesUsed() {
        return ES92BFloat16FlatVectorsReader.SHALLOW_SIZE + fields.ramBytesUsed();
    }

    @Override
    public Map<String, Long> getOffHeapByteSize(FieldInfo fieldInfo) {
        final FieldEntry entry = getFieldEntryOrThrow(fieldInfo.name);
        return Map.of(ES92BFloat16FlatVectorsFormat.VECTOR_DATA_EXTENSION, entry.vectorDataLength());
    }

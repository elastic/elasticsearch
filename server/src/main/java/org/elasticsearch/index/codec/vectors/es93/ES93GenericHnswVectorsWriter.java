...
import static org.elasticsearch.index.codec.vectors.es93.ES93GenericHnswVectorsFormat.DIRECT_MONOTONIC_BLOCK_SHIFT;
...
import static org.elasticsearch.index.codec.vectors.es93.ES93GenericHnswVectorsReader.SIMILARITY_FUNCTIONS;

public final class ES93GenericHnswVectorsWriter extends KnnVectorsWriter {

    private static final long SHALLOW_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ES93GenericHnswVectorsWriter.class);
    ...
    public ES93GenericHnswVectorsWriter(
        ...
        this(state, M, beamWidth, flatVectorFormatName, flatVectorWriter, numMergeWorkers, mergeExec, VERSION_CURRENT);
    }

    // Test-only constructor, should not be called directly outside of tests.
    ES93GenericHnswVectorsWriter(
        SegmentWriteState state,
        int M,
        int beamWidth,
        String flatVectorFormatName,
        ...
        this.M = M;
        this.flatVectorFormatName = flatVectorFormatName;
    ...
    public void mergeOneField(FieldInfo fieldInfo, MergeState mergeState) throws IOException {
        ...
        try {
            ...
            // we use Lucene104HnswVectorsReader.DenseOffHeapVectorValues for the graph construction
            ...
            if (scorerSupplier.totalVectorCount() > 0) {
                ...
                switch (fieldInfo.getVectorEncoding()) {
                    case BYTE -> mergedVectorValues = MergedVectorValues.mergeByteVectorValues(fieldInfo, mergeState);
                    case FLOAT32 -> mergedVectorValues = MergedVectorValues.mergeFloatVectorValues(fieldInfo, mergeState);
                }

...
public abstract class Engine implements Closeable {
    ...
    public abstract static class Operation {
        ...
        public enum Origin {
            ...
            public boolean skipTranslog() {
                return this == LOCAL_TRANSLOG_RECOVERY || this == LOCAL_REINDEX;
            }

            public boolean isPrimary() {
                return this == PRIMARY || this == LOCAL_REINDEX;
            }
        }
    ...
    public static class Index extends Operation {
        ...
        public Index(Term uid, ParsedDocument doc, long seqNo, long primaryTerm, long version, VersionType versionType, Origin origin,
            ...
            assert (origin.isPrimary()) == (versionType != null) : "invalid version_type=" + versionType + " for origin=" + origin;
            this.doc = doc;

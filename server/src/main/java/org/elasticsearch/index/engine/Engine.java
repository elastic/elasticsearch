...
public abstract class Engine implements Closeable {
    ...
    /**
     * Read-only view over a single index operation. Implemented by both {@link Index} (row path) and
     * the positioned {@link IndexOperationBatch.OpView} cursor (columnar batch path). Provides the
     * fields that planning and helper methods need without coupling them to {@link ParsedDocument}.
     */
    public interface IndexOpView {
        BytesRef uid();
        ...
        long getAutoGeneratedIdTimestamp();
    ...
    public static class Index extends Operation implements Engine.IndexOpView {
        ...
        public int reservingDocs() {
            return this.doc.docs().size();
        }

        @Override
        public String documentDescription() {
            return this.doc.documentDescription();
        }
    }

 ...
 */
final class RamAccountingDirectoryReaderConsumer implements BiConsumer<DirectoryReader, DirectoryReader> {

    private final CircuitBreakerService breakerService;

    RamAccountingDirectoryReaderConsumer(CircuitBreakerService breakerService) {

        ...
        return new TranslogOperationAsserter() {
            ...
            public boolean assertSameIndexOperation(Translog.Index o1, Translog.Index o2) throws IOException {
                ...
                if (engineConfig.getIndexSettings().isRecoverySourceSyntheticEnabled()
                    ...
                    // Synthesize both sides to handle mixed-cluster scenarios where the same vector may arrive in
                    // different encodings (e.g. hex string vs byte array) depending on whether the op came via
                    // replication from a new primary or recovery from an old primary.

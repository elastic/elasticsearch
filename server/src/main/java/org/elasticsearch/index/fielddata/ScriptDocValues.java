...
public abstract class ScriptDocValues<T> extends AbstractList<T> {
     ...
     * convert them to wrappers around {@link DocValuesScriptFieldSource}.
     * This allows for different {@link DocValuesScriptFieldSource} to implement
     * this supplier class in many-to-one relationship since
     * {@link DocValuesScriptFieldSource} are more specific where

...
public abstract class AbstractLatLonPointIndexFieldData implements IndexGeoPointFieldData {
    ...
    public static class LatLonPointIndexFieldData extends AbstractLatLonPointIndexFieldData {
        ...
        public LeafGeoPointFieldData load(LeafReaderContext context) {
            ...
            return new LatLonPointDVLeafFieldData(reader, fieldName, toScriptFieldSource);
        }
    ...
    public static class Builder implements IndexFieldData.Builder {
        ...
        public Builder(String name, ValuesSourceType valuesSourceType, ToScriptFieldSource<MultiGeoPointValues> toScriptFieldSource) {
            this.name = name;
            this.valuesSourceType = valuesSourceType;
            this.toScriptFieldSource = toScriptFieldSource;
        }
        ...
        public IndexFieldData<?> build(IndexFieldDataCache cache, CircuitBreakerService breakerService) {
            // ignore breaker
            return new LatLonPointIndexFieldData(name, valuesSourceType, toScriptFieldSource);
        }
    }
}

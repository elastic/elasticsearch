...
public class SortedSetOrdinalsIndexFieldData extends AbstractIndexOrdinalsFieldData {
    ...
    public static class Builder implements IndexFieldData.Builder {
        ...
        public Builder(String name, ValuesSourceType valuesSourceType, ToScriptFieldSource<SortedSetDocValues> toScriptFieldSource) {
            this.name = name;
        ...
        public SortedSetOrdinalsIndexFieldData build(IndexFieldDataCache cache, CircuitBreakerService breakerService) {
            return new SortedSetOrdinalsIndexFieldData(cache, name, valuesSourceType, breakerService, toScriptFieldSource);
        }
    }
    ...
    public LeafOrdinalsFieldData load(LeafReaderContext context) {
        return new SortedSetBytesLeafFieldData(context.reader(), getFieldName(), toScriptFieldSource);
    }

...
public abstract class AbstractGeometryFieldMapper<Parsed, Processed> extends FieldMapper {
    ...
    public abstract static class AbstractGeometryFieldType extends MappedFieldType {
        ...
        @Override
        public final ValueFetcher valueFetcher(SearchFields searchFields, SearchLookup searchLookup, String format) {
            ...
            if (parsesArrayValue) {
                return new ArraySourceValueFetcher(name(), searchFields) {
                    @Override

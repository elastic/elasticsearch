 ...
 */
public abstract class BaseGeometryFieldMapper extends FieldMapper {
    ...
    public abstract static class Builder<T extends Builder, Y extends BaseGeometryFieldMapper>
        ...
        protected void setupFieldType(BuilderContext context) {
            ...
            BaseGeometryFieldType ft = (BaseGeometryFieldType) fieldType();
    ...
    public abstract static class TypeParser implements Mapper.TypeParser {
        ...
        protected abstract boolean parseXContentParameters(String name, Map.Entry<String, Object> entry,
    ...
    public abstract static class BaseGeometryFieldType extends MappedFieldType {
        protected Orientation orientation = Defaults.ORIENTATION.value();

        protected BaseGeometryFieldType() {
        ...
        protected BaseGeometryFieldType(BaseGeometryFieldType ref) {
            super(ref);
        ...
        public boolean equals(Object o) {
            ...
            BaseGeometryFieldType that = (BaseGeometryFieldType) o;
    ...
    protected BaseGeometryFieldMapper(String simpleName, MappedFieldType fieldType, MappedFieldType defaultFieldType,
        ...
        this.ignoreMalformed = ignoreMalformed;
        this.ignoreZValue = ignoreZValue;
        this.geometryParser = new GeometryParser(orientation() == ShapeBuilder.Orientation.RIGHT, coerce().value(), ignoreZValue.value());
    }

    @Override
    protected void doMerge(Mapper mergeWith) {
        super.doMerge(mergeWith);
        BaseGeometryFieldMapper gsfm = (BaseGeometryFieldMapper)mergeWith;
    ...
    public Orientation orientation() {
        return ((BaseGeometryFieldType)fieldType).orientation();
    }
}

...
public enum BasicRangeType implements RangeType {
    ...
    FLOAT("float_range", LengthType.FIXED_4, NumberFieldMapper.NumberType.FLOAT) {
        ...
        public Query withinQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Float) from, (Float) to, includeFrom, includeTo,
                    (f, t) -> FloatRange.newWithinQuery(field, new float[] { f }, new float[] { t }), BasicRangeType.FLOAT);
        }
        @Override
        public Query containsQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Float) from, (Float) to, includeFrom, includeTo,
                    (f, t) -> FloatRange.newContainsQuery(field, new float[] { f }, new float[] { t }), BasicRangeType.FLOAT);
        }
        @Override
        public Query intersectsQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Float) from, (Float) to, includeFrom, includeTo,
                    (f, t) -> FloatRange.newIntersectsQuery(field, new float[] { f }, new float[] { t }), BasicRangeType.FLOAT);
        }
    },
    DOUBLE("double_range", LengthType.FIXED_8, NumberFieldMapper.NumberType.DOUBLE) {
        ...
        public Query withinQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Double) from, (Double) to, includeFrom, includeTo,
                    (f, t) -> DoubleRange.newWithinQuery(field, new double[] { f }, new double[] { t }), BasicRangeType.DOUBLE);
        }
        @Override
        public Query containsQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Double) from, (Double) to, includeFrom, includeTo,
                    (f, t) -> DoubleRange.newContainsQuery(field, new double[] { f }, new double[] { t }), BasicRangeType.DOUBLE);
        }
        @Override
        public Query intersectsQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Double) from, (Double) to, includeFrom, includeTo,
                    (f, t) -> DoubleRange.newIntersectsQuery(field, new double[] { f }, new double[] { t }), BasicRangeType.DOUBLE);
        }
    ...
    INTEGER("integer_range", LengthType.VARIABLE, NumberFieldMapper.NumberType.INTEGER) {
        ...
        public Query withinQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Integer) from, (Integer) to, includeFrom, includeTo,
                    (f, t) -> IntRange.newWithinQuery(field, new int[] { f }, new int[] { t }), BasicRangeType.INTEGER);
        }
        @Override
        public Query containsQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field,  (Integer) from,  (Integer) to, includeFrom, includeTo,
                    (f, t) -> IntRange.newContainsQuery(field, new int[] { f }, new int[] { t }), BasicRangeType.INTEGER);
        }
        @Override
        public Query intersectsQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field,  (Integer) from,  (Integer) to, includeFrom, includeTo,
                    (f, t) -> IntRange.newIntersectsQuery(field, new int[] { f }, new int[] { t }), BasicRangeType.INTEGER);
        }
    },
    LONG("long_range", LengthType.VARIABLE, NumberFieldMapper.NumberType.LONG) {
        ...
        public Query withinQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Long) from, (Long) to, includeFrom, includeTo,
                    (f, t) -> LongRange.newWithinQuery(field, new long[] { f }, new long[] { t }), BasicRangeType.LONG);
        }
        @Override
        public Query containsQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Long) from, (Long) to, includeFrom, includeTo,
                    (f, t) -> LongRange.newContainsQuery(field, new long[] { f }, new long[] { t }), BasicRangeType.LONG);
        }
        @Override
        public Query intersectsQuery(String field, Object from, Object to, boolean includeFrom, boolean includeTo) {
            return createQuery(field, (Long) from, (Long) to, includeFrom, includeTo,
                    (f, t) -> LongRange.newIntersectsQuery(field, new long[] { f }, new long[] { t }), BasicRangeType.LONG);
        }
    };

    BasicRangeType(String name, LengthType lengthType) {
        this.name = name;
        this.numberType = null;
        this.lengthType = lengthType;
    }

    BasicRangeType(String name, LengthType lengthType, NumberFieldMapper.NumberType type) {
        this.name = name;
    ...
    private static <T extends Comparable<T>> Query createQuery(String field, T from, T to, boolean includeFrom, boolean includeTo,
            BiFunction<T, T, Query> querySupplier, BasicRangeType rangeType) {

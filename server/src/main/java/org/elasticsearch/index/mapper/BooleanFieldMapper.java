...
import org.elasticsearch.script.field.BooleanDocValues;
import org.elasticsearch.script.field.BooleanDocValuesSource;
...
public class BooleanFieldMapper extends FieldMapper {
    ...
    public static final class BooleanFieldType extends TermBasedFieldType {
        ...
        public IndexFieldData.Builder fielddataBuilder(String fullyQualifiedIndexName, Supplier<SearchLookup> searchLookup) {
            failIfNoDocValues();
            return new SortedNumericIndexFieldData.Builder(name(), NumericType.BOOLEAN, BooleanDocValuesSource::new);
        }

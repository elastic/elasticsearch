...
public abstract class FieldMapper extends Mapper implements Cloneable {
    ...
    protected final void doXContentAnalyzers(XContentBuilder builder, boolean includeDefaults) throws IOException {
        ...
        if (fieldType().indexAnalyzer() == null) {
            ...
            boolean hasDifferentSearchAnalyzer = !searchAnalyzerName.equals(fieldType().indexAnalyzer().name());
            boolean hasDifferentSearchQuoteAnalyzer = !searchAnalyzerName.equals(fieldType().searchQuoteAnalyzer().name());

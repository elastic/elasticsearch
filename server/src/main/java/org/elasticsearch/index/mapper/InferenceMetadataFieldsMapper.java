...
public abstract class InferenceMetadataFieldsMapper extends MetadataFieldMapper {
     ...
     * 1. The index version is on or after {@link IndexVersions#INFERENCE_METADATA_FIELDS_BACKPORT}, and
    ...
    public static boolean isEnabled(Settings settings) {
        return IndexMetadata.SETTING_INDEX_VERSION_CREATED.get(settings).onOrAfter(IndexVersions.INFERENCE_METADATA_FIELDS_BACKPORT)

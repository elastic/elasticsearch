...
public class MapperFeatures implements FeatureSpecification {
    ...
    public static final NodeFeature DOC_VALUES_UPDATABLE = new NodeFeature("mapper.doc_values.updatable");
    ...
    public Set<NodeFeature> getTestFeatures() {
        ...
        // Only advertise the capability the node will actually accept: the mapping parameter is itself gated by this flag.
        if (FieldMapper.DOC_VALUES_UPDATABLE_FEATURE_FLAG.isEnabled()) {
            features.add(DOC_VALUES_UPDATABLE);
        }
        return features;
    }
}

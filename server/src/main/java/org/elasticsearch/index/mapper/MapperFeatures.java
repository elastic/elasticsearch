...
public class MapperFeatures implements FeatureSpecification {
    ...
    public static final NodeFeature DOC_VALUES_EXTENDED_ONLY_IN_COLUMNAR = new NodeFeature("mapper.doc_values.extended_only_in_columnar");
    ...
    public Set<NodeFeature> getTestFeatures() {
        return Set.of(
            ...
            DOC_VALUES_EXTENDED_ONLY_IN_COLUMNAR,

...
public class MapperFeatures implements FeatureSpecification {
    ...
    public static final NodeFeature EXTENDED_DOC_VALUES_ONLY_IN_COLUMNAR = new NodeFeature("mapper.doc_values.extended_only_in_columnar");
    ...
    public Set<NodeFeature> getTestFeatures() {
        return Set.of(
            ...
            EXTENDED_DOC_VALUES_ONLY_IN_COLUMNAR,

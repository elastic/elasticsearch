...
public class NanosecondDateFieldMapper extends FieldMapper {
    ...
    public static final String CONTENT_TYPE = "nanosecond";
    public static final String DEFAULT_DATE_FORMATTER_STRING = "strict_date_optional_time_nanos||epoch_millis";
    public static final DateFormatter DEFAULT_DATE_TIME_FORMATTER = DateFormatter.forPattern(DEFAULT_DATE_FORMATTER_STRING);

    public static class Defaults {
        public static final Explicit<Boolean> IGNORE_MALFORMED = new Explicit<>(false, false);
    }

    public static class Builder extends FieldMapper.Builder<Builder, NanosecondDateFieldMapper> {
        ...
        protected void setupFieldType(BuilderContext context) {
            ...
            if (Objects.equals(locale, fieldType().dateTimeFormatter.locale()) == false ||
                (Objects.equals(formatter, fieldType().dateTimeFormatter.pattern()) == false && Strings.isEmpty(formatter) == false)) {
                fieldType().setDateTimeFormatter(DateFormatter.forPattern(formatter).withLocale(locale));
            }
        }

        @Override
        public NanosecondDateFieldMapper build(BuilderContext context) {
            setupFieldType(context);
            return new NanosecondDateFieldMapper(name, fieldType, defaultFieldType, ignoreMalformed(context),
    ...
    public static final class DateFieldType extends MappedFieldType {
        ...
        long parse(String value) {
            return toLong(DateFormatters.toZonedDateTime(dateTimeFormatter().parse(value)).toInstant());
        }
        ...
        public Query rangeQuery(Object lowerTerm, Object upperTerm, boolean includeLower, boolean includeUpper, ShapeRelation relation,
            ...
            if (lowerTerm == null) {
                ...
                l = parseToNanoseconds(lowerTerm, !includeLower, timeZone, parser, context);
            ...
            if (upperTerm == null) {
                ...
                u = parseToNanoseconds(upperTerm, includeUpper, timeZone, parser, context);
        ...
        long parseToNanoseconds(Object value, boolean roundUp,
        ...
        public Relation isFieldWithinQuery(IndexReader reader,
            ...
            if (from != null) {
                fromInclusive = parseToNanoseconds(from, !includeLower, timeZone, dateParser, context);
                if (includeLower == false) {
            ...
            if (to != null) {
                toInclusive = parseToNanoseconds(to, includeUpper, timeZone, dateParser, context);
                if (includeUpper == false) {
        ...
        public IndexFieldData.Builder fielddataBuilder(String fullyQualifiedIndexName) {
            failIfNoDocValues();
            return new DocValuesIndexFieldData.Builder().numericType(NumericType.DATE_NANOSECONDS);
        }
        ...
        public Object valueForDisplay(Object value) {
            ...
            return dateTimeFormatter().format(toInstant(val).atZone(ZoneOffset.UTC));
        }
    ...
    private NanosecondDateFieldMapper(
        String simpleName,
    ...
    @Override
    protected NanosecondDateFieldMapper clone() {
        return (NanosecondDateFieldMapper) super.clone();
    }
    ...
    protected void doMerge(Mapper mergeWith) {
        ...
        final NanosecondDateFieldMapper other = (NanosecondDateFieldMapper) mergeWith;

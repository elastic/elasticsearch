...
public class NestedValueFetcher implements ValueFetcher {
    ...
    public List<Object> fetchValues(ValuesLookup lookup, Set<String> ignoreFields) throws IOException {
        ...
        List<?> nestedValues = XContentMapValues.extractNestedValue(nestedFieldPath, lookup.source().source());
        ...
        for (Object entry : nestedValues) {
            ...
            ValuesLookup nestedSourceLookup = ValuesLookup.sourceOnly(filteredSource);

    ...
    public enum NumberType {
        HALF_FLOAT("half_float", NumericType.HALF_FLOAT) {
            ...
            public IndexFieldData.Builder getFieldDataBuilder(String name) {
                return new SortedDoublesIndexFieldData.Builder(name, numericType(), HalfFloatField::new);
            }
        ...
        DOUBLE("double", NumericType.DOUBLE) {
            ...
            @Override
            public IndexFieldData.Builder getFieldDataBuilder(String name) {
                return new SortedDoublesIndexFieldData.Builder(name, numericType(), DoubleField::new);
            }
        ...
        BYTE("byte", NumericType.BYTE) {
            ...
            @Override
            public IndexFieldData.Builder getFieldDataBuilder(String name) {
                return new SortedNumericIndexFieldData.Builder(name, numericType(), ByteField::new);
            }
        },
        ...
        INTEGER("integer", NumericType.INT) {
            ...
            @Override
            public IndexFieldData.Builder getFieldDataBuilder(String name) {
                return new SortedNumericIndexFieldData.Builder(name, numericType(), IntegerField::new);
            }
        },

...
public class NumberFieldMapper extends FieldMapper {
    ...
    public static class Builder extends FieldMapper.Builder {
        ...
        protected List<Parameter<?>> getParameters() {
            return Arrays.asList(indexed, hasDocValues, stored, ignoreMalformed, coerce, nullValue, script, onScriptError, meta, dimension);
        }
    ...
    public FieldMapper.Builder getMergeBuilder() {
        return new Builder(simpleName(), type, scriptCompiler, ignoreMalformedByDefault, coerceByDefault).dimension(dimension).init(this);
    }
}

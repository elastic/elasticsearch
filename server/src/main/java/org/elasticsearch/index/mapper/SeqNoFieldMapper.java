...
import org.elasticsearch.script.field.ToScriptField.ToUnsupportedScriptField;
...
public class SeqNoFieldMapper extends MetadataFieldMapper {
    ...
    static final class SeqNoFieldType extends SimpleMappedFieldType {
        ...
        public IndexFieldData.Builder fielddataBuilder(String fullyQualifiedIndexName, Supplier<SearchLookup> searchLookup) {
            failIfNoDocValues();
            return new SortedNumericIndexFieldData.Builder(name(), NumericType.LONG, ToUnsupportedScriptField.INSTANCE);
        }
    }

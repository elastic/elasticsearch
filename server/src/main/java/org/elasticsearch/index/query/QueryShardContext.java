...
import org.elasticsearch.index.mapper.DerivedFieldResolver;
import org.elasticsearch.index.mapper.DerivedFieldResolverFactory;
...
public class QueryShardContext extends QueryRewriteContext {
    ...
    private TriFunction<MappedFieldType, String, Supplier<SearchLookup>, IndexFieldData<?>> indexFieldDataService;
    private int shardId;
    private IndexSearcher searcher;
    private boolean cacheable = true;
    private final SetOnce<Boolean> frozen = new SetOnce<>();

    private  Index fullyQualifiedIndex;
    private  Predicate<String> indexNameMatcher;
    private  BooleanSupplier allowExpensiveQueries;

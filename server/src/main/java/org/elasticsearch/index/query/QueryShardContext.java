...
public class QueryShardContext extends QueryRewriteContext {
    ...
    public static final String TYPES_DEPRECATION_MESSAGE = "[types removal] Using the type field " +
        "in queries and aggregations is deprecated, prefer to filter on a field instead.";

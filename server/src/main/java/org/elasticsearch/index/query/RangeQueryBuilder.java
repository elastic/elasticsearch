...
public class RangeQueryBuilder extends AbstractQueryBuilder<RangeQueryBuilder> implements MultiTermQueryBuilder {
    ...
    public RangeQueryBuilder from(Object from, boolean includeLower) {
        this.from = convertToBytesRefIfStringOrCharBuffer(from);
     ...
     */
    public Object from() {
        return convertToStringIfBytesRefOrCharBuffer(this.from);
    }
    ...
    public RangeQueryBuilder to(Object to, boolean includeUpper) {
        this.to = convertToBytesRefIfStringOrCharBuffer(to);
     ...
     */
    public Object to() {
        return convertToStringIfBytesRefOrCharBuffer(this.to);
    }
    ...
    protected void doXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.field(FROM_FIELD.getPreferredName(), convertToStringIfBytesRefOrCharBuffer(this.from));
        builder.field(TO_FIELD.getPreferredName(), convertToStringIfBytesRefOrCharBuffer(this.to));
                ...
                while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                    if (token == XContentParser.Token.FIELD_NAME) {
                        ...
                        if (FROM_FIELD.match(currentFieldName, parser.getDeprecationHandler())) {
                            from = convertToBytesRefIfStringOrCharBuffer(parser.objectBytes());
                        } else if (TO_FIELD.match(currentFieldName, parser.getDeprecationHandler())) {
                            to = convertToBytesRefIfStringOrCharBuffer(parser.objectBytes());

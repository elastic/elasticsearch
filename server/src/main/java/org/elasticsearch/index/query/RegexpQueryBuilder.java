...
public class RegexpQueryBuilder extends AbstractQueryBuilder<RegexpQueryBuilder> implements MultiTermQueryBuilder {
    ...
    public RegexpQueryBuilder caseSensitivityMode(CaseSensitivityMode caseSensitivityMode) {
    ...
    public static RegexpQueryBuilder fromXContent(XContentParser parser) throws IOException {
        ...
        return new RegexpQueryBuilder(fieldName, value)
                ...
                .boost(boost)
                .queryName(queryName)
                .caseSensitivityMode(caseSensitivityMode);
    }
    ...
    protected Query doToQuery(QueryShardContext context) throws QueryShardException, IOException {
        ...
        int matchFlagsValue = caseSensitivityMode == CaseSensitivityMode.INSENSITIVE ? RegExp.ASCII_CASE_INSENSITIVE : 0;
        Query query = null;
    ...
    protected int doHashCode() {
        return Objects.hash(fieldName, value, syntaxFlagsValue, caseSensitivityMode, maxDeterminizedStates, rewrite);
    }

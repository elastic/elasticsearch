...
public abstract class DecayFunctionBuilder<DFB extends DecayFunctionBuilder<DFB>> extends ScoreFunctionBuilder<DFB> {
    ...
    private AbstractDistanceScoreFunction parseNumberVariable(
        ...
        IndexNumericFieldData numericFieldData = context.getForField(fieldType, MappedFieldType.FielddataType.SEARCH);
    ...
    private AbstractDistanceScoreFunction parseGeoVariable(
        ...
        IndexGeoPointFieldData indexFieldData = context.getForField(fieldType, MappedFieldType.FielddataType.SEARCH);
    ...
    private AbstractDistanceScoreFunction parseDateVariable(
        ...
        IndexNumericFieldData numericFieldData = context.getForField(dateFieldType, MappedFieldType.FielddataType.SEARCH);
        return new NumericFieldDataScoreFunction(origin, scale, decay, offset, getDecayFunction(), numericFieldData, mode);
    }

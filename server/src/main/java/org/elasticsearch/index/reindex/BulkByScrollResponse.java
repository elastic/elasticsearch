...
public class BulkByScrollResponse extends ActionResponse implements ToXContentFragment {
    ...
    private final List<HitSource.SearchFailure> searchFailures;
    ...
    public BulkByScrollResponse(StreamInput in) throws IOException {
        ...
        searchFailures = in.readCollectionAsList(HitSource.SearchFailure::new);
     ...
     * All search failures.
     */
    public List<HitSource.SearchFailure> getSearchFailures() {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        for (HitSource.SearchFailure failure : searchFailures) {
            failure.toXContent(builder, params);
        }
        builder.endArray();
        return builder;

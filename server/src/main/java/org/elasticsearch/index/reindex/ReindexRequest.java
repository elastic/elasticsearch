...
public class ReindexRequest extends AbstractBulkIndexByScrollRequest<ReindexRequest>
    ...
    static {
        ...
        PARSER.declareInt(ReindexRequest::setMaxDocsValidateIdentical,
            new ParseField("max_docs", "size").forVersions(RestApiCompatibleVersion.V_7));

        PARSER.declareInt(ReindexRequest::setMaxDocsValidateIdentical,
            new ParseField("max_docs").forVersions(RestApiCompatibleVersion.V_8));
        // avoid silently accepting an ignored size.
        PARSER.declareInt((r,s) -> failOnSizeSpecified(),
            new ParseField("size").forVersions(RestApiCompatibleVersion.V_8));

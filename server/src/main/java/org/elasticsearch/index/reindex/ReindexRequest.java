...
public class ReindexRequest extends AbstractBulkIndexByScrollRequest<ReindexRequest>
    ...
    static {
        ...
        PARSER.declareInt(ReindexRequest::setMaxDocsValidateIdentical,
            new ParseField("max_docs", "size").withRestApiCompatibilityVersions(RestApiVersion.V_7));

        PARSER.declareInt(ReindexRequest::setMaxDocsValidateIdentical,
            new ParseField("max_docs").withRestApiCompatibilityVersions(RestApiVersion.V_8));
        // avoid silently accepting an ignored size.
        PARSER.declareInt((r,s) -> failOnSizeSpecified(),
            new ParseField("size").withRestApiCompatibilityVersions(RestApiVersion.V_8));

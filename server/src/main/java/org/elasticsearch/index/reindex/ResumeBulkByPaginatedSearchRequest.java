...
public class ResumeBulkByPaginatedSearchRequest extends ActionRequest implements CompositeIndicesRequest {

    private final AbstractBulkByPaginatedSearchRequest<?> delegate;

    public ResumeBulkByPaginatedSearchRequest(AbstractBulkByPaginatedSearchRequest<?> delegate) {
        super();

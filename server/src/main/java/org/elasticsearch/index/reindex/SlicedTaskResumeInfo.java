...
public record SlicedTaskResumeInfo(@Nullable WorkerResumeInfo worker, @Nullable Map<Integer, SliceStatusInfo> slices) implements Writeable {
    ...
    public SlicedTaskResumeInfo(StreamInput in) throws IOException {
        this(
            in.readOptionalNamedWriteable(WorkerResumeInfo.class),
            in.readOptionalImmutableMap(StreamInput::readVInt, SliceStatusInfo::new)
        );
    }
    ...
    public Optional<SliceStatusInfo> getSlice(int sliceId) {
     ...
     * - the final result of the slice if it has completed (successfully or erroneously).
     */
    public record SliceStatusInfo(int sliceId, @Nullable WorkerResumeInfo resumeInfo, @Nullable WorkerResult result) implements Writeable {
        public SliceStatusInfo {
        ...
        public SliceStatusInfo(StreamInput in) throws IOException {

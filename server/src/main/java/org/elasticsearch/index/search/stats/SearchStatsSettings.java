...
/**
 * Container for cluster settings related to {@link ShardSearchLoadRateStatsService}.
 */
public class SearchStatsSettings {
     ...
     * recency-weighted read load returned by {@link ShardSearchLoadRateStatsService}.
     *

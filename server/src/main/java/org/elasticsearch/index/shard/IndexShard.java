...
public class IndexShard extends AbstractIndexShardComponent implements IndicesClusterStateService.Shard {
    ...
    public Engine.IndexResult applyIndexOperationOnReplica(long seqNo, long version, long autoGeneratedTimeStamp,
        ...
        return applyIndexOperation(getEngine(), seqNo, operationPrimaryTerm, version, null, autoGeneratedTimeStamp,
            isRetry, Engine.Operation.Origin.REPLICA, sourceToParse);
    }

    private Engine.IndexResult applyIndexOperation(Engine engine, long seqNo, long opPrimaryTerm, long version, @Nullable VersionType versionType,
        ...
        synchronized (mutex) {
            try {
                ...
                try {
                    ...
                    IOUtils.close(engineHolder, globalCheckpointListeners, refreshListeners);
    ...
    /**
     * This method is called after each bulk of primary-replica resync operations are applied to this shard
     * via {@link #applyResyncOperation(Translog.Operation)}.
     *
    ...
    public void afterApplyResyncOperationsBulk(long maxSeqNoFromPrimary) throws IOException {
        if (maxSeqNoFromPrimary != UNASSIGNED_SEQ_NO) {
    ...
    /**
     * An {@link EngineHolder} holds one or two engine references and manages its transition during primary-replica resync.
     */
    static final class EngineHolder implements Closeable {
        ...
        private long minRequiredCheckpoint = NO_OPS_PERFORMED;

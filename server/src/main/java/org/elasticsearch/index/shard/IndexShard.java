...
public class IndexShard extends AbstractIndexShardComponent implements IndicesClusterStateService.Shard {
    ...
    public Engine.IndexResult applyIndexOperation(long seqNo, long opPrimaryTerm, long version, @Nullable VersionType versionType,
            ...
            case INDEX:
                ...
                result = applyIndexOperation(index.seqNo(), index.primaryTerm(), index.version(),
                    ...
                    source(shardId.getIndexName(), index.type(), index.id(), index.source(),
                        XContentHelper.xContentType(index.source()), true).routing(index.routing()));
                break;
            case DELETE:

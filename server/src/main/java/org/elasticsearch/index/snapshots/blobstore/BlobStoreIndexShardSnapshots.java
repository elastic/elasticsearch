...
public class BlobStoreIndexShardSnapshots implements Iterable<SnapshotFiles>, ToXContentFragment {
     ...
     */
    public BlobStoreIndexShardSnapshots withSurvivingSnapshots(Set<SnapshotId> retainedSnapshots) {
    ...
    /**
     * Creates a new list of the shard's snapshots ({@link BlobStoreIndexShardSnapshots}) adding
     * a new shard snapshot ({@link SnapshotFiles}).
     */

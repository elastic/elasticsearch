...
public class TranslogStreamOutput extends RecyclerBytesStreamOutput {
    ...
    public void writeIndexHeader(Translog.Index indexOperation) throws IOException {
        ...
        if (FIXED_INDEX_HEADER_SIZE <= (pageSize - currentPageOffset)) {
            ...
            ByteUtils.writeLongBE(indexOperation.version(), localBytesRef, off + 6);
            ByteUtils.writeLongBE(indexOperation.getAutoGeneratedIdTimestamp(), localBytesRef, off + 14);
            ByteUtils.writeLongBE(indexOperation.seqNo(), localBytesRef, off + 22);
            ByteUtils.writeLongBE(indexOperation.primaryTerm(), localBytesRef, off + 30);
            ...
            ByteUtils.writeIntBE(sizeOfOperation, localBytesRef, off);
        } else {
    ...
    public void writeDeleteHeader(Translog.Delete delete) throws IOException {
        ...
        if (FIXED_DELETE_HEADER_SIZE <= (pageSize - currentPageOffset)) {
            ...
            ByteUtils.writeLongBE(delete.version(), localBytesRef, off + 6);
            ByteUtils.writeLongBE(delete.seqNo(), localBytesRef, off + 14);
            ByteUtils.writeLongBE(delete.primaryTerm(), localBytesRef, off + 22);
    ...
    public void writeNoOpHeader(Translog.NoOp noop) throws IOException {
        ...
        if (FIXED_NO_OP_HEADER_SIZE <= (pageSize - currentPageOffset)) {
            ...
            ByteUtils.writeLongBE(noop.seqNo(), localBytesRef, off + 5);
            ByteUtils.writeLongBE(noop.primaryTerm(), localBytesRef, off + 13);

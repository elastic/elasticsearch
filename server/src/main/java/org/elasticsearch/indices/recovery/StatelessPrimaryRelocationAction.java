...
public class StatelessPrimaryRelocationAction {
    ...
    public static class Request extends ActionRequest {
        ...
        public Request(StreamInput in) throws IOException {
            ...
            if (in.getTransportVersion().onOrAfter(TransportVersions.WAIT_FOR_RECOVERY_ADDED)) {
        ...
        public void writeTo(StreamOutput out) throws IOException {
            ...
            if (out.getTransportVersion().onOrAfter(TransportVersions.WAIT_FOR_RECOVERY_ADDED)) {

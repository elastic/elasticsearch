...
public final class InferenceStringGroup implements Accountable, Writeable, ToXContentObject {
    ...
    public long ramBytesUsed() {
        return SHALLOW_SIZE + RamUsageEstimator.alignObjectSize(
            RamUsageEstimator.shallowSizeOf(inferenceStrings()) + 2L * RamUsageEstimator.NUM_BYTES_ARRAY_HEADER
                + (long) inferenceStrings().size() * RamUsageEstimator.NUM_BYTES_OBJECT_REF

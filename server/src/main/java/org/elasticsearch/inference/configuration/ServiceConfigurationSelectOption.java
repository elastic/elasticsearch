...
public class ServiceConfigurationSelectOption implements Writeable, ToXContentObject {
    ...
    public ServiceConfigurationSelectOption(StreamInput in) throws IOException {
    ...
    private static final ConstructingObjectParser<ServiceConfigurationSelectOption, Void> PARSER = new ConstructingObjectParser<>(
        "service_configuration_select_option",
        true,
        args -> new ServiceConfigurationSelectOption.Builder().setLabel((String) args[0]).setValue(args[1]).build()
    );
    ...
    public static ServiceConfigurationSelectOption fromXContent(XContentParser parser) throws IOException {

 ...
 * is insufficient for a particular binding, the module can specify a custom {@code LibraryProvider}
 * instead, to control exactly how Guice creates or obtains instances for the binding.
 * <li>An implementation class may always choose to have a {@code LibraryProvider<T>} instance injected,
 ...
 * <li>The {@link Injector} offers access to the {@code LibraryProvider<T>} it uses to fulfill requests

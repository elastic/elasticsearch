...
public abstract class XNumericComparator<T extends Number> extends FieldComparator<T> {
    ...
    /** Leaf comparator for {@link org.apache.lucene.search.comparators.NumericComparator} that provides skipping functionality */
    ...
    protected abstract class CompetitiveDISIBuilder {
        ...
        protected final XUpdateableDocIdSetIterator competitiveIterator = new XUpdateableDocIdSetIterator();
        ...
        protected void doUpdateCompetitiveIterator() throws IOException {
            ...
            if (PointValues.isEstimatedPointCountGreaterThanOrEqualTo(visitor, getPointTree(), threshold)) {
                ...
                if (pointValues.getDocCount() < iteratorCost) {
                    ...
                    competitiveIterator.update(leafComparator.getNumericDocValues(leafComparator.context, field));

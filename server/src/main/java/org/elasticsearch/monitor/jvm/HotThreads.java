...
public class HotThreads {
    ...
    private static final DateTimeFormatter DATE_TIME_FORMATTER = DateFormatters.forPattern("dateOptionalTime");
    ...
    private String innerDetect() throws Exception {
        ...
        sb.append(LocalDateTime.now(Clock.systemUTC()).format(DATE_TIME_FORMATTER));
        sb.append(", interval=");
        sb.append(interval);

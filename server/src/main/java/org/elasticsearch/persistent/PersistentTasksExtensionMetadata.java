 ...
 */
public final class PersistentTasksExtensionMetadata extends AbstractNamedDiffable<MetadataExtension> implements MetadataExtension {
    ...
    public PersistentTasksExtensionMetadata(long lastAllocationId, Map<String, PersistentTask<?>> tasks) {
    ...
    public static PersistentTasksExtensionMetadata getPersistentTasksCustomMetadata(ClusterState clusterState) {
        return clusterState.getMetadata().custom(PersistentTasksExtensionMetadata.TYPE);
    }
    ...
    public boolean equals(Object o) {
        ...
        PersistentTasksExtensionMetadata that = (PersistentTasksExtensionMetadata) o;
    ...
    public static PersistentTasksExtensionMetadata fromXContent(XContentParser parser) {
    ...
    public static ClusterState disassociateDeadNodes(ClusterState clusterState) {
        PersistentTasksExtensionMetadata tasks = getPersistentTasksCustomMetadata(clusterState);
        if (tasks == null) {
            return clusterState;
        }

        PersistentTasksExtensionMetadata.Builder taskBuilder = PersistentTasksExtensionMetadata.builder(tasks);
    ...
    public PersistentTasksExtensionMetadata(StreamInput in) throws IOException {
    ...
    public static Builder builder(PersistentTasksExtensionMetadata tasks) {
    ...
    public static class Builder {
        ...
        private Builder(PersistentTasksExtensionMetadata tasksInProgress) {
        ...
        public PersistentTasksExtensionMetadata build() {
            return new PersistentTasksExtensionMetadata(lastAllocationId, Collections.unmodifiableMap(tasks));
        }
    }
}

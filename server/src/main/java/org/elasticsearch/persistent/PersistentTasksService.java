...
public class PersistentTasksService {
    ...
    public void waitForPersistentTaskCondition(
        ...
        ClusterStateObserver.waitForState(clusterService, threadPool.getThreadContext(), new ClusterStateObserver.Listener() {
            ...
            public void onNewClusterState(ClusterState state) {
                listener.onResponse(PersistentTasksMetadataSection.getTaskWithId(state, taskId));
            }
        ...
        }, clusterState -> predicate.test(PersistentTasksMetadataSection.getTaskWithId(clusterState, taskId)), timeout, logger);
    }
    ...
    public void waitForPersistentTasksCondition(
        final Predicate<PersistentTasksMetadataSection> predicate,
        final @Nullable TimeValue timeout,
        ...
        }, clusterState -> predicate.test(clusterState.metadata().section(PersistentTasksMetadataSection.TYPE)), timeout, logger);
    }

...
public interface SystemIndexPlugin extends ActionPlugin {
     ...
     * @param client A {@link org.elasticsearch.internal.client.ParentTaskAssigningClient} with the parent task set to the upgrade task.
     *               Does not set the origin header, so implementors of this method will likely want to wrap it in an
     *               {@link org.elasticsearch.internal.client.OriginSettingClient}.

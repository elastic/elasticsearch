...
public class StableLuceneTokenizerIteratorMH extends StableLuceneFilterIteratorMH {
    private final ReaderProvider readerProvider;

    private final MethodHandle mhSetReader;

    public StableLuceneTokenizerIteratorMH(Object stream, ReaderProvider provider) {
        super(stream);

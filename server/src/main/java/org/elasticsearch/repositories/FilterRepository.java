...
public class FilterRepository implements Repository {
    ...
    @Override
    public SnapshotInfo finalizeSnapshot(SnapshotId snapshotId, String repository, List<IndexId> indices, long startTime, String failure,
                                         int totalShards, List<SnapshotShardFailure> shardFailures, long repositoryStateId,
                                         boolean includeGlobalState) {
        return in.finalizeSnapshot(snapshotId, repository, indices, startTime, failure, totalShards, shardFailures,
                repositoryStateId, includeGlobalState);
    }

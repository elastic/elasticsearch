...
public interface Repository extends LifecycleComponent {
     ...
     * task generated through {@code createUpdateTaskAsync} is guaranteed to point at the same state for this repository as the
     * state at the time the {@code RepositoryData} was loaded.
     ...
     * cluster state.
     *
     * @param createUpdateTaskAsync async supplier of the cluster state update task
     * @param source                the source of the cluster state update task
     * @param onFailure             error handler invoked on failure to get a consistent view of the current {@link RepositoryData}
     */
    void executeConsistentStateUpdate(BiConsumer<RepositoryData, ActionListener<ClusterStateUpdateTask>> createUpdateTaskAsync,
                                      String source,

 ...
 * <li>Get the current {@link org.elasticsearch.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob file
 * with name {@code index-${uuid}} by loading the index shard's generation {@code uuid} from
 * {@link org.elasticsearch.repositories.ShardGenerations} (via {@link org.elasticsearch.repositories.ShardGenerations#getShardGen}). This
 * blob file will list what segment files are already available in the blobstore.</li>

...
public class RestPostFeatureUpgradeAction extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return org.elasticsearch.core.List.of(new Route(RestRequest.Method.POST, "/_migration/system_features"));
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return restChannel -> {
            client.execute(PostFeatureUpgradeAction.INSTANCE, req, new RestToXContentListener<>(restChannel));
        };
    }
}

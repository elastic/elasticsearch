...
public class CtxMap<M extends Metadata> extends MapWrapper {

    protected Map<String, Object> source;
    protected M metadata;

    CtxMap(Map<String, Object> source, M metadata) {
        super(new SourceAndMetadataMap(source, metadata));
        this.source = source;
    ...
    private static class SourceAndMetadataMap implements MapWrappable {
        protected Map<String, Object> source;
        protected MapWrappable metadata;

        SourceAndMetadataMap(Map<String, Object> source, MapWrappable metadata) {
            this.source = source;
            this.metadata = metadata;
        }

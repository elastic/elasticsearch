    ...
    public static class Metadata {
        ...
        public Op getOp() {
            ...
            if (validOps.contains(raw.op) == false) {
                throw new IllegalArgumentException("unknown op [" + raw.str + "], valid ops are " + String.join(", ", validOps()));
            }
            return raw.op;
        }
        ...
        public void setOp(Op op) {
            if (validOps.contains(op) == false) {
                throw new IllegalArgumentException("unknown op [" + op + "], valid ops are " + String.join(", ", validOps()));
            }

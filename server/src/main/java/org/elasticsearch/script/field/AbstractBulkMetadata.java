...
public abstract class AbstractBulkMetadata implements BulkMetadata {
    ...
    protected static final Set<String> CTX_KEYS = Set.of(MapBackedMetadata.INDEX, MapBackedMetadata.ID, MapBackedMetadata.VERSION, MapBackedMetadata.ROUTING, MapBackedMetadata.OP, MapBackedMetadata.SOURCE);

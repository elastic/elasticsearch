...
public class ByteDocValuesSource implements FieldDocValuesSource {

    protected final ByteDocValuesSupplier supplier;
    ...
    public ByteDocValuesSource(SortedNumericDocValues docValues) {
        this.supplier = new ByteDocValuesSupplier(docValues);
    }

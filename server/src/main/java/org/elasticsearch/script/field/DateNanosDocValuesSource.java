...
public class DateNanosDocValuesSource implements FieldDocValuesSource {

    protected final DateNanosDocValuesSupplier supplier;
    ...
    public DateNanosDocValuesSource(SortedNumericDocValues docValues) {
        this.supplier = new DateNanosDocValuesSupplier(docValues);
    }

...
public class FloatDocValuesSource implements FieldDocValuesSource {

    protected final FloatDocValuesSupplier supplier;
    ...
    public FloatDocValuesSource(SortedNumericDoubleValues docValues) {
        this.supplier = new FloatDocValuesSupplier(docValues);
    }

...
public class IPAddressSortedSetDocValuesSource implements FieldDocValuesSource {

    protected final IpAddressSortedSetDocValuesSupplier supplier;
    ...
    public IPAddressSortedSetDocValuesSource(SortedSetDocValues docValues) {
        this.supplier = new IpAddressSortedSetDocValuesSupplier(docValues);
    }

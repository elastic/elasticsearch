...
/**
 * Implements a stub LongDocValuesField that implements no useful Field API methods for getting
 * values but provides access to a {@link ScriptDocValues.Longs} until the Field API can support
 * all mapped types backed by {@link ScriptDocValues.Longs}.
 */
public class LongDocValuesWrapper implements DocValuesField<Long>, SortedNumericDocValuesWrapper {
    ...
    public LongDocValuesWrapper(SortedNumericDocValues input, String name) {
        this.input = input;
        this.name = name;
    }

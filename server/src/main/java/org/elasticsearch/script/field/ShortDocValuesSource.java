...
public class ShortDocValuesSource implements FieldDocValuesSource {

    protected final ShortDocValuesSupplier supplier;
    ...
    public ShortDocValuesSource(SortedNumericDocValues docValues) {
        this.supplier = new ShortDocValuesSupplier(docValues);
    }

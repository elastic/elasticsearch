...
public final class SearchHit implements Writeable, ToXContentObject, Iterable<DocumentField> {
    ...
    * */
    ...
    public static class Fields {
        ...
        static final String _POSITIONS = "_positions";
    ...
    public XContentBuilder toInnerXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (rank != NO_RANK) {
            ...
            if (positions.length > 0) {
                builder.array(Fields._POSITIONS, positions);
            }
        }
    ...
    public static void declareInnerHitsParseFields(ObjectParser<Map<String, Object>, Void> parser) {
        ...
        parser.declareIntArray((map, value) -> map.put(Fields._POSITIONS, value), new ParseField(Fields._POSITIONS));
    ...
    public static SearchHit createFromMap(Map<String, Object> values) {
        ...
        searchHit.setPositions(get(Fields._POSITIONS, values, new int[0]));

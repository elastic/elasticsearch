...
import org.elasticsearch.index.query.FirstQueryBuilder;
...
public class SearchModule {
    ...
    private void registerQueryParsers(List<SearchPlugin> plugins) {
        ...
        FirstQueryBuilder.setMaxClauseCount(INDICES_MAX_CLAUSE_COUNT_SETTING.get(settings));
        registerQuery(new QuerySpec<>(FirstQueryBuilder.NAME, FirstQueryBuilder::new, FirstQueryBuilder::fromXContent));
        registerQuery(

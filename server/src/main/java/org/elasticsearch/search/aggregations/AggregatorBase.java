...
public abstract class AggregatorBase extends Aggregator {
     ...
     * @param bucketCardinality     Rough count of the number of buckets that this aggregation will collect
    ...
    protected AggregatorBase(String name, AggregatorFactories factories, SearchContext context, Aggregator parent,
            TotalBucketCardinality bucketCardinality, Map<String, Object> metadata) throws IOException {
        this.name = name;
        ...
        this.subAggregators = factories.createSubAggregators(context, this, bucketCardinality);

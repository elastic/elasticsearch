...
public final class InternalAggregations extends Aggregations implements Writeable {
    ...
    public InternalAggregations(StreamInput in) throws IOException {
        ...
        if (in.getVersion().before(Version.V_7_7_0) && in.getVersion().onOrAfter(Version.V_6_7_0)) {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getVersion().before(Version.V_7_7_0) && out.getVersion().onOrAfter(Version.V_6_7_0)) {

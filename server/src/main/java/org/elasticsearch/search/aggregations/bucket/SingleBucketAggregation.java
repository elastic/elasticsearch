...
public class SingleBucketAggregation extends InternalAggregation {
     ...
     * Read from a stream.
     */
    protected SingleBucketAggregation(StreamInput in) throws IOException {
        super(in);
     ...
     */
    public SingleBucketAggregation create(InternalAggregations subAggregations) {
    ...
    protected AggregatorReducer getLeaderReducer(AggregationReduceContext reduceContext, int size) {
        return new AggregatorReducer() {
            ...
            public void accept(InternalAggregation aggregation) {
                docCount += ((SingleBucketAggregation) aggregation).docCount;
                subAggregatorReducer.accept(((SingleBucketAggregation) aggregation).aggregations);
            }
    ...
    public boolean equals(Object obj) {
        ...
        SingleBucketAggregation other = (SingleBucketAggregation) obj;

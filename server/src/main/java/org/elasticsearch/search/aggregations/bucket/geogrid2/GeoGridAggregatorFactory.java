...
import org.elasticsearch.search.aggregations.bucket.geogrid2.GeoGridAggregationBuilder2.CellIdSource;
...
public class GeoGridAggregatorFactory extends ValuesSourceAggregatorFactory<ValuesSource.GeoPoint, GeoGridAggregatorFactory> {
    ...
    protected Aggregator doCreateInternal(final ValuesSource.GeoPoint valuesSource, Aggregator parent, boolean collectsFromSingleBucket,
        ...
        return new GeoGridAggregator(name, factories, cellIdSource, requiredSize, shardSize, context, parent,

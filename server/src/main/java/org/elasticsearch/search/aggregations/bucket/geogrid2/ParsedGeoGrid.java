...
public class ParsedGeoGrid extends ParsedMultiBucketAggregation<ParsedGeoGrid.ParsedBucket> implements GeoGrid {
    ...
    private static ObjectParser<ParsedGeoGrid, Void> PARSER =
            new ObjectParser<>(ParsedGeoGrid.class.getSimpleName(), true, ParsedGeoGrid::new);
    static {
    ...
    public static class ParsedBucket extends ParsedMultiBucketAggregation.ParsedBucket implements GeoGrid.Bucket {

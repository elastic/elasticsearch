...
public class DoubleTerms extends InternalMappedTerms<DoubleTerms, DoubleTerms.Bucket> {
    ...
    public DoubleTerms(String name, BucketOrder reduceOrder, BucketOrder order, int requiredSize, long minDocCount, long maxDocCount,
        ...
        super(name, reduceOrder, order, requiredSize, minDocCount, maxDocCount, metadata, format, shardSize, showTermDocCountError,
    ...
    public DoubleTerms create(List<Bucket> buckets) {
        return new DoubleTerms(name, reduceOrder, order, requiredSize, minDocCount, maxDocCount, metadata, format, shardSize,
    ...
    protected DoubleTerms create(String name, List<Bucket> buckets, BucketOrder reduceOrder, long docCountError, long otherDocCount) {
        return new DoubleTerms(name, reduceOrder, order, requiredSize, minDocCount, maxDocCount, getMetadata(), format,

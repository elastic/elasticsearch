...
public class SignificantLongTerms extends InternalMappedSignificantTerms<SignificantLongTerms, SignificantLongTerms.Bucket> {
    ...
    public SignificantLongTerms(String name, int requiredSize, long minDocCount, long maxDocCount,
        ...
        super(name, requiredSize, minDocCount, maxDocCount, metadata, format, subsetSize, supersetSize, significanceHeuristic,
                buckets);
    }
    ...
    public SignificantLongTerms create(List<SignificantLongTerms.Bucket> buckets) {
        return new SignificantLongTerms(name, requiredSize, minDocCount, maxDocCount, metadata, format, subsetSize, supersetSize,
    ...
    protected SignificantLongTerms create(long subsetSize, long supersetSize, List<Bucket> buckets) {
        return new SignificantLongTerms(getName(), requiredSize, minDocCount, maxDocCount, getMetadata(), format, subsetSize,

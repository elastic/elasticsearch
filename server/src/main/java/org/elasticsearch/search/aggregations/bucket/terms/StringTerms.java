...
public class StringTerms extends InternalMappedTerms<StringTerms, StringTerms.Bucket> {
    ...
    public StringTerms(String name, BucketOrder reduceOrder, BucketOrder order, int requiredSize, long minDocCount, long maxDocCount,
        ...
        super(name, reduceOrder, order, requiredSize, minDocCount, maxDocCount, metadata, format,
    ...
    public StringTerms create(List<Bucket> buckets) {
        return new StringTerms(name, reduceOrder, order, requiredSize, minDocCount, maxDocCount, metadata, format, shardSize,
    ...
    protected StringTerms create(String name, List<Bucket> buckets, BucketOrder reduceOrder, long docCountError, long otherDocCount) {
        return new StringTerms(name, reduceOrder, order, requiredSize, minDocCount, maxDocCount, getMetadata(), format, shardSize,
                showTermDocCountError, otherDocCount, buckets, docCountError);
    }
}

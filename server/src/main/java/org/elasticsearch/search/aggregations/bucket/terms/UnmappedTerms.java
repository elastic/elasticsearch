...
public class UnmappedTerms extends InternalTerms<UnmappedTerms, UnmappedTerms.Bucket> {
    ...
    public UnmappedTerms(String name, BucketOrder order, int requiredSize, long minDocCount, long maxDocCount, Map<String, Object> metadata) {
        super(name, order, order, requiredSize, minDocCount, maxDocCount, metadata);
    }
    ...
    public UnmappedTerms create(List<Bucket> buckets) {
        return new UnmappedTerms(name, order, requiredSize, minDocCount, maxDocCount, metadata);
    }

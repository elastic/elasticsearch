...
public enum CoreValuesSourceType implements Writeable, ValuesSourceType {
    ...
    GEOPOINT {
        ...
        public ValuesSource replaceMissing(ValuesSource valuesSource, Object rawMissing, DocValueFormat docValueFormat, LongSupplier now) {
            ...
            final MultiGeoValues.GeoPointValue missing = new MultiGeoValues.GeoPointValue(missingPoint);
    ...
    GEOSHAPE {
        ...
        @Override
        public ValuesSource replaceMissing(ValuesSource valuesSource, Object rawMissing, DocValueFormat docValueFormat, LongSupplier now) {
            final MultiGeoValues.GeoShapeValue missing = MultiGeoValues.GeoShapeValue.missing(rawMissing.toString());
            return MissingValues.replaceMissing((ValuesSource.GeoShape) valuesSource, missing);
        }
    },
    GEO {
        @Override

...
public class SourceLookup implements Map<String, Object> {
    ...
    /**
     * Point this lookup at a document, returning true if it was already
     * pointed at that document, false otherwise.
     */
    public boolean setSegmentAndDocument(LeafReaderContext context, int docId) {

...
public interface SourceProvider {
     ...
     * multiple threads.
     */
    static SourceProvider fromSyntheticSource(Mapping mapping, SourceFilter sourceFilter, SourceFieldMetrics metrics) {
        return new SyntheticSourceProvider(new SourceLoader.Synthetic(() -> mapping.syntheticFieldLoader(sourceFilter), metrics));
    }
}

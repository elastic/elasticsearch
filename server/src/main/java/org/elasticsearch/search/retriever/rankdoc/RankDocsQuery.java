...
public class RankDocsQuery extends Query {
     ...
     * @return this query
     */
    public RankDocsQuery setCountFilteredHits(boolean countFilteredHits) {
    ...
    public Query rewrite(IndexSearcher searcher) throws IOException {
        ...
        RankDocsQuery rewritten = hasChanged ? new RankDocsQuery(docs, topRewrite, tailRewrite, onlyRankDocs, minScore) : this;
        if (hasChanged && countFilteredHits) {
            rewritten.setCountFilteredHits(true);
        }
        return rewritten;
    }
            ...
            public ScorerSupplier scorerSupplier(LeafReaderContext context) throws IOException {
                ...
                return new ScorerSupplier() {
                    ...
                    public Scorer get(long leadCost) throws IOException {
                        return new MinScoreScorer(supplier.get(leadCost), minScore);
                    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(classHash(), topQuery, tailQuery, onlyRankDocs, minScore, countFilteredHits);
    }
}

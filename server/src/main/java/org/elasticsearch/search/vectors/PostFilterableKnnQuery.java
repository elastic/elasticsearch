...
public interface PostFilterableKnnQuery {
    ...
    default Query maybePostFilterRewrite(
        ...
        if (shouldPostFilter || filter == null) {
            return null;
        }
     ...
     */
    default FixedBitSet buildRetrySeenDocs(FixedBitSet previousSeenDocs, TopDocs capturedResults, IndexReader reader) {
     ...
     */
    default KnnCollectorManager wrapCollectorManager(

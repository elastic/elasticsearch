...
public class TaskResultsService {
    ...
    public static final SystemIndexDescriptor TASKS_DESCRIPTOR = SystemIndexDescriptor.builder()
        ...
        .setSettings(taskResultIndexSettings())
        .setMappings(taskResultIndexMapping())
    ...
    private static Settings taskResultIndexSettings() {
    ...
    private static String taskResultIndexMapping() {
        try {
            ...
            builder.startObject();
            {
                ...
                builder.field(TASK_RESULT_MAPPING_VERSION_META_FIELD, TASK_RESULT_MAPPING_VERSION);
                builder.endObject();

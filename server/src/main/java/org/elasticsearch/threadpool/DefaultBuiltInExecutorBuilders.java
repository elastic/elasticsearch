...
public class DefaultBuiltInExecutorBuilders implements BuiltInExecutorBuilders {
    ...
    public Map<String, ExecutorBuilder> getBuilders(Settings settings, int allocatedProcessors) {
        ...
        result.put(ThreadPool.Names.GET, new VirtualThreadsExecutorBuilder(ThreadPool.Names.GET, false)
        ...
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.ANALYZE, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.SEARCH, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.SEARCH_COORDINATION, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.AUTO_COMPLETE, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.MANAGEMENT, false)
        );
        result.put(
            ThreadPool.Names.FLUSH,
            // new ScalingExecutorBuilder(ThreadPool.Names.FLUSH, 1, halfProcMaxAt5, TimeValue.timeValueMinutes(5), false)
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.FLUSH, false)
        );
        ...
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.REFRESH, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.WARMER, false)
        );
        ...
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.SNAPSHOT, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.SNAPSHOT_META, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.FETCH_SHARD_STARTED, false)
        );
        if (ThreadPoolMergeScheduler.USE_THREAD_POOL_MERGE_SCHEDULER_SETTING.get(settings)) {
            result.put(
                ...
                new VirtualThreadsExecutorBuilder(ThreadPool.Names.MERGE, false)
            );
        }
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.FORCE_MERGE, false)
        );
        result.put(
            ...
            // new VirtualThreadsExecutorBuilder(ThreadPool.Names.CLUSTER_COORDINATION, false)
        );
        result.put(
            ThreadPool.Names.FETCH_SHARD_STORE,
            // new ScalingExecutorBuilder(ThreadPool.Names.FETCH_SHARD_STORE, 1, 2 * allocatedProcessors, TimeValue.timeValueMinutes(5),
            // false)
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.FETCH_SHARD_STORE, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.SYSTEM_READ, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.SYSTEM_WRITE, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.SYSTEM_WRITE_COORDINATION, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.SYSTEM_CRITICAL_READ, false)
        );
        result.put(
            ...
            new VirtualThreadsExecutorBuilder(ThreadPool.Names.SYSTEM_CRITICAL_WRITE, false)
        );

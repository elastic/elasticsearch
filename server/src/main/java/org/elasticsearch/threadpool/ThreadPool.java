...
public class ThreadPool extends AbstractComponent implements Scheduler, Closeable {
    ...
    public static class Names {
        ...
        public static final String SEARCH_SEQUENTIAL = "search_sequential";
    ...
    static {
        ...
        map.put(Names.SEARCH_SEQUENTIAL, ThreadPoolType.FIXED_AUTO_QUEUE_SIZE);
    ...
    public ThreadPool(final Settings settings, final ExecutorBuilder<?>... customBuilders) {
        ...
        builders.put(Names.SEARCH_SEQUENTIAL, new AutoQueueAdjustingExecutorBuilder(settings,
            Names.SEARCH_SEQUENTIAL, 1, 100, 100, 100, 200));

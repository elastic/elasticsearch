 ...
 * {@link #onTraceStarted(ThreadContext, String, String, Map)}, and stop it using
 * {@link #onTraceStopped(String)}, at which point the tracing system will queue
...
public interface Tracer {
     ...
     */
    void onTraceStarted(ThreadContext threadContext, String id, String name, Map<String, Object> attributes);

    /**
     * Called when a span ends.
     * @param id an identifier for the span
     */
    void onTraceStopped(String id);
     ...
     */
    void onTraceEvent(String id, String eventName);
     ...
     */
    void onTraceException(String id, Throwable throwable);
    ...
    Tracer NOOP = new Tracer() {
        @Override
        public void onTraceStarted(ThreadContext threadContext, String id, String name, Map<String, Object> attributes) {}

        @Override
        public void onTraceStopped(String id) {}

        @Override
        public void onTraceEvent(String id, String eventName) {}

        @Override
        public void onTraceException(String id, Throwable throwable) {}

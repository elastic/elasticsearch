...
abstract class OutboundMessage extends NetworkMessage {
    ...
    BytesReference serialize(ReleasableBytesStreamOutput bytesStream) throws IOException {
    ...
    private StreamOutput wrapCompressed(ReleasableBytesStreamOutput bytesStream) throws IOException {

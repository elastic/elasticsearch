...
public class ProxyConnectionStrategy implements TransportConnectionListener {
    ...
    ProxyConnectionStrategy(ConnectionManager connectionManager, ThreadPool threadPool, int maxNumRemoteConnections) {

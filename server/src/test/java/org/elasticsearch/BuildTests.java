...
public class BuildTests extends ESTestCase {
    ...
    public void testEqualsAndHashCode() {
        ...
        Build another = new Build(
            build.flavor(), build.type(), build.shortHash(), build.date(), build.isSnapshot(), build.getVersion()
        );
        ...
        Build differentFlavor = new Build(
            otherFlavor, build.type(), build.shortHash(), build.date(), build.isSnapshot(), build.getVersion()
        );
        ...
        Build differentType = new Build(
            build.flavor(), otherType, build.shortHash(), build.date(), build.isSnapshot(), build.getVersion()
        );
        ...
        Build differentDate = new Build(
            build.flavor(), build.type(), build.shortHash(), "1970-01-01", build.isSnapshot(), build.getVersion()
        );

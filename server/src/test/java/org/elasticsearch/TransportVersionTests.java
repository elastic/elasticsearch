...
public class TransportVersionTests extends ESTestCase {
    ...
    public void testLatest() {
        TransportVersion latest = TransportVersion.parseFromBufferedReader("<test>",
    ...
    public void testSupports() {
        ...
        TransportVersion test0 = TransportVersion.fromBufferedReader("<test>", "testSupports0", false, new BufferedReader(
            new InputStreamReader(new ByteArrayInputStream(data0))), 5000000
        );
        ...
        TransportVersion test1 = TransportVersion.fromBufferedReader("<test>", "testSupports1", false, new BufferedReader(
            new InputStreamReader(new ByteArrayInputStream(data1))), 5000000
        );
        ...
        TransportVersion test2 = TransportVersion.fromBufferedReader("<test>", "testSupports2", false, new BufferedReader(
            new InputStreamReader(new ByteArrayInputStream(data2))), 5000000
        );
        ...
        TransportVersion test3 = TransportVersion.fromBufferedReader("<test>", "testSupports3", false, new BufferedReader(
            new InputStreamReader(new ByteArrayInputStream(data3))), 5000000
        );
        ...
        TransportVersion test4 = TransportVersion.fromBufferedReader("<test>", "testSupports3", false, new BufferedReader(
            new InputStreamReader(new ByteArrayInputStream(data4))), 5000000
        );

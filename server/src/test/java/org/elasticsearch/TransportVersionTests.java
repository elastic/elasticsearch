...
public class TransportVersionTests extends ESTestCase {
    ...
    public void testMin() {
        assertEquals(TransportVersionUtils.getPreviousVersion(), TransportVersion.min(TransportVersion.CURRENT, TransportVersionUtils.getPreviousVersion()));
        assertEquals(TransportVersion.fromId(1_01_01_99), TransportVersion.min(TransportVersion.fromId(1_01_01_99), TransportVersion.CURRENT));
        TransportVersion version = TransportVersionUtils.randomVersion(random());
        TransportVersion version1 = TransportVersionUtils.randomVersion(random());
...
//        for (int i = 0; i < iters; i++) {
//            TransportVersion version = TransportVersionUtils.randomVersion(random());
//            assertThat(TransportVersion.fromString(version.toString()), sameInstance(version));
//        }
//    }
...
//    }
    ...
    public void testToString() {
        ...
        assertEquals("5000099", TransportVersion.fromId(5_00_00_99).toString());
//        assertEquals("0.90.0",TransportVersion.fromId(0_90_0).toString());
    }

//    public void testParseVersion() {
//        final int iters = scaledRandomIntBetween(100, 1000);
//        for (int i = 0; i < iters; i++) {
//            Version version = TransportVersionUtils.randomVersion(random());

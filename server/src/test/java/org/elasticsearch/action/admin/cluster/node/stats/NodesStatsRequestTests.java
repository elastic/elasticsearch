...
public class NodesStatsRequestTests extends ESTestCase {
    ...
    public void testAddMetrics() throws Exception {
        ...
        String[] metrics = randomSubsetOf(NodesStatsMetrics.Metric.allMetrics()).toArray(String[]::new);
    ...
    public void testAddSingleMetric() throws Exception {
        ...
        request.addMetric(randomFrom(NodesStatsMetrics.Metric.allMetrics()));
        NodesStatsRequest deserializedRequest = roundTripRequest(request);
        assertRequestsEqual(request, deserializedRequest);
    }
    ...
    public void testRemoveSingleMetric() throws Exception {
        NodesStatsRequest request = new NodesStatsRequest();
        request.all();
        String metric = randomFrom(NodesStatsMetrics.Metric.allMetrics());
    ...
    public void testNodesInfoRequestAll() throws Exception {
        ...
        assertThat(request.requestedMetrics(), equalTo(NodesStatsMetrics.Metric.allMetrics()));
    }
    ...
    public void testUnknownMetricsRejected() {
        ...
        unknownMetrics.addAll(randomSubsetOf(NodesStatsMetrics.Metric.allMetrics()));
    ...
    public void testGetDescription() {
        ...
        request.clear();
        request.addMetrics(NodesStatsMetrics.Metric.OS.metricName(), NodesStatsMetrics.Metric.TRANSPORT.metricName());
        ...
        assertThat(
            ...
            allOf(
                ...
                containsString(NodesStatsMetrics.Metric.OS.metricName()),
                containsString(NodesStatsMetrics.Metric.TRANSPORT.metricName()),
                not(containsString(NodesStatsMetrics.Metric.SCRIPT.metricName())),

...
public class RestoreSnapshotRequestTests extends AbstractStreamableTestCase<RestoreSnapshotRequest> {
    ...
    @Override
    protected RestoreSnapshotRequest createBlankInstance() {

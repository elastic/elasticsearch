...
public class ConditionRamBytesUsedTests extends AbstractAccountableFieldsTestCase {
    ...
    protected Set<String> fieldsExcludedFromRamBytesUsed() {
        // type is one of a small set of shared Condition.Type enum singletons, so only its reference (part of the shallow size) is counted.
        return Set.of("type");
    }
    ...
    public void testRamBytesUsedCountsConditionValue() {
        ...
        assertThat(new MaxDocsCondition(1L).ramBytesUsed(), greaterThan(shallow));

...
public class GetSettingsResponseTests extends AbstractStreamableXContentTestCase<GetSettingsResponse> {
    ...
    public GetSettingsResponseTests() {
        ...
        indexNames = Collections.unmodifiableSet(names);
    }
    /*
    ...
    public void testRoundtrip622DropsDefaults() throws IOException {
        ...
        Assert.assertNotEquals(responseWithExtraFields, newResponse);
        Assert.assertEquals(getExpectedTest622Response(), newResponse);
    }
}

...
public class ShardBatchIndexerTests extends IndexShardTestCase {
    ...
    // TODO(columnar): this test asserted successful real-field batch indexing through the
    // now-removed row-major path. No field mapper supports columnar parsing yet (see
    // FieldMapper#supportsColumnarParse()), so ShardBatchMapper.mapColumnBatch always falls back
    // for the MAPPING used here (title/count/tag). Re-enable once field mappers support columnar
    // parsing.

...
public class SimulateProcessorResultTests extends AbstractXContentTestCase<SimulateProcessorResult> {
    ...
    static SimulateProcessorResult createTestInstance(boolean isSuccessful,
        ...
        if (isSuccessful) {
            ...
            if (isIgnoredException) {
                simulateProcessorResult = new SimulateProcessorResult(processorTag, null, null, true, ingestDocument,
                    new IllegalArgumentException("test"));
            } else {
                simulateProcessorResult = new SimulateProcessorResult(processorTag, null, null, true, ingestDocument);
            }
        } else {
            simulateProcessorResult = new SimulateProcessorResult(processorTag, null, null, true, null,
                new IllegalArgumentException("test"));
        }

...
public class TransportMultiTermVectorsActionTests extends ESTestCase {
    ...
    public static void beforeClass() throws Exception {
        ...
        shardAction = new TransportShardMultiTermsVectorAction(Settings.EMPTY,
            clusterService, transportService, mock(IndicesService.class), threadPool,
    ...
    public void testTransportMultiGetAction() {
        ...
        transportAction = new TransportMultiTermVectorsAction(Settings.EMPTY, threadPool, transportService, clusterService, shardAction,
            new ActionFilters(emptySet()), new Resolver()) {
            @Override

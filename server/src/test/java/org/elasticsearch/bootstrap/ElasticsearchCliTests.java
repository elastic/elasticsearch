...
public class ElasticsearchCliTests extends ESElasticsearchCliTestCase {
    ...
    private void runTestVersion(int expectedStatus, Consumer<String> outputConsumer, String... args) throws Exception {
        runTest(expectedStatus, false, outputConsumer, (foreground, pidFile, quiet, stdin, esSettings) -> {}, args);
    }
    ...
    private void runPidFileTest(final int expectedStatus, final boolean expectedInit, Consumer<String> outputConsumer,
        ...
        runTest(
                ...
                expectedInit,
                outputConsumer,
                (foreground, pidFile, quiet, stdin, esSettings) -> assertThat(pidFile.toString(), equalTo(expectedPidFile.toString())),
                args);
    }
    ...
    private void runDaemonizeTest(final boolean expectedDaemonize, final String... args) throws Exception {
        runTest(
                ...
                true,
                output -> {},
                (foreground, pidFile, quiet, stdin, esSettings) -> assertThat(foreground, equalTo(!expectedDaemonize)),
                args);
    }
    ...
    private void runQuietTest(final boolean expectedQuiet, final String... args) throws Exception {
        runTest(
                ...
                true,
                output -> {},
                (foreground, pidFile, quiet, stdin, esSettings) -> assertThat(quiet, equalTo(expectedQuiet)),
                args);
    }
    ...
    public void testElasticsearchSettings() throws Exception {
        runTest(
                ...
                true,
                output -> {},
                (foreground, pidFile, quiet, stdin, env) -> {
    ...
    public void testElasticsearchSettingCanNotBeDuplicated() throws Exception {
        runTest(
                ...
                (foreground, pidFile, quiet, stdin, initialEnv) -> {},
                "-E", "foo=bar", "-E", "foo=baz");
    }

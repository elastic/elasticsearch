...
public class ClusterChangedEventTests extends ESTestCase {
    ...
    public void testChangedCustomMetadataSet() {
        ...
        final ClusterState originalState = createState(numNodesInCluster, randomBoolean(), initialIndices);
        MetadataSection1 customMetadata1 = new MetadataSection1("data");
        ...
        nextState = nextState(originalState, Collections.singletonList(new MetadataSection1("data")));
        event = new ClusterChangedEvent("_na_", stateWithCustomMetadata, nextState);
        changedCustomMetadataTypeSet = event.changedCustomMetadataSet();
        assertTrue(changedCustomMetadataTypeSet.isEmpty());
        ...
        nextState = nextState(stateWithCustomMetadata, Collections.singletonList(new MetadataSection1("data1")));
        event = new ClusterChangedEvent("_na_", stateWithCustomMetadata, nextState);
        changedCustomMetadataTypeSet = event.changedCustomMetadataSet();
        assertTrue(changedCustomMetadataTypeSet.size() == 1);
        assertTrue(changedCustomMetadataTypeSet.contains(customMetadata1.getWriteableName()));
        ...
        MetadataSection2 customMetadata2 = new MetadataSection2("data2");
    ...
    private static class MetadataSection2 extends TestMetadataSection {
        protected MetadataSection2(String data) {
            super(data);
        }
    ...
    private static class MetadataSection1 extends TestMetadataSection {
        protected MetadataSection1(String data) {
            super(data);
        }
    ...
    private static ClusterState nextState(final ClusterState previousState, List<TestMetadataSection> customMetadataList) {

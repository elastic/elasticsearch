...
public class ClusterChangedEventTests extends ESTestCase {
    ...
    public void testProjectsDelta() {
        ...
        assertThat(event.projectDelta().initialized(), empty());
        ...
        assertThat(event.projectDelta().initialized(), containsInAnyOrder(finalizedIds.toArray()));
        assertThat(event.projectDelta().deleting(), empty());
        assertThat(event.projectDelta().deleted(), empty());
        ...
        assertThat(event.projectDelta().initialized(), containsInAnyOrder(toFinalize));

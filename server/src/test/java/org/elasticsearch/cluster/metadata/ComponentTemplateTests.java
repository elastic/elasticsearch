...
public class ComponentTemplateTests extends SimpleDiffableSerializationTestCase<ComponentTemplate> {
    ...
    public void testMappingsEquals() throws IOException {
...

        {
            ...
            CompressedXContent m1 = new CompressedXContent(org.elasticsearch.core.Strings.format("""
                {"properties":{"%s":{"type":"keyword"}}}
                """, randomString));
            CompressedXContent m2 = new CompressedXContent(org.elasticsearch.core.Strings.format("""
                {"properties":{"%s":{"type":"keyword"}}}
                """, randomString));
        ...
        {
            Map<String, Object> map = XContentHelper.convertToMap(new BytesArray(org.elasticsearch.core.Strings.format("""

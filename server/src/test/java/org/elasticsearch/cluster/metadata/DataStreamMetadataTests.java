...
public class DataStreamMetadataTests extends AbstractChunkedSerializingTestCase<DataStreamMetadata> {
    ...
    public void testWithAlias() {
        ...
        Map<String, DataStreamAlias> dataStream1AliasMap = resultDataStream1.getAliases();
        assertThat(dataStream1AliasMap.size(), equalTo(1));
        DataStreamAlias dataStreamAlias1 = dataStream1AliasMap.get("alias1");
        assertNotNull(dataStreamAlias1.getFilter());

        Map<String, DataStreamAlias> dataStream2AliasMap = resultDataStream2.getAliases();
        assertThat(dataStream2AliasMap.size(), equalTo(1));

...
public class DataStreamTests extends AbstractXContentSerializingTestCase<DataStream> {
    ...
    protected DataStream mutateInstance(DataStream instance) {
        ...
        switch (between(0, 16)) {
            ...
            case 15 -> {
                backingPendingIndices = randomValueOtherThan(backingPendingIndices, DataStreamTestHelper::randomIndexInstances);
            }
            case 16 -> {
                failurePendingIndices = randomValueOtherThan(failurePendingIndices, DataStreamTestHelper::randomIndexInstances);
            }
        }

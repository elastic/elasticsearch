...
public class DesiredNodeTests extends ESTestCase {
    public void testExternalIdIsRequired() {
        ...
        final IllegalArgumentException exception = expectThrows(
            ...
            () -> new DesiredNode(settings.build(), 1, ByteSizeValue.ofGb(1), ByteSizeValue.ofGb(1), Build.current().version())
        );
    ...
    public void testExternalIdFallbacksToNodeName() {
        ...
        DesiredNode desiredNode = new DesiredNode(settings, 1, ByteSizeValue.ofGb(1), ByteSizeValue.ofGb(1), Build.current().version());
    ...
    public void testNodeCPUsRoundUp() {
        ...
        {
            final var desiredNode = new DesiredNode(settings, 1.2, ByteSizeValue.ofGb(1), ByteSizeValue.ofGb(1), Build.current().version());
    ...
    public void testEqualsOrProcessorsCloseTo() {
        ...
        if (randomBoolean()) {
            desiredNode1 = new DesiredNode(settings, processorCount, memory, storage, Build.current().version());
            ...
            desiredNode1 = new DesiredNode(settings, desiredNodes1ProcessorsRange, memory, storage, Build.current().version());
            desiredNode2 = new DesiredNode(settings, desiredNodes2ProcessorsRange, memory, storage, Build.current().version());
        }

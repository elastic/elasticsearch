...
public class MetadataIndexTemplateServiceTests extends ESSingleNodeTestCase {
    ...
    public void testPutGlobalV2TemplateWhichResolvesIndexHiddenSetting() throws Exception {
        ...
        ComposableIndexTemplate globalIndexTemplate = new ComposableIndexTemplate(
            org.elasticsearch.core.List.of("*"),
            null,
            org.elasticsearch.core.List.of("ct-with-index-hidden-setting"),
            null,
            null,
            null,
            null,
        ...
        try {
            ...
            Metadata invalidGlobalTemplateMetadata = Metadata.builder()
                .putCustom(
                    ...
                    new ComposableIndexTemplateMetadata(org.elasticsearch.core.Map.of("invalid_global_template", invalidGlobalTemplate))
                )
                .build();
    ...
    public void testDefinedTimestampMappingIsAddedForDataStreamTemplates() throws Exception {
...

        {
            ComposableIndexTemplate it = new ComposableIndexTemplate(
                ...
                org.elasticsearch.core.List.of("ct1"),
                0L,
                1L,
                null,
            ...
            List<Map<String, Object>> parsedMappings = mappings.stream().map(m -> {
                try {
                    return MapperService.parseMapping(new NamedXContentRegistry(org.elasticsearch.core.List.of()), m.string());
                } catch (Exception e) {
                    logger.error(e);
                    fail("failed to parse mappings: " + m.string());
                    return null;
            ...
            Map<String, Object> firstParsedMapping = org.elasticsearch.core.Map.of(
                "_doc",
                org.elasticsearch.core.Map.of(
                    "properties",
                    org.elasticsearch.core.Map.of(DEFAULT_TIMESTAMP_FIELD, org.elasticsearch.core.Map.of("type", "date"))
                )
            );
            assertThat(parsedMappings.get(0), equalTo(firstParsedMapping));

            Map<String, Object> secondMapping = org.elasticsearch.core.Map.of(
                "_doc",
                org.elasticsearch.core.Map.of(
                    "properties",
                    org.elasticsearch.core.Map.of("field1", org.elasticsearch.core.Map.of("type", "keyword"))
                )
            );
            assertThat(parsedMappings.get(1), equalTo(secondMapping));

            Map<String, Object> thirdMapping = org.elasticsearch.core.Map.of(
                "_doc",
                org.elasticsearch.core.Map.of(
                    "properties",
                    org.elasticsearch.core.Map.of("field2", org.elasticsearch.core.Map.of("type", "integer"))
                )
            );
...

        {
            ...
            ComposableIndexTemplate it = new ComposableIndexTemplate(
                org.elasticsearch.core.List.of("timeseries*"),
                new Template(
                    null,
                    new CompressedXContent(
                        "{\n"
            ...
            Map<String, Object> firstMapping = org.elasticsearch.core.Map.of(
                "_doc",
                org.elasticsearch.core.Map.of(
                    "properties",
                    org.elasticsearch.core.Map.of("field1", org.elasticsearch.core.Map.of("type", "keyword"))
            ...
            firstMapping = org.elasticsearch.core.Map.of(
                "_doc",
                org.elasticsearch.core.Map.of(
                    "properties",
                    org.elasticsearch.core.Map.of("field1", org.elasticsearch.core.Map.of("type", "keyword"))
            ...
            secondMapping = org.elasticsearch.core.Map.of(
                "_doc",
                org.elasticsearch.core.Map.of(
                    "properties",
                    org.elasticsearch.core.Map.of("field2", org.elasticsearch.core.Map.of("type", "integer"))
    ...
    public void testUserDefinedMappingTakesPrecedenceOverDefault() throws Exception {
...

        {
            ...
            Map<String, Object> secondMapping = org.elasticsearch.core.Map.of(
                ...
                org.elasticsearch.core.Map.of(
                    "properties",
                    org.elasticsearch.core.Map.of(DEFAULT_TIMESTAMP_FIELD, org.elasticsearch.core.Map.of("type", "date_nanos"))
                )
            );
            assertThat(parsedMappings.get(1), equalTo(secondMapping));
        }

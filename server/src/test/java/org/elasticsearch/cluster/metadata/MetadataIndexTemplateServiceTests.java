    ...
    public void testV2TemplateOverlaps() throws Exception {
        {
            ...
            var overlaps = MetadataIndexTemplateService.v2TemplateOverlaps(state.metadata().templatesV2(), "foo2", newTemplate, false);
            ...
            IllegalArgumentException e = expectThrows(
                IllegalArgumentException.class,
                () -> MetadataIndexTemplateService.v2TemplateOverlaps(state.metadata().templatesV2(), "foo2", newTemplate, true)
            );
            assertThat(
                e.getMessage(),
                equalTo(
            ...
            overlaps = MetadataIndexTemplateService.v2TemplateOverlaps(state.metadata().templatesV2(), "no-conflict", nonConflict, true);

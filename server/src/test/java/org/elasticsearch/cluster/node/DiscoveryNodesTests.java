...
public class DiscoveryNodesTests extends ESTestCase {
    ...
    private enum NodeSelector {
        ...
        }, MASTER_ELIGIBLE(DiscoveryNode.MasterRole.INSTANCE.roleName() + ":true") {
            @Override
            Set<String> matchingNodeIds(DiscoveryNodes nodes) {
        ...
        }, DATA(DiscoveryNode.DataRole.INSTANCE.roleName() + ":true") {
            @Override
            Set<String> matchingNodeIds(DiscoveryNodes nodes) {
                Set<String> ids = new HashSet<>();
        ...
        }, INGEST(DiscoveryNode.IngestRole.INSTANCE.roleName() + ":true") {
            @Override
            Set<String> matchingNodeIds(DiscoveryNodes nodes) {
                Set<String> ids = new HashSet<>();

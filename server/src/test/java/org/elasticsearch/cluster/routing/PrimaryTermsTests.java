...
public class PrimaryTermsTests extends ESAllocationTestCase {
    ...
    private void initPrimaries() {
        ...
        ClusterState rerouteResult = allocationService.reroute(clusterState, "reroute", ActionListener.noop()).clusterState();
    ...
    private boolean startInitializingShards(String index) {
        final List<ShardRouting> startedShards = RoutingNodesHelper.shardsWithState(clusterState.getRoutingNodes(), index, INITIALIZING);
    ...
    private void addNodes() {
        ...
        applyRerouteResult(allocationService.reroute(this.clusterState, "nodes added", ActionListener.noop()).clusterState());

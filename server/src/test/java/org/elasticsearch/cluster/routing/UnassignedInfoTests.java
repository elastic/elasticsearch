...
public class UnassignedInfoTests extends ESAllocationTestCase {
    ...
    public void testStateTransitionMetaHandling() {
        ShardRouting shard = TestShardRouting.shardRoutingBuilder("test", 1, null, true, ShardRoutingState.UNASSIGNED)
            .withUnassignedInfo(new UnassignedInfo(UnassignedInfo.Reason.INDEX_CREATED, null))
            .build();

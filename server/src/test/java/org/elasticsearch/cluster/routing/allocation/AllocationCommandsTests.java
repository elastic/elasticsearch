...
public class AllocationCommandsTests extends ESAllocationTestCase {
    ...
    public void testCanceledShardIsInitializedRespectingAllocationDeciders() {
        ...
        ShardRouting primary = aShardRouting(shardId, "node-0", true, STARTED).withAllocationId(allocationId1).build();
        ShardRouting replica = aShardRouting(shardId, "node-1", false, STARTED).withAllocationId(allocationId2).build();

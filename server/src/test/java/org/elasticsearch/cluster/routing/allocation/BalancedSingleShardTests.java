...
public class BalancedSingleShardTests extends ESAllocationTestCase {
    ...
    public void testRebalanceNonStartedShardNotAllowed() {
        ...
        MoveDecision rebalanceDecision = allocator.decideShardAllocationExplain(
            shard,
    ...
    public void testRebalanceNotAllowedDuringPendingAsyncFetch() {
        ...
        MoveDecision rebalanceDecision = allocator.decideShardAllocationExplain(shard, routingAllocation).getMoveDecision();
    ...
    private MoveDecision executeRebalanceFor(
        ...
        return allocator.decideShardAllocationExplain(shardRouting, routingAllocation).getMoveDecision();
    }

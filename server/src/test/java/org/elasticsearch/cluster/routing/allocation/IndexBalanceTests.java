...
public class IndexBalanceTests extends ESAllocationTestCase {
    ...
    public void testBalanceAllNodesStarted() {
        ...
        assertThat(routingNodes.node("node1").shardsWithState("test", STARTED).count(), equalTo(2));
        assertThat(routingNodes.node("node2").shardsWithState("test", STARTED).count(), equalTo(2));
        assertThat(routingNodes.node("node3").shardsWithState("test", STARTED).count(), equalTo(2));

        assertThat(routingNodes.node("node1").shardsWithState("test1", STARTED).count(), equalTo(2));
        assertThat(routingNodes.node("node2").shardsWithState("test1", STARTED).count(), equalTo(2));
        assertThat(routingNodes.node("node3").shardsWithState("test1", STARTED).count(), equalTo(2));
    }
    ...
    public void testBalanceIncrementallyStartNodes() {
        ...
        assertThat(clusterState.getRoutingNodes().node("node1").shardsWithState("test", STARTED).count(), equalTo(2));
        assertThat(clusterState.getRoutingNodes().node("node2").shardsWithState("test", STARTED).count(), equalTo(2));
        assertThat(clusterState.getRoutingNodes().node("node3").shardsWithState("test", STARTED).count(), equalTo(2));

        assertThat(clusterState.getRoutingNodes().node("node1").shardsWithState("test1", STARTED).count(), equalTo(2));
        assertThat(clusterState.getRoutingNodes().node("node2").shardsWithState("test1", STARTED).count(), equalTo(2));
        assertThat(clusterState.getRoutingNodes().node("node3").shardsWithState("test1", STARTED).count(), equalTo(2));
    }

...
public class NodeVersionAllocationDeciderTests extends ESAllocationTestCase {
    ...
    public void testMessages() {
        ...
        RoutingAllocation routingAllocation = TestRoutingAllocationFactory.immutable(null, clusterState, null, null, 0);
        ...
        routingAllocation = TestRoutingAllocationFactory.mutable(null, routingNodes, clusterState, null, null, 0);
        routingAllocation.debugDecision(true);

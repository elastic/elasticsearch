...
public class AllocationDecidersTests extends ESTestCase {
    ...
    private void verifyDebugMode(RoutingAllocation.DebugMode mode, Matcher<Collection<? extends Decision>> matcher) {
        ...
        final RoutingAllocation allocation = new RoutingAllocation(deciders, clusterState, null, null, null, 0L);
    ...
    public void testEarlyTermination() {
        ...
        final RoutingAllocation allocation = new RoutingAllocation(allocationDeciders, clusterState, null, null, null, 0L);

...
public class DiskThresholdDeciderTests extends ESAllocationTestCase {
    ...
    private void doTestDiskThreshold(boolean testMaxHeadroom) {
        ...
        strategy = createAllocationService(clusterInfo, makeDecider(diskSettings.build()));
    ...
    public void testDiskThresholdWithAbsoluteSizes() {
        ...
        AllocationService strategy = createAllocationService(clusterInfo, makeDecider(diskSettings));
        ...
        strategy = createAllocationService(clusterInfo2, makeDecider(diskSettings));
    ...
    private void doTestDiskThresholdWithShardSizes(boolean testMaxHeadroom) {
        ...
        AllocationService strategy = createAllocationService(clusterInfo, makeDecider(diskSettings.build()));
    ...
    private void doTestShardRelocationsTakenIntoAccount(boolean testMaxHeadroom) {
        ...
        ClusterState clusterState = ClusterState.builder(ClusterName.CLUSTER_NAME_SETTING.getDefault(Settings.EMPTY))
            ...
            .routingTable(RoutingTable.builder().addAsNew(indexMetadata1).addAsNew(indexMetadata2).build())
            .build();

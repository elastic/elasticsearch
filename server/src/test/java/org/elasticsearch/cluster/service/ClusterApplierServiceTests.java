...
public class ClusterApplierServiceTests extends ESTestCase {
    ...
    public void testClusterStateUpdateLogging() throws Exception {
        ...
        try {
            ...
            clusterApplierService.runOnApplierThread("test3", Priority.HIGH, currentState -> {}, new ActionListener<Void>() {
                @Override
                public void onResponse(Void ignored) {}
    ...
    public void testLongClusterStateUpdateLogging() throws Exception {
        ...
        try {
            ...
            clusterApplierService.runOnApplierThread("test4", Priority.HIGH, currentState -> {}, new ActionListener<Void>() {
                @Override
                public void onResponse(Void ignored) {
                    latch.countDown();
                }

...
public class VersionsTests extends ESTestCase {
    ...
    public void testVersions() throws Exception {
        ...
        doc = new Document();
        Field uid = new Field(IdFieldMapper.NAME, "1", StandardIdFieldMapper.Defaults.FIELD_TYPE);
    ...
    public void testNestedDocuments() throws IOException {
        ...
        for (int i = 0; i < 4; ++i) {
            // Nested
            Document doc = new Document();
            doc.add(new Field(IdFieldMapper.NAME, "1", StandardIdFieldMapper.Defaults.NESTED_FIELD_TYPE));
            docs.add(doc);
        }
        // Root
        Document doc = new Document();
    ...
    public void testCache() throws Exception {
        ...
        IndexWriter writer = new IndexWriter(dir, new IndexWriterConfig(Lucene.STANDARD_ANALYZER));
        Document doc = new Document();
        doc.add(new Field(IdFieldMapper.NAME, "6", StandardIdFieldMapper.Defaults.FIELD_TYPE));

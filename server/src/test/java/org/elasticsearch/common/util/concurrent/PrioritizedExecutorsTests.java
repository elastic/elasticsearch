...
public class PrioritizedExecutorsTests extends ESTestCase {
    ...
    public void testSubmitPrioritizedExecutorWithRunnables() throws Exception {
        ExecutorService executor = EsExecutors.newSinglePrioritizing(
            getName(),
            EsExecutors.testOnlyDaemonThreadFactory(getTestName()),
            holder,
            null
        );
    ...
    public void testTimeout() throws Exception {
        ScheduledExecutorService timer = Executors.newSingleThreadScheduledExecutor(EsExecutors.testOnlyDaemonThreadFactory(getTestName()));

...
public class TaskExecutionTimeTrackingEsThreadPoolExecutorTests extends ESTestCase {
    ...
    public void testExecutionEWMACalculation() throws Exception {
        ...
        TaskExecutionTimeTrackingEsThreadPoolExecutor executor = new TaskExecutionTimeTrackingEsThreadPoolExecutor(
            ...
            context,
            randomBoolean() ?
                EsExecutors.TaskTrackingConfig.builder().trackOngoingTasks().trackExecutionTime(DEFAULT_EXECUTION_TIME_EWMA_ALPHA_FOR_TEST).build() :
    ...
    public void testMaxQueueLatency() throws Exception {
        ...
        TaskExecutionTimeTrackingEsThreadPoolExecutor executor = new TaskExecutionTimeTrackingEsThreadPoolExecutor(
            ...
            context,
            randomBoolean() ?
                EsExecutors.TaskTrackingConfig.builder().trackOngoingTasks().trackMaxQueueLatency().trackExecutionTime(DEFAULT_EXECUTION_TIME_EWMA_ALPHA_FOR_TEST).build() :
                EsExecutors.TaskTrackingConfig.builder().trackMaxQueueLatency().trackExecutionTime(DEFAULT_EXECUTION_TIME_EWMA_ALPHA_FOR_TEST).build()
        );
        try {
            executor.prestartAllCoreThreads();
            logger.info("--> executor: {}", executor);

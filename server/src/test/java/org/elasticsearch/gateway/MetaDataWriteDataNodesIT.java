...
public class MetaDataWriteDataNodesIT extends ESIntegTestCase {
    ...
    public void testMetaWrittenWhenIndexIsClosedAndMetaUpdated() throws Exception {
        ...
        assertNotNull(((LinkedHashMap) (getMappingsResponse.getMappings().get(index).get("_doc").getSourceAsMap().get("properties")))
            .get("integer_field"));
        ...
        assertNotNull(((LinkedHashMap) (indicesMetaData.get(index).getMappings().get("_doc").getSourceAsMap().get("properties")))
            .get("integer_field"));

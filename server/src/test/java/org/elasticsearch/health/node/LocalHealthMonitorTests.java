...
public class LocalHealthMonitorTests extends ESTestCase {
    ...
    public void setUp() throws Exception {
        ...
        frozenNode = TestDiscoveryNode.builder("frozen-node").name("frozen-node").roles(Set.of(DiscoveryNodeRole.DATA_FROZEN_NODE_ROLE)).build();
    ...
    public void testYellowStatusForNonDataNode() {
        DiscoveryNode dedicatedMasterNode = TestDiscoveryNode.builder("master-node-1").name("master-node").roles(Set.of(DiscoveryNodeRole.MASTER_ROLE)).build();

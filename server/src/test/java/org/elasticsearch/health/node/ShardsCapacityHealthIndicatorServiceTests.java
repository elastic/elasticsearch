...
public class ShardsCapacityHealthIndicatorServiceTests extends ESTestCase {
    ...
    public void setUp() throws Exception {
        ...
        dataNode = TestDiscoveryNode.builder("data_node").name("data_node").roles(Set.of(DiscoveryNodeRole.MASTER_ROLE, DiscoveryNodeRole.DATA_ROLE)).build();

        frozenNode = TestDiscoveryNode.builder("frozen_node").name("frozen_node").roles(Set.of(DiscoveryNodeRole.DATA_FROZEN_NODE_ROLE)).build();

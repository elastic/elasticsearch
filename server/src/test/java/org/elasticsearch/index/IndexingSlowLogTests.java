...
public class IndexingSlowLogTests extends ESTestCase {
    ...
    public void testLevelPrecedence() {
        ...
        IndexingSlowLog log = new IndexingSlowLog(settings, mock(ActionLogFields.class));
    ...
    public void testTwoLoggersDifferentLevel() {
        ...
        IndexingSlowLog log1 = new IndexingSlowLog(index1Settings, mock(ActionLogFields.class));
        ...
        IndexingSlowLog log2 = new IndexingSlowLog(index2Settings, mock(ActionLogFields.class));
    ...
    public void testReformatSetting() {
        ...
        log = new IndexingSlowLog(settings, mock(ActionLogFields.class));
        assertTrue(log.isReformat());
        try {
            settings.updateIndexMetadata(
                newIndexMeta(

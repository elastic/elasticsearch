...
public class SearchSlowLogTests extends ESSingleNodeTestCase {
    ...
    public void testLevelPrecedence() {
        try (SearchContext ctx = searchContextWithSourceAndTask(createIndex("index"))) {
            ...
            SearchSlowLog log = new SearchSlowLog(settings, mock(ActionLogFields.class));
    ...
    public void testTwoLoggersDifferentLevel() {
        try (
            ...
            SearchSlowLog log1 = new SearchSlowLog(settings1, mock(ActionLogFields.class));
            ...
            SearchSlowLog log2 = new SearchSlowLog(settings2, mock(ActionLogFields.class));
    ...
    public void testSetQueryLevels() {
        ...
        log = new SearchSlowLog(settings, mock(ActionLogFields.class));

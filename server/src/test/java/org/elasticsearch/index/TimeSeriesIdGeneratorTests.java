...
public class TimeSeriesIdGeneratorTests extends ESTestCase {
    ...
    private ObjectComponent objectComponentForDimensions(Map<?, ?> docDimensions) {
        ...
        return new ObjectComponent(subs);
    }
    ...
    private TimeSeriesIdGenerator.Component componentForRepresentativeValue(Object value) {
        ...
        if (value instanceof Number) {
            return NumberType.LONG.timeSeriesIdGenerator(null, false);
        }

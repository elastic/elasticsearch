...
public class AnalysisRegistryTests extends ESTestCase {
    ...
    public void testOverrideDefaultAnalyzerWithoutAnalysisModeAll() throws IOException {
        ...
        MapperException ex = expectThrows(MapperException.class, () -> emptyRegistry.build(IndexSettingsModule.newIndexSettings("index", settings),
                singletonMap("default", new PreBuiltAnalyzerProvider("my_analyzer", AnalyzerScope.INDEX, analyzer)), emptyMap(), emptyMap(),
                emptyMap(), emptyMap()));

...
public class DemoTokenizerFactory extends AbstractTokenizerFactory {
    public DemoTokenizerFactory(IndexSettings indexSettings, Environment environment, Settings settings, String name) {
        super(indexSettings, settings, name);
    }

    @Override
    public Tokenizer create() {
        return new UAX29URLEmailTokenizer(newAttributeFactory());
    }
}

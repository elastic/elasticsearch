...
public class CodecTests extends ESTestCase {
    ...
    private CodecService createCodecService() throws IOException {
        ...
        boolean autoGeneratedId = IndexSettings.TIME_SERIES_USE_AUTO_GENERATED_ID.get(settings.getSettings());
        MapperService service = new MapperService(
            ...
            mapperRegistry,
            () -> null,
            settings.getMode().idFieldMapperWithoutFieldData(autoGeneratedId),
            ScriptCompiler.NONE
        );

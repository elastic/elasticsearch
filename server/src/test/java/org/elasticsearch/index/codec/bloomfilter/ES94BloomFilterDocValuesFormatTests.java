...
import static org.elasticsearch.index.codec.bloomfilter.ES94BloomFilterDocValuesFormat.LOW_BPD;
...
public class ES94BloomFilterDocValuesFormatTests extends ESTestCase {
    ...
    public void testBloomFilterSizing() {
        ...
        int maxDocsBeforeCap = (int) (MAX_BLOOM_FILTER_SIZE.getBytes() * Byte.SIZE / LOW_BPD);
        assertThat(

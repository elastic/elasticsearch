 ...
 *
 * <p>Worth its own test because it is the only place the two are put side by side: a suite that runs queries over real
 * columns checks the answers, not which of the two ways of reading produced them.
 */

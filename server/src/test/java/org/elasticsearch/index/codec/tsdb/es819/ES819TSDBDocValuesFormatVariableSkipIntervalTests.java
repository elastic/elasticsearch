...
public class ES819TSDBDocValuesFormatVariableSkipIntervalTests extends ES87TSDBDocValuesFormatVariableSkipIntervalTests {
    ...
    protected Codec getCodec() {
        ...
        return TestUtil.alwaysDocValuesFormat(
            new ES819TSDBDocValuesFormat(random().nextInt(4, 16), random().nextInt(1, 32), random().nextBoolean(), ES819TSDBDocValuesFormatTests.randomBinaryCompressionMode())
        );
    }
    ...
    public void testSkipIndexIntervalSize() {
        IllegalArgumentException ex = expectThrows(
            ...
            () -> new ES819TSDBDocValuesFormat(random().nextInt(Integer.MIN_VALUE, 2), random().nextInt(1, 32), random().nextBoolean(), ES819TSDBDocValuesFormatTests.randomBinaryCompressionMode())
        );

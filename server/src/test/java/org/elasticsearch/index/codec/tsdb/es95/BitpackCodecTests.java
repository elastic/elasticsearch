...
/**
 * Payload round-trip and corruption tests for {@link BitpackCodec}.
 * Covers a narrow-range block (small local bits relative to segment
 * width) and a malformed wire payload whose stored bit width exceeds 63.
 */
public class BitpackCodecTests extends ESTestCase {
    ...
    public void testPayloadRoundTripNarrowRange() throws Exception {
        ...
        BitpackCodec.INSTANCE.decodePayload(ctx, new ByteBuffersDataInput(out.toBufferList()), decoded, 16);

...
public class StaticPipelineConfigResolverTests extends ESTestCase {
    ...
    public void testIpDimensionFieldUsesBlockSize4096() {
        final StaticPipelineConfigResolver resolver = StaticPipelineConfigResolver.INSTANCE;
        final FieldContext context = new FieldContext(
            randomFrom(128, 512),
            randomNonTimestampFieldName(),
        ...
        assertEquals(4096, config.blockSize());
    }

    public void testKeywordDimensionFieldUsesBlockSize4096() {
        final StaticPipelineConfigResolver resolver = StaticPipelineConfigResolver.INSTANCE;
        final FieldContext context = new FieldContext(
            randomFrom(128, 512),
            randomNonTimestampFieldName(),
    ...
    public void testIpDimensionBlockSize4096IsCached() {
        final StaticPipelineConfigResolver resolver = StaticPipelineConfigResolver.INSTANCE;
        ...
        assertSame(first, second);
        assertEquals(4096, first.blockSize());
    }

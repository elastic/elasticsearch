...
public class ES816TSDBDocValuesEncoderTests extends LuceneTestCase {

    private final ES816TSDBDocValuesEncoder encoder;
    private final int blockSize = ES816TSDBDocValuesFormat.NUMERIC_BLOCK_SIZE;

    public ES816TSDBDocValuesEncoderTests() {
        this.encoder = new ES816TSDBDocValuesEncoder();
    }

...
public abstract class BaseQuantizedBFloat16KnnVectorsFormatTestCase extends BaseBFloat16KnnVectorsFormatTestCase {
    ...
    public void testRescoreUsesRawVectorSlice() throws IOException {
        ...
        try (Directory dir = newDirectory()) {
            ...
            try {
                ...
                assertThat(vectorValues.getVectorByteLength(), equalTo(dimension * BFloat16.BYTES));

                float[] expected = Arrays.copyOf(vector, vector.length);
                for (int i = 0; i < expected.length; i++) {
                    expected[i] = BFloat16.truncateToBFloat16(expected[i]);
                }
                ...
                BFloat16.bFloat16ToFloat(sliceBytes, sliceValues);

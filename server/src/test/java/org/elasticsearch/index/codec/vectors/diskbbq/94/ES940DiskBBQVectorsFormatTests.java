...
public class ES940DiskBBQVectorsFormatTests extends BaseKnnVectorsFormatTestCase {
    ...
    public void testToString() {
        FilterCodec customCodec = new FilterCodec("foo", Codec.getDefault()) {
            ...
            public KnnVectorsFormat knnVectorsFormat() {
                return new ES940DiskBBQVectorsFormat(128, 4);
            }
        };
        String expectedPattern = "ES940DiskBBQVectorsFormat(vectorPerCluster=128, mergeExec=false)";
    ...
    public void testLimits() {
        expectThrows(IllegalArgumentException.class, () -> new ES940DiskBBQVectorsFormat(MIN_VECTORS_PER_CLUSTER - 1, 16));

...
public class ManifoldExpectedRecallIntegrationTests extends ESTestCase {
    ...
    public void testSimilarityFunctionsComposeWithExpectedRecall() throws IOException {
        ...
        double[] dotManifold = estimateManifold(fixture, VectorSimilarityFunction.DOT_PRODUCT, numVectors);
    ...
    private static double expectedRecallForEncoding(
        ...
        double[] manifold = estimateManifold(fixture, similarityFunction, numVectors);
    ...
    private static double[] estimateManifold(CalibrationFixture fixture, VectorSimilarityFunction similarityFunction, int numVectors)
        throws IOException {

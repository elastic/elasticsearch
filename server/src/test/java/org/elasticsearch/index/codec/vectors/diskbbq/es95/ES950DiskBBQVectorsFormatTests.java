...
public class ES950DiskBBQVectorsFormatTests extends BaseKnnVectorsFormatTestCase {
    ...
    public void setUp() throws Exception {
        ...
        if (rarely()) {
            ...
            int flatVectorThreshold = disableFlatOnFlush ? 0 : ES950DiskBBQVectorsFormat.defaultFlatThreshold(vectorPerCluster);
    ...
    public void testToString() {
        FilterCodec customCodec = new FilterCodec("foo", Codec.getDefault()) {
            ...
            public KnnVectorsFormat knnVectorsFormat() {
                return new ES950DiskBBQVectorsFormat(128, 4, null);
            }
        };
        String expectedPattern = "ES950DiskBBQVectorsFormat(vectorPerCluster=128, mergeExec=false, sliceField=null)";
    ...
    public void testLimits() {
        expectThrows(IllegalArgumentException.class, () -> new ES950DiskBBQVectorsFormat(MIN_VECTORS_PER_CLUSTER - 1, 16, null));
        expectThrows(IllegalArgumentException.class, () -> new ES950DiskBBQVectorsFormat(MAX_VECTORS_PER_CLUSTER + 1, 16, null));
        expectThrows(IllegalArgumentException.class, () -> new ES950DiskBBQVectorsFormat(128, MIN_CENTROIDS_PER_PARENT_CLUSTER - 1, null));
        expectThrows(IllegalArgumentException.class, () -> new ES950DiskBBQVectorsFormat(128, MAX_CENTROIDS_PER_PARENT_CLUSTER + 1, null));
    }
    ...
    private void doTestSlices(BooleanSupplier supplier, boolean applyFilter) throws IOException {
        ...
        int vectorPerCluster = random().nextInt(MIN_VECTORS_PER_CLUSTER, 2 * MIN_VECTORS_PER_CLUSTER);
        ES950DiskBBQVectorsFormat localFormat = new ES950DiskBBQVectorsFormat(
            encoding,
            vectorPerCluster,
            random().nextInt(MIN_CENTROIDS_PER_PARENT_CLUSTER, MAX_CENTROIDS_PER_PARENT_CLUSTER),
            DenseVectorFieldMapper.ElementType.FLOAT,

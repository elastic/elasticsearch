...
public class ES950DiskBBQVectorsFormatTests extends ESBaseKnnVectorsFormatTestCase {
    ...
    public void testToString() {
        FilterCodec customCodec = new FilterCodec("foo", Codec.getDefault()) {
            ...
            public KnnVectorsFormat knnVectorsFormat() {
                return new ES950DiskBBQVectorsFormat(128, 4);
            }
        };
        String expectedPattern = "ES950DiskBBQVectorsFormat(vectorPerCluster=128, mergeExec=false)";
    ...
    public void testLimits() {
        expectThrows(IllegalArgumentException.class, () -> new ES950DiskBBQVectorsFormat(MIN_VECTORS_PER_CLUSTER - 1, 16));
        expectThrows(IllegalArgumentException.class, () -> new ES950DiskBBQVectorsFormat(MAX_VECTORS_PER_CLUSTER + 1, 16));
        expectThrows(IllegalArgumentException.class, () -> new ES950DiskBBQVectorsFormat(128, MIN_CENTROIDS_PER_PARENT_CLUSTER - 1));
        expectThrows(IllegalArgumentException.class, () -> new ES950DiskBBQVectorsFormat(128, MAX_CENTROIDS_PER_PARENT_CLUSTER + 1));
    }

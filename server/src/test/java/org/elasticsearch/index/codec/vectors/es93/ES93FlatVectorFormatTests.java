...
public class ES93FlatVectorFormatTests extends ESBaseKnnVectorsFormatTestCase {
    ...
    protected Codec getCodec() {
        return TestUtil.alwaysKnnVectorsFormat(new ES93FlatVectorFormat(elementType, false));
    }

...
public class ScriptDocValuesGeoPointsTests extends ESTestCase {
    ...
    public void testGeoGetLatLon() throws IOException {
        ...
        final ScriptDocValues.GeoPoints script = (GeoPoints) new GeoPointField(values, "test").getScriptDocValues();
    ...
    public void testGeoDistance() throws IOException {
        ...
        final ScriptDocValues.GeoPoints emptyScript = (GeoPoints) new GeoPointField(wrap(points2), "test").getScriptDocValues();
    ...
    public void testMissingValues() throws IOException {
        ...
        final ScriptDocValues.GeoPoints geoPoints = (GeoPoints) new GeoPointField(wrap(points), "test").getScriptDocValues();
        for (int d = 0; d < points.length; d++) {

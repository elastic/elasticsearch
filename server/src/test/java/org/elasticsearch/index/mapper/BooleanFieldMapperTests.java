...
public class BooleanFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testFetchValues() throws IOException {
        ...
        assertThat(fetchFromSource(mapper, null, true), equalTo(List.of(true)));
        assertThat(fetchFromSource(mapper, null, false), equalTo(List.of(false)));
        assertThat(fetchFromSource(mapper, null, "false"), equalTo(List.of(false)));
        assertThat(fetchFromSource(mapper, null, ""), equalTo(List.of(false)));
        ...
        assertEquals(List.of(true), fetchFromSource(nullValueMapper, null, null));
    }
}

...
public class BooleanFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testParsesBooleansStrict() throws IOException {
        ...
        MapperParsingException ex = expectThrows(MapperParsingException.class,
                () -> defaultMapper.parse(SourceToParse.source("test", "type", "1", null, source, XContentType.JSON)));
    ...
    public void testMultiFields() throws IOException {
        ...
        BytesReference source = BytesReference.bytes(XContentFactory.jsonBuilder()
                .startObject()
                    .field("field", false)
                .endObject());
        ParsedDocument doc = mapper.parse(SourceToParse.source("test", "type", "1", null, source, XContentType.JSON));
    ...
    public void testDocValues() throws Exception {
        ...
        ParsedDocument parsedDoc = defaultMapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference
                .bytes(XContentFactory.jsonBuilder()
                        .startObject()
                        .field("bool1", true)
                        .field("bool2", true)

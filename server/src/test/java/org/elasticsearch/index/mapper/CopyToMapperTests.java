...
public class CopyToMapperTests extends ESSingleNodeTestCase {
    ...
    public void testCopyToFieldsParsing() throws Exception {
        ...
        ParsedDocument parsedDoc = docMapper.parse(SourceToParse.source("test", "type1", "1", null, json, XContentType.JSON));
    ...
    public void testCopyToFieldsInnerObjectParsing() throws Exception {
        ...
        ParseContext.Document doc = docMapper.parse(SourceToParse.source("test", "type1", "1", null, json,
    ...
    public void testCopyToStrictDynamicInnerObjectParsing() throws Exception {
        ...
        try {
            docMapper.parse(SourceToParse.source("test", "type1", "1", null, json, XContentType.JSON)).rootDoc();
            fail();
    ...
    public void testCopyToNestedField() throws Exception {
        ...
        ParsedDocument doc = mapper.parse(SourceToParse.source("test", "type", "1",
            null, BytesReference.bytes(jsonDoc), XContentType.JSON));

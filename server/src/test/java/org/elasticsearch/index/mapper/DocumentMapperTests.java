...
public class DocumentMapperTests extends MapperServiceTestCase {
    ...
    public void testMergeSearchAnalyzer() throws Exception {
        ...
        assertThat(mapperService.mappedField("field").getTextSearchInfo().searchAnalyzer().name(), equalTo("whitespace"));
    ...
    public void testChangeSearchAnalyzerToDefault() throws Exception {
        ...
        assertThat(mapperService.mappedField("field").getTextSearchInfo().searchAnalyzer().name(), equalTo("default"));
    }

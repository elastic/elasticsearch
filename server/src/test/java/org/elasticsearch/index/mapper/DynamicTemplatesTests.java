...
public class DynamicTemplatesTests extends MapperServiceTestCase {
    ...
    public void testSubobjectFalseDynamicNestedNotAllowed() throws IOException {
        ...
        IllegalArgumentException err = expectThrows(IllegalArgumentException.class, () -> mapper.parse(source("""
            ...
            """)));
        assertEquals("Object [metrics] has subobjects set to false hence it does not support inner object [object]", err.getMessage());
    }
    ...
    public void testRootSubobjectFalseDynamicNestedNotAllowed() throws IOException {
        ...
        IllegalArgumentException err = expectThrows(IllegalArgumentException.class, () -> mapper.parse(source("""
            ...
            """)));
        assertEquals("Object [_doc] has subobjects set to false hence it does not support inner object [object]", err.getMessage());
    }
    ...
    public void testSubobjectsFalseWithInnerNestedFromDynamicTemplate() {
        ...
        assertThat(exception.getRootCause(), instanceOf(IllegalArgumentException.class));
        assertEquals(
            "Object [__dynamic__test] has subobjects set to false hence it does not support inner object [time]",

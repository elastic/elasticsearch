...
public class GeoPointFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        MappedField mapper = new GeoPointFieldMapper.Builder("field", ScriptCompiler.NONE, ignoreMalformed, Version.CURRENT).build(
    ...
    public void testFetchVectorTile() throws IOException {
        MappedField mapper = new GeoPointFieldMapper.Builder("field", ScriptCompiler.NONE, false, Version.CURRENT).build(
            MapperBuilderContext.ROOT
        ).field();

...
public class GeoPointScriptFieldTypeTests extends AbstractNonTextScriptFieldTypeTestCase {
    ...
    public void testDocValues() throws IOException {
        try (Directory directory = newDirectory(); RandomIndexWriter iw = new RandomIndexWriter(random(), directory)) {
            ...
            try (DirectoryReader reader = iw.getReader()) {
                ...
                GeoPointScriptFieldData ifd = (GeoPointScriptFieldData) mappedField.fielddataBuilder("test", mockContext()::lookup)
                    .build(null, null);
    ...
    public void testSort() throws IOException {
        GeoPointScriptFieldData ifd = (GeoPointScriptFieldData) simpleMappedField().fielddataBuilder("test", mockContext()::lookup)
            .build(null, null);

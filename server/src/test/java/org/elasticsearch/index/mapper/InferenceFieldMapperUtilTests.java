...
public class InferenceFieldMapperUtilTests extends ESTestCase {
    public void testInsertValueMapTraversal() throws IOException {
        {
            ...
            InferenceFieldMapperUtil.insertValue("test", map, "value2");
            assertThat(getMapValue(map, "test"), equalTo("value2"));
            InferenceFieldMapperUtil.insertValue("something.else", map, "something_else_value");
        ...
        }
        {
            ...
            Map<String, Object> map = toSourceMap(Strings.toString(builder));
            InferenceFieldMapperUtil.insertValue("path1.path2.test", map, "value2");
            assertThat(getMapValue(map, "path1.path2.test"), equalTo("value2"));
            InferenceFieldMapperUtil.insertValue("path1.path2.test_me", map, "test_me_value");
            assertThat(getMapValue(map, "path1.path2.test_me"), equalTo("test_me_value"));
            InferenceFieldMapperUtil.insertValue("path1.non_path2.test", map, "test_value");
            assertThat(getMapValue(map, "path1.non_path2\\.test"), equalTo("test_value"));

            InferenceFieldMapperUtil.insertValue("path1.path2", map, Map.of("path3", "bar"));
            assertThat(getMapValue(map, "path1.path2"), equalTo(Map.of("path3", "bar")));

            InferenceFieldMapperUtil.insertValue("path1", map, "baz");
            assertThat(getMapValue(map, "path1"), equalTo("baz"));

            InferenceFieldMapperUtil.insertValue("path3.path4", map, Map.of("test", "foo"));
        ...
        }
        {
            ...
            InferenceFieldMapperUtil.insertValue("path1.test", map, List.of("value3", "value4", "value5"));
            assertThat(getMapValue(map, "path1.test"), equalTo(List.of("value3", "value4", "value5")));

            InferenceFieldMapperUtil.insertValue("path2.test", map, List.of("value6", "value7", "value8"));
    ...
    public void testInsertValueListTraversal() throws IOException {
        {
            ...
            InferenceFieldMapperUtil.insertValue("path1.path2.test", map, "value2");
            assertThat(getMapValue(map, "path1.path2.test"), equalTo("value2"));
            InferenceFieldMapperUtil.insertValue("path1.path2.test2", map, "value3");
            ...
            InferenceFieldMapperUtil.insertValue("path3.path4.test", map, "value4");
    ...
    public void testInsertValueFieldsWithDots() throws IOException {
        {
            ...
            InferenceFieldMapperUtil.insertValue("xxx.yyy", map, "value2");
            assertThat(getMapValue(map, "xxx\\.yyy"), equalTo("value2"));

            InferenceFieldMapperUtil.insertValue("xxx", map, "value3");
        ...
        }
        {
            ...
            InferenceFieldMapperUtil.insertValue("path1.path2.path3.path4.test", map, "value2");
            assertThat(getMapValue(map, "path1\\.path2.path3\\.path4.test"), equalTo("value2"));

            InferenceFieldMapperUtil.insertValue("path1.path2.path3.path4.test2", map, "value3");
    ...
    public void testInsertValueAmbiguousPath() throws IOException {
        // Mixed dotted object notation
        {
            ...
            IllegalArgumentException ex = assertThrows(
                ...
                () -> InferenceFieldMapperUtil.insertValue("path1.path2.path3.test1", map, "value3")
            );
            assertThat(
                ex.getMessage(),
            ...
            ex = assertThrows(
                IllegalArgumentException.class,
                () -> InferenceFieldMapperUtil.insertValue("path1.path2.path3.test3", map, "value4")
            );
            assertThat(
                ex.getMessage(),
    ...
    public void testInsertValueCannotTraversePath() throws IOException {
        ...
        IllegalArgumentException ex = assertThrows(
            IllegalArgumentException.class,
            () -> InferenceFieldMapperUtil.insertValue("path1.path2.test.test2", map, "value2")
        );
        assertThat(
            ex.getMessage(),

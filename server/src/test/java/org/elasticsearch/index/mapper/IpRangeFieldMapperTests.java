...
public class IpRangeFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testParseSourceValue() throws IOException {
        ...
        assertEquals(List.of(Map.of("gte", "2001:db8::2:1")), fetchFromSource(mapper, null, range));
        assertEquals(List.of("2001:db8::2:1/32"), fetchFromSource(mapper, null, "2001:db8:0:0:0:0:2:1/32"));
    }
}

...
public class MappingLookupTests extends ESTestCase {
    ...
    public void testOnlyRuntimeField() {
        ...
        assertThat(mappingLookup.mappedFieldsLookup().get("test").type(), instanceOf(TestRuntimeField.TestRuntimeFieldType.class));
    }
    ...
    public void testSubfieldOverride() {
        ...
        assertThat(
            mappingLookup.mappedFieldsLookup().get("object.subfield").type(),
            instanceOf(TestRuntimeField.TestRuntimeFieldType.class)
        );
    }

...
public class MappingLookupTests extends ESTestCase {
    ...
    public void testOnlyRuntimeField() {
        ...
        assertThat(mappingLookup.fieldTypesLookup().get("test").type(), instanceOf(TestRuntimeField.TestRuntimeFieldType.class));
    }
    ...
    public void testSubfieldOverride() {
        ...
        assertThat(mappingLookup.fieldTypesLookup().get("object.subfield").type(), instanceOf(TestRuntimeField.TestRuntimeFieldType.class));
    }

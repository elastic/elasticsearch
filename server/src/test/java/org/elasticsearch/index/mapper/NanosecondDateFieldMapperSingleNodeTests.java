...
public class NanosecondDateFieldMapperSingleNodeTests extends ESSingleNodeTestCase {
    ...
    public void testDefaults() throws Exception {
        String mapping = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("type")
            .startObject("properties").startObject("field").field("type", NanosecondDateFieldMapper.CONTENT_TYPE).endObject().endObject()
            .endObject().endObject());
        ...
        assertEquals(1457654400000000000L, pointField.numericValue().longValue());
        IndexableField dvField = fields[1];
        assertEquals(DocValuesType.SORTED_NUMERIC, dvField.fieldType().docValuesType());
        assertEquals(1457654400000000000L, dvField.numericValue().longValue());
        assertFalse(dvField.fieldType().stored());
    }

    public void testNotIndexed() throws Exception {
        String mapping = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("type")
            .startObject("properties").startObject("field").field("type", NanosecondDateFieldMapper.CONTENT_TYPE)
    ...
    public void testStore() throws Exception {
        ...
        assertEquals(1457654400000000000L, storedField.numericValue().longValue());
    }
    ...
    public void testIgnoreMalformed() throws Exception {
        ...
        assertThat(e.getCause().getMessage(),
            containsString("failed to parse date field [2016-03-99] with format [strict_date_optional_time_nanos||epoch_millis]"));
    ...
    public void testNullValue() throws IOException {
        String mapping = Strings.toString(XContentFactory.jsonBuilder().startObject()
            ...
            .startObject("field")
            .field("type", NanosecondDateFieldMapper.CONTENT_TYPE)
            .endObject()
            .endObject()
            .endObject().endObject());
    ...
    public void testEmptyName() throws IOException {
        String mapping = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("type")
            .startObject("properties").startObject("").field("type", NanosecondDateFieldMapper.CONTENT_TYPE)
            .field("format", "epoch_second").endObject().endObject()
            .endObject().endObject());
    ...
    public void testTimeZoneParsing() throws Exception {
        ...
        long nanos = toLong(randomDate.withZoneSameInstant(ZoneOffset.UTC).toInstant());
        assertEquals(nanos, fields[0].numericValue().longValue());
    }
    ...
    public void testMergeDate() throws IOException {
        String initMapping = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("movie")
            .startObject("properties")
            .startObject("release_date").field("type", NanosecondDateFieldMapper.CONTENT_TYPE).field("format", "yyyy/MM/dd").endObject()
        ...
        String updateFormatMapping = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("movie")
            .startObject("properties")
            .startObject("release_date").field("type", NanosecondDateFieldMapper.CONTENT_TYPE).field("format", "epoch_millis").endObject()
            .endObject().endObject().endObject());
    ...
    public void testMergeText() throws Exception {
        String mapping = Strings.toString(XContentFactory.jsonBuilder().startObject().startObject("_doc")
            .startObject("properties").startObject("date").field("type", NanosecondDateFieldMapper.CONTENT_TYPE).endObject()
            .endObject().endObject().endObject());
        ...
        assertEquals("mapper [date] of different type, current_type [nanosecond], merged_type [text]", e.getMessage());
    }

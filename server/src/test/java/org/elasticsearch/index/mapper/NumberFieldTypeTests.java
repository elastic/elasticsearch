...
public class NumberFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testRangeQuery() {
        ...
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class,
                () -> unsearchable.rangeQuery("1", "3", true, true, null, null, null, null));
        assertEquals("Cannot search on field [field] since it is not indexed.", e.getMessage());
    }
    ...
    public void testHalfFloatRange() throws IOException {
        ...
        for (int i = 0; i < numQueries; ++i) {
            ...
            Query floatQ = NumberType.FLOAT.rangeQuery("float", l, u, includeLower, includeUpper, false);
            Query halfFloatQ = NumberType.HALF_FLOAT.rangeQuery("half_float", l, u, includeLower, includeUpper, false);

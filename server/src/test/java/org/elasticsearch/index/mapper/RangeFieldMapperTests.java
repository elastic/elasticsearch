...
public class RangeFieldMapperTests extends AbstractNumericFieldMapperTestCase {
    ...
    public void doTestDefaults(String type) throws Exception {
        ...
        ParsedDocument doc = mapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference.bytes(XContentFactory.jsonBuilder()
            .startObject()
            .startObject("field")
        ...
        if (type.equals("date_range") == false) {
            ...
            ThrowingRunnable runnable = () -> mapper2
                    .parse(SourceToParse.source(
                            "test", "type", "1", null, BytesReference.bytes(XContentFactory.jsonBuilder().startObject().startObject("field")
    ...
    protected void doTestDecimalCoerce(String type) throws IOException {
        ...
        ParsedDocument doc1 = mapper.parse(SourceToParse.source("test", "type", "1", null,
        ...
        ParsedDocument doc2 = mapper.parse(SourceToParse.source("test", "type", "1", null,
            BytesReference.bytes(XContentFactory.jsonBuilder()
            .startObject()
            .startObject("field")
    ...
    protected void doTestNullValue(String type) throws IOException {
        ...
        // test null max value
        doc = mapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference.bytes(XContentFactory.jsonBuilder()
            .startObject()
            .startObject("field")
            .field(getFromField(), getFrom(type))
            .nullField(getToField())

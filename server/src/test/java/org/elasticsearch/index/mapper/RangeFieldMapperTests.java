...
public class RangeFieldMapperTests extends AbstractNumericFieldMapperTestCase<RangeFieldMapper.Builder> {
    ...
    public void testParseSourceValue() throws IOException {
        ...
        assertEquals(List.of(Map.of("gte", 3L, "lt", 42L)), fetchFromSource(longMapper, null, longRange));
    ...
    public void testParseSourceValueWithFormat() throws IOException {
        ...
        assertEquals(List.of(Map.of("lt", "1990/12/29")), fetchFromSource(dateMapper, "yyy/MM/dd", dateRange));
        assertEquals(List.of(Map.of("lt", "662428800000")), fetchFromSource(dateMapper, "epoch_millis", dateRange));
    }
}

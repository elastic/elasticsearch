...
public class RangeFieldQueryStringQueryBuilderTests extends AbstractQueryTestCase<QueryStringQueryBuilder> {
    ...
    public void testDateRangeQuery() throws Exception {
        ...
        RangeFieldMapper.RangeFieldType type = (RangeFieldMapper.RangeFieldType) context.searchFields().fieldType(DATE_RANGE_FIELD_NAME);
        ...
        DateFieldMapper.DateFieldType dateType = (DateFieldMapper.DateFieldType) context.searchFields().fieldType(DATE_FIELD_NAME);

...
public class RangeFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        MappedFieldType longMapper = new RangeFieldMapper.Builder("field", RangeType.LONG, true, Version.CURRENT).build(
            MapperBuilderContext.ROOT
        ).fieldType();
        Map<String, Object> longRange = org.elasticsearch.core.Map.of("gte", 3.14, "lt", "42.9");
        assertEquals(
            Collections.singletonList(org.elasticsearch.core.Map.of("gte", 3L, "lt", 42L)),
            fetchSourceValue(longMapper, longRange)
        );

        MappedFieldType dateMapper = new RangeFieldMapper.Builder("field", RangeType.DATE, true, Version.CURRENT).format(
        ...
        assertEquals(
            Collections.singletonList(org.elasticsearch.core.Map.of("lt", "1990/12/29", "gte", "1988/12/06")),
    ...
    public void testParseSourceValueWithFormat() throws IOException {
        ...
        MappedFieldType dateMapper = new RangeFieldMapper.Builder("field", RangeType.DATE, true, Version.CURRENT).format("strict_date_time")
            .build(MapperBuilderContext.ROOT)
            .fieldType();
        Map<String, Object> dateRange = org.elasticsearch.core.Map.of("lt", "1990-12-29T00:00:00.000Z");
        assertEquals(
            Collections.singletonList(org.elasticsearch.core.Map.of("lt", "1990/12/29")),
            fetchSourceValue(dateMapper, dateRange, "yyy/MM/dd")
        );
        assertEquals(
            Collections.singletonList(org.elasticsearch.core.Map.of("lt", "662428800000")),

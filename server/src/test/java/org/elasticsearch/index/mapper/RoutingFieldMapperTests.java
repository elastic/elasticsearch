...
public class RoutingFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testRoutingMapper() throws Exception {
        ...
        ParsedDocument doc = docMapper.parse(SourceToParse.source("test", "type", "1", "routing_value", BytesReference
    ...
    public void testIncludeInObjectNotAllowed() throws Exception {
        ...
        try {
            docMapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference.bytes(XContentFactory.jsonBuilder()

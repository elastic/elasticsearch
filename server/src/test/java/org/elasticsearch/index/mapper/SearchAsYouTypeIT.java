...
public class SearchAsYouTypeIT extends ESRestTestCase {
    ...
    public void testTerms() throws IOException {
        ...
        termQuery("a_field._with_2_shingles", asList("quick red", "red fox", "fox lazy", "lazy brown", "brown dog"), text);
        termQuery("a_field._with_3_shingles", asList("quick red fox", "red fox lazy", "fox lazy brown", "lazy brown dog"), text);
        termQuery("a_field._with_4_shingles", asList("quick red fox lazy", "red fox lazy brown", "fox lazy brown dog"), text);
    }

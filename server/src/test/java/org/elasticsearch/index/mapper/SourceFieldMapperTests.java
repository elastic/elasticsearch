...
public class SourceFieldMapperTests extends MetadataMapperTestCase {
    ...
    public void testNoFormat() throws Exception {
        ...
        ParsedDocument doc = documentMapper.parse(new SourceToParse("test", "_doc", "1",
        ...
        doc = documentMapper.parse(new SourceToParse("index", "_doc", "1",
    ...
    public void testSourceObjectContainsExtraTokens() throws Exception {
        ...
        MapperParsingException exception = expectThrows(MapperParsingException.class,
            ...
            () -> documentMapper.parse(new SourceToParse("test", "_doc", "1", new BytesArray("{}}"), XContentType.JSON)));

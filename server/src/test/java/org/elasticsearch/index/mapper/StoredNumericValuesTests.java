...
public class StoredNumericValuesTests extends MapperServiceTestCase {
    public void testBytesAndNumericRepresentation() throws Exception {
        ...
        ParsedDocument doc = mapperService.documentMapper().parse(new SourceToParse("test", "_doc", "1", BytesReference
        ...
        withLuceneIndex(mapperService, iw -> iw.addDocument(doc.rootDoc()), ir -> {
            ...
            fieldsVisitor.postProcess(mapperService::fieldType, "_doc");

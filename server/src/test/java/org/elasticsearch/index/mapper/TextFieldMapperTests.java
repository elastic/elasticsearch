...
public class TextFieldMapperTests extends MapperTestCase {
    ...
    public void testFielddata() throws IOException {
        ...
        Exception e = expectThrows(
            ...
            () -> disabledMapper.fieldType("field").fielddataBuilder(FieldDataContext.staticContext("test"))
        );
        ...
        enabledMapper.fieldType("field").fielddataBuilder(FieldDataContext.staticContext("test")); // no exception
                                                                                                   // this time
    ...
    public void testIgnoreFieldDataOnLegacyIndex() throws IOException {
        ...
        expectThrows(
            ...
            () -> ((TextFieldMapper) finalMapperService.documentMapper().mappers().getMapper("field")).fieldType()
                .fielddataBuilder(FieldDataContext.staticContext("test"))
        );
    }

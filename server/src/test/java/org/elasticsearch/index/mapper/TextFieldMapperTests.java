...
public class TextFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void testIndexOptions() throws IOException {
        ...
        ParsedDocument doc = mapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference.bytes(jsonDoc.endObject()),
                XContentType.JSON));
    ...
    public void testDefaultPositionIncrementGap() throws IOException {
        ...
        SourceToParse sourceToParse = SourceToParse.source("test", "type", "1", null, BytesReference
                .bytes(XContentFactory.jsonBuilder()
                        .startObject()
    ...
    public void testTermVectors() throws IOException {
        ...
        ParsedDocument doc = defaultMapper.parse(SourceToParse.source("test", "type", "1", null, BytesReference
                .bytes(XContentFactory.jsonBuilder()
                        .startObject()
                        .field("field1", "1234")
                        .field("field2", "1234")

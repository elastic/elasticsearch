...
public class TsidExtractingIdFieldMapperTests extends MetadataMapperTestCase {
    private static class TestCase {
        ...
        TestCase(String name, String expectedId, String expectedTsid, CheckedConsumer<XContentBuilder, IOException> source) {
            this.name = name;
    ...
    public static Iterable<Object[]> params() {
        ...
        // Dates
        items.add(new TestCase("2022-01-01T01:00:00Z", "XsFI2ezm5OViFixWgIomE34BAAA", "{r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
        }));
        items.add(new TestCase("2022-01-01T01:00:01Z", "XsFI2ezm5OViFixWaI4mE34BAAA", "{r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:01Z");
            b.field("r1", "cat");
        }));
        items.add(new TestCase("1970-01-01T00:00:00Z", "XsFI2ezm5OViFixWAAAAAAAAAAA", "{r1=cat}", b -> {
            b.field("@timestamp", "1970-01-01T00:00:00Z");
            b.field("r1", "cat");
        }));
        items.add(new TestCase("-9998-01-01T00:00:00Z", "XsFI2ezm5OViFixWABhgBIKo_v8", "{r1=cat}", b -> {
            b.field("@timestamp", "-9998-01-01T00:00:00Z");
            b.field("r1", "cat");
        }));
        items.add(new TestCase("9998-01-01T00:00:00Z", "XsFI2ezm5OViFixWAIS9ImnmAAA", "{r1=cat}", b -> {
            b.field("@timestamp", "9998-01-01T00:00:00Z");
            b.field("r1", "cat");
        }));

        // routing keywords
        items.add(new TestCase("r1", "XsFI2ezm5OViFixWgIomE34BAAA", "{r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
        }).and(b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
        ...
        items.add(new TestCase("r2", "1y-UzdYi98F0UVRigIomE34BAAA", "{r2=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r2", "cat");
        }));
        items.add(new TestCase("o.r3", "zh4dcftpIU55Ond-gIomE34BAAA", "{o.r3=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
        ...
        // non-routing keyword
        items.add(new TestCase("k1=dog", "XsFI2dL8sZeQhBgxgIomE34BAAA", "{k1=dog, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("k1", "dog");
        }));
        items.add(new TestCase("k1=pumpkin", "XsFI2VlD6_SkSo4MgIomE34BAAA", "{k1=pumpkin, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("k1", "pumpkin");
        }));
        items.add(new TestCase("k1=empty string", "XsFI2aBA6UgrxLRqgIomE34BAAA", "{k1=, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("k1", "");
        }));
        items.add(new TestCase("k2", "XsFI2W2e5Ycw0o5_gIomE34BAAA", "{k2=dog, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("k2", "dog");
        }));
        items.add(new TestCase("o.k3", "XsFI2ZAfOI6DMQhFgIomE34BAAA", "{o.k3=dog, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.startObject("o").field("k3", "dog").endObject();
        }));
        items.add(new TestCase("o.r3", "zh4dcbFtT1qHtjl8gIomE34BAAA", "{o.k3=dog, o.r3=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.startObject("o");
            {
                b.field("r3", "cat");
        ...
        // long
        items.add(new TestCase("L1=1", "XsFI2eGMFOYjW7LLgIomE34BAAA", "{L1=1, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("L1", 1);
        }));
        items.add(new TestCase("L1=min", "XsFI2f9V0yuDfkRWgIomE34BAAA", "{L1=" + Long.MIN_VALUE + ", r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("L1", Long.MIN_VALUE);
        }));
        items.add(new TestCase("L2=1234", "XsFI2S8PYEBSm6QYgIomE34BAAA", "{L2=1234, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("L2", 1234);
        }));
        items.add(new TestCase("o.L3=max", "zh4dcaI-57LdG7-cgIomE34BAAA", "{o.L3=" + Long.MAX_VALUE + ", o.r3=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.startObject("o");
            {
                b.field("r3", "cat");
        ...
        // int
        items.add(new TestCase("i1=1", "XsFI2R3LiMZSeUGKgIomE34BAAA", "{i1=1, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("i1", 1);
        }));
        items.add(new TestCase("i1=min", "XsFI2fC7DMEVFaU9gIomE34BAAA", "{i1=" + Integer.MIN_VALUE + ", r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("i1", Integer.MIN_VALUE);
        }));
        items.add(new TestCase("i2=1234", "XsFI2ZVte8HK90RJgIomE34BAAA", "{i2=1324, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("i2", 1324);
        }));
        items.add(new TestCase("o.i3=max", "zh4dcQy_QJRCqIx7gIomE34BAAA", "{o.i3=" + Integer.MAX_VALUE + ", o.r3=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.startObject("o");
            {
                b.field("r3", "cat");
        ...
        // short
        items.add(new TestCase("s1=1", "XsFI2axCr11Q93m7gIomE34BAAA", "{r1=cat, s1=1}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("s1", 1);
        }));
        items.add(new TestCase("s1=min", "XsFI2Rbs9Ua9BH1wgIomE34BAAA", "{r1=cat, s1=" + Short.MIN_VALUE + "}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("s1", Short.MIN_VALUE);
        }));
        items.add(new TestCase("s2=1234", "XsFI2SBKaLBqXMBYgIomE34BAAA", "{r1=cat, s2=1234}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("s2", 1234);
        }));
        items.add(new TestCase("o.s3=max", "zh4dcYIFo98LQWs4gIomE34BAAA", "{o.r3=cat, o.s3=" + Short.MAX_VALUE + "}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.startObject("o");
            {
                b.field("r3", "cat");
        ...
        // byte
        items.add(new TestCase("b1=1", "XsFI2dDrcWaf3zDPgIomE34BAAA", "{b1=1, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("b1", 1);
        }));
        items.add(new TestCase("b1=min", "XsFI2cTzLrNqHtxngIomE34BAAA", "{b1=" + Byte.MIN_VALUE + ", r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("b1", Byte.MIN_VALUE);
        }));
        items.add(new TestCase("b2=12", "XsFI2Sb77VB9AswjgIomE34BAAA", "{b2=12, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("b2", 12);
        }));
        items.add(new TestCase("o.s3=max", "zh4dcfFauKzj6lgxgIomE34BAAA", "{o.b3=" + Byte.MAX_VALUE + ", o.r3=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.startObject("o");
            {
                b.field("r3", "cat");
        ...
        // ip
        items.add(new TestCase("ip1=192.168.0.1", "XsFI2dJ1cyrrjNa2gIomE34BAAA", "{ip1=192.168.0.1, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
        ...
        items.add(new TestCase("ip1=12.12.45.254", "XsFI2ZUAcRxOwhHKgIomE34BAAA", "{ip1=12.12.45.254, r1=cat}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
        ...
        items.add(new TestCase("huge", "XsFI2ajoxid9Tfl3gIomE34BAAA", "{k1=" + huge + ", k2=" + huge.substring(0, 191) + "...}", b -> {
            b.field("@timestamp", "2022-01-01T01:00:00Z");
            b.field("r1", "cat");
            b.field("k1", huge);
            b.field("k2", huge);

...
public class FlattenedIndexFieldDataTests extends ESSingleNodeTestCase {
    ...
    public void testGlobalFieldDataCaching() throws IOException {
        ...
        IndexFieldData<?> ifd1 = ifdService.getForField(fieldType1, FieldDataContext.noRuntimeFields("test", false));
        ...
        IndexFieldData<?> ifd2 = ifdService.getForField(fieldType2, FieldDataContext.noRuntimeFields("test", false));

...
public class IdsQueryBuilderTypedTests extends AbstractQueryTestCase<IdsQueryBuilder> {
    ...
    protected IdsQueryBuilder doCreateTestQueryBuilder() {
        ...
        IdsQueryBuilder query = new IdsQueryBuilder().types(type);
        query.addIds(ids);
        return query;
    }

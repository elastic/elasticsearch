...
public class PrefixQueryBuilderTests extends AbstractQueryTestCase<PrefixQueryBuilder> {
    ...
    public void testFieldValueBreakerEstimate() throws IOException {
        // PrefixQueryBuilder stores value as String: estimateValue = s.length()*2 + 64.
        ...
        try {
            PrefixQueryBuilder small = new PrefixQueryBuilder(TEXT_FIELD_NAME, shortValue);
            PrefixQueryBuilder big = new PrefixQueryBuilder(TEXT_FIELD_NAME, "x".repeat(500));

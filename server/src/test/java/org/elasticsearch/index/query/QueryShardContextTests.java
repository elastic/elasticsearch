...
public class QueryShardContextTests extends ESTestCase {
    ...
    public void testRuntimeFields() throws IOException {
        MapperService mapperService = mockMapperService("test", org.elasticsearch.common.collect.List.of(new MapperPlugin() {
            @Override
            public Map<String, TypeParser> getMappers() {
                return org.elasticsearch.common.collect.Map.of("runtime", (name, node, parserContext) -> new Mapper.Builder(name) {
                    @Override
        ...
        when(mapperService.simpleMatchToFullName("*")).thenReturn(org.elasticsearch.common.collect.Set.of("pig"));
        /*
        ...
        Map<String, Object> runtimeMappings = org.elasticsearch.common.collect.Map.ofEntries(
            ...
            org.elasticsearch.common.collect.Map.entry("dog", org.elasticsearch.common.collect.Map.of("type", "keyword"))
        );
    ...
    private static QueryShardContext createQueryShardContext(
        ...
        MapperService mapperService = mockMapperService(indexUuid, org.elasticsearch.common.collect.List.of());
    ...
    private static class DummyMapper extends FieldMapper {
        protected DummyMapper(String simpleName, MappedFieldType mappedFieldType) {
            super(simpleName, mappedFieldType, org.elasticsearch.common.collect.Map.of(), MultiFields.empty(), CopyTo.empty());
        }

...
public class SpanContainingQueryBuilderTests extends AbstractQueryTestCase<SpanContainingQueryBuilder> {
    ...
    protected SpanContainingQueryBuilder doCreateTestQueryBuilder() {
        SpanTermQueryBuilder[] spanTermQueries = new SpanTermQueryBuilderTests().createSpanTermQueryBuilders(2, false, true);
    ...
    public void testFromJson_withNonDefaultBoost_inBigQuery() {
        ...
        assertThat(exception.getMessage(), equalTo("span_containing [big] can't have non-default boost value [2.0]"));
    }
    ...
    public void testFromJson_withNonDefaultBoost_inLittleQuery() {
        ...
        Exception exception = expectThrows(ParsingException.class, () -> parseQuery(json));
        assertThat(exception.getMessage(), equalTo("span_containing [little] can't have non-default boost value [2.0]"));
    }
}

...
public class TermQueryBuilderTests extends AbstractTermQueryTestCase<TermQueryBuilder> {
    ...
    public void testTermClauseChargesPerClauseFloor() throws IOException {
        ...
        try {
            ...
            assertTrue("a term clause must contribute strictly positive bytes to the breaker", delta > 0);
            assertEquals(
    ...
    public void testFieldValueBreakerEstimate() throws IOException {
        ...
        try {
            TermQueryBuilder small = new TermQueryBuilder(TEXT_FIELD_NAME, shortValue);
            TermQueryBuilder big = new TermQueryBuilder(TEXT_FIELD_NAME, "x".repeat(500));

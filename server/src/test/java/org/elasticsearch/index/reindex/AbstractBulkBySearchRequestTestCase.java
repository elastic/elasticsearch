 ...
 */
public abstract class AbstractBulkBySearchRequestTestCase<R extends AbstractBulkBySearchRequest<R> & ToXContent> extends
    ...
    public void testForSlice() {
        ...
        original.setSlices(randomBoolean() ? actualSlices : AbstractBulkBySearchRequest.AUTO_SLICES);
        ...
        assertEquals(
            ...
            original.getMaxDocs() == AbstractBulkBySearchRequest.MAX_DOCS_ALL_MATCHES
                ? AbstractBulkBySearchRequest.MAX_DOCS_ALL_MATCHES

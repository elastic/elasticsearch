    ...
    public void testRecoveryToReplicaThatReceivedExtraDocument() throws Exception {
        try (ReplicationGroup shards = createGroup(2)) {
            ...
            remainingReplica.applyIndexOperationOnReplica(
                    ...
                    false,
                    SourceToParse.source("index", "type", "replica", null, new BytesArray("{}"), XContentType.JSON));
            ...
            if (extra) {
                promotedReplica.applyIndexOperationOnPrimary(
                        ...
                        SourceToParse.source("index", "type", "primary", null, new BytesArray("{}"), XContentType.JSON),

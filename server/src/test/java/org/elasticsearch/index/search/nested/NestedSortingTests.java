...
public class NestedSortingTests extends AbstractFieldDataTestCase {
    ...
    public void testDuel() throws Exception {
        ...
        for (int i = 0; i < numDocs; ++i) {
            ...
            for (int j = 0; j < numChildren; ++j) {
                ...
                doc.add(new StringField("__nested_path", "child", Field.Store.NO));
                docs.add(doc);
            }
            if (randomBoolean()) {
            ...
            parent.add(new StringField("__nested_path", "parent", Field.Store.NO));
            docs.add(parent);
    ...
    private TopDocs getTopDocs(IndexSearcher searcher, IndexFieldData<?> indexFieldData, String missingValue,
        ...
        Query parentFilter = new TermQuery(new Term("__nested_path", "parent"));
        Query childFilter = new TermQuery(new Term("__nested_path", "child"));
    ...
    public void testNestedSorting() throws Exception {
        ...
        docs.add(document);
        document = new Document();
        document.add(new StringField("__nested_path", "parent", Field.Store.NO));
    ...
    public void testMultiLevelNestedSorting() throws IOException {
        ...
        List<List<Document>> books = new ArrayList<>();
        {
            ...
            document.add(new StringField("_nested_path", "__chapters.paragraphs", Field.Store.NO));
            ...
            document.add(new StringField("_nested_path", "__chapters", Field.Store.NO));

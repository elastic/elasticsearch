...
public class RetentionLeaseSyncActionTests extends ESTestCase {
    ...
    public void testRetentionLeaseSyncExecution() throws Exception {
        final IndicesService indicesService = mock(IndicesService.class);
        ...
        action.updateRetentionLeasesForShard(indexShard.shardId(), retentionLeases, ActionListener.wrap(() -> {}));

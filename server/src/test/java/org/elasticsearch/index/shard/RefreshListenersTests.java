...
public class RefreshListenersTests extends ESTestCase {
    ...
    public void testBeforeRefresh() throws Exception {
        ...
        assertFalse(listeners.addOrNotify(index.getSeqNo(), false, seqNoListener));
    ...
    public void testAfterRefresh() throws Exception {
        ...
        assertFalse(listener.forcedRefresh.get());
        TestSeqNoListener seqNoListener = new TestSeqNoListener();
        assertTrue(listeners.addOrNotify(index.getSeqNo(), false, seqNoListener));
        assertTrue(seqNoListener.isDone.get());
        listener.assertNoError();
        assertEquals(0, listeners.pendingCount());
    }
    ...
    public void testContextIsPreserved() throws IOException, InterruptedException {
        ...
        try (ThreadContext.StoredContext ignore = threadPool.getThreadContext().stashContext()) {
            ...
            assertFalse(listeners.addOrNotify(index.getSeqNo(), false, new ActionListener<>() {
                @Override
    ...
    public void testTooMany() throws Exception {
        ...
        for (int i = 0; i < maxListeners; i++) {
            if (randomBoolean()) {
                ...
                listeners.addOrNotify(index.getSeqNo(), false, listener);
            }
        ...
        listeners.addOrNotify(index.getSeqNo(), false, rejectedListener);
    ...
    public void testClose() throws Exception {
        ...
        Engine.IndexResult unrefreshedOperation = index("1");
        {
            ...
            TestSeqNoListener seqNoListener = new TestSeqNoListener();
            assertFalse(listeners.addOrNotify(unrefreshedOperation.getSeqNo(), false, seqNoListener));
        ...
        }
        {
            ...
            listener.assertNoError();
            TestSeqNoListener seqNoListener = new TestSeqNoListener();
            assertTrue(listeners.addOrNotify(refreshedOperation.getSeqNo(), false, seqNoListener));
            assertTrue(seqNoListener.isDone.get());
        ...
        }
        {
            ...
            TestSeqNoListener seqNoListener = new TestSeqNoListener();
            listeners.addOrNotify(unrefreshedOperation.getSeqNo(), false, seqNoListener);
        ...
        try {
            for (int i = 0; i < 1000; i++) {
                ...
                if (randomBoolean()) {
                    ...
                    TestSeqNoListener seqNoListener = new TestSeqNoListener();
                    immediate = listeners.addOrNotify(index.getSeqNo(), false, seqNoListener);
            ...
            indexers[thread] = new Thread(() -> {
                for (int iteration = 1; iteration <= 50; iteration++) {
                    try {
                        ...
                        listeners.addOrNotify(processedLocalCheckpoint, false, seqNoListener);
                        assertBusy(() -> {
    ...
    public void testDisallowAddListeners() throws Exception {
        ...
        TestSeqNoListener seqNoListener = new TestSeqNoListener();
        assertFalse(listeners.addOrNotify(index("1").getSeqNo(), false, seqNoListener));
        engine.refresh("I said so");
        assertFalse(listener.forcedRefresh.get());
        listener.assertNoError();
        assertTrue(seqNoListener.isDone.get());
        ...
        if (listeners.pendingCount() == maxListeners) {
            ...
            assertTrue(listeners.addOrNotify(index("1").getSeqNo(), false, rejected));
            assertNotNull(rejected.error);
            expectedPending = 2;
        } else {
            TestSeqNoListener acceptedListener = new TestSeqNoListener();
            assertFalse(listeners.addOrNotify(index("1").getSeqNo(), false, acceptedListener));

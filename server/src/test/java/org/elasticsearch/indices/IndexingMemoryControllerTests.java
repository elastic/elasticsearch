...
public class IndexingMemoryControllerTests extends ESSingleNodeTestCase {
    ...
    public void testNegativeInterval() {
        ...
        assertEquals("failed to parse value [-42] for setting [indices.memory.interval], must be >= [0ms]", e.getMessage());
    ...
    public void testNegativeShardInactiveTime() {
        ...
        assertEquals("failed to parse value [-42] for setting [indices.memory.shard_inactive_time], must be >= [0ms]", e.getMessage());

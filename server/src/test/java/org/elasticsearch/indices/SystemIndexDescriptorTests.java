    ...
    public void testValidation() {
        {
            Exception ex = expectThrows(
                ...
                () -> SystemIndexDescriptor.builder().setIndexPattern(null).setDescription(randomAlphaOfLength(5)).build()
            );
...

        {
            Exception ex = expectThrows(
                ...
                () -> SystemIndexDescriptor.builder().setIndexPattern("").setDescription(randomAlphaOfLength(5)).build()
            );

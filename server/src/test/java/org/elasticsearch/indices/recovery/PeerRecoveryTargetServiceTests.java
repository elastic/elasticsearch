...
public class PeerRecoveryTargetServiceTests extends IndexShardTestCase {
    ...
    public void testPrepareIndexForPeerRecovery() throws Exception {
        DiscoveryNode localNode = TestDiscoveryNode.create("foo", Collections.emptyMap(), Collections.emptySet());
    ...
    public void testResetStartingSeqNoIfLastCommitCorrupted() throws Exception {
        IndexShard shard = newStartedShard(false);
        populateRandomData(shard);
        DiscoveryNode pNode = TestDiscoveryNode.create("foo", Collections.emptyMap(), Collections.emptySet());
        DiscoveryNode rNode = TestDiscoveryNode.create("foo", Collections.emptyMap(), Collections.emptySet());

...
public class RecoverySettingsTests extends ESTestCase {
    ...
    public void testMaxBytesPerSecOnDataNodeWithIndicesRecoveryMaxBytesPerSecAndOvercommit() {
        ...
        final ByteSizeValue indicesRecoveryMaxBytesPerSec;
        switch (randomInt(2)) {
            case 0:
                indicesRecoveryMaxBytesPerSec = ByteSizeValue.MINUS_ONE;
                break;
            case 1:
                indicesRecoveryMaxBytesPerSec = ByteSizeValue.ZERO;
                break;
            case 2:
                indicesRecoveryMaxBytesPerSec = ByteSizeValue.ofGb(between(100, 1000));
                break;
            default:
                throw new AssertionError();
        }
    ...
    private static double requireNonNullElse(Double value, double defaultValue) {

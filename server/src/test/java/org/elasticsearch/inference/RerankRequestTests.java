...
public class RerankRequestTests extends AbstractBWCSerializationTestCase<RerankRequest> {
    ...
    public void testParser_WithSingleStringInputAndQuery() throws IOException {
        ...
        try (var parser = createParser(JsonXContent.jsonXContent, requestJson)) {
            ...
            assertThat(request.inputs(), is(List.of(new InferenceString(DataType.TEXT, INPUT_TEXT))));
            assertThat(request.query(), is(new InferenceString(DataType.TEXT, QUERY_TEXT)));
    ...
    public void testParser_WithStringArrayInput() throws IOException {
        ...
        try (var parser = createParser(JsonXContent.jsonXContent, requestJson)) {
            ...
            assertThat(
                request.inputs(),
                is(List.of(new InferenceString(DataType.TEXT, INPUT_TEXT), new InferenceString(DataType.TEXT, input2)))
            );
            assertThat(request.query(), is(new InferenceString(DataType.TEXT, QUERY_TEXT)));
            assertThat(request.topN(), is(nullValue()));
            assertThat(request.returnDocuments(), is(nullValue()));
    ...
    public void testParser_WithObjectArrayInput() throws IOException {
        ...
        try (var parser = createParser(JsonXContent.jsonXContent, requestJson)) {
            ...
            assertThat(
                request.inputs(),
                is(List.of(new InferenceString(DataType.TEXT, firstInput), new InferenceString(DataType.TEXT, secondInput)))
            );
            assertThat(request.query(), is(new InferenceString(DataType.TEXT, QUERY_TEXT)));
            assertThat(request.topN(), is(nullValue()));
            assertThat(request.returnDocuments(), is(nullValue()));

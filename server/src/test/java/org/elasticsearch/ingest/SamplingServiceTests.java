        ...
        ProjectMetadata.Builder projectBuilder = ProjectMetadata.builder(ProjectId.DEFAULT)
            .putCustom(
                ...
                new SamplingMetadata(
                    Map.of(
                        indexName,
                        new SamplingConfiguration(1.0, 100, ByteSizeValue.ofKb(100), TimeValue.timeValueDays(3), TEST_CONDITIONAL_SCRIPT)
                    )
                )
            );
        final ProjectId projectId = projectBuilder.getId();
    ...
    public void testMaybeSampleWithLowRate() {
        ...
        ProjectMetadata.Builder projectBuilder = ProjectMetadata.builder(ProjectId.DEFAULT)
            .putCustom(
                SamplingMetadata.TYPE,
                new SamplingMetadata(
                    Map.of(indexName, new SamplingConfiguration(0.001, 100, ByteSizeValue.ofKb(100), TimeValue.timeValueDays(3), null))
                )
            );
        final ProjectId projectId = projectBuilder.getId();
        ProjectMetadata projectMetadata = projectBuilder.build();
    ...
    public void testMaybeSampleMaxSamples() {
        ...
        ProjectMetadata.Builder projectBuilder = ProjectMetadata.builder(ProjectId.DEFAULT)
            .putCustom(
                SamplingMetadata.TYPE,
                new SamplingMetadata(
                    Map.of(indexName, new SamplingConfiguration(1.0, maxSamples, ByteSizeValue.ofKb(100), TimeValue.timeValueDays(3), null))
                )
            );
        final ProjectId projectId = projectBuilder.getId();
        ProjectMetadata projectMetadata = projectBuilder.build();

...
public class CustomPassageFormatterTests extends ESTestCase {
    public void testSimpleFormat() {
        ...
        CustomPassageFormatter passageFormatter = new CustomPassageFormatter("<em>", "</em>", new DefaultEncoder(), 0);
    ...
    public void testHtmlEncodeFormat() {
        ...
        CustomPassageFormatter passageFormatter = new CustomPassageFormatter("<em>", "</em>", new SimpleHTMLEncoder(), 0);

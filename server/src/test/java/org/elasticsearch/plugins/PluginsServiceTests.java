...
public class PluginsServiceTests extends ESTestCase {
    ...
    static PluginsService newPluginsService(Settings settings) {
        return new PluginsService(settings, null, null, TestEnvironment.newEnvironment(settings).pluginsFile(), emptyList());
    }
    ...
    static PluginsService newPluginsService(
        ...
        return new PluginsService(settings, null, null, TestEnvironment.newEnvironment(settings).pluginsFile(), plugins);
    }

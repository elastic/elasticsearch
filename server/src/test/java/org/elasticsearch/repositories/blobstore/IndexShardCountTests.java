...
public class IndexShardCountTests extends ESTestCase {
    ...
    public void testFromLegacyIndexMetaDataWithNewCompatibleVersionThrowsException() throws IOException {
        ...
        assertThrows(IllegalStateException.class, () -> IndexShardCount.fromLegacyIndexMetaData(parser));
    }
    ...
    public void testFromLegacyIndexMetaDataWithOldIncompatibleVersionSucceeds() throws IOException {
        ...
        XContentParser parser = createParser(indexMetadataBuilder);
        IndexShardCount count = IndexShardCount.fromLegacyIndexMetaData(parser);
        assertEquals(numberOfShards, count.count());
    }

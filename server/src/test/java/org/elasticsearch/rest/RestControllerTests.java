...
public class RestControllerTests extends ESTestCase {
    ...
    public void setup() {
        ...
        restController = new RestController(null, client, circuitBreakerService, usageService, tracer, Meter.NOOP);
    ...
    public void testApplyProductSpecificResponseHeaders() {
        ...
        final RestController restController = new RestController(null, null, circuitBreakerService, usageService, tracer, Meter.NOOP);
    ...
    public void testRequestWithDisallowedMultiValuedHeaderButSameValues() {
        ...
        final RestController restController = new RestController(null, client, circuitBreakerService, usageService, tracer, Meter.NOOP);
        Map<String, List<String>> restHeaders = new HashMap<>();
        restHeaders.put("header.1", Collections.singletonList("boo"));
    ...
    public void testRestHandlerWrapper() throws Exception {
        ...
        }, client, circuitBreakerService, usageService, tracer, Meter.NOOP);
    ...
    public void testDispatchRequiresContentTypeForRequestsWithContent() {
        ...
        restController = new RestController(null, null, circuitBreakerService, usageService, tracer, Meter.NOOP);
        restController.registerHandler(
            new Route(GET, "/"),
    ...
    public void testDispatchCompatibleHandler() {
        ...
        RestController restController = new RestController(null, client, circuitBreakerService, usageService, tracer, Meter.NOOP);

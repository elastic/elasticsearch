...
public class RestControllerTests extends ESTestCase {
    ...
    public void setup() {
        ...
        restController = new RestController(Collections.emptySet(), null, null, circuitBreakerService, usageService, (a, b) -> false);
    ...
    public void testApplyRelevantHeaders() throws Exception {
        ...
        final RestController restController = new RestController(headers, null, null, circuitBreakerService, usageService, (a, b) -> false);
    ...
    public void testRegisterSecondMethodWithDifferentNamedWildcard() {
        final RestController restController = new RestController(null, null, null, circuitBreakerService, usageService, (a, b) -> false);
    ...
    public void testRestHandlerWrapper() throws Exception {
        ...
        final RestController restController =
            new RestController(Collections.emptySet(),
                ...
                }, null, circuitBreakerService, usageService, (a, b) -> false);

...
public class RestControllerTests extends ESTestCase {
    ...
    public void setup() {
        ...
        restController = new RestController(null, client, circuitBreakerService, usageService, tracer, MeterRegistry.NOOP);
    ...
    public void testRestHandlerWrapper() throws Exception {
        ...
        }, client, circuitBreakerService, usageService, tracer, MeterRegistry.NOOP);
    ...
    public void testDispatchRequiresContentTypeForRequestsWithContent() {
        ...
        restController = new RestController(null, null, circuitBreakerService, usageService, tracer, MeterRegistry.NOOP);
        restController.registerHandler(
            new Route(GET, "/"),
    ...
    public void testDispatchCompatibleHandler() {
        ...
        RestController restController = new RestController(null, client, circuitBreakerService, usageService, tracer, MeterRegistry.NOOP);

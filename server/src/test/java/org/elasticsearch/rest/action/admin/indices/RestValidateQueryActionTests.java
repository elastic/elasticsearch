...
public class RestValidateQueryActionTests extends AbstractSearchTestCase {
    ...
    public static void stubValidateQueryAction() {
        ...
        final TransportAction transportAction = new TransportAction(Settings.EMPTY, ValidateQueryAction.NAME, threadPool,
            new ActionFilters(Collections.emptySet()), null, taskManager) {
            @Override

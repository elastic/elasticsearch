...
public class DefaultSearchContextTests extends ESTestCase {
    ...
    public void testPreProcess() throws Exception {
        ...
        try (Directory dir = newDirectory();
            ...
            DefaultSearchContext contextWithoutScroll = new DefaultSearchContext(mock(ClusterService.class), mock(IndicesService.class),
                readerWithoutScroll, shardSearchRequest, target, null, timeout, null, false);
            ...
            DefaultSearchContext context1 = new DefaultSearchContext(mock(ClusterService.class), mock(IndicesService.class),
                readerContext, shardSearchRequest, target, null, timeout, null, false);
            context1.from(300);
            ...
            DefaultSearchContext context2 = new DefaultSearchContext(mock(ClusterService.class), mock(IndicesService.class),
                readerContext, shardSearchRequest, target, null, timeout, null, false);
            ...
            DefaultSearchContext context3 = new DefaultSearchContext(mock(ClusterService.class), mock(IndicesService.class),
                readerContext, shardSearchRequest, target, null, timeout, null, false);
            ...
            readerContext = new ReaderContext(newContextId(), indexService, indexShard,
                searcherSupplier.get(), randomNonNegativeLong(), false);
            DefaultSearchContext context4 = new DefaultSearchContext(mock(ClusterService.class), mock(IndicesService.class),
                readerContext, shardSearchRequest, target, null, timeout, null, false);
    ...
    public void testClearQueryCancellationsOnClose() throws IOException {
        ...
        try (Directory dir = newDirectory();
            ...
            DefaultSearchContext context = new DefaultSearchContext(mock(ClusterService.class), mock(IndicesService.class),
                readerContext, shardSearchRequest, target, null, timeout, null, false);

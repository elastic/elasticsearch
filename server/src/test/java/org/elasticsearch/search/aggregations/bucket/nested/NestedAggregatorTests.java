...
public class NestedAggregatorTests extends AggregatorTestCase {
    ...
    public void testResetRootDocId() throws Exception {
        ...
        try (Directory directory = newDirectory()) {
            try (RandomIndexWriter iw = new RandomIndexWriter(random(), directory, iwc)) {
                ...
                Document document = new Document();
                document.add(new Field(IdFieldMapper.NAME, Uid.encodeId("1"), StandardIdFieldMapper.Defaults.NESTED_FIELD_TYPE));
                ...
                documents.add(document);
                document = new Document();
                document.add(new Field(IdFieldMapper.NAME, Uid.encodeId("1"), StandardIdFieldMapper.Defaults.FIELD_TYPE));
                document.add(new Field(NestedPathFieldMapper.NAME, "test", NestedPathFieldMapper.Defaults.FIELD_TYPE));
                document.add(sequenceIDFields.primaryTerm);
                documents.add(document);
                iw.addDocuments(documents);
                ...
                document = new Document();
                document.add(new Field(IdFieldMapper.NAME, Uid.encodeId("2"), StandardIdFieldMapper.Defaults.NESTED_FIELD_TYPE));
                document.add(new Field(NestedPathFieldMapper.NAME, "nested_field", NestedPathFieldMapper.Defaults.FIELD_TYPE));
                documents.add(document);
                document = new Document();
                document.add(new Field(IdFieldMapper.NAME, Uid.encodeId("2"), StandardIdFieldMapper.Defaults.FIELD_TYPE));
                document.add(new Field(NestedPathFieldMapper.NAME, "test", NestedPathFieldMapper.Defaults.FIELD_TYPE));
                document.add(sequenceIDFields.primaryTerm);
                documents.add(document);
                iw.addDocuments(documents);
                ...
                document = new Document();
                document.add(new Field(IdFieldMapper.NAME, Uid.encodeId("3"), StandardIdFieldMapper.Defaults.NESTED_FIELD_TYPE));
                document.add(new Field(NestedPathFieldMapper.NAME, "nested_field", NestedPathFieldMapper.Defaults.FIELD_TYPE));
                documents.add(document);
                document = new Document();
                document.add(new Field(IdFieldMapper.NAME, Uid.encodeId("3"), StandardIdFieldMapper.Defaults.FIELD_TYPE));
                document.add(new Field(NestedPathFieldMapper.NAME, "test", NestedPathFieldMapper.Defaults.FIELD_TYPE));
                document.add(sequenceIDFields.primaryTerm);
                documents.add(document);
                iw.addDocuments(documents);
    ...
    public static CheckedConsumer<RandomIndexWriter, IOException> buildResellerData(int numProducts, int numResellers) {
        return iw -> {
            for (int p = 0; p < numProducts; p++) {
                ...
                Document document = new Document();
                document.add(new Field(IdFieldMapper.NAME, Uid.encodeId(Integer.toString(p)), StandardIdFieldMapper.Defaults.FIELD_TYPE));
                document.add(new Field(NestedPathFieldMapper.NAME, "test", NestedPathFieldMapper.Defaults.FIELD_TYPE));
                document.add(sequenceIDFields.primaryTerm);
    ...
    private static double[] generateDocuments(List<Document> documents, int numNestedDocs, int id, String path, String fieldName) {
        ...
        for (int nested = 0; nested < numNestedDocs; nested++) {
            Document document = new Document();
            document.add(
                new Field(IdFieldMapper.NAME, Uid.encodeId(Integer.toString(id)), StandardIdFieldMapper.Defaults.NESTED_FIELD_TYPE)
            );
    ...
    public static List<Document> generateBook(String id, String[] authors, int[] numPages) {
        ...
        for (int numPage : numPages) {
            Document document = new Document();
            document.add(new Field(IdFieldMapper.NAME, Uid.encodeId(id), StandardIdFieldMapper.Defaults.NESTED_FIELD_TYPE));
        ...
        Document document = new Document();
        document.add(new Field(IdFieldMapper.NAME, Uid.encodeId(id), StandardIdFieldMapper.Defaults.FIELD_TYPE));

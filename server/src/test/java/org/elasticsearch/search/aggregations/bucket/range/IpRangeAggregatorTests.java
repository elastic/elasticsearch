...
public class IpRangeAggregatorTests extends AggregatorTestCase {
    ...
    public void testRanges() throws Exception {
        ...
        try (Directory dir = newDirectory(); RandomIndexWriter w = new RandomIndexWriter(random(), dir)) {
            ...
            try (IndexReader reader = w.getReader()) {
                ...
                InternalBinaryRange range = searchAndReduce(new AggTestConfig(searcher, new MatchAllDocsQuery(), builder, fieldType));
    ...
    public void testMissingUnmapped() throws Exception {
        try (Directory dir = newDirectory(); RandomIndexWriter w = new RandomIndexWriter(random(), dir)) {
            ...
            try (IndexReader reader = w.getReader()) {
                IndexSearcher searcher = new IndexSearcher(reader);
                InternalBinaryRange range = searchAndReduce(new AggTestConfig(searcher, new MatchAllDocsQuery(), builder));
        ...
        try (Directory dir = newDirectory(); RandomIndexWriter w = new RandomIndexWriter(random(), dir)) {
            ...
            try (IndexReader reader = w.getReader()) {
                ...
                expectThrows(
                    ...
                    () -> searchAndReduce(new AggTestConfig(searcher, new MatchAllDocsQuery(), builder))
                );
            }
        }
    }

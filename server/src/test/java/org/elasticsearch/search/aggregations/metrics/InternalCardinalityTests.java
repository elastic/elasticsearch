...
public class InternalCardinalityTests extends InternalAggregationTestCase<InternalCardinality> {
    ...
    private static CircuitBreakerService limitedBreakerService(ByteSizeValue max) {
        CircuitBreaker breaker = new MockBigArrays.LimitedBreaker(CircuitBreaker.REQUEST, max);

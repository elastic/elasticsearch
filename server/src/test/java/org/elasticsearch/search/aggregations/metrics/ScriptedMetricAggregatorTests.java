        ...
        try (Directory directory = newDirectory()) {
            ...
            try (IndexReader indexReader = DirectoryReader.open(directory)) {
                ...
                ScriptedMetric scriptedMetric = searchAndReduce(
                    new AggTestConfig(newSearcher(indexReader, true, true), new MatchAllDocsQuery(), aggregationBuilder)
                );
    ...
    public void testAggParamsPassedToReduceScript() throws IOException {
        ...
        try (Directory directory = newDirectory()) {
            ...
            try (IndexReader indexReader = DirectoryReader.open(directory)) {
                ...
                ScriptedMetric scriptedMetric = searchAndReduce(
                    new AggTestConfig(newSearcher(indexReader, true, true), new MatchAllDocsQuery(), aggregationBuilder).withMaxBuckets(0)
                );

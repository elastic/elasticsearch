...
public class MovAvgIT extends ESIntegTestCase {
        ...
        SearchResponse response = client()
                ...
                .addAggregation(
                        histogram("histo")
                                ...
                                .subAggregation(
                                        movingAvg("movavg_values", "avg")
                                            .window(windowSize)
                                            .modelBuilder(new SimpleModel.SimpleModelBuilder())
                                            .gapPolicy(gapPolicy).predict(5)))
            .get();
        ...
        SearchResponse response = client()
                ...
                .addAggregation(
                        histogram("histo")
                                ...
                                .subAggregation(
                                        movingAvg("avg_movavg", "avg")
                                            .window(windowSize)
                                            .modelBuilder(new SimpleModel.SimpleModelBuilder())
                                            .gapPolicy(gapPolicy)
                                            .predict(12))
                                .subAggregation(
                                        movingAvg("deriv_movavg", "deriv")
                                            .window(windowSize)
                                            .modelBuilder(new SimpleModel.SimpleModelBuilder())
                                            .gapPolicy(gapPolicy)
                                            .predict(12))
    ...
    private void assertBucketContents(Histogram.Bucket actual, Double expectedCount, Double expectedValue) {
        ...
        if (expectedCount == null) {
            ...
            assertThat("[_count] movavg should be NaN, but is ["+countMovAvg.value()+"] instead",
        ...
        if (expectedValue == null) {
            ...
            assertThat("[value] movavg should be NaN, but is ["+valuesMovAvg.value()+"] instead",

...
public class MovFnWhitelistedFunctionTests extends ESTestCase {
    ...
    public void testWindowMax() {
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            double actual = MovingFunctions.max(window.toArray(new Double[0]));
    ...
    public void testWindowMin() {
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            double actual = MovingFunctions.min(window.toArray(new Double[0]));
            assertEquals(expected, actual, 0.01 * Math.abs(expected));
            window.offer(randValue);
        }
    }
    ...
    public void testWindowSum() {
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            double actual = MovingFunctions.sum(window.toArray(new Double[0]));
            assertEquals(expected, actual, 0.01 * Math.abs(expected));
            window.offer(randValue);
        }
    }
    ...
    public void testSimpleMovAvg() {
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            double actual = MovingFunctions.unweightedAvg(window.toArray(new Double[0]));
            assertEquals(expected, actual, 0.01 * Math.abs(expected));
            window.offer(randValue);
        }
    }
    ...
    public void testSimpleMovStdDev() {
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            double actual = MovingFunctions.stdDev(window.toArray(new Double[0]), mean);
            assertEquals(expected, actual, 0.01 * Math.abs(expected));
            window.offer(randValue);
        }
    }
    ...
    public void testNullSimpleStdDev() {
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            double actual = MovingFunctions.stdDev(window.toArray(new Double[0]),
                MovingFunctions.unweightedAvg(window.toArray(new Double[0])));
            assertThat(actual, equalTo(Double.NaN));
            if (randValue != null) {
                window.offer(randValue);
            }
    ...
    public void testLinearMovAvg() {
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            double actual = MovingFunctions.linearWeightedAvg(window.toArray(new Double[0]));
            assertEquals(expected, actual, 0.01 * Math.abs(expected));
            window.offer(randValue);
        }
    }
    ...
    public void testEWMAMovAvg() {
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            double expected = avg;
            double actual = MovingFunctions.ewma(window.toArray(new Double[0]), alpha);
            assertEquals(expected, actual, 0.01 * Math.abs(expected));
            window.offer(randValue);
        }
    }
    ...
    public void testHoltLinearMovAvg() {
        ...
        for (int i = 0; i < numValues; i++) {
            ...
            double actual = MovingFunctions.holt(window.toArray(new Double[0]), alpha, beta);
            assertEquals(expected, actual, 0.01 * Math.abs(expected));
            window.offer(randValue);
        }
    }
    ...
    public void testHoltWintersMultiplicative() {
        ...
        double actual = MovingFunctions.holtWinters(window.toArray(new Double[0]),

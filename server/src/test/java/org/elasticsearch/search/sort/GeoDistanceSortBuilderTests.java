...
public class GeoDistanceSortBuilderTests extends AbstractSortTestCase<GeoDistanceSortBuilder> {
    ...
    public void testGeoDistanceSortCanBeParsedFromGeoHash() throws IOException {
        ...
        try (XContentParser itemParser = createParser(JsonXContent.jsonXContent, json)) {
            ...
            assertEquals(
                "[POINT (-2.8225036337971687 -19.700583312660456), "
                    + "POINT (-74.63590376079082 31.537466906011105), "
                    + "POINT (-5.548660643398762 43.71844606474042), "
                    + "POINT (38.71751043945551 -37.20467280596495), "
                    + "POINT (84.25200328230858 -69.44606635719538), "
                    + "POINT (44.74099852144718 -39.03717711567879)]",

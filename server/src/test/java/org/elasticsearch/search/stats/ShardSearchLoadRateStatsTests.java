...
public class ShardSearchLoadRateStatsTests extends ESTestCase {
    ...
    private ShardSearchLoadRateService shardStats;
    ...
    public void testZeroDeltaReturnsZeroRate() {
        ...
        ShardSearchLoadRateService.SearchLoadRate result = shardStats.getSearchLoadRate(mockStats);
    ...
    public void testLoadRateComputationConsecutiveCalls() throws InterruptedException {
        ...
        Thread.sleep(10);
        ShardSearchLoadRateService.SearchLoadRate result = shardStats.getSearchLoadRate(mockStats2);

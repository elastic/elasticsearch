...
public class CategoryContextMappingTests extends ESSingleNodeTestCase {
    ...
    public void testIndexingWithNoContexts() throws Exception {
        ...
        ParsedDocument parsedDocument = defaultMapper.parse(SourceToParse.source("test", "type1", "1", null, BytesReference
                .bytes(jsonBuilder()
                        .startObject()
    ...
    public void testIndexingWithSimpleNULLContexts() throws Exception {
        ...
        Exception e = expectThrows(MapperParsingException.class,
            () -> defaultMapper.parse(SourceToParse.source("test", "type1", "1", null, BytesReference.bytes(builder), XContentType.JSON)));
    ...
    public void testIndexingWithMultipleContexts() throws Exception {
        ...
        XContentBuilder builder = jsonBuilder()
                ...
                .endArray()
                .endObject();
        ParsedDocument parsedDocument = defaultMapper.parse(SourceToParse.source("test", "type1", "1", null, BytesReference.bytes(builder),
                XContentType.JSON));
        IndexableField[] fields = parsedDocument.rootDoc().getFields(fieldMapper.name());
        assertContextSuggestFields(fields, 3);
    }

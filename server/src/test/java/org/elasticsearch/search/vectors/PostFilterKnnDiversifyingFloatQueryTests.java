...
public class PostFilterKnnDiversifyingFloatQueryTests extends AbstractPostFilterDiversifyingKnnQueryTests {

    @Override
    protected AssertingKnnQuery.VectorType vectorType() {
        return AssertingKnnQuery.VectorType.DIVERSIFYING_FLOAT;
    }

...
public class RepositoriesMetadataSerializationTests extends ChunkedToXContentDiffableSerializationTestCase<ProjectCustom> {

    @Override
    protected ProjectCustom createTestInstance() {
    ...
    @Override
    protected ProjectCustom doParseInstance(XContentParser parser) throws IOException {

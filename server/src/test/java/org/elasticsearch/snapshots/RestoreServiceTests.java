...
public class RestoreServiceTests extends ESTestCase {
    ...
    public void testUpdateDataStream() {
        ...
        assertEquals(List.of(updatedFailureIndex), updateDataStream.getFailureComponent().getIndices());
    }
    ...
    public void testUpdateDataStreamRename() {
        ...
        assertEquals(List.of(renamedFailureIndex), renamedDataStream.getFailureComponent().getIndices());
    }

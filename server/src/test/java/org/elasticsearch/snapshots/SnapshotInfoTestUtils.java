...
public class SnapshotInfoTestUtils {
    ...
    private static List<SnapshotFeatureInfo> randomSnapshotFeatureInfos() {
        ...
        for (int i = between(0, 5); i >= 0; i--) {
            snapshotFeatureInfos.add(new SnapshotFeatureInfo(randomAlphaOfLengthBetween(1, 10),
                    randomList(0, 5, () -> randomAlphaOfLengthBetween(1, 10)))) ;
        }
    ...
    static SnapshotInfo mutateSnapshotInfo(SnapshotInfo instance) {
        switch (randomIntBetween(0, 10)) {
            ...
            case 1:
                ...
                final List<String> indices = Arrays.asList(randomArray(indicesSize, indicesSize, String[]::new,

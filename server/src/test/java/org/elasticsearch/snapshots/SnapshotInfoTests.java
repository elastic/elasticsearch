...
public class SnapshotInfoTests extends AbstractWireSerializingTestCase<SnapshotInfo> {
    ...
    protected SnapshotInfo createTestInstance() {
        ...
        return new SnapshotInfo(snapshotId, indices, dataStreams, null, reason, endTime, totalShards, shardFailures, includeGlobalState,
            userMetadata, startTime
        );
    }
    ...
    protected SnapshotInfo mutateInstance(SnapshotInfo instance) {
        switch (randomIntBetween(0, 8)) {
            case 0:
                ...
                return new SnapshotInfo(snapshotId, instance.indices(), instance.dataStreams(), null, instance.reason(),
            ...
            case 1:
                ...
                return new SnapshotInfo(instance.snapshotId(), indices, instance.dataStreams(), null, instance.reason(),
                    instance.endTime(), instance.totalShards(), instance.shardFailures(), instance.includeGlobalState(),
                    instance.userMetadata(), instance.startTime()
                );
            case 2:
                return new SnapshotInfo(instance.snapshotId(), instance.indices(), instance.dataStreams(),
                    null, instance.reason(), instance.endTime(), instance.totalShards(), instance.shardFailures(),
                    instance.includeGlobalState(), instance.userMetadata(), randomValueOtherThan(instance.startTime(),
                    ESTestCase::randomNonNegativeLong)
                );
            case 3:
                return new SnapshotInfo(instance.snapshotId(), instance.indices(), instance.dataStreams(), null,
            ...
            case 4:
                return new SnapshotInfo(instance.snapshotId(), instance.indices(), instance.dataStreams(),
                    null, instance.reason(), randomValueOtherThan(instance.endTime(), ESTestCase::randomNonNegativeLong),
                    instance.totalShards(), instance.shardFailures(), instance.includeGlobalState(), instance.userMetadata(),
                    instance.startTime()
                );
            case 5:
                ...
                return new SnapshotInfo(instance.snapshotId(), instance.indices(), instance.dataStreams(), null, instance.reason(),

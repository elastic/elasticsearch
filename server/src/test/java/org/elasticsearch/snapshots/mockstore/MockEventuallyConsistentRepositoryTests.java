    ...
    public void testOverwriteSnapshotInfoBlob() {
        ...
        try (BlobStoreRepository repository =
            ...
            repository.finalizeSnapshot(snapshotId, ShardGenerations.EMPTY, 1L, null, 5, Collections.emptyList(),
                -1L, false, MetaData.EMPTY_META_DATA, Collections.emptyMap(), true, true, future);
            future.actionGet();
            ...
            final AssertionError assertionError = expectThrows(AssertionError.class,
                () -> {
                    ...
                    repository.finalizeSnapshot(
                        ...
                        0, false, MetaData.EMPTY_META_DATA, Collections.emptyMap(), true, true, fut);
                    fut.actionGet();
                });
            ...
            repository.finalizeSnapshot(snapshotId, ShardGenerations.EMPTY, 1L, null, 5, Collections.emptyList(),
                0, false, MetaData.EMPTY_META_DATA, Collections.emptyMap(),true, true, future2);
            future2.actionGet();
        }
    }

...
public class InlineArrayReaderTests extends ESTestCase {
    ...
    public void testWithOffset() {
        ...
        InlineArrayReader reader = new InlineArrayReader(withPrefix, 5, packed.length, false);
        assertTrue(reader.next());
    ...
    public void testUnionArrayWithCompoundKeyValue() {
        ...
        KeyValueReader kv = reader.nestedKeyValue();
        assertTrue(kv.next());

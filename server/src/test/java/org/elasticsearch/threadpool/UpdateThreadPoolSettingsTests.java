...
public class UpdateThreadPoolSettingsTests extends ESThreadPoolTestCase {
    ...
    public void testFixedExecutorType() throws InterruptedException {
        ...
        try {
            ...
            Settings nodeSettings = Settings.builder()
                ...
                .build();
            threadPool = new ThreadPool(nodeSettings, Meter.NOOP);
    ...
    public void testCustomThreadPool() throws Exception {
        ...
        try {
            ...
            threadPool = new ThreadPool(Settings.builder().put("node.name", "testCustomThreadPool").build(), Meter.NOOP, scaling, fixed);

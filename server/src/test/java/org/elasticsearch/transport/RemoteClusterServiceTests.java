...
public class RemoteClusterServiceTests extends ESTestCase {
    ...
    public void testSettingsAreRegistered() {
        ...
        if (TcpTransport.isUntrustedRemoteClusterEnabled()) {
            assertTrue(ClusterSettings.BUILT_IN_CLUSTER_SETTINGS.contains(RemoteConnectionStrategy.REMOTE_CLUSTER_AUTHORIZATION));
        } else {
            assertTrue(ClusterSettings.BUILT_IN_CLUSTER_SETTINGS.contains(RemoteConnectionStrategy.REMOTE_CLUSTER_AUTHORIZATION) == false);
        }

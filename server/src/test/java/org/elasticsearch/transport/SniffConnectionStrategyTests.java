...
public class SniffConnectionStrategyTests extends ESTestCase {
    ...
    public void testGetNodePredicateNodeVersion() {
        ...
        DiscoveryNode node = DiscoveryNodeUtils.create("id", address, Collections.emptyMap(), roles, version);
    ...
    public void testGetNodePredicatesCombination() {
        ...
        {
            DiscoveryNode node = DiscoveryNodeUtils.create("id", address, Collections.singletonMap("gateway", "true"), dedicatedMasterRoles);

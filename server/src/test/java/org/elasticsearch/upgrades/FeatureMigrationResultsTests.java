...
public class FeatureMigrationResultsTests extends ChunkedToXContentDiffableSerializationTestCase<MetadataSection> {
    ...
    @Override
    protected FeatureMigrationResults mutateInstance(MetadataSection instance) {

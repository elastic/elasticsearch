...
public class FeatureMigrationResultsTests extends ChunkedToXContentDiffableSerializationTestCase<ProjectMetadata.ProjectCustom> {
    ...
    @Override
    protected FeatureMigrationResults mutateInstance(ProjectMetadata.ProjectCustom instance) {

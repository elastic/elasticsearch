...
/**
 */
public class SealIndicesAction extends IndicesAction<SealIndicesRequest, SealIndicesResponse, SealIndicesRequestBuilder> {
    ...
    @Override
    public SealIndicesRequestBuilder newRequestBuilder(IndicesAdminClient client) {
        return new SealIndicesRequestBuilder(client);
    }
}

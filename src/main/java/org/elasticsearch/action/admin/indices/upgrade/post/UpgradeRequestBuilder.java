 ...
 */
public class UpgradeRequestBuilder extends BroadcastOperationRequestBuilder<UpgradeRequest, UpgradeResponse, UpgradeRequestBuilder, IndicesAdminClient> {

    public UpgradeRequestBuilder(IndicesAdminClient client) {
        super(client, new UpgradeRequest());
    }
    ...
    protected void doExecute(ActionListener listener) {
        client.upgrade(request, listener);
    }
}

...
public class UpgradeSettingsRequestBuilder extends AcknowledgedRequestBuilder<UpgradeSettingsRequest, UpgradeSettingsResponse, UpgradeSettingsRequestBuilder, ClusterAdminClient> {
    ...
    public UpgradeSettingsRequestBuilder(ClusterAdminClient client) {
        super(client, new UpgradeSettingsRequest());
    }
    ...
    @Override
    protected void doExecute(ActionListener<UpgradeSettingsResponse> listener) {
        client.execute(UpgradeSettingsAction.INSTANCE, request, listener);
    }
}

...
public class BoundsManagingActionListener<Response> implements ActionListener<Response> {
    ...
    public void onFailure(Throwable e) {
        try {
            if (errorMessages.size() < 5) {
                BenchmarkExecutor.logger.debug("Failed to execute benchmark [{}]", e.getMessage(), e);

 ...
 */
public class BenchmarkStartRequest extends MasterNodeOperationRequest<BenchmarkStartRequest> implements CompositeIndicesRequest {
     ...
     */
    public BenchmarkStartRequest() { }

    /**
     * Constructs a benchmark request
     */
    public BenchmarkStartRequest(String... indices) {
    ...
    public ActionRequestValidationException validate() {
        ...
        if (benchmarkId == null) {
            validationException = ValidateActions.addValidationError("Benchmark ID must not be null", validationException);
        }
        if (competitors.isEmpty()) {
            validationException = ValidateActions.addValidationError("Benchmark competitors must not be empty", validationException);
        }
        if (numExecutorNodes <= 0) {
            validationException = ValidateActions.addValidationError("Benchmark num_executors must be at least 1", validationException);
        }

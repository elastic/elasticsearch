 ...
 */
public class BenchmarkStatusAction extends ClientAction<BenchmarkStatusRequest, BenchmarkStatusResponses, BenchmarkStatusRequestBuilder> {
    ...
    @Override
    public BenchmarkStatusResponses newResponse() {

...
public abstract class TransportShardReplicationOperationAction<Request extends ShardReplicationOperationRequest, ReplicaRequest extends ShardReplicationOperationRequest, Response extends ActionResponse> extends TransportAction<Request, Response> {
    ...
    public final static String VALIDATE_WRITE_CONSISTENCY = "action.replication.validate_write_consistency";
    ...
    protected TransportShardReplicationOperationAction(Settings settings, String actionName, TransportService transportService,
        ...
        this.defaultValidateWriteConsistency = settings.getAsBoolean(VALIDATE_WRITE_CONSISTENCY, false);
    }
    ...
    protected class AsyncShardOperationAction {
        ...
        void performOnPrimary(final int primaryShardId, final ShardRouting shard, final ClusterState clusterState, final WriteConsistencyLevel consistencyLevel, final int requiredNumber) {
            ...
            if (internalRequest.request().validateWriteConsistency() != null) {
                validateWriteConsistency = internalRequest.request().validateWriteConsistency();
            } else {

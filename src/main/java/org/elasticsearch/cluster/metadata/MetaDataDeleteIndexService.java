        ...
        clusterService.submitStateUpdateTask("delete-index [" + request.index() + "]", Priority.URGENT, new AckedClusterStateUpdateTask() {
            ...
            public ClusterState execute(final ClusterState currentState) {
                ...
                MetaData newMetaData = MetaData.builder(currentState.metaData())
                        ...
                        .build();
                //no wait for other nodes needed as we use AckedClusterStateUpdateTask to submit the cluster state update
                //each node gets back after it has removed the index from the cluster state and deleted files from file system

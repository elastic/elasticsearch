...
public class Lucene {
    ...
    /**
     * This exception is thrown when a search exceeds a stated timeout
     * parameter. We cannot reuse Lucene's {@link TimeExceededException} because
     * the constructor is private.
     **/
    public final static class TimedoutException extends ElasticsearchException {

        public TimedoutException(long expectedTimeout, long recordedTime) {
            super("Timeout - overrun of " + (expectedTimeout - recordedTime));
        }
    }

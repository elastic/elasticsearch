...
public class DiscoveryService extends AbstractLifecycleComponent<DiscoveryService> {
    ...
    protected void doStart() throws ElasticsearchException {
        ...
        discovery.addListener(initialState);
        discovery.start();
    ...
    public void waitForInitialState() {
        try {
            if (!initialState.waitForInitialState(initialStateTimeout)) {
    ...
    protected void doStop() throws ElasticsearchException {
        if (initialState != null) {
            discovery.removeListener(initialState);
        }
        discovery.stop();
    }
    ...
    public boolean initialStateReceived() {
        return initialState.initialStateReceived;
    }

...
/**
* Replacement for Lucene's PatternAnalyzer which is not susceptible to lowercasing localization issues.
*/
public final class PatternAnalyzer extends Analyzer {
    ...
    public PatternAnalyzer(org.apache.lucene.util.Version version, Pattern pattern, boolean lowercase, CharArraySet stopWords) {

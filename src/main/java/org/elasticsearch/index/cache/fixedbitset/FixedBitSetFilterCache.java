...
public class FixedBitSetFilterCache extends AbstractIndexComponent implements AtomicReader.CoreClosedListener, RemovalListener<Object, Cache<Filter, FixedBitSetFilterCache.Value>> {
    ...
    @Inject
    public FixedBitSetFilterCache(Index index, @IndexSettings Settings indexSettings, @Nullable IndicesWarmer indicesWarmer) {
    ...
    final class FixedBitSetFilterWarmer extends IndicesWarmer.Listener {
        ...
        @Override
        public TerminationHandle warm(final IndexShard indexShard, IndexMetaData indexMetaData, final IndicesWarmer.WarmerContext context, ThreadPool threadPool) {

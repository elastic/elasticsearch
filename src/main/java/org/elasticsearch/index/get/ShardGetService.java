...
public class ShardGetService extends AbstractIndexShardComponent {
        ...
        try {
            ...
            if (get.docIdAndVersion() != null) {
                ...
                if (fieldSelector != null) {
                    ...
                    source = extractSource(type, id, doc, mapperService, docMapper);
    ...
    private static BytesHolder extractSource(String type, String id, Document doc, MapperService mapperService, DocumentMapper documentMapper) {
        BytesHolder source = null;

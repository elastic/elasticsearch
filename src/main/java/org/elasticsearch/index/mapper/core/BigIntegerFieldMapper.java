...
import static org.elasticsearch.common.xcontent.support.XContentMapValues.nodeBigIntegerValue;
import static org.elasticsearch.index.mapper.MapperBuilders.bigintegerField;
import static org.elasticsearch.index.mapper.core.TypeParsers.parseNumberField;

/**
 *
 */
public class BigIntegerFieldMapper extends NumberFieldMapper<BigInteger> {

    public static final String CONTENT_TYPE = "biginteger";
    ...
    public static class Defaults extends NumberFieldMapper.Defaults {
        ...
        public static final BigInteger NULL_VALUE = null;
    }

    public static class Builder extends NumberFieldMapper.Builder<Builder, BigIntegerFieldMapper> {

        protected BigInteger nullValue = Defaults.NULL_VALUE;
        ...
        public Builder nullValue(BigInteger nullValue) {
            this.nullValue = nullValue;
            return this;
        }

        @Override
        public BigIntegerFieldMapper build(BuilderContext context) {
            fieldType.setOmitNorms(fieldType.omitNorms() && boost == 1.0f);
            BigIntegerFieldMapper fieldMapper = new BigIntegerFieldMapper(buildNames(context), precisionStep, boost, fieldType, docValues, nullValue,
    ...
    public static class TypeParser implements Mapper.TypeParser {
        ...
        public Mapper.Builder parse(String name, Map<String, Object> node, ParserContext parserContext) throws MapperParsingException {
            BigIntegerFieldMapper.Builder builder = bigintegerField(name);
            parseNumberField(builder, name, node, parserContext);
            for (Map.Entry<String, Object> entry : node.entrySet()) {
                String propName = Strings.toUnderscoreCase(entry.getKey());
                Object propNode = entry.getValue();
                if (propName.equals("null_value")) {
                    builder.nullValue(nodeBigIntegerValue(propNode));
                }
            }
            return builder;
        }
    ...
    protected BigIntegerFieldMapper(Names names, int precisionStep, float boost, FieldType fieldType, Boolean docValues,
                                    BigInteger nullValue, Explicit<Boolean> ignoreMalformed, Explicit<Boolean> coerce,
    ...
    public FieldDataType defaultFieldDataType() {
        return new FieldDataType("biginteger");
    }
    ...
    protected void innerParseCreateField(ParseContext context, List<Field> fields) throws IOException {
        ...
        if (context.externalValueSet()) {
            ...
            if (externalValue == null) {
                ...
                value = nullValue;
            } else if (externalValue instanceof BigInteger) {
                value = (BigInteger) externalValue;
                ...
                if (sExternalValue.length() == 0) {
                    ...
                    value = new BigInteger(sExternalValue);
                }
            } else {
                value = new BigInteger(externalValue.toString());
            }
        ...
        if (hasDocValues()) {
            addDocValue(context, value.longValue());
        }
    }
    ...
    public void merge(Mapper mergeWith, MergeContext mergeContext) throws MergeMappingException {
        ...
        if (!mergeContext.mergeFlags().simulate()) {
            this.nullValue = ((BigIntegerFieldMapper) mergeWith).nullValue;
            this.nullValueAsString = ((BigIntegerFieldMapper) mergeWith).nullValueAsString;
        }
    }
    ...
    public static class CustomBigIntegerNumericField extends CustomNumericField {
        ...
        public CustomBigIntegerNumericField(NumberFieldMapper mapper, BigInteger number, FieldType fieldType) {
        ...
        public TokenStream tokenStream(Analyzer analyzer) throws IOException {
            if (fieldType().indexed()) {
                return mapper.popCachedStream().setLongValue(number.longValue());
            }
            return null;
        }

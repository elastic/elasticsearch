...
import org.elasticsearch.index.query.GeoShapeQueryBuilder.DEFAULTS;
 ...
 */
public class GeoShapeQueryBuilder extends BaseQueryBuilder implements QueryParser, BoostableQueryBuilder<GeoShapeQueryBuilder> {
    ...
    public GeoShapeQueryBuilder() {
        // for juice, functionality of the former GeoShapeQueryParser

...
public class TemplateQueryParser implements QueryParser {
    ...
    public Query parse(QueryParseContext parseContext) throws IOException {
        ...
        ExecutableScript executable = this.scriptService.executable(MustacheScriptEngineService.NAME, templateContext.template(), templateContext.scriptType(), ScriptContextRegistry.SEARCH, templateContext.params());

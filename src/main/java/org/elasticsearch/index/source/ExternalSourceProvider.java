...
public interface ExternalSourceProvider {
     ...
     * not necessary to restore the source later. If source can be restored based only on type
     * and id, this method can return null to indicate that source shouldn't be stored.
     *
    ...
    /**
     * Returns true if this external source provider is enabled
     * @return true if this external source provider is enabled, false otherwise
     */
    boolean enabled();
}

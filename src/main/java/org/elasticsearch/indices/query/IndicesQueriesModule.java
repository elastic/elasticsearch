...
public class IndicesQueriesModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        qpBinders.addBinding().to(SpanNotQueryBuilder.class).asEagerSingleton();
        qpBinders.addBinding().to(FieldMaskingSpanQueryBuilder.class).asEagerSingleton();
        qpBinders.addBinding().to(SpanFirstQueryBuilder.class).asEagerSingleton();
        qpBinders.addBinding().to(SpanNearQueryBuilder.class).asEagerSingleton();
        qpBinders.addBinding().to(SpanOrQueryBuilder.class).asEagerSingleton();

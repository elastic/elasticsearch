...
package org.elasticsearch.legacy.action.delete;

import org.elasticsearch.legacy.action.ActionListener;
import org.elasticsearch.legacy.action.WriteConsistencyLevel;
import org.elasticsearch.legacy.action.support.replication.ReplicationType;
import org.elasticsearch.legacy.action.support.replication.ShardReplicationOperationRequestBuilder;
...
public class DeleteRequestBuilder extends ShardReplicationOperationRequestBuilder<DeleteRequest, DeleteResponse, DeleteRequestBuilder> {
    ...
    /**
     * Sets the consistency level. Defaults to {@link org.elasticsearch.legacy.action.WriteConsistencyLevel#DEFAULT}.
     */

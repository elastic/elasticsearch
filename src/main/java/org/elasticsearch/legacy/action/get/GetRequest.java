...
import org.elasticsearch.legacy.action.support.single.shard.SingleShardOperationRequest;
 ...
 * to be set.
 *
 * @see org.elasticsearch.legacy.action.get.GetResponse
...
public class GetRequest extends SingleShardOperationRequest<GetRequest> {
    ...
    /**
     * Sets the versioning type. Defaults to {@link org.elasticsearch.legacy.index.VersionType#INTERNAL}.
     */

...
import org.elasticsearch.legacy.*;
 ...
 * its string form ({@link #source(String)}) or using a {@link org.elasticsearch.legacy.common.xcontent.XContentBuilder}
 * ({@link #source(org.elasticsearch.legacy.common.xcontent.XContentBuilder)}).
 * <p/>
...
public class PutIndexedScriptRequest extends ActionRequest<PutIndexedScriptRequest> {
     ...
     * <p/>
     * <p>Note, its preferable to either set it using {@link #source(org.elasticsearch.legacy.common.xcontent.XContentBuilder)}
    ...
    /**
     * Set to <tt>true</tt> to force this index to use {@link org.elasticsearch.legacy.action.index.IndexRequest.OpType#CREATE}.
     */

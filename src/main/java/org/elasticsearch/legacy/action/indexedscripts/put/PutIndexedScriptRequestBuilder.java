...
public class PutIndexedScriptRequestBuilder extends ActionRequestBuilder<PutIndexedScriptRequest, PutIndexedScriptResponse, PutIndexedScriptRequestBuilder, Client> {
     ...
     * <p/>
     * <p>Note, its preferable to either set it using {@link #setSource(org.elasticsearch.legacy.common.xcontent.XContentBuilder)}
    ...
    /**
     * Sets a string representation of the {@link #setOpType(org.elasticsearch.legacy.action.index.IndexRequest.OpType)}. Can

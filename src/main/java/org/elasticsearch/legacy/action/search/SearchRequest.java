 ...
 * <p/>
 * <p>Note, the search {@link #source(org.elasticsearch.legacy.search.builder.SearchSourceBuilder)}
 * is required. The search source is the different search options, including facets and such.
 * <p/>
 * <p>There is an option to specify an addition search source using the {@link #extraSource(org.elasticsearch.legacy.search.builder.SearchSourceBuilder)}.
 *
...
//        }
     ...
     * {@link #source(org.elasticsearch.legacy.search.builder.SearchSourceBuilder)}.
     */

...
import org.elasticsearch.legacy.search.rescore.RescoreBuilder;
...
public class SearchRequestBuilder extends ActionRequestBuilder<SearchRequest, SearchResponse, SearchRequestBuilder, Client> {
    ...
    /**
     * The search type to execute, defaults to {@link org.elasticsearch.legacy.action.search.SearchType#DEFAULT}.
     */
     ...
     * use {@link org.elasticsearch.legacy.action.search.SearchRequestBuilder#setFetchSource(String, String)} instead
     *
    ...
    /**
     * Delegates to {@link org.elasticsearch.legacy.search.suggest.SuggestBuilder#setText(String)}.
     */
    ...
    /**
     * Delegates to {@link org.elasticsearch.legacy.search.suggest.SuggestBuilder#addSuggestion(org.elasticsearch.legacy.search.suggest.SuggestBuilder.SuggestionBuilder)}.
     */
     ...
     * {@link #addRescorer(org.elasticsearch.legacy.search.rescore.RescoreBuilder.Rescorer, int)}.

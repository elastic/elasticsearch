...
import static org.elasticsearch.legacy.action.search.ShardSearchFailure.readShardSearchFailure;
import static org.elasticsearch.legacy.search.internal.InternalSearchResponse.readInternalSearchResponse;
...
public class SearchResponse extends ActionResponse implements StatusToXContent {
    ...
    /**
     * If scrolling was enabled ({@link SearchRequest#scroll(org.elasticsearch.legacy.search.Scroll)}, the

...
package org.elasticsearch.legacy.action.support.replication;
...
public class IndexReplicationOperationRequest<T extends IndexReplicationOperationRequest> extends ActionRequest<T> {
    ...
    /**
     * Sets the consistency level of write. Defaults to {@link org.elasticsearch.legacy.action.WriteConsistencyLevel#DEFAULT}
     */
    @SuppressWarnings("unchecked")

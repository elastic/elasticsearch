...
import org.elasticsearch.legacy.action.support.single.instance.InstanceShardOperationRequestBuilder;
...
public class UpdateRequestBuilder extends InstanceShardOperationRequestBuilder<UpdateRequest, UpdateResponse, UpdateRequestBuilder> {
    ...
    /**
     * Sets the index request to be used if the document does not exists. Otherwise, a {@link org.elasticsearch.legacy.index.engine.DocumentMissingException}
     * is thrown.
     */

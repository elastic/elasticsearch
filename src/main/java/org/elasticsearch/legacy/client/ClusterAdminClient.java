...
import org.elasticsearch.legacy.action.admin.cluster.node.hotthreads.NodesHotThreadsRequest;
import org.elasticsearch.legacy.action.admin.cluster.node.hotthreads.NodesHotThreadsRequestBuilder;
import org.elasticsearch.legacy.action.admin.cluster.node.hotthreads.NodesHotThreadsResponse;
import org.elasticsearch.legacy.action.admin.cluster.node.info.NodesInfoRequest;
import org.elasticsearch.legacy.action.admin.cluster.node.info.NodesInfoRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.node.restart.NodesRestartRequestBuilder;
import org.elasticsearch.legacy.action.admin.cluster.node.restart.NodesRestartResponse;
import org.elasticsearch.legacy.action.admin.cluster.node.shutdown.NodesShutdownRequest;
import org.elasticsearch.legacy.action.admin.cluster.node.shutdown.NodesShutdownRequestBuilder;
import org.elasticsearch.legacy.action.admin.cluster.node.shutdown.NodesShutdownResponse;
import org.elasticsearch.legacy.action.admin.cluster.node.stats.NodesStatsRequest;
import org.elasticsearch.legacy.action.admin.cluster.node.stats.NodesStatsRequestBuilder;
import org.elasticsearch.legacy.action.admin.cluster.node.stats.NodesStatsResponse;
import org.elasticsearch.legacy.action.admin.cluster.repositories.delete.DeleteRepositoryRequest;
import org.elasticsearch.legacy.action.admin.cluster.repositories.delete.DeleteRepositoryRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.repositories.get.GetRepositoriesRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.repositories.put.PutRepositoryRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.reroute.ClusterRerouteRequestBuilder;
import org.elasticsearch.legacy.action.admin.cluster.reroute.ClusterRerouteResponse;
import org.elasticsearch.legacy.action.admin.cluster.settings.ClusterUpdateSettingsRequest;
import org.elasticsearch.legacy.action.admin.cluster.settings.ClusterUpdateSettingsRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.shards.ClusterSearchShardsRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.snapshots.create.CreateSnapshotRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.snapshots.delete.DeleteSnapshotRequestBuilder;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.delete.DeleteSnapshotResponse;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.get.GetSnapshotsRequest;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.get.GetSnapshotsRequestBuilder;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.get.GetSnapshotsResponse;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.restore.RestoreSnapshotRequest;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.restore.RestoreSnapshotRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.snapshots.status.SnapshotsStatusRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.state.ClusterStateRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.stats.ClusterStatsRequestBuilder;
...
import org.elasticsearch.legacy.action.admin.cluster.tasks.PendingClusterTasksRequestBuilder;

...
package org.elasticsearch.legacy.client;

import org.elasticsearch.legacy.action.*;
import org.elasticsearch.legacy.action.admin.indices.alias.IndicesAliasesRequest;
import org.elasticsearch.legacy.action.admin.indices.alias.IndicesAliasesRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.alias.IndicesAliasesResponse;
import org.elasticsearch.legacy.action.admin.indices.alias.exists.AliasesExistRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.alias.exists.AliasesExistResponse;
import org.elasticsearch.legacy.action.admin.indices.alias.get.GetAliasesRequest;
import org.elasticsearch.legacy.action.admin.indices.alias.get.GetAliasesRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.alias.get.GetAliasesResponse;
import org.elasticsearch.legacy.action.admin.indices.analyze.AnalyzeRequest;
import org.elasticsearch.legacy.action.admin.indices.analyze.AnalyzeRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.analyze.AnalyzeResponse;
import org.elasticsearch.legacy.action.admin.indices.cache.clear.ClearIndicesCacheRequest;
import org.elasticsearch.legacy.action.admin.indices.cache.clear.ClearIndicesCacheRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.cache.clear.ClearIndicesCacheResponse;
import org.elasticsearch.legacy.action.admin.indices.close.CloseIndexRequest;
import org.elasticsearch.legacy.action.admin.indices.close.CloseIndexRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.close.CloseIndexResponse;
import org.elasticsearch.legacy.action.admin.indices.create.CreateIndexRequest;
import org.elasticsearch.legacy.action.admin.indices.create.CreateIndexRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.create.CreateIndexResponse;
import org.elasticsearch.legacy.action.admin.indices.delete.DeleteIndexRequest;
import org.elasticsearch.legacy.action.admin.indices.delete.DeleteIndexRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.delete.DeleteIndexResponse;
import org.elasticsearch.legacy.action.admin.indices.exists.indices.IndicesExistsRequest;
import org.elasticsearch.legacy.action.admin.indices.exists.indices.IndicesExistsRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.exists.indices.IndicesExistsResponse;
import org.elasticsearch.legacy.action.admin.indices.exists.types.TypesExistsRequest;
import org.elasticsearch.legacy.action.admin.indices.exists.types.TypesExistsRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.exists.types.TypesExistsResponse;
import org.elasticsearch.legacy.action.admin.indices.flush.FlushRequest;
import org.elasticsearch.legacy.action.admin.indices.flush.FlushRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.flush.FlushResponse;
import org.elasticsearch.legacy.action.admin.indices.mapping.delete.DeleteMappingRequest;
import org.elasticsearch.legacy.action.admin.indices.mapping.delete.DeleteMappingRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.mapping.delete.DeleteMappingResponse;
import org.elasticsearch.legacy.action.admin.indices.mapping.get.*;
import org.elasticsearch.legacy.action.admin.indices.mapping.put.PutMappingRequest;
import org.elasticsearch.legacy.action.admin.indices.mapping.put.PutMappingRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.mapping.put.PutMappingResponse;
import org.elasticsearch.legacy.action.admin.indices.open.OpenIndexRequest;
import org.elasticsearch.legacy.action.admin.indices.open.OpenIndexRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.open.OpenIndexResponse;
import org.elasticsearch.legacy.action.admin.indices.optimize.OptimizeRequest;
import org.elasticsearch.legacy.action.admin.indices.optimize.OptimizeRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.optimize.OptimizeResponse;
import org.elasticsearch.legacy.action.admin.indices.refresh.RefreshRequest;
import org.elasticsearch.legacy.action.admin.indices.refresh.RefreshRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.refresh.RefreshResponse;
import org.elasticsearch.legacy.action.admin.indices.segments.IndicesSegmentResponse;
import org.elasticsearch.legacy.action.admin.indices.segments.IndicesSegmentsRequest;
import org.elasticsearch.legacy.action.admin.indices.segments.IndicesSegmentsRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.settings.get.GetSettingsRequest;
import org.elasticsearch.legacy.action.admin.indices.settings.get.GetSettingsRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.settings.get.GetSettingsResponse;
import org.elasticsearch.legacy.action.admin.indices.settings.put.UpdateSettingsRequest;
import org.elasticsearch.legacy.action.admin.indices.settings.put.UpdateSettingsRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.settings.put.UpdateSettingsResponse;
import org.elasticsearch.legacy.action.admin.indices.stats.IndicesStatsRequest;
import org.elasticsearch.legacy.action.admin.indices.stats.IndicesStatsRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.stats.IndicesStatsResponse;
import org.elasticsearch.legacy.action.admin.indices.status.IndicesStatusRequest;
import org.elasticsearch.legacy.action.admin.indices.status.IndicesStatusRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.status.IndicesStatusResponse;
import org.elasticsearch.legacy.action.admin.indices.recovery.RecoveryRequest;
import org.elasticsearch.legacy.action.admin.indices.recovery.RecoveryRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.recovery.RecoveryResponse;
import org.elasticsearch.legacy.action.admin.indices.template.delete.DeleteIndexTemplateRequest;
import org.elasticsearch.legacy.action.admin.indices.template.delete.DeleteIndexTemplateRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.template.delete.DeleteIndexTemplateResponse;
import org.elasticsearch.legacy.action.admin.indices.template.get.GetIndexTemplatesRequest;
import org.elasticsearch.legacy.action.admin.indices.template.get.GetIndexTemplatesRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.template.get.GetIndexTemplatesResponse;
import org.elasticsearch.legacy.action.admin.indices.template.put.PutIndexTemplateRequest;
import org.elasticsearch.legacy.action.admin.indices.template.put.PutIndexTemplateRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.template.put.PutIndexTemplateResponse;
import org.elasticsearch.legacy.action.admin.indices.validate.query.ValidateQueryRequest;
import org.elasticsearch.legacy.action.admin.indices.validate.query.ValidateQueryRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.validate.query.ValidateQueryResponse;
import org.elasticsearch.legacy.action.admin.indices.warmer.delete.DeleteWarmerRequest;
import org.elasticsearch.legacy.action.admin.indices.warmer.delete.DeleteWarmerRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.warmer.delete.DeleteWarmerResponse;
import org.elasticsearch.legacy.action.admin.indices.warmer.get.GetWarmersRequest;
import org.elasticsearch.legacy.action.admin.indices.warmer.get.GetWarmersRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.warmer.get.GetWarmersResponse;
import org.elasticsearch.legacy.action.admin.indices.warmer.put.PutWarmerRequest;
import org.elasticsearch.legacy.action.admin.indices.warmer.put.PutWarmerRequestBuilder;
import org.elasticsearch.legacy.action.admin.indices.warmer.put.PutWarmerResponse;

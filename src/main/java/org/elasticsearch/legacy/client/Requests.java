...
import org.elasticsearch.legacy.action.admin.cluster.node.info.NodesInfoRequest;
import org.elasticsearch.legacy.action.admin.cluster.node.restart.NodesRestartRequest;
import org.elasticsearch.legacy.action.admin.cluster.node.shutdown.NodesShutdownRequest;
import org.elasticsearch.legacy.action.admin.cluster.node.stats.NodesStatsRequest;
import org.elasticsearch.legacy.action.admin.cluster.repositories.delete.DeleteRepositoryRequest;
...
import org.elasticsearch.legacy.action.admin.cluster.reroute.ClusterRerouteRequest;
import org.elasticsearch.legacy.action.admin.cluster.settings.ClusterUpdateSettingsRequest;
import org.elasticsearch.legacy.action.admin.cluster.shards.ClusterSearchShardsRequest;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.create.CreateSnapshotRequest;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.delete.DeleteSnapshotRequest;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.get.GetSnapshotsRequest;
import org.elasticsearch.legacy.action.admin.cluster.snapshots.restore.RestoreSnapshotRequest;
...
import org.elasticsearch.legacy.action.admin.cluster.stats.ClusterStatsRequest;
...
import org.elasticsearch.legacy.action.bulk.BulkRequest;
import org.elasticsearch.legacy.action.count.CountRequest;
import org.elasticsearch.legacy.action.delete.DeleteRequest;
import org.elasticsearch.legacy.action.deletebyquery.DeleteByQueryRequest;
...
public class Requests {
     ...
     * @see org.elasticsearch.client.Client#index(org.elasticsearch.legacy.action.index.IndexRequest)
     */
     ...
     * @see org.elasticsearch.client.Client#delete(org.elasticsearch.legacy.action.delete.DeleteRequest)
     */
     ...
     * of the query, or by using a {@link org.elasticsearch.legacy.index.query.QueryBuilder} (using {@link org.elasticsearch.legacy.index.query.QueryBuilders}).
     *
     ...
     * @see org.elasticsearch.client.Client#deleteByQuery(org.elasticsearch.legacy.action.deletebyquery.DeleteByQueryRequest)
     */
     ...
     * @see org.elasticsearch.client.Client#get(org.elasticsearch.legacy.action.get.GetRequest)
     */
     ...
     * either using the JSON source of the query, or using a {@link org.elasticsearch.legacy.index.query.QueryBuilder} (using {@link org.elasticsearch.legacy.index.query.QueryBuilders}).
     *
     ...
     * @see org.elasticsearch.client.Client#count(org.elasticsearch.legacy.action.count.CountRequest)
     */
     ...
     * @see org.elasticsearch.client.Client#moreLikeThis(org.elasticsearch.legacy.action.mlt.MoreLikeThisRequest)
     */
     ...
     * actual JSON search source, or the {@link org.elasticsearch.legacy.search.builder.SearchSourceBuilder}.
     *
     * @param indices The indices to search against. Use <tt>null</tt> or <tt>_all</tt> to execute against all indices
     * @return The search request
     * @see org.elasticsearch.client.Client#search(org.elasticsearch.legacy.action.search.SearchRequest)
     */
     ...
     * @see org.elasticsearch.client.Client#searchScroll(org.elasticsearch.legacy.action.search.SearchScrollRequest)
     */
     ...
     * @see org.elasticsearch.client.IndicesAdminClient#status(org.elasticsearch.legacy.action.admin.indices.status.IndicesStatusRequest)
     */
    @Deprecated
     ...
     * @see org.elasticsearch.client.IndicesAdminClient#exists(org.elasticsearch.legacy.action.admin.indices.exists.indices.IndicesExistsRequest)
     */
     ...
     * @see org.elasticsearch.client.IndicesAdminClient#create(org.elasticsearch.legacy.action.admin.indices.create.CreateIndexRequest)
     */
     ...
     * @see org.elasticsearch.client.IndicesAdminClient#delete(org.elasticsearch.legacy.action.admin.indices.delete.DeleteIndexRequest)
     */
     ...
     * @return The delete index request
     * @see org.elasticsearch.client.IndicesAdminClient#close(org.elasticsearch.legacy.action.admin.indices.close.CloseIndexRequest)
     */
     ...
     * @return The delete index request
     * @see org.elasticsearch.client.IndicesAdminClient#open(org.elasticsearch.legacy.action.admin.indices.open.OpenIndexRequest)
     */
     ...
     * @see org.elasticsearch.client.IndicesAdminClient#putMapping(org.elasticsearch.legacy.action.admin.indices.mapping.put.PutMappingRequest)
     */
     ...
     * @return The create mapping request
     * @see org.elasticsearch.client.IndicesAdminClient#deleteMapping(org.elasticsearch.legacy.action.admin.indices.mapping.delete.DeleteMappingRequest)
     */
     ...
     * @see org.elasticsearch.client.IndicesAdminClient#refresh(org.elasticsearch.legacy.action.admin.indices.refresh.RefreshRequest)
     */
     ...
     * @see org.elasticsearch.client.IndicesAdminClient#flush(org.elasticsearch.legacy.action.admin.indices.flush.FlushRequest)
     */
     ...
     * @see org.elasticsearch.client.IndicesAdminClient#optimize(org.elasticsearch.legacy.action.admin.indices.optimize.OptimizeRequest)
     */
     ...
     * @see org.elasticsearch.client.ClusterAdminClient#state(org.elasticsearch.legacy.action.admin.cluster.state.ClusterStateRequest)
     */
     ...
     * @see org.elasticsearch.client.ClusterAdminClient#health(org.elasticsearch.legacy.action.admin.cluster.health.ClusterHealthRequest)
     */
     ...
     * @see org.elasticsearch.client.ClusterAdminClient#nodesInfo(org.elasticsearch.legacy.action.admin.cluster.node.info.NodesInfoRequest)
     */
     ...
     * @return The nodes info request
     * @see org.elasticsearch.client.ClusterAdminClient#nodesStats(org.elasticsearch.legacy.action.admin.cluster.node.stats.NodesStatsRequest)
     */
     ...
     * @see org.elasticsearch.client.ClusterAdminClient#clusterStats(org.elasticsearch.legacy.action.admin.cluster.stats.ClusterStatsRequest)
     */
     ...
     * @param nodesIds The nodes ids to get the status for
     * @return The nodes info request
     * @see org.elasticsearch.client.ClusterAdminClient#nodesShutdown(org.elasticsearch.legacy.action.admin.cluster.node.shutdown.NodesShutdownRequest)
     */
     ...
     * @return The nodes info request
     * @see org.elasticsearch.client.ClusterAdminClient#nodesRestart(org.elasticsearch.legacy.action.admin.cluster.node.restart.NodesRestartRequest)
     */

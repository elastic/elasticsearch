...
import org.elasticsearch.legacy.cluster.action.index.*;
import org.elasticsearch.legacy.cluster.action.shard.ShardStateAction;
import org.elasticsearch.legacy.cluster.metadata.*;
import org.elasticsearch.legacy.cluster.node.DiscoveryNodeService;
import org.elasticsearch.legacy.cluster.routing.RoutingService;
import org.elasticsearch.legacy.cluster.routing.allocation.AllocationModule;
import org.elasticsearch.legacy.cluster.routing.operation.OperationRoutingModule;
import org.elasticsearch.legacy.cluster.service.InternalClusterService;
import org.elasticsearch.legacy.cluster.settings.ClusterDynamicSettingsModule;
...
import org.elasticsearch.legacy.index.settings.IndexDynamicSettingsModule;

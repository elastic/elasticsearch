...
import org.elasticsearch.legacy.indices.IndexClosedException;
...
public class MetaData implements Iterable<IndexMetaData> {
     ...
     * @deprecated use {@link #concreteIndices(org.elasticsearch.legacy.action.support.IndicesOptions, String...)} instead and

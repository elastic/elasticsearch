 ...
 * under the License.
 */
package org.elasticsearch.legacy.common.netty;

import org.elasticsearch.legacy.common.Booleans;
import org.elasticsearch.legacy.common.logging.Loggers;
import org.elasticsearch.legacy.transport.netty.NettyInternalESLoggerFactory;
...
public class NettyUtils {
     ...
     * <p/>
     * In ES, we try and page the buffers allocated, all serialized data uses {@link org.elasticsearch.legacy.common.bytes.PagedBytesReference}
     * typically generated from {@link org.elasticsearch.legacy.common.io.stream.BytesStreamOutput}. When sending it over

...
public enum Recyclers {
     ...
     *
     * @see #soft(org.elasticsearch.legacy.common.recycler.Recycler.Factory)
     */
    ...
    public static <T> Recycler<T> locked(final Recycler<T> recycler) {
        return new FilterRecycler<T>() {
            ...
            @Override
            public org.elasticsearch.legacy.common.recycler.Recycler.V<T> obtain(int sizing) {
                synchronized (lock) {
                    return super.obtain(sizing);
                }
            }
            ...
            @Override
            public org.elasticsearch.legacy.common.recycler.Recycler.V<T> obtain() {
                synchronized (lock) {
                    return super.obtain();
                }
            }

...
public class AnalysisModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        for (Map.Entry<String, Settings> entry : charFiltersSettings.entrySet()) {
            ...
            try {
                type = charFilterSettings.getAsClass("type", null, "org.elasticsearch.legacy.index.analysis.", "CharFilterFactory");
        ...
        for (Map.Entry<String, Settings> entry : tokenFiltersSettings.entrySet()) {
            ...
            try {
                type = tokenFilterSettings.getAsClass("type", null, "org.elasticsearch.legacy.index.analysis.", "TokenFilterFactory");
            } catch (NoClassSettingsException e) {
                // nothing found, see if its in bindings as a binding name
        ...
        for (Map.Entry<String, Settings> entry : tokenizersSettings.entrySet()) {
            ...
            try {
                type = tokenizerSettings.getAsClass("type", null, "org.elasticsearch.legacy.index.analysis.", "TokenizerFactory");
            } catch (NoClassSettingsException e) {
                // nothing found, see if its in bindings as a binding name
        ...
        for (Map.Entry<String, Settings> entry : analyzersSettings.entrySet()) {
            ...
            try {
                type = analyzerSettings.getAsClass("type", null, "org.elasticsearch.legacy.index.analysis.", "AnalyzerProvider");
            } catch (NoClassSettingsException e) {
                // nothing found, see if its in bindings as a binding name

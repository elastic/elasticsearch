...
public class NGramTokenizerFactory extends AbstractTokenizerFactory {
    ...
    private org.elasticsearch.legacy.Version esVersion;
    ...
    public NGramTokenizerFactory(Index index, @IndexSettings Settings indexSettings, @Assisted String name, @Assisted Settings settings) {
        ...
        this.esVersion = indexSettings.getAsVersion(IndexMetaData.SETTING_VERSION_CREATED, org.elasticsearch.legacy.Version.CURRENT);
    }

    @SuppressWarnings("deprecation")
    @Override
    public Tokenizer create(Reader reader) {
        if (version.onOrAfter(Version.LUCENE_43) && esVersion.onOrAfter(org.elasticsearch.legacy.Version.V_0_90_2)) {
            /*

...
import org.elasticsearch.legacy.index.codec.docvaluesformat.DocValuesFormats;
import org.elasticsearch.legacy.index.codec.docvaluesformat.PreBuiltDocValuesFormatProvider;
 ...
 * <tt>org.elasticsearch.legacy.index.codec.postingsformat</tt> package and the
 ...
 * <tt>org.elasticsearch.legacy.index.codec.postingsformat</tt></li>
 * 
...
public class CodecModule extends AbstractModule {
    ...
    private void configurePostingsFormats() {
        ...
        for (Map.Entry<String, Settings> entry : postingsFormatsSettings.entrySet()) {
            ...
            try {
                type = settings.getAsClass("type", null, "org.elasticsearch.legacy.index.codec.postingsformat.", "PostingsFormatProvider");
    ...
    private void configureDocValuesFormats() {
        ...
        for (Map.Entry<String, Settings> entry : docValuesFormatSettings.entrySet()) {
            ...
            try {
                type = settings.getAsClass("type", null, "org.elasticsearch.legacy.index.codec.docvaluesformat.", "DocValuesFormatProvider");
            } catch (NoClassSettingsException e) {

...
import org.elasticsearch.legacy.index.engine.internal.InternalEngineModule;
import org.elasticsearch.legacy.index.engine.internal.InternalIndexEngineModule;

import static org.elasticsearch.legacy.common.inject.Modules.createModule;
...
public class IndexEngineModule extends AbstractModule implements SpawnModules {
    ...
    public Iterable<? extends Module> spawnModules() {
        return ImmutableList.of(createModule(settings.getAsClass(EngineSettings.INDEX_ENGINE_TYPE, EngineSettings.DEFAULT_INDEX_ENGINE, "org.elasticsearch.legacy.index.engine.", "IndexEngineModule"), settings));
    }

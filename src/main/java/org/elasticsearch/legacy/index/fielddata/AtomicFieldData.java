...
import org.elasticsearch.legacy.index.fielddata.ScriptDocValues.Strings;
...
public interface AtomicFieldData<Script extends ScriptDocValues> extends Accountable {
     ...
     * value iterations.
     *
     * @see org.elasticsearch.legacy.index.fielddata.BytesValues#getOrder()
     * @see org.elasticsearch.legacy.index.fielddata.DoubleValues#getOrder()
     * @see org.elasticsearch.legacy.index.fielddata.LongValues#getOrder()
     */
    public enum Order {
        /**

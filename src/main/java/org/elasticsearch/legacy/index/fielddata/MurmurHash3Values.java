...
public class MurmurHash3Values {
    ...
    private static class Bytes extends LongValues {
        ...
        private final org.elasticsearch.legacy.common.hash.MurmurHash3.Hash128 hash = new org.elasticsearch.legacy.common.hash.MurmurHash3.Hash128();
        ...
        public long nextValue() {
            ...
            org.elasticsearch.legacy.common.hash.MurmurHash3.hash128(next.bytes, next.offset, next.length, 0, hash);
            return hash.h1;
        }

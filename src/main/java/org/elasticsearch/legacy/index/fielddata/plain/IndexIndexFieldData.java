...
public class IndexIndexFieldData implements IndexFieldData.WithOrdinals<AtomicFieldData.WithOrdinals<ScriptDocValues>> {
    ...
    @Override
    public org.elasticsearch.legacy.index.mapper.FieldMapper.Names getFieldNames() {
        return names;
    }
    ...
    @Override
    public org.elasticsearch.legacy.index.fielddata.IndexFieldData.XFieldComparatorSource comparatorSource(Object missingValue,

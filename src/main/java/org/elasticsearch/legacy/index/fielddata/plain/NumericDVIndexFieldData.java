...
package org.elasticsearch.legacy.index.fielddata.plain;
...
import org.elasticsearch.legacy.index.fielddata.fieldcomparator.LongValuesComparatorSource;
import org.elasticsearch.legacy.search.MultiValueMode;
import org.elasticsearch.legacy.index.mapper.FieldMapper.Names;
...
public class NumericDVIndexFieldData extends DocValuesIndexFieldData implements IndexNumericFieldData<NumericDVAtomicFieldData> {
    ...
    @Override
    public org.elasticsearch.legacy.index.fielddata.IndexFieldData.XFieldComparatorSource comparatorSource(Object missingValue, MultiValueMode sortMode) {
        return new LongValuesComparatorSource(this, missingValue, sortMode);
    }

    @Override
    public org.elasticsearch.legacy.index.fielddata.IndexNumericFieldData.NumericType getNumericType() {

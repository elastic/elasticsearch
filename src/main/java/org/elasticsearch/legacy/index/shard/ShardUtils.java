...
package org.elasticsearch.legacy.index.shard;
...
import org.elasticsearch.legacy.index.store.DirectoryUtils;
import org.elasticsearch.legacy.index.store.Store;
...
public class ShardUtils {
     ...
     * and the directory backing it to be {@link org.elasticsearch.legacy.index.store.Store.StoreDirectory}.

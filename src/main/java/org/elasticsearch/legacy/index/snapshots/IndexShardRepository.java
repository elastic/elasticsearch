...
package org.elasticsearch.legacy.index.snapshots;

import org.elasticsearch.legacy.cluster.metadata.SnapshotId;
import org.elasticsearch.legacy.index.deletionpolicy.SnapshotIndexCommit;
...
public interface IndexShardRepository {
     ...
     * <p/>
     * The index commit point can be obtained by using {@link org.elasticsearch.legacy.index.engine.internal.InternalEngine#snapshotIndex()} method.

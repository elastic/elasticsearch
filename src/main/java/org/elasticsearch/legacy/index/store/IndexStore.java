...
package org.elasticsearch.legacy.index.store;
...
public interface IndexStore extends CloseableIndexComponent {
     ...
     * that it has storage files that can be deleted using {@link #deleteUnallocated(org.elasticsearch.legacy.index.shard.ShardId)}.
     */

...
import org.elasticsearch.legacy.index.store.fs.DefaultFsIndexStoreModule;
import org.elasticsearch.legacy.index.store.fs.MmapFsIndexStoreModule;
import org.elasticsearch.legacy.index.store.fs.NioFsIndexStoreModule;
import org.elasticsearch.legacy.index.store.fs.SimpleFsIndexStoreModule;
import org.elasticsearch.legacy.index.store.ram.RamIndexStoreModule;
...
public class IndexStoreModule extends AbstractModule implements SpawnModules {
    ...
    public Iterable<? extends Module> spawnModules() {
        ...
        if (Type.RAM.name().equalsIgnoreCase(storeType)) {
            ...
            indexStoreModule = settings.getAsClass("index.store.type", indexStoreModule, "org.elasticsearch.legacy.index.store.", "IndexStoreModule");
        }

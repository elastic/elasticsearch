...
import org.elasticsearch.legacy.common.compress.Compressor;
...
import org.elasticsearch.legacy.index.store.distributor.Distributor;
import org.elasticsearch.legacy.index.store.support.ForceSyncDirectory;
...
public class Store extends AbstractIndexShardComponent implements CloseableIndexComponent, Closeable {
     ...
     * @see MetadataSnapshot#recoveryDiff(org.elasticsearch.legacy.index.store.Store.MetadataSnapshot)
     */

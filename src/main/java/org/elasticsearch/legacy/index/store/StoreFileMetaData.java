...
public class StoreFileMetaData implements Streamable {
    ...
    public void readFrom(StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(org.elasticsearch.legacy.Version.V_1_3_0)) {
            String versionString = in.readOptionalString();
            writtenBy = Lucene.parseVersionLenient(versionString, null);
        }
        if (in.getVersion().onOrAfter(org.elasticsearch.legacy.Version.V_1_3_3)) {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getVersion().onOrAfter(org.elasticsearch.legacy.Version.V_1_3_0)) {
            out.writeOptionalString(writtenBy == null ? null : writtenBy.name());
        }
        if (out.getVersion().onOrAfter(org.elasticsearch.legacy.Version.V_1_3_3)) {

 ...
 * {@link org.elasticsearch.legacy.common.breaker.MemoryCircuitBreaker}s
...
public class InternalCircuitBreakerService extends AbstractLifecycleComponent<InternalCircuitBreakerService> implements CircuitBreakerService {
    ...
    /**
     * @return a {@link org.elasticsearch.legacy.common.breaker.MemoryCircuitBreaker} that can be used for aggregating memory usage
     */

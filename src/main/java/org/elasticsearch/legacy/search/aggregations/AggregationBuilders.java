...
import org.elasticsearch.legacy.search.aggregations.bucket.geogrid.GeoHashGridBuilder;
import org.elasticsearch.legacy.search.aggregations.bucket.global.GlobalBuilder;
import org.elasticsearch.legacy.search.aggregations.bucket.histogram.DateHistogramBuilder;
import org.elasticsearch.legacy.search.aggregations.bucket.histogram.HistogramBuilder;
import org.elasticsearch.legacy.search.aggregations.bucket.missing.MissingBuilder;
import org.elasticsearch.legacy.search.aggregations.bucket.nested.NestedBuilder;
import org.elasticsearch.legacy.search.aggregations.bucket.nested.ReverseNestedBuilder;
...
import org.elasticsearch.legacy.search.aggregations.bucket.range.geodistance.GeoDistanceBuilder;
import org.elasticsearch.legacy.search.aggregations.bucket.range.ipv4.IPv4RangeBuilder;
...
import org.elasticsearch.legacy.search.aggregations.metrics.tophits.TopHitsBuilder;
import org.elasticsearch.legacy.search.aggregations.metrics.avg.AvgBuilder;
import org.elasticsearch.legacy.search.aggregations.metrics.cardinality.CardinalityBuilder;
import org.elasticsearch.legacy.search.aggregations.metrics.geobounds.GeoBoundsBuilder;
import org.elasticsearch.legacy.search.aggregations.metrics.max.MaxBuilder;
import org.elasticsearch.legacy.search.aggregations.metrics.min.MinBuilder;
...
import org.elasticsearch.legacy.search.aggregations.metrics.stats.StatsBuilder;
import org.elasticsearch.legacy.search.aggregations.metrics.stats.extended.ExtendedStatsBuilder;
import org.elasticsearch.legacy.search.aggregations.metrics.sum.SumBuilder;
import org.elasticsearch.legacy.search.aggregations.metrics.valuecount.ValueCountBuilder;

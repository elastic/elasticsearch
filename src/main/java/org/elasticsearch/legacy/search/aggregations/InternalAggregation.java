...
public abstract class InternalAggregation implements Aggregation, ToXContent, Streamable {
    ...
    public static class Type {
        ...
        /**
         * @return The name of the type (mainly used for registering the parser for the aggregator (see {@link org.elasticsearch.legacy.search.aggregations.Aggregator.Parser#type()}).
         */
        public String name() {
            return name;
        }
         ...
         *          (see {@link AggregationStreams#registerStream(AggregationStreams.Stream, org.elasticsearch.legacy.common.bytes.BytesReference...)}).
         */

...
public interface Terms extends MultiBucketsAggregation {
    ...
    static enum ValueType {
        ...
        STRING(org.elasticsearch.legacy.search.aggregations.support.ValueType.STRING),
        LONG(org.elasticsearch.legacy.search.aggregations.support.ValueType.LONG),
        DOUBLE(org.elasticsearch.legacy.search.aggregations.support.ValueType.DOUBLE);

        final org.elasticsearch.legacy.search.aggregations.support.ValueType scriptValueType;

        private ValueType(org.elasticsearch.legacy.search.aggregations.support.ValueType scriptValueType) {

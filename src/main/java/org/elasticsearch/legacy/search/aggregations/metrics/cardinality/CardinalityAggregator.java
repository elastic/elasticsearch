...
import org.elasticsearch.legacy.common.util.ObjectArray;
import org.elasticsearch.legacy.index.fielddata.BytesValues;
import org.elasticsearch.legacy.index.fielddata.LongValues;
import org.elasticsearch.legacy.index.fielddata.MurmurHash3Values;
...
import org.elasticsearch.legacy.search.aggregations.metrics.NumericMetricsAggregator;
...
public class CardinalityAggregator extends NumericMetricsAggregator.SingleValue {
    ...
    private static class OrdinalsCollector implements Collector {
        ...
        public void postCollect() {
            ...
            final org.elasticsearch.legacy.common.hash.MurmurHash3.Hash128 hash = new org.elasticsearch.legacy.common.hash.MurmurHash3.Hash128();
            try (LongArray hashes = bigArrays.newLongArray(maxOrd, false)) {
                for (int ord = allVisitedOrds.nextSetBit(0); ord != -1; ord = ord + 1 < maxOrd ? allVisitedOrds.nextSetBit(ord + 1) : -1) {
                    ...
                    org.elasticsearch.legacy.common.hash.MurmurHash3.hash128(value.bytes, value.offset, value.length, 0, hash);

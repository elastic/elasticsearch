...
import org.elasticsearch.legacy.search.aggregations.AbstractAggregationBuilder;
import org.elasticsearch.legacy.search.builder.SearchSourceBuilder;
import org.elasticsearch.legacy.search.highlight.HighlightBuilder;
import org.elasticsearch.legacy.search.sort.SortBuilder;
...
public class TopHitsBuilder extends AbstractAggregationBuilder {
    ...
    /**
     * Should each {@link org.elasticsearch.legacy.search.SearchHit} be returned with an
    ...
    /**
     * Should each {@link org.elasticsearch.legacy.search.SearchHit} be returned with its
     * version.
     */
     ...
     *
     * @see org.elasticsearch.legacy.search.sort.SortBuilders
     */

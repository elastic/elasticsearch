 ...
 * under the License.
 */
package org.elasticsearch.legacy.search.aggregations.support;
...
import org.elasticsearch.legacy.common.lucene.ReaderContextAware;
import org.elasticsearch.legacy.common.lucene.TopReaderContextAware;
import org.elasticsearch.legacy.common.util.CollectionUtils;
import org.elasticsearch.legacy.index.fielddata.*;
import org.elasticsearch.legacy.index.fielddata.AtomicFieldData.Order;
import org.elasticsearch.legacy.script.SearchScript;
import org.elasticsearch.legacy.search.aggregations.support.ValuesSource.Bytes.SortedAndUnique.SortedUniqueBytesValues;
import org.elasticsearch.legacy.search.aggregations.support.values.ScriptBytesValues;
import org.elasticsearch.legacy.search.aggregations.support.values.ScriptDoubleValues;
import org.elasticsearch.legacy.search.aggregations.support.values.ScriptLongValues;
...
public abstract class ValuesSource {
    ...
    public static abstract class Bytes extends ValuesSource {
        ...
        public static class FieldData extends Bytes implements ReaderContextAware {
            ...
            @Override
            public org.elasticsearch.legacy.index.fielddata.BytesValues bytesValues() {
                if (bytesValues == null) {
                    bytesValues = atomicFieldData.getBytesValues();
                }
                return bytesValues;
    ...
    public static abstract class Numeric extends ValuesSource {
        ...
        public static class WithScript extends Numeric {
            ...
            static class LongValues extends org.elasticsearch.legacy.index.fielddata.LongValues {
            ...
            static class DoubleValues extends org.elasticsearch.legacy.index.fielddata.DoubleValues {
        ...
        public static class FieldData extends Numeric implements ReaderContextAware {
            ...
            @Override
            public org.elasticsearch.legacy.index.fielddata.LongValues longValues() {
                if (longValues == null) {
                    longValues = atomicFieldData.getLongValues();
                }
            ...
            @Override
            public org.elasticsearch.legacy.index.fielddata.DoubleValues doubleValues() {
                if (doubleValues == null) {
                    doubleValues = atomicFieldData.getDoubleValues();
                }
    ...
    public static class WithScript extends Bytes {
        ...
        static class BytesValues extends org.elasticsearch.legacy.index.fielddata.BytesValues {
    ...
    public static class GeoPoint extends ValuesSource implements ReaderContextAware {
        ...
        public org.elasticsearch.legacy.index.fielddata.GeoPointValues geoPointValues() {
            if (geoPointValues == null) {
                geoPointValues = atomicFieldData.getGeoPointValues();
            }

 ...
 * using {@link org.elasticsearch.legacy.search.builder.SearchSourceBuilder#searchSource()}.
 *
 * @see org.elasticsearch.legacy.action.search.SearchRequest#source(SearchSourceBuilder)
 */
public class SearchSourceBuilder implements ToXContent {
    ...
    /**
     * Should each {@link org.elasticsearch.legacy.search.SearchHit} be returned with a version
     * associated with it.
     */

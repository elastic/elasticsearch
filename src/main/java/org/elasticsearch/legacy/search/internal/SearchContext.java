...
import org.elasticsearch.legacy.action.search.SearchType;
...
import org.elasticsearch.legacy.common.lease.Releasable;
...
import org.elasticsearch.legacy.index.cache.docset.DocSetCache;
import org.elasticsearch.legacy.index.cache.filter.FilterCache;
...
import org.elasticsearch.legacy.index.mapper.FieldMappers;
...
import org.elasticsearch.legacy.index.query.ParsedFilter;
import org.elasticsearch.legacy.index.query.ParsedQuery;
...
import org.elasticsearch.legacy.search.SearchShardTarget;
import org.elasticsearch.legacy.search.aggregations.SearchContextAggregations;
import org.elasticsearch.legacy.search.dfs.DfsSearchResult;
import org.elasticsearch.legacy.search.facet.SearchContextFacets;
import org.elasticsearch.legacy.search.fetch.FetchSearchResult;
import org.elasticsearch.legacy.search.fetch.fielddata.FieldDataFieldsContext;
import org.elasticsearch.legacy.search.fetch.partial.PartialFieldsContext;
import org.elasticsearch.legacy.search.fetch.script.ScriptFieldsContext;
import org.elasticsearch.legacy.search.fetch.source.FetchSourceContext;
import org.elasticsearch.legacy.search.highlight.SearchContextHighlight;
import org.elasticsearch.legacy.search.lookup.SearchLookup;
...
import org.elasticsearch.legacy.search.scan.ScanContext;

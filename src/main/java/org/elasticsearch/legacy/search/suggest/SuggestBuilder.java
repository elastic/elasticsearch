...
import org.elasticsearch.legacy.search.suggest.context.ContextMapping.ContextQuery;
import org.elasticsearch.legacy.search.suggest.context.CategoryContextMapping;
import org.elasticsearch.legacy.search.suggest.context.GeolocationContextMapping;
import org.elasticsearch.legacy.search.suggest.phrase.PhraseSuggestionBuilder;
import org.elasticsearch.legacy.search.suggest.term.TermSuggestionBuilder;

/**
 * Defines how to perform suggesting. This builders allows a number of global options to be specified and
 * an arbitrary number of {@link org.elasticsearch.legacy.search.suggest.term.TermSuggestionBuilder} instances.
 * <p/>
...
public class SuggestBuilder implements ToXContent {
     ...
     * to be set either via this setter or via the {@link org.elasticsearch.legacy.search.suggest.SuggestBuilder.SuggestionBuilder#setText(String)} method.
     * <p/>
    ...
    /**
     * Adds an {@link org.elasticsearch.legacy.search.suggest.term.TermSuggestionBuilder} instance under a user defined name.
    ...
    public static abstract class SuggestionBuilder<T> implements ToXContent {
         ...
         * {@link org.elasticsearch.legacy.search.suggest.term.TermSuggestionBuilder#field(String)}
         * method
         */
        @SuppressWarnings("unchecked")

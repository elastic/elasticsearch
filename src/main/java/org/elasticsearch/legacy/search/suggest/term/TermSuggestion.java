 ...
 * under the License.
 */
package org.elasticsearch.legacy.search.suggest.term;
...
public class TermSuggestion extends Suggestion<TermSuggestion.Entry> {
    ...
    public static class Entry extends
            org.elasticsearch.legacy.search.suggest.Suggest.Suggestion.Entry<TermSuggestion.Entry.Option> {
         ...
         */
        public static class Option extends org.elasticsearch.legacy.search.suggest.Suggest.Suggestion.Entry.Option {

...
public class RestSyncedFlushAction extends BaseRestHandler {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel, final Client client) {
        ...
        SyncedFlushRequest syncedFlushRequest = new SyncedFlushRequest(indices);
        client.admin().indices().execute(SyncedFlushAction.INSTANCE, syncedFlushRequest, new RestBuilderListener<SyncedFlushResponse>(channel) {
            @Override
            public RestResponse buildResponse(SyncedFlushResponse response, XContentBuilder builder) throws Exception {
                builder.startObject();

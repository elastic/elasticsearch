...
package org.elasticsearch.rest.action.benchmark.submit;
...
/**
 * REST handler for submitting benchmarks.
 */
public class RestBenchmarkSubmitAction extends BaseRestHandler {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel, final Client client) throws Exception {
        ...
        client.startBenchmark(benchmarkStartRequest, new RestBuilderListener<BenchmarkStartResponse>(channel) {

            @Override
            public RestResponse buildResponse(BenchmarkStartResponse response, XContentBuilder builder) throws Exception {
                builder.startObject();
    ...
    public static BenchmarkStartRequest parse(BenchmarkStartRequestBuilder builder, BytesReference data, boolean contentUnsafe) throws Exception {

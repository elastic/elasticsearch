...
package org.elasticsearch.rest.action.profile;
...
/**
 * This is essentially a c/p of the Search Rest endpoint because I couldn't determine a better
 * way to extend that class for profiling.  Would *really* love to nuke this whole file so we
 * dont have to maintain two copies of basically the same thing
 *
 * This is a bit truncated compared to search
 */
public class RestProfileAction extends BaseRestHandler {

    @Inject
    public RestProfileAction(Settings settings, Client client, RestController controller) {
        super(settings, client);
        controller.registerHandler(GET, "/_profile", this);
        controller.registerHandler(POST, "/_profile", this);
        controller.registerHandler(GET, "/{index}/_profile", this);
        controller.registerHandler(POST, "/{index}/_profile", this);
        controller.registerHandler(GET, "/{index}/{type}/_profile", this);
        controller.registerHandler(POST, "/{index}/{type}/_profile", this);
        controller.registerHandler(GET, "/_profile/template", this);
        controller.registerHandler(POST, "/_profile/template", this);
        controller.registerHandler(GET, "/{index}/_profile/template", this);
        controller.registerHandler(POST, "/{index}/_profile/template", this);
        controller.registerHandler(GET, "/{index}/{type}/_profile/template", this);
        controller.registerHandler(POST, "/{index}/{type}/_profile/template", this);
    }

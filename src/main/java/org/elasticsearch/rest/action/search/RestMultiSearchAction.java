...
public class RestMultiSearchAction extends BaseRestHandler {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        try {
            multiSearchRequest.add(RestActions.getRestContent(request), request.contentUnsafe(), indices, types, request.param("search_type"), request.param("routing"), ignoreIndices, allowExplicitIndex);
        } catch (Exception e) {
            try {

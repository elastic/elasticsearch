...
import org.elasticsearch.search.reducers.ReductionModule;
...
public class SearchModule extends AbstractModule implements SpawnModules {
    ...
    public Iterable<? extends Module> spawnModules() {
        return ImmutableList.of(new TransportSearchModule(), new HighlightModule(), new SuggestModule(), new FunctionScoreModule(), new AggregationModule(), new ReductionModule());
    }

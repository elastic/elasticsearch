...
class InternalOrder extends Histogram.Order {
    ...
    static class Aggregation extends InternalOrder {
        ...
        Aggregation(String key, boolean asc) {
            super(ID, key, asc, new Bucket.SubAggregationComparator<InternalHistogram.Bucket>(key, asc));
        }

        Aggregation(String aggName, String valueName, boolean asc) {
            super(ID, key(aggName, valueName), asc, new Bucket.SubAggregationComparator<InternalHistogram.Bucket>(aggName, valueName, asc));
        }

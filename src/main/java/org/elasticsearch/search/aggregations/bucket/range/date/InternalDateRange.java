...
public class InternalDateRange extends InternalRange<InternalDateRange.Bucket> implements DateRange {
    ...
    public InternalDateRange() {} // for serialization

    public InternalDateRange(String name, List<InternalDateRange.Bucket> ranges, ValueFormatter formatter, boolean keyed, boolean unmapped) {

...
public class DoubleTermsAggregator extends TermsAggregator {
    ...
    public DoubleTerms buildAggregation(long owningBucketOrdinal) {
        ...
        return new DoubleTerms(name, order, formatter, bucketCountThresholds.requiredSize, bucketCountThresholds.minDocCount, Arrays.asList(list));
    }

    @Override
    public DoubleTerms buildEmptyAggregation() {
        return new DoubleTerms(name, order, formatter, bucketCountThresholds.requiredSize, bucketCountThresholds.minDocCount, Collections.<InternalTerms.Bucket>emptyList());
    }

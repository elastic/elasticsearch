...
public class CountBucketParser extends BucketMetricsParser {
    @Override
    public String type() {
        return CountBucketReducer.TYPE.name();
    }
    ...
    protected ReducerFactory buildFactory(String reducerName, String[] bucketsPaths, GapPolicy gapPolicy, @Nullable ValueFormatter formatter) {
        return new CountBucketReducer.Factory(reducerName, bucketsPaths, gapPolicy, formatter);
    }
}

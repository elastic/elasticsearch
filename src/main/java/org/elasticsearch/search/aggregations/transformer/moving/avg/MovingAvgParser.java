 ...
 */
public class MovingAvgParser implements Aggregator.Parser {
    ...
    static final ParseField WEIGHTING = new ParseField("weight");

    @Override
    public String type() {
        return InternalMovingAvg.TYPE.name();
    }
    ...
    public AggregatorFactory parse(String aggregationName, XContentParser parser, SearchContext context) throws IOException {
        ...
        return new MovingAvgTransformer.Factory(aggregationName, keyed, formatter, gapPolicy, window, weight);

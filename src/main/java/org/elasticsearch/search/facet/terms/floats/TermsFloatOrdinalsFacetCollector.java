...
public class TermsFloatOrdinalsFacetCollector extends AbstractFacetCollector {
    ...
    public TermsFloatOrdinalsFacetCollector(String facetName, String fieldName, int size, TermsFacetComparator comparator, boolean allTerms, SearchContext context,
    ...
    public Facet facet() {
        ...
        if (size < EntryPriorityQueue.LIMIT) {
            ...
            return new InternalFloatTermsFacet(facetName, comparator, size, Arrays.asList(list), missing, total);
        }

        BoundedTreeSet<InternalFloatTermsFacet.FloatEntry> ordered = new BoundedTreeSet<InternalFloatTermsFacet.FloatEntry>(comparator, size);
        ...
        return new InternalFloatTermsFacet(facetName, comparator, size, ordered, missing, total);
    }

 ...
 *
 */
public class ScriptSourceParseElement implements SearchParseElement {
    @Override
    public void parse(XContentParser parser, SearchContext context) throws Exception {
        ...
        if (token == XContentParser.Token.START_OBJECT) {
            ...
            context.scriptSource(new ScriptSourceContext(fieldName, searchScript, ignoreException));
        }
    }
}

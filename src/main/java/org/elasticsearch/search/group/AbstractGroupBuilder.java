 ...
 *
 */
public abstract class AbstractGroupBuilder implements ToXContent {
    ...
    protected AbstractGroupBuilder(String name) {
        this.name = name;
    }

    public AbstractGroupBuilder facetFilter(FilterBuilder filter) {
     ...
     */
    public AbstractGroupBuilder nested(String nested) {
        this.nested = nested;
        return this;
    }
     ...
     */
    public AbstractGroupBuilder global(boolean global) {
     ...
     */
    public AbstractGroupBuilder scope(String scope) {
        this.scope = scope;
        return this;
    }

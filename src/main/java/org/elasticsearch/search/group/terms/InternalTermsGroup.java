 ...
 *
 */
public abstract class InternalTermsGroup implements TermsGroup, InternalGroup {

    public static void registerStreams() {
        InternalStringTermsGroup.registerStream();
...
//        InternalIpTermsFacet.registerStream();
    ...
    public abstract Group reduce(String name, List<Group> groups);
}

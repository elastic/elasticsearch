...
/**
 * Terms group allows to return groups of the most popular terms within the search query.
 *
 *
 */
public interface TermsGroup extends Group, Iterable<TermsGroup.Entry> {
     ...
     */
    List<? extends TermsGroup.Entry> entries();

    /**
     * The terms and counts.
     */
    List<? extends TermsGroup.Entry> getEntries();
}
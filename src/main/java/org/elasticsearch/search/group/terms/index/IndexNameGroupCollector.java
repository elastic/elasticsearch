...
package org.elasticsearch.search.group.terms.index;
 ...
 *
 */
public class IndexNameGroupCollector extends AbstractGroupCollector {
    ...
    public IndexNameGroupCollector(String groupName, String indexName, TermsGroup.ComparatorType comparatorType, int size) {
        super(groupName);
    ...
    public Group group() {
        return new InternalStringTermsGroup(groupName, comparatorType, size,
                Sets.newHashSet(new InternalStringTermsGroup.ScoreDocsEntry(indexName, count, new ArrayList<ScoreDoc>())), 0, count);
    }

 ...
 * */
public class IndexFieldImpl extends MinimalMap<String, IndexFieldTerm> implements IndexField {
     ...
     */
    private final LeafIndexLookupImpl indexLookup;
     ...
     */
    public IndexFieldImpl(String fieldName, LeafIndexLookupImpl indexLookup) throws IOException {
    ...
    public IndexFieldTerm get(Object key, int flags) {
        ...
        if (indexFieldTerm == null) {
            indexFieldTerm = new IndexFieldTermImpl(termString, fieldName, indexLookup, flags);
    ...
    public IndexFieldTerm get(Object key) {
        ...
        return get(key, IndexLookupImpl.FLAG_FREQUENCIES);
    }

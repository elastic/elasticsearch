...
public class LeafIndexLookupImpl implements LeafIndexLookup {
    ...
    public LeafIndexLookupImpl(LeafReaderContext ctx) {
        reader = ctx.reader();
    ...
    public IndexField get(Object key) {
        ...
        if (indexField == null) {
            try {
                indexField = new IndexFieldImpl(stringField, this);
                indexFields.put(stringField, LookupImpl.createProxy(IndexField.class, indexField));
            } catch (IOException e) {
     ...
     * *
     */
    Fields termVectors() throws IOException {
        assert reader != null;
    ...
    IndexReaderContext getReaderContext() {
    ...
    @Override
    public IndexField put(String key, IndexField value) { throw new UnsupportedOperationException(); }

    @Override
    public IndexField remove(Object key) { throw new UnsupportedOperationException(); }

    @Override
    public void putAll(Map<? extends String,? extends IndexField> m) { throw new UnsupportedOperationException(); }
    ...
    @Override
    public Collection<IndexField> values() { throw new UnsupportedOperationException(); }
    
    @Override
    public Set<Map.Entry<String,IndexField>> entrySet() { throw new UnsupportedOperationException(); }
}

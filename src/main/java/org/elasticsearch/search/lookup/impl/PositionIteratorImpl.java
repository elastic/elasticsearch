...
public class PositionIteratorImpl implements PositionIterator {
    ...
    protected IndexFieldTermImpl indexFieldTerm;
    ...
    protected final TermPositionImpl termPosition = new TermPositionImpl();

    private PostingsEnum postings;

    public PositionIteratorImpl(IndexFieldTermImpl indexFieldTerm) {

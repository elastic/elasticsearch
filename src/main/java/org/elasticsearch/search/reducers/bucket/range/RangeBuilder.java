...
public class RangeBuilder extends ReductionBuilder<RangeBuilder> {
    ...
    public RangeBuilder path(String path) {
        this.path = path;
        return this;
    }
    ...
    protected XContentBuilder internalXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (path != null) {
            builder.field(RangeParser.BUCKETS_FIELD.getPreferredName(), path);
        }

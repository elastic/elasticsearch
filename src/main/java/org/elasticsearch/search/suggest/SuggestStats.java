...
public class SuggestStats implements Streamable, ToXContent {
    ...
    private SuggestStats() {}

    public SuggestStats(String name) {
        this.name = name;
    }

    public SuggestStats(String name, long size, @Nullable ObjectLongOpenHashMap<String> fields) {
        this.name = name;
    ...
    public void add(SuggestStats completion) {
        if (completion == null) {
            return;
        }

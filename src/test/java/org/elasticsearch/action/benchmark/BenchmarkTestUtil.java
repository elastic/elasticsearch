...
public class BenchmarkTestUtil {
    ...
    public static final int DEFAULT_HIGH_INTERVAL_BOUND = 5;
    ...
    public static BenchmarkStartRequest randomRequest(Client client, String[] indices, int numExecutorNodes,
                                                      Map<String, Map<String, BenchmarkSettings>> competitionSettingsMap, SearchRequest... requests) {
    ...
    public static BenchmarkStartRequest randomRequest(Client client, String[] indices, int numExecutorNodes,
                                                      Map<String, Map<String, BenchmarkSettings>> competitionSettingsMap, String benchmarkName,
    ...
    public static BenchmarkStartRequest randomRequest(Client client, String[] indices, int numExecutorNodes,
                                                      Map<String, Map<String, BenchmarkSettings>> competitionSettingsMap,
    ...
    public static List<BenchmarkStartRequest> randomRequests(int nRequests, Client client, String[] indices, int numExecutorNodes,
        ...
        for (int i = 0; i < nRequests; i++) {
            ...
            final String benchmarkId = nRequests == 1 ? prefix : prefix + "_" + i;
            final int numCompetitors = between(lowRandomIntervalBound, highRandomIntervalBound);
            for (int j = 0; j < numCompetitors; j++) {
                builder.addCompetitor(randomCompetitor(benchmarkId, client, COMPETITOR_PREFIX + j, indices,
    ...
    public static BenchmarkCompetitor randomCompetitor(String benchmarkId, Client client, String name, String[] indices,
                                                       Map<String, Map<String, BenchmarkSettings>> competitionSettingsMap,
        ...
        if (competitionSettingsMap != null) {
            Map<String, BenchmarkSettings> map = competitionSettingsMap.get(benchmarkId);
            if (map == null) {
                map = new HashMap<>();
                competitionSettingsMap.put(benchmarkId, map);
            }

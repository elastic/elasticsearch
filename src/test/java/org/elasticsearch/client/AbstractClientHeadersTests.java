...
public abstract class AbstractClientHeadersTests extends ElasticsearchTestCase {
    ...
    private static final GenericAction[] ACTIONS = new GenericAction[] {
                ...
                IndexAction.INSTANCE, BenchmarkAbortAction.INSTANCE, BenchmarkStartAction.INSTANCE, BenchmarkStatusAction.INSTANCE,
    ...
    public void testActions() {
        ...
        client.prepareAbortBench("bname").execute().addListener(new AssertingActionListener<BenchmarkAbortResponse>(BenchmarkAbortAction.NAME));
        client.prepareStartBenchmark("idx").setBenchmarkId("id").addCompetitor(new BenchmarkCompetitorBuilder().setName("name")).execute().addListener(new AssertingActionListener<BenchmarkStartResponse>(BenchmarkStartAction.NAME));
        client.prepareBenchmarkStatus().execute().addListener(new AssertingActionListener<BenchmarkStatusResponses>(BenchmarkStatusAction.NAME));

...
public class GceDifferentTagsTest extends GceAbstractTest {

    public GceDifferentTagsTest() {
        super(GceComputeServiceTwoNodesDifferentTagsMock.class);
    }
    ...
    @Test
    public void one_node_should_run_two_tags() {
        // Then we start our node for tests
    ...
    @Test
    public void one_node_should_be_filtered_one_tag() {
        // Then we start our node for tests

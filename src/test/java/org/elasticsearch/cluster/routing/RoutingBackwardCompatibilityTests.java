...
public class RoutingBackwardCompatibilityTests extends ElasticsearchTestCase {
    ...
    public void testBackwardCompatibility() throws Exception {
        ...
        try {
            BufferedReader reader = new BufferedReader(new InputStreamReader(RoutingBackwardCompatibilityTests.class.getResourceAsStream("/org/elasticsearch/cluster/routing/shard_routes.txt"), "UTF-8"));
            try {

...
public class CodecTests extends ElasticSearchLuceneTestCase {
    ...
    public void testResolveDefaultCodecs() throws Exception {
        ...
        assertThat(codecService.codec("default"), instanceOf(Lucene42Codec.class));
    ...
    public void testResolveDefaultDocValuesFormats() throws Exception {
        ...
        assertThat(docValuesFormatService.get("memory").get(), instanceOf(Lucene42DocValuesFormat.class));
        assertThat(docValuesFormatService.get("disk").get(), instanceOf(DiskDocValuesFormat.class));
        assertThat(docValuesFormatService.get("Disk").get(), instanceOf(DiskDocValuesFormat.class));
        assertThat(docValuesFormatService.get("default").get(), instanceOf(Lucene42DocValuesFormat.class));
    }
    ...
    public void testResolveDocValuesFormatsFromMapping_default() throws Exception {
        ...
        assertThat(documentMapper.mappers().name("field1").mapper().docValuesFormatProvider().get(), instanceOf(Lucene42DocValuesFormat.class));

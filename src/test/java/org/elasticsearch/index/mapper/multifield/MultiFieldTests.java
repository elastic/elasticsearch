...
public class MultiFieldTests extends ElasticsearchSingleNodeTest {
    ...
    private void testMultiField(String mapping) throws Exception {
        ...
        assertNotNull(f.fieldType().indexOptions());
        ...
        assertThat(f.stringValue(), equalTo("some name"));
        assertThat(f.fieldType().stored(), equalTo(true));
        assertNull(f.fieldType().indexOptions());
        ...
        assertNotNull(docMapper.mappers().fullName("name").mapper().fieldType().indexOptions());
        ...
        assertNull(docMapper.mappers().fullName("name.not_indexed").mapper().fieldType().indexOptions());
        ...
        assertNotNull(docMapper.mappers().fullName("name.test1").mapper().fieldType().indexOptions());
        ...
        assertNotNull(docMapper.mappers().fullName("name.test2").mapper().fieldType().indexOptions());
        ...
        assertNotNull(docMapper.mappers().fullName("object1.multi1.string").mapper().fieldType().indexOptions());
...
//        System.out.println(builtMapping);
    ...
    public void testConvertMultiFieldNoDefaultField() throws Exception {
        ...
        assertThat(docMapper.mappers().fullName("name").mapper(), notNullValue());
        assertThat(docMapper.mappers().fullName("name").mapper(), instanceOf(StringFieldMapper.class));
        assertNull(docMapper.mappers().fullName("name").mapper().fieldType().indexOptions());
        ...
        assertNull(docMapper.mappers().fullName("age").mapper().fieldType().indexOptions());
        ...
        assertNotNull(docMapper.mappers().fullName("age.not_stored").mapper().fieldType().indexOptions());
        ...
        assertNotNull(docMapper.mappers().fullName("age.stored").mapper().fieldType().indexOptions());
    ...
    public void testConvertMultiFieldGeoPoint() throws Exception {
        ...
        assertNotNull(docMapper.mappers().fullName("a").mapper().fieldType().indexOptions());
        ...
        assertNotNull(docMapper.mappers().fullName("a.b").mapper().fieldType().indexOptions());
        ...
        assertNotNull(docMapper.mappers().fullName("b").mapper().fieldType().indexOptions());
        ...
        assertNotNull(docMapper.mappers().fullName("b.a").mapper().fieldType().indexOptions());

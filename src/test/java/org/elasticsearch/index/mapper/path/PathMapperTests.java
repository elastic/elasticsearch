...
public class PathMapperTests extends ElasticsearchSingleNodeTest {
    ...
    public void testPathMapping() throws IOException {
        ...
        assertThat(docMapper.mappers().indexName("first1"), nullValue());
        assertThat(docMapper.mappers().indexName("name1.first1"), notNullValue());
        assertThat(docMapper.mappers().indexName("last1"), nullValue());
        assertThat(docMapper.mappers().indexName("name1.last1"), notNullValue());

...
public class MergePolicySettingsTest extends ElasticsearchTestCase {
    ...
    public void testLogDocSizeMergePolicySettingsUpdate() throws IOException {
        ...
        mp = new LogDocMergePolicyProvider(createStore(ImmutableSettings.builder()
                .put(LogDocMergePolicyProvider.INDEX_MERGE_POLICY_MAX_MERGE_DOCS, LogDocMergePolicy.DEFAULT_MAX_MERGE_DOCS / 2)
                .put(LogDocMergePolicyProvider.INDEX_MERGE_POLICY_MERGE_FACTOR, LogDocMergePolicy.DEFAULT_MERGE_FACTOR / 2)

...
public abstract class AbstractNumberNestedSortingTests extends AbstractFieldDataTests {
    ...
    public void testNestedSorting() throws Exception {
        ...
        XFieldComparatorSource nestedComparatorSource = createFieldComparator("field2", sortMode, null, new NestedLayout(parentFilter, childFilter));
        ...
        nestedComparatorSource = createFieldComparator("field2", sortMode, null, new NestedLayout(parentFilter, childFilter));
        ...
        nestedComparatorSource = createFieldComparator("field2", sortMode, 127, new NestedLayout(parentFilter, childFilter));
        sort = new Sort(new SortField("field2", nestedComparatorSource, true));
    ...
    protected abstract IndexFieldData.XFieldComparatorSource createFieldComparator(String fieldName, MultiValueMode sortMode, Object missingValue, NestedLayout nested);

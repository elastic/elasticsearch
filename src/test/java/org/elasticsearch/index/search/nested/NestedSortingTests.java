...
public class NestedSortingTests extends AbstractFieldDataTests {
    ...
    private TopDocs getTopDocs(IndexSearcher searcher, IndexFieldData<?> indexFieldData, String missingValue, MultiValueMode sortMode, int n, boolean reverse) throws IOException {
        ...
        XFieldComparatorSource nestedComparatorSource = indexFieldData.comparatorSource(missingValue, sortMode, new NestedLayout(parentFilter, childFilter));
    ...
    public void testNestedSorting() throws Exception {
        ...
        BytesRefFieldComparatorSource nestedComparatorSource = new BytesRefFieldComparatorSource(indexFieldData, null, sortMode, new NestedLayout(parentFilter, childFilter));
        ...
        nestedComparatorSource = new BytesRefFieldComparatorSource(indexFieldData, null, sortMode, new NestedLayout(parentFilter, childFilter));

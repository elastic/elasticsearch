...
public class SimpleIndexTemplateTests extends ElasticsearchIntegrationTest {
    ...
    public void testInvalidSettings() throws Exception {
        ...
        Settings settings = client().admin().cluster().prepareState().get().getState().metaData().index("test").settings();
        assertThat(settings.getAsMap().get("index.does_not_exist"), equalTo("test"));
    }
}

...
import org.elasticsearch.legacy.action.admin.indices.recovery.ShardRecoveryResponse;
import org.elasticsearch.legacy.action.admin.indices.status.IndexShardStatus;
import org.elasticsearch.legacy.action.admin.indices.status.IndicesStatusResponse;
import org.elasticsearch.legacy.action.admin.indices.status.ShardStatus;
import org.elasticsearch.legacy.client.Client;
import org.elasticsearch.legacy.cluster.ClusterState;
import org.elasticsearch.legacy.cluster.routing.allocation.allocator.BalancedShardsAllocator;

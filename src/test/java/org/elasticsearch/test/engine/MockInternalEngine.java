...
import org.elasticsearch.index.engine.internal.InternalEngineImpl;
...
public final class MockInternalEngine extends InternalEngine implements Engine {
    ...
    protected InternalEngineImpl createEngineImpl() {
        return new MockInternalEngineImpl(mockContext, shardId, logger, codecService, threadPool, indexingService,

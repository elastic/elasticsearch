...
public class MockInternalEngineImpl extends InternalEngineImpl {

    public static final ConcurrentMap<AssertingSearcher, RuntimeException> INFLIGHT_ENGINE_SEARCHERS = new ConcurrentHashMap<>();

    private MockInternalEngine.MockContext mockContext;

    public MockInternalEngineImpl(MockInternalEngine.MockContext mockContext, ShardId shardId, ESLogger logger, CodecService codecService,
    ...
    public void close() {
        try {
            ...
            if (logger.isTraceEnabled()) {
                ...
                for (Map.Entry<MockInternalEngineImpl.AssertingSearcher, RuntimeException> entry : INFLIGHT_ENGINE_SEARCHERS.entrySet()) {

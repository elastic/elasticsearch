...
public class CompoundAnalysisTests {
    ...
    private Settings getJsonSettings() {
        return settingsBuilder().loadFromClasspath("org/elasticsearch/test/unit/index/analysis/test1.json").build();
    }

    private Settings getYamlSettings() {
        return settingsBuilder().loadFromClasspath("org/elasticsearch/test/unit/index/analysis/test1.yml").build();
    }
}

...
public class FieldLevelBoostTests {
    ...
    public void testFieldLevelBoost() throws Exception {
        ...
        Fieldable f = doc.getFieldable("str_field");
        assertThat((double) f.getBoost(), closeTo(2.0, 0.001));

        f = doc.getFieldable("int_field");
        assertThat((double) f.getBoost(), closeTo(3.0, 0.001));

        f = doc.getFieldable("byte_field");
        assertThat((double) f.getBoost(), closeTo(4.0, 0.001));

        f = doc.getFieldable("date_field");
        assertThat((double) f.getBoost(), closeTo(5.0, 0.001));

        f = doc.getFieldable("double_field");
        assertThat((double) f.getBoost(), closeTo(6.0, 0.001));

        f = doc.getFieldable("float_field");
        assertThat((double) f.getBoost(), closeTo(7.0, 0.001));

        f = doc.getFieldable("long_field");
        assertThat((double) f.getBoost(), closeTo(8.0, 0.001));

        f = doc.getFieldable("short_field");
        assertThat((double) f.getBoost(), closeTo(9.0, 0.001));
    }

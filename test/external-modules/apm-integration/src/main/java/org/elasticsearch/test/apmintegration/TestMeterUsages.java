...
public class TestMeterUsages {
    ...
    public static String veryLongName = "a1234567890123456789012345678901234567890123456789012345678901234567890";

    public TestMeterUsages(MeterRegistry meterRegistry) {
        this.doubleCounter = meterRegistry.registerDoubleCounter(veryLongName, "test", "unit");

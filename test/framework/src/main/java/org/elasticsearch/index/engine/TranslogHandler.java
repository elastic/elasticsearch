    ...
    public Engine.Operation convertToEngineOp(Translog.Operation operation, Engine.Operation.Origin origin) {
        ...
        switch (operation.opType()) {
            case INDEX:
                ...
                final Function<DocumentMapper, SourceToParse> sourceSource = SourceToParse.parseTimeSeriesIdFromSource(
                    indexName,
                    index.id(),
                    index.source(),
                ...
                final Engine.Index engineIndex = IndexShard.prepareIndex(mapperService,
                        sourceSource, index.seqNo(), index.primaryTerm(),

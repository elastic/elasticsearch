...
public abstract class IndexShardTestCase extends ESTestCase {
    ...
    protected Engine.IndexResult indexDoc(IndexShard shard, String type, String id) throws IOException {
        return indexDoc(shard, type, id, false);
    }

    protected Engine.IndexResult indexDoc(IndexShard shard, String type, String id, boolean isSimulated) throws IOException {
        return indexDoc(shard, type, id, "{}", isSimulated);
    }

    protected Engine.IndexResult indexDoc(IndexShard shard, String type, String id, String source) throws IOException {
        return indexDoc(shard, type, id, source, false);
    }

    protected Engine.IndexResult indexDoc(IndexShard shard, String type, String id, String source, boolean isSimulated) throws IOException {
        return indexDoc(shard, id, source, XContentType.JSON, null, isSimulated);
    }
    ...
    protected Engine.IndexResult indexDoc(IndexShard shard, String id, String source, XContentType xContentType, String routing)
        throws IOException {
        return indexDoc(shard, id, source, xContentType, routing, false);
    }

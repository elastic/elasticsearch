...
public class ScaledFloatFieldDataGenerator implements FieldDataGenerator {
    ...
    public ScaledFloatFieldDataGenerator(String fieldName, DataSource dataSource, DataSourceResponse.LeafMappingParametersGenerator mappingParametersGenerator) {

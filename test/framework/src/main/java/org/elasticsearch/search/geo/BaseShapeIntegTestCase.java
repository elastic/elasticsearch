...
public abstract class BaseShapeIntegTestCase<T extends AbstractGeometryQueryBuilder<T>> extends ESIntegTestCase {
    ...
    public void testIgnoreMalformed() throws Exception {
        ...
        indexRandom(true, prepareIndex("test").setId("0").setSource("shape", polygonGeoJson));
    ...
    public void testIndexShapeRouting() throws Exception {
        ...
        indexRandom(true, prepareIndex("test").setId("0").setSource(source, XContentType.JSON).setRouting("ABC"));

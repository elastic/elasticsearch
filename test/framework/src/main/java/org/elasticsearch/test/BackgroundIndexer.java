...
public final class BackgroundIndexer implements AutoCloseable {
    ...
    /// When set, overrides both the auto-generated UUID path and the `Long.toString(id)` path, giving the
    /// caller full control over shard routing. Must be called before [start(int)][#start(int)].

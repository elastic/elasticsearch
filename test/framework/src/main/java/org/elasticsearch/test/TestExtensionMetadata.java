...
public abstract class TestExtensionMetadata extends AbstractNamedDiffable<MetadataExtension> implements MetadataExtension {
    private final String data;

    protected TestExtensionMetadata(String data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        TestExtensionMetadata that = (TestExtensionMetadata) o;
    ...
    public static <T extends TestExtensionMetadata> T readFrom(Function<String, T> supplier, StreamInput in) throws IOException {
        return supplier.apply(in.readString());
    }

    public static NamedDiff<MetadataExtension> readDiffFrom(String name, StreamInput in) throws IOException {
        return readDiffFrom(MetadataExtension.class, name, in);
    }
    ...
    public static <T extends MetadataExtension> T fromXContent(Function<String, T> supplier, XContentParser parser) throws IOException {

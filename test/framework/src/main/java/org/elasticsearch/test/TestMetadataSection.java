...
public abstract class TestMetadataSection extends AbstractNamedDiffable<MetadataSection> implements MetadataSection {
    private final String data;

    protected TestMetadataSection(String data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        TestMetadataSection that = (TestMetadataSection) o;
    ...
    public static <T extends TestMetadataSection> T readFrom(Function<String, T> supplier, StreamInput in) throws IOException {
        return supplier.apply(in.readString());
    }

    public static NamedDiff<MetadataSection> readDiffFrom(String name, StreamInput in) throws IOException {
        return readDiffFrom(MetadataSection.class, name, in);
    }
    ...
    public static <T extends MetadataSection> T fromXContent(Function<String, T> supplier, XContentParser parser) throws IOException {

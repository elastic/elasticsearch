    ...
    public static class TestPlugin extends Plugin implements DiscoveryPlugin {
        ...
        public Map<String, Supplier<Discovery>> getDiscoveryTypes(ThreadPool threadPool, TransportService transportService,
            ...
            return Collections.singletonMap("test-zen",
                () -> new TestZenDiscovery(
                    ...
                    Settings.builder().put(settings).putArray(DISCOVERY_ZEN_PING_UNICAST_HOSTS_SETTING.getKey()).build(),
                    threadPool, transportService, namedWriteableRegistry, clusterService, hostsProvider));
        }
        ...
        public Settings additionalSettings() {
            return Settings.builder()
                ...
                .putArray(DISCOVERY_ZEN_PING_UNICAST_HOSTS_SETTING.getKey())
                .build();
        }

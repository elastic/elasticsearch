...
public class ClientYamlSuiteRestApi {
    ...
    void addPath(String path, String[] methods, Set<String> parts, String deprecation) {
        ...
        boolean add = this.paths.add(new Path(path, methods, parts, deprecation));
        if (add == false) {
    ...
    public static class Path {
        ...
        private Path(String path, String[] methods, Set<String> parts, String deprecation) {
            this.path = path;

...
public class ByteWriteOperation extends WriteOperation {

    private final NetworkBytesReference[] references;

    public ByteWriteOperation(NioSocketChannel channel, BytesReference bytesReference, ActionListener<NioChannel> listener) {

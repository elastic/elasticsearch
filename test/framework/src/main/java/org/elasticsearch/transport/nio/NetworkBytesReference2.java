...
public abstract class NetworkBytesReference2 extends BytesReference implements NetworkBytes {
    ...
    NetworkBytesReference2(Releasable releasable, int length) {
        this.refCountedReleasable = new RefCountedReleasable(releasable);
        this.length = length;
    }

    NetworkBytesReference2(RefCountedReleasable refCountedReleasable, int length) {
    ...
    public abstract NetworkBytesReference2 sliceAndRetain(int from, int length);

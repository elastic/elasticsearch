...
public class SocketEventHandler extends EventHandler {
    ...
    void registrationException(NioSocketChannel channel, Exception exception) {
        logger.trace(new ParameterizedMessage("failed to register socket channel: {}", channel), exception);
    ...
    void connectException(NioSocketChannel channel, Exception exception) {
        logger.trace(new ParameterizedMessage("failed to connect to socket channel: {}", channel), exception);
        exceptionCaught(channel, exception);
    ...
    void readException(NioSocketChannel channel, Exception exception) {
        logger.trace(new ParameterizedMessage("exception while reading from socket channel: {}", channel), exception);
        exceptionCaught(channel, exception);
    }
    ...
    void writeException(NioSocketChannel channel, Exception exception) {
        logger.trace(new ParameterizedMessage("exception while writing to socket channel: {}", channel), exception);
        exceptionCaught(channel, exception);
    }
    ...
    void genericChannelException(NioSocketChannel channel, Exception exception) {
        logger.trace(new ParameterizedMessage("exception while handling event for socket channel: {}", channel), exception);
        exceptionCaught(channel, exception);
    }

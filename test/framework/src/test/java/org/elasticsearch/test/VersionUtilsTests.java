...
public class VersionUtilsTests extends ESTestCase {
    ...
    public void testRandomVersionBetween() {
        ...
        // sub range
        got = VersionUtils.randomVersionBetween(random(), Version.V_7_0_0,
                Version.V_7_1_0);
        assertTrue(got.onOrAfter(Version.V_7_0_0));
        assertTrue(got.onOrBefore(Version.V_7_1_0));

        // unbounded lower
        got = VersionUtils.randomVersionBetween(random(), null, Version.V_7_0_0);
        assertTrue(got.onOrAfter(VersionUtils.getFirstVersion()));
        assertTrue(got.onOrBefore(Version.V_7_0_0));
        ...
        // unbounded upper
        got = VersionUtils.randomVersionBetween(random(), Version.V_7_0_0, null);
        assertTrue(got.onOrAfter(Version.V_7_0_0));
        assertTrue(got.onOrBefore(Version.CURRENT));
        ...
        got = VersionUtils.randomVersionBetween(random(), Version.V_7_0_0,
                Version.V_7_0_0);
        assertEquals(got, Version.V_7_0_0);

...
[discrete]
[[security-create-enrollment-token-apis]]
=== Enrollment

You can use the following API to generate a token with which a user can enroll a new node
...
* <<security-create-enrollment-token-apis, Create enrollment token>>
...
include::security/create-enrollment-token.asciidoc[]

...
Most operating systems with a shell include the `base64` utility that can perform the encoding for you.
Make sure a trailing newline is not included when encoding the base64 value:

[role="xpack"]
[[security-api-get-service-tokens]]
...
[[security-api-get-service-tokens-path-params]]
...
[[security-api-get-service-tokens-example]]
==== {api-examples-title}

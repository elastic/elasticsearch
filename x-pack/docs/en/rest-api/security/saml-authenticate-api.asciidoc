...
custom web applications or other clients. See also <<security-saml-prepare-authentication,SAML Prepare Authentication
API>> , <<security-saml-invalidate,SAML Invalidate API>> and <<security-saml-logout,SAML Logout API>>.

...
Creates a SAML authentication request as a URL string, based on the configuration of the respective SAML realm in {es} when using a custom web application other than {kib}.

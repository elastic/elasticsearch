...
`PUT watcher/watch/<watch_id>/_ack` +

`PUT watcher/watch/<watch_id>/_ack/<action_id>`
...
[source,js]
--------------------------------------------------
PUT watcher/watch/my_watch/_ack/test_index
GET watcher/watch/my_watch
--------------------------------------------------
// CONSOLE
// TEST[continued]
...
[source,js]
--------------------------------------------------
POST watcher/watch/my_watch/_ack/action1,action2
--------------------------------------------------
// CONSOLE
...
[source,js]
--------------------------------------------------
POST watcher/watch/my_watch/_ack
--------------------------------------------------

...
| `trigger`         | The <<watcher-triggers,trigger>> that defines when
                      the watch should run.

| `input`           | The <<watcher-inputs,input>> that defines the input
                      that loads the data for the watch.

| `condition`       | The <<watcher-conditions,condition>> that defines if
                      the actions should be run.

| `actions`         | The list of <<watcher-actions,actions>> that will be

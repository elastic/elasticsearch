...
{"type":"audit", "timestamp":"2020-12-31T00:33:52,521+0200", "node.id":
"9clhpgjJRR-iKzOw20xBNQ", "event.type":"security_config_change", "event.action":
"update_apikey", "request.id":"9FteCmovTzWHVI-9Gpa_vQ", "change":{"apikey":
...
The object for an API key update will differ in that it will include an `id`
field instead of `name` and will not include `expiration`.

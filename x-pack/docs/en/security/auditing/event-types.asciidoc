...
| `run_as_granted`                  | | Logged when an authenticated user attempts to                          | | example7
                                        <<run-as-privilege, run as>> another user that they have
                                        the necessary privileges to do.
| `run_as_denied`                   | | Logged when an authenticated user attempts to                          | | example8

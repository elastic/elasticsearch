...
The `elasticsearch-reset-passwords` tool is the simplest method to set the
...
[source,shell]
--------------------------------------------------
bin/elasticsearch-reset-passwords interactive
--------------------------------------------------

For more information about the command options, see
<<reset-password,`elasticsearch-reset-password`>>.

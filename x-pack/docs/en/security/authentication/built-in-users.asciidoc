...
TIP: The built-in users serve a specific purpose and are not intended for every
day use. In particular, do not use the `elastic` superuser unless full access to

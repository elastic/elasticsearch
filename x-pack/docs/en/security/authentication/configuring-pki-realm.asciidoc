...
(or, equivalently `certificate_authorities`) when configuring
a PKI realm for delegation, as delegated PKI will not automatically
make use of the network layer's trust settings. 

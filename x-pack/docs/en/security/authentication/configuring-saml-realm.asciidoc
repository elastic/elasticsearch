...
the {stack} requires. For more information, see <<saml-guide-idp>>.
--
...
For more information, see <<saml-create-realm>>.
--
...
For more information, see <<saml-attribute-mapping>>. 
--
...
separate keys. For more information, see <<saml-enc-sign>>. 
--
...
NOTE: You cannot use <<mapping-roles-file,role mapping files>> to grant roles to
users authenticating via SAML.

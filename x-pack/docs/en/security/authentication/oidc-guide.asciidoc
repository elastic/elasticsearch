...
rp.response_type::
    ...
    which flow this PR requests the OP should follow. Supported values are
...
. Configure your OP to "release" those claims to your {stack} Relying
  ...
  request scopes that the OP supports, and which you intend to map to {es} user properties.

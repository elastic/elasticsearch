...
that is available both at the Service Provider (Elastic Stack) and at the Identity Provider.
...
look through our {stack-ov}/saml-guide.html[SAML troubleshooting documentation] that has

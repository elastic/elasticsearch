...
configuration in the index is compatible with the rest of the configuration, as
was the case at the time of the snapshot. But be advised that this will also
restore non-security persistent cluster seetting.
--

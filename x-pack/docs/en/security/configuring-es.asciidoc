...
include::{es-repo-dir}/security/authentication/configuring-active-directory-realm.asciidoc[]
include::{es-repo-dir}/security/authentication/configuring-file-realm.asciidoc[]
include::{es-repo-dir}/security/authentication/configuring-ldap-realm.asciidoc[]
include::{es-repo-dir}/security/authentication/configuring-native-realm.asciidoc[]
include::{es-repo-dir}/security/authentication/configuring-pki-realm.asciidoc[]
include::{es-repo-dir}/security/authentication/configuring-saml-realm.asciidoc[]
:edit_url: https://github.com/elastic/elasticsearch/edit/{branch}/reference/docs/security/authentication/configuring-kerberos-realm.asciidoc
include::{es-repo-dir}/security/authentication/configuring-kerberos-realm.asciidoc[]

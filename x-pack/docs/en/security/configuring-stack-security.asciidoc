...
indication that you <<<<manually-configure-security,manually configured security>>,
or don't want security to be configured automatically. In these cases, we'll
respect your existing configuration and skip the auto-configuration process. 
...
If {es} detects any of the following settings, then we'll assume that you want
to configure security on your own and we won't configure security automatically.

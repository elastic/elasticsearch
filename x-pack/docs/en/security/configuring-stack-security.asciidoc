...
IMPORTANT: Only use this security configuration for local development. The
minimal security scenario is not meant for <<dev-vs-prod-mode,production mode>>
clusters. If your cluster has multiple nodes, then you must

...
NOTE: If your Cryptographic Module offers a keystore type that is FIPS 140-2
compliant, you can use that instead, ensuring you set the correct value for
the type identifier in `\*.truststore.type` and `*.keystore.type` settings.

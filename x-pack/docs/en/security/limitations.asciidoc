...
* The same realm can also be renamed. This can cause inconsistency for same user check
when submitting async search/scroll before the rename and retrieving the result after the rename.

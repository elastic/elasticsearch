...
* `ES_PATH_CONF/role_mapping.yml` defines the role assignments for a
  Distinguished Name (DN) to a role. This allows groups and users to be mapped to roles
  for realm types LDAP, Active Directory, PKI, Kerberos, SAML, Open ID Connect, and JWT.
  See <<mapping-roles>>.

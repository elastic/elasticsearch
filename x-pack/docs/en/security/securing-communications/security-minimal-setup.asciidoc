...
{kibana-ref}/tutorial-secure-access-to-kibana.html[create new users and assign roles]. If you're running {kib} locally, go to `https://localhost:5601` to view the login page.

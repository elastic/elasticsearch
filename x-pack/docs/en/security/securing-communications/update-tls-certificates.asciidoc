...
expire soon, you're adding new nodes to your secured cluster, or a security
...
If you have to trust a new CA from your organization, or you need to generate a new CA yourself, you need to use this new CA to sign the new node certificates and instruct your nodes to trust the new CA. 
...
on a five-second interval by default. You can just copy the new
...
you must use *the same file names* so that {es} refreshes the

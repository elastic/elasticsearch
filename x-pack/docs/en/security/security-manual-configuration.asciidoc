...
NOTE: Make sure that you configure security _before_ you start your {es} nodes
and the auto-configuration process will respect your security configuration.
...
This scenario configures Transport Layer Security (TLS) for communication between

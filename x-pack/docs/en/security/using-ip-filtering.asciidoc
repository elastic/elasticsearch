...
{ref}/modules-transport.html[TCP transport profiles] enable {es} to bind on
multiple hosts. The {es} {security-features} enable you to apply different IP
filtering on different profiles.

...
<<all-realm-settings>>, you can specify the following settings: 
...
//TBD: Is this incomplete? Presented to what?
Defaults to `uid`.
...
are cached for this period of time. Use the standard {es}

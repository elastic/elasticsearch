...
<<watcher-actions-ack-throttle,throttled>>. A watch can perform multiple actions.
...
* <<watcher-action-email,`email`>>
* <<watcher-action-webhook,`webhook`>>
* <<watcher-action-index,`index`>>
* <<watcher-action-logging,`logging`>>
* <<watcher-action-slack,`slack`>>
* <<watcher-action-pagerduty,`pagerduty`>>
...
<1> There will be at least 15 minutes between subsequent `email_administrator`
		action executions.
<2> See <<watcher-action-email>> for more information.

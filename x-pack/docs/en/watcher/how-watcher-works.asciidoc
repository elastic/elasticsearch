...
For more information, see <<watcher-actions-ack-throttle>>.
...
You can use scripts to define <<watcher-condition-script,conditions>> and
<<watcher-transform-script,transforms>>. The default scripting language is

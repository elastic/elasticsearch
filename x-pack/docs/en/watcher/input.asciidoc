...
* <<watcher-input-simple,`simple`>>: load static data into the execution context.
* <<watcher-input-search,`search`>>: load the results of a search into the execution 
context.
* <<watcher-input-http,`http`>>: load the results of an HTTP request into the execution
context.
* <<watcher-input-chain,`chain`>>: use a series of inputs to load data into the 
execution context.

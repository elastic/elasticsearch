...
public class AnalyticsPercentilesAggregatorFactory {
    public static void registerPercentilesAggregator(ValuesSourceRegistry.ValuesSourceRegistryBuilder valuesSourceRegistryBuilder) {
    ...
    public static void registerPercentileRanksAggregator(ValuesSourceRegistry.ValuesSourceRegistryBuilder valuesSourceRegistryBuilder) {

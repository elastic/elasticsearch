...
public class HistoBackedHistogramAggregator extends BucketsAggregator {
    ...
    public HistoBackedHistogramAggregator(String name, AggregatorFactories factories, double interval, double offset,
                               BucketOrder order, boolean keyed, long minDocCount, double minBound, double maxBound,
                               @Nullable HistogramValuesSource.Histogram valuesSource, DocValueFormat formatter,

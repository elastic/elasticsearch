...
public class NormalizeAggregatorTests extends AggregatorTestCase {
    ...
    private static final List<Double> percentOfSum = Arrays.asList(0.2,0.0,0.2,0.0,0.2,0.0,0.1,0.1,0.2);
    ...
    private void testCase(ValuesSourceAggregationBuilder<?> aggBuilder, Consumer<InternalAggregation> aggAssertion) throws IOException {
        ...
        try (Directory directory = newDirectory()) {
            ...
            try (IndexReader indexReader = DirectoryReader.open(directory)) {
                ...
                InternalAggregation internalAggregation = searchAndReduce(indexSearcher, query, aggBuilder, dateFieldType, valueFieldType);

...
import org.elasticsearch.aggregations.bucket.composite.HistogramValuesSourceBuilder;
...
public class RateAggregatorTests extends AggregatorTestCase {
    ...
    private void testCase(
        ...
        testCase(buildIndex, verify, new AggTestConfig(dateHistogramAggregationBuilder, dateType, numType).withQuery(query));
    }

...
public class TTestAggregatorTests extends AggregatorTestCase {
    ...
    public void testBadMissingField() {
        ...
        NumberFormatException ex = expectThrows(NumberFormatException.class, () -> testCase(new AggTestConfig<>(aggregationBuilder, iw -> {
            iw.addDocument(asList(new SortedNumericDocValuesField("a", 102), new SortedNumericDocValuesField("b", 89)));
            iw.addDocument(asList(new SortedNumericDocValuesField("a", 99), new SortedNumericDocValuesField("b", 93)));
        }, tTest -> fail("Should have thrown exception"), fieldType1, fieldType2)));
    ...
    public void testScript() throws IOException {
        ...
        }, tTest -> assertEquals(tTestType == TTestType.PAIRED ? 0 : 0.5733922538, tTest.getValue(), 0.000001), fieldType));
    }
    ...
    public void testPaired() throws IOException {
        ...
        }, ttest -> assertEquals(0.09571844217 * tails, ttest.getValue(), 0.00001), fieldType1, fieldType2));
    }
    ...
    public void testHomoscedastic() throws IOException {
        ...
        testCase(new AggTestConfig<InternalTTest>(aggregationBuilder, iw -> {
            ...
            iw.addDocument(asList(new NumericDocValuesField("a", 101), new NumericDocValuesField("b", 102)));
            iw.addDocument(asList(new NumericDocValuesField("a", 99), new NumericDocValuesField("b", 98)));
        }, ttest -> assertEquals(0.03928288693 * tails, ttest.getValue(), 0.00001), fieldType1, fieldType2));
    }
    ...
    public void testHeteroscedastic() throws IOException {
        ...
        testCase(new AggTestConfig<InternalTTest>(aggregationBuilder, iw -> {
            ...
            iw.addDocument(asList(new NumericDocValuesField("a", 101), new NumericDocValuesField("b", 102)));
            iw.addDocument(asList(new NumericDocValuesField("a", 99), new NumericDocValuesField("b", 98)));
        }, ttest -> { assertEquals(0.04538666214 * tails, ttest.getValue(), 0.00001); }, fieldType1, fieldType2));
    }
    ...
    public void testFilterByFilterOrScript() throws IOException {
        ...
        }, tTest -> { assertEquals(0.02131164113, tTest.getValue(), 0.000001); }, fieldType1, fieldType2));
    }
    ...
    private void testCase(
        ...
        testCase(new AggTestConfig<>(aggregationBuilder, buildIndex, verify, fieldType1, fieldType2).withQuery(query));
    }

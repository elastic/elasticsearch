...
public class CrossClusterAsyncSearchIT extends AbstractMultiClustersTestCase {
    ...
    public void testGetResultPartialResultsFalseOnRunningSearchDoesNotIncludePartialResults() throws Exception {
        ...
        try {
            ...
            assertThat(localQueryDoneNoPartialResponse.getSearchResponse().getAggregations(), notNullValue());
        } finally {
        ...
        try {
            ...
            assertThat(localQueryDoneWithPartialResponse.getSearchResponse().getAggregations(), nullValue());
        } finally {

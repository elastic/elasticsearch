...
public class AutoscalingRestApiSpecTests extends ESClientYamlSuiteTestCase {

    public AutoscalingRestApiSpecTests(final ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

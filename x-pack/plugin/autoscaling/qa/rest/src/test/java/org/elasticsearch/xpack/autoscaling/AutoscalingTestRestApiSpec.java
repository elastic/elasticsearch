...
public class AutoscalingTestRestApiSpec extends ESClientYamlSuiteTestCase {

    public AutoscalingTestRestApiSpec(final ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class FrozenExistenceDeciderIT extends AbstractFrozenAutoscalingIntegTestCase {
    ...
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return org.elasticsearch.common.collect.List.of(LocalStateAutoscalingAndSearchableSnapshotsAndIndexLifecycle.class);
    }
    ...
    public void testZeroToOne() throws Exception {
        ...
        LifecyclePolicy lifecyclePolicy = new LifecyclePolicy(
            "policy",
            org.elasticsearch.common.collect.Map.of("hot", hotPhase, "frozen", frozenPhase)
        );

...
import org.elasticsearch.xpack.autoscaling.capacity.memory.AutoscalingMemoryAndProcessorInfoService;
...
public class Autoscaling extends Plugin implements ActionPlugin, ExtensiblePlugin, AutoscalingExtension {
    ...
    public Collection<Object> createComponents(
        ...
        return List.of(
            ...
            new AutoscalingMemoryAndProcessorInfoService(clusterService, client)
        );
    }

    @Override
    public List<Setting<?>> getSettings() {
        return List.of(AutoscalingMemoryAndProcessorInfoService.FETCH_TIMEOUT);
    }

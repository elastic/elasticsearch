...
public class Autoscaling extends Plugin implements ActionPlugin, ExtensiblePlugin, AutoscalingExtension {
    ...
    public List<NamedWriteableRegistry.Entry> getNamedWriteables() {
        return List.of(
            new NamedWriteableRegistry.Entry(MetadataExtension.class, AutoscalingMetadata.NAME, AutoscalingMetadata::new),
    ...
    public List<NamedXContentRegistry.Entry> getNamedXContent() {
        return List.of(
            new NamedXContentRegistry.Entry(MetadataExtension.class, new ParseField(AutoscalingMetadata.NAME), AutoscalingMetadata::parse)
        );
    }

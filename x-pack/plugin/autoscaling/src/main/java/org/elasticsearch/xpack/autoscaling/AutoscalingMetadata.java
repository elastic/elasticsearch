...
public class AutoscalingMetadata implements MetadataSection {
    ...
    @Override
    public Diff<MetadataSection> diff(final MetadataSection previousState) {
    ...
    public static class AutoscalingMetadataDiff implements NamedDiff<MetadataSection> {
        ...
        @Override
        public MetadataSection apply(final MetadataSection part) {

...
public class CcrRepositoryIT extends CcrIntegTestCase {
    ...
    public void testThatRepositoryRecoversEmptyIndexBasedOnLeaderSettings() throws IOException {
        ...
        IndexMetadata leaderMetadata = leaderState.getState().metadata().projectMetadata.index(leaderIndex);
        IndexMetadata followerMetadata = followerState.getState().metadata().projectMetadata.index(followerIndex);

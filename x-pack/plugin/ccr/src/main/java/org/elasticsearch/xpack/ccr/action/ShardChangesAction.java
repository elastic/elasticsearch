...
import org.elasticsearch.transport.RawDataTransportRequest;
...
public class ShardChangesAction extends ActionType<ShardChangesAction.Response> {
    ...
    public static class Request extends SingleShardRequest<Request> implements RawDataTransportRequest {

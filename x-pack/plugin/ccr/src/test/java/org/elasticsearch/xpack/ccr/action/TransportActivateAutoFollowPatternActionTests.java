...
public class TransportActivateAutoFollowPatternActionTests extends ESTestCase {
    ...
    public void testInnerActivateToggle() {
        ...
        }
        {
            ...
            AutoFollowMetadata updatedAutoFollowMetadata = updatedState.getMetadata().projectMetadata.custom(AutoFollowMetadata.TYPE);
            assertNotEquals(updatedAutoFollowMetadata, notNullValue());

            AutoFollowMetadata autoFollowMetadata = clusterState.getMetadata().projectMetadata.custom(AutoFollowMetadata.TYPE);

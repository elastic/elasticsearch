...
public class TransportActivateAutoFollowPatternActionTests extends ESTestCase {
    ...
    public void testInnerActivateToggle() {
        ...
        }
        {
            ...
            AutoFollowMetadata updatedAutoFollowMetadata = updatedState.getMetadata().section(AutoFollowMetadata.TYPE);
            assertNotEquals(updatedAutoFollowMetadata, notNullValue());

            AutoFollowMetadata autoFollowMetadata = clusterState.getMetadata().section(AutoFollowMetadata.TYPE);

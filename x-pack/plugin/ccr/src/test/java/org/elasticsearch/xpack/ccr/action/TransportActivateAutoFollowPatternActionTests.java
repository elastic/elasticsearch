...
public class TransportActivateAutoFollowPatternActionTests extends ESTestCase {
    ...
    public void testInnerActivateToggle() {
        ...
        }
        {
            ...
            AutoFollowMetadata updatedAutoFollowMetadata = updatedState.getMetadata().projectCustom(AutoFollowMetadata.TYPE);
            assertNotEquals(updatedAutoFollowMetadata, notNullValue());

            AutoFollowMetadata autoFollowMetadata = clusterState.getMetadata().projectCustom(AutoFollowMetadata.TYPE);

...
public class CompatRestRequestTest extends ESTestCase {
    ...
    public void testAcceptAndContentTypeCombinations() {
        ...
        expectThrows(CompatibleApiException.class, () ->
    ...
    private Matcher<Tuple> requestCreated() {
        //meaning request creation and compatible function succeeded
        return Matchers.not(nullValue(Tuple.class));
    }
    ...
    private Matcher<Tuple<RestRequest,Version>> requestHasVersion(int version) {
        return ElasticsearchMatchers.HasPropertyLambdaMatcher.hasProperty(tuple ->
            (int) tuple.v2().major, equalTo(version));
    }

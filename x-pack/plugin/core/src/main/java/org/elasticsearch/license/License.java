...
public class License implements ToXContentObject {
    ...
    /**
     * Returns the version number of this license format.
     * <p>
     * The version indicates which license format is being used and affects
     * serialization and validation behavior. Current versions include:
     * <ul>
     *   <li>{@link #VERSION_START} - Initial version with subscription type</li>
     *   <li>{@link #VERSION_NO_FEATURE_TYPE} - Removed feature type field</li>
     *   <li>{@link #VERSION_START_DATE} - Added start date field</li>
     *   <li>{@link #VERSION_CRYPTO_ALGORITHMS} - Updated crypto algorithms</li>
     *   <li>{@link #VERSION_ENTERPRISE} - Added enterprise license support</li>
     * </ul>
     *
     * @return the version of the license format
     */
    public int version() {
        return version;
    }
     ...
     * <p>
     * The UID is a globally unique identifier assigned to each license
     * during creation and used for license tracking and management.
     *
     * @return a unique identifier string for this license
     */
    public String uid() {
        return uid;
    }
     ...
     * <p>
     * Valid types include: trial, basic, standard, gold, platinum, and enterprise.
     * The type determines which features are available to the user.
     *
     ...
     * }</pre>
     *
     * @return the type of the license as a string (e.g., "trial", "basic", "platinum")
     */
    public String type() {
        return type;
    }
    ...
    /**
     * Returns the date and time when this license was issued.
     * <p>
     * The issue date marks when the license was originally created and is
     * used for license validity tracking and auditing purposes.
     *
     * @return the issue date in milliseconds since the Unix epoch
     */
    ...
    /**
     * Returns the date and time when this license becomes valid.
     * <p>
     * The start date indicates when the license period begins. For most licenses,
     * this is the same as or close to the issue date, but may differ for
     * pre-issued licenses.
     *
     * @return the start date in milliseconds since the Unix epoch
     */
    ...
    /**
     * Returns the name of the entity to whom this license was issued.
     * <p>
     * This is typically the customer or organization name that purchased
     * or received the license.
     *
     * @return a string representing the licensee's name
     */
    ...
    /**
     * Returns the name of the entity that issued this license.
     * <p>
     * This is typically "Elasticsearch" for official licenses. This field
     * is primarily for internal tracking purposes.
     *
     * @return a string representing the issuer's name
     */
    ...
    /**
     * Returns the cryptographic signature of this license.
     * <p>
     * The signature is used to verify the authenticity and integrity of the
     * license. It is generated during license creation and validated when
     * the license is installed or verified.
     *
     * @return the Base64-encoded signature string, or null if the license is unsigned
     * @see #verified()
     * @see #isAutoGeneratedLicense(String)
     */
    ...
    /**
     * Returns the operation mode derived from this license's type.
     * <p>
     * The operation mode determines which features are enabled in Elasticsearch.
     * It is computed from the license type and provides a consistent way to
     * check feature availability across the codebase.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * License license = getLicense();
     ...
     * }</pre>
     *
     * @return the operation mode (e.g., BASIC, GOLD, PLATINUM, ENTERPRISE)
     * @see OperationMode
     */
    ...
    /**
     * Deserializes a license from a {@link StreamInput}.
     * <p>
     * This method reconstructs a License object from its serialized binary form,
     * handling backward compatibility with different license versions.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     ...
     * @return the deserialized license object
     * @throws IOException if an I/O error occurs during deserialization
     * @throws ElasticsearchException if the license version is unknown or unsupported
     */
     ...
     * <p>
     * This method writes the license data to the output stream in a binary format
     * that can be transmitted over the network or stored on disk. The serialization
     * format is version-aware to maintain backward compatibility.
     *
    ...
    /**
     * Determines whether a license was auto-generated by the Elasticsearch cluster.
     * <p>
     * Auto-generated licenses include self-generated licenses and trial licenses
     * created by the cluster itself, as opposed to licenses that were issued
     * and signed by Elastic.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     * License license = getLicense();
     ...
     * }</pre>
     *
     * @param signature the license signature to check
     * @return true if the license was auto-generated by the cluster, false otherwise
     * @throws IllegalStateException if the signature cannot be decoded
     */
    ...
    /**
     * Parses a license from a byte source in the specified content type format.
     * <p>
     * This method deserializes license data from JSON or other XContent formats,
     * handling both single license documents and legacy multi-license arrays.
     * For backward compatibility, it can process pre-2.0 license formats and
     * will select the latest unexpired license from multi-license documents.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     ...
     * }</pre>
     *
     * @param bytes the byte content containing the license data
     * @param xContentType the content type (e.g., JSON, SMILE)
     * @return the parsed license object
     * @throws IOException if an I/O error occurs during parsing
     * @throws ElasticsearchParseException if the content cannot be parsed as a valid license
     */
    ...
    /**
     * Creates a new builder for constructing a license object.
     * <p>
     * The builder pattern allows for flexible and readable license construction
     * with validation. All required fields must be set before calling
     * {@link Builder#build()}.
     *
     * <p><b>Usage Examples:</b></p>
     * <pre>{@code
     ...
     * }</pre>
     *
     * @return a new License builder instance
     */

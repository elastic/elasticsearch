...
public class License implements ToXContentObject {
    ...
    private License(
        ...
        if (expiryDate == -1) {
            this.expiryDate = LicenseServiceInterface.BASIC_SELF_GENERATED_LICENSE_EXPIRATION_MILLIS;
        } else {
    ...
    private void validate() {
        ...
        } else if (expiryDate == LicenseServiceInterface.BASIC_SELF_GENERATED_LICENSE_EXPIRATION_MILLIS
            && LicenseType.isBasic(type) == false) {
    ...
    public XContentBuilder toInnerXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (expiryDate != LicenseServiceInterface.BASIC_SELF_GENERATED_LICENSE_EXPIRATION_MILLIS) {

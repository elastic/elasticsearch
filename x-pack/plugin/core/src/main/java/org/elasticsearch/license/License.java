...
public class License implements ToXContentObject {
    ...
    public XContentBuilder toInnerXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        builder.unixEpochMillisField(Fields.ISSUE_DATE_IN_MILLIS, Fields.ISSUE_DATE, issueDate);
        if (licenseVersion == VERSION_START) {
            builder.field(Fields.FEATURE, feature);
        }

        if (expiryDate != LicenseSettings.BASIC_SELF_GENERATED_LICENSE_EXPIRATION_MILLIS) {
            builder.unixEpochMillisField(Fields.EXPIRY_DATE_IN_MILLIS, Fields.EXPIRY_DATE, expiryDate);
        }
        ...
        if (licenseVersion >= VERSION_START_DATE) {
            builder.unixEpochMillisField(Fields.START_DATE_IN_MILLIS, Fields.START_DATE, startDate);
        }
        return builder;
    }

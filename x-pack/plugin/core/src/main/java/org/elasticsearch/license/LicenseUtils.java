...
public class LicenseUtils {
     ...
     */
    public static boolean signatureNeedsUpdate(License license, ClusterState currentState) {
        ...
        // only upgrade signature when all nodes are ready to deserialize the new signature
            (license.version() < License.VERSION_CRYPTO_ALGORITHMS
                && compatibleLicenseVersion(currentState) >= License.VERSION_CRYPTO_ALGORITHMS);
    }

...
public final class ClientHelper {
    ...
    public static <Request extends ActionRequest, Response extends ActionResponse,
        ...
        Client client, String origin, GenericAction<Response> action, Request request,
    ...
    public static <Request extends ActionRequest, Response extends ActionResponse, 
        ...
        Map<String, String> headers, String origin, Client client, GenericAction<Response> action, Request request,
        ActionListener<Response> listener) {

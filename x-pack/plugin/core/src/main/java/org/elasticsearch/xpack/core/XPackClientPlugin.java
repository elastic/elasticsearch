...
public class XPackClientPlugin extends Plugin implements ActionPlugin, SearchPlugin, NetworkPlugin {
    ...
    public List<NamedWriteableRegistry.Entry> getNamedWriteables() {
        return Stream.of(
            ...
            new NamedWriteableRegistry.Entry(ProjectMetadata.ProjectCustom.class, RoleMappingMetadata.TYPE, RoleMappingMetadata::new),
            ...
            // watcher
            new NamedWriteableRegistry.Entry(ProjectMetadata.ProjectCustom.class, WatcherMetadata.TYPE, WatcherMetadata::new),
            ...
            // licensing
            new NamedWriteableRegistry.Entry(Metadata.ClusterCustom.class, LicensesMetadata.TYPE, LicensesMetadata::new),
            ...
            new NamedWriteableRegistry.Entry(ProjectMetadata.ProjectCustom.class, AutoFollowMetadata.TYPE, AutoFollowMetadata::new),
            new NamedWriteableRegistry.Entry(
                NamedDiff.class,
                AutoFollowMetadata.TYPE,
                in -> AutoFollowMetadata.readDiffFrom(ProjectMetadata.ProjectCustom.class, AutoFollowMetadata.TYPE, in)
            ),
            // ILM
            ...
            // ILM - Custom Metadata
            new NamedWriteableRegistry.Entry(ProjectMetadata.ProjectCustom.class, IndexLifecycleMetadata.TYPE, IndexLifecycleMetadata::new),
            new NamedWriteableRegistry.Entry(
                NamedDiff.class,
            ...
            new NamedWriteableRegistry.Entry(
                ...
                LifecycleOperationMetadata::new
            ),
            new NamedWriteableRegistry.Entry(
                NamedDiff.class,
                LifecycleOperationMetadata.TYPE,
            ...
            // Transforms
            new NamedWriteableRegistry.Entry(ProjectMetadata.ProjectCustom.class, TransformMetadata.TYPE, TransformMetadata::new),
    ...
    public List<NamedXContentRegistry.Entry> getNamedXContent() {
        return Arrays.asList(
            ...
            new NamedXContentRegistry.Entry(
                ProjectMetadata.ProjectCustom.class,
                new ParseField(WatcherMetadata.TYPE),
                WatcherMetadata::fromXContent
            ),
            // licensing
            new NamedXContentRegistry.Entry(
                Metadata.ClusterCustom.class,
                new ParseField(LicensesMetadata.TYPE),

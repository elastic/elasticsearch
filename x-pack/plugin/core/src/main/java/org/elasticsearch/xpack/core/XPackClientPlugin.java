...
public class XPackClientPlugin extends Plugin implements ActionPlugin, SearchPlugin, NetworkPlugin {
    ...
    public List<NamedWriteableRegistry.Entry> getNamedWriteables() {
        return Stream.of(
            ...
            new NamedWriteableRegistry.Entry(MetadataExtension.class, RoleMappingMetadata.TYPE, RoleMappingMetadata::new),
            ...
            // watcher
            new NamedWriteableRegistry.Entry(MetadataExtension.class, WatcherMetadata.TYPE, WatcherMetadata::new),
            ...
            // licensing
            new NamedWriteableRegistry.Entry(MetadataExtension.class, LicensesMetadata.TYPE, LicensesMetadata::new),
            ...
            new NamedWriteableRegistry.Entry(MetadataExtension.class, AutoFollowMetadata.TYPE, AutoFollowMetadata::new),
            new NamedWriteableRegistry.Entry(
                NamedDiff.class,
                AutoFollowMetadata.TYPE,
                in -> AutoFollowMetadata.readDiffFrom(MetadataExtension.class, AutoFollowMetadata.TYPE, in)
            ),
            // ILM
            ...
            // ILM - Custom Metadata
            new NamedWriteableRegistry.Entry(MetadataExtension.class, IndexLifecycleMetadata.TYPE, IndexLifecycleMetadata::new),
            new NamedWriteableRegistry.Entry(
                NamedDiff.class,
                IndexLifecycleMetadata.TYPE,
                IndexLifecycleMetadata.IndexLifecycleMetadataDiff::new
            ),
            new NamedWriteableRegistry.Entry(MetadataExtension.class, LifecycleOperationMetadata.TYPE, LifecycleOperationMetadata::new),
            new NamedWriteableRegistry.Entry(
                NamedDiff.class,
                LifecycleOperationMetadata.TYPE,
                LifecycleOperationMetadata.LifecycleOperationMetadataDiff::new
            ),
            new NamedWriteableRegistry.Entry(MetadataExtension.class, SnapshotLifecycleMetadata.TYPE, SnapshotLifecycleMetadata::new),
            new NamedWriteableRegistry.Entry(
                NamedDiff.class,
            ...
            // Transforms
            new NamedWriteableRegistry.Entry(MetadataExtension.class, TransformMetadata.TYPE, TransformMetadata::new),
    ...
    public List<NamedXContentRegistry.Entry> getNamedXContent() {
        return Arrays.asList(
            ...
            // watcher
            new NamedXContentRegistry.Entry(MetadataExtension.class, new ParseField(WatcherMetadata.TYPE), WatcherMetadata::fromXContent),
            // licensing
            new NamedXContentRegistry.Entry(MetadataExtension.class, new ParseField(LicensesMetadata.TYPE), LicensesMetadata::fromXContent),
            // rollup

...
public class XPackClientPlugin extends Plugin implements ActionPlugin, NetworkPlugin {
    ...
    public List<NamedWriteableRegistry.Entry> getNamedWriteables() {
        return Arrays.asList(
                ...
                new NamedWriteableRegistry.Entry(SecurityPrivileges.ConditionalPrivilege.class,
                    SecurityPrivileges.ManageApplicationPrivileges.NAME, SecurityPrivileges.ManageApplicationPrivileges::createFrom),

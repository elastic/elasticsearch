...
import org.elasticsearch.xpack.core.action.TransportClientEnrollmentAction;
...
import org.elasticsearch.xpack.core.rest.action.RestClientEnrollmentRequest;
...
public class XPackPlugin extends XPackClientPlugin
    ...
    public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
        ...
        actions.add(new ActionHandler<>(ClientEnrollmentAction.INSTANCE, TransportClientEnrollmentAction.class));
        return actions;
    }
    ...
    public List<RestHandler> getRestHandlers(Settings settings, RestController restController, ClusterSettings clusterSettings,
        ...
        handlers.add(new RestClientEnrollmentRequest());

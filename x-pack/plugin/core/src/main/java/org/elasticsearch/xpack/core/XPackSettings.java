...
public class XPackSettings {
    ...
    private static final List<String> JDK24_CIPHERS = List.of(
        ...
        "TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", // PFS, hardware support
        "TLS_DHE_DSS_WITH_AES_128_GCM_SHA256",
        "TLS_DHE_RSA_WITH_AES_128_GCM_SHA256",
        "TLS_DHE_DSS_WITH_AES_256_GCM_SHA384",
        "TLS_DHE_RSA_WITH_AES_256_GCM_SHA384", // PFS, AEAD, hardware support
        "TLS_DHE_RSA_WITH_AES_128_CBC_SHA",
        "TLS_DHE_RSA_WITH_AES_128_CBC_SHA256",
        "TLS_DHE_RSA_WITH_AES_256_CBC_SHA",
        "TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", // PFS, hardware support
        // PFS, AEAD
        "TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256"
    ); // hardware support

    public static final List<String> DEFAULT_CIPHERS = JDK24_CIPHERS;

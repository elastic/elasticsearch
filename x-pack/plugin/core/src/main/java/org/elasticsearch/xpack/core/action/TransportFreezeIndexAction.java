...
public final class TransportFreezeIndexAction extends
    ...
    @Inject
    public TransportFreezeIndexAction(Settings settings, MetaDataIndexStateService indexStateService, TransportService transportService,
    ...
    public static class FreezeIndexAction extends Action<FreezeRequest, FreezeResponse, FreezeRequestBuilder> {
    ...
    public static final class FreezeRequestBuilder extends ActionRequestBuilder<FreezeRequest, FreezeResponse, FreezeRequestBuilder> {

        protected FreezeRequestBuilder(ElasticsearchClient client, Action<FreezeRequest, FreezeResponse, FreezeRequestBuilder> action,

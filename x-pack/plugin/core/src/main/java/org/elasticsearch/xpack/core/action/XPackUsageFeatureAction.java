...
public class XPackUsageFeatureAction extends ActionType<XPackUsageFeatureResponse> {
    ...
    public static final XPackUsageFeatureAction CONSTANT_KEYWORD = new XPackUsageFeatureAction(XPackField.CONSTANT_KEYWORD);

    public static final List<XPackUsageFeatureAction> ALL = Arrays.asList(
        SECURITY, MONITORING, WATCHER, GRAPH, MACHINE_LEARNING, LOGSTASH, EQL, SQL, ROLLUP, INDEX_LIFECYCLE, SNAPSHOT_LIFECYCLE, CCR,
        TRANSFORM, FLATTENED, VECTORS, VOTING_ONLY, FROZEN_INDICES, SPATIAL, ANALYTICS, CONSTANT_KEYWORD
    );

...
/**
 * Usage statistics for the {@code columnar} index mode ({@code index.mode: columnar}).
 * <p>
...
public final class ColumnarFeatureSetUsage extends XPackFeatureUsage {
    ...
    public ColumnarFeatureSetUsage(StreamInput input) throws IOException {
        super(input);
    ...
    public ColumnarFeatureSetUsage(
        boolean available,
        boolean enabled,
        int indicesCount,
        ...
        super(XPackField.COLUMNAR, available, enabled);
    ...
    public boolean equals(Object obj) {
        ...
        ColumnarFeatureSetUsage other = (ColumnarFeatureSetUsage) obj;

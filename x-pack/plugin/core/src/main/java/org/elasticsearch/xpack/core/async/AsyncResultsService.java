...
public class AsyncResultsService<Task extends AsyncTask, Response extends AsyncResponse<Response>> {
    ...
    private void getSearchResponseFromIndexAndUpdateExpiration(
        ...
        // When updateInitialResultsInStore=false, we can't update the expiration time in the store immediately.
        // Therefore, we need to update the keep-alive before accessing the document after the task completes.

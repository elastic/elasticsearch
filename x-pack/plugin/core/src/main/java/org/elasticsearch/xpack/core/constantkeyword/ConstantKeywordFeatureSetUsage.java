...
public class ConstantKeywordFeatureSetUsage extends XPackFeatureSet.Usage {
    ...
    public ConstantKeywordFeatureSetUsage(boolean available, int fieldCount) {
        super(XPackField.CONSTANT_KEYWORD, available, true);
    ...
    public boolean equals(Object o) {
        ...
        ConstantKeywordFeatureSetUsage that = (ConstantKeywordFeatureSetUsage) o;

...
public class DownsampleAction extends ActionType<AcknowledgedResponse> {
    ...
    public static class Request extends MasterNodeRequest<Request> implements IndicesRequest, ToXContentObject {
        ...
        public Request(StreamInput in) throws IOException {
            ...
            timeout = in.getTransportVersion().onOrAfter(TransportVersion.V_8_500_040)
        ...
        public void writeTo(StreamOutput out) throws IOException {
            ...
            out.writeString(
                out.getTransportVersion().onOrAfter(TransportVersion.V_8_500_040) ? timeout.getStringRep() : DEFAULT_TIMEOUT.getStringRep()
            );

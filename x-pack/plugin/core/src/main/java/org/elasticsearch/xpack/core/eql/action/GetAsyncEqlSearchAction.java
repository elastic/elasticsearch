...
public class GetAsyncEqlSearchAction extends ActionType<AsyncEqlSearchResponse> {
    public static final GetAsyncEqlSearchAction INSTANCE = new GetAsyncEqlSearchAction();
    public static final String NAME = "indices:data/read/eql/async_search/get";

    private GetAsyncEqlSearchAction() {
        super(NAME, AsyncEqlSearchResponse::new);
    }

    @Override
    public Writeable.Reader<AsyncEqlSearchResponse> getResponseReader() {

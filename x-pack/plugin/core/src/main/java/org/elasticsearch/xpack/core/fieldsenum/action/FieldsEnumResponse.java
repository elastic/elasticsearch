 ...
 */
public class FieldsEnumResponse extends BroadcastResponse {

    public static final String TERMS_FIELD = "terms";
    public static final String COMPLETE_FIELD = "complete";

    @SuppressWarnings("unchecked")
    static final ConstructingObjectParser<FieldsEnumResponse, Void> PARSER = new ConstructingObjectParser<>(
        "term_enum_results",
        true,
        arg -> {
            BroadcastResponse response = (BroadcastResponse) arg[0];
            return new FieldsEnumResponse(
                (List<String>) arg[1],
    ...
    FieldsEnumResponse(StreamInput in) throws IOException {
        super(in);
        terms = in.readStringList();
        complete = in.readBoolean();
    }

    public FieldsEnumResponse(
        List<String> terms,
        int totalShards,
    ...
    public static FieldsEnumResponse fromXContent(XContentParser parser) {

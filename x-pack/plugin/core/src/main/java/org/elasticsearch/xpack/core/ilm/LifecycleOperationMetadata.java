 ...
 */
public class LifecycleOperationMetadata implements ProjectMetadata.ProjectCustom {
    ...
    public static OperationMode currentILMMode(final ClusterState state) {
        IndexLifecycleMetadata oldMetadata = state.metadata().projectCustom(IndexLifecycleMetadata.TYPE);
        LifecycleOperationMetadata currentMetadata = state.metadata().projectCustom(LifecycleOperationMetadata.TYPE);
    ...
    public static OperationMode currentSLMMode(final ClusterState state) {
        SnapshotLifecycleMetadata oldMetadata = state.metadata().projectCustom(SnapshotLifecycleMetadata.TYPE);
        LifecycleOperationMetadata currentMetadata = state.metadata().projectCustom(LifecycleOperationMetadata.TYPE);
        return Optional.ofNullable(currentMetadata)
    ...
    public static class LifecycleOperationMetadataDiff implements NamedDiff<ProjectMetadata.ProjectCustom> {

...
public class WaitForActiveShardsStep extends ClusterStateWaitStep {
    ...
    public Result isConditionMet(Index index, ClusterState clusterState) {
        ...
        assert aliasOrIndex.getType() == AliasOrIndex.Type.ALIAS : rolloverAlias + " must be an alias but it is an index";

        IndexMetaData aliasWriteIndex = aliasOrIndex.getWriteIndex();

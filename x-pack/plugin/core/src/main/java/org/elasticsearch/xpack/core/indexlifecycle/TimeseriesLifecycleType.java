...
public class TimeseriesLifecycleType implements LifecycleType {
    ...
    static final List<String> ORDERED_VALID_WARM_ACTIONS = Arrays.asList(UnfollowAction.NAME, ReadOnlyAction.NAME, AllocateAction.NAME,
        ShrinkAction.NAME, ForceMergeAction.NAME);
    static final List<String> ORDERED_VALID_COLD_ACTIONS = Arrays.asList(UnfollowAction.NAME, AllocateAction.NAME, FreezeAction.NAME);

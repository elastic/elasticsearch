...
public class AnnotationIndex {
    ...
    public static void createAnnotationsIndexIfNecessary(
        ...
        final ActionListener<String> createAliasListener = finalListener.wrapResponse((finalDelegate, currentIndexName) -> {
            ...
            executeAsyncWithOrigin(
                ...
                finalDelegate.<AcknowledgedResponse>wrapResponse((l, r) -> checkMappingsListener.onResponse(r.isAcknowledged())),

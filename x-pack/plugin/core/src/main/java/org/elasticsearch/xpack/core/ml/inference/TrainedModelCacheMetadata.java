...
public class TrainedModelCacheMetadata extends AbstractNamedDiffable<MetadataSection> implements MetadataSection {
    ...
    public static NamedDiff<MetadataSection> readDiffFrom(StreamInput streamInput) throws IOException {
        return readDiffFrom(MetadataSection.class, NAME, streamInput);
    }

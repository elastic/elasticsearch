...
public class AssignmentStats implements ToXContentObject, Writeable {
    ...
    public static class NodeStats implements ToXContentObject, Writeable {
        ...
        public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
            ...
            if (lastAccess != null) {
                builder.unixEpochMillisField("last_access", "last_access_string", lastAccess.toEpochMilli());
            }
            ...
            if (startTime != null) {
                builder.unixEpochMillisField("start_time", "start_time_string", startTime.toEpochMilli());
            }

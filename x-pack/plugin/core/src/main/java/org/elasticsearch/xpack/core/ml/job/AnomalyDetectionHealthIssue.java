...
/**
 * Represents a single health issue detected for an anomaly detection job or datafeed.
 * Each issue has a machine-readable {@code type}, a human-readable {@code issue} title,
 * an optional {@code details} string, a repetition {@code count}, and an optional
 * {@code firstOccurrence} timestamp.
 */
public class AnomalyDetectionHealthIssue implements Writeable, ToXContentObject {
    ...
    /**
     * @param type            machine-readable issue type string (required)
     * @param issue           human-readable issue title (required)
     * @param details         optional additional context
     * @param count           number of occurrences; must be at least 1
     * @param firstOccurrence optional timestamp of the first occurrence; truncated to millisecond precision
     */
    public AnomalyDetectionHealthIssue(String type, String issue, String details, int count, Instant firstOccurrence) {
    ...
    public AnomalyDetectionHealthIssue(StreamInput in) throws IOException {
    ...
    public boolean equals(Object other) {
        ...
        AnomalyDetectionHealthIssue that = (AnomalyDetectionHealthIssue) other;

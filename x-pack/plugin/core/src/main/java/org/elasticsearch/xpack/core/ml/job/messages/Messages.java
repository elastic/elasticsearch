...
public final class Messages {
    ...
    public static final String INFERENCE_WARNING_ALL_FIELDS_MISSING =
        "Model [{0}] could not be inferred as all fields were either missing or not of the expected type";

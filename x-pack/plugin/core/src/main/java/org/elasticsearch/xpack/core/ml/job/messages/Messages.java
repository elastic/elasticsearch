...
public final class Messages {
    ...
    public static final String DATAFEED_AGGREGATIONS_INTERVAL_MUST_BE_GREATER_THAN_ZERO = "Aggregation interval must be greater than 0";
    ...
    public static final String JOB_AUDIT_DATAFEED_PROJECT_ROUTING_CHANGED = "Datafeed project_routing changed: [{0}] -> [{1}]."
        + " Data distribution may change when the datafeed runs."
        + " A rollback model snapshot was retained when required;"
        + " review recent snapshots if detection quality degrades.";
    ...
    public static final String JOB_CONFIG_DUPLICATE_DETECTORS_DISALLOWED = "Duplicate detectors are not allowed: [{0}]";
    public static final String JOB_CONFIG_DETECTOR_DUPLICATE_FIELD_NAME = "{0} and {1} cannot be the same: ''{2}''";
    public static final String JOB_CONFIG_DETECTOR_COUNT_DISALLOWED = "''count'' is not a permitted value for {0}";
    public static final String JOB_CONFIG_DETECTOR_BY_DISALLOWED = "''by'' is not a permitted value for {0}";
    public static final String JOB_CONFIG_DETECTOR_OVER_DISALLOWED = "''over'' is not a permitted value for {0}";
    ...
    public static final String JOB_CONFIG_TIME_FIELD_CANNOT_BE_RUNTIME = "data_description.time_field [{0}] cannot be a runtime field";
    public static final String JOB_CONFIG_MODEL_SNAPSHOT_RETENTION_SETTINGS_INCONSISTENT = "The value of '"
        + Job.DAILY_MODEL_SNAPSHOT_RETENTION_AFTER_DAYS
        + "' [{0}] cannot be greater than '"
        + Job.MODEL_SNAPSHOT_RETENTION_DAYS
        + "' [{1}]";
    public static final String JOB_CONFIG_DATAFEED_CONFIG_JOB_ID_MISMATCH = "datafeed job_id [{0}] does not equal job id [{1}}";

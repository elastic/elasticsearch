 ...
 * API key information
 */
public class ApiKey implements ToXContentObject {
    ...
    protected ApiKey(ApiKey other) {
        ...
        this.invalidation = other.invalidation;
        this.username = other.username;
        this.realm = other.realm;
        this.realmType = other.realmType;
        this.metadata = other.metadata;
        this.roleDescriptors = other.roleDescriptors;
        this.limitedBy = other.limitedBy;
    }
    ...
    protected static int initializeParser(AbstractObjectParser<?, Void> parser) {

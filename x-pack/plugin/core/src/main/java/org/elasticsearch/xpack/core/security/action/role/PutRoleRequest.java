...
public class PutRoleRequest extends ActionRequest implements WriteRequest<PutRoleRequest> {
    ...
    private RenderableConditionalClusterPrivilege[] conditionalClusterPrivileges = ConditionalClusterPrivileges.EMPTY_ARRAY;
    ...
    void conditionalCluster(RenderableConditionalClusterPrivilege... conditionalClusterPrivileges) {
    ...
    public RenderableConditionalClusterPrivilege[] conditionalClusterPrivileges() {

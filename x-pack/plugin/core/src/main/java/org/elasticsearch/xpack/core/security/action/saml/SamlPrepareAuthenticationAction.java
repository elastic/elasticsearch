...
/**
 * GenericAction for initiating an authentication process using SAML assertions
 */
public final class SamlPrepareAuthenticationAction extends GenericAction<SamlPrepareAuthenticationResponse> {

...
public final class CreateTokenResponse extends ActionResponse implements ToXContentObject {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getVersion().onOrAfter(Version.V_7_0_0)) { // TODO change to V_6_5_0 after backport
    ...
    public void readFrom(StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(Version.V_7_0_0)) { // TODO change to V_6_5_0 after backport

...
public final class GetUserPrivilegesResponse extends ActionResponse {
    ...
    private Set<RenderableConditionalClusterPrivilege> conditionalCluster;
    ...
    public GetUserPrivilegesResponse(Set<String> cluster, Set<RenderableConditionalClusterPrivilege> conditionalCluster,
                                     Set<Indices> index,
    ...
    public Set<RenderableConditionalClusterPrivilege> getConditionalClusterPrivileges() {

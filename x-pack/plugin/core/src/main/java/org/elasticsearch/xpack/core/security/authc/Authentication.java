...
public final class Authentication implements ToXContentObject {
    ...
    public Authentication(StreamInput in) throws IOException {
        ...
        if (InternalUsers.isInternal(outerUser)) {
            hasInnerUser = false;
        } else {
        ...
        if (hasInnerUser) {
            ...
            assert false == InternalUsers.isInternal(innerUser) : "internal users cannot participate in run-as";
        } else {
            innerUser = null;
        }
    ...
    private static void doWriteTo(Subject effectiveSubject, Subject authenticatingSubject, AuthenticationType type, StreamOutput out)
        ...
        if (isRunAs) {
            ...
            assert false == InternalUsers.isInternal(outerUser) && false == InternalUsers.isInternal(innerUser)

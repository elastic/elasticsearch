...
public interface AuthenticationFailureHandler {
     ...
     * @return ElasticsearchSecurityException with the appropriate headers and message
     */
    ElasticsearchSecurityException exceptionProcessingRequest(HttpRequestLineAndHeaders request, Exception e, ThreadContext context);
     ...
     * @return ElasticsearchSecurityException with the appropriate headers and message
     */
    ElasticsearchSecurityException missingToken(HttpRequestLineAndHeaders request, ThreadContext context);

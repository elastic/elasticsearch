...
public interface AuthenticationFailureHandler {
     ...
     */
    ElasticsearchSecurityException failedAuthentication(BasicHttpRequest request, AuthenticationToken token, ThreadContext context);
     ...
     * @return ElasticsearchSecurityException with the appropriate headers and message
     */
    ElasticsearchSecurityException exceptionProcessingRequest(BasicHttpRequest request, Exception e, ThreadContext context);
     ...
     * @return ElasticsearchSecurityException with the appropriate headers and message
     */
    ElasticsearchSecurityException missingToken(BasicHttpRequest request, ThreadContext context);

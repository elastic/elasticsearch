...
public final class AuthenticationField {
    ...
    public static final String CROSS_CLUSTER_FC_ID_KEY = "_security_cross_cluster_fc_api_key_id";
    public static final String CROSS_CLUSTER_ROLE_DESCRIPTORS_KEY = "_security_cross_cluster_role_descriptors";

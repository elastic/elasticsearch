...
public final class AuthenticationField {
    ...
    public static final String CROSS_CLUSTER_REALM_TYPE = "_es_cross_cluster";
    ...
    public static final String CROSS_CLUSTER_ID_KEY = "_security_cross_cluster_id";
    ...
    public static final String CROSS_CLUSTER_QC_ROLE_DESCRIPTORS_KEY = "_security_cross_cluster_qc_role_descriptors";
    public static final String CROSS_CLUSTER_FC_ROLE_DESCRIPTORS_KEY = "_security_cross_cluster_fc_role_descriptors";

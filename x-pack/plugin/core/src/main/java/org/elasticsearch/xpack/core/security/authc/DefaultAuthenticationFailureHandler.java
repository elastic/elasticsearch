...
public class DefaultAuthenticationFailureHandler implements AuthenticationFailureHandler {
    ...
    @Override
    public ElasticsearchSecurityException failedAuthentication(BasicHttpRequest request, AuthenticationToken token, ThreadContext context) {
    ...
    @Override
    public ElasticsearchSecurityException exceptionProcessingRequest(BasicHttpRequest request, Exception e, ThreadContext context) {
    ...
    @Override
    public ElasticsearchSecurityException missingToken(BasicHttpRequest request, ThreadContext context) {

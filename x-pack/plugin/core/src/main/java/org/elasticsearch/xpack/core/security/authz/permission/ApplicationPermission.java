...
public final class ApplicationPermission {
     ...
     * </li>
     * <li>The {@link ApplicationPrivilege#initOrGetAutomaton automaton that defines the entry's actions} entirely covers the
    ...
    private static class PermissionEntry {
        ...
        private boolean matchesPrivilege(ApplicationPrivilege other) {
            ...
            if (Operations.isTotal(privilege.initOrGetAutomaton())) {
                return true;
            }
            return Operations.isEmpty(privilege.initOrGetAutomaton()) == false
                && Operations.isEmpty(other.initOrGetAutomaton()) == false
                && Operations.subsetOf(other.initOrGetAutomaton(), privilege.initOrGetAutomaton());
        }

...
public class ClusterPrivilegeResolver {
    ...
    private static final Set<String> ALL_CLUSTER_PATTERN = Set.of("cluster:*", "indices:admin/template/*", "indices:admin/template_v2/*",
    ...
    private static final Set<String> MANAGE_IDX_TEMPLATE_PATTERN = Set.of("indices:admin/template/*", "indices:admin/template_v2/*",
    ...
    public static boolean isClusterAction(String actionName) {
        return actionName.startsWith("cluster:") ||
            ...
            actionName.startsWith("indices:admin/template_v2/");
    }

...
public final class IndexPrivilege extends Privilege {
    ...
    private static final Automaton CREATE_DOCS_AUTOMATON = Automatons.minusAndMinimize(CREATE_AUTOMATON,
    ...
    public static final IndexPrivilege CREATE_DOCS =         new IndexPrivilege("create_docs",         CREATE_DOCS_AUTOMATON);

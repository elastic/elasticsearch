...
public final class SystemPrivilege extends Privilege {
    ...
    private static final Predicate<String> ALLOWED_ACTIONS = StringMatcher.of(
        ...
        RetentionLeaseActions.TransportAddAction.TYPE.name() + "*", // needed for CCR to add retention leases
        RetentionLeaseActions.TransportRemoveAction.TYPE.name() + "*", // needed for CCR to remove retention leases
        RetentionLeaseActions.TransportRenewAction.TYPE.name() + "*", // needed for CCR to renew retention leases

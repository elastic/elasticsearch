    ...
    static RoleDescriptor kibanaSystem(String name) {
        return new RoleDescriptor(
            ...
            new RoleDescriptor.IndicesPrivileges[] {
                ...
                // "Alerting V2" indexes
                RoleDescriptor.IndicesPrivileges.builder().indices(ReservedRolesStore.ALERTING_V2_ALERT_INDEX_ALIAS).privileges("all").build(),
                RoleDescriptor.IndicesPrivileges.builder().indices(ReservedRolesStore.ALERTING_V2_RULE_INDEX_ALIAS).privileges("all").build(),

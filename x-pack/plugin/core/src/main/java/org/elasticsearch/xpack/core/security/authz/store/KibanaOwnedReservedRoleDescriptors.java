    ...
    static RoleDescriptor kibanaSystem(String name) {
        return new RoleDescriptor(
                ...
                new RoleDescriptor.IndicesPrivileges[] {
                        ...
                        // telemetry
                        RoleDescriptor.IndicesPrivileges.builder().indices(".logs-endpoint.diagnostic.collection-*")
                                .privileges("read").build(),
                        ...
                        RoleDescriptor.IndicesPrivileges.builder().indices(ReservedRolesStore.ALERTS_LEGACY_INDEX)
                        ...
                        // aliases (see below).
                        RoleDescriptor.IndicesPrivileges.builder().indices(ReservedRolesStore.ALERTS_BACKING_INDEX)
                                .privileges("all").build(),
                        ...
                        // for such agents.
                        RoleDescriptor.IndicesPrivileges.builder().indices("logs-sentinel_one.*", "logs-crowdstrike.*")
                                .privileges("read").build(),
                        ...
                        RoleDescriptor.IndicesPrivileges.builder()
                                ...
                                .build(),
                        RoleDescriptor.IndicesPrivileges.builder()
                                .indices("security_solution-wiz.vulnerability_latest_*")
                                .privileges(
                                        "create_index",
                                        "read",
                                        "index",

    ...
    static RoleDescriptor kibanaSystem(String name) {
        return new RoleDescriptor(
                ...
                new String[] {
                        ...
                        // manage_inference required for Kibana's inference plugin to setup an ELSER
                        // endpoint.
                        "manage_inference",
                ...
                new RoleDescriptor.IndicesPrivileges[] {
                        ...
                        RoleDescriptor.IndicesPrivileges.builder()
                                ...
                                .build(),
                        RoleDescriptor.IndicesPrivileges.builder().indices(".monitoring-*")
                                .privileges("read", "read_cross_cluster").build(),
                        RoleDescriptor.IndicesPrivileges.builder().indices(".management-beats")
                                .privileges("create_index", "read", "write").build(),
                        // To facilitate ML UI functionality being controlled using Kibana security
                        // privileges
                        RoleDescriptor.IndicesPrivileges.builder().indices(".ml-anomalies*", ".ml-stats-*")
                        ...
                        // indices
                        RoleDescriptor.IndicesPrivileges.builder().indices("metrics-logstash.*").privileges("read")
                                .build(),

                        // Data telemetry reads mappings, metadata and stats of indices
                        RoleDescriptor.IndicesPrivileges.builder().indices("*")
                        ...
                        RoleDescriptor.IndicesPrivileges.builder()
                                ...
                                .allowRestrictedIndices(true)
                                .build(),
                        RoleDescriptor.IndicesPrivileges.builder().indices(".fleet-agents*").privileges("all")
                        ...
                        RoleDescriptor.IndicesPrivileges.builder()
                                ...
                                .allowRestrictedIndices(true)
                                .build(),
                        RoleDescriptor.IndicesPrivileges.builder().indices(".fleet-fileds*").privileges("all")
                                .allowRestrictedIndices(true).build(),
                        // 8.9 BWC
                        RoleDescriptor.IndicesPrivileges.builder()
                                ...
                                .allowRestrictedIndices(true)
                                .build(),
                        RoleDescriptor.IndicesPrivileges.builder().indices(".fleet-files-*").privileges("all")
                                .allowRestrictedIndices(true).build(),
                        RoleDescriptor.IndicesPrivileges.builder()
                        ...
                        RoleDescriptor.IndicesPrivileges.builder().indices("logs-elastic_agent*").privileges("read")
                                .build(),
                        // Fleet publishes Agent metrics in kibana task runner
                        RoleDescriptor.IndicesPrivileges.builder().indices("metrics-fleet_server*").privileges("all")
                                .build(),
                        // Fleet reads output health from this index pattern
                        RoleDescriptor.IndicesPrivileges.builder().indices("logs-fleet_server*")
                                .privileges("read", "delete_index").build(),
                        ...
                        RoleDescriptor.IndicesPrivileges.builder().indices(ReservedRolesStore.ALERTS_INDEX_ALIAS)
                                .privileges("all").build(),
                        // "Alerts as data" public index alias used in Security Solution
                        // Kibana system user uses them to read / write alerts.
                        RoleDescriptor.IndicesPrivileges.builder()
                                .indices(ReservedRolesStore.PREVIEW_ALERTS_INDEX_ALIAS).privileges("all").build(),
                        // "Alerts as data" internal backing indices used in Security Solution
                        // Kibana system user creates these indices; reads / writes to them via the
                        // aliases (see below).
                        RoleDescriptor.IndicesPrivileges.builder()
                                .indices(ReservedRolesStore.PREVIEW_ALERTS_BACKING_INDEX,
                        ...
                        // telemetry
                        RoleDescriptor.IndicesPrivileges.builder().indices("metrics-endpoint.policy-*")
                                .privileges("read").build(),
                        // Endpoint metrics. Kibana requires read access to send telemetry
                        RoleDescriptor.IndicesPrivileges.builder().indices("metrics-endpoint.metrics-*")
                                .privileges("read").build(),
                        // Endpoint events. Kibana reads endpoint alert lineage for building and sending
                        // telemetry
                        RoleDescriptor.IndicesPrivileges.builder().indices("logs-endpoint.events.*").privileges("read")
                                .build(),
                        ...
                        // `create_index`: is necessary in order to ensure that the DOT datastream index
                        // is
                        // created by Kibana in order to avoid errors on the Elastic Defend side when
                        // streaming
                        // documents to it.
                        RoleDescriptor.IndicesPrivileges.builder()
                        ...
                        // for such agents.
                        RoleDescriptor.IndicesPrivileges.builder()
                                .indices("logs-sentinel_one.*", "logs-crowdstrike.*",
                                        "logs-microsoft_defender_endpoint.*", "logs-m365_defender.*")
                                .privileges("read")
                                .build(),
                        ...
                        RoleDescriptor.IndicesPrivileges.builder()
                                ...
                                .build(),
                        // For destination indices of the Cloud Security Posture packages that ships a
                        // transform (specific for scores indexes, as of 9.0.0 score indices will need
                        // to have auto_put priviliges)
                        RoleDescriptor.IndicesPrivileges.builder()
                                ...
                                .build(),
                        // For source indices of the Cloud Detection & Response (CDR) packages that
                        // ships a
                        // transform
                        RoleDescriptor.IndicesPrivileges.builder()
                                .indices(
                                ...
                                .privileges("read", "view_index_metadata")
                                .build(),
                        // For alias indices of the Cloud Detection & Response (CDR) packages that ships
                        // a
                        // transform
                        RoleDescriptor.IndicesPrivileges.builder()
                                ...
                                .privileges("manage", "read", TransportIndicesAliasesAction.NAME,
                                        TransportUpdateSettingsAction.TYPE.name())
                                .build(),
                        // For destination indices of the Cloud Detection & Response (CDR) packages that
                        // ships a
                        // transform
                        RoleDescriptor.IndicesPrivileges.builder()
                                .indices("security_solution-*.vulnerability_latest-*",
                        ...
                        RoleDescriptor.IndicesPrivileges.builder().indices("risk-score.risk-*").privileges("all")
                                .build(),
                        RoleDescriptor.IndicesPrivileges.builder().indices(".entity_analytics.*").privileges("all")
                                .build(),
                        RoleDescriptor.IndicesPrivileges.builder()
                                .indices(".asset-criticality.asset-criticality-*")
                                .privileges("create_index", "manage", "read", "write")
                                .build(),
                        RoleDescriptor.IndicesPrivileges.builder().indices(".entities.v1.latest.security*")
                                .privileges("read").build(),
                        ...
                        RoleDescriptor.IndicesPrivileges.builder().indices(".slo-observability.*").privileges("all")
                                .build(),
                        // Endpoint heartbeat. Kibana reads from these to determine metering/billing for
                        // endpoints.
                        RoleDescriptor.IndicesPrivileges.builder().indices(".logs-endpoint.heartbeat-*")
                                .privileges("read", "create_index").build(),
                        ...
                        RoleDescriptor.IndicesPrivileges.builder().indices(".elastic-connectors*").privileges("read")
                                .build() },
                null,

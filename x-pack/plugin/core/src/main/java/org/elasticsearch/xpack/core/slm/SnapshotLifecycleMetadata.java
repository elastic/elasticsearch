 ...
 */
public class SnapshotLifecycleMetadata implements MetadataSection {
    ...
    public static class SnapshotLifecycleMetadataDiff implements NamedDiff<MetadataSection> {

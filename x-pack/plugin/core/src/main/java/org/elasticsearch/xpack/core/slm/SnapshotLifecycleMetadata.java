 ...
 */
public class SnapshotLifecycleMetadata implements MetadataExtension {
    ...
    public static class SnapshotLifecycleMetadataDiff implements NamedDiff<MetadataExtension> {

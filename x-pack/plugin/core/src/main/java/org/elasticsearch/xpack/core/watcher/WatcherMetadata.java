...
public class WatcherMetadata extends AbstractNamedDiffable<MetadataSection> implements MetadataSection {
    ...
    public static MetadataSection fromXContent(XContentParser parser) throws IOException {

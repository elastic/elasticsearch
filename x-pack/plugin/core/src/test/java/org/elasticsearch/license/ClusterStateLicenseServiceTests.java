...
public class ClusterStateLicenseServiceTests extends ESTestCase {
    ...
    /*
     * The output message depends on the locale data provider used. This test works with the COMPAT locale provider,
     * or the same changes applied from CompatCalendarNameProvider on top of CLDR provider.
     */

...
public class LicenseRegistrationTests extends AbstractClusterStateLicenseServiceTestCase {
    ...
    public void testSelfGeneratedTrialLicense() throws Exception {
        ...
        assertEquals(
            clock.millis() + LicenseServiceInterface.NON_BASIC_SELF_GENERATED_LICENSE_DURATION.millis(),
    ...
    public void testSelfGeneratedBasicLicense() throws Exception {
        ...
        assertEquals(LicenseServiceInterface.BASIC_SELF_GENERATED_LICENSE_EXPIRATION_MILLIS, licenseMetadata.getLicense().expiryDate());
    }

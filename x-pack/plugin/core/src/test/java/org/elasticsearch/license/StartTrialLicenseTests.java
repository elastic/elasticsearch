...
public class StartTrialLicenseTests extends AbstractLicensesIntegrationTestCase {
    ...
    protected Settings nodeSettings(int nodeOrdinal, Settings otherSettings) {
        return Settings.builder()
            ...
            .put(LicenseServiceInterface.SELF_GENERATED_LICENSE_TYPE.getKey(), "basic")
            .build();
    }
    ...
    public void testStartTrial() throws Exception {
        ...
        builder.request().setType(randomFrom(LicenseServiceInterface.VALID_TRIAL_TYPES).getTypeName());
        ...
        License.LicenseType type = randomFrom(LicenseServiceInterface.VALID_TRIAL_TYPES);
        ...
        License.LicenseType secondAttemptType = randomFrom(LicenseServiceInterface.VALID_TRIAL_TYPES);

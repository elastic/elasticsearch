...
public class XPackUsageResponseTests extends ESTestCase {
    ...
    public void testVersionDependentSerializationWriteToOldStream() throws IOException {
        final XPackUsageResponse before = new XPackUsageResponse(Arrays.asList(new OldUsage(), new NewUsage()));
        ...
        final NamedWriteableRegistry registry = new NamedWriteableRegistry(Arrays.asList(

...
public class ColumnarFeatureSetUsageTests extends AbstractWireSerializingTestCase<ColumnarFeatureSetUsage> {

    @Override
    protected Writeable.Reader<ColumnarFeatureSetUsage> instanceReader() {
        return ColumnarFeatureSetUsage::new;
    }

    @Override
    protected ColumnarFeatureSetUsage createTestInstance() {
        return new ColumnarFeatureSetUsage(
            randomBoolean(),
            randomBoolean(),
    ...
    @Override
    protected ColumnarFeatureSetUsage mutateInstance(ColumnarFeatureSetUsage instance) throws IOException {
        ...
        return switch (between(0, 8)) {
            case 0 -> new ColumnarFeatureSetUsage(
                available == false,
                enabled,
                indicesCount,
            ...
            case 1 -> new ColumnarFeatureSetUsage(
                available,
                enabled == false,
                indicesCount,
                indicesWithSyntheticSource,
            ...
            case 2 -> new ColumnarFeatureSetUsage(
                available,
                enabled,
            ...
            case 3 -> new ColumnarFeatureSetUsage(
                available,
                enabled,
                indicesCount,
            ...
            case 4 -> new ColumnarFeatureSetUsage(
                available,
                enabled,
                indicesCount,
                indicesWithSyntheticSource,
            ...
            case 5 -> new ColumnarFeatureSetUsage(
                available,
                enabled,
                indicesCount,
                indicesWithSyntheticSource,
            ...
            case 6 -> new ColumnarFeatureSetUsage(
                available,
                enabled,
                indicesCount,
                indicesWithSyntheticSource,
            ...
            case 7 -> new ColumnarFeatureSetUsage(
                available,
                enabled,
                indicesCount,
                indicesWithSyntheticSource,
            ...
            case 8 -> new ColumnarFeatureSetUsage(
                available,
                enabled,
                indicesCount,
                indicesWithSyntheticSource,
    ...
    public void testGetMinimalSupportedVersion() {
        assertThat(createTestInstance().getMinimalSupportedVersion(), equalTo(TransportVersion.fromName("columnar_usage")));
    }
}

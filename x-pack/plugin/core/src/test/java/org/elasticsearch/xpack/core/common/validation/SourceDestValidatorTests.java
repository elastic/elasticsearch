    ...
    public void testRemoteSourcePlatinum() throws InterruptedException {
        final Context context = spy(
            new SourceDestValidator.Context(
                ...
                new IndexNameExpressionResolver(),
                remoteClusterService,
                new RemoteClusterLicenseChecker(clientWithBasicLicense, XPackLicenseState::isPlatinumPlusOrTrialOperationMode),
                new String[] { REMOTE_BASIC + ":" + "SOURCE_1" },
                "dest",
                "node_id",
                "platinum"
        ...
        final Context context2 = spy(
            new SourceDestValidator.Context(
                ...
                new IndexNameExpressionResolver(),
                remoteClusterService,
                new RemoteClusterLicenseChecker(clientWithPlatinumLicense, XPackLicenseState::isPlatinumPlusOrTrialOperationMode),
        ...
        final Context context4 = spy(
            new SourceDestValidator.Context(
                ...
                new IndexNameExpressionResolver(),
                remoteClusterService,
                new RemoteClusterLicenseChecker(clientWithTrialLicense, XPackLicenseState::isPlatinumPlusOrTrialOperationMode),
                new String[] { REMOTE_PLATINUM + ":" + "SOURCE_1" },
                "dest",
                "node_id",
                "trial"
    ...
    public void testRemoteSourceLicenseInActive() throws InterruptedException {
        final Context context = spy(
            new SourceDestValidator.Context(
                ...
                new IndexNameExpressionResolver(),
                remoteClusterService,
                new RemoteClusterLicenseChecker(clientWithExpiredBasicLicense, XPackLicenseState::isPlatinumPlusOrTrialOperationMode),
                new String[] { REMOTE_BASIC + ":" + "SOURCE_1" },
                "dest",
                "node_id",
                "license"

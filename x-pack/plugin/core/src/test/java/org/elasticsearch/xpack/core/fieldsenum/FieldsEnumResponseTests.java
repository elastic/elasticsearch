...
public class FieldsEnumResponseTests extends AbstractBroadcastResponseTestCase<FieldsEnumResponse> {
    ...
    private static FieldsEnumResponse createRandomTermEnumResponse() {
    ...
    @Override
    protected FieldsEnumResponse doParseInstance(XContentParser parser) throws IOException {
        return FieldsEnumResponse.fromXContent(parser);
    }
    ...
    @Override
    protected void assertEqualInstances(FieldsEnumResponse response, FieldsEnumResponse parsedResponse) {

...
public class CheckNoDataStreamWriteIndexStepTests extends AbstractStepTestCase<CheckNotDataStreamWriteIndexStep> {
        ...
        ClusterState clusterState = ClusterState.builder(emptyClusterState())
            .metadata(
                Metadata.builder()
                    ...
                    .put(new DataStream(dataStreamName, createTimestampField("@timestamp"), Arrays.asList(indexMetadata.getIndex())))
                    .build()
            )
            .build();
    ...
    public void testStepCompleteIfPartOfDataStreamButNotWriteIndex() {
        ...
        List<Index> backingIndices = org.elasticsearch.core.List.of(indexMetadata.getIndex(), writeIndexMetadata.getIndex());
        ClusterState clusterState = ClusterState.builder(emptyClusterState())
            .metadata(
                Metadata.builder()
                    .put(indexMetadata, true)

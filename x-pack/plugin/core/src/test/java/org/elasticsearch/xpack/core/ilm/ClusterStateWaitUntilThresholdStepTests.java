...
public class ClusterStateWaitUntilThresholdStepTests extends AbstractStepTestCase<ClusterStateWaitUntilThresholdStep> {
    ...
    public void testIndexIsMissingReturnsIncompleteResult() {
        ...
        ClusterStateWaitStep.Result result = underTest.isConditionMet(new Index("testName", UUID.randomUUID().toString()),
    ...
    public void testWaitedMoreThanThresholdLevelMath() {
...

        {
            ...
            LifecycleExecutionState executionState =
                new LifecycleExecutionState.Builder().setStepTime(epochMillis - TimeValue.timeValueHours(2).millis()).build();
    ...
    public void testIsCompletableBreaches() {
        IndexMetadata indexMetadata = IndexMetadata.builder("index")
            ...
            .numberOfShards(1)
            .numberOfReplicas(0)
            .putCustom(ILM_CUSTOM_METADATA_KEY, Collections.singletonMap("step_time", String.valueOf(Clock.systemUTC().millis())))
            .build();

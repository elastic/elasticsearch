...
public class GenerateSnapshotNameStepTests extends AbstractStepTestCase<GenerateSnapshotNameStep> {
    ...
    private void testPerformAction(String policyName, String expectedPolicyName) {
        ...
        LifecycleExecutionState executionState = newClusterState.metadata().projectMetadata.index(indexName).getLifecycleExecutionState();
        ...
        LifecycleExecutionState repeatedState = newClusterState.metadata().projectMetadata.index(indexName).getLifecycleExecutionState();

...
public class LifecycleExecutionStateUtilsTests extends ESTestCase {
    ...
    public void testNewClusterStateWithLifecycleState() {
        ...
        IndexMetadata indexMetadata1 = clusterState1.metadata().projectMetadata.index(indexName);
        ...
        IndexMetadata indexMetadata2 = clusterState2.metadata().projectMetadata.index(indexName);

...
public class RollupILMActionTests extends AbstractActionTestCase<RollupILMAction> {
    ...
    public void testToSteps() {
        ...
        assertThat(steps.get(1).getNextStepKey().getName(), equalTo(GenerateUniqueIndexNameStep.NAME));
        assertThat(steps.get(2).getKey().getName(), equalTo(GenerateUniqueIndexNameStep.NAME));

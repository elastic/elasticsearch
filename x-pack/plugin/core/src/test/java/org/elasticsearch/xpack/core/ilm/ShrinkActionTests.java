...
public class ShrinkActionTests extends AbstractActionTestCase<ShrinkAction> {
    ...
    protected ShrinkAction mutateInstance(ShrinkAction action) {
        if (action.getNumberOfShards() != null) {
            ...
            return new ShrinkAction(null, new ByteSizeValue(action.getMaxSinglePrimaryShardSize().getBytes() + 1));
        }
    }
    ...
    public void testMaxSinglePrimaryShardSize() {
        ...
        Exception e2 = expectThrows(Exception.class, () -> new ShrinkAction(null, maxSinglePrimaryShardSize2));

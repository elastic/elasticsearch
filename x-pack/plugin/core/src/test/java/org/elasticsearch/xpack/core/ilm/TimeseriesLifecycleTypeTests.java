...
public class TimeseriesLifecycleTypeTests extends ESTestCase {
    ...
    private static final ShrinkAction TEST_SHRINK_ACTION = new ShrinkAction(1, null, null);
    ...
    public void testValidateActionsFollowingSearchableSnapshot() {
        {
            ...
            Phase warmPhase = new Phase("warm", TimeValue.ZERO, Map.of(ShrinkAction.NAME, new ShrinkAction(1, null, null)));

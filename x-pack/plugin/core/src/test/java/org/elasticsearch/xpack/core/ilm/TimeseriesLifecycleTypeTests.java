    ...
    public void testShouldMigrateDataToTiers() {
        {
            ...
            assertThat(TimeseriesLifecycleType.INSTANCE.shouldMigrateDataToTiers(phase), is(false));
        }

        {
            ...
            Phase phase = new Phase(WARM_PHASE, TimeValue.ZERO, actions);
            assertThat(TimeseriesLifecycleType.INSTANCE.shouldMigrateDataToTiers(phase), is(true));
        }

...
public class TimeseriesLifecycleTypeTests extends ESTestCase {
    ...
    public void testValidateConflictingDataMigrationConfigurations() {
        ...
        List<Phase> phases = org.elasticsearch.core.List.of(
            new Phase(WARM_PHASE, TimeValue.ZERO, actions),
            new Phase(COLD_PHASE, TimeValue.ZERO, actions)
        );
    ...
    public void testValidateActionsFollowingSearchableSnapshot() {
        {
            ...
            Phase coldPhase = new Phase("cold", TimeValue.ZERO, org.elasticsearch.core.Map.of(FreezeAction.NAME, new FreezeAction()));
            IllegalArgumentException e = expectThrows(
                IllegalArgumentException.class,
...

        {
            ...
            Phase frozenPhase = new Phase("frozen", TimeValue.ZERO, org.elasticsearch.core.Map.of(FreezeAction.NAME, new FreezeAction()));
            IllegalArgumentException e = expectThrows(
                IllegalArgumentException.class,
                () -> TimeseriesLifecycleType.validateActionsFollowingSearchableSnapshot(
...

        {
            ...
            IllegalArgumentException e = expectThrows(
                IllegalArgumentException.class,
                () -> TimeseriesLifecycleType.validateActionsFollowingSearchableSnapshot(org.elasticsearch.core.List.of(warm, hot, cold))
            );
            assertThat(
                e.getMessage(),
                is(

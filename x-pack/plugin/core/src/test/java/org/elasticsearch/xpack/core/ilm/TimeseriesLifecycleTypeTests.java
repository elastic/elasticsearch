...
public class TimeseriesLifecycleTypeTests extends ESTestCase {
    ...
    private static final DownsampleAction TEST_DOWNSAMPLE_ACTION = new DownsampleAction(DateHistogramInterval.DAY, TIMEOUT, null);
    ...
    public void testValidateDownsamplingAction() {
        {
            ...
            Phase warmPhase = new Phase(
                "warm",
                TimeValue.ZERO,
                Map.of(DownsampleAction.NAME, new DownsampleAction(DateHistogramInterval.hours(1), TIMEOUT, null))
            );
            Phase coldPhase = new Phase(
                "cold",
                TimeValue.ZERO,
...

        {
            ...
            Phase coldPhase = new Phase(
                "cold",
                TimeValue.ZERO,
                Map.of(DownsampleAction.NAME, new DownsampleAction(DateHistogramInterval.minutes(30), TIMEOUT, null))
            );
...

        {
            ...
            Phase coldPhase = new Phase(
                "cold",
                TimeValue.ZERO,
                Map.of(DownsampleAction.NAME, new DownsampleAction(DateHistogramInterval.minutes(130), TIMEOUT, null))
            );
...

        {
            Phase hotPhase = new Phase(
                ...
                Map.of(
                    ...
                    new DownsampleAction(DateHistogramInterval.minutes(10), TIMEOUT, null)
                )
            );
            Phase warmPhase = new Phase(
                "warm",
            ...
            Phase coldPhase = new Phase(
                "cold",
                TimeValue.ZERO,
                Map.of(DownsampleAction.NAME, new DownsampleAction(DateHistogramInterval.hours(2), TIMEOUT, null))
            );

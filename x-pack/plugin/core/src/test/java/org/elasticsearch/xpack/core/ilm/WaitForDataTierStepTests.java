...
public class WaitForDataTierStepTests extends AbstractStepTestCase<WaitForDataTierStep> {
    ...
    public void testConditionMet() {
        ...
        verify(step, state(org.elasticsearch.common.collect.List.of(notIncludedTier)), false,
            "no nodes for tiers [" + tierPreference + "] available");
        verify(step, state(includedTiers), true, null);
        verify(step, state(org.elasticsearch.common.collect.List.of(DiscoveryNodeRole.DATA_ROLE.roleName())), true, null);
    }

...
public class TextEmbeddingBitResultsTests extends AbstractWireSerializingTestCase<DenseEmbeddingBitResults> {
            ...
            is(
                List.of(
                    new MlTextEmbeddingResults(
                        DenseEmbeddingBitResults.getArrayNameFromTaskName(DenseEmbeddingResults.TEXT_EMBEDDING),
                        new double[] { 23F, 24F },
                        false
                    ),
                    new MlTextEmbeddingResults(

...
public class MlTasksTests extends ESTestCase {
    ...
    public void testGetJobState() {
        ...
        tasksBuilder.addTask(
            ...
            new PersistentTasksMetadataSection.Assignment("bar", "test assignment")
        );
    ...
    public void testStartedDatafeedIds() {
        ...
        tasksBuilder.addTask(
            ...
            new PersistentTasksMetadataSection.Assignment("node-2", "test assignment")
        );
    ...
    public void testUnallocatedJobIds() {
        ...
        tasksBuilder.addTask(
            ...
            new PersistentTasksMetadataSection.Assignment(null, "test assignment")
        );
        tasksBuilder.addTask(
            MlTasks.jobTaskId("job_without_node"),
            MlTasks.JOB_TASK_NAME,
            new OpenJobAction.JobParams("job_without_node"),
            new PersistentTasksMetadataSection.Assignment("dead-node", "expired node")
        );
    ...
    public void testUnallocatedDatafeedIds() {
        ...
        tasksBuilder.addTask(
            ...
            new PersistentTasksMetadataSection.Assignment("dead_node", "expired node")
        );
    ...
    public void testGetDataFrameAnalyticsState_GivenTaskWithNullState() {
        String jobId = "foo";
        PersistentTasksMetadataSection.PersistentTask<?> task = createDataFrameAnalyticsTask(jobId, "test_node", null, false);
    ...
    public void testGetDataFrameAnalyticsState_GivenTaskWithStartedState() {
        String jobId = "foo";
        PersistentTasksMetadataSection.PersistentTask<?> task = createDataFrameAnalyticsTask(
            jobId,
            "test_node",
    ...
    public void testFindMlProcessTasks() {
        ...
        tasksBuilder.addTask(
            ...
            new PersistentTasksMetadataSection.Assignment(randomAlphaOfLength(5), "test")
        );
        tasksBuilder.addTask(
            ...
            new PersistentTasksMetadataSection.Assignment(randomAlphaOfLength(5), "test assignment")
        );
        tasksBuilder.addTask(
        ...
        Set<PersistentTasksMetadataSection.PersistentTask<?>> mlProcessTasks = MlTasks.findMlProcessTasks(tasks);
    ...
    private static PersistentTasksMetadataSection.PersistentTask<?> createDataFrameAnalyticsTask(
        String jobId,
        String nodeId,

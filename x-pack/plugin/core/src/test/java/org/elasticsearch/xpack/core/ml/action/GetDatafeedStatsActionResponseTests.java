...
public class GetDatafeedStatsActionResponseTests extends AbstractWireSerializingTestCase<Response> {
    ...
    public void testDatafeedStatsToXContent() throws IOException {
        ...
        DiscoveryNode node = DiscoveryNodeUtils.create("df-node-name", "df-node-id", transportAddress, attributes, Set.of());
    ...
    public void testCrossClusterStatsRenderedAtTopLevel() throws IOException {
        ...
        Map<String, Object> dfStatsMap = XContentHelper.convertToMap(bytes, randomBoolean(), xContentType).v2();
        assertThat(dfStatsMap, hasKey("remote_cluster_stats"));

        Map<String, Object> cpsMap = (Map<String, Object>) dfStatsMap.get("remote_cluster_stats");
    ...
    public void testCrossClusterStatsAbsentWhenNull() throws IOException {
        ...
        Map<String, Object> dfStatsMap = XContentHelper.convertToMap(bytes, randomBoolean(), xContentType).v2();
        assertFalse(dfStatsMap.containsKey("remote_cluster_stats"));
    }
}

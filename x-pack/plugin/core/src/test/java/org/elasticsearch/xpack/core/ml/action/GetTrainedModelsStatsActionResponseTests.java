                    ...
                    instance.getResources()
                        ...
                        .map(stats -> new Response.TrainedModelStats(
                            ...
                            new AssignmentStats(
                                ...
                                stats.getDeploymentStats().getNodeStats()
                                    .stream()
                                    .map(nodeStats -> new AssignmentStats.NodeStats(
                                        nodeStats.getNode(),

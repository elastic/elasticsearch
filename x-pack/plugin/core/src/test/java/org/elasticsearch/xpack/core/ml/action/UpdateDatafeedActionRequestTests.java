...
public class UpdateDatafeedActionRequestTests extends AbstractXContentSerializingTestCase<Request> {
    ...
    public void testCloudCredentialSurvivesTransportRoundTrip() throws IOException {
        Request request = new Request(DatafeedUpdateTests.createRandomized(datafeedId));

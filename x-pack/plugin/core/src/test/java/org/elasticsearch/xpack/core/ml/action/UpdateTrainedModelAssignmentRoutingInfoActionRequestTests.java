...
import org.elasticsearch.xpack.core.ml.inference.assignment.RoutingInfoTests;
...
public class UpdateTrainedModelAssignmentRoutingInfoActionRequestTests extends AbstractWireSerializingTestCase<Request> {
    ...
    protected Request createTestInstance() {
        return new Request(randomAlphaOfLength(10), randomAlphaOfLength(10), RoutingInfoTests.randomInstance());
    }

...
public class DatafeedUpdateTests extends AbstractSerializingTestCase<DatafeedUpdate> {
    ...
    public static DatafeedUpdate createRandomized(String datafeedId, @Nullable DatafeedConfig datafeed) {
        ...
        if (randomBoolean()) {
            builder.setStopAfterEmptySearchResponses(randomBoolean() ? -1 : randomIntBetween(10, 100));
        }
    ...
    protected DatafeedUpdate mutateInstance(DatafeedUpdate instance) throws IOException {
        ...
        case 10:
            if (instance.getStopAfterEmptySearchResponses() == null) {
                builder.setStopAfterEmptySearchResponses(randomFrom(-1, 10));
            } else {
                builder.setStopAfterEmptySearchResponses(instance.getStopAfterEmptySearchResponses() + 100);
            }
            break;
        default:

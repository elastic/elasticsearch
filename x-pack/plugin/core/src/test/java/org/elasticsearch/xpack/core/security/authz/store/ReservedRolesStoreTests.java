...
public class ReservedRolesStoreTests extends ESTestCase {
    ...
    public void testSnapshotUserRole() {
        ...
        assertThat(
            snapshotUserRole.indices()
                .allowedIndicesMatcher(GetIndexAction.NAME)
                .test(mockIndexAbstraction(RestrictedIndicesNames.ASYNC_SEARCH_PREFIX + randomAlphaOfLengthBetween(0, 2))),
            is(true)
        );
    ...
    public void testRemoteMonitoringCollectorRole() {
        ...
        assertThat(
            remoteMonitoringCollectorRole.indices()
                .allowedIndicesMatcher(UpgradeStatusAction.NAME)
                .test(mockIndexAbstraction(randomFrom(RestrictedIndicesNames.RESTRICTED_NAMES))),
            is(true)
        );
        assertThat(
    ...
    public void testKibanaDashboardOnlyUserRole() {
        ...
        final String randomApplication = "kibana-" + randomAlphaOfLengthBetween(8, 24);
        assertThat(
            dashboardsOnlyUserRole.application().grants(new ApplicationPrivilege(randomApplication, "app-random", "all"), "*"),
            is(false)
        );
        ...
        final String applicationWithRandomIndex = "kibana-.kibana_" + randomAlphaOfLengthBetween(8, 24);
        assertThat(
            dashboardsOnlyUserRole.application()
    ...
    public void testPredefinedViewerRole() {
        ...
        assertThat(
            role.application().grants(new ApplicationPrivilege(kibIndex, "app-reserved_ml_user", "reserved_ml_user"), "*"),
            is(true)
        );
        assertThat(
            role.application().grants(new ApplicationPrivilege(kibIndex, "app-reserved_ml_admin", "reserved_ml_admin"), "*"),
            is(false)
        );
    ...
    public void testPredefinedEditorRole() {
        ...
        assertThat(
            role.application()
                .grants(
                    new ApplicationPrivilege("kibana-" + randomAlphaOfLengthBetween(6, 10), "app-reserved_ml", "reserved_ml_admin"),
                    "*"
                ),
            is(true)
        );

...
public class ReservedRolesStoreTests extends ESTestCase {
    ...
    public void testWatcherAdminRole() {
        ...
        for (String index : new String[]{ Watch.INDEX, HistoryStoreField.DATA_STREAM_NAME, TriggeredWatchStoreField.INDEX_NAME }) {
    ...
    public void testWatcherUserRole() {
        ...
        for (String index : new String[]{ Watch.INDEX, HistoryStoreField.DATA_STREAM_NAME }) {
            assertOnlyReadAllowed(role, index);
        }

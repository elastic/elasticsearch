...
public class ProfileConfigurationsTests extends ESTestCase {
    ...
    public void testGetSecureTransportProfileConfigurations() {
        ...
        assertThat(profileConfigurations.get("full").getVerificationMode(), Matchers.equalTo(VerificationMode.FULL));
        assertThat(profileConfigurations.get("cert").getVerificationMode(), Matchers.equalTo(VerificationMode.CERTIFICATE));
    ...
    public void testGetInsecureTransportProfileConfigurations() {
        ...
        assertThat(profileConfigurations.get("none").getVerificationMode(), Matchers.equalTo(VerificationMode.NONE));
        assertThat(profileConfigurations.get("default"), Matchers.sameInstance(defaultConfig));
    }

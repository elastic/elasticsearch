...
public class TransformConfigUpdateTests extends AbstractWireSerializingTransformTestCase<TransformConfigUpdate> {
    ...
    public void testApply() {
        ...
        SettingsConfig settings = new SettingsConfig(4_000, 4_000.400F, true, true, true, true, 10, true);
    ...
    public void testApplySettings() {
        ...
        TransformConfigUpdate update = new TransformConfigUpdate(
            ...
            null,
            null,
            new SettingsConfig(4_000, null, (Boolean) null, null, null, null, null, null),
            null,
            null
        );
        TransformConfig updatedConfig = update.apply(config);
        ...
        update = new TransformConfigUpdate(
            ...
            null,
            null,
            new SettingsConfig(null, 43.244F, (Boolean) null, null, null, null, null, null),
            null,
            null
        );
        ...
        update = new TransformConfigUpdate(
            ...
            null,
            null,
            new SettingsConfig(-1, null, (Boolean) null, null, null, null, null, null),
            null,
            null
        );
        updatedConfig = update.apply(updatedConfig);
        ...
        update = new TransformConfigUpdate(
            ...
            null,
            null,
            new SettingsConfig(-1, -1F, (Boolean) null, null, null, null, null, null),
            null,
            null
        );
        updatedConfig = update.apply(updatedConfig);

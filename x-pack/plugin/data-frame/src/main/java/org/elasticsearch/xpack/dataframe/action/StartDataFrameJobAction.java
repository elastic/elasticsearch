...
public class StartDataFrameJobAction extends Action<StartDataFrameJobAction.Response> {

    public static final StartDataFrameJobAction INSTANCE = new StartDataFrameJobAction();
    public static final String NAME = "cluster:admin/data_frame/start";

    private StartDataFrameJobAction() {
        super(NAME);
    }
    ...
    public static class RequestBuilder extends ActionRequestBuilder<Request, Response> {
        ...
        protected RequestBuilder(ElasticsearchClient client, StartDataFrameJobAction action) {

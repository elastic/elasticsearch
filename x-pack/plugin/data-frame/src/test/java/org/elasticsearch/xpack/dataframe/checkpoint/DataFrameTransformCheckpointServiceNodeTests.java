...
public class DataFrameTransformCheckpointServiceNodeTests extends DataFrameSingleNodeTestCase {
    ...
    public void testGetCheckpointStats() throws InterruptedException {
        ...
        assertAsync(listener ->
                transformsCheckpointService.getCheckpointStats(transformId, 1, IndexerState.STARTED, position, progress, listener),
        ...
        checkpointInfo = new DataFrameTransformCheckpointingInfo(
                ...
                63L);
        assertAsync(listener ->
                transformsCheckpointService.getCheckpointStats(transformId, 1, IndexerState.INDEXING, position, progress, listener),
            checkpointInfo, null, null);
        ...
        checkpointInfo = new DataFrameTransformCheckpointingInfo(
                ...
                0L);
        assertAsync(listener ->
                transformsCheckpointService.getCheckpointStats(transformId, 1, IndexerState.STOPPING, position, progress, listener),
            checkpointInfo, null, null);
    }

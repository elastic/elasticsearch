...
public class GetDataStreamsTransportActionTests extends ESTestCase {
    ...
    public void testGetDataStream() {
        ...
        List<DataStream> dataStreams = GetDataStreamsTransportAction.getDataStreams(
            cs,
    ...
    public void testGetDataStreamsWithWildcards() {
        ...
        dataStreams = GetDataStreamsTransportAction.getDataStreams(
            cs,
            new IndexNameExpressionResolver(new ThreadContext(Settings.EMPTY)),
            req
        );
    ...
    public void testGetDataStreamsWithoutWildcards() {
        ...
        IndexNotFoundException e = expectThrows(
            ...
            () -> GetDataStreamsTransportAction.getDataStreams(cs, new IndexNameExpressionResolver(new ThreadContext(Settings.EMPTY)), req2)
        );
    ...
    public void testGetNonexistentDataStream() {
        ...
        IndexNotFoundException e = expectThrows(
            IndexNotFoundException.class,
            () -> GetDataStreamsTransportAction.getDataStreams(cs, new IndexNameExpressionResolver(new ThreadContext(Settings.EMPTY)), req)
        );

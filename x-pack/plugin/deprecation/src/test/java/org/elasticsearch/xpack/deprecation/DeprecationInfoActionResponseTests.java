...
public class DeprecationInfoActionResponseTests extends AbstractWireSerializingTestCase<DeprecationInfoAction.Response> {
    ...
    public void testFrom() throws IOException {
        ...
        List<Function<ClusterState, DeprecationIssue>> clusterSettingsChecks = Collections.unmodifiableList(
            Arrays.asList((s) -> clusterIssueFound ? foundIssue : null)
        );
        List<BiFunction<ClusterState, IndexMetadata, DeprecationIssue>> indexSettingsChecks = Collections.unmodifiableList(
            Arrays.asList((cs, idx) -> indexIssueFound ? foundIssue : null)
        );
    ...
    public void testRemoveSkippedSettings() throws IOException {
        ...
        Assert.assertTrue(
            resultIndexSettings.getAsList("some.undeprecated.list.property")

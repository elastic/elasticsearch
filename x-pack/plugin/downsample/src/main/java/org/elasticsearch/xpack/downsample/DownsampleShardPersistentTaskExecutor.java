...
public class DownsampleShardPersistentTaskExecutor extends PersistentTasksExecutor<DownsampleShardTaskParams> {
    ...
    protected AllocatedPersistentTask createTask(
        ...
        final PersistentTasksMetadataSection.PersistentTask<DownsampleShardTaskParams> taskInProgress,
    ...
    public PersistentTasksMetadataSection.Assignment getAssignment(
        ...
        if (indexShardRouting == null) {
            ...
            return new PersistentTasksMetadataSection.Assignment(node.getId(), "a node to fail and stop this persistent task");
        }
        ...
        return candidateNodes.stream()
            ...
            .findAny()
            .map(
                node -> new PersistentTasksMetadataSection.Assignment(
                    node.getId(),

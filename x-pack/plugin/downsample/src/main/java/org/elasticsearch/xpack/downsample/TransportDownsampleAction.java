...
public class TransportDownsampleAction extends AcknowledgedTransportMasterNodeAction<DownsampleAction.Request> {
    ...
    private static void validateDownsamplingConfiguration(
        ...
        if (meta.isEmpty() == false) {
            ...
            if (interval != null) {
                ...
                if (Objects.equals(sourceSamplingMethod, config.getEffectiveSamplingMethod()) == false) {
                    e.addValidationError(
                        "Source index is a downsampled index. Downsampling method ["
                            + config.getEffectiveSamplingMethod()
    ...
    private void createDownsampleIndex(
        ...
        Settings.Builder builder = Settings.builder()
            ...
            .put(IndexMetadata.INDEX_DOWNSAMPLE_METHOD.getKey(), request.getDownsampleConfig().getEffectiveSamplingMethod().toString())

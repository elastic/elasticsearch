...
public class EnrichPlugin extends Plugin implements SystemIndexPlugin, IngestPlugin {
    ...
    public List<NamedWriteableRegistry.Entry> getNamedWriteables() {
        return List.of(
            new NamedWriteableRegistry.Entry(ProjectMetadata.ProjectCustom.class, EnrichMetadata.TYPE, EnrichMetadata::new),
            new NamedWriteableRegistry.Entry(
                NamedDiff.class,
                EnrichMetadata.TYPE,
                in -> EnrichMetadata.readDiffFrom(ProjectMetadata.ProjectCustom.class, EnrichMetadata.TYPE, in)
            )
        );
    }
    ...
    public List<NamedXContentRegistry.Entry> getNamedXContent() {
        return List.of(
            new NamedXContentRegistry.Entry(
                ...
                new ParseField(EnrichMetadata.TYPE),

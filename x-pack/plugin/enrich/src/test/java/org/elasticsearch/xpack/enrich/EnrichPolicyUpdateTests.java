...
public class EnrichPolicyUpdateTests extends ESSingleNodeTestCase {
    ...
    public void testUpdatePolicyOnly() {
        ...
        EnrichPolicy instance1 = new EnrichPolicy(EnrichPolicy.MATCH_TYPE, null, List.of("index"), "key1", List.of("field1"), null);
        ...
        EnrichPolicy instance2 = new EnrichPolicy(EnrichPolicy.MATCH_TYPE, null, List.of("index2"), "key2", List.of("field2"), null);

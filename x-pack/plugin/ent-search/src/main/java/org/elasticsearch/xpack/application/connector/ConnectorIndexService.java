...
public class ConnectorIndexService {
     ...
     */
    public void putConnector(PutConnectorAction.Request request, ActionListener<DocWriteResponse> listener) {
     ...
     * @param listener  The action listener to invoke on response/failure.
     */
    public void postConnector(PostConnectorAction.Request request, ActionListener<PostConnectorAction.Response> listener) {

...
public class TransportPutConnectorAction extends TransportAction<PutConnectorAction.Request, ConnectorCreateActionResponse> {
    ...
    public TransportPutConnectorAction(TransportService transportService, ActionFilters actionFilters, Client client) {
        super(PutConnectorAction.NAME, actionFilters, transportService.getTaskManager(), EsExecutors.DIRECT_EXECUTOR_SERVICE);

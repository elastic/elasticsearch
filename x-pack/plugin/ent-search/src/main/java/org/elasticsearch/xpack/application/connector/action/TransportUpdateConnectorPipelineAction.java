...
public class TransportUpdateConnectorPipelineAction extends HandledTransportAction<
    ...
    @Override
    protected void doExecute(Task task, UpdateConnectorPipelineAction.Request request, ActionListener<ActionResponse.Empty> listener) {
        connectorIndexService.updateConnectorPipeline(request, listener.map(r -> ActionResponse.Empty.INSTANCE));
    }
}

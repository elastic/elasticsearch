...
public class TransportUpdateConnectorPipelineAction extends TransportAction<
    ...
    public TransportUpdateConnectorPipelineAction(TransportService transportService, ActionFilters actionFilters, Client client) {
        super(UpdateConnectorPipelineAction.NAME, actionFilters, transportService.getTaskManager(), EsExecutors.DIRECT_EXECUTOR_SERVICE);

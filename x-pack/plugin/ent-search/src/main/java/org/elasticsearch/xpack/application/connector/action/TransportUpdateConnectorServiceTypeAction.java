...
public class TransportUpdateConnectorServiceTypeAction extends TransportAction<
    ...
    public TransportUpdateConnectorServiceTypeAction(TransportService transportService, ActionFilters actionFilters, Client client) {
        super(UpdateConnectorServiceTypeAction.NAME, actionFilters, transportService.getTaskManager(), EsExecutors.DIRECT_EXECUTOR_SERVICE);

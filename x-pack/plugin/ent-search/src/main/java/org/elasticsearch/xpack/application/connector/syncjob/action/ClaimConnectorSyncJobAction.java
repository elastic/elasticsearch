...
public class ClaimConnectorSyncJobAction {
    ...
    public static class Request extends ConnectorSyncJobActionRequest implements ToXContentObject {
        ...
        public static Request fromXContentBytes(String connectorSyncJobId, BytesReference source, XContentType xContentType) {
            try (XContentParser parser = XContentHelper.createParser(XContentParserConfiguration.EMPTY, source, xContentType)) {
                return fromXContent(parser, connectorSyncJobId);
            } catch (IOException e) {
                throw new ElasticsearchParseException("Failed to parse request" + source.utf8ToString());
            }
        }

...
public class TransportGetQueryRulesetAction extends HandledTransportAction<
    GetQueryRulesetAction.Request,
    GetQueryRulesetAction.Response> {
    ...
    protected void doExecute(
        Task task,
        GetQueryRulesetAction.Request request,
        ActionListener<GetQueryRulesetAction.Response> listener
    ) {

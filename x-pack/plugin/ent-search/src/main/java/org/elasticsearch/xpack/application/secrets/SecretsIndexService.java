...
public class SecretsIndexService {
    ...
    public static final String SEARCH_SECRETS_INDEX_NAME = ".search-secrets";
    ...
    public static SystemIndexDescriptor getSystemIndexDescriptor() {
        ...
        return SystemIndexDescriptor.builder()
            .setIndexPattern(SEARCH_SECRETS_INDEX_NAME + "*")
            .setPrimaryIndex(SEARCH_SECRETS_INDEX_NAME + "-" + CURRENT_INDEX_VERSION)
            .setDescription("Secret values managed by Search")
            .setMappings(request.mappings())
            .setSettings(request.settings())
            .setAliasName(SEARCH_SECRETS_INDEX_NAME)

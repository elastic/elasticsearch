...
package org.elasticsearch.xpack.entsearch.utils;
...
public final class LicenseUtils {
    ...
    public static ElasticsearchSecurityException newComplianceException(XPackLicenseState licenseState) {
        ...
        ElasticsearchSecurityException e = new ElasticsearchSecurityException(
            "Current license is non-compliant for engines and behavioral analytics. Current license is {}. "
                + "Engines and behavioral analytics require an active trial, platinum or enterprise license.",

...
public class HybridRetrieverBuilder extends RetrieverBuilderWrapper<HybridRetrieverBuilder> {
    ...
    private HybridRetrieverBuilder(List<String> fields, String query, RetrieverBuilder retrieverBuilder) {
    ...
    protected HybridRetrieverBuilder clone(RetrieverBuilder sub) {
        assert sub instanceof LinearRetrieverBuilder;
        return new HybridRetrieverBuilder(fields, query, sub);
    }

...
public class RestUpdateConnectorApiKeyIdActionTests extends ESTestCase {

    private RestUpdateConnectorApiKeyIdAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorApiKeyIdAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/123/_api_key_id")
            .build();

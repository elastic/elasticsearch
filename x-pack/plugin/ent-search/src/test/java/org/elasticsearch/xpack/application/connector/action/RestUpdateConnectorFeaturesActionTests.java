...
public class RestUpdateConnectorFeaturesActionTests extends ESTestCase {

    private RestUpdateConnectorFeaturesAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorFeaturesAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/123/_features")
            .build();

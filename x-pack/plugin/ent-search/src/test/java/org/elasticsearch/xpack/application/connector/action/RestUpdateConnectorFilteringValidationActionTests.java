...
public class RestUpdateConnectorFilteringValidationActionTests extends ESTestCase {

    private RestUpdateConnectorFilteringValidationAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorFilteringValidationAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/123/_filtering/_validation")
            .build();

...
public class RestUpdateConnectorLastSyncStatsActionTests extends ESTestCase {

    private RestUpdateConnectorLastSyncStatsAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorLastSyncStatsAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/123/_last_sync")
            .build();

...
public class RestUpdateConnectorNativeActionTests extends ESTestCase {

    private RestUpdateConnectorNativeAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorNativeAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/123/_native")
            .build();

...
public class RestUpdateConnectorPipelineActionTests extends ESTestCase {

    private RestUpdateConnectorPipelineAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorPipelineAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/123/_pipeline")
            .build();

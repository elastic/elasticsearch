...
public class RestUpdateConnectorSchedulingActionTests extends ESTestCase {

    private RestUpdateConnectorSchedulingAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorSchedulingAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/123/_scheduling")
            .build();

...
public class RestUpdateConnectorServiceTypeActionTests extends ESTestCase {

    private RestUpdateConnectorServiceTypeAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorServiceTypeAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/123/_service_type")
            .build();

...
public class TransportDeleteConnectorSecretActionTests extends ESSingleNodeTestCase {

    private static final Long TIMEOUT_SECONDS = 10L;

    private final ThreadPool threadPool = new TestThreadPool(getClass().getName());
    private TransportDeleteConnectorSecretAction action;
    ...
    public void testDeleteConnectorSecret_ExpectNoWarnings() throws InterruptedException {
    ...
    private void executeRequest(DeleteConnectorSecretRequest request) throws InterruptedException {

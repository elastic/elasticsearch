...
public class RestClaimConnectorSyncJobActionTests extends ESTestCase {

    private RestClaimConnectorSyncJobAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestClaimConnectorSyncJobAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/_sync_job/456/_claim")
            .build();

...
public class RestUpdateConnectorSyncJobErrorActionTests extends ESTestCase {

    private RestUpdateConnectorSyncJobErrorAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorSyncJobErrorAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/_sync_job/456/_error")
            .build();

...
public class RestUpdateConnectorSyncJobIngestionStatsActionTests extends ESTestCase {

    private RestUpdateConnectorSyncJobIngestionStatsAction action;

    @Override
    public void setUp() throws Exception {
        super.setUp();
        action = new RestUpdateConnectorSyncJobIngestionStatsAction();
    }
    ...
    public void testPrepareRequest_emptyPayload_badRequestError() {
        RestRequest request = new FakeRestRequest.Builder(xContentRegistry()).withMethod(RestRequest.Method.PUT)
            .withPath("/_connector/_sync_job/456/_stats")
            .build();

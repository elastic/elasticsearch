...
public class TransportCheckInConnectorSyncJobActionTests extends ESSingleNodeTestCase {
    private static final Long TIMEOUT_SECONDS = 10L;

    private final ThreadPool threadPool = new TestThreadPool(getClass().getName());
    private TransportCheckInConnectorSyncJobAction action;
    ...
    public void testCheckInConnectorSyncJob_ExpectNoWarnings() throws InterruptedException {
    ...
    private void executeRequest(CheckInConnectorSyncJobAction.Request request) throws InterruptedException {
        ...
        assertTrue("Timeout waiting for checkin request", requestTimedOut);
    }
}

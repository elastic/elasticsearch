...
public class TransportDeleteConnectorSyncJobActionTests extends ESSingleNodeTestCase {

    private static final Long TIMEOUT_SECONDS = 10L;

    private final ThreadPool threadPool = new TestThreadPool(getClass().getName());
    private TransportDeleteConnectorSyncJobAction action;
    ...
    public void testDeleteConnectorSyncJob_ExpectNoWarnings() throws InterruptedException {
    ...
    private void executeRequest(DeleteConnectorSyncJobAction.Request request) throws InterruptedException {
        ...
        assertTrue("Timeout waiting for delete request", requestTimedOut);
    }

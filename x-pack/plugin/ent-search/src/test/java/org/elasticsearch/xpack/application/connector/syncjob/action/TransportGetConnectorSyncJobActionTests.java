...
public class TransportGetConnectorSyncJobActionTests extends ESSingleNodeTestCase {

    private static final Long TIMEOUT_SECONDS = 10L;

    private final ThreadPool threadPool = new TestThreadPool(getClass().getName());
    private TransportGetConnectorSyncJobAction action;
    ...
    public void setup() {
        ...
        action = new TransportGetConnectorSyncJobAction(transportService, clusterService, mock(ActionFilters.class), client());
    }
    ...
    public void testGetConnectorSyncJob_ExpectNoWarnings() throws InterruptedException {
    ...
    private void executeRequest(GetConnectorSyncJobAction.Request request) throws InterruptedException {

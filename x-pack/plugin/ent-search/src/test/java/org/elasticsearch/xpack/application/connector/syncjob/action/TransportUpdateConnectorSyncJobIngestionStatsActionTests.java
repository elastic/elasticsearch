...
public class TransportUpdateConnectorSyncJobIngestionStatsActionTests extends ESSingleNodeTestCase {
    private static final Long TIMEOUT_SECONDS = 10L;

    private final ThreadPool threadPool = new TestThreadPool(getClass().getName());
    private TransportUpdateConnectorSyncJobIngestionStatsAction action;
    ...
    public void testUpdateConnectorSyncJobIngestionStatsAction_ExpectNoWarnings() throws InterruptedException {
    ...
    private void executeRequest(UpdateConnectorSyncJobIngestionStatsAction.Request request) throws InterruptedException {

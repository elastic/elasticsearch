...
public class QueryRuleCriteriaTests extends ESTestCase {
    ...
    public void testExactMatch() {
        ...
        assertTrue(queryRuleCriteria.isMatch(analysisService, "elastic", type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, "elasticc", type));

        queryRuleCriteria = new QueryRuleCriteria(type, "zip_code", List.of("12345"));
        assertTrue(queryRuleCriteria.isMatch(analysisService, 12345, type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "12345", type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, "123456", type));
    }
    ...
    public void testFuzzyExactMatch() {
        ...
        QueryRuleCriteria queryRuleCriteria = new QueryRuleCriteria(type, "query", List.of("elastic"));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "elastic", type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "elasticc", type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, "elastic elastic elastic elastic", type));
    }
    ...
    public void testPrefixMatch() {
        ...
        assertTrue(queryRuleCriteria.isMatch(analysisService, "elastic", type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "kibana", type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "elastic is a great search engine", type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "kibana is a great visualization tool", type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, "you know, for search - elastic, kibana", type));
    }
    ...
    public void testSuffixMatch() {
        ...
        assertTrue(queryRuleCriteria.isMatch(analysisService, "search", type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "lucene", type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "you know, for search", type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "elasticsearch is built on top of lucene", type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, "search is a good use case for elastic", type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, "lucene and elastic are open source", type));
    }
    ...
    public void testContainsMatch() {
        ...
        QueryRuleCriteria queryRuleCriteria = new QueryRuleCriteria(type, "query", List.of("elastic"));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "elastic", type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, "I use elastic for search", type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, "you know, for search", type));
    }
    ...
    public void testLtMatch() {
        ...
        assertTrue(queryRuleCriteria.isMatch(analysisService, 5, type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, 10, type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, 20, type));
    }
    ...
    public void testLteMatch() {
        ...
        QueryRuleCriteria queryRuleCriteria = new QueryRuleCriteria(type, "age", List.of("10"));
        assertTrue(queryRuleCriteria.isMatch(analysisService, 5, type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, 10, type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, 20, type));
    }
    ...
    public void testGtMatch() {
        ...
        QueryRuleCriteria queryRuleCriteria = new QueryRuleCriteria(type, "age", List.of("10"));
        assertTrue(queryRuleCriteria.isMatch(analysisService, 20, type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, 10, type));
        assertFalse(queryRuleCriteria.isMatch(analysisService, 5, type));
    }
    ...
    public void testAlwaysMatch() {
        ...
        assertTrue(queryRuleCriteria.isMatch(analysisService, "elastic", type));
        assertTrue(queryRuleCriteria.isMatch(analysisService, 42, type));
    }
    ...
    public void testInvalidCriteriaInput() {
        for (QueryRuleCriteriaType type : List.of(FUZZY, PREFIX, SUFFIX, CONTAINS)) {
            ...
            expectThrows(IllegalArgumentException.class, () -> queryRuleCriteria.isMatch(analysisService, 42, type));
        }
        ...
        for (QueryRuleCriteriaType type : List.of(LT, LTE, GT, GTE)) {
            ...
            expectThrows(IllegalArgumentException.class, () -> queryRuleCriteria.isMatch(analysisService, "puggles", type));
        }
    }

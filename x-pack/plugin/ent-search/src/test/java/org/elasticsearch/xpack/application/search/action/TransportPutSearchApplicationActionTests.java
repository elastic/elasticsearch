...
public class TransportPutSearchApplicationActionTests extends ESTestCase {
    public void testWithUnsupportedLicense() {
        ...
        final AtomicReference<PutSearchApplicationAction.Response> responseRef = new AtomicReference<>();

        transportAction.doExecute(mock(Task.class), request, new ActionListener<>() {
            @Override
            public void onResponse(PutSearchApplicationAction.Response response) {

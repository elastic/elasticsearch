...
public abstract class EqlSpecTestCase extends BaseEqlSpecTestCase {
    ...
    public EqlSpecTestCase(String query, String name, long[] eventIds, String[] joinKeys, Integer size) {
        this(TEST_INDEX, query, name, eventIds, joinKeys, size);
    }

    // constructor for multi-cluster tests
    public EqlSpecTestCase(String index, String query, String name, long[] eventIds, String[] joinKeys, Integer size) {

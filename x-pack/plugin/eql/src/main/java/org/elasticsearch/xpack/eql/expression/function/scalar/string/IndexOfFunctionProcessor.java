...
public class IndexOfFunctionProcessor implements Processor {
    ...
    public IndexOfFunctionProcessor(Processor input, Processor substring, Processor start) {
        this.input = input;
    ...
    public Object process(Object o) {
        return doProcess(input.process(o), substring.process(o), start.process(o));
    }

    public static Object doProcess(Object input, Object substring, Object start) {
        if (input == null) {
            return null;
        }
        ...
        int result = input.toString().toLowerCase(Locale.ROOT).indexOf(substring.toString().toLowerCase(Locale.ROOT), startIndex);

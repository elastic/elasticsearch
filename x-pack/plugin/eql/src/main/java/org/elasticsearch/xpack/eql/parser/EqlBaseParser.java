...
class EqlBaseParser extends Parser {
    ...
    public static final int AND = 1, ANY = 2, BY = 3, FALSE = 4, IN = 5, IN_INSENSITIVE = 6, JOIN = 7, LIKE = 8, LIKE_INSENSITIVE = 9,
        ...
        ASTERISK = 32, SLASH = 33, PERCENT = 34, DOT = 35, COMMA = 36, LB = 37, RB = 38, LP = 39, RP = 40, PIPE = 41, STRING = 42,
        INTEGER_VALUE = 43, DECIMAL_VALUE = 44, IDENTIFIER = 45, QUOTED_IDENTIFIER = 46, TILDE_IDENTIFIER = 47, LINE_COMMENT = 48,
        BRACKETED_COMMENT = 49, WS = 50;
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                if ((((_la) & ~0x3f) == 0
                    && ((1L << _la) & ((1L << FALSE) | (1L << NOT) | (1L << NULL) | (1L << TRUE) | (1L << PLUS) | (1L << MINUS) | (1L << LP)
                        | (1L << STRING) | (1L << INTEGER_VALUE) | (1L << DECIMAL_VALUE) | (1L << IDENTIFIER) | (1L << QUOTED_IDENTIFIER)
                        | (1L << TILDE_IDENTIFIER))) != 0)) {
                    {
                        setState(121);
                        booleanExpression(0);
                        setState(126);
    ...
    public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\64\u013a\4\2\t\2"

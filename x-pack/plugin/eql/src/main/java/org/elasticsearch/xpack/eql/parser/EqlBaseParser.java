...
class EqlBaseParser extends Parser {
  ...
  public static final int
    ...
    SAMPLE=17, SEQUENCE=18, TRUE=19, UNTIL=20, WHERE=21, WITH=22, SEQ=23, 
    ...
    RP=41, PIPE=42, OPTIONAL=43, MISSING_EVENT_OPEN=44, STRING=45, INTEGER_VALUE=46, 
    DECIMAL_VALUE=47, IDENTIFIER=48, QUOTED_IDENTIFIER=49, TILDE_IDENTIFIER=50, 
    LINE_COMMENT=51, BRACKETED_COMMENT=52, WS=53;
  public static final int
    RULE_singleStatement = 0, RULE_singleExpression = 1, RULE_statement = 2, 
    RULE_query = 3, RULE_sequenceParams = 4, RULE_sequence = 5, RULE_sample = 6, 
    RULE_join = 7, RULE_pipe = 8, RULE_joinKeys = 9, RULE_joinTerm = 10, RULE_sequenceTerm = 11, 
    RULE_subquery = 12, RULE_eventQuery = 13, RULE_eventFilter = 14, RULE_expression = 15, 
    RULE_booleanExpression = 16, RULE_valueExpression = 17, RULE_operatorExpression = 18, 
    RULE_predicate = 19, RULE_primaryExpression = 20, RULE_functionExpression = 21, 
    RULE_functionName = 22, RULE_constant = 23, RULE_comparisonOperator = 24, 
  ...
  private static String[] makeSymbolicNames() {
    return new String[] {
      ...
      "MISSING_EVENT_OPEN", "STRING", "INTEGER_VALUE", "DECIMAL_VALUE", "IDENTIFIER", 
      "QUOTED_IDENTIFIER", "TILDE_IDENTIFIER", "LINE_COMMENT", "BRACKETED_COMMENT", 
      "WS"
    };
  }
  ...
  public static class SampleContext extends ParserRuleContext {
    public JoinKeysContext by;
    public TerminalNode SAMPLE() { return getToken(EqlBaseParser.SAMPLE, 0); }
  ...
  public static class SubqueryContext extends ParserRuleContext {
    ...
    public TerminalNode MISSING_EVENT_OPEN() { return getToken(EqlBaseParser.MISSING_EVENT_OPEN, 0); }

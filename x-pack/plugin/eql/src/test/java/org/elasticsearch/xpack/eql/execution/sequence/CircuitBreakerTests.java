...
public class CircuitBreakerTests extends ESTestCase {
    ...
    public void testCircuitBreakerTumblingWindow() {
        ...
        TumblingWindow window = new TumblingWindow(client, criteria, null, matcher, Collections.emptyList(), randomBoolean());
    ...
    private void assertMemoryCleared(
        ...
        try (
            ...
            TumblingWindow window = new TumblingWindow(eqlClient, criteria, null, matcher, Collections.emptyList(), randomBoolean());

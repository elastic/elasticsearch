...
public class UnresolvedAttribute extends Attribute implements Unresolvable {
    ...
    public int nonSemanticHashCode() {
        return Objects.hash(super.nonSemanticHashCode(), resolutionMetadata, unresolvedMsg);
    }

    /**
     * Note that the {@link #id()} is respected here. Two unresolved attributes with the same name but different
    ...
    protected boolean nonSemanticEquals(Attribute o) {
        ...
        return super.nonSemanticEquals(other)

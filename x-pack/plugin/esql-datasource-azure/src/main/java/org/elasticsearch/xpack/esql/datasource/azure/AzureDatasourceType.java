...
/** Datasource type descriptor for Azure Blob Storage. */
public class AzureDatasourceType implements DatasourceType {

    public static final AzureDatasourceType INSTANCE = new AzureDatasourceType();
    static final Set<String> VALID_SCHEMES = Set.of("wasbs://", "wasb://");
    ...
    public Map<String, SettingValue> validateDatasource(Map<String, Object> settings) {
        AzureConfiguration config = AzureConfiguration.fromMap(settings);

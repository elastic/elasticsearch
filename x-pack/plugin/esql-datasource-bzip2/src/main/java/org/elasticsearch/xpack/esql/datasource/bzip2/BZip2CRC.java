 ...
 * 2.0.
 *
 * Adapted from Apache Hadoop's CRC (Apache License 2.0).
 * Original: github.com/apache/hadoop - hadoop-common - bzip2/CRC.java
 */
...
final class BZip2CRC {
    ...
    void updateCRC(int inCh) {
        ...
        globalCrc = (globalCrc << 8) ^ BZip2CRC.crc32Table[temp];
    }

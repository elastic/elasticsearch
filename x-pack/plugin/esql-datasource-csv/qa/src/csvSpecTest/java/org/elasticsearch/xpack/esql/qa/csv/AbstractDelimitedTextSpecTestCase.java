 ...
 * ({@link CsvFormatSpecIT}, {@link CsvCompressedFormatSpecIT}, {@link TsvFormatSpecIT},
 * {@link TsvCompressedFormatSpecIT}) inherit the same static {@code cluster} field and therefore
 * share a single {@code ElasticsearchCluster} instance across the entire JVM run. This mirrors
 * the pattern used in {@code AbstractParquetExternalSpecTestCase} and lets the JVM-level

...
public class CsvFormatSpecIT extends AbstractCsvExternalSpecTestCase {
    ...
    // employees twin) and multi-value coverage in csv-multivalue.csv-spec. external-heavy-aggregates and
    // external-fork are the exceptions: they use only the bracket-free employees_no_mv twin, so they parse
    // under CSV too.

 ...
 * and only when — {@link ExternalRowCountCache} has an entry for the file. This is the lookup half
 * of B'; the execution-side cache write (the capture hook) is a follow-up.
 */

...
// DISABLED. Fails with the following error, despite being almost identical to datasource-csv tests that run successfully:

//   Not entitled:
//     component [esql-datasource-iceberg],
//     module [ALL-UNNAMED],
//     class [class software.amazon.awssdk.profiles.ProfileFileLocation],
//     entitlement [file],
//     operation [read],
//     path [/dev/null/aws/credentials]
//  org.elasticsearch.entitlement.bridge.NotEntitledException:
//    component [esql-datasource-iceberg],
//    module [ALL-UNNAMED],
//    class [class software.amazon.awssdk.profiles.ProfileFileLocation],
//    entitlement [file],

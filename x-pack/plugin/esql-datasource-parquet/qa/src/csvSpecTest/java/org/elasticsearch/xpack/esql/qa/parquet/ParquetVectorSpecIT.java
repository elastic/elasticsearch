...
/**
 * Generated-vector suite for parquet. Configuration comes from the declaration, not from this file: the
...
public class ParquetVectorSpecIT extends AbstractParquetExternalSpecTestCase {

    private final Map<String, String> vector;
    private final Map<String, String> vectorSettings;

    public ParquetVectorSpecIT(
        String fileName,
        String groupName,
        String testName,
        Integer lineNumber,
    ...
    public static List<Object[]> readScriptSpec() throws Exception {
        return readExternalSpecTestsWithVectorsForSuite("parquet", "parquet-vector");
    }
}

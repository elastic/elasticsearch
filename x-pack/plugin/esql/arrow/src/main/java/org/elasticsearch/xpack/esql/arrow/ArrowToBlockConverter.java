...
public interface ArrowToBlockConverter {
    ...
    Map<Types.MinorType, ArrowToBlockConverter> CONVERTERS = buildConverters();
    ...
    private static Map<Types.MinorType, ArrowToBlockConverter> buildConverters() {
        ...
        map.put(Types.MinorType.TIMESTAMPSEC, Timestamp1kArrowBufBlock::of);
        map.put(Types.MinorType.TIMESTAMPSECTZ, Timestamp1kArrowBufBlock::of);
        map.put(Types.MinorType.TIMESTAMPMILLI, LongArrowBufBlock::of);
        map.put(Types.MinorType.TIMESTAMPMILLITZ, LongArrowBufBlock::of);
        map.put(Types.MinorType.TIMESTAMPMICRO, Timestamp1kArrowBufBlock::of);
        map.put(Types.MinorType.TIMESTAMPMICROTZ, Timestamp1kArrowBufBlock::of);

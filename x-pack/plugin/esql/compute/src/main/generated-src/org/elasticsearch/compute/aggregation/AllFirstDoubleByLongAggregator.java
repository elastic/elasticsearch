...
public class AllFirstDoubleByLongAggregator {
    public static String describe() {
        return "all_first_double_by_long";
    }
    ...
    public static void combine(AllLongDoubleState current, @Position int position, DoubleBlock values, LongBlock timestamps) {
    ...
    public static void combine(GroupingState current, int group, @Position int position, DoubleBlock values, LongBlock timestamps) {

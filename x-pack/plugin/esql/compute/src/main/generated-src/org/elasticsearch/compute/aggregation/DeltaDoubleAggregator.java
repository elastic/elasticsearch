 ...
 */
@GroupingAggregator(
    value = { @IntermediateState(name = "samples", type = "LONG_BLOCK"), @IntermediateState(name = "timestamps", type = "LONG_BLOCK"), @IntermediateState(name = "values", type = "DOUBLE_BLOCK") }
)

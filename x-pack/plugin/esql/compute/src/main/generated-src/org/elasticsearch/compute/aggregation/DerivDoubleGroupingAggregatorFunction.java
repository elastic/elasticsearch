...
public class DerivDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
    ...
    public DerivDoubleGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext) {
    ...
    public static class Supplier implements AggregatorFunctionSupplier {
        ...
        public GroupingAggregatorFunction groupingAggregator(DriverContext driverContext, List<Integer> channels) {
            return new DerivDoubleGroupingAggregatorFunction(channels, driverContext);
        }
        ...
        try (
            ...
            for (int p = 0; p < positionCount; p++) {
                ...
                if (state == null) {
                    ...
                    sumValBuilder.appendDouble((double) state.sumVal);
                    sumTsBuilder.appendLong(state.sumTs);
                    sumTsValBuilder.appendDouble((double) state.sumTsVal); // TODO: fix this actually

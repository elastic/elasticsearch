 ...
 * </p>
 */
public final class DoubleArrayState extends AbstractArrayState implements GroupingAggregatorState {
    private final double init;

    private DoubleArray values;

    public DoubleArrayState(BigArrays bigArrays, double init) {
        super(bigArrays);

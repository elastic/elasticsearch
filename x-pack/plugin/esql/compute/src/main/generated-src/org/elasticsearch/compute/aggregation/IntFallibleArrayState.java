 ...
 * </p>
 */
public final class IntFallibleArrayState extends AbstractFallibleArrayState implements GroupingAggregatorState {
    private final int init;

    private IntArray values;

    public IntFallibleArrayState(BigArrays bigArrays, int init) {
        super(bigArrays);

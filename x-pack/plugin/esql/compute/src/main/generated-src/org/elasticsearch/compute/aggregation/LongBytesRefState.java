 ...
 */
public final class LongBytesRefState implements AggregatorState {
    private long v1;
    private final BreakingBytesRefBuilder v2;
    private boolean seen;

    public LongBytesRefState(long v1, BytesRef v2, CircuitBreaker breaker, String label) {
        this.v1 = v1;

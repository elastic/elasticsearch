    ...
    private final class ValuesList implements Releasable {
        ...
        ValuesList(long capacity) {
            if (capacity > 0) {
                ...
                this.values = bigArrays.newDoubleArray(capacity, false);
            }
        }
        ...
        private void increaseCapacity() {
            if (timestamps == null) {
                ...
                this.values = bigArrays.newDoubleArray(INITIAL_CAPACITY, false);
            } else {
        ...
        public void set(long index, long timestamp, double value) {
            assert index < size;
    ...
    private final class GroupedValuesList implements Releasable {
        ...
        ReducedState flushGroup(int group, ReducedState state) {
            ...
            if (numValues == 1) {
                ...
                double v = values.getValue(groupStart);

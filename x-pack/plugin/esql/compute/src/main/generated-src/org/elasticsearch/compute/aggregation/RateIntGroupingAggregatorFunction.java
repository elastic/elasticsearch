...
public final class RateIntGroupingAggregatorFunction extends AbstractRateGroupingFunction implements GroupingAggregatorFunction {
            ...
            for (int p = 0; p < positionCount; p++) {
                ...
                if (state != null && state.samples > 0) {
                    ...
                    for (Interval interval : state.intervals) {
                        ...
                        values.appendInt(interval.lastV);
                        values.appendInt(interval.firstV);
                    }
    ...
    record Interval(long lastTs, int lastV, long firstTs, int firstV) implements Comparable<Interval> {
        @Override

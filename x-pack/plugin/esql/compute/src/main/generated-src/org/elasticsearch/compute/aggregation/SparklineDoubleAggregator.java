...
import org.elasticsearch.compute.data.sort.TupleLongDoubleBucketedSort;
...
class SparklineDoubleAggregator {
    ...
    public static class GroupingState implements GroupingAggregatorState {
        private final TupleLongDoubleBucketedSort sort;

        private GroupingState(BigArrays bigArrays, int limit, boolean ascending) {
            this.sort = new TupleLongDoubleBucketedSort(bigArrays, ascending ? SortOrder.ASC : SortOrder.DESC, limit);
        }

        public void add(int groupId, long timestamp, double value) {

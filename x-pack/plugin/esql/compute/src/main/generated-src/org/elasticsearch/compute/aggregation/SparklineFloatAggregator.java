...
import org.elasticsearch.compute.data.sort.TupleLongFloatBucketedSort;
...
class SparklineFloatAggregator {
    ...
    public static class GroupingState implements GroupingAggregatorState {
        private final TupleLongFloatBucketedSort sort;

        private GroupingState(BigArrays bigArrays, int limit, boolean ascending) {
            this.sort = new TupleLongFloatBucketedSort(bigArrays, ascending ? SortOrder.ASC : SortOrder.DESC, limit);
        }

        public void add(int groupId, long timestamp, float value) {

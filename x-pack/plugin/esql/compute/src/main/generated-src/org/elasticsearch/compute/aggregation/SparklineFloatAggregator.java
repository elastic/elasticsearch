...
import org.elasticsearch.compute.data.sort.FloatIndirectBucketedSort;
...
class SparklineFloatAggregator {
    ...
    private static class TimestampValueComparator implements Comparator<Tuple<Long, Float>> {
        ...
        public int compare(Tuple<Long, Float> lhs, Tuple<Long, Float> rhs) {
            ...
            return order.reverseMul() * Float.compare(lhs.v2(), rhs.v2());
        }
    }
    ...
    public static class GroupingState implements GroupingAggregatorState {
        private final FloatIndirectBucketedSort sort;

        private GroupingState(BigArrays bigArrays, int limit, boolean ascending) {
            Comparator<Tuple<Long, Float>> comparator = Comparator.<Tuple<Long, Float>>comparingLong(Tuple::v1).thenComparing(Tuple::v2);
            this.sort = new FloatIndirectBucketedSort(bigArrays, comparator, limit);
        }

        public void add(int groupId, long sortValue, float indirectValue) {
    ...
    public static class SingleState implements AggregatorState {
        ...
        public void add(long sortValue, float indirectValue) {

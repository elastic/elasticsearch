...
import org.elasticsearch.compute.data.sort.TupleLongIntBucketedSort;
...
class SparklineIntAggregator {
    ...
    public static class GroupingState implements GroupingAggregatorState {
        private final TupleLongIntBucketedSort sort;

        private GroupingState(BigArrays bigArrays, int limit, boolean ascending) {
            this.sort = new TupleLongIntBucketedSort(bigArrays, ascending ? SortOrder.ASC : SortOrder.DESC, limit);
        }

        public void add(int groupId, long timestamp, int value) {

...
import org.elasticsearch.compute.data.sort.IntIndirectBucketedSort;
...
class SparklineIntAggregator {
    ...
    private static class TimestampValueComparator implements Comparator<Tuple<Long, Integer>> {
        ...
        public int compare(Tuple<Long,Integer> lhs, Tuple<Long, Integer> rhs) {
            ...
            return order.reverseMul() * Integer.compare(lhs.v2(), rhs.v2());
        }
    }
    ...
    public static class GroupingState implements GroupingAggregatorState {
        ...
        public void add(int groupId, long sortValue, int indirectValue) {
    ...
    public static class SingleState implements AggregatorState {
        ...
        public void add(long sortValue, int indirectValue) {

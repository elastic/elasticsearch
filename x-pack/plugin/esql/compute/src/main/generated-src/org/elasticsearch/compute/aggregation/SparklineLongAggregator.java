...
import org.elasticsearch.compute.data.LongBlock;
import org.elasticsearch.compute.data.sort.TupleLongLongBucketedSort;
...
class SparklineLongAggregator {
    ...
    public static class GroupingState implements GroupingAggregatorState {
        private final TupleLongLongBucketedSort sort;

        private GroupingState(BigArrays bigArrays, int limit, boolean ascending) {
            this.sort = new TupleLongLongBucketedSort(bigArrays, ascending ? SortOrder.ASC : SortOrder.DESC, limit);
        }

        public void add(int groupId, long timestamp, long value) {
            sort.collect(Tuple.tuple(timestamp, value), groupId);
        }
    ...
    public static class SingleState implements AggregatorState {
        ...
        public void add(long timestamp, long value) {
            internalState.add(0, timestamp, value);
        }

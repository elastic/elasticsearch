...
public class StdDeviationFloatAggregator {
    ...
    public static void combine(StdDeviationStates.StdDeviationState state, float value) {
        state.add(value);
    }
    ...
    public static void combine(StdDeviationStates.GroupingStdDeviationState current, int groupId, float value) {

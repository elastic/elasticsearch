...
public class StdDeviationLongAggregator {
    ...
    public static void combine(StdDeviationStates.StdDeviationState state, long value) {
        state.add(value);
    }
    ...
    public static void combine(StdDeviationStates.GroupingStdDeviationState current, int groupId, long value) {

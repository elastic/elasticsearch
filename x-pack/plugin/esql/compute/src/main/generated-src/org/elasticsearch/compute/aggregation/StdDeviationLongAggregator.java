...
@GroupingAggregator
public class StdDeviationLongAggregator {

    public static StdDeviationLongState initSingle() {
        return new StdDeviationLongState();
    }

    public static void combine(StdDeviationLongState state, long value) {
        state.add(value);
    }

    public static void combineIntermediate(StdDeviationLongState state, double mean, double m2, long count) {
        state.combine(mean, m2, count);
    }

    public static void evaluateIntermediate(StdDeviationLongState state, DriverContext driverContext, Block[] blocks, int offset) {
    ...
    public static Block evaluateFinal(StdDeviationLongState state, DriverContext driverContext) {
    ...
    public static GroupingStdDeviationLongState initGrouping(BigArrays bigArrays) {
        return new GroupingStdDeviationLongState(bigArrays);
    }

    public static void combine(GroupingStdDeviationLongState current, int groupId, long value) {
        current.add(groupId, value);
    }

    public static void combineStates(
        GroupingStdDeviationLongState current,
        int groupId,
        GroupingStdDeviationLongState state,
        int statePosition
    ) {
    ...
    public static void combineIntermediate(GroupingStdDeviationLongState state, int groupId, double mean, double m2, long count) {
    ...
    public static Block evaluateFinal(GroupingStdDeviationLongState state, IntVector selected, DriverContext driverContext) {
    ...
    static final class StdDeviationLongState implements AggregatorState {

        private WelfordAlgorithm welfordAlgorithm;

        StdDeviationLongState() {
            this(0, 0, 0);
        }

        StdDeviationLongState(double mean, double m2, long count) {
        ...
        public void toIntermediate(Block[] blocks, int offset, DriverContext driverContext) {
            StdDeviationLongAggregator.evaluateIntermediate(this, driverContext, blocks, offset);
        }
    ...
    static final class GroupingStdDeviationLongState implements GroupingAggregatorState {

        private ObjectArray<StdDeviationLongState> states;
        private final BigArrays bigArrays;

        GroupingStdDeviationLongState(BigArrays bigArrays) {
        ...
        public void combine(int groupId, double meanValue, double m2Value, long countValue) {
            ...
            if (state == null) {
                state = new StdDeviationLongState(meanValue, m2Value, countValue);
        ...
        public void add(int groupId, long value) {
            ...
            var state = states.get(groupId);
            if (state == null) {
                state = new StdDeviationLongState();
                states.set(groupId, state);
            }
            state.add(value);
        }
        ...
        public void toIntermediate(Block[] blocks, int offset, IntVector selected, DriverContext driverContext) {
            StdDeviationLongAggregator.evaluateIntermediate(this, blocks, offset, selected, driverContext);
        }

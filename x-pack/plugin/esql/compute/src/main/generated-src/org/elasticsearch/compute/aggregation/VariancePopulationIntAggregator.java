...
@GroupingAggregator
public class VariancePopulationIntAggregator {
    ...
    public static Block evaluateFinal(StdDevStates.SingleState state, DriverContext driverContext) {
        return state.evaluateFinal(driverContext, StdDevStates.Variation.POPULATION_VARIANCE);
    }
    ...
    public static Block evaluateFinal(StdDevStates.GroupingState state, IntVector selected, DriverContext driverContext) {
        return state.evaluateFinal(selected, driverContext, StdDevStates.Variation.POPULATION_VARIANCE);
    }
}

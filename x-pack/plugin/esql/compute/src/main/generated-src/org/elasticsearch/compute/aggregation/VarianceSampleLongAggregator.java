...
@GroupingAggregator
public class VarianceSampleLongAggregator {
    ...
    public static Block evaluateFinal(StdDevStates.SingleState state, DriverContext driverContext) {
        return state.evaluateFinal(driverContext, StdDevStates.Variation.SAMPLE_VARIANCE);
    }
    ...
    public static Block evaluateFinal(StdDevStates.GroupingState state, IntVector selected, DriverContext driverContext) {
        return state.evaluateFinal(selected, driverContext, StdDevStates.Variation.SAMPLE_VARIANCE);
    }
}

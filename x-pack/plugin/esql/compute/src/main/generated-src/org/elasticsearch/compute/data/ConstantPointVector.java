 ...
 */
final class ConstantPointVector extends AbstractVector implements PointVector {
    ...
    ConstantPointVector(SpatialPoint value, int positionCount, BlockFactory blockFactory) {
    ...
    public PointVector filter(int... positions) {
        return blockFactory().newConstantPointVector(value, positions.length);
    }

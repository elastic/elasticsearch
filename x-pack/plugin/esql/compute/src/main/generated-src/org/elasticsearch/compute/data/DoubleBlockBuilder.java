...
final class DoubleBlockBuilder extends AbstractBlockBuilder implements DoubleBlock.Builder {
    ...
    private DoubleBlock buildBigArraysBlock() {
         ...
         */
        DoubleArray array = blockFactory.bigArrays().newDoubleArray(valueCount, false);
        try {
            ...
            DoubleBigArrayVector vector = new DoubleBigArrayVector(array, vectorPositions, blockFactory);
            ...
            try {
                ...
                if (isDense() && singleValued()) {
                    ...
                    theBlock = new DoubleBigArrayBlock(vector, positionCount, firstValueIndexes, nullsMask, mvOrdering);
                    vector = null; // ownership transferred to theBlock
                    try {

...
final class FloatBlockBuilder extends AbstractBlockBuilder implements FloatBlock.Builder {
    ...
    private FloatBlock buildBigArraysBlock() {
         ...
         */
        FloatArray array = blockFactory.bigArrays().newFloatArray(valueCount, false);
        try {
            ...
            FloatBigArrayVector vector = new FloatBigArrayVector(array, vectorPositions, blockFactory);

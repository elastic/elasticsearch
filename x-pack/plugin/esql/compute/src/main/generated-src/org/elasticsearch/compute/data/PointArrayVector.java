 ...
 */
final class PointArrayVector extends AbstractVector implements PointVector {
    ...
    PointArrayVector(SpatialPoint[] values, int positionCount, BlockFactory blockFactory) {

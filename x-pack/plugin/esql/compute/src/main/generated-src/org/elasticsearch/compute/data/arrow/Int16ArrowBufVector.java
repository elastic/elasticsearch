 ...
 */
public final class Int16ArrowBufVector extends AbstractArrowBufVector<IntVector, IntBlock> implements IntVector {
     ...
     */
    public Int16ArrowBufVector(ArrowBuf valueBuffer, int positionCount, BlockFactory blockFactory) {
        super(valueBuffer, positionCount, blockFactory);
    }

    private Int16ArrowBufVector(FixedWidthVector arrowVector, BlockFactory blockFactory) {
        super(arrowVector, blockFactory);
    }

    public static Int16ArrowBufVector of(FixedWidthVector arrowVector, BlockFactory blockFactory) {
        return new Int16ArrowBufVector(arrowVector, blockFactory);
    }
    ...
    protected ArrowBufBlockConstructor<IntBlock> blockConstructor() {
        return Int16ArrowBufBlock::new;
    }

    @Override
    public int getInt(int valueIndex) {
        return valueBuffer.getShort((long) valueIndex * Short.BYTES);
    }

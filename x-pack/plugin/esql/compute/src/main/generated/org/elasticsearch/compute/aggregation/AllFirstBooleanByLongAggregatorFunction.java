...
public final class AllFirstBooleanByLongAggregatorFunction implements AggregatorFunction {
  ...
  AllFirstBooleanByLongAggregatorFunction(DriverContext driverContext,
      List<ExpressionEvaluator> inputs) {
    this.driverContext = driverContext;
    this.inputs = inputs;
    this.state = AllFirstBooleanByLongAggregator.initSingle(driverContext);
  ...
  private void addRawInputMasked(Page page, BooleanVector mask) {
    try (
      ...
      BooleanBlock valuesBlock = (BooleanBlock) valuesUncast;

...
/**
 * {@link AggregatorFunction} implementation for {@link AllFirstBooleanByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllFirstBooleanByLongAggregatorFunction implements AggregatorFunction {
  ...
  public AllFirstBooleanByLongAggregatorFunction(DriverContext driverContext,
  ...
  public static AllFirstBooleanByLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new AllFirstBooleanByLongAggregatorFunction(driverContext, channels, AllFirstBooleanByLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawBlock(BooleanBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllFirstBooleanByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllFirstBooleanByLongAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllFirstBooleanByLongAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link AllFirstBooleanByTimestampAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllFirstBooleanByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  public AllFirstBooleanByTimestampAggregatorFunction(DriverContext driverContext,
  ...
  private void addRawBlock(BooleanBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllFirstBooleanByTimestampAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllFirstBooleanByTimestampAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllFirstBooleanByTimestampAggregator.evaluateFinal(state, driverContext);
  }

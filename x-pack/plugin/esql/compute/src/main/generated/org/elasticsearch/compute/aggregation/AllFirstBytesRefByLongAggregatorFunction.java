...
/**
 * {@link AggregatorFunction} implementation for {@link AllFirstBytesRefByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllFirstBytesRefByLongAggregatorFunction implements AggregatorFunction {
  ...
  public AllFirstBytesRefByLongAggregatorFunction(DriverContext driverContext,
  ...
  public static AllFirstBytesRefByLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new AllFirstBytesRefByLongAggregatorFunction(driverContext, channels, AllFirstBytesRefByLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawBlock(BytesRefBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllFirstBytesRefByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllFirstBytesRefByLongAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllFirstBytesRefByLongAggregator.evaluateFinal(state, driverContext);
  }

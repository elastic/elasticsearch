...
public final class AllFirstBytesRefByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  private void addRawBlock(BytesRefBlock valueBlock, LongBlock timestampBlock) {
    for (int p = 0; p < valueBlock.getPositionCount(); p++) {
      AllFirstBytesRefByTimestampAggregator.combine(state, p, valueBlock, timestampBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllFirstBytesRefByTimestampAggregator.combineIntermediate(state, timestamps.getLong(0), values.getBytesRef(0, valuesScratch), seen.getBoolean(0), hasValue.getBoolean(0));
  }

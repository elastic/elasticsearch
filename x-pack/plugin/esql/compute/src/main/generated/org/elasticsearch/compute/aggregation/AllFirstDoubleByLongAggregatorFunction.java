...
/**
 * {@link AggregatorFunction} implementation for {@link AllFirstDoubleByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllFirstDoubleByLongAggregatorFunction implements AggregatorFunction {
  ...
  public AllFirstDoubleByLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
  ...
  public static AllFirstDoubleByLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new AllFirstDoubleByLongAggregatorFunction(driverContext, channels, AllFirstDoubleByLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawBlock(DoubleBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllFirstDoubleByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllFirstDoubleByLongAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllFirstDoubleByLongAggregator.evaluateFinal(state, driverContext);
  }

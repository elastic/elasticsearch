...
/**
 * {@link AggregatorFunction} implementation for {@link AllFirstExponentialHistogramByIntAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllFirstExponentialHistogramByIntAggregatorFunction implements AggregatorFunction {
  ...
  AllFirstExponentialHistogramByIntAggregatorFunction(DriverContext driverContext,
      List<Integer> channels) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = AllFirstExponentialHistogramByIntAggregator.initSingle(driverContext);
  }
  ...
  private void addRawBlock(ExponentialHistogramBlock valueBlock, IntBlock sortKeyBlock) {
    ...
    for (int p = 0; p < valueBlock.getPositionCount(); p++) {
      ...
      for (int valueOffset = valueStart; valueOffset < valueEnd; valueOffset++) {
        ...
        for (int sortKeyOffset = sortKeyStart; sortKeyOffset < sortKeyEnd; sortKeyOffset++) {
          ...
          AllFirstExponentialHistogramByIntAggregator.combine(state, valueValue, sortKeyValue);
        }
      }
    }
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllFirstExponentialHistogramByIntAggregator.evaluateFinal(state, driverContext);
  }

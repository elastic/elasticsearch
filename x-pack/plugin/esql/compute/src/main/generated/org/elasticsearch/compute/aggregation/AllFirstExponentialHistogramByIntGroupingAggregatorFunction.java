...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link AllFirstExponentialHistogramByIntAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class AllFirstExponentialHistogramByIntGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  AllFirstExponentialHistogramByIntGroupingAggregatorFunction(List<Integer> channels,
      DriverContext driverContext) {
    this.channels = channels;
    this.state = AllFirstExponentialHistogramByIntAggregator.initGrouping(driverContext);
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        for (int valueOffset = valueStart; valueOffset < valueEnd; valueOffset++) {
          ...
          for (int sortKeyOffset = sortKeyStart; sortKeyOffset < sortKeyEnd; sortKeyOffset++) {
            ...
            AllFirstExponentialHistogramByIntAggregator.combine(state, groupId, valueValue, sortKeyValue);
          }
        }
      }
    }
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = AllFirstExponentialHistogramByIntAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

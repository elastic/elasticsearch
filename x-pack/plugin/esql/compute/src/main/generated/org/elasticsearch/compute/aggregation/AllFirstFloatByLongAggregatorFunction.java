...
/**
 * {@link AggregatorFunction} implementation for {@link AllFirstFloatByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllFirstFloatByLongAggregatorFunction implements AggregatorFunction {
  ...
  public AllFirstFloatByLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      AllLongFloatState state) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = state;
  }

  public static AllFirstFloatByLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new AllFirstFloatByLongAggregatorFunction(driverContext, channels, AllFirstFloatByLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawBlock(FloatBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllFirstFloatByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllFirstFloatByLongAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link AllFirstFloatByTimestampAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class AllFirstFloatByTimestampGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  private final AllFirstFloatByTimestampAggregator.GroupingState state;

  private final List<Integer> channels;

  private final DriverContext driverContext;

  public AllFirstFloatByTimestampGroupingAggregatorFunction(List<Integer> channels,
      AllFirstFloatByTimestampAggregator.GroupingState state, DriverContext driverContext) {
    this.channels = channels;
    this.state = state;
    this.driverContext = driverContext;
  }

  public static AllFirstFloatByTimestampGroupingAggregatorFunction create(List<Integer> channels,
      DriverContext driverContext) {
    return new AllFirstFloatByTimestampGroupingAggregatorFunction(channels, AllFirstFloatByTimestampAggregator.initGrouping(driverContext), driverContext);
  }
  ...
  private void addRawInput(int positionOffset, IntArrayBlock groups, FloatBlock valuesBlock,
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        AllFirstFloatByTimestampAggregator.combine(state, groupId, valuesPosition, valuesBlock, timestampsBlock);
      }
    }
  }
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        int groupId = groups.getInt(g);
        int valuesPosition = groupPosition + positionOffset;
        AllFirstFloatByTimestampAggregator.combineIntermediate(state, groupId, observed, timestampsPresent, timestamps, values, valuesPosition);
      }
    }
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, IntVector selected,
    ...
    blocks[offset] = AllFirstFloatByTimestampAggregator.evaluateFinal(state, selected, ctx);
  }

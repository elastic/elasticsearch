...
/**
 * {@link AggregatorFunction} implementation for {@link AllFirstIntByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllFirstIntByLongAggregatorFunction implements AggregatorFunction {
  ...
  public AllFirstIntByLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      AllLongIntState state) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = state;
  }

  public static AllFirstIntByLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new AllFirstIntByLongAggregatorFunction(driverContext, channels, AllFirstIntByLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawBlock(IntBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllFirstIntByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllFirstIntByLongAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllFirstIntByLongAggregator.evaluateFinal(state, driverContext);
  }

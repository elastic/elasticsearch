...
public final class AllFirstIntByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  private void addRawBlock(IntBlock valueBlock, LongBlock timestampBlock) {
    for (int p = 0; p < valueBlock.getPositionCount(); p++) {
      AllFirstIntByTimestampAggregator.combine(state, p, valueBlock, timestampBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllFirstIntByTimestampAggregator.combineIntermediate(state, timestamps.getLong(0), values.getInt(0), seen.getBoolean(0), hasValue.getBoolean(0));
  }

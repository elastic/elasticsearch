...
/**
 * {@link AggregatorFunction} implementation for {@link AllFirstIntByTimestampAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllFirstIntByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  public AllFirstIntByTimestampAggregatorFunction(DriverContext driverContext,
      List<Integer> channels, AllLongIntState state) {
  ...
  private void addRawBlock(IntBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllFirstIntByTimestampAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllFirstIntByTimestampAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllFirstIntByTimestampAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link AllFirstLongByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllFirstLongByLongAggregatorFunction implements AggregatorFunction {
  ...
  AllFirstLongByLongAggregatorFunction(DriverContext driverContext,
  ...
  private void addRawBlock(LongBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllFirstLongByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    try (
      ...
      AllFirstLongByLongAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
    }
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllFirstLongByLongAggregator.evaluateFinal(state, driverContext);
  }

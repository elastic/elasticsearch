...
public final class AllFirstLongByLongGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  AllFirstLongByLongGroupingAggregatorFunction(List<Integer> channels,
      DriverContext driverContext) {
    this.channels = channels;
    this.state = AllFirstLongByLongAggregator.initGrouping(driverContext);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = AllFirstLongByLongAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link AllLastBooleanByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllLastBooleanByLongAggregatorFunction implements AggregatorFunction {
  ...
  public AllLastBooleanByLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      AllLongBooleanState state) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = state;
  }

  public static AllLastBooleanByLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new AllLastBooleanByLongAggregatorFunction(driverContext, channels, AllLastBooleanByLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawBlock(BooleanBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllLastBooleanByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastBooleanByLongAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllLastBooleanByLongAggregator.evaluateFinal(state, driverContext);
  }

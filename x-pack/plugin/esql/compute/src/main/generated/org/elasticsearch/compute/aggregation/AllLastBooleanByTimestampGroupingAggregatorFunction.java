...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link AllLastBooleanByTimestampAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class AllLastBooleanByTimestampGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  private final AllLastBooleanByTimestampAggregator.GroupingState state;

  private final List<Integer> channels;

  private final DriverContext driverContext;

  public AllLastBooleanByTimestampGroupingAggregatorFunction(List<Integer> channels,
      AllLastBooleanByTimestampAggregator.GroupingState state, DriverContext driverContext) {
    this.channels = channels;
    this.state = state;
    this.driverContext = driverContext;
  }

  public static AllLastBooleanByTimestampGroupingAggregatorFunction create(List<Integer> channels,
      DriverContext driverContext) {
    return new AllLastBooleanByTimestampGroupingAggregatorFunction(channels, AllLastBooleanByTimestampAggregator.initGrouping(driverContext), driverContext);
  }
  ...
  private void addRawInput(int positionOffset, IntArrayBlock groups, BooleanBlock valuesBlock,
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        AllLastBooleanByTimestampAggregator.combine(state, groupId, valuesPosition, valuesBlock, timestampsBlock);
      }
    }
  }
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        int groupId = groups.getInt(g);
        int valuesPosition = groupPosition + positionOffset;
        AllLastBooleanByTimestampAggregator.combineIntermediate(state, groupId, observed, timestampsPresent, timestamps, values, valuesPosition);
      }
    }
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, IntVector selected,
    ...
    blocks[offset] = AllLastBooleanByTimestampAggregator.evaluateFinal(state, selected, ctx);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link AllLastBytesRefByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllLastBytesRefByLongAggregatorFunction implements AggregatorFunction {
  ...
  public AllLastBytesRefByLongAggregatorFunction(DriverContext driverContext,
  ...
  public static AllLastBytesRefByLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new AllLastBytesRefByLongAggregatorFunction(driverContext, channels, AllLastBytesRefByLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawBlock(BytesRefBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllLastBytesRefByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastBytesRefByLongAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllLastBytesRefByLongAggregator.evaluateFinal(state, driverContext);
  }

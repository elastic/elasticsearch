...
/**
 * {@link AggregatorFunction} implementation for {@link AllLastDoubleByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllLastDoubleByLongAggregatorFunction implements AggregatorFunction {
  ...
  AllLastDoubleByLongAggregatorFunction(DriverContext driverContext,
  ...
  private void addRawBlock(DoubleBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllLastDoubleByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    try (
      ...
      AllLastDoubleByLongAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
    }
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllLastDoubleByLongAggregator.evaluateFinal(state, driverContext);
  }

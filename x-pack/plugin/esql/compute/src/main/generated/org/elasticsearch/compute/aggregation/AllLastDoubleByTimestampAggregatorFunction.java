...
/**
 * {@link AggregatorFunction} implementation for {@link AllLastDoubleByTimestampAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllLastDoubleByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  public AllLastDoubleByTimestampAggregatorFunction(DriverContext driverContext,
  ...
  private void addRawBlock(DoubleBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllLastDoubleByTimestampAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastDoubleByTimestampAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllLastDoubleByTimestampAggregator.evaluateFinal(state, driverContext);
  }

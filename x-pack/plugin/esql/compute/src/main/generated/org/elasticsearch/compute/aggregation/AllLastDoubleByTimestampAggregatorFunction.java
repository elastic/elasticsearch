...
public final class AllLastDoubleByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  private void addRawBlock(DoubleBlock valueBlock, LongBlock timestampBlock) {
    for (int p = 0; p < valueBlock.getPositionCount(); p++) {
      AllLastDoubleByTimestampAggregator.combine(state, p, valueBlock, timestampBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastDoubleByTimestampAggregator.combineIntermediate(state, timestamps.getLong(0), values.getDouble(0), seen.getBoolean(0), hasValue.getBoolean(0));
  }

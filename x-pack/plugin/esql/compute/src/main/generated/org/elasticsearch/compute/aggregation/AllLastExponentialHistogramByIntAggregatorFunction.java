...
/**
 * {@link AggregatorFunction} implementation for {@link AllLastExponentialHistogramByIntAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllLastExponentialHistogramByIntAggregatorFunction implements AggregatorFunction {
  ...
  AllLastExponentialHistogramByIntAggregatorFunction(DriverContext driverContext,
      List<Integer> channels) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = AllLastExponentialHistogramByIntAggregator.initSingle(driverContext);
  }
    ...
    for (int p = 0; p < valueBlock.getPositionCount(); p++) {
      ...
      for (int valueOffset = valueStart; valueOffset < valueEnd; valueOffset++) {
        ...
        for (int sortKeyOffset = sortKeyStart; sortKeyOffset < sortKeyEnd; sortKeyOffset++) {
          ...
          AllLastExponentialHistogramByIntAggregator.combine(state, valueValue, sortKeyValue);
        }
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastExponentialHistogramByIntAggregator.combineIntermediate(state, sortKeys.getLong(0), values, seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllLastExponentialHistogramByIntAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link AllLastExponentialHistogramByLongAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class AllLastExponentialHistogramByLongGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  AllLastExponentialHistogramByLongGroupingAggregatorFunction(List<Integer> channels,
      DriverContext driverContext) {
    this.channels = channels;
    this.state = AllLastExponentialHistogramByLongAggregator.initGrouping(driverContext);
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        for (int valueOffset = valueStart; valueOffset < valueEnd; valueOffset++) {
          ...
          for (int sortKeyOffset = sortKeyStart; sortKeyOffset < sortKeyEnd; sortKeyOffset++) {
            ...
            AllLastExponentialHistogramByLongAggregator.combine(state, groupId, valueValue, sortKeyValue);
          }
        }
      }
    }
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        int groupId = groups.getInt(g);
        int valuesPosition = groupPosition + positionOffset;
        AllLastExponentialHistogramByLongAggregator.combineIntermediate(state, groupId, sortKeys.getLong(valuesPosition), values, seen.getBoolean(valuesPosition), valuesPosition);
      }
    }
  }
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = AllLastExponentialHistogramByLongAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

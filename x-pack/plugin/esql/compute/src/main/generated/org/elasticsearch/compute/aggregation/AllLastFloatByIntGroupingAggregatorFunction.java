...
public final class AllLastFloatByIntGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  private void addRawInput(IntVector groupIds, IntVector positions, FloatBlock valuesBlock,
      IntBlock timestampsBlock) {
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = AllLastFloatByIntAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

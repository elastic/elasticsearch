...
/**
 * {@link AggregatorFunction} implementation for {@link AllLastIntByTimestampAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllLastIntByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  public AllLastIntByTimestampAggregatorFunction(DriverContext driverContext,
  ...
  private void addRawBlock(IntBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllLastIntByTimestampAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastIntByTimestampAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllLastIntByTimestampAggregator.evaluateFinal(state, driverContext);
  }

  ...
  private void addRawInput(int positionOffset, IntArrayBlock groups, IntBlock valueBlock,
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        AllLastIntByTimestampAggregator.combine(state, groupId, valuesPosition, valueBlock, timestampBlock);
      }
    }
  }
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        int groupId = groups.getInt(g);
        int valuesPosition = groupPosition + positionOffset;
        AllLastIntByTimestampAggregator.combineIntermediate(state, groupId, timestamps, values, hasValues, valuesPosition);
      }
    }
  }

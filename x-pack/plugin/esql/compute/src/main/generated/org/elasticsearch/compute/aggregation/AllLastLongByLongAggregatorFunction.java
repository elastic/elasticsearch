...
/**
 * {@link AggregatorFunction} implementation for {@link AllLastLongByLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllLastLongByLongAggregatorFunction implements AggregatorFunction {
  ...
  public AllLastLongByLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
  ...
  public static AllLastLongByLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new AllLastLongByLongAggregatorFunction(driverContext, channels, AllLastLongByLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawBlock(LongBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllLastLongByLongAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastLongByLongAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllLastLongByLongAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link AllLastLongByTimestampAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllLastLongByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  public AllLastLongByTimestampAggregatorFunction(DriverContext driverContext,
  ...
  private void addRawBlock(LongBlock valuesBlock, LongBlock timestampsBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AllLastLongByTimestampAggregator.combine(state, p, valuesBlock, timestampsBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastLongByTimestampAggregator.combineIntermediate(state, observed.getBoolean(0), timestampPresent.getBoolean(0), timestamp.getLong(0), values);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllLastLongByTimestampAggregator.evaluateFinal(state, driverContext);
  }

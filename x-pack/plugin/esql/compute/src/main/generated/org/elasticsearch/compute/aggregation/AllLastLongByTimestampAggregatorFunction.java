...
public final class AllLastLongByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  private void addRawBlock(LongBlock valueBlock, LongBlock timestampBlock) {
    for (int p = 0; p < valueBlock.getPositionCount(); p++) {
      AllLastLongByTimestampAggregator.combine(state, p, valueBlock, timestampBlock);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastLongByTimestampAggregator.combineIntermediate(state, timestamps.getLong(0), values.getLong(0), seen.getBoolean(0), hasValue.getBoolean(0));
  }

...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link AllLastLongByTimestampAggregator}.
...
public final class AllLastLongByTimestampGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public AllLastLongByTimestampGroupingAggregatorFunction(List<Integer> channels,
      AllLastLongByTimestampAggregator.GroupingState state, DriverContext driverContext) {
    this.channels = channels;
    this.state = state;
    this.driverContext = driverContext;
  }

  public static AllLastLongByTimestampGroupingAggregatorFunction create(List<Integer> channels,
  ...
  public void evaluateFinal(Block[] blocks, int offset, IntVector selected,
    ...
    blocks[offset] = AllLastLongByTimestampAggregator.evaluateFinal(state, selected, ctx);
  }

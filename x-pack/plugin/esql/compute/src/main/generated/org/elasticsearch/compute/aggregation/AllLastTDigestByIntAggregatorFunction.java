...
/**
 * {@link AggregatorFunction} implementation for {@link AllLastTDigestByIntAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AllLastTDigestByIntAggregatorFunction implements AggregatorFunction {
  ...
  AllLastTDigestByIntAggregatorFunction(DriverContext driverContext, List<Integer> channels) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = AllLastTDigestByIntAggregator.initSingle(driverContext);
  }
    ...
    for (int p = 0; p < valueBlock.getPositionCount(); p++) {
      ...
      for (int valueOffset = valueStart; valueOffset < valueEnd; valueOffset++) {
        ...
        for (int sortKeyOffset = sortKeyStart; sortKeyOffset < sortKeyEnd; sortKeyOffset++) {
          ...
          AllLastTDigestByIntAggregator.combine(state, valueValue, sortKeyValue);
        }
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AllLastTDigestByIntAggregator.combineIntermediate(state, sortKeys.getLong(0), values, seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AllLastTDigestByIntAggregator.evaluateFinal(state, driverContext);
  }

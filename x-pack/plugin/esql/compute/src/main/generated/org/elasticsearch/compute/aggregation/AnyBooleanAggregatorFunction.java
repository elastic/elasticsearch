...
/**
 * {@link AggregatorFunction} implementation for {@link AnyBooleanAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AnyBooleanAggregatorFunction implements AggregatorFunction {
  ...
  private void addRawBlock(BooleanBlock valuesBlock) {
    for (int p = 0; p < valuesBlock.getPositionCount(); p++) {
      AnyBooleanAggregator.combine(state, p, valuesBlock);
    }
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AnyBooleanAggregator.evaluateFinal(state, driverContext);
  }

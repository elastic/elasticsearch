...
/**
 * {@link AggregatorFunction} implementation for {@link AnyExponentialHistogramAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AnyExponentialHistogramAggregatorFunction implements AggregatorFunction {
  ...
  private final ExponentialHistogramStates.SeenSingleState state;

  private final List<Integer> channels;

  AnyExponentialHistogramAggregatorFunction(DriverContext driverContext, List<Integer> channels) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = AnyExponentialHistogramAggregator.initSingle(driverContext);
  }
  ...
  private void addRawBlock(ExponentialHistogramBlock valueBlock) {
    ...
    for (int p = 0; p < valueBlock.getPositionCount(); p++) {
      ...
      for (int valueOffset = valueStart; valueOffset < valueEnd; valueOffset++) {
        ...
        AnyExponentialHistogramAggregator.combine(state, valueValue);
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AnyExponentialHistogramAggregator.combineIntermediate(state, values.getExponentialHistogram(values.getFirstValueIndex(0), valuesScratch), seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AnyExponentialHistogramAggregator.evaluateFinal(state, driverContext);
  }

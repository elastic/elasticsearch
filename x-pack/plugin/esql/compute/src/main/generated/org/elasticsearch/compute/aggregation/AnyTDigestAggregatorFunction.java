...
/**
 * {@link AggregatorFunction} implementation for {@link AnyTDigestAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class AnyTDigestAggregatorFunction implements AggregatorFunction {
  ...
  private final TDigestStates.SeenSingleState state;

  private final List<Integer> channels;

  AnyTDigestAggregatorFunction(DriverContext driverContext, List<Integer> channels) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = AnyTDigestAggregator.initSingle(driverContext);
  }
  ...
  private void addRawBlock(TDigestBlock valueBlock) {
    ...
    for (int p = 0; p < valueBlock.getPositionCount(); p++) {
      ...
      for (int valueOffset = valueStart; valueOffset < valueEnd; valueOffset++) {
        ...
        AnyTDigestAggregator.combine(state, valueValue);
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    AnyTDigestAggregator.combineIntermediate(state, values.getTDigestHolder(values.getFirstValueIndex(0), valuesScratch), seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = AnyTDigestAggregator.evaluateFinal(state, driverContext);
  }

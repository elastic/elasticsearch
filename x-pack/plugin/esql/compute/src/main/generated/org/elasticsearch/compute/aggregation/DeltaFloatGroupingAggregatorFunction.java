...
public final class DeltaFloatGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  DeltaFloatGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext) {
    this.channels = channels;
    this.state = DeltaFloatAggregator.initGrouping(driverContext);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = DeltaFloatAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

...
public final class DeltaLongGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  DeltaLongGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext) {
    this.channels = channels;
    this.state = DeltaLongAggregator.initGrouping(driverContext);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = DeltaLongAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

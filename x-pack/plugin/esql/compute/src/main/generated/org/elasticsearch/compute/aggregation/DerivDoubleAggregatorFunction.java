...
public final class DerivDoubleAggregatorFunction implements AggregatorFunction {
  ...
  public static DerivDoubleAggregatorFunction create(DriverContext driverContext,
    ...
    return new DerivDoubleAggregatorFunction(driverContext, channels, DerivDoubleAggregator.initSingle(driverContext, dateNanos), dateNanos);
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    DerivDoubleAggregator.combineIntermediate(state, count.getLong(0), sumVal.getDouble(0), sumTs.getDouble(0), sumTsVal.getDouble(0), sumTsSq.getDouble(0));
  }

...
public final class DerivDoubleAggregatorFunction implements AggregatorFunction {
  ...
  DerivDoubleAggregatorFunction(DriverContext driverContext, List<ExpressionEvaluator> inputs,
      boolean dateNanos) {
    this.dateNanos = dateNanos;
    this.driverContext = driverContext;
    this.inputs = inputs;
    this.state = DerivDoubleAggregator.initSingle(driverContext, dateNanos);

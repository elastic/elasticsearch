...
/**
 * {@link AggregatorFunction} implementation for {@link FirstOverTimeDoubleAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class FirstOverTimeDoubleAggregatorFunction implements AggregatorFunction {
  ...
  public FirstOverTimeDoubleAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      LongDoubleState state) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = state;
  }

  public static FirstOverTimeDoubleAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new FirstOverTimeDoubleAggregatorFunction(driverContext, channels, FirstOverTimeDoubleAggregator.initSingle(driverContext));
  }
  ...
  private void addRawVector(DoubleVector vector, LongVector timestamps) {
    ...
    for (int i = 0; i < vector.getPositionCount(); i++) {
      FirstOverTimeDoubleAggregator.combine(state, timestamps.getLong(i), vector.getDouble(i));
    }
  }
  ...
  private void addRawBlock(DoubleBlock block, LongVector timestamps) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        FirstOverTimeDoubleAggregator.combine(state, timestamps.getLong(i), block.getDouble(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    FirstOverTimeDoubleAggregator.combineIntermediate(state, timestamps.getLong(0), values.getDouble(0), seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    ...
    blocks[offset] = FirstOverTimeDoubleAggregator.evaluateFinal(state, driverContext);
  }

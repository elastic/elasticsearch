...
public final class FirstOverTimeIntAggregatorFunction implements AggregatorFunction {
  ...
  private void addRawVector(IntVector vector, LongVector timestamps) {
    ...
    for (int i = 0; i < vector.getPositionCount(); i++) {
      FirstOverTimeIntAggregator.combine(state, timestamps.getLong(i), vector.getInt(i));
    }
  }
  ...
  private void addRawBlock(IntBlock block, LongVector timestamps) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        FirstOverTimeIntAggregator.combine(state, timestamps.getLong(i), block.getInt(i));
      }
    }
  }

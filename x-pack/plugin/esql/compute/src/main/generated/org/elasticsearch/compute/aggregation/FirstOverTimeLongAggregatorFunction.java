...
/**
 * {@link AggregatorFunction} implementation for {@link FirstOverTimeLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class FirstOverTimeLongAggregatorFunction implements AggregatorFunction {
  ...
  public FirstOverTimeLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      LongLongState state) {
  ...
  public static FirstOverTimeLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new FirstOverTimeLongAggregatorFunction(driverContext, channels, FirstOverTimeLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawVector(LongVector vector, LongVector timestamps) {
    ...
    for (int i = 0; i < vector.getPositionCount(); i++) {
      FirstOverTimeLongAggregator.combine(state, timestamps.getLong(i), vector.getLong(i));
    }
  }
  ...
  private void addRawBlock(LongBlock block, LongVector timestamps) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        FirstOverTimeLongAggregator.combine(state, timestamps.getLong(i), block.getLong(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    FirstOverTimeLongAggregator.combineIntermediate(state, timestamps.getLong(0), values.getLong(0), seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    ...
    blocks[offset] = FirstOverTimeLongAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link GeoCentroidGeoPointAggregator}.
 * This class is generated. Do not edit it.
 */
public final class GeoCentroidGeoPointAggregatorFunction implements AggregatorFunction {
  ...
  private final GeoCentroidGeoPointAggregator.CentroidState state;

  private final List<Integer> channels;

  public GeoCentroidGeoPointAggregatorFunction(List<Integer> channels,
      GeoCentroidGeoPointAggregator.CentroidState state) {
    this.channels = channels;
    this.state = state;
  }

  public static GeoCentroidGeoPointAggregatorFunction create(List<Integer> channels) {
    return new GeoCentroidGeoPointAggregatorFunction(channels, GeoCentroidGeoPointAggregator.initSingle());
  }
  ...
  private void addRawVector(LongVector vector) {
    for (int i = 0; i < vector.getPositionCount(); i++) {
      GeoCentroidGeoPointAggregator.combine(state, vector.getLong(i));
    }
  }
  ...
  private void addRawBlock(LongBlock block) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        GeoCentroidGeoPointAggregator.combine(state, block.getLong(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    GeoCentroidGeoPointAggregator.combineIntermediate(state, xVal.getDouble(0), xDel.getDouble(0), yVal.getDouble(0), yDel.getDouble(0), count.getLong(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset) {
    blocks[offset] = GeoCentroidGeoPointAggregator.evaluateFinal(state);
  }

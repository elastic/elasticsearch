...
/**
 * {@link AggregatorFunction} implementation for {@link LastBooleanByTimestampAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class LastBooleanByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  public LastBooleanByTimestampAggregatorFunction(DriverContext driverContext,
  ...
  public static LastBooleanByTimestampAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new LastBooleanByTimestampAggregatorFunction(driverContext, channels, LastBooleanByTimestampAggregator.initSingle(driverContext));
  }
  ...
  private void addRawVector(BooleanVector valueVector, LongVector timestampVector) {
    ...
    while (state.seen() == false && valuesPosition < valueVector.getPositionCount()) {
      ...
      LastBooleanByTimestampAggregator.first(state, valueValue, timestampValue);
      valuesPosition++;
      state.seen(true);
      break;
    }
    while (valuesPosition < valueVector.getPositionCount()) {
      boolean valueValue = valueVector.getBoolean(valuesPosition);
      long timestampValue = timestampVector.getLong(valuesPosition);
      LastBooleanByTimestampAggregator.combine(state, valueValue, timestampValue);
      valuesPosition++;
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    LastBooleanByTimestampAggregator.combineIntermediate(state, timestamps.getLong(0), values.getBoolean(0), seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    ...
    blocks[offset] = LastBooleanByTimestampAggregator.evaluateFinal(state, driverContext);
  }

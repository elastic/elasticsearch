...
/**
 * {@link AggregatorFunction} implementation for {@link LastIntByTimestampAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class LastIntByTimestampAggregatorFunction implements AggregatorFunction {
  ...
  public LastIntByTimestampAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      LongIntState state) {
  ...
  public static LastIntByTimestampAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new LastIntByTimestampAggregatorFunction(driverContext, channels, LastIntByTimestampAggregator.initSingle(driverContext));
  }
  ...
  private void addRawVector(IntVector valueVector, LongVector timestampVector) {
    ...
    while (state.seen() == false && valuesPosition < valueVector.getPositionCount()) {
      ...
      LastIntByTimestampAggregator.first(state, valueValue, timestampValue);
      valuesPosition++;
      state.seen(true);
      break;
    }
    while (valuesPosition < valueVector.getPositionCount()) {
      int valueValue = valueVector.getInt(valuesPosition);
      long timestampValue = timestampVector.getLong(valuesPosition);
      LastIntByTimestampAggregator.combine(state, valueValue, timestampValue);
      valuesPosition++;
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    LastIntByTimestampAggregator.combineIntermediate(state, timestamps.getLong(0), values.getInt(0), seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    ...
    blocks[offset] = LastIntByTimestampAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link LastOverTimeDoubleAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class LastOverTimeDoubleAggregatorFunction implements AggregatorFunction {
  ...
  public LastOverTimeDoubleAggregatorFunction(DriverContext driverContext, List<Integer> channels,
  ...
  public static LastOverTimeDoubleAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new LastOverTimeDoubleAggregatorFunction(driverContext, channels, LastOverTimeDoubleAggregator.initSingle(driverContext));
  }
  ...
  private void addRawVector(DoubleVector vector, LongVector timestamps) {
    ...
    for (int i = 0; i < vector.getPositionCount(); i++) {
      LastOverTimeDoubleAggregator.combine(state, timestamps.getLong(i), vector.getDouble(i));
    }
  }
  ...
  private void addRawBlock(DoubleBlock block, LongVector timestamps) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        LastOverTimeDoubleAggregator.combine(state, timestamps.getLong(i), block.getDouble(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    LastOverTimeDoubleAggregator.combineIntermediate(state, timestamps.getLong(0), values.getDouble(0), seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    ...
    blocks[offset] = LastOverTimeDoubleAggregator.evaluateFinal(state, driverContext);
  }

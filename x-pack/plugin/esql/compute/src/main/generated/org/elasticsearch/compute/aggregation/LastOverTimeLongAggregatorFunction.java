...
/**
 * {@link AggregatorFunction} implementation for {@link LastOverTimeLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class LastOverTimeLongAggregatorFunction implements AggregatorFunction {
  ...
  public LastOverTimeLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      LongLongState state) {
  ...
  public static LastOverTimeLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new LastOverTimeLongAggregatorFunction(driverContext, channels, LastOverTimeLongAggregator.initSingle(driverContext));
  }
  ...
  private void addRawInputMasked(Page page, BooleanVector mask) {
    ...
    LongBlock valueBlock = page.getBlock(channels.get(1));
  ...
  private void addRawBlock(LongBlock timestampBlock, LongBlock valueBlock) {
  ...
  private void addRawBlock(LongBlock timestampBlock, LongBlock valueBlock, BooleanVector mask) {
    for (int p = 0; p < timestampBlock.getPositionCount(); p++) {
  ...
  public void addIntermediateInput(Page page) {
    ...
    LastOverTimeLongAggregator.combineIntermediate(state, timestamps.getLong(0), values.getLong(0), seen.getBoolean(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    ...
    blocks[offset] = LastOverTimeLongAggregator.evaluateFinal(state, driverContext);
  }

...
public final class LastOverTimeLongAggregatorFunction implements AggregatorFunction {
  ...
  private void addRawVector(LongVector vector, LongVector timestamps) {
    ...
    for (int i = 0; i < vector.getPositionCount(); i++) {
      LastOverTimeLongAggregator.combine(state, timestamps.getLong(i), vector.getLong(i));
    }
  }
  ...
  private void addRawBlock(LongBlock block, LongVector timestamps) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        LastOverTimeLongAggregator.combine(state, timestamps.getLong(i), block.getLong(i));
      }
    }
  }

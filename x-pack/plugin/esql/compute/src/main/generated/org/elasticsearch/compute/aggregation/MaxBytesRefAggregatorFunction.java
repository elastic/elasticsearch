...
public final class MaxBytesRefAggregatorFunction implements AggregatorFunction {
  ...
  private final BytesRefState.SingleState state;
  ...
  public void addIntermediateInput(Page page) {
    ...
    BytesRefVector max = page.<BytesRefBlock>getBlock(channels.get(0)).asVector();
    assert max.getPositionCount() == 1;
    BytesRef scratch = new BytesRef();
    MaxBytesRefAggregator.combineIntermediate(state, max.getBytesRef(0, scratch));
  }

...
public final class MaxBytesRefGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public static MaxBytesRefGroupingAggregatorFunction create(List<Integer> channels,
    ...
    return new MaxBytesRefGroupingAggregatorFunction(channels, MaxBytesRefAggregator.initGrouping(bigArrays), driverContext, bigArrays);
  }
  ...
  public void addIntermediateInput(int positionOffset, IntVector groups, Page page) {
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      int groupId = Math.toIntExact(groups.getInt(groupPosition));
      MaxBytesRefAggregator.combineIntermediate(state, groupId, max.getBytesRef(groupPosition + positionOffset, scratch));
    }
  }
  ...
  public void addIntermediateRowInput(int groupId, GroupingAggregatorFunction input, int position) {
    ...
    BytesRefState.GroupingState inState = ((MaxBytesRefGroupingAggregatorFunction) input).state;
    state.enableGroupIdTracking(new SeenGroupIds.Empty());
  ...
  public void evaluateFinal(Block[] blocks, int offset, IntVector selected,
    ...
    blocks[offset] = MaxBytesRefAggregator.evaluateFinal(state, selected, driverContext);
  }

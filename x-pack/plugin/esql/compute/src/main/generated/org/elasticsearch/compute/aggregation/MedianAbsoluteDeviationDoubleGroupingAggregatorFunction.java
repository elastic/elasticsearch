...
public final class MedianAbsoluteDeviationDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public void addIntermediateInput(Vector groupIdVector, Block block) {
    ...
    MedianAbsoluteDeviationStates.GroupingState inState = MedianAbsoluteDeviationDoubleAggregator.initGrouping(bigArrays);
  ...
  public void addIntermediateRowInput(int groupId, GroupingAggregatorFunction input, int position) {
    ...
    MedianAbsoluteDeviationStates.GroupingState inState = ((MedianAbsoluteDeviationDoubleGroupingAggregatorFunction) input).state;
    MedianAbsoluteDeviationDoubleAggregator.combineStates(state, groupId, inState, position);
  }

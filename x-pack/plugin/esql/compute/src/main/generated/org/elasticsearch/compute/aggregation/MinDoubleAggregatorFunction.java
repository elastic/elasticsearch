...
public final class MinDoubleAggregatorFunction implements AggregatorFunction {
  ...
  MinDoubleAggregatorFunction(DriverContext driverContext, List<ExpressionEvaluator> inputs) {
  ...
  private void addRawVector(DoubleVector vVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      state.doubleValue(MinDoubleAggregator.combine(state.doubleValue(), vValue));
    }
  }

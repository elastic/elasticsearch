...
public final class PercentileDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public static PercentileDoubleGroupingAggregatorFunction create(int channel, BigArrays bigArrays,
      double percentile) {
    return new PercentileDoubleGroupingAggregatorFunction(channel, PercentileDoubleAggregator.initGrouping(bigArrays, percentile), bigArrays, percentile);
  }

...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link PercentileDoubleLenientAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class PercentileDoubleLenientGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  private final LenientQuantileStates.GroupingState state;
  ...
  PercentileDoubleLenientGroupingAggregatorFunction(List<Integer> channels,
    ...
    this.state = PercentileDoubleLenientAggregator.initGrouping(driverContext, percentile, tDigestStateCompression);
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        for (int vOffset = vStart; vOffset < vEnd; vOffset++) {
          ...
          PercentileDoubleLenientAggregator.combine(state, groupId, vValue);
        }
      }
    }
  }
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    assert quart.getPositionCount() == nan.getPositionCount() && quart.getPositionCount() == negInf.getPositionCount() && quart.getPositionCount() == posInf.getPositionCount();
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        int groupId = groups.getInt(g);
        int valuesPosition = groupPosition + positionOffset;
        PercentileDoubleLenientAggregator.combineIntermediate(state, groupId, quart.getBytesRef(valuesPosition, quartScratch), nan.getLong(valuesPosition), negInf.getLong(valuesPosition), posInf.getLong(valuesPosition));
      }
    }
  }
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = PercentileDoubleLenientAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link PromqlHistogramFractionAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class PromqlHistogramFractionAggregatorFunction implements AggregatorFunction {
  ...
  private final PromqlHistogramStates.Fraction.SingleState state;
  ...
  PromqlHistogramFractionAggregatorFunction(Warnings warnings, DriverContext driverContext,
      List<Integer> channels, double lower, double upper) {
    this.lower = lower;
    this.upper = upper;
    this.warnings = warnings;
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = PromqlHistogramFractionAggregator.initSingle(driverContext, lower, upper, warnings);
  }
  ...
  private void addRawVector(DoubleVector countVector, BytesRefVector upperBoundVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < countVector.getPositionCount(); valuesPosition++) {
      ...
      PromqlHistogramFractionAggregator.combine(state, countValue, upperBoundValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    PromqlHistogramFractionAggregator.combineIntermediate(state, buckets);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = PromqlHistogramFractionAggregator.evaluateFinal(state, driverContext);
  }

...
public final class RateIntAggregatorFunctionSupplier implements AggregatorFunctionSupplier {
  ...
  @Override
  public RateIntAggregatorFunction aggregator() {
    return RateIntAggregatorFunction.create(channels);
  }

  @Override
  public RateIntGroupingAggregatorFunction groupingAggregator() {
    return RateIntGroupingAggregatorFunction.create(channels, bigArrays);
  }

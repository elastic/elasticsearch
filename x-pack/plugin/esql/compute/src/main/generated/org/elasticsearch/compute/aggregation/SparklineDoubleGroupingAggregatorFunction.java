...
public final class SparklineDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public SparklineDoubleGroupingAggregatorFunction(List<Integer> channels,
      SparklineDoubleAggregator.GroupingState state, DriverContext driverContext) {
  ...
  public static SparklineDoubleGroupingAggregatorFunction create(List<Integer> channels,
    ...
    return new SparklineDoubleGroupingAggregatorFunction(channels, SparklineDoubleAggregator.initGrouping(driverContext), driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link SparklineFloatAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class SparklineFloatAggregatorFunction implements AggregatorFunction {
  ...
  private final SparklineFloatAggregator.SingleState state;
  ...
  public SparklineFloatAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      SparklineFloatAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static SparklineFloatAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new SparklineFloatAggregatorFunction(driverContext, channels, SparklineFloatAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(FloatVector valueVector, LongVector timestampVector) {
    for (int valuesPosition = 0; valuesPosition < valueVector.getPositionCount(); valuesPosition++) {
      ...
      SparklineFloatAggregator.combine(state, valueValue, timestampValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    SparklineFloatAggregator.combineIntermediate(state, values, timestamps);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = SparklineFloatAggregator.evaluateFinal(state, driverContext);
  }

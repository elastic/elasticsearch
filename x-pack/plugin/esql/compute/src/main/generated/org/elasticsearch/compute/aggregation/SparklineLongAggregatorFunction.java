...
public final class SparklineLongAggregatorFunction implements AggregatorFunction {
  ...
  public SparklineLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      SparklineLongAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static SparklineLongAggregatorFunction create(DriverContext driverContext,
    ...
    return new SparklineLongAggregatorFunction(driverContext, channels, SparklineLongAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(LongVector valueVector, LongVector timestampVector) {
    for (int valuesPosition = 0; valuesPosition < valueVector.getPositionCount(); valuesPosition++) {
      ...
      SparklineLongAggregator.combine(state, valueValue, timestampValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    SparklineLongAggregator.combineIntermediate(state, values, timestamps);
  }

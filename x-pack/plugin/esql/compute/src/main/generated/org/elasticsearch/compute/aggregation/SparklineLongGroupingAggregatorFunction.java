...
public final class SparklineLongGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public SparklineLongGroupingAggregatorFunction(List<Integer> channels,
      SparklineLongAggregator.GroupingState state, DriverContext driverContext, int limit,
      boolean ascending) {
  ...
  public static SparklineLongGroupingAggregatorFunction create(List<Integer> channels,
    ...
    return new SparklineLongGroupingAggregatorFunction(channels, SparklineLongAggregator.initGrouping(driverContext.bigArrays(), limit, ascending), driverContext, limit, ascending);
  }
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        for (int valueOffset = valueStart; valueOffset < valueEnd; valueOffset++) {
          ...
          for (int timestampOffset = timestampStart; timestampOffset < timestampEnd; timestampOffset++) {
            ...
            SparklineLongAggregator.combine(state, groupId, valueValue, timestampValue);
          }
        }
      }
    }
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        int groupId = groups.getInt(g);
        int valuesPosition = groupPosition + positionOffset;
        SparklineLongAggregator.combineIntermediate(state, groupId, values, timestamps, valuesPosition);
      }
    }
  }

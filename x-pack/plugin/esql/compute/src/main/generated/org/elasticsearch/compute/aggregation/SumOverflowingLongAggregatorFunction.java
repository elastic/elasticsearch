...
public final class SumOverflowingLongAggregatorFunction implements AggregatorFunction {
  ...
  SumOverflowingLongAggregatorFunction(DriverContext driverContext, List<Integer> channels) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = new LongState(SumOverflowingLongAggregator.init());
  }
  ...
  private void addRawVector(LongVector vVector) {
    ...
    if (vVector.getClass() == LongArrowBufVector.class) {
      ...
      for (int p = 0; p < bulkCount; p++) {
        ...
        bulkAcc = SumOverflowingLongAggregator.combine(bulkAcc, vValue);
      }

...
/**
 * {@link AggregatorFunction} implementation for {@link TopBooleanIpAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopBooleanIpAggregatorFunction implements AggregatorFunction {
  ...
  private final TopBooleanIpAggregator.SingleState state;
  ...
  public TopBooleanIpAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopBooleanIpAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopBooleanIpAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopBooleanIpAggregatorFunction(driverContext, channels, TopBooleanIpAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BooleanVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopBooleanIpAggregator.combine(state, vValue, extraValue);
    }
  }

  private void addRawVector(BooleanVector vVector, BytesRefVector extraVector, BooleanVector mask) {
    BytesRef extraScratch = new BytesRef();
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
  ...
  private void addRawBlock(BooleanBlock vBlock, BytesRefBlock extraBlock) {
    BytesRef extraScratch = new BytesRef();
  ...
  private void addRawBlock(BooleanBlock vBlock, BytesRefBlock extraBlock, BooleanVector mask) {
    BytesRef extraScratch = new BytesRef();
    for (int p = 0; p < vBlock.getPositionCount(); p++) {
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopBooleanIpAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopBooleanIpAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link TopBytesRefBooleanAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class TopBytesRefBooleanGroupingAggregatorFunction implements GroupingAggregatorFunction {
  private static final List<IntermediateStateDesc> INTERMEDIATE_STATE_DESC = List.of(
      new IntermediateStateDesc("top", ElementType.BYTES_REF),
      new IntermediateStateDesc("extra", ElementType.BOOLEAN)  );

  private final TopBytesRefBooleanAggregator.GroupingState state;
  ...
  public TopBytesRefBooleanGroupingAggregatorFunction(List<Integer> channels,
      TopBytesRefBooleanAggregator.GroupingState state, DriverContext driverContext, int limit,
      boolean ascending) {
  ...
  public static TopBytesRefBooleanGroupingAggregatorFunction create(List<Integer> channels,
      DriverContext driverContext, int limit, boolean ascending) {
    return new TopBytesRefBooleanGroupingAggregatorFunction(channels, TopBytesRefBooleanAggregator.initGrouping(driverContext.bigArrays(), limit, ascending), driverContext, limit, ascending);
  }
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        for (int vOffset = vStart; vOffset < vEnd; vOffset++) {
          ...
          for (int extraOffset = extraStart; extraOffset < extraEnd; extraOffset++) {
            ...
            TopBytesRefBooleanAggregator.combine(state, groupId, vValue, extraValue);
          }
        }
      }
    }
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        int groupId = groups.getInt(g);
        int valuesPosition = groupPosition + positionOffset;
        TopBytesRefBooleanAggregator.combineIntermediate(state, groupId, top, extra, valuesPosition);
      }
    }
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, IntVector selected,
    ...
    blocks[offset] = TopBytesRefBooleanAggregator.evaluateFinal(state, selected, ctx);
  }

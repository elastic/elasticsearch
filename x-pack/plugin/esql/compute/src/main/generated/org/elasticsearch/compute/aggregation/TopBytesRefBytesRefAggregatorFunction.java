...
public final class TopBytesRefBytesRefAggregatorFunction implements AggregatorFunction {
  ...
  public TopBytesRefBytesRefAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopBytesRefBytesRefAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopBytesRefBytesRefAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopBytesRefBytesRefAggregatorFunction(driverContext, channels, TopBytesRefBytesRefAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BytesRefVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopBytesRefBytesRefAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopBytesRefBytesRefAggregator.combineIntermediate(state, top, extra);
  }

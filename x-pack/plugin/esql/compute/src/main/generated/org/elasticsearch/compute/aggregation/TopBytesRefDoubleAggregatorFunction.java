...
public final class TopBytesRefDoubleAggregatorFunction implements AggregatorFunction {
  ...
  public TopBytesRefDoubleAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopBytesRefDoubleAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopBytesRefDoubleAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopBytesRefDoubleAggregatorFunction(driverContext, channels, TopBytesRefDoubleAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BytesRefVector vVector, DoubleVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopBytesRefDoubleAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopBytesRefDoubleAggregator.combineIntermediate(state, top, extra);
  }

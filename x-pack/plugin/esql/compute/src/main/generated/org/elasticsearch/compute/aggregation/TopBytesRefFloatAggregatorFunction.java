...
public final class TopBytesRefFloatAggregatorFunction implements AggregatorFunction {
  ...
  public TopBytesRefFloatAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopBytesRefFloatAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopBytesRefFloatAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopBytesRefFloatAggregatorFunction(driverContext, channels, TopBytesRefFloatAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BytesRefVector vVector, FloatVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopBytesRefFloatAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopBytesRefFloatAggregator.combineIntermediate(state, top, extra);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link TopBytesRefIpAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopBytesRefIpAggregatorFunction implements AggregatorFunction {
  ...
  private final TopBytesRefIpAggregator.SingleState state;
  ...
  public TopBytesRefIpAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopBytesRefIpAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopBytesRefIpAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopBytesRefIpAggregatorFunction(driverContext, channels, TopBytesRefIpAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BytesRefVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopBytesRefIpAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopBytesRefIpAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopBytesRefIpAggregator.evaluateFinal(state, driverContext);
  }

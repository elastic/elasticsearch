...
public final class TopDoubleIntGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  TopDoubleIntGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext,
      int limit, boolean ascending) {
    this.limit = limit;
    this.ascending = ascending;
    this.channels = channels;
    this.state = TopDoubleIntAggregator.initGrouping(driverContext.bigArrays(), limit, ascending);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = TopDoubleIntAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link TopDoubleIpAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopDoubleIpAggregatorFunction implements AggregatorFunction {
  ...
  private final TopDoubleIpAggregator.SingleState state;
  ...
  public TopDoubleIpAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopDoubleIpAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopDoubleIpAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopDoubleIpAggregatorFunction(driverContext, channels, TopDoubleIpAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(DoubleVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopDoubleIpAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopDoubleIpAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopDoubleIpAggregator.evaluateFinal(state, driverContext);
  }

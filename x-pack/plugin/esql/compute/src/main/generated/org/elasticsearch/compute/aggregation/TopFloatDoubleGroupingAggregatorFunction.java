...
public final class TopFloatDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  TopFloatDoubleGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext,
      int limit, boolean ascending) {
    this.limit = limit;
    this.ascending = ascending;
    this.channels = channels;
    this.state = TopFloatDoubleAggregator.initGrouping(driverContext.bigArrays(), limit, ascending);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = TopFloatDoubleAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

...
public final class TopFloatIntGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  TopFloatIntGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext,
      int limit, boolean ascending) {
    this.limit = limit;
    this.ascending = ascending;
    this.channels = channels;
    this.state = TopFloatIntAggregator.initGrouping(driverContext.bigArrays(), limit, ascending);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = TopFloatIntAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

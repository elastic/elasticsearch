...
/**
 * {@link AggregatorFunction} implementation for {@link TopFloatIpAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopFloatIpAggregatorFunction implements AggregatorFunction {
  ...
  private final TopFloatIpAggregator.SingleState state;
  ...
  public TopFloatIpAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopFloatIpAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopFloatIpAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopFloatIpAggregatorFunction(driverContext, channels, TopFloatIpAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(FloatVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopFloatIpAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopFloatIpAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopFloatIpAggregator.evaluateFinal(state, driverContext);
  }

...
public final class TopFloatLongGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  TopFloatLongGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext,
      int limit, boolean ascending) {
    this.limit = limit;
    this.ascending = ascending;
    this.channels = channels;
    this.state = TopFloatLongAggregator.initGrouping(driverContext.bigArrays(), limit, ascending);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = TopFloatLongAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

...
public final class TopIntBytesRefAggregatorFunction implements AggregatorFunction {
  ...
  public TopIntBytesRefAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopIntBytesRefAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopIntBytesRefAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopIntBytesRefAggregatorFunction(driverContext, channels, TopIntBytesRefAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(IntVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopIntBytesRefAggregator.combine(state, vValue, extraValue);
    }
  }

  private void addRawVector(IntVector vVector, BytesRefVector extraVector, BooleanVector mask) {
    BytesRef extraScratch = new BytesRef();
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
  ...
  private void addRawBlock(IntBlock vBlock, BytesRefBlock extraBlock) {
    BytesRef extraScratch = new BytesRef();
  ...
  private void addRawBlock(IntBlock vBlock, BytesRefBlock extraBlock, BooleanVector mask) {
    BytesRef extraScratch = new BytesRef();
    for (int p = 0; p < vBlock.getPositionCount(); p++) {
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopIntBytesRefAggregator.combineIntermediate(state, top, extra);
  }

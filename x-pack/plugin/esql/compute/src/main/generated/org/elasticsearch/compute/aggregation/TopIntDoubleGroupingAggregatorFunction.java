...
public final class TopIntDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  TopIntDoubleGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext,
      int limit, boolean ascending) {
    this.limit = limit;
    this.ascending = ascending;
    this.channels = channels;
    this.state = TopIntDoubleAggregator.initGrouping(driverContext.bigArrays(), limit, ascending);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = TopIntDoubleAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

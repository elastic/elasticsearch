...
public final class TopIntIntGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  TopIntIntGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext,
      int limit, boolean ascending) {
    this.limit = limit;
    this.ascending = ascending;
    this.channels = channels;
    this.state = TopIntIntAggregator.initGrouping(driverContext.bigArrays(), limit, ascending);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = TopIntIntAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

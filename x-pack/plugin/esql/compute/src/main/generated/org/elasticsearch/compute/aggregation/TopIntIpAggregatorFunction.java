...
/**
 * {@link AggregatorFunction} implementation for {@link TopIntIpAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopIntIpAggregatorFunction implements AggregatorFunction {
  ...
  private final TopIntIpAggregator.SingleState state;
  ...
  public TopIntIpAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopIntIpAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopIntIpAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopIntIpAggregatorFunction(driverContext, channels, TopIntIpAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(IntVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopIntIpAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopIntIpAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopIntIpAggregator.evaluateFinal(state, driverContext);
  }

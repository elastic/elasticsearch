...
public final class TopIntLongGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  TopIntLongGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext,
      int limit, boolean ascending) {
    this.limit = limit;
    this.ascending = ascending;
    this.channels = channels;
    this.state = TopIntLongAggregator.initGrouping(driverContext.bigArrays(), limit, ascending);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = TopIntLongAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

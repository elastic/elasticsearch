...
/**
 * {@link AggregatorFunction} implementation for {@link TopIpDoubleAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopIpDoubleAggregatorFunction implements AggregatorFunction {
  ...
  private final TopIpDoubleAggregator.SingleState state;
  ...
  public TopIpDoubleAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopIpDoubleAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopIpDoubleAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopIpDoubleAggregatorFunction(driverContext, channels, TopIpDoubleAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BytesRefVector vVector, DoubleVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopIpDoubleAggregator.combine(state, vValue, extraValue);
    }
  }

  private void addRawVector(BytesRefVector vVector, DoubleVector extraVector, BooleanVector mask) {
    BytesRef vScratch = new BytesRef();
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
  ...
  private void addRawBlock(BytesRefBlock vBlock, DoubleBlock extraBlock) {
    BytesRef vScratch = new BytesRef();
  ...
  private void addRawBlock(BytesRefBlock vBlock, DoubleBlock extraBlock, BooleanVector mask) {
    BytesRef vScratch = new BytesRef();
    for (int p = 0; p < vBlock.getPositionCount(); p++) {
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopIpDoubleAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopIpDoubleAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link TopIpFloatAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopIpFloatAggregatorFunction implements AggregatorFunction {
  ...
  private final TopIpFloatAggregator.SingleState state;
  ...
  public TopIpFloatAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopIpFloatAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopIpFloatAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopIpFloatAggregatorFunction(driverContext, channels, TopIpFloatAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BytesRefVector vVector, FloatVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopIpFloatAggregator.combine(state, vValue, extraValue);
    }
  }

  private void addRawVector(BytesRefVector vVector, FloatVector extraVector, BooleanVector mask) {
    BytesRef vScratch = new BytesRef();
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
  ...
  private void addRawBlock(BytesRefBlock vBlock, FloatBlock extraBlock) {
    BytesRef vScratch = new BytesRef();
  ...
  private void addRawBlock(BytesRefBlock vBlock, FloatBlock extraBlock, BooleanVector mask) {
    BytesRef vScratch = new BytesRef();
    for (int p = 0; p < vBlock.getPositionCount(); p++) {
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopIpFloatAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopIpFloatAggregator.evaluateFinal(state, driverContext);
  }

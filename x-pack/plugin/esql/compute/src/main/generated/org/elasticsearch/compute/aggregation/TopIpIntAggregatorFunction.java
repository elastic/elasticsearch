...
/**
 * {@link AggregatorFunction} implementation for {@link TopIpIntAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopIpIntAggregatorFunction implements AggregatorFunction {
  ...
  private final TopIpIntAggregator.SingleState state;
  ...
  public TopIpIntAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopIpIntAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopIpIntAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopIpIntAggregatorFunction(driverContext, channels, TopIpIntAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BytesRefVector vVector, IntVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopIpIntAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopIpIntAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopIpIntAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link TopIpIpAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopIpIpAggregatorFunction implements AggregatorFunction {
  ...
  private final TopIpIpAggregator.SingleState state;
  ...
  public TopIpIpAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopIpIpAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopIpIpAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopIpIpAggregatorFunction(driverContext, channels, TopIpIpAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BytesRefVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopIpIpAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopIpIpAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopIpIpAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link TopIpLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopIpLongAggregatorFunction implements AggregatorFunction {
  ...
  private final TopIpLongAggregator.SingleState state;
  ...
  public TopIpLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopIpLongAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopIpLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopIpLongAggregatorFunction(driverContext, channels, TopIpLongAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(BytesRefVector vVector, LongVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopIpLongAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopIpLongAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopIpLongAggregator.evaluateFinal(state, driverContext);
  }

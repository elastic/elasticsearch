...
public final class TopLongBytesRefAggregatorFunction implements AggregatorFunction {
  ...
  public TopLongBytesRefAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopLongBytesRefAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopLongBytesRefAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopLongBytesRefAggregatorFunction(driverContext, channels, TopLongBytesRefAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(LongVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopLongBytesRefAggregator.combine(state, vValue, extraValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopLongBytesRefAggregator.combineIntermediate(state, top, extra);
  }

...
public final class TopLongFloatAggregatorFunction implements AggregatorFunction {
  ...
  TopLongFloatAggregatorFunction(DriverContext driverContext, List<Integer> channels, int limit,
      boolean ascending) {
    this.limit = limit;
    this.ascending = ascending;
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = TopLongFloatAggregator.initSingle(driverContext.bigArrays(), limit, ascending);
  }
  ...
  private void addRawVectorLongArrayVector(LongArrayVector vVector, FloatVector outputValueVector) {
  ...
  private void addRawVectorGeneric(LongVector vVector, FloatVector outputValueVector) {
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      long vValue = vVector.getLong(valuesPosition);
      float outputValueValue = outputValueVector.getFloat(valuesPosition);
      TopLongFloatAggregator.combine(state, vValue, outputValueValue);

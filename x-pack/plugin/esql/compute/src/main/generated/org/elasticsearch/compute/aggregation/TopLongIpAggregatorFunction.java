...
/**
 * {@link AggregatorFunction} implementation for {@link TopLongIpAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class TopLongIpAggregatorFunction implements AggregatorFunction {
  ...
  private final TopLongIpAggregator.SingleState state;
  ...
  public TopLongIpAggregatorFunction(DriverContext driverContext, List<Integer> channels,
      TopLongIpAggregator.SingleState state, int limit, boolean ascending) {
  ...
  public static TopLongIpAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels, int limit, boolean ascending) {
    return new TopLongIpAggregatorFunction(driverContext, channels, TopLongIpAggregator.initSingle(driverContext.bigArrays(), limit, ascending), limit, ascending);
  }
  ...
  private void addRawVector(LongVector vVector, BytesRefVector extraVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
      ...
      TopLongIpAggregator.combine(state, vValue, extraValue);
    }
  }

  private void addRawVector(LongVector vVector, BytesRefVector extraVector, BooleanVector mask) {
    BytesRef extraScratch = new BytesRef();
    for (int valuesPosition = 0; valuesPosition < vVector.getPositionCount(); valuesPosition++) {
  ...
  private void addRawBlock(LongBlock vBlock, BytesRefBlock extraBlock) {
    BytesRef extraScratch = new BytesRef();
  ...
  private void addRawBlock(LongBlock vBlock, BytesRefBlock extraBlock, BooleanVector mask) {
    BytesRef extraScratch = new BytesRef();
    for (int p = 0; p < vBlock.getPositionCount(); p++) {
  ...
  public void addIntermediateInput(Page page) {
    ...
    TopLongIpAggregator.combineIntermediate(state, top, extra);
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = TopLongIpAggregator.evaluateFinal(state, driverContext);
  }

...
public final class TopLongLongGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  TopLongLongGroupingAggregatorFunction(List<Integer> channels, DriverContext driverContext,
      int limit, boolean ascending) {
    this.limit = limit;
    this.ascending = ascending;
    this.channels = channels;
    this.state = TopLongLongAggregator.initGrouping(driverContext.bigArrays(), limit, ascending);
  ...
  private void evaluateFinal(Block[] blocks, int offset, IntVector selectedInPage,
      GroupingAggregatorEvaluationContext ctx) {
    blocks[offset] = TopLongLongAggregator.evaluateFinal(state, selectedInPage, ctx);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link VariancePopulationDoubleAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class VariancePopulationDoubleAggregatorFunction implements AggregatorFunction {
  ...
  public VariancePopulationDoubleAggregatorFunction(DriverContext driverContext,
  ...
  public static VariancePopulationDoubleAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new VariancePopulationDoubleAggregatorFunction(driverContext, channels, VariancePopulationDoubleAggregator.initSingle());
  }
  ...
  private void addRawVector(DoubleVector vector) {
    for (int i = 0; i < vector.getPositionCount(); i++) {
      VariancePopulationDoubleAggregator.combine(state, vector.getDouble(i));
    }
  }
  ...
  private void addRawBlock(DoubleBlock block) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        VariancePopulationDoubleAggregator.combine(state, block.getDouble(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    VariancePopulationDoubleAggregator.combineIntermediate(state, mean.getDouble(0), m2.getDouble(0), count.getLong(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = VariancePopulationDoubleAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link VariancePopulationFloatAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class VariancePopulationFloatAggregatorFunction implements AggregatorFunction {
  ...
  public VariancePopulationFloatAggregatorFunction(DriverContext driverContext,
      List<Integer> channels, StdDevStates.SingleState state) {
    this.driverContext = driverContext;
    this.channels = channels;
    this.state = state;
  }

  public static VariancePopulationFloatAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new VariancePopulationFloatAggregatorFunction(driverContext, channels, VariancePopulationFloatAggregator.initSingle());
  }
  ...
  private void addRawVector(FloatVector vector) {
    for (int i = 0; i < vector.getPositionCount(); i++) {
      VariancePopulationFloatAggregator.combine(state, vector.getFloat(i));
    }
  }
  ...
  private void addRawBlock(FloatBlock block) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        VariancePopulationFloatAggregator.combine(state, block.getFloat(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    VariancePopulationFloatAggregator.combineIntermediate(state, mean.getDouble(0), m2.getDouble(0), count.getLong(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = VariancePopulationFloatAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link VariancePopulationIntAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class VariancePopulationIntAggregatorFunction implements AggregatorFunction {
  ...
  public VariancePopulationIntAggregatorFunction(DriverContext driverContext,
  ...
  public static VariancePopulationIntAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new VariancePopulationIntAggregatorFunction(driverContext, channels, VariancePopulationIntAggregator.initSingle());
  }
  ...
  private void addRawVector(IntVector vector) {
    for (int i = 0; i < vector.getPositionCount(); i++) {
      VariancePopulationIntAggregator.combine(state, vector.getInt(i));
    }
  }
  ...
  private void addRawBlock(IntBlock block) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        VariancePopulationIntAggregator.combine(state, block.getInt(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    VariancePopulationIntAggregator.combineIntermediate(state, mean.getDouble(0), m2.getDouble(0), count.getLong(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = VariancePopulationIntAggregator.evaluateFinal(state, driverContext);
  }

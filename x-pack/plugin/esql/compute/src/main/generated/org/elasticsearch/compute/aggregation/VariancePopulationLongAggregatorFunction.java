...
/**
 * {@link AggregatorFunction} implementation for {@link VariancePopulationLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class VariancePopulationLongAggregatorFunction implements AggregatorFunction {
  ...
  public VariancePopulationLongAggregatorFunction(DriverContext driverContext,
  ...
  public static VariancePopulationLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new VariancePopulationLongAggregatorFunction(driverContext, channels, VariancePopulationLongAggregator.initSingle());
  }
  ...
  private void addRawVector(LongVector vector) {
    for (int i = 0; i < vector.getPositionCount(); i++) {
      VariancePopulationLongAggregator.combine(state, vector.getLong(i));
    }
  }
  ...
  private void addRawBlock(LongBlock block) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        VariancePopulationLongAggregator.combine(state, block.getLong(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    VariancePopulationLongAggregator.combineIntermediate(state, mean.getDouble(0), m2.getDouble(0), count.getLong(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = VariancePopulationLongAggregator.evaluateFinal(state, driverContext);
  }

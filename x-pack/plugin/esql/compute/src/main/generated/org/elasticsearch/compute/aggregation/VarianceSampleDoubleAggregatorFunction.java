...
/**
 * {@link AggregatorFunction} implementation for {@link VarianceSampleDoubleAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class VarianceSampleDoubleAggregatorFunction implements AggregatorFunction {
  ...
  public VarianceSampleDoubleAggregatorFunction(DriverContext driverContext, List<Integer> channels,
  ...
  public static VarianceSampleDoubleAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new VarianceSampleDoubleAggregatorFunction(driverContext, channels, VarianceSampleDoubleAggregator.initSingle());
  }
  ...
  private void addRawVector(DoubleVector vector) {
    for (int i = 0; i < vector.getPositionCount(); i++) {
      VarianceSampleDoubleAggregator.combine(state, vector.getDouble(i));
    }
  }
  ...
  private void addRawBlock(DoubleBlock block) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        VarianceSampleDoubleAggregator.combine(state, block.getDouble(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    VarianceSampleDoubleAggregator.combineIntermediate(state, mean.getDouble(0), m2.getDouble(0), count.getLong(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = VarianceSampleDoubleAggregator.evaluateFinal(state, driverContext);
  }

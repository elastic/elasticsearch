...
/**
 * {@link AggregatorFunction} implementation for {@link VarianceSampleFloatAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class VarianceSampleFloatAggregatorFunction implements AggregatorFunction {
  ...
  public VarianceSampleFloatAggregatorFunction(DriverContext driverContext, List<Integer> channels,
  ...
  public static VarianceSampleFloatAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new VarianceSampleFloatAggregatorFunction(driverContext, channels, VarianceSampleFloatAggregator.initSingle());
  }
  ...
  private void addRawVector(FloatVector vector) {
    for (int i = 0; i < vector.getPositionCount(); i++) {
      VarianceSampleFloatAggregator.combine(state, vector.getFloat(i));
    }
  }
  ...
  private void addRawBlock(FloatBlock block) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        VarianceSampleFloatAggregator.combine(state, block.getFloat(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    VarianceSampleFloatAggregator.combineIntermediate(state, mean.getDouble(0), m2.getDouble(0), count.getLong(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = VarianceSampleFloatAggregator.evaluateFinal(state, driverContext);
  }

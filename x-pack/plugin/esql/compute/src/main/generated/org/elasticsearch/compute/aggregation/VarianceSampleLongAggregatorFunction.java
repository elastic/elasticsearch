...
/**
 * {@link AggregatorFunction} implementation for {@link VarianceSampleLongAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class VarianceSampleLongAggregatorFunction implements AggregatorFunction {
  ...
  public VarianceSampleLongAggregatorFunction(DriverContext driverContext, List<Integer> channels,
  ...
  public static VarianceSampleLongAggregatorFunction create(DriverContext driverContext,
      List<Integer> channels) {
    return new VarianceSampleLongAggregatorFunction(driverContext, channels, VarianceSampleLongAggregator.initSingle());
  }
  ...
  private void addRawVector(LongVector vector) {
    for (int i = 0; i < vector.getPositionCount(); i++) {
      VarianceSampleLongAggregator.combine(state, vector.getLong(i));
    }
  }
  ...
  private void addRawBlock(LongBlock block) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        VarianceSampleLongAggregator.combine(state, block.getLong(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    VarianceSampleLongAggregator.combineIntermediate(state, mean.getDouble(0), m2.getDouble(0), count.getLong(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = VarianceSampleLongAggregator.evaluateFinal(state, driverContext);
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link SpatialCentroidCartesianShapeSourceValuesAggregator}.
 * This class is generated. Edit {@code AggregatorImplementer} instead.
 */
public final class SpatialCentroidCartesianShapeSourceValuesAggregatorFunction implements AggregatorFunction {
  ...
  public SpatialCentroidCartesianShapeSourceValuesAggregatorFunction(DriverContext driverContext,
  ...
  public static SpatialCentroidCartesianShapeSourceValuesAggregatorFunction create(
      DriverContext driverContext, List<Integer> channels) {
    return new SpatialCentroidCartesianShapeSourceValuesAggregatorFunction(driverContext, channels, SpatialCentroidCartesianShapeSourceValuesAggregator.initSingle());
  }
  ...
  private void addRawVector(BytesRefVector wkbVector) {
    ...
    for (int valuesPosition = 0; valuesPosition < wkbVector.getPositionCount(); valuesPosition++) {
      ...
      SpatialCentroidCartesianShapeSourceValuesAggregator.combine(state, wkbValue);
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    SpatialCentroidCartesianShapeSourceValuesAggregator.combineIntermediate(state, xVal.getDouble(0), xDel.getDouble(0), yVal.getDouble(0), yDel.getDouble(0), weight.getDouble(0), shapeType.getInt(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = SpatialCentroidCartesianShapeSourceValuesAggregator.evaluateFinal(state, driverContext);
  }

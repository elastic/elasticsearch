...
/**
 * {@link GroupingAggregatorFunction} implementation for {@link SpatialCentroidCartesianShapeSourceValuesAggregator}.
 * This class is generated. Edit {@code GroupingAggregatorImplementer} instead.
 */
public final class SpatialCentroidCartesianShapeSourceValuesGroupingAggregatorFunction implements GroupingAggregatorFunction {
  ...
  public SpatialCentroidCartesianShapeSourceValuesGroupingAggregatorFunction(List<Integer> channels,
  ...
  public static SpatialCentroidCartesianShapeSourceValuesGroupingAggregatorFunction create(
      List<Integer> channels, DriverContext driverContext) {
    return new SpatialCentroidCartesianShapeSourceValuesGroupingAggregatorFunction(channels, SpatialCentroidCartesianShapeSourceValuesAggregator.initGrouping(driverContext.bigArrays()), driverContext);
  }
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        ...
        for (int wkbOffset = wkbStart; wkbOffset < wkbEnd; wkbOffset++) {
          ...
          SpatialCentroidCartesianShapeSourceValuesAggregator.combine(state, groupId, wkbValue);
        }
      }
    }
  }
  ...
  public void addIntermediateInput(int positionOffset, IntArrayBlock groups, Page page) {
    ...
    for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
      ...
      for (int g = groupStart; g < groupEnd; g++) {
        int groupId = groups.getInt(g);
        int valuesPosition = groupPosition + positionOffset;
        SpatialCentroidCartesianShapeSourceValuesAggregator.combineIntermediate(state, groupId, xVal.getDouble(valuesPosition), xDel.getDouble(valuesPosition), yVal.getDouble(valuesPosition), yDel.getDouble(valuesPosition), weight.getDouble(valuesPosition), shapeType.getInt(valuesPosition));
      }
    }
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, IntVector selected,
    ...
    blocks[offset] = SpatialCentroidCartesianShapeSourceValuesAggregator.evaluateFinal(state, selected, ctx);
  }

...
public final class SpatialExtentGeoShapeSourceValuesAggregatorFunction implements AggregatorFunction {
  ...
  public void addIntermediateInput(Page page) {
    ...
    SpatialExtentGeoShapeSourceValuesAggregator.combineIntermediate(state, minNegX.getInt(0), minPosX.getInt(0), maxNegX.getInt(0), maxPosX.getInt(0), maxY.getInt(0), minY.getInt(0));
  }

...
/**
 * {@link AggregatorFunction} implementation for {@link SpatialStExtentCartesianShapeAggregator}.
...
public final class SpatialStExtentCartesianShapeAggregatorFunction implements AggregatorFunction {
  ...
  public static SpatialStExtentCartesianShapeAggregatorFunction create(DriverContext driverContext,
    ...
    return new SpatialStExtentCartesianShapeAggregatorFunction(driverContext, channels, SpatialStExtentCartesianShapeAggregator.initSingle());
  }
  ...
  private void addRawVector(BytesRefVector vector) {
    ...
    for (int i = 0; i < vector.getPositionCount(); i++) {
      SpatialStExtentCartesianShapeAggregator.combine(state, vector.getBytesRef(i, scratch));
    }
  }
  ...
  private void addRawBlock(BytesRefBlock block) {
    ...
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        SpatialStExtentCartesianShapeAggregator.combine(state, block.getBytesRef(i, scratch));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    SpatialStExtentCartesianShapeAggregator.combineIntermediate(state, minX.getInt(0), maxX.getInt(0), maxY.getInt(0), minY.getInt(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = SpatialStExtentCartesianShapeAggregator.evaluateFinal(state, driverContext);
  }

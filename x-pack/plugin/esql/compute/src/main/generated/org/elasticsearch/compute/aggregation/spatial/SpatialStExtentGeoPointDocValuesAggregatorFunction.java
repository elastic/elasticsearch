...
/**
 * {@link AggregatorFunction} implementation for {@link SpatialStExtentGeoPointDocValuesAggregator}.
 * This class is generated. Do not edit it.
 */
public final class SpatialStExtentGeoPointDocValuesAggregatorFunction implements AggregatorFunction {
  ...
  public static SpatialStExtentGeoPointDocValuesAggregatorFunction create(
      DriverContext driverContext, List<Integer> channels) {
    return new SpatialStExtentGeoPointDocValuesAggregatorFunction(driverContext, channels, SpatialStExtentGeoPointDocValuesAggregator.initSingle());
  }
  ...
  private void addRawVector(LongVector vector) {
    for (int i = 0; i < vector.getPositionCount(); i++) {
      SpatialStExtentGeoPointDocValuesAggregator.combine(state, vector.getLong(i));
    }
  }
  ...
  private void addRawBlock(LongBlock block) {
    for (int p = 0; p < block.getPositionCount(); p++) {
      ...
      for (int i = start; i < end; i++) {
        SpatialStExtentGeoPointDocValuesAggregator.combine(state, block.getLong(i));
      }
    }
  }
  ...
  public void addIntermediateInput(Page page) {
    ...
    SpatialStExtentGeoPointDocValuesAggregator.combineIntermediate(state, minNegX.getInt(0), minPosX.getInt(0), maxNegX.getInt(0), maxPosX.getInt(0), maxY.getInt(0), minY.getInt(0));
  }
  ...
  public void evaluateFinal(Block[] blocks, int offset, DriverContext driverContext) {
    blocks[offset] = SpatialStExtentGeoPointDocValuesAggregator.evaluateFinal(state, driverContext);
  }

...
class LastValueDoubleAggregator {
    ...
    public static void combine(LastValueStates.SingleState current, double v, long ts) {
        current.add(v, ts);
    }
    ...
    public static void combine(LastValueStates.GroupingState state, int groupId, double v, long ts) {

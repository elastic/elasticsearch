...
class LastValueLongAggregator {
    ...
    public static void combine(LastValueStates.SingleState current, long v, long ts) {
        current.add(v, ts);
    }
    ...
    public static void combine(LastValueStates.GroupingState state, int groupId, long v, long ts) {

 ...
 * Unlike {@link MaxDoubleAggregator} (which seeds with a {@code -Double.MAX_VALUE} sentinel and uses {@code Math.max}, propagating
...
@GroupingAggregator
class MaxNonFiniteDoubleAggregator {

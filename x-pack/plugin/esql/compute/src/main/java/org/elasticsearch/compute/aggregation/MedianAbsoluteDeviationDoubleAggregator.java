...
class MedianAbsoluteDeviationDoubleAggregator {
    ...
    public static void combine(MedianAbsoluteDeviationStates.UngroupedState current, double v) {
        current.add(v);
    }
    ...
    public static void combine(MedianAbsoluteDeviationStates.GroupingState state, int groupId, double v) {
        state.add(groupId, v);
    }

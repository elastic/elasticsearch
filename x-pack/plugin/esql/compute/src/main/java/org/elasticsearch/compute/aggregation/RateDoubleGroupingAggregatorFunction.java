...
public final class RateDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
    ...
    public static RateDoubleGroupingAggregatorFunction create(List<Integer> channels, DriverContext driverContext, BigArrays bigArrays) {
    ...
    private void addRawInput(int positionOffset, IntVector groups, DoubleBlock values, LongBlock timestamps) {
        for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
            ...
            for (int v = valuesStart; v < valuesEnd; v++) {
                RateDoubleAggregator.combine(state, groupId, values.getDouble(v), timestamps.getLong(v));
            }
        }
    }
    ...
    private void addRawInput(int positionOffset, IntVector groups, DoubleVector values, LongVector timestamps) {
        for (int groupPosition = 0; groupPosition < groups.getPositionCount(); groupPosition++) {
            ...
            RateDoubleAggregator.combine(state, groupId, values.getDouble(offset), timestamps.getLong(offset));
        }
    }
    ...
    public void evaluateFinal(Block[] blocks, int offset, IntVector selected, DriverContext driverContext) {
        ...
        blocks[offset] = RateDoubleAggregator.evaluateFinal(state, selected, tsids, driverContext);
    }

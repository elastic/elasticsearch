 ...
 *
 */
public final class OldRateDoubleAggregator {
    ...
    public static final class DoubleRateGroupingState implements Releasable, Accountable, GroupingAggregatorState {
        ...
        public DoubleRateGroupingState(BigArrays bigArrays, CircuitBreaker breaker) {
        ...
        public void combine(int groupId, LongBlock timestamps, DoubleBlock values, int sampleCount, double reset, int otherPosition) {

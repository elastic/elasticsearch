...
/**
 * Shared implementation for builders that emit {@link OrdinalBytesRefBlock}s from a stream of ordinals into a backing
 * {@link SortedSetDocValues}. Concrete subclasses declare the {@link Block.MvOrdering} that describes the in-position
 * ordering of ords appended through this builder. The base handles construction, append API, dictionary build, and
 * dense-renumbering of ords; it does not assume sorted-deduped input, so subclasses are free to declare any honest
 * {@link Block.MvOrdering}.
 */
abstract class OrdinalsBuilderBase implements BlockLoader.SortedSetOrdinalsBuilder, Releasable, Block.Builder {
    ...
    OrdinalsBuilderBase(BlockFactory blockFactory, SortedSetDocValues docValues, int count) {
    ...
    /**
     * Ordering claim attached to this builder's output IntBlock. Must reflect how the subclass actually appends ords.
     */
    protected abstract Block.MvOrdering mvOrdering();

    @Override
    public final OrdinalsBuilderBase appendNull() {
        ordsBuilder.appendNull();
        return this;
    }

    @Override
    public final OrdinalsBuilderBase appendOrd(int ord) {
    ...
    @Override
    public final OrdinalsBuilderBase beginPositionEntry() {
        ordsBuilder.beginPositionEntry();
        return this;
    }

    @Override
    public final OrdinalsBuilderBase endPositionEntry() {
    ...
    @Override
    public final BytesRefBlock build() {
    ...
    @Override
    public final Block.Builder copyFrom(Block block, int beginInclusive, int endExclusive) {
        throw new UnsupportedOperationException();
    }

    @Override
    public final Block.Builder mvOrdering(Block.MvOrdering mvOrdering) {
        throw new UnsupportedOperationException();
    }

...
public class AllFirstBytesRefByLongGroupingAggregatorFunctionTests extends GroupingAggregatorFunctionTestCase {
    @Override
    protected SourceOperator simpleInput(BlockFactory blockFactory, int size) {
        ...
        return new ListRowsBlockSourceOperator(
            ...
            IntStream.range(0, size)
                .mapToObj(l -> List.of(randomLongBetween(0, 4), randomAlphanumericOfLength(randomInt(20)), tsgen.gen()))
                .toList()
        );
    }
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllFirstBytesRefByLongAggregatorFunctionSupplier();
    }

    @Override
    protected String expectedDescriptionOfAggregator() {
        return "all_first_bytesref_by_long";
    }

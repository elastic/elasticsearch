...
public class AllFirstBytesRefByTimestampGroupingAggregatorFunctionTests extends GroupingAggregatorFunctionTestCase {
    @Override
    protected SourceOperator simpleInput(BlockFactory blockFactory, int size) {
        ...
        return new ListRowsBlockSourceOperator(
            blockFactory,
            List.of(ElementType.LONG, ElementType.BYTES_REF, ElementType.LONG),
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllFirstBytesRefByTimestampAggregatorFunctionSupplier();
    }

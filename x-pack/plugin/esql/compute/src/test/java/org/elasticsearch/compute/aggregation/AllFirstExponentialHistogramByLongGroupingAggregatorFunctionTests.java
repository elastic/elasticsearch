...
public class AllFirstExponentialHistogramByLongGroupingAggregatorFunctionTests extends GroupingAggregatorFunctionTestCase {
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllFirstExponentialHistogramByLongAggregatorFunctionSupplier();
    }

    @Override
    protected String expectedDescriptionOfAggregator() {
        return "all_first_ExponentialHistogram_by_long";
    }

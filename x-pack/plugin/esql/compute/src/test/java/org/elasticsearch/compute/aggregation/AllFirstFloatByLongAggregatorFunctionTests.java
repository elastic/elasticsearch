...
public class AllFirstFloatByLongAggregatorFunctionTests extends AggregatorFunctionTestCase {
    @Override
    protected SourceOperator simpleInput(BlockFactory blockFactory, int size) {
        ...
        return new ListRowsBlockSourceOperator(
            ...
            IntStream.range(0, size).mapToObj(l -> List.of(randomFloat(), tsgen.gen())).toList()
        );
    }

    @Override
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllFirstFloatByLongAggregatorFunctionSupplier();
    }

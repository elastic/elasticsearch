...
public class AllFirstTDigestByLongGroupingAggregatorFunctionTests extends GroupingAggregatorFunctionTestCase {
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllFirstTDigestByLongAggregatorFunctionSupplier();
    }

    @Override
    protected String expectedDescriptionOfAggregator() {
        return "all_first_TDigest_by_long";
    }

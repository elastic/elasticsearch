...
public class AllLastBytesRefByTimestampGroupingAggregatorFunctionTests extends GroupingAggregatorFunctionTestCase {
    @Override
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllLastBytesRefByTimestampAggregatorFunctionSupplier();
    }

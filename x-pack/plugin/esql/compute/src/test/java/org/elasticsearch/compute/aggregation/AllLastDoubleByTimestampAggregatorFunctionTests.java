...
public class AllLastDoubleByTimestampAggregatorFunctionTests extends AggregatorFunctionTestCase {
    @Override
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllLastDoubleByTimestampAggregatorFunctionSupplier();
    }

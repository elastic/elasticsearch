...
public class AllLastExponentialHistogramByIntGroupingAggregatorFunctionTests extends GroupingAggregatorFunctionTestCase {
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllLastExponentialHistogramByIntAggregatorFunctionSupplier();
    }

    @Override
    protected String expectedDescriptionOfAggregator() {
        return "all_last_ExponentialHistogram_by_int";
    }

...
public class AllLastFloatByLongGroupingAggregatorFunctionTests extends GroupingAggregatorFunctionTestCase {
    @Override
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllLastFloatByLongAggregatorFunctionSupplier();
    }

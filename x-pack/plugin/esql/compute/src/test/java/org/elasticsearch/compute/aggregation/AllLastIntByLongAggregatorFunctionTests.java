...
public class AllLastIntByLongAggregatorFunctionTests extends AggregatorFunctionTestCase {
    @Override
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllLastIntByLongAggregatorFunctionSupplier();
    }

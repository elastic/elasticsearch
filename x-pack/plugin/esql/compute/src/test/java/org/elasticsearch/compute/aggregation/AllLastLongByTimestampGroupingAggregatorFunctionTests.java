...
public class AllLastLongByTimestampGroupingAggregatorFunctionTests extends GroupingAggregatorFunctionTestCase {
    @Override
    ...
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AllLastLongByTimestampAggregatorFunctionSupplier();
    }

...
public class AnyLongAggregatorFunctionTests extends AggregatorFunctionTestCase {
    @Override
    ...
    protected SourceOperator simpleInput(BlockFactory blockFactory, int size) {
        return new ListRowsBlockSourceOperator(
            ...
            IntStream.range(0, size).mapToObj(l -> List.of(randomLong())).toList()
        );
    }

    @Override
    protected AggregatorFunctionSupplier aggregatorFunction() {
        return new AnyLongAggregatorFunctionSupplier();
    }

...
public class FirstFloatByTimestampAggregatorFunctionTests extends AggregatorFunctionTestCase {
    @Override
    protected SourceOperator simpleInput(BlockFactory blockFactory, int size) {
        ...
        return new ListRowsBlockSourceOperator(
            blockFactory,
            List.of(ElementType.FLOAT, ElementType.LONG),
    ...
    public void assertSimpleOutput(List<Page> input, Block result) {
        ...
        for (Page page : input) {
            FloatBlock values = page.getBlock(0);

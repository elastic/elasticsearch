...
public class MedianIntAggregatorFunctionTests extends AggregatorFunctionTestCase {

    @Override
    protected SourceOperator simpleInput(int end) {
        List<Integer> values = Arrays.asList(12, 20, 20, 43, 60, 90, 125);
    ...
    protected AggregatorFunction.Factory aggregatorFunction() {
        return AggregatorFunction.MEDIAN_INTS;
    }

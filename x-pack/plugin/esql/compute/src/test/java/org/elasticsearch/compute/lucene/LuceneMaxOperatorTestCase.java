...
public abstract class LuceneMaxOperatorTestCase extends AnyOperatorTestCase {
    ...
    protected abstract LuceneMaxFactory.NumberType getNumberType();
    ...
    private LuceneMaxFactory simple(NumberTypeTest numberTypeTest, DataPartitioning dataPartitioning, int numDocs, int limit) {

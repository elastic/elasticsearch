...
public class DriverCompletionInfoBwcWarningsTests extends ESTestCase {
    ...
    public void testBwcReadTakesWarningsFromThreadContext() throws IOException {
        ...
        DriverCompletionInfo original = new DriverCompletionInfo(42L, 100L, List.of(), List.of(), Set.of());
        ...
        assertThat(first.warnings(), containsInAnyOrder("field [foo] is deprecated", "field [bar] is deprecated"));
    ...
    public void testNewVersionReadsWarningsFromWire() throws IOException {
        ...
        DriverCompletionInfo original = new DriverCompletionInfo(1L, 2L, List.of(), List.of(), Set.of("wire warning 1", "wire warning 2"));

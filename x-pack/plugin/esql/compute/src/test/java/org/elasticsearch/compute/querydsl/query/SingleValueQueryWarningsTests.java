...
public class SingleValueQueryWarningsTests extends ESTestCase {
    ...
    private static WarningSourceLocation testSource() {
        return new WarningSourceLocation(1, 1, "test");
    }
    ...
    private SingleValueMatchQuery newQuery(QueryWarnings bridge, String fieldName, String message) {
        ...
        return new SingleValueMatchQuery(fieldData, bridge, testSource(), message);
    }
    ...
    public void testRegisterDelegatesToBoundWarnings() {
        ...
        Warnings warnings = driverContext.createWarnings(testSource());
    ...
    public void testRegisterForUnknownQueryThrows() {
        ...
        Warnings warnings = collectingContext().createWarnings(testSource());
    ...
    public void testPerThreadIsolation() throws Exception {
        ...
        Warnings warningsA = collectingContext().createWarnings(new WarningSourceLocation(1, 1, "a"));
        Warnings warningsB = collectingContext().createWarnings(new WarningSourceLocation(1, 1, "b"));

...
public record RandomBlock(List<List<Object>> values, Block block) {
    ...
    public static RandomBlock randomBlock(
        ...
        return randomBlock(blockFactory, elementType, positionCount, nullAllowed, ESTestCase.randomBoolean(), minValuesPerPosition, maxValuesPerPosition, minDupsPerPosition, maxDupsPerPosition);
    }

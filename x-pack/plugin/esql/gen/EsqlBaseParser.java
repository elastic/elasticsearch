...
public class EsqlBaseParser extends Parser {
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EsqlBaseListener ) ((EsqlBaseListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EsqlBaseListener ) ((EsqlBaseListener)listener).exitExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EsqlBaseVisitor ) return ((EsqlBaseVisitor<? extends T>)visitor).visitExpr(this);

...
/**
 * Abstract base for {@link EsqlSpecForkIT}. Wraps every csv-spec test case with a
 * {@code FORK} suffix, exercising the FORK command with the same expected results

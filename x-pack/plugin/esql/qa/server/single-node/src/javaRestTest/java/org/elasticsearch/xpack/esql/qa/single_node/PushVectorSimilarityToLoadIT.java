...
/**
 * Tests for pushing vector similarity functions into field loading.
 * This test should be merged with {@link PushVectorSimilarityToLoadIT} when function pushing is not behind snapshot
 */
@ThreadLeakFilters(filters = TestClustersThreadFilter.class)
public class PushVectorSimilarityToLoadIT extends ESRestTestCase {
    @ClassRule

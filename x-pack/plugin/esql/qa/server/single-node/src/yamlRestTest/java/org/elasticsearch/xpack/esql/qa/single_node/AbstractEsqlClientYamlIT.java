...
abstract class AbstractEsqlClientYamlIT extends ESClientYamlSuiteTestCase {
    ...
    public static ElasticsearchCluster cluster = ElasticsearchCluster.local()
        ...
        // ES|QL federation (external data sources / datasets) is off by default; the esql/210_data_source.yml
        // and esql/220_dataset.yml YAML suites require the data_sources capability, so opt in here.

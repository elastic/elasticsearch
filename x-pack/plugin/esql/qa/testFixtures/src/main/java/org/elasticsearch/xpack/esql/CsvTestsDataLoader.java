...
public class CsvTestsDataLoader {
    ...
    private static final TestDataset DATE_NANOS_LOOKUP = new TestDataset("date_nanos_lookup").withSetting("lookup-settings.json");
    ...
    public static final Map<String, TestDataset> CSV_DATASET_MAP = Map.ofEntries(
        ...
        Map.entry(DATE_NANOS_LOOKUP.indexName, DATE_NANOS_LOOKUP),

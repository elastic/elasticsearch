...
public class CsvIT extends ESTestCase {
    ...
    public final void test() throws Throwable {
        ...
        if (testCase.timestampBoundsGte != null && testCase.timestampBoundsGte.isEmpty() == false) {
            request.filter(new RangeQueryBuilder("@timestamp").gte(testCase.timestampBoundsGte).lte(testCase.timestampBoundsLte));
        }

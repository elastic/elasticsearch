...
public class AsyncCrossClustersQueryIT extends AbstractMultiClustersTestCase {
    ...
    public void testSyncQueryWithoutCancel() throws Exception {  // MP TODO: temp - either remove, or rename and change functionality
        ...
        EsqlQueryResponse response = requestFuture.get();
        System.err.println(response);
        System.err.println("DONE");
    }

    public void xtestCancel() throws Exception {
        createRemoteIndex(between(10, 100));
        EsqlQueryRequest request = EsqlQueryRequest.syncEsqlQueryRequest();
        request.query("FROM *:test | STATS total=sum(const) | LIMIT 1");
        request.pragmas(randomPragmas());

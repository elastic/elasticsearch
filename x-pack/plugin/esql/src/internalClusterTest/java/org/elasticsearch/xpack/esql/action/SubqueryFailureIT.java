 ...
 * Batch-execution failures during batched subquery execution are properly propagated, resources are cleaned up, and the correct error
 * is reported.
 */
...
public class SubqueryFailureIT extends AbstractEsqlIntegTestCase {
     ...
     * {@code MergeLevelExecutor}'s segment, then the outer one. With {@code allowPartialResults} the rows from every ok

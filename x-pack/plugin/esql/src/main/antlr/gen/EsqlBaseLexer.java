...
public class EsqlBaseLexer extends LexerConfig {
    ...
    public static final int LINE_COMMENT = 1, MULTILINE_COMMENT = 2, WS = 3;
    public static String[] channelNames = { "DEFAULT_TOKEN_CHANNEL", "HIDDEN" };

    public static String[] modeNames = { "DEFAULT_MODE" };

    private static String[] makeRuleNames() {
        return new String[] { "LINE_COMMENT", "MULTILINE_COMMENT", "WS" };
    }
    ...
    private static String[] makeSymbolicNames() {
        return new String[] { null, "LINE_COMMENT", "MULTILINE_COMMENT", "WS" };
    }

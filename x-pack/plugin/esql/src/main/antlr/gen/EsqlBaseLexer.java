// Generated from /Users/fang.xing/elasticsearch/x-pack/plugin/esql/src/main/antlr/EsqlBaseLexer.g4 by ANTLR 4.13.2
...
public class EsqlBaseLexer extends LexerConfig {
    ...
    public static final int DISSECT = 1, DROP = 2, ENRICH = 3, EVAL = 4, EXPLAIN = 5, FROM = 6, GROK = 7, KEEP = 8, LIMIT = 9, MV_EXPAND =
        10, RENAME = 11, ROW = 12, SHOW = 13, SORT = 14, STATS = 15, WHERE = 16, DEV_INLINESTATS = 17, DEV_LOOKUP = 18, DEV_METRICS = 19,
        DEV_JOIN = 20, DEV_JOIN_FULL = 21, DEV_JOIN_LEFT = 22, DEV_JOIN_RIGHT = 23, DEV_JOIN_LOOKUP = 24, UNKNOWN_CMD = 25, LINE_COMMENT =
            26, MULTILINE_COMMENT = 27, WS = 28, PIPE = 29, QUOTED_STRING = 30, INTEGER_LITERAL = 31, DECIMAL_LITERAL = 32, BY = 33, AND =
                34, ASC = 35, ASSIGN = 36, CAST_OP = 37, COLON = 38, COMMA = 39, DESC = 40, DOT = 41, FALSE = 42, FIRST = 43, IN = 44, IS =
                    45, LAST = 46, LIKE = 47, LP = 48, NOT = 49, NULL = 50, NULLS = 51, OR = 52, PARAM = 53, RLIKE = 54, RP = 55, TRUE = 56,
        EQ = 57, CIEQ = 58, NEQ = 59, LT = 60, LTE = 61, GT = 62, GTE = 63, PLUS = 64, MINUS = 65, ASTERISK = 66, SLASH = 67, PERCENT = 68,
        LEFT_BRACES = 69, RIGHT_BRACES = 70, NAMED_OR_POSITIONAL_PARAM = 71, OPENING_BRACKET = 72, CLOSING_BRACKET = 73,
        UNQUOTED_IDENTIFIER = 74, QUOTED_IDENTIFIER = 75, EXPR_LINE_COMMENT = 76, EXPR_MULTILINE_COMMENT = 77, EXPR_WS = 78, EXPLAIN_WS =
            79, EXPLAIN_LINE_COMMENT = 80, EXPLAIN_MULTILINE_COMMENT = 81, METADATA = 82, UNQUOTED_SOURCE = 83, FROM_LINE_COMMENT = 84,
        FROM_MULTILINE_COMMENT = 85, FROM_WS = 86, ID_PATTERN = 87, PROJECT_LINE_COMMENT = 88, PROJECT_MULTILINE_COMMENT = 89, PROJECT_WS =
            90, AS = 91, RENAME_LINE_COMMENT = 92, RENAME_MULTILINE_COMMENT = 93, RENAME_WS = 94, ON = 95, WITH = 96, ENRICH_POLICY_NAME =
                97, ENRICH_LINE_COMMENT = 98, ENRICH_MULTILINE_COMMENT = 99, ENRICH_WS = 100, ENRICH_FIELD_LINE_COMMENT = 101,
        ENRICH_FIELD_MULTILINE_COMMENT = 102, ENRICH_FIELD_WS = 103, MVEXPAND_LINE_COMMENT = 104, MVEXPAND_MULTILINE_COMMENT = 105,
        MVEXPAND_WS = 106, INFO = 107, SHOW_LINE_COMMENT = 108, SHOW_MULTILINE_COMMENT = 109, SHOW_WS = 110, SETTING = 111,
        SETTING_LINE_COMMENT = 112, SETTTING_MULTILINE_COMMENT = 113, SETTING_WS = 114, LOOKUP_LINE_COMMENT = 115,
        LOOKUP_MULTILINE_COMMENT = 116, LOOKUP_WS = 117, LOOKUP_FIELD_LINE_COMMENT = 118, LOOKUP_FIELD_MULTILINE_COMMENT = 119,
        LOOKUP_FIELD_WS = 120, USING = 121, JOIN_LINE_COMMENT = 122, JOIN_MULTILINE_COMMENT = 123, JOIN_WS = 124, METRICS_LINE_COMMENT =
            125, METRICS_MULTILINE_COMMENT = 126, METRICS_WS = 127, CLOSING_METRICS_LINE_COMMENT = 128, CLOSING_METRICS_MULTILINE_COMMENT =
                129, CLOSING_METRICS_WS = 130;
    public static final int EXPRESSION_MODE = 1, EXPLAIN_MODE = 2, FROM_MODE = 3, PROJECT_MODE = 4, RENAME_MODE = 5, ENRICH_MODE = 6,
        ENRICH_FIELD_MODE = 7, MVEXPAND_MODE = 8, SHOW_MODE = 9, SETTING_MODE = 10, LOOKUP_MODE = 11, LOOKUP_FIELD_MODE = 12, JOIN_MODE =
            13, METRICS_MODE = 14, CLOSING_METRICS_MODE = 15;
    ...
    public static final String _serializedATN = "\u0004\u0000\u0082\u064b\u0006\uffff\uffff\u0006\uffff\uffff\u0006\uffff"
        + "\uffff\u0006\uffff\uffff\u0006\uffff\uffff\u0006\uffff\uffff\u0006\uffff"
        + "\uffff\u0006\uffff\uffff\u0006\uffff\uffff\u0006\uffff\uffff\u0006\uffff"
        + "\uffff\u0006\uffff\uffff\u0006\uffff\uffff\u0006\uffff\uffff\u0006\uffff"
        + "\uffff\u0006\uffff\uffff\u0002\u0000\u0007\u0000\u0002\u0001\u0007\u0001"

...
import org.elasticsearch.compute.aggregation.VarianceSampleDoubleAggregatorFunctionSupplier;
import org.elasticsearch.compute.aggregation.VarianceSampleIntAggregatorFunctionSupplier;
import org.elasticsearch.compute.aggregation.VarianceSampleLongAggregatorFunctionSupplier;
...
public class VarianceSample extends AggregateFunction implements ToAggregator {
    ...
    public final AggregatorFunctionSupplier supplier() {
        ...
        if (type == DataType.LONG) {
            return new VarianceSampleLongAggregatorFunctionSupplier();
        }
        if (type == DataType.INTEGER) {
            return new VarianceSampleIntAggregatorFunctionSupplier();
        }
        if (type == DataType.DOUBLE) {
            return new VarianceSampleDoubleAggregatorFunctionSupplier();
        }

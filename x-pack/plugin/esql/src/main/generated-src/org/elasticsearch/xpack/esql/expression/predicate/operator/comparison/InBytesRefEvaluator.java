 ...
 */
public class InBytesRefEvaluator implements ExpressionEvaluator {
    ...
    public InBytesRefEvaluator(Source source, ExpressionEvaluator lhs, ExpressionEvaluator[] rhs, DriverContext driverContext) {
        this.source = source;
        this.lhs = lhs;
        this.rhs = rhs;

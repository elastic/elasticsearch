 ...
 */
public class InDoubleEvaluator implements ExpressionEvaluator {
    ...
    public InDoubleEvaluator(Source source, ExpressionEvaluator lhs, ExpressionEvaluator[] rhs, DriverContext driverContext) {
        this.source = source;
        this.lhs = lhs;
        this.rhs = rhs;

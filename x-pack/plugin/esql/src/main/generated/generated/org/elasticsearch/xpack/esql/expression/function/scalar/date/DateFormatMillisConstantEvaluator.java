...
public final class DateFormatMillisConstantEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public String toString() {
    return "DateFormatMillisConstantEvaluator[" + "val=" + val + ", formatter=" + formatter + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public DateFormatMillisConstantEvaluator get(DriverContext context) {
      return new DateFormatMillisConstantEvaluator(source, val.get(context), formatter, context);
    }

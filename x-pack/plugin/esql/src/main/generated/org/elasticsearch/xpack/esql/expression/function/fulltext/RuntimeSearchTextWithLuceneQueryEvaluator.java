 ...
 */
public final class RuntimeSearchTextWithLuceneQueryEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RuntimeSearchTextWithLuceneQueryEvaluator.class);
  ...
  public String toString() {
    return "RuntimeSearchTextWithLuceneQueryEvaluator[" + "fieldBlock=" + fieldBlock + ", analyzer=" + analyzer + ", query=" + query + "]";
  }

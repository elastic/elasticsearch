 ...
 */
public final class BucketExponentialHistogramEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(BucketExponentialHistogramEvaluator.class);
  ...
  public BucketExponentialHistogramEvaluator(Source source, ExpressionEvaluator histogram,
      double roundTo, DriverContext driverContext) {
    this.source = source;
  ...
  public DoubleRangeBlock eval(int positionCount, ExponentialHistogramBlock histogramBlock) {
  ...
  public String toString() {
    return "BucketExponentialHistogramEvaluator[" + "histogram=" + histogram + ", roundTo=" + roundTo + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public BucketExponentialHistogramEvaluator get(DriverContext context) {
      return new BucketExponentialHistogramEvaluator(source, histogram.get(context), roundTo, context);
    }

...
public final class GreatestBooleanEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public GreatestBooleanEvaluator get(DriverContext context, boolean collectWarnings) {
      ...
      return new GreatestBooleanEvaluator(source, values, context, collectWarnings ? new Warnings(source) : Warnings.NOOP_WARNINGS);
    }

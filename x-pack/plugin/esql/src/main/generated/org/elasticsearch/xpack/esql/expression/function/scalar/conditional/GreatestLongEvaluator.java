...
public final class GreatestLongEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public GreatestLongEvaluator get(DriverContext context, boolean collectWarnings) {
      ...
      return new GreatestLongEvaluator(source, values, context, collectWarnings ? new Warnings(source) : Warnings.NOOP_WARNINGS);
    }

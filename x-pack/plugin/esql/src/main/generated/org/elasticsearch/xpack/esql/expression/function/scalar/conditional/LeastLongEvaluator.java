 ...
 */
public final class LeastLongEvaluator implements ExpressionEvaluator {
  ...
  public LeastLongEvaluator(Source source, ExpressionEvaluator[] values,
  ...
  public LongVector eval(int positionCount, LongVector[] valuesVectors) {
    try(LongVector.FixedBuilder result = driverContext.blockFactory().newLongVectorFixedBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendLong(p, Least.process(valuesValues));
      }
      return result.build();
    }
  }

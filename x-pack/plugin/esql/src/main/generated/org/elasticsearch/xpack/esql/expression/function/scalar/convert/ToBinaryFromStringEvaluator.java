...
/**
 * {@link ExpressionEvaluator} implementation for {@link ToBinary}.
 * This class is generated. Edit {@code ConvertEvaluatorImplementer} instead.
 */
public final class ToBinaryFromStringEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToBinaryFromStringEvaluator.class);

  private final ExpressionEvaluator asString;

  public ToBinaryFromStringEvaluator(Source source, ExpressionEvaluator asString,
  ...
  private BytesRef evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return ToBinary.fromKeyword(value);
  }
  ...
  public String toString() {
    return "ToBinaryFromStringEvaluator[" + "asString=" + asString + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToBinaryFromStringEvaluator get(DriverContext context) {
      return new ToBinaryFromStringEvaluator(source, asString.get(context), context);
    }

...
public final class ToDateRangeFromStringEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  ...
  public ToDateRangeFromStringEvaluator(Source source, ExpressionEvaluator in,
  ...
  public Block evalVector(Vector v) {
    ...
    if (vector.isConstant()) {
      try {
        return driverContext.blockFactory().newConstantLongRangeBlockWith(evalValue(vector, 0, scratchPad), positionCount);
  ...
  private LongRangeBlockBuilder.LongRange evalValue(BytesRefVector container, int index,
    ...
    return ToDateRange.fromKeyword(value, this.formatter);
  }
  ...
  public String toString() {
    return "ToDateRangeFromStringEvaluator[" + "in=" + in + ", formatter=" + formatter + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    public ToDateRangeFromStringEvaluator get(DriverContext context) {
      return new ToDateRangeFromStringEvaluator(source, in.get(context), formatter, context);
    }

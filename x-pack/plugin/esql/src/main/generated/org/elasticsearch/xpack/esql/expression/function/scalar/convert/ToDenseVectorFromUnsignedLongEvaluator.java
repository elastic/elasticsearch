 ...
 */
public final class ToDenseVectorFromUnsignedLongEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToDenseVectorFromUnsignedLongEvaluator.class);

  private final EvalOperator.ExpressionEvaluator l;

  public ToDenseVectorFromUnsignedLongEvaluator(Source source, EvalOperator.ExpressionEvaluator l,
  ...
  private float evalValue(LongVector container, int index) {
    ...
    return ToDenseVector.fromUnsignedLong(value);
  }
  ...
  public String toString() {
    return "ToDenseVectorFromUnsignedLongEvaluator[" + "l=" + l + "]";
  }
  ...
  public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public ToDenseVectorFromUnsignedLongEvaluator get(DriverContext context) {
      return new ToDenseVectorFromUnsignedLongEvaluator(source, l.get(context), context);
    }

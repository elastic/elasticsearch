 ...
 */
public final class ToStringFromBinaryEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToStringFromBinaryEvaluator.class);

  private final ExpressionEvaluator binary;

  public ToStringFromBinaryEvaluator(Source source, ExpressionEvaluator binary,
  ...
  private BytesRef evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return ToString.fromBinary(value);
  }
  ...
  public String toString() {
    return "ToStringFromBinaryEvaluator[" + "binary=" + binary + "]";
  }

  @Override
  public void close() {
    Releasables.closeExpectNoException(binary);
  }

  @Override
  public long baseRamBytesUsed() {
    long baseRamBytesUsed = BASE_RAM_BYTES_USED;
    baseRamBytesUsed += binary.baseRamBytesUsed();
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    private final ExpressionEvaluator.Factory binary;

    public Factory(Source source, ExpressionEvaluator.Factory binary) {
      this.source = source;
      this.binary = binary;
    }

    @Override
    public ToStringFromBinaryEvaluator get(DriverContext context) {
      return new ToStringFromBinaryEvaluator(source, binary.get(context), context);
    }

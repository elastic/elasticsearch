...
public final class ToStringFromGeoGridEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  ...
  private BytesRef evalValue(LongVector container, int index) {
    ...
    return ToString.fromGeoGrid(value, this.dataType);
  }
  ...
  public String toString() {
    return "ToStringFromGeoGridEvaluator[" + "gridId=" + gridId + ", dataType=" + dataType + "]";
  }
  ...
  public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public ToStringFromGeoGridEvaluator get(DriverContext context) {
      return new ToStringFromGeoGridEvaluator(source, gridId.get(context), dataType, context);
    }

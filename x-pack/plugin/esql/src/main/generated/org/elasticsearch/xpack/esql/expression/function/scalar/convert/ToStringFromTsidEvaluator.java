 ...
 */
public final class ToStringFromTsidEvaluator extends AbstractConvertFunction.AbstractEvaluator {
    private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToStringFromTsidEvaluator.class);

    private final EvalOperator.ExpressionEvaluator tsid;

    public ToStringFromTsidEvaluator(Source source, EvalOperator.ExpressionEvaluator tsid, DriverContext driverContext) {
    ...
    private BytesRef evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
        ...
        return ToString.fromTsid(value);
    }
    ...
    public String toString() {
        return "ToStringFromTsidEvaluator[" + "tsid=" + tsid + "]";
    }

    @Override
    public void close() {
        Releasables.closeExpectNoException(tsid);
    }

    @Override
    public long baseRamBytesUsed() {
        long baseRamBytesUsed = BASE_RAM_BYTES_USED;
        baseRamBytesUsed += tsid.baseRamBytesUsed();
    ...
    public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
        ...
        private final EvalOperator.ExpressionEvaluator.Factory tsid;

        public Factory(Source source, EvalOperator.ExpressionEvaluator.Factory tsid) {
            this.source = source;
            this.tsid = tsid;
        }

        @Override
        public ToStringFromTsidEvaluator get(DriverContext context) {
            return new ToStringFromTsidEvaluator(source, tsid.get(context), context);
        }

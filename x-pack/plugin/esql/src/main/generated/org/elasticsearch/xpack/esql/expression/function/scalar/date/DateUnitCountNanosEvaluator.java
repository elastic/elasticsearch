...
public final class DateUnitCountNanosEvaluator implements ExpressionEvaluator {
  ...
  public DateUnitCountNanosEvaluator(Source source, ExpressionEvaluator toUnit,
  ...
  public LongBlock eval(int positionCount, BytesRefBlock toUnitBlock, BytesRefBlock fromUnitBlock,
    ...
    try(LongBlock.Builder result = driverContext.blockFactory().newLongBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendLong(DateUnitCount.processNanos(toUnit, fromUnit, date, this.zoneId));
      }
      return result.build();
    }
  }
  ...
  public LongVector eval(int positionCount, BytesRefVector toUnitVector,
    ...
    try(LongVector.FixedBuilder result = driverContext.blockFactory().newLongVectorFixedBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendLong(p, DateUnitCount.processNanos(toUnit, fromUnit, date, this.zoneId));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "DateUnitCountNanosEvaluator[" + "toUnit=" + toUnit + ", fromUnit=" + fromUnit + ", date=" + date + ", zoneId=" + zoneId + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public DateUnitCountNanosEvaluator get(DriverContext context) {
      return new DateUnitCountNanosEvaluator(source, toUnit.get(context), fromUnit.get(context), date.get(context), zoneId, context);
    }

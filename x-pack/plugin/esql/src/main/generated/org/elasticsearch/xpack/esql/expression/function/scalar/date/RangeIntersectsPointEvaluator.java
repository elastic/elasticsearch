 ...
 */
public final class RangeIntersectsPointEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RangeIntersectsPointEvaluator.class);
  ...
  public RangeIntersectsPointEvaluator(Source source, ExpressionEvaluator point,
  ...
  public String toString() {
    return "RangeIntersectsPointEvaluator[" + "point=" + point + ", range=" + range + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public RangeIntersectsPointEvaluator get(DriverContext context) {
      return new RangeIntersectsPointEvaluator(source, point.get(context), range.get(context), context);
    }

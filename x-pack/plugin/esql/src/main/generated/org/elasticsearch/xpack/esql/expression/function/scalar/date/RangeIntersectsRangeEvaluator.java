 ...
 */
public final class RangeIntersectsRangeEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RangeIntersectsRangeEvaluator.class);
  ...
  public RangeIntersectsRangeEvaluator(Source source, ExpressionEvaluator a, ExpressionEvaluator b,
  ...
  public String toString() {
    return "RangeIntersectsRangeEvaluator[" + "a=" + a + ", b=" + b + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public RangeIntersectsRangeEvaluator get(DriverContext context) {
      return new RangeIntersectsRangeEvaluator(source, a.get(context), b.get(context), context);
    }

 ...
 */
public final class RangeMaxDoubleEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RangeMaxDoubleEvaluator.class);
  ...
  public RangeMaxDoubleEvaluator(Source source, ExpressionEvaluator range,
  ...
  public DoubleBlock eval(int positionCount, DoubleRangeBlock rangeBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(RangeMax.process(range));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "RangeMaxDoubleEvaluator[" + "range=" + range + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public RangeMaxDoubleEvaluator get(DriverContext context) {
      return new RangeMaxDoubleEvaluator(source, range.get(context), context);
    }

 ...
 */
public final class RangeMinDoubleEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RangeMinDoubleEvaluator.class);
  ...
  public RangeMinDoubleEvaluator(Source source, ExpressionEvaluator range,
  ...
  public DoubleBlock eval(int positionCount, DoubleRangeBlock rangeBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(RangeMin.process(range));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "RangeMinDoubleEvaluator[" + "range=" + range + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public RangeMinDoubleEvaluator get(DriverContext context) {
      return new RangeMinDoubleEvaluator(source, range.get(context), context);
    }

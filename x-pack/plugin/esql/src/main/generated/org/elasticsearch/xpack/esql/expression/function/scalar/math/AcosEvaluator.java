...
/**
 * {@link ExpressionEvaluator} implementation for {@link Acos}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class AcosEvaluator implements ExpressionEvaluator {
  ...
  public AcosEvaluator(Source source, ExpressionEvaluator val, boolean allowNonFinite,
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock valBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendDouble(Acos.process(val, this.allowNonFinite));
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public AcosEvaluator get(DriverContext context) {
      return new AcosEvaluator(source, val.get(context), allowNonFinite, context);
    }

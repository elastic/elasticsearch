...
/**
 * {@link ExpressionEvaluator} implementation for {@link Acosh}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class AcoshEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(AcoshEvaluator.class);
  ...
  public AcoshEvaluator(Source source, ExpressionEvaluator val, boolean allowNonFinite,
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock valBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendDouble(Acosh.process(val, this.allowNonFinite));
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public AcoshEvaluator get(DriverContext context) {
      return new AcoshEvaluator(source, val.get(context), allowNonFinite, context);
    }

...
/**
 * {@link ExpressionEvaluator} implementation for {@link Atan}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class AtanEvaluator implements ExpressionEvaluator {
  ...
  public AtanEvaluator(Source source, ExpressionEvaluator val, DriverContext driverContext) {
    this.source = source;
    this.val = val;
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock valBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(Atan.process(val));
      }
      return result.build();
    }
  }
  ...
  public DoubleVector eval(int positionCount, DoubleVector valVector) {
    try(DoubleVector.FixedBuilder result = driverContext.blockFactory().newDoubleVectorFixedBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(p, Atan.process(val));
      }
      return result.build();
    }
  }

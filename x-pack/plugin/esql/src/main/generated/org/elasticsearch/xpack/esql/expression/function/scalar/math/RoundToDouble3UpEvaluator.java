 ...
 */
public final class RoundToDouble3UpEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RoundToDouble3UpEvaluator.class);
  ...
  public RoundToDouble3UpEvaluator(Source source, ExpressionEvaluator field, double p0, double p1,
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock fieldBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(RoundToDouble.processUp(field, this.p0, this.p1, this.p2));
      }
      return result.build();
    }
  }
  ...
  public DoubleVector eval(int positionCount, DoubleVector fieldVector) {
    try(DoubleVector.FixedBuilder result = driverContext.blockFactory().newDoubleVectorFixedBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(p, RoundToDouble.processUp(field, this.p0, this.p1, this.p2));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "RoundToDouble3UpEvaluator[" + "field=" + field + ", p0=" + p0 + ", p1=" + p1 + ", p2=" + p2 + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public RoundToDouble3UpEvaluator get(DriverContext context) {
      return new RoundToDouble3UpEvaluator(source, field.get(context), p0, p1, p2, context);
    }

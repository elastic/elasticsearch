 ...
 */
public final class RoundToDouble7UpEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RoundToDouble7UpEvaluator.class);
  ...
  public RoundToDouble7UpEvaluator(Source source, ExpressionEvaluator field, double p0, double p1,
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock fieldBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(RoundToDouble.processUp(field, this.p0, this.p1, this.p2, this.p3, this.p4, this.p5, this.p6));
      }
      return result.build();
    }
  }
  ...
  public DoubleVector eval(int positionCount, DoubleVector fieldVector) {
    try(DoubleVector.FixedBuilder result = driverContext.blockFactory().newDoubleVectorFixedBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(p, RoundToDouble.processUp(field, this.p0, this.p1, this.p2, this.p3, this.p4, this.p5, this.p6));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "RoundToDouble7UpEvaluator[" + "field=" + field + ", p0=" + p0 + ", p1=" + p1 + ", p2=" + p2 + ", p3=" + p3 + ", p4=" + p4 + ", p5=" + p5 + ", p6=" + p6 + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public RoundToDouble7UpEvaluator get(DriverContext context) {
      return new RoundToDouble7UpEvaluator(source, field.get(context), p0, p1, p2, p3, p4, p5, p6, context);
    }

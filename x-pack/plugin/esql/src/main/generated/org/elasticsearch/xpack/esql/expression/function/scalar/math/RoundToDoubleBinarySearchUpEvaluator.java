 ...
 */
public final class RoundToDoubleBinarySearchUpEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RoundToDoubleBinarySearchUpEvaluator.class);
  ...
  public RoundToDoubleBinarySearchUpEvaluator(Source source, ExpressionEvaluator field,
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock fieldBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(RoundToDouble.processUp(field, this.points));
      }
      return result.build();
    }
  }
  ...
  public DoubleVector eval(int positionCount, DoubleVector fieldVector) {
    try(DoubleVector.FixedBuilder result = driverContext.blockFactory().newDoubleVectorFixedBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(p, RoundToDouble.processUp(field, this.points));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "RoundToDoubleBinarySearchUpEvaluator[" + "field=" + field + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public RoundToDoubleBinarySearchUpEvaluator get(DriverContext context) {
      return new RoundToDoubleBinarySearchUpEvaluator(source, field.get(context), points, context);
    }

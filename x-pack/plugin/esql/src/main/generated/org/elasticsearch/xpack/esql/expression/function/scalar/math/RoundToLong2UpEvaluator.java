 ...
 */
public final class RoundToLong2UpEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RoundToLong2UpEvaluator.class);
  ...
  public RoundToLong2UpEvaluator(Source source, ExpressionEvaluator field, long p0, long p1,
  ...
  public LongBlock eval(int positionCount, LongBlock fieldBlock) {
    try(LongBlock.Builder result = driverContext.blockFactory().newLongBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendLong(RoundToLong.processUp(field, this.p0, this.p1));
      }
      return result.build();
    }
  }
  ...
  public LongVector eval(int positionCount, LongVector fieldVector) {
    try(LongVector.FixedBuilder result = driverContext.blockFactory().newLongVectorFixedBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendLong(p, RoundToLong.processUp(field, this.p0, this.p1));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "RoundToLong2UpEvaluator[" + "field=" + field + ", p0=" + p0 + ", p1=" + p1 + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public RoundToLong2UpEvaluator get(DriverContext context) {
      return new RoundToLong2UpEvaluator(source, field.get(context), p0, p1, context);
    }

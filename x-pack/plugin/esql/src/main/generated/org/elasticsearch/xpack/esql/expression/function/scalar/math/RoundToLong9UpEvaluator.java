 ...
 */
public final class RoundToLong9UpEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(RoundToLong9UpEvaluator.class);
  ...
  public RoundToLong9UpEvaluator(Source source, ExpressionEvaluator field, long p0, long p1,
  ...
  public LongBlock eval(int positionCount, LongBlock fieldBlock) {
    try(LongBlock.Builder result = driverContext.blockFactory().newLongBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendLong(RoundToLong.processUp(field, this.p0, this.p1, this.p2, this.p3, this.p4, this.p5, this.p6, this.p7, this.p8));
      }
      return result.build();
    }
  }
  ...
  public LongVector eval(int positionCount, LongVector fieldVector) {
    try(LongVector.FixedBuilder result = driverContext.blockFactory().newLongVectorFixedBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendLong(p, RoundToLong.processUp(field, this.p0, this.p1, this.p2, this.p3, this.p4, this.p5, this.p6, this.p7, this.p8));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "RoundToLong9UpEvaluator[" + "field=" + field + ", p0=" + p0 + ", p1=" + p1 + ", p2=" + p2 + ", p3=" + p3 + ", p4=" + p4 + ", p5=" + p5 + ", p6=" + p6 + ", p7=" + p7 + ", p8=" + p8 + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public RoundToLong9UpEvaluator get(DriverContext context) {
      return new RoundToLong9UpEvaluator(source, field.get(context), p0, p1, p2, p3, p4, p5, p6, p7, p8, context);
    }

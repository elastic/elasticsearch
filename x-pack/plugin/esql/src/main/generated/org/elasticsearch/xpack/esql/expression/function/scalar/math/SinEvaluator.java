...
/**
 * {@link ExpressionEvaluator} implementation for {@link Sin}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class SinEvaluator implements ExpressionEvaluator {
  ...
  public SinEvaluator(Source source, ExpressionEvaluator val, DriverContext driverContext) {
    this.source = source;
    this.val = val;
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock valBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(Sin.process(val));
      }
      return result.build();
    }
  }
  ...
  public DoubleVector eval(int positionCount, DoubleVector valVector) {
    try(DoubleVector.FixedBuilder result = driverContext.blockFactory().newDoubleVectorFixedBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendDouble(p, Sin.process(val));
      }
      return result.build();
    }
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public SinEvaluator get(DriverContext context) {
      return new SinEvaluator(source, val.get(context), context);
    }

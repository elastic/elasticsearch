...
/**
 * {@link ExpressionEvaluator} implementation for {@link Sinh}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class SinhEvaluator implements ExpressionEvaluator {
  ...
  public SinhEvaluator(Source source, ExpressionEvaluator val, boolean allowNonFinite,
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock valBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendDouble(Sinh.process(val, this.allowNonFinite));
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public SinhEvaluator get(DriverContext context) {
      return new SinhEvaluator(source, val.get(context), allowNonFinite, context);
    }

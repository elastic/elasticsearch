...
public final class MvAppendDoubleEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public Block eval(Page page) {
    try (DoubleBlock field1Block = (DoubleBlock) field1.eval(page)) {
      DoubleBlock[] field2Blocks = new DoubleBlock[field2.length];
      try (Releasable field2Release = Releasables.wrap(field2Blocks)) {
        for (int i = 0; i < field2Blocks.length; i++) {
          field2Blocks[i] = (DoubleBlock)field2[i].eval(page);
        }
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock field1Block, DoubleBlock[] field2Blocks) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      DoubleBlock[] field2Values = new DoubleBlock[field2.length];
  ...
  public String toString() {
    return "MvAppendDoubleEvaluator[" + "field1=" + field1 + ", field2=" + Arrays.toString(field2) + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    public MvAppendDoubleEvaluator get(DriverContext context) {
      ...
      return new MvAppendDoubleEvaluator(source, field1.get(context), field2, context);
    }

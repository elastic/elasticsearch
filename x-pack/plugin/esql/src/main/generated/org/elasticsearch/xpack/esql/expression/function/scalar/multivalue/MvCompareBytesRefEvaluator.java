 ...
 */
public final class MvCompareBytesRefEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MvCompareBytesRefEvaluator.class);
  ...
  public MvCompareBytesRefEvaluator(Source source, ExpressionEvaluator field,
  ...
  public Block eval(Page page) {
    try (BytesRefBlock fieldBlock = (BytesRefBlock) field.eval(page)) {
      try (BytesRefBlock boundBlock = (BytesRefBlock) bound.eval(page)) {
  ...
  public BooleanBlock eval(int positionCount, BytesRefBlock fieldBlock, BytesRefBlock boundBlock) {
  ...
  public String toString() {
    return "MvCompareBytesRefEvaluator[" + "field=" + field + ", bound=" + bound + ", greater=" + greater + ", includeBound=" + includeBound + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public MvCompareBytesRefEvaluator get(DriverContext context) {
      return new MvCompareBytesRefEvaluator(source, field.get(context), bound.get(context), greater, includeBound, context);
    }

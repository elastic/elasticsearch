 ...
 */
public final class MvCompareIntEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MvCompareIntEvaluator.class);
  ...
  public MvCompareIntEvaluator(Source source, ExpressionEvaluator field, ExpressionEvaluator bound,
  ...
  public BooleanBlock eval(int positionCount, IntBlock fieldBlock, IntBlock boundBlock) {
  ...
  public String toString() {
    return "MvCompareIntEvaluator[" + "field=" + field + ", bound=" + bound + ", greater=" + greater + ", includeBound=" + includeBound + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public MvCompareIntEvaluator get(DriverContext context) {
      return new MvCompareIntEvaluator(source, field.get(context), bound.get(context), greater, includeBound, context);
    }

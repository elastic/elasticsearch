 ...
 */
public final class MvContainsAllBooleanEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public MvContainsAllBooleanEvaluator(Source source, EvalOperator.ExpressionEvaluator field1,
  ...
  public String toString() {
    return "MvContainsAllBooleanEvaluator[" + "field1=" + field1 + ", field2=" + field2 + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public MvContainsAllBooleanEvaluator get(DriverContext context) {
      return new MvContainsAllBooleanEvaluator(source, field1.get(context), field2.get(context), context);
    }

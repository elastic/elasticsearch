...
/**
 * {@link EvalOperator.ExpressionEvaluator} implementation for {@link MvContainsAll}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class MvContainsAllBytesRefEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public MvContainsAllBytesRefEvaluator(Source source, EvalOperator.ExpressionEvaluator field1,
  ...
  public BooleanBlock eval(int positionCount, BytesRefBlock field1Block,
    ...
    try(BooleanBlock.Builder result = driverContext.blockFactory().newBooleanBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        MvContainsAll.process(result, p, field1Block, field2Block);
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "MvContainsAllBytesRefEvaluator[" + "field1=" + field1 + ", field2=" + field2 + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public MvContainsAllBytesRefEvaluator get(DriverContext context) {
      return new MvContainsAllBytesRefEvaluator(source, field1.get(context), field2.get(context), context);
    }

 ...
 */
public final class MvContainsAllDoubleEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public MvContainsAllDoubleEvaluator(Source source, EvalOperator.ExpressionEvaluator field1,
  ...
  public String toString() {
    return "MvContainsAllDoubleEvaluator[" + "field1=" + field1 + ", field2=" + field2 + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public MvContainsAllDoubleEvaluator get(DriverContext context) {
      return new MvContainsAllDoubleEvaluator(source, field1.get(context), field2.get(context), context);
    }

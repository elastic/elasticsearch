 ...
 */
public final class MvContainsAllLongEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public MvContainsAllLongEvaluator(Source source, EvalOperator.ExpressionEvaluator field1,
  ...
  public String toString() {
    return "MvContainsAllLongEvaluator[" + "field1=" + field1 + ", field2=" + field2 + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public MvContainsAllLongEvaluator get(DriverContext context) {
      return new MvContainsAllLongEvaluator(source, field1.get(context), field2.get(context), context);
    }

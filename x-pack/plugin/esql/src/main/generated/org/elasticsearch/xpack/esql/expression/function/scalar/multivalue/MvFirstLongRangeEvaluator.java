 ...
 */
public final class MvFirstLongRangeEvaluator extends AbstractMultivalueFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MvFirstLongRangeEvaluator.class);

  public MvFirstLongRangeEvaluator(ExpressionEvaluator field, DriverContext driverContext) {
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public MvFirstLongRangeEvaluator get(DriverContext context) {
      return new MvFirstLongRangeEvaluator(field.get(context), context);
    }

...
public final class MvInRangeBytesRefEvaluator implements ExpressionEvaluator {
  ...
  public String toString() {
    return "MvInRangeBytesRefEvaluator[" + "field=" + field + ", lower=" + lower + ", upper=" + upper + ", includeLower=" + includeLower + ", includeUpper=" + includeUpper + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public MvInRangeBytesRefEvaluator get(DriverContext context) {
      return new MvInRangeBytesRefEvaluator(source, field.get(context), lower.get(context), upper.get(context), includeLower, includeUpper, context);
    }

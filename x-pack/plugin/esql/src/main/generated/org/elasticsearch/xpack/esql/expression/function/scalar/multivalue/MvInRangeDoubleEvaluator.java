...
public final class MvInRangeDoubleEvaluator implements ExpressionEvaluator {
  ...
  public String toString() {
    return "MvInRangeDoubleEvaluator[" + "field=" + field + ", lower=" + lower + ", upper=" + upper + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public MvInRangeDoubleEvaluator get(DriverContext context) {
      return new MvInRangeDoubleEvaluator(source, field.get(context), lower.get(context), upper.get(context), context);
    }

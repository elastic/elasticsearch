...
public final class MvIntersectIntEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public MvIntersectIntEvaluator(Source source, EvalOperator.ExpressionEvaluator firstValue,
  ...
  public Block eval(Page page) {
    try (IntBlock firstValueBlock = (IntBlock) firstValue.eval(page)) {
      try (IntBlock secondValueBlock = (IntBlock) secondValue.eval(page)) {
  ...
  public IntBlock eval(int positionCount, IntBlock firstValueBlock, IntBlock secondValueBlock) {
  ...
  public String toString() {
    return "MvIntersectIntEvaluator[" + "firstValue=" + firstValue + ", secondValue=" + secondValue + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    public MvIntersectIntEvaluator get(DriverContext context) {
      return new MvIntersectIntEvaluator(source, firstValue.get(context), secondValue.get(context), context);
    }

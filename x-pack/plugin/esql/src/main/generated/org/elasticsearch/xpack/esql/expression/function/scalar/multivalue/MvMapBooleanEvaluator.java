 ...
 */
public final class MvMapBooleanEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MvMapBooleanEvaluator.class);
  ...
  public MvMapBooleanEvaluator(ExpressionEvaluator field, ExpressionEvaluator lambda,
  ...
  public String toString() {
    return "MvMapBooleanEvaluator[field=" + field + ", lambda=" + lambda + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public MvMapBooleanEvaluator get(DriverContext context) {
      return new MvMapBooleanEvaluator(field.get(context), lambda.get(context), outerChannels, context);
    }

 ...
 */
public final class MvMapDoubleEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MvMapDoubleEvaluator.class);
  ...
  public MvMapDoubleEvaluator(ExpressionEvaluator field, ExpressionEvaluator lambda,
  ...
  private Block evalNotExpanded(Page page, Block fieldBlock) {
    ...
    try {
      ...
      try (DoubleBlock lambdaBlock = (DoubleBlock) lambda.eval(innerPage); DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(fieldBlock.getPositionCount())) {
  ...
  public String toString() {
    return "MvMapDoubleEvaluator[field=" + field + ", lambda=" + lambda + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public MvMapDoubleEvaluator get(DriverContext context) {
      return new MvMapDoubleEvaluator(field.get(context), lambda.get(context), outerChannels, context);
    }

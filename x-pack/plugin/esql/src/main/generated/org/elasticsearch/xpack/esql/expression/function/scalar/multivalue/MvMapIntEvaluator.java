 ...
 */
public final class MvMapIntEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MvMapIntEvaluator.class);
  ...
  public MvMapIntEvaluator(ExpressionEvaluator field, ExpressionEvaluator lambda,
  ...
  private Block evalNotExpanded(Page page, Block fieldBlock) {
    ...
    try {
      ...
      try (IntBlock lambdaBlock = (IntBlock) lambda.eval(innerPage); IntBlock.Builder result = driverContext.blockFactory().newIntBlockBuilder(fieldBlock.getPositionCount())) {
  ...
  public String toString() {
    return "MvMapIntEvaluator[field=" + field + ", lambda=" + lambda + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public MvMapIntEvaluator get(DriverContext context) {
      return new MvMapIntEvaluator(field.get(context), lambda.get(context), outerChannels, context);
    }

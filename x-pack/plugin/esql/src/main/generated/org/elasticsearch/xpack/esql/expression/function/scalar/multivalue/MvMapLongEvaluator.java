 ...
 */
public final class MvMapLongEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MvMapLongEvaluator.class);
  ...
  public MvMapLongEvaluator(ExpressionEvaluator field, ExpressionEvaluator lambda,
  ...
  private Block evalNotExpanded(Page page, Block fieldBlock) {
    ...
    try {
      ...
      try (LongBlock lambdaBlock = (LongBlock) lambda.eval(innerPage); LongBlock.Builder result = driverContext.blockFactory().newLongBlockBuilder(fieldBlock.getPositionCount())) {
  ...
  public String toString() {
    return "MvMapLongEvaluator[field=" + field + ", lambda=" + lambda + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public MvMapLongEvaluator get(DriverContext context) {
      return new MvMapLongEvaluator(field.get(context), lambda.get(context), outerChannels, context);
    }

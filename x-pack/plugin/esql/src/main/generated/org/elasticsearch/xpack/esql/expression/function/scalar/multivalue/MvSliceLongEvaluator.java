 ...
 */
public final class MvSliceLongEvaluator implements ExpressionEvaluator {
  ...
  public MvSliceLongEvaluator(Source source, ExpressionEvaluator field, ExpressionEvaluator start,
      ExpressionEvaluator end, DriverContext driverContext) {
    this.source = source;
    this.field = field;
    this.start = start;
    this.end = end;

 ...
 */
public final class SpatialContainsCartesianSourceAndConstantEvaluator implements ExpressionEvaluator {
  ...
  public SpatialContainsCartesianSourceAndConstantEvaluator(Source source, ExpressionEvaluator left,
  ...
  public BooleanBlock eval(int positionCount, BytesRefBlock leftBlock) {
    try(BooleanBlock.Builder result = driverContext.blockFactory().newBooleanBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          SpatialContains.processCartesianSourceAndConstant(result, p, leftBlock, this.right);
  ...
  public String toString() {
    return "SpatialContainsCartesianSourceAndConstantEvaluator[" + "left=" + left + ", right=" + right + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public SpatialContainsCartesianSourceAndConstantEvaluator get(DriverContext context) {
      return new SpatialContainsCartesianSourceAndConstantEvaluator(source, left.get(context), right, context);
    }

 ...
 */
public final class SpatialDisjointCartesianSourceAndConstantEvaluator implements ExpressionEvaluator {
  ...
  public SpatialDisjointCartesianSourceAndConstantEvaluator(Source source, ExpressionEvaluator left,
  ...
  public BooleanBlock eval(int positionCount, BytesRefBlock leftBlock) {
    try(BooleanBlock.Builder result = driverContext.blockFactory().newBooleanBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          SpatialDisjoint.processCartesianSourceAndConstant(result, p, leftBlock, this.right);

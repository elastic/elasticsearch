 ...
 */
public final class SpatialDisjointGeoSourceAndConstantEvaluator implements ExpressionEvaluator {
  ...
  public SpatialDisjointGeoSourceAndConstantEvaluator(Source source, ExpressionEvaluator left,
  ...
  public BooleanBlock eval(int positionCount, BytesRefBlock leftBlock) {
    try(BooleanBlock.Builder result = driverContext.blockFactory().newBooleanBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          SpatialDisjoint.processGeoSourceAndConstant(result, p, leftBlock, this.right);
  ...
  public String toString() {
    return "SpatialDisjointGeoSourceAndConstantEvaluator[" + "left=" + left + ", right=" + right + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public SpatialDisjointGeoSourceAndConstantEvaluator get(DriverContext context) {
      return new SpatialDisjointGeoSourceAndConstantEvaluator(source, left.get(context), right, context);
    }

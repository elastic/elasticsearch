 ...
 */
public final class SpatialDisjointGeoSourceAndSourceEvaluator implements ExpressionEvaluator {
  ...
  public SpatialDisjointGeoSourceAndSourceEvaluator(Source source, ExpressionEvaluator left,
  ...
  public String toString() {
    return "SpatialDisjointGeoSourceAndSourceEvaluator[" + "left=" + left + ", right=" + right + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public SpatialDisjointGeoSourceAndSourceEvaluator get(DriverContext context) {
      return new SpatialDisjointGeoSourceAndSourceEvaluator(source, left.get(context), right.get(context), context);
    }

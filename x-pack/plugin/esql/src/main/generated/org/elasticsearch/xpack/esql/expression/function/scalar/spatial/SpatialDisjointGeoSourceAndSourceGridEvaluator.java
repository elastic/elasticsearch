 ...
 */
public final class SpatialDisjointGeoSourceAndSourceGridEvaluator implements ExpressionEvaluator {
  ...
  public SpatialDisjointGeoSourceAndSourceGridEvaluator(Source source, ExpressionEvaluator wkb,
      ExpressionEvaluator gridId, DataType gridType, DriverContext driverContext) {
    this.source = source;
    this.wkb = wkb;
    this.gridId = gridId;
  ...
  public String toString() {
    return "SpatialDisjointGeoSourceAndSourceGridEvaluator[" + "wkb=" + wkb + ", gridId=" + gridId + ", gridType=" + gridType + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public Factory(Source source, ExpressionEvaluator.Factory wkb,
        ExpressionEvaluator.Factory gridId, DataType gridType) {
      this.source = source;
      this.wkb = wkb;
      this.gridId = gridId;
      this.gridType = gridType;
    ...
    public SpatialDisjointGeoSourceAndSourceGridEvaluator get(DriverContext context) {
      return new SpatialDisjointGeoSourceAndSourceGridEvaluator(source, wkb.get(context), gridId.get(context), gridType, context);
    }

 ...
 */
public final class SpatialIntersectsCartesianSourceAndSourceEvaluator implements ExpressionEvaluator {
  ...
  public SpatialIntersectsCartesianSourceAndSourceEvaluator(Source source, ExpressionEvaluator left,
  ...
  public String toString() {
    return "SpatialIntersectsCartesianSourceAndSourceEvaluator[" + "left=" + left + ", right=" + right + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public SpatialIntersectsCartesianSourceAndSourceEvaluator get(DriverContext context) {
      return new SpatialIntersectsCartesianSourceAndSourceEvaluator(source, left.get(context), right.get(context), context);
    }

...
public final class SpatialIntersectsGeoSourceAndConstantGridEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public Block eval(Page page) {
    try (BytesRefBlock wkbBlock = (BytesRefBlock) wkb.eval(page)) {
      return eval(page.getPositionCount(), wkbBlock);
    }
  }
  ...
  public String toString() {
    return "SpatialIntersectsGeoSourceAndConstantGridEvaluator[" + "wkb=" + wkb + ", gridId=" + gridId + ", gridType=" + gridType + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    public SpatialIntersectsGeoSourceAndConstantGridEvaluator get(DriverContext context) {
      return new SpatialIntersectsGeoSourceAndConstantGridEvaluator(source, wkb.get(context), gridId, gridType, context);
    }

 ...
 */
public final class SpatialIntersectsGeoSourceAndSourceEvaluator implements ExpressionEvaluator {
  ...
  public SpatialIntersectsGeoSourceAndSourceEvaluator(Source source, ExpressionEvaluator left,
  ...
  public String toString() {
    return "SpatialIntersectsGeoSourceAndSourceEvaluator[" + "left=" + left + ", right=" + right + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public SpatialIntersectsGeoSourceAndSourceEvaluator get(DriverContext context) {
      return new SpatialIntersectsGeoSourceAndSourceEvaluator(source, left.get(context), right.get(context), context);
    }

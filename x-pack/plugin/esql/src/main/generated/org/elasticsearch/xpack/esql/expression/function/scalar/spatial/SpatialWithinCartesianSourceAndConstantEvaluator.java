 ...
 */
public final class SpatialWithinCartesianSourceAndConstantEvaluator implements ExpressionEvaluator {
  ...
  public SpatialWithinCartesianSourceAndConstantEvaluator(Source source, ExpressionEvaluator left,
      Component2D right, DriverContext driverContext) {
    this.source = source;
    this.left = left;
    this.right = right;

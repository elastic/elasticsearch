 ...
 */
public final class StDistanceCartesianPointDocValuesAndConstantEvaluator implements ExpressionEvaluator {
  ...
  public StDistanceCartesianPointDocValuesAndConstantEvaluator(Source source,
      ExpressionEvaluator left, Point right, DriverContext driverContext) {
    this.source = source;
    this.left = left;
    this.right = right;

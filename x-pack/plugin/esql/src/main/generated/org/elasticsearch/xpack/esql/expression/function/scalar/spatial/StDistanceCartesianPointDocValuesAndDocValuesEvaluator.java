...
public final class StDistanceCartesianPointDocValuesAndDocValuesEvaluator implements ExpressionEvaluator {
  ...
  public DoubleBlock eval(int positionCount, LongBlock leftBlock, LongBlock rightBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        StDistance.processCartesianPointDocValuesAndDocValues(result, p, leftBlock, rightBlock);
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "StDistanceCartesianPointDocValuesAndDocValuesEvaluator[" + "left=" + left + ", right=" + right + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public StDistanceCartesianPointDocValuesAndDocValuesEvaluator get(DriverContext context) {
      return new StDistanceCartesianPointDocValuesAndDocValuesEvaluator(source, left.get(context), right.get(context), context);
    }

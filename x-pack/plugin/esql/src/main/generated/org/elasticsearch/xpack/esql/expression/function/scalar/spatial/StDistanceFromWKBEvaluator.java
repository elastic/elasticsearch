 ...
 */
public final class StDistanceFromWKBEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  public StDistanceFromWKBEvaluator(EvalOperator.ExpressionEvaluator field, Source source,
  ...
  private static double evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return StDistance.fromWellKnownBinary(value);
  }
  ...
  public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public StDistanceFromWKBEvaluator get(DriverContext context) {
      return new StDistanceFromWKBEvaluator(field.get(context), source, context);
    }

    @Override
    public String toString() {
      return "StDistanceFromWKBEvaluator[field=" + field + "]";
    }
  }
}

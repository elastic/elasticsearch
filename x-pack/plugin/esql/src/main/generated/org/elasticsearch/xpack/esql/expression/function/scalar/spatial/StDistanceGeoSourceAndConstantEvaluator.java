 ...
 */
public final class StDistanceGeoSourceAndConstantEvaluator implements ExpressionEvaluator {
  ...
  public StDistanceGeoSourceAndConstantEvaluator(Source source, ExpressionEvaluator left,
      Point right, DriverContext driverContext) {
    this.source = source;
    this.left = left;
    this.right = right;
  ...
  public String toString() {
    return "StDistanceGeoSourceAndConstantEvaluator[" + "left=" + left + ", right=" + right + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public Factory(Source source, ExpressionEvaluator.Factory left, Point right) {
      this.source = source;
      this.left = left;
      this.right = right;
    }
    ...
    public StDistanceGeoSourceAndConstantEvaluator get(DriverContext context) {
      return new StDistanceGeoSourceAndConstantEvaluator(source, left.get(context), right, context);
    }

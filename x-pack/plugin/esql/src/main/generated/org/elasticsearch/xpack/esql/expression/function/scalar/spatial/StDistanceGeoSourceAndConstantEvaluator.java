...
public final class StDistanceGeoSourceAndConstantEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public StDistanceGeoSourceAndConstantEvaluator(Source source,
  ...
  public String toString() {
    return "StDistanceGeoSourceAndConstantEvaluator[" + "leftValue=" + leftValue + ", rightValue=" + rightValue + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    public StDistanceGeoSourceAndConstantEvaluator get(DriverContext context) {
      return new StDistanceGeoSourceAndConstantEvaluator(source, leftValue.get(context), rightValue, context);
    }

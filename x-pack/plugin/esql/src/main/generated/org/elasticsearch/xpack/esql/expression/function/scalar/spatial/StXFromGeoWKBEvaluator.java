 ...
 */
public final class StXFromGeoWKBEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(StXFromGeoWKBEvaluator.class);

  private final EvalOperator.ExpressionEvaluator in;

  public StXFromGeoWKBEvaluator(Source source, EvalOperator.ExpressionEvaluator in,
  ...
  private double evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return StX.fromGeoWellKnownBinary(value);
  }
  ...
  public String toString() {
    return "StXFromGeoWKBEvaluator[" + "in=" + in + "]";
  }
  ...
  public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public StXFromGeoWKBEvaluator get(DriverContext context) {
      return new StXFromGeoWKBEvaluator(source, in.get(context), context);
    }

 ...
 */
public final class StXMinFromCartesianWKBEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(StXMinFromCartesianWKBEvaluator.class);
  ...
  public StXMinFromCartesianWKBEvaluator(Source source, EvalOperator.ExpressionEvaluator wkbBlock,
  ...
  public DoubleBlock eval(int positionCount, BytesRefBlock wkbBlockBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          StXMin.fromCartesianWKB(result, p, wkbBlockBlock, this.resultsBuilder);
  ...
  public String toString() {
    return "StXMinFromCartesianWKBEvaluator[" + "wkbBlock=" + wkbBlock + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public StXMinFromCartesianWKBEvaluator get(DriverContext context) {
      return new StXMinFromCartesianWKBEvaluator(source, wkbBlock.get(context), resultsBuilder.apply(context), context);
    }

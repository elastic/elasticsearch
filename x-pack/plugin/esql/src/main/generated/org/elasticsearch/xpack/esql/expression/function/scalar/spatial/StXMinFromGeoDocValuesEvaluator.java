...
/**
 * {@link ExpressionEvaluator} implementation for {@link StXMin}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class StXMinFromGeoDocValuesEvaluator implements ExpressionEvaluator {
  ...
  public StXMinFromGeoDocValuesEvaluator(Source source, ExpressionEvaluator encodedBlock,
  ...
  public DoubleBlock eval(int positionCount, LongBlock encodedBlockBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          StXMin.fromGeoDocValues(result, p, encodedBlockBlock, this.resultsBuilder);
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public StXMinFromGeoDocValuesEvaluator get(DriverContext context) {
      return new StXMinFromGeoDocValuesEvaluator(source, encodedBlock.get(context), resultsBuilder.apply(context), context);
    }

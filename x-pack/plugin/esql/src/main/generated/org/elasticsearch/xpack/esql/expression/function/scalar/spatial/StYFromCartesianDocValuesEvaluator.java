 ...
 */
public final class StYFromCartesianDocValuesEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(StYFromCartesianDocValuesEvaluator.class);

  private final EvalOperator.ExpressionEvaluator encoded;

  public StYFromCartesianDocValuesEvaluator(Source source, EvalOperator.ExpressionEvaluator encoded,
  ...
  private double evalValue(LongVector container, int index) {
    ...
    return StY.fromCartesianDocValues(value);
  }
  ...
  public String toString() {
    return "StYFromCartesianDocValuesEvaluator[" + "encoded=" + encoded + "]";
  }
  ...
  public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public StYFromCartesianDocValuesEvaluator get(DriverContext context) {
      return new StYFromCartesianDocValuesEvaluator(source, encoded.get(context), context);
    }

...
public final class StYFromGeoDocValuesEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  ...
  private double evalValue(LongVector container, int index) {
    ...
    return StY.fromGeoDocValues(value);
  }
  ...
  public String toString() {
    return "StYFromGeoDocValuesEvaluator[" + "encoded=" + encoded + "]";
  }
  ...
  public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public StYFromGeoDocValuesEvaluator get(DriverContext context) {
      return new StYFromGeoDocValuesEvaluator(source, encoded.get(context), context);
    }

 ...
 */
public final class StYFromGeoWKBEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(StYFromGeoWKBEvaluator.class);

  private final EvalOperator.ExpressionEvaluator in;

  public StYFromGeoWKBEvaluator(Source source, EvalOperator.ExpressionEvaluator in,
  ...
  private double evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return StY.fromGeoWellKnownBinary(value);
  }
  ...
  public String toString() {
    return "StYFromGeoWKBEvaluator[" + "in=" + in + "]";
  }
  ...
  public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public StYFromGeoWKBEvaluator get(DriverContext context) {
      return new StYFromGeoWKBEvaluator(source, in.get(context), context);
    }

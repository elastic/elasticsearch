 ...
 */
public final class StYMaxFromWKBGeoEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public StYMaxFromWKBGeoEvaluator(Source source, EvalOperator.ExpressionEvaluator wkbBlock,
  ...
  public DoubleBlock eval(int positionCount, BytesRefBlock wkbBlockBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          StYMax.fromWellKnownBinaryGeo(result, p, wkbBlockBlock);
  ...
  public String toString() {
    return "StYMaxFromWKBGeoEvaluator[" + "wkbBlock=" + wkbBlock + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    public StYMaxFromWKBGeoEvaluator get(DriverContext context) {
      return new StYMaxFromWKBGeoEvaluator(source, wkbBlock.get(context), context);
    }

...
public final class ChunkBytesRefRescoreEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public ChunkBytesRefRescoreEvaluator(Source source, EvalOperator.ExpressionEvaluator str,
      String query, int numChunks, int chunkSize, DriverContext driverContext) {
    this.source = source;
    this.str = str;
    this.query = query;
  ...
  public BytesRefBlock eval(int positionCount, BytesRefBlock strBlock) {
    try(BytesRefBlock.Builder result = driverContext.blockFactory().newBytesRefBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        Chunk.process(result, str, this.query, this.numChunks, this.chunkSize);
      }
      return result.build();
    }
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    public Factory(Source source, EvalOperator.ExpressionEvaluator.Factory str, String query,
    ...
    public ChunkBytesRefRescoreEvaluator get(DriverContext context) {
      return new ChunkBytesRefRescoreEvaluator(source, str.get(context), query, numChunks, chunkSize, context);
    }

 ...
 */
public final class EndsWithEvaluator implements ExpressionEvaluator {
  ...
  private final ExpressionEvaluator suffix;

  private final DriverContext driverContext;

  private Warnings warnings;

  public EndsWithEvaluator(Source source, ExpressionEvaluator str, ExpressionEvaluator suffix,
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    private final ExpressionEvaluator.Factory suffix;

    public Factory(Source source, ExpressionEvaluator.Factory str,
        ExpressionEvaluator.Factory suffix) {
      this.source = source;
      this.str = str;
      this.suffix = suffix;
    }

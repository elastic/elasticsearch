 ...
 */
public final class FieldExtractConstantEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(FieldExtractConstantEvaluator.class);
  ...
  public BytesRefBlock eval(int positionCount, BytesRefBlock flattenedJsonBlock) {
    try(BytesRefBlock.Builder result = driverContext.blockFactory().newBytesRefBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          FieldExtract.processConstant(result, flattenedJson, this.path);
  ...
  public String toString() {
    return "FieldExtractConstantEvaluator[" + "flattenedJson=" + flattenedJson + ", path=" + path + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public FieldExtractConstantEvaluator get(DriverContext context) {
      return new FieldExtractConstantEvaluator(source, flattenedJson.get(context), path, context);
    }

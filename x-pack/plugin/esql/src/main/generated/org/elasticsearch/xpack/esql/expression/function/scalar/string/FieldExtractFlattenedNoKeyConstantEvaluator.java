 ...
 */
public final class FieldExtractFlattenedNoKeyConstantEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(FieldExtractFlattenedNoKeyConstantEvaluator.class);
  ...
  public FieldExtractFlattenedNoKeyConstantEvaluator(Source source,
      ExpressionEvaluator flattenedJson, String path, DriverContext driverContext) {
    this.source = source;
  ...
  public BytesRefBlock eval(int positionCount, BytesRefBlock flattenedJsonBlock) {
    try(BytesRefBlock.Builder result = driverContext.blockFactory().newBytesRefBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          FieldExtractFlattened.process(result, flattenedJson, this.path);
  ...
  public String toString() {
    return "FieldExtractFlattenedNoKeyConstantEvaluator[" + "flattenedJson=" + flattenedJson + ", path=" + path + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public FieldExtractFlattenedNoKeyConstantEvaluator get(DriverContext context) {
      return new FieldExtractFlattenedNoKeyConstantEvaluator(source, flattenedJson.get(context), path, context);
    }

 ...
 */
public final class FieldExtractFlattenedNoKeyEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(FieldExtractFlattenedNoKeyEvaluator.class);
  ...
  public FieldExtractFlattenedNoKeyEvaluator(Source source, ExpressionEvaluator flattenedJson,
  ...
  public BytesRefBlock eval(int positionCount, BytesRefBlock flattenedJsonBlock,
    ...
    try(BytesRefBlock.Builder result = driverContext.blockFactory().newBytesRefBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          FieldExtractFlattened.process(result, flattenedJson, path);
  ...
  public String toString() {
    return "FieldExtractFlattenedNoKeyEvaluator[" + "flattenedJson=" + flattenedJson + ", path=" + path + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public FieldExtractFlattenedNoKeyEvaluator get(DriverContext context) {
      return new FieldExtractFlattenedNoKeyEvaluator(source, flattenedJson.get(context), path.get(context), context);
    }

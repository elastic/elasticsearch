 ...
 */
public final class FmtBytesFromLongEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(FmtBytesFromLongEvaluator.class);
  ...
  public FmtBytesFromLongEvaluator(Source source, ExpressionEvaluator bytes,
  ...
  public String toString() {
    return "FmtBytesFromLongEvaluator[" + "bytes=" + bytes + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public FmtBytesFromLongEvaluator get(DriverContext context) {
      return new FmtBytesFromLongEvaluator(source, bytes.get(context), context);
    }

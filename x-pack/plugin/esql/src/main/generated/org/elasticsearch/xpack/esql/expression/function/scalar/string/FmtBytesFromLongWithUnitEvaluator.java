 ...
 */
public final class FmtBytesFromLongWithUnitEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(FmtBytesFromLongWithUnitEvaluator.class);
  ...
  public FmtBytesFromLongWithUnitEvaluator(Source source, ExpressionEvaluator bytes,
  ...
  public BytesRefBlock eval(int positionCount, LongBlock bytesBlock, BytesRefBlock unitBlock) {
    try(BytesRefBlock.Builder result = driverContext.blockFactory().newBytesRefBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendBytesRef(FmtBytes.processLongWithUnit(bytes, unit));
  ...
  public String toString() {
    return "FmtBytesFromLongWithUnitEvaluator[" + "bytes=" + bytes + ", unit=" + unit + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public FmtBytesFromLongWithUnitEvaluator get(DriverContext context) {
      return new FmtBytesFromLongWithUnitEvaluator(source, bytes.get(context), unit.get(context), context);
    }

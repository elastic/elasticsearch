 ...
 */
public final class FmtBytesSiFromIntWithUnitEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(FmtBytesSiFromIntWithUnitEvaluator.class);
  ...
  public FmtBytesSiFromIntWithUnitEvaluator(Source source, ExpressionEvaluator bytes,
  ...
  public BytesRefBlock eval(int positionCount, IntBlock bytesBlock, BytesRefBlock unitBlock) {
    try(BytesRefBlock.Builder result = driverContext.blockFactory().newBytesRefBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendBytesRef(FmtBytesSi.processIntWithUnit(bytes, unit));
  ...
  public String toString() {
    return "FmtBytesSiFromIntWithUnitEvaluator[" + "bytes=" + bytes + ", unit=" + unit + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public FmtBytesSiFromIntWithUnitEvaluator get(DriverContext context) {
      return new FmtBytesSiFromIntWithUnitEvaluator(source, bytes.get(context), unit.get(context), context);
    }

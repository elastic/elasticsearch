 ...
 */
public final class FmtPercentFromDoubleEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(FmtPercentFromDoubleEvaluator.class);
  ...
  public FmtPercentFromDoubleEvaluator(Source source, ExpressionEvaluator value,
  ...
  public BytesRefBlock eval(int positionCount, DoubleBlock valueBlock) {
    try(BytesRefBlock.Builder result = driverContext.blockFactory().newBytesRefBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendBytesRef(FmtPercent.processDouble(value));
      }
      return result.build();
    }
  }

  public BytesRefVector eval(int positionCount, DoubleVector valueVector) {
  ...
  public String toString() {
    return "FmtPercentFromDoubleEvaluator[" + "value=" + value + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public FmtPercentFromDoubleEvaluator get(DriverContext context) {
      return new FmtPercentFromDoubleEvaluator(source, value.get(context), context);
    }

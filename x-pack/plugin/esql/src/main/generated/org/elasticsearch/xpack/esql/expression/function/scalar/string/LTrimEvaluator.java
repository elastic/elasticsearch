...
/**
 * {@link ExpressionEvaluator} implementation for {@link LTrim}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class LTrimEvaluator implements ExpressionEvaluator {
  ...
  public LTrimEvaluator(Source source, ExpressionEvaluator val, DriverContext driverContext) {
    this.source = source;
    this.val = val;
  ...
  public BytesRefBlock eval(int positionCount, BytesRefBlock valBlock) {
    try(BytesRefBlock.Builder result = driverContext.blockFactory().newBytesRefBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendBytesRef(LTrim.process(val));
      }
      return result.build();
    }
  }

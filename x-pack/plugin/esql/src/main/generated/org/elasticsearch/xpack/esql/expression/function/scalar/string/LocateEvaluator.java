 ...
 */
public final class LocateEvaluator implements ExpressionEvaluator {
  ...
  public LocateEvaluator(Source source, ExpressionEvaluator str, ExpressionEvaluator substr,
      ExpressionEvaluator start, DriverContext driverContext) {
    this.source = source;
    this.str = str;
    this.substr = substr;
    this.start = start;
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public Factory(Source source, ExpressionEvaluator.Factory str,
        ExpressionEvaluator.Factory substr, ExpressionEvaluator.Factory start) {
      this.source = source;
      this.str = str;
      this.substr = substr;
      this.start = start;

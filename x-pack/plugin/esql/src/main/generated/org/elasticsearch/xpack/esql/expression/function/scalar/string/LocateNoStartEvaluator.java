...
/**
 * {@link ExpressionEvaluator} implementation for {@link Locate}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class LocateNoStartEvaluator implements ExpressionEvaluator {
  ...
  private final ExpressionEvaluator substr;

  private final DriverContext driverContext;

  private Warnings warnings;

  public LocateNoStartEvaluator(Source source, ExpressionEvaluator str, ExpressionEvaluator substr,
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    private final ExpressionEvaluator.Factory substr;

    public Factory(Source source, ExpressionEvaluator.Factory str,
        ExpressionEvaluator.Factory substr) {
      this.source = source;
      this.str = str;
      this.substr = substr;
    }

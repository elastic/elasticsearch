 ...
 */
public final class AddDenseVectorDoubleEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(AddDenseVectorDoubleEvaluator.class);
  ...
  public AddDenseVectorDoubleEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Add.processDenseVectorDouble(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "AddDenseVectorDoubleEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public AddDenseVectorDoubleEvaluator get(DriverContext context) {
      return new AddDenseVectorDoubleEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

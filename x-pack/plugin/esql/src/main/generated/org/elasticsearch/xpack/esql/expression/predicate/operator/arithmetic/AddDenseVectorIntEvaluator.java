 ...
 */
public final class AddDenseVectorIntEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(AddDenseVectorIntEvaluator.class);
  ...
  public AddDenseVectorIntEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Add.processDenseVectorInt(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "AddDenseVectorIntEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public AddDenseVectorIntEvaluator get(DriverContext context) {
      return new AddDenseVectorIntEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

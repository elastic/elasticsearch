 ...
 */
public final class AddDenseVectorLongEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(AddDenseVectorLongEvaluator.class);
  ...
  public AddDenseVectorLongEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Add.processDenseVectorLong(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "AddDenseVectorLongEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public AddDenseVectorLongEvaluator get(DriverContext context) {
      return new AddDenseVectorLongEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

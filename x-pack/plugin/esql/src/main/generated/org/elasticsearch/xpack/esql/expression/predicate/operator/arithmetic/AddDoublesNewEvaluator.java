 ...
 */
public final class AddDoublesNewEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(AddDoublesNewEvaluator.class);
  ...
  public AddDoublesNewEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock lhsBlock, DoubleBlock rhsBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendDouble(Add.processDoublesNew(lhs, rhs));
  ...
  public String toString() {
    return "AddDoublesNewEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public AddDoublesNewEvaluator get(DriverContext context) {
      return new AddDoublesNewEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

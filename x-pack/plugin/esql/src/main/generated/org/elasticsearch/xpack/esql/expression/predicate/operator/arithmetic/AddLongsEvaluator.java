 ...
 */
public final class AddLongsEvaluator implements ExpressionEvaluator {
  ...
  public AddLongsEvaluator(Source source, ExpressionEvaluator lhs, ExpressionEvaluator rhs,
  ...
  public LongBlock eval(int positionCount, LongBlock lhsBlock, LongBlock rhsBlock) {
    try(LongBlock.Builder result = driverContext.blockFactory().newLongBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendLong(Add.processLongs(lhs, rhs));
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public AddLongsEvaluator get(DriverContext context) {
      return new AddLongsEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

...
public final class AddLongsEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public AddLongsEvaluator get(DriverContext context, boolean collectWarnings) {
      return new AddLongsEvaluator(source, lhs.get(context, collectWarnings), rhs.get(context, collectWarnings), context, collectWarnings ? new Warnings(source) : Warnings.NOOP_WARNINGS);
    }

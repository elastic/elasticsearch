 ...
 */
public final class AddLongsNewEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(AddLongsNewEvaluator.class);
  ...
  public AddLongsNewEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
  ...
  public LongBlock eval(int positionCount, LongBlock lhsBlock, LongBlock rhsBlock) {
    try(LongBlock.Builder result = driverContext.blockFactory().newLongBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendLong(Add.processLongsNew(lhs, rhs));
  ...
  public String toString() {
    return "AddLongsNewEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public AddLongsNewEvaluator get(DriverContext context) {
      return new AddLongsNewEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

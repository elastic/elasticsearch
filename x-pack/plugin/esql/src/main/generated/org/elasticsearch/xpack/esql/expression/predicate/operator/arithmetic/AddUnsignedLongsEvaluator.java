 ...
 */
public final class AddUnsignedLongsEvaluator implements ExpressionEvaluator {
  ...
  public AddUnsignedLongsEvaluator(Source source, ExpressionEvaluator lhs, ExpressionEvaluator rhs,
  ...
  public LongBlock eval(int positionCount, LongBlock lhsBlock, LongBlock rhsBlock) {
    try(LongBlock.Builder result = driverContext.blockFactory().newLongBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendLong(Add.processUnsignedLongs(lhs, rhs));

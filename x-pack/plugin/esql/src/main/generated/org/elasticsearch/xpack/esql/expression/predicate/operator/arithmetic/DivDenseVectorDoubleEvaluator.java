 ...
 */
public final class DivDenseVectorDoubleEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(DivDenseVectorDoubleEvaluator.class);
  ...
  public DivDenseVectorDoubleEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
  ...
  public FloatBlock eval(int positionCount, FloatBlock lhsBlock, DoubleBlock rhsBlock) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Div.processDenseVectorDouble(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "DivDenseVectorDoubleEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public DivDenseVectorDoubleEvaluator get(DriverContext context) {
      return new DivDenseVectorDoubleEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

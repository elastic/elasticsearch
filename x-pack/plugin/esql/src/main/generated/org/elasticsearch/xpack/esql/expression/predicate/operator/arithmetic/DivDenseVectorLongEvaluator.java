 ...
 */
public final class DivDenseVectorLongEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(DivDenseVectorLongEvaluator.class);
  ...
  public DivDenseVectorLongEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
  ...
  public FloatBlock eval(int positionCount, FloatBlock lhsBlock, LongBlock rhsBlock) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Div.processDenseVectorLong(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "DivDenseVectorLongEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public DivDenseVectorLongEvaluator get(DriverContext context) {
      return new DivDenseVectorLongEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

 ...
 */
public final class DivDoublesEvaluator implements ExpressionEvaluator {
  ...
  public DivDoublesEvaluator(Source source, ExpressionEvaluator lhs, ExpressionEvaluator rhs,
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock lhsBlock, DoubleBlock rhsBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendDouble(Div.processDoubles(lhs, rhs, this.allowNonFinite));
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public DivDoublesEvaluator get(DriverContext context) {
      return new DivDoublesEvaluator(source, lhs.get(context), rhs.get(context), allowNonFinite, context);
    }

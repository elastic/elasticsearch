 ...
 */
public final class MulDenseVectorDoubleEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MulDenseVectorDoubleEvaluator.class);
  ...
  public MulDenseVectorDoubleEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Mul.processDenseVectorDouble(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "MulDenseVectorDoubleEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public MulDenseVectorDoubleEvaluator get(DriverContext context) {
      return new MulDenseVectorDoubleEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

 ...
 */
public final class MulDenseVectorIntEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MulDenseVectorIntEvaluator.class);
  ...
  public MulDenseVectorIntEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Mul.processDenseVectorInt(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "MulDenseVectorIntEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public MulDenseVectorIntEvaluator get(DriverContext context) {
      return new MulDenseVectorIntEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

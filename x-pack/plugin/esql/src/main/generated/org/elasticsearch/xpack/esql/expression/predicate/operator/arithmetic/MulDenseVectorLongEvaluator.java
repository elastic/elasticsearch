 ...
 */
public final class MulDenseVectorLongEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(MulDenseVectorLongEvaluator.class);
  ...
  public MulDenseVectorLongEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Mul.processDenseVectorLong(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "MulDenseVectorLongEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public MulDenseVectorLongEvaluator get(DriverContext context) {
      return new MulDenseVectorLongEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

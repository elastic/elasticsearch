...
/**
 * {@link ExpressionEvaluator} implementation for {@link Mul}.
 * This class is generated. Edit {@code EvaluatorImplementer} instead.
 */
public final class MulDoublesEvaluator implements ExpressionEvaluator {
  ...
  public MulDoublesEvaluator(Source source, ExpressionEvaluator lhs, ExpressionEvaluator rhs,
  ...
  public DoubleBlock eval(int positionCount, DoubleBlock lhsBlock, DoubleBlock rhsBlock) {
    try(DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendDouble(Mul.processDoubles(lhs, rhs, this.allowNonFinite));
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    public MulDoublesEvaluator get(DriverContext context) {
      return new MulDoublesEvaluator(source, lhs.get(context), rhs.get(context), allowNonFinite, context);
    }

 ...
 */
public final class NegIntsEvaluator implements ExpressionEvaluator {
  ...
  public NegIntsEvaluator(Source source, ExpressionEvaluator v, DriverContext driverContext) {
    this.source = source;
    this.v = v;

 ...
 */
public final class NegLongsEvaluator implements ExpressionEvaluator {
  ...
  public NegLongsEvaluator(Source source, ExpressionEvaluator v, DriverContext driverContext) {
    this.source = source;
    this.v = v;

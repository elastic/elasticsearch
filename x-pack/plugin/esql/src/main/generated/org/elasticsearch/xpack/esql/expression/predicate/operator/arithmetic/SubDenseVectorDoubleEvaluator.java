 ...
 */
public final class SubDenseVectorDoubleEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(SubDenseVectorDoubleEvaluator.class);
  ...
  public SubDenseVectorDoubleEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Sub.processDenseVectorDouble(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "SubDenseVectorDoubleEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public SubDenseVectorDoubleEvaluator get(DriverContext context) {
      return new SubDenseVectorDoubleEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

 ...
 */
public final class SubDenseVectorIntEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(SubDenseVectorIntEvaluator.class);
  ...
  public SubDenseVectorIntEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Sub.processDenseVectorInt(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "SubDenseVectorIntEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public SubDenseVectorIntEvaluator get(DriverContext context) {
      return new SubDenseVectorIntEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

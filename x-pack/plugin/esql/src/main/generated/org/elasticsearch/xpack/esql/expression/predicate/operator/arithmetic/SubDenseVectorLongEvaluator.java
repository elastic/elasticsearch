 ...
 */
public final class SubDenseVectorLongEvaluator implements EvalOperator.ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(SubDenseVectorLongEvaluator.class);
  ...
  public SubDenseVectorLongEvaluator(Source source, EvalOperator.ExpressionEvaluator lhs,
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          ...
          for (int lhsOffset = lhsStart; lhsOffset < lhsEnd; lhsOffset++) {
            ...
            buffer[i++] = Sub.processDenseVectorLong(lhsValue, rhs);
          }
  ...
  public String toString() {
    return "SubDenseVectorLongEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public SubDenseVectorLongEvaluator get(DriverContext context) {
      return new SubDenseVectorLongEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

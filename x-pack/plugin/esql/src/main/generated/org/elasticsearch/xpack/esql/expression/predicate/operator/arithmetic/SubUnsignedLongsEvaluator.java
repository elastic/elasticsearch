 ...
 */
public final class SubUnsignedLongsEvaluator implements ExpressionEvaluator {
  ...
  public SubUnsignedLongsEvaluator(Source source, ExpressionEvaluator lhs, ExpressionEvaluator rhs,
  ...
  public LongBlock eval(int positionCount, LongBlock lhsBlock, LongBlock rhsBlock) {
    try(LongBlock.Builder result = driverContext.blockFactory().newLongBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        try {
          result.appendLong(Sub.processUnsignedLongs(lhs, rhs));

 ...
 */
public final class EqualsExponentialHistogramEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(EqualsExponentialHistogramEvaluator.class);
  ...
  public EqualsExponentialHistogramEvaluator(Source source, ExpressionEvaluator lhs,
  ...
  public BooleanBlock eval(int positionCount, ExponentialHistogramBlock lhsBlock,
    ...
    try(BooleanBlock.Builder result = driverContext.blockFactory().newBooleanBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendBoolean(Equals.processExponentialHistogram(lhs, rhs));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "EqualsExponentialHistogramEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public EqualsExponentialHistogramEvaluator get(DriverContext context) {
      return new EqualsExponentialHistogramEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

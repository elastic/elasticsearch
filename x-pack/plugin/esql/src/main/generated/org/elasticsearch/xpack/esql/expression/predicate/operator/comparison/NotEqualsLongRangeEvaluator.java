 ...
 */
public final class NotEqualsLongRangeEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(NotEqualsLongRangeEvaluator.class);
  ...
  public NotEqualsLongRangeEvaluator(Source source, ExpressionEvaluator lhs,
  ...
  public BooleanBlock eval(int positionCount, LongRangeBlock lhsBlock, LongRangeBlock rhsBlock) {
    try(BooleanBlock.Builder result = driverContext.blockFactory().newBooleanBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendBoolean(NotEquals.processLongRange(lhs, rhs));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "NotEqualsLongRangeEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public NotEqualsLongRangeEvaluator get(DriverContext context) {
      return new NotEqualsLongRangeEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

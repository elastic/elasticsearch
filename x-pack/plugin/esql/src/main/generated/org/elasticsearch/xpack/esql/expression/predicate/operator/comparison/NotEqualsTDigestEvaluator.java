 ...
 */
public final class NotEqualsTDigestEvaluator implements ExpressionEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(NotEqualsTDigestEvaluator.class);
  ...
  public NotEqualsTDigestEvaluator(Source source, ExpressionEvaluator lhs, ExpressionEvaluator rhs,
  ...
  public BooleanBlock eval(int positionCount, TDigestBlock lhsBlock, TDigestBlock rhsBlock) {
    try(BooleanBlock.Builder result = driverContext.blockFactory().newBooleanBlockBuilder(positionCount)) {
      ...
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendBoolean(NotEquals.processTDigest(lhs, rhs));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "NotEqualsTDigestEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public NotEqualsTDigestEvaluator get(DriverContext context) {
      return new NotEqualsTDigestEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

 ...
 */
public final class CastUnsignedLongToLongEvaluator implements EvalOperator.ExpressionEvaluator {
  private final EvalOperator.ExpressionEvaluator v;

  public CastUnsignedLongToLongEvaluator(EvalOperator.ExpressionEvaluator v) {
    this.v = v;
  }
  ...
  public LongBlock eval(int positionCount, LongBlock vBlock) {
    ...
    position: for (int p = 0; p < positionCount; p++) {
      ...
      result.appendLong(Cast.castUnsignedLongToLong(vBlock.getLong(vBlock.getFirstValueIndex(p))));
    }
    return result.build();
  }
  ...
  public LongVector eval(int positionCount, LongVector vVector) {
    ...
    position: for (int p = 0; p < positionCount; p++) {
      result.appendLong(Cast.castUnsignedLongToLong(vVector.getLong(p)));
    }
    return result.build();
  }
  ...
  public String toString() {
    return "CastUnsignedLongToLongEvaluator[" + "v=" + v + "]";
  }
}

 ...
 */
public final class PowDoubleDoubleEvaluator implements EvalOperator.ExpressionEvaluator {
  private final EvalOperator.ExpressionEvaluator base;

  private final EvalOperator.ExpressionEvaluator exponent;

  public PowDoubleDoubleEvaluator(EvalOperator.ExpressionEvaluator base,
  ...
  public String toString() {
    return "PowDoubleDoubleEvaluator[" + "base=" + base + ", exponent=" + exponent + "]";
  }
}

 ...
 */
public final class PowLongLongEvaluator implements EvalOperator.ExpressionEvaluator {
  private final EvalOperator.ExpressionEvaluator base;

  private final EvalOperator.ExpressionEvaluator exponent;

  public PowLongLongEvaluator(EvalOperator.ExpressionEvaluator base,
  ...
  static Long fold(Expression base, Expression exponent) {
    ...
    return Pow.process(((Number) baseVal).longValue(), ((Number) exponentVal).longValue());
  }
  ...
  public String toString() {
    return "PowLongLongEvaluator[" + "base=" + base + ", exponent=" + exponent + "]";
  }
}

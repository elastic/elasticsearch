 ...
 */
public final class MvMedian2DoubleEvaluator extends AbstractMultivalueFunction.AbstractEvaluator {
  public MvMedian2DoubleEvaluator(EvalOperator.ExpressionEvaluator field,
  ...
  public Block evalNullable(Block fieldVal) {
    ...
    try (DoubleBlock.Builder builder = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
      MvMedian2.Doubles work = new MvMedian2.Doubles();
  ...
  public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public MvMedian2DoubleEvaluator get(DriverContext context) {
      return new MvMedian2DoubleEvaluator(field.get(context), context);
    }

 ...
 */
public final class SpatialIntersectsCartesianPointDocValuesAndDocValuesEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public SpatialIntersectsCartesianPointDocValuesAndDocValuesEvaluator(Source source,
  ...
  public BooleanBlock eval(int positionCount, LongBlock leftValueBlock, LongBlock rightValueBlock) {
    try(BooleanBlock.Builder result = driverContext.blockFactory().newBooleanBlockBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        ...
        result.appendBoolean(SpatialIntersects.processCartesianPointDocValuesAndDocValues(leftValueBlock.getLong(leftValueBlock.getFirstValueIndex(p)), rightValueBlock.getLong(rightValueBlock.getFirstValueIndex(p))));
      }
      return result.build();
    }
  }
  ...
  public BooleanVector eval(int positionCount, LongVector leftValueVector,
    ...
    try(BooleanVector.Builder result = driverContext.blockFactory().newBooleanVectorBuilder(positionCount)) {
      position: for (int p = 0; p < positionCount; p++) {
        result.appendBoolean(SpatialIntersects.processCartesianPointDocValuesAndDocValues(leftValueVector.getLong(p), rightValueVector.getLong(p)));
      }
      return result.build();
    }
  }
  ...
  public String toString() {
    return "SpatialIntersectsCartesianPointDocValuesAndDocValuesEvaluator[" + "leftValue=" + leftValue + ", rightValue=" + rightValue + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public SpatialIntersectsCartesianPointDocValuesAndDocValuesEvaluator get(
        DriverContext context) {
      return new SpatialIntersectsCartesianPointDocValuesAndDocValuesEvaluator(source, leftValue.get(context), rightValue.get(context), context);
    }

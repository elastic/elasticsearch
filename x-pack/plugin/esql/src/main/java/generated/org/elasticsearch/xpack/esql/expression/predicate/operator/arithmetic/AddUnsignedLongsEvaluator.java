...
public final class AddUnsignedLongsEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public String toString() {
    return "AddUnsignedLongsEvaluator[" + "lhs=" + lhs + ", rhs=" + rhs + "]";
  }
  ...
  static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
    ...
    @Override
    public AddUnsignedLongsEvaluator get(DriverContext context) {
      return new AddUnsignedLongsEvaluator(source, lhs.get(context), rhs.get(context), context);
    }

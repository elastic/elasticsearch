...
public final class LessThanDoublesEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public LessThanDoublesEvaluator(EvalOperator.ExpressionEvaluator lhs,
  ...
  static Boolean fold(Expression lhs, Expression rhs) {
    ...
    return LessThan.processDoubles(((Number) lhsVal).doubleValue(), ((Number) rhsVal).doubleValue());
  }

...
public final class LessThanOrEqualIntsEvaluator implements EvalOperator.ExpressionEvaluator {
  ...
  public LessThanOrEqualIntsEvaluator(EvalOperator.ExpressionEvaluator lhs,
  ...
  static Boolean fold(Expression lhs, Expression rhs) {
    ...
    return LessThanOrEqual.processInts(((Number) lhsVal).intValue(), ((Number) rhsVal).intValue());
  }

...
final class RequestXContent {
    ...
    private static final ParseField INCLUDE_CPS_METADATA_FIELD = new ParseField("include_cps_metadata");
    ...
    private static void objectParserCommon(ObjectParser<EsqlQueryRequest, ?> parser) {
        ...
        parser.declareBoolean(EsqlQueryRequest::includeCPSMetadata, INCLUDE_CPS_METADATA_FIELD);

...
public final class ResponseValueUtils {
    ...
    private static Object valueAt(String dataType, Block block, int offset, BytesRef scratch) {
        return switch (dataType) {
            ...
            case "geo_point", "geography" -> GEO.wkbToWkt(((BytesRefBlock) block).getBytesRef(offset, scratch));
            case "cartesian_point", "geometry" -> CARTESIAN.wkbToWkt(((BytesRefBlock) block).getBytesRef(offset, scratch));

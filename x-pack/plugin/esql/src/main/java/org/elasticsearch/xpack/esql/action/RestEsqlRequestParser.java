...
/** Static methods to convert an ES|QL request from REST/xcontent to a transport request. */
public final class RestEsqlRequestParser {
    ...
    private static void objectParserCommon(ObjectParser<EsqlQueryRequest, ?> parser) {
        ...
        parser.declareField(EsqlQueryRequest::params, RestEsqlRequestParser::parseParams, PARAMS_FIELD, VALUE_ARRAY);

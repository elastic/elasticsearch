...
public class Exchange {
    ...
    public Exchange(int defaultConcurrency, PlanNode.ExchangeNode.Partitioning partitioning, int bufferMaxPages) {
        int bufferCount = partitioning == PlanNode.ExchangeNode.Partitioning.SINGLE_DISTRIBUTION ? 1 : defaultConcurrency;
        ...
        } else if (partitioning == PlanNode.ExchangeNode.Partitioning.FIXED_ARBITRARY_DISTRIBUTION) {

...
import org.elasticsearch.xpack.esql.action.compute.operator.EvalOperator;
import org.elasticsearch.xpack.esql.action.compute.operator.EvalOperator.ExpressionEvaluator;
...
import org.elasticsearch.xpack.esql.action.compute.operator.TopNOperator;
...
public class LocalExecutionPlanner {
    ...
    public PhysicalOperation plan(LogicalPlan node, LocalExecutionPlanContext context) {
        if (node instanceof Aggregate aggregate) {
            ...
            Exchange ex = new Exchange(driverInstances, exchange.getPartitioning(), bufferMaxPages);

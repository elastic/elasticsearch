...
public class PreAnalyzer {
    ...
    public static class PreAnalysis {
        ...
        public final List<InferencePlan> inferences;
        public final List<TableInfo> lookupIndices;

        public PreAnalysis(List<TableInfo> indices, List<Enrich> enriches, List<InferencePlan> inferences, List<TableInfo> lookupIndices) {
    ...
    protected PreAnalysis doPreAnalyze(LogicalPlan plan) {
        ...
        List<InferencePlan> inferences = new ArrayList<>();

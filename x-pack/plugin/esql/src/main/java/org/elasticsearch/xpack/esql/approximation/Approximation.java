 ...
 * approximation query happens during logical optimization, in the rule
 ...
 * is needed. The first goal is to find a sample probability that leads to approximately

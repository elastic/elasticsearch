 ...
 */
public interface PreOptimizerProcessor<C, R> {
     ...
     */
    C preOptimizerPreExec(LogicalPlan plan);
     ...
     */
    void preOptimizerExec(Services services, C c, ActionListener<R> listener);
     ...
     */
    default LogicalPlan preOptimizerPostExec(LogicalPlan plan, R r) {
        return plan;
    }
}

...
/**
 * Hints for partition planning in {@link Connector#planPartitions}.
 *
 * <h2>Call Sites</h2>
 *
 ...
 *
 * <p><b>Passed to:</b> {@link Connector#planPartitions} to guide partitioning decisions.
 *
 * <p>Connectors should treat these as guidance, not strict requirements. For example,
 * a connector may create fewer partitions if the data is small, or more if files are numerous.
 *

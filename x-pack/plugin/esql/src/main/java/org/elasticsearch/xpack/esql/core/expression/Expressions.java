...
public final class Expressions {
     ...
     *   {@link org.elasticsearch.xpack.esql.plan.logical.UnionPlan} output.</li>
     *   <li>An {@link ExternalMetadataAttribute} is rebuilt as the same subtype with the preserved id. The
     *   "virtual column" identity must survive operators that re-class their output (e.g. {@code UnionPlan.refreshOutput()})
     ...
     *   into default output and would also re-enable predicate pushdown on virtual columns past a {@code UnionPlan}.</li>
     * </ul>
     */

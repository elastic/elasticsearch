...
public abstract class NodeInfo<T extends Node<?>> {
    ...
    public static <T extends Node<?>, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12> NodeInfo<T> create(
        T n,
        NodeCtor12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, T> ctor,
        P1 p1,
        P2 p2,
        P3 p3,
        P4 p4,
        ...
        return new NodeInfo<T>(n) {
            @Override
            protected List<Object> innerProperties() {
                return Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12);
            }
            ...
            protected T innerTransform(Function<Object, Object> rule) {
                ...
                same &= Objects.equals(p11, newP11);
                @SuppressWarnings("unchecked")
                P12 newP12 = (P12) rule.apply(p12);
                same &= Objects.equals(p12, newP12);

                return same
                    ? node
                    : ctor.apply(node.source(), newP1, newP2, newP3, newP4, newP5, newP6, newP7, newP8, newP9, newP10, newP11, newP12);
            }
        };
    }

    public interface NodeCtor12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, T> {
        T apply(Source l, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8, P9 p9, P10 p10, P11 p11, P12 p12);
    }

    public static <T extends Node<?>, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13> NodeInfo<T> create(
        T n,
        NodeCtor13<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, T> ctor,
        P1 p1,
        P2 p2,
        P3 p3,
        P4 p4,
        ...
        return new NodeInfo<T>(n) {
            @Override
            protected List<Object> innerProperties() {
                return Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13);
            }
            ...
            protected T innerTransform(Function<Object, Object> rule) {
                ...
                same &= Objects.equals(p12, newP12);
                @SuppressWarnings("unchecked")
                P13 newP13 = (P13) rule.apply(p13);
                same &= Objects.equals(p13, newP13);
    ...
    public interface NodeCtor13<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, T> {
        T apply(Source l, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8, P9 p9, P10 p10, P11 p11, P12 p12, P13 p13);
    }

    public static <T extends Node<?>, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> NodeInfo<T> create(
        T n,
        NodeCtor14<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, T> ctor,
        P1 p1,
        P2 p2,
        P3 p3,
        P4 p4,
        ...
        return new NodeInfo<T>(n) {
            ...
            protected T innerTransform(Function<Object, Object> rule) {
                ...
                same &= Objects.equals(p13, newP13);
                @SuppressWarnings("unchecked")
                P14 newP14 = (P14) rule.apply(p14);
                same &= Objects.equals(p14, newP14);
    ...
    public interface NodeCtor14<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, T> {
        T apply(Source l, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8, P9 p9, P10 p10, P11 p11, P12 p12, P13 p13, P14 p14);
    }
}

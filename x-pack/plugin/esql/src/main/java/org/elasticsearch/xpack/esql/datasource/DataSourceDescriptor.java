 ...
 *
 * <p>Three forms, all data source-specific and opaque to ES|QL:
 * <ul>
...
public record DataSourceDescriptor(
     ...
     * @param type The data source type from the registration
     ...
     * @param source Source location for error reporting
     */
    public static DataSourceDescriptor registered(
        String dataSourceName,
        String type,
        Map<String, Object> configuration,
        Map<String, Object> settings,
        ...
        return new DataSourceDescriptor(type, configuration, settings, expression, dataSourceName, source);
    }
     ...
     *
     * @param type The data source type (e.g., "s3")
     * @param configuration The inline configuration
     * @param settings The inline settings
     * @param expression The expression after {@code :} (e.g., "logs", "logs/*.parquet")
     * @param source Source location for error reporting
     */
    public static DataSourceDescriptor inline(
        String type,
        Map<String, Object> configuration,
        Map<String, Object> settings,
        String expression,
        ...
        return new DataSourceDescriptor(type, configuration, settings, expression, null, source);
    }

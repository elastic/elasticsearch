 ...
 * </ol>
 *
 * <p>Both {@link org.elasticsearch.xpack.esql.datasource.sql.SqlDataSource} and
 * {@link org.elasticsearch.xpack.esql.datasource.lakehouse.LakehouseDataSource} use this class for their
 * built-in pushdown rules.
 *
 * <p>Usage example:
 * <pre>{@code
 * private class PushFilterToSql extends DataSourcePushdownRule<Filter, SqlPlan> {
 *     PushFilterToSql() { super(SqlDataSource.this, SqlPlan.class); }
 *
 *     @Override
 ...
 * @param <P> The data source plan type to expect as the child (e.g., SqlPlan, LakehousePlan)
 */

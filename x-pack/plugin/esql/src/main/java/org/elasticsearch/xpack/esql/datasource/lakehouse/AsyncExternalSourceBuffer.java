 ...
 *
 * <p>This buffer provides:
 * <ul>
 *   <li>Thread-safe page queue for cross-thread communication</li>
 *   <li>Backpressure control via max buffer size</li>
 *   <li>Notification via {@link SubscribableListener} when data becomes available</li>
 *   <li>Lifecycle management (finished state tracking)</li>
 * </ul>
 */
public final class AsyncExternalSourceBuffer {
     ...
     *
     * <p>Unlike {@link #waitForWriting()} which returns an {@link IsBlockedResult}, this method

 ...
 *
 * <p>This operator uses an async pattern:
 * <ul>
 *   <li>Background thread reads from external source and fills a buffer</li>
 *   <li>Operator polls from buffer without blocking the Driver</li>
 *   <li>{@link #isBlocked()} signals when waiting for data</li>
 * </ul>
 */

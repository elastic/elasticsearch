 ...
 *
 * <p>This is the synchronous implementation that works with any StorageProvider
 * (HTTP, S3, local) and any FormatReader (CSV, Parquet, etc.). For async
 * operation with backpressure, use {@link AsyncExternalSourceOperatorFactory}.
 *
 * <p>The factory creates operators that:
 * <ul>
...
public class ExternalSourceOperatorFactory implements SourceOperator.SourceOperatorFactory {
    ...
    public SourceOperator get(DriverContext driverContext) {
        ...
        try {
            ...
            return new ExternalSourceOperator(pages);
        } catch (Exception e) {
     ...
     * This is a synchronous operator — for async operations, use {@link AsyncExternalSourceOperator}.
     */
    private static class ExternalSourceOperator extends SourceOperator {
        ...
        ExternalSourceOperator(CloseableIterator<Page> pages) {
            this.pages = pages;
        }

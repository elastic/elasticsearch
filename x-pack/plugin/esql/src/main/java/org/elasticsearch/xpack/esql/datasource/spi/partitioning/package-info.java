 ...
 *
 * <ul>
 *   <li>{@link org.elasticsearch.xpack.esql.datasource.spi.partitioning.DataSourceSplit} — interface
 *       for discovered units of work with optional size estimates and node affinity</li>
 *   <li>{@link org.elasticsearch.xpack.esql.datasource.spi.partitioning.SplitPartitioner} — reusable
 *       discover → group → wrap pipeline helper</li>
 *   <li>{@link org.elasticsearch.xpack.esql.datasource.spi.partitioning.DistributionHints} — planner
 *       hints for partitioning (target parallelism, available nodes, locality preference)</li>
 *   <li>{@link org.elasticsearch.xpack.esql.datasource.spi.partitioning.NodeAffinity} — hard (required)
 *       vs soft (preferred) node affinity for splits and partitions</li>
 * </ul>
 *
 * <h2>Algorithm</h2>
 *
 * <p>{@link org.elasticsearch.xpack.esql.datasource.spi.partitioning.SizeAwareBinPacking} provides
 ...
 * {@link org.elasticsearch.xpack.esql.datasource.spi.partitioning.DistributionHints#preferDataLocality()}
 * is true.
 *
 * @see org.elasticsearch.xpack.esql.datasource.spi.DataSource#planPartitions

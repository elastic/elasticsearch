...
/**
 * Base class for SQL data sources (Postgres, MySQL, Oracle, etc.).
 *
 ...
 * <ul>
 *   <li>Define a data source-specific {@link SqlPlan} implementation</li>
...
public abstract class SqlDataSource implements DataSource {
    ...
    /**
     * Returns default optimization rules for SQL data sources:
     * <ul>
     ...
     * </ul>
     *
     * <p>Rules are non-static inner classes that call this data source's abstract translate methods.
     ...
     */
    private class PushFilterToSql extends DataSourcePushdownRule<Filter, SqlPlan> {
        PushFilterToSql() {
            super(SqlDataSource.this, SqlPlan.class);
        }
     ...
     */
    private class PushLimitToSql extends DataSourcePushdownRule<Limit, SqlPlan> {
        PushLimitToSql() {
            super(SqlDataSource.this, SqlPlan.class);
        }
     ...
     */
    private class PushOrderByToSql extends DataSourcePushdownRule<OrderBy, SqlPlan> {
        PushOrderByToSql() {
            super(SqlDataSource.this, SqlPlan.class);
        }
     ...
     */
    private class PushAggregateToSql extends DataSourcePushdownRule<Aggregate, SqlPlan> {
        PushAggregateToSql() {
            super(SqlDataSource.this, SqlPlan.class);
        }
    ...
    private class BuildSql extends OptimizerRules.OptimizerRule<LogicalPlan> {
        ...
        protected LogicalPlan rule(LogicalPlan plan) {
            ...
            if (sqlPlan.dataSource() != SqlDataSource.this) {
                return plan;
            }

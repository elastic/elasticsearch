 ...
 * {@link ExternalSourceOperatorFactory}, which pins each reader to the per-file schema
 * carried by its {@link FileSplit}.
 *
 * @deprecated retained for test fixtures only; new code should use
 *             {@link ExternalSourceOperatorFactory}.
 */
@Deprecated
public class SingleFileExternalSourceOperatorFactory implements SourceOperator.SourceOperatorFactory {
    ...
    public SingleFileExternalSourceOperatorFactory(

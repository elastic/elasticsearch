...
public final class StreamingParallelParsingCoordinator {
    ...
    /**
     * As the above, plus an explicit {@code readerWarningSink}, still defaulting to
     * {@link StreamingSegmentatorAdmission#unbounded()}. Retained for tests and benchmarks that care about
     * reader-warning routing but not the admission gate.
     */
    public static CloseableIterator<Page> parallelRead(
        SegmentableFormatReader reader,
        InputStream decompressedStream,

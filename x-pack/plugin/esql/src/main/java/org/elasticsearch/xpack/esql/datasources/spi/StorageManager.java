    ...
    private StorageProvider createProviderWithConfig(StoragePath path, String scheme, Object config) {
        ...
        if (scheme.equals("s3") || scheme.equals("s3a") || scheme.equals("s3n")) {
            if (config == null) {
                ...
                throw new IllegalArgumentException(
                    "S3 scheme requires S3Configuration, got: " + config.getClass().getName()
                );
            }
        }
        ...
        if (scheme.equals("http") || scheme.equals("https")) {
            ...
            if (config != null && config instanceof HttpConfiguration == false) {
                ...
                throw new IllegalArgumentException(
                    "HTTP scheme requires HttpConfiguration, got: " + config.getClass().getName()
                );
            }
        ...
        if (scheme.equals("file")) {
            if (config != null) {
                throw new IllegalArgumentException(
                    "file:// scheme does not accept configuration, got: " + config.getClass().getName()
                );
            }
        ...
        throw new IllegalArgumentException(
            ...
            "Supported schemes: s3://, s3a://, s3n://, http://, https://, file://"
        );
    }
}

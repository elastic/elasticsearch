...
public class LookupFromIndexService extends AbstractLookupService<LookupFromIndexService.Request, LookupFromIndexService.LookupRequest> {
    ...
    protected LookupResponse createLookupResponse(List<Page> pages, BlockFactory blockFactory, Collection<String> warnings) {
        return new LookupResponse(pages, blockFactory, null, List.copyOf(warnings));
    }
    ...
    protected static class LookupResponse extends AbstractLookupService.LookupResponse {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(pages, planString, warnings);
        }
    ...
    protected void startServerWithOperators(
        ...
        server.startWithOperators(
            ...
            releasables,
            ActionListener.wrap(
                ignored -> responseListener.onResponse(new LookupResponse(List.of(), blockFactory, planString, List.of())),

    ...
    private static class TermQueryList extends QueryList {
        ...
        private IntFunction<Object> blockToJavaObject() {
            return switch (block.elementType()) {
                ...
                case CATEGORY_RAW -> throw new EsqlIllegalArgumentException("can't read values from [category_raw] block");
                case CATEGORY_INTERMEDIATE -> throw new EsqlIllegalArgumentException(
                    "can't read values from [category_intermediate] block"
                );

...
public abstract class NegMapper extends ExpressionMapper<Neg> {
    public static final ExpressionMapper<?> NEG_MAPPER = new NegMapper(
    ...
    @Override
    public final Supplier<EvalOperator.ExpressionEvaluator> map(Neg neg, Layout layout) {

...
public class AbsentOverTime extends TimeSeriesAggregateFunction implements AggregateMetricDoubleNativeSupport {
    ...
    public static final PromqlFunctionDefinition PROMQL_DEFINITION = PromqlFunctionDefinition.def()
        ...
        .description(
            "Returns an empty vector if the range vector has any elements and a 1-element vector with the value `1`, "
                + "labelled after the selector's equality matchers, if it has none."
        )

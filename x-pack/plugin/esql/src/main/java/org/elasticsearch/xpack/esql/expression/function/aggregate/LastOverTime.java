...
import org.elasticsearch.compute.aggregation.LastDoubleByLongAggregatorFunctionSupplier;
import org.elasticsearch.compute.aggregation.LastFloatByLongAggregatorFunctionSupplier;
import org.elasticsearch.compute.aggregation.LastIntByLongAggregatorFunctionSupplier;
import org.elasticsearch.compute.aggregation.LastLongByLongAggregatorFunctionSupplier;
...
public class LastOverTime extends TimeSeriesAggregateFunction implements OptionalArgument, ToAggregator {
    ...
    public AggregatorFunctionSupplier supplier() {
        ...
        return switch (type) {
            case LONG -> new LastLongByLongAggregatorFunctionSupplier();
            case INTEGER -> new LastIntByLongAggregatorFunctionSupplier();
            case DOUBLE -> new LastDoubleByLongAggregatorFunctionSupplier();
            case FLOAT -> new LastFloatByLongAggregatorFunctionSupplier();

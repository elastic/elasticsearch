...
import org.elasticsearch.compute.aggregation.ExponentialHistogramMergeAggregatorFunctionSupplier;
...
public class Merge extends AggregateFunction implements ToAggregator {
    ...
    public final AggregatorFunctionSupplier supplier() {
        ...
        if (type == DataType.EXPONENTIAL_HISTOGRAM) {
            return new ExponentialHistogramMergeAggregatorFunctionSupplier();
        }

...
public final class OptimizedRateDoubleGroupingAggregatorFunction implements GroupingAggregatorFunction {
    ...
    public static final class FunctionSupplier implements AggregatorFunctionSupplier {
        ...
        @Override
        public OptimizedRateDoubleGroupingAggregatorFunction groupingAggregator(DriverContext driverContext, List<Integer> channels) {
            return new OptimizedRateDoubleGroupingAggregatorFunction(channels, driverContext, isRateOverTime, isDateNanos);
        }
    ...
    public OptimizedRateDoubleGroupingAggregatorFunction(

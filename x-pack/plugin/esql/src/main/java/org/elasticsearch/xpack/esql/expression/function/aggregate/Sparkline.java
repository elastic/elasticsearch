...
import org.elasticsearch.compute.aggregation.SparklineBooleanAggregatorFunctionSupplier;
...
public class Sparkline extends AggregateFunction implements OptionalArgument, ToAggregator {
    ...
    private static final Map<DataType, Supplier<AggregatorFunctionSupplier>> SUPPLIERS = Map.ofEntries(
        Map.entry(DataType.INTEGER, SparklineIntAggregatorFunctionSupplier::new),
        Map.entry(DataType.LONG, SparklineLongAggregatorFunctionSupplier::new),
        Map.entry(DataType.UNSIGNED_LONG, SparklineLongAggregatorFunctionSupplier::new),
        Map.entry(DataType.DATETIME, SparklineLongAggregatorFunctionSupplier::new),
        Map.entry(DataType.DATE_NANOS, SparklineLongAggregatorFunctionSupplier::new),
        Map.entry(DataType.DOUBLE, SparklineDoubleAggregatorFunctionSupplier::new),
        Map.entry(DataType.BOOLEAN, SparklineBooleanAggregatorFunctionSupplier::new)
    );

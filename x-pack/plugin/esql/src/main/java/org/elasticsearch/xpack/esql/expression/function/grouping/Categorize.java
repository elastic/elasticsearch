...
import org.elasticsearch.xpack.esql.expression.function.scalar.string.CategorizeInternal;
...
public class Categorize extends GroupingFunction implements Validatable {
    ...
    public ExpressionEvaluator.Factory toEvaluator(Function<Expression, ExpressionEvaluator.Factory> toEvaluator) {
        CategorizeInternal categorize = new CategorizeInternal(source(), field);
        return toEvaluator.apply(categorize);
    }

 ...
 */
public class Asin extends AbstractTrigonometricFunction implements AnyNullIsNull, NonFiniteSupport {
    ...
    public static final PromqlFunctionDefinition PROMQL_DEFINITION = PromqlFunctionDefinition.def()
        ...
        .unaryValueTransformation((source, field) -> new Asin(source, field, true))
    ...
    public Asin(Source source, Expression n, boolean allowNonFinite) {
        super(source, n);
    ...
    protected ExpressionEvaluator.Factory doubleEvaluator(ExpressionEvaluator.Factory field) {
        return new AsinEvaluator.Factory(source(), field, allowNonFinite);
    }

    @Override
    public Expression replaceChildren(List<Expression> newChildren) {
        return new Asin(source(), newChildren.get(0), allowNonFinite);
    }

    @Override
    protected NodeInfo<? extends Expression> info() {
        return NodeInfo.create(this, Asin::new, field(), allowNonFinite);
    }
    ...
    public Expression toStrictVariant() {
        return new Asin(source(), field(), false);
    }

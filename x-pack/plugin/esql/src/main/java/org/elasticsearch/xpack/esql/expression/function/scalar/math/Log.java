...
public class Log extends EsqlScalarFunction implements OptionalArgument, AnyNullIsNull, NonFiniteSupport {
    ...
    private Log(StreamInput in) throws IOException {
        this(
            ...
            NonFiniteSupport.readNonFinite(in, NonFiniteSupport.ESQL_PROMQL_NON_FINITE_UNARY_MATH)
        );
    }

 ...
 */
public class Tanh extends AbstractTrigonometricFunction implements AnyNullIsNull {
    public static final NamedWriteableRegistry.Entry ENTRY = new NamedWriteableRegistry.Entry(Expression.class, "Tanh", Tanh::new);
    public static final FunctionDefinition DEFINITION = FunctionDefinition.def(Tanh.class).unary(Tanh::new).name("tanh");

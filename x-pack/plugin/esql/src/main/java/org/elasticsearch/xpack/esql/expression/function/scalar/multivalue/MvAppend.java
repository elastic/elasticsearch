...
public class MvAppend extends EsqlScalarFunction implements EvaluatorMapper {
    ...
    protected TypeResolution resolveType() {
        ...
        TypeResolution resolution = isRepresentableExceptCountersAndAggregateMetricDouble(field1, sourceText(), FIRST);
        ...
        if (dataType == DataType.NULL) {
            ...
            return isRepresentableExceptCountersAndAggregateMetricDouble(field2, sourceText(), SECOND);
        }

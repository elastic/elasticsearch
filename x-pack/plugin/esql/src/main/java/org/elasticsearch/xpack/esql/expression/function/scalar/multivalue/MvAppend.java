...
public class MvAppend extends EsqlScalarFunction implements EvaluatorMapper {
    ...
    protected TypeResolution resolveType() {
        ...
        TypeResolution resolution = isRepresentableExceptCountersAndDenseVector(field1, sourceText(), FIRST);
        ...
        if (dataType == DataType.NULL) {
            ...
            return isRepresentableExceptCountersAndDenseVector(field2, sourceText(), SECOND);
        }

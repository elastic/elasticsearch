...
import static org.elasticsearch.xpack.esql.core.expression.TypeResolutions.isRepresentableExceptCountersSpatialAndDenseVector;
...
public class MvMax extends AbstractMultivalueFunction {
    ...
    protected TypeResolution resolveFieldType() {
        return isRepresentableExceptCountersSpatialAndDenseVector(field(), sourceText(), DEFAULT);
    }

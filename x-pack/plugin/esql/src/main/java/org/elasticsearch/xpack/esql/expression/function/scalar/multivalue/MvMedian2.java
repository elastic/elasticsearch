...
/**
 * Version of {@link MvMedian} that only returns doubles and does not round.
 */
...
public class MvMedian2 extends AbstractMultivalueFunction {
    ...
    public Expression replaceChildren(List<Expression> newChildren) {
        return new MvMedian2(source(), newChildren.get(0));
    }

    @Override
    protected NodeInfo<? extends Expression> info() {
        return NodeInfo.create(this, MvMedian2::new, field());
    }

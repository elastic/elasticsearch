...
public class MvZip extends EsqlScalarFunction implements OptionalArgument, EvaluatorMapper {
    ...
    public MvZip(
        Source source,
        @Param(name = "string1", type = { "keyword", "text" }, description = "Expression that can be null, a single value, or multiple values.") Expression mvLeft,
        @Param(name = "string2", type = { "keyword", "text" }, description = "Expression that can be null, a single value, or multiple values.") Expression mvRight,
        @Param(
            name = "delim",
            type = { "keyword", "text" },

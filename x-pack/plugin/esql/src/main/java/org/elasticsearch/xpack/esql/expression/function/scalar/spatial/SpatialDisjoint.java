 ...
 * {@link SpatialIntersects} function. In mathematical terms: ST_Disjoint(A, B) iff A and B share no points.
 *
...
public class SpatialDisjoint extends SpatialRelatesFunction {
    ...
    public static final FunctionDefinition DEFINITION = FunctionDefinition.def(SpatialDisjoint.class)
        .binary(SpatialDisjoint::new)
        .name("st_disjoint");

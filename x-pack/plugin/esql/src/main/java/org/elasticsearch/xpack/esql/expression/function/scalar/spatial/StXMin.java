 ...
 */
public class StXMin extends SpatialUnaryDocValuesFunction implements AnyNullIsNull {
    ...
    @FunctionInfo(
        ...
        briefSummary = "Extracts the minimum x coordinate from the supplied geometry.",

...
public class BitLength extends UnaryScalarFunction implements AnyNullIsNull {
    ...
    public static final FunctionDefinition DEFINITION = FunctionDefinition.def(BitLength.class).unary(BitLength::new).name("bit_length");

 ...
 */
public class Nothing extends EsqlScalarFunction {
    public static final NamedWriteableRegistry.Entry ENTRY = new NamedWriteableRegistry.Entry(Expression.class, "Nothing", Nothing::new);
    ...
    public Nothing(
        ...
        super(source, Arrays.asList(str));
        this.str = str;
    }

    private Nothing(StreamInput in) throws IOException {
    ...
    public ExpressionEvaluator.Factory toEvaluator(Function<Expression, ExpressionEvaluator.Factory> toEvaluator) {
        return new NothingEvaluator.Factory(
            source(),
    ...
    public Expression replaceChildren(List<Expression> newChildren) {
        return new Nothing(source(), newChildren.get(0));
    }

    @Override
    protected NodeInfo<? extends Expression> info() {
        return NodeInfo.create(this, Nothing::new, str);
    }

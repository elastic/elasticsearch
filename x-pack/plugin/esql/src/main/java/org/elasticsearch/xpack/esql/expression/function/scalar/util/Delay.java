...
public class Delay extends UnaryScalarFunction implements EvaluatorMapper {
    public Delay(Source source, Expression field) {
        super(source, field);
    }
    ...
    public ExpressionEvaluator.Factory toEvaluator(Function<Expression, ExpressionEvaluator.Factory> toEvaluator) {
        ...
        return dvrCtx -> new DelayEvaluator(field.get(dvrCtx), dvrCtx);
    }

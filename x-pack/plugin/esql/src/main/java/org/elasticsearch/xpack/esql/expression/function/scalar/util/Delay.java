...
public class Delay extends UnaryScalarFunction {
    ...
    @FunctionInfo(returnType = { "boolean" }, briefSummary = "Sleeps for a duration for every row, for debug purposes only.", description = "Sleeps for a duration for every row. For debug purposes only.")

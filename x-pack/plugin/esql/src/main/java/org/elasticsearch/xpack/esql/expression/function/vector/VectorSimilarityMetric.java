...
public enum VectorSimilarityMetric {
     ...
     *
     * @param dimensions the number of dimensions of the vectors the similarity was computed over (currently unused,
     *                   retained for API symmetry in case a future metric needs it)
     */

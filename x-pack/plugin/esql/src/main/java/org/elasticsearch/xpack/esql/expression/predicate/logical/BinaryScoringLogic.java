...
public abstract class BinaryScoringLogic extends BinaryOperator<Double, Double, Double, BinaryScoringLogicOperation>
    implements
        TranslationAware {

    protected BinaryScoringLogic(Source source, Expression left, Expression right, BinaryScoringLogicOperation operation) {
        super(source, left, right, operation);
    }

    protected BinaryScoringLogic(StreamInput in, BinaryScoringLogicOperation op) throws IOException {
        this(
    ...
    public Query asQuery(TranslatorHandler handler) {
        return boolQuery(source(), handler.asQuery(left()), handler.asQuery(right()), function() == BinaryScoringLogicOperation.AND);
    }

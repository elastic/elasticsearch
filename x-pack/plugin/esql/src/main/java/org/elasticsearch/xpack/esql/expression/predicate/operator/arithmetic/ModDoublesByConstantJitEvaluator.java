...
public abstract class ModDoublesByConstantJitEvaluator implements ExpressionEvaluator {
    private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ModDoublesByConstantJitEvaluator.class);
    ...
    protected ModDoublesByConstantJitEvaluator(Source source, ExpressionEvaluator lhs, DriverContext driverContext) {
        this.source = source;
        this.lhs = lhs;
    ...
    public final DoubleBlock eval(int positionCount, DoubleBlock lhsBlock) {
        try (DoubleBlock.Builder result = driverContext.blockFactory().newDoubleBlockBuilder(positionCount)) {
            position: for (int p = 0; p < positionCount; p++) {
                ...
                try {
                    result.appendDouble(Mod.processDoublesByConstant(lhsVal, rhs()));
    ...
    public final String toString() {
        return "ModDoublesByConstantJitEvaluator[lhs=" + lhs + ", rhs=" + rhs() + "]";
    }
    ...
    public static final class Factory implements ExpressionEvaluator.Factory {
        ...
        @Override
        public ModDoublesByConstantJitEvaluator get(DriverContext context) {
            Class<? extends ModDoublesByConstantJitEvaluator> spunClass = JitConstantSpinner.doubleConstantSubclass(
                ModDoublesByConstantJitEvaluator.class,
                "rhs",
                rhs
            );
            try {

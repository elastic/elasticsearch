...
import org.elasticsearch.xpack.esql.expression.function.scalar.convert.ToGeography;
import org.elasticsearch.xpack.esql.expression.function.scalar.convert.ToGeometry;
...
public final class PlanNamedTypes {
    ...
    public static List<PlanNameRegistry.Entry> namedTypeEntries() {
        return List.of(
            ...
            of(ESQL_UNARY_SCLR_CLS, ToGeography.class, PlanNamedTypes::writeESQLUnaryScalar, PlanNamedTypes::readESQLUnaryScalar),
            of(ESQL_UNARY_SCLR_CLS, ToGeometry.class, PlanNamedTypes::writeESQLUnaryScalar, PlanNamedTypes::readESQLUnaryScalar),
    ...
    static final Map<String, BiFunction<Source, Expression, UnaryScalarFunction>> ESQL_UNARY_SCALAR_CTRS = Map.ofEntries(
        ...
        entry(name(ToGeography.class), ToGeography::new),
        entry(name(ToGeometry.class), ToGeometry::new),

...
public final class PlanNamedTypes {
    ...
    public static List<PlanNameRegistry.Entry> namedTypeEntries() {
        List<PlanNameRegistry.Entry> declared = List.of(
            ...
            of(PhysicalPlan.class, LocalSourceExec.class, StreamOutput::writeWriteable, LocalSourceExec::new),
            of(PhysicalPlan.class, HashJoinExec.class, StreamOutput::writeWriteable, HashJoinExec::new),

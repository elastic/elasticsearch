...
public final class PlanNamedTypes {
    ...
    public static List<PlanNameRegistry.Entry> namedTypeEntries() {
        return List.of(
            ...
            of(AggregateFunction.class, LastValue.class, PlanNamedTypes::writeAggFunction, PlanNamedTypes::readAggFunction),
            ...
            of(AggregateFunction.class, Rate.class, PlanNamedTypes::writeAggFunction, PlanNamedTypes::readAggFunction),
    ...
    static final Map<String, BiFunction<Source, Expression, AggregateFunction>> AGG_CTRS = Map.ofEntries(
        ...
        entry(name(LastValue.class), LastValue::new),
        ...
        entry(name(Rate.class), Rate::new)
    );

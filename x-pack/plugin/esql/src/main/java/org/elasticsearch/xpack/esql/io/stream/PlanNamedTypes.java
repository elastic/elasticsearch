...
public final class PlanNamedTypes {
    ...
    public static List<PlanNameRegistry.Entry> namedTypeEntries() {
        List<PlanNameRegistry.Entry> declared = List.of(
            ...
            of(PhysicalPlan.class, LocalSourceExec.class, Writeable.writer(), LocalSourceExec::new),
            of(PhysicalPlan.class, HashJoinExec.class, Writeable.writer(), HashJoinExec::new),

...
import org.elasticsearch.xpack.esql.optimizer.rules.logical.PruneEmptyUnionBranches;
...
import org.elasticsearch.xpack.esql.optimizer.rules.logical.PushDownLimitAndOrderByIntoUnionPlan;
...
public class LogicalPlanOptimizer extends ParameterizedRuleExecutor<LogicalPlan, LogicalOptimizerContext> {
    ...
    protected static Batch<LogicalPlan> operators() {
        return new Batch<>(
            ...
            new PushDownLimitAndOrderByIntoUnionPlan(),

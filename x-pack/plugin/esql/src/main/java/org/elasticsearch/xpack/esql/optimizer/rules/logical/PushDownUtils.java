...
class PushDownUtils {
    ...
    public static boolean shouldPushDownPipelineBreakerIntoUnionBranch(LogicalPlan plan) {
        ...
        // We should not push a pipeline breaker like LIMIT into the union branch, since it will
     ...
     * wrapping one of those leaves (the shape produced by the analyzer's {@code resolveUnionPlan}

 ...
 * <p>
 * For nested expressions in a {@code STATS}:
 * <pre>
 ...
 * <pre>
 *     STATS sum = SUM(value) BY month = DATE_FORMAT("yyyy-MM", timestamp)
 * </pre>
 * can be optimized to
 * <pre>
 *     STATS sum = SUM(value) BY month1 = DATE_TRUNC(1 month, timestamp) | EVAL month = DATE_FORMAT("yyyy-MM", month1) | KEEP sum, month
 * </pre>

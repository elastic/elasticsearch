                ...
                if (s instanceof AggregateFunction == false) {
                    ...
                    var surrogateWithRefs = s.transformUp(AggregateFunction.class, af -> {
                        ...
                        if (attr == null) {
                            ...
                            // TODO: opportunity for special qualifier
                            var newAlias = new Alias(agg.source(), null, temporaryName, af, null, true);
                    ...
                    var aliased = new Alias(agg.source(), agg.qualifier(), agg.name(), surrogateWithRefs, agg.toAttribute().id());

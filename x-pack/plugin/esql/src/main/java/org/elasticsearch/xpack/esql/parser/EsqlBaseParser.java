...
public class EsqlBaseParser extends ParserConfig {
  ...
  public static final int
    ...
    DROP=37, KEEP=38, PROMQL=39, RENAME=40, SET=41, SHOW=42, UNKNOWN_CMD=43, 
    CHANGE_POINT_LINE_COMMENT=44, CHANGE_POINT_MULTILINE_COMMENT=45, CHANGE_POINT_WS=46, 
    ENRICH_POLICY_NAME=47, ENRICH_LINE_COMMENT=48, ENRICH_MULTILINE_COMMENT=49, 
  ...
  public static final int
    ...
    RULE_uriPartsCommand = 73, RULE_registeredDomainCommand = 74, RULE_userAgentCommand = 75, 
  ...
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "lookupCommand", "uriPartsCommand", "registeredDomainCommand", "userAgentCommand", 
  ...
  public final UserAgentCommandContext userAgentCommand() throws RecognitionException {
    ...
    enterRule(_localctx, 150, RULE_userAgentCommand);
    try {
      enterOuterAlt(_localctx, 1);
      {
      setState(732);

...
public class EsqlBaseParser extends Parser {
  ...
  public static final int
    ...
    RULE_projectClause = 24, RULE_booleanValue = 25, RULE_decimalValue = 26, 
    RULE_integerValue = 27, RULE_string = 28, RULE_comparisonOperator = 29, 
    RULE_explainCommand = 30, RULE_subqueryExpression = 31;
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "projectClause", "booleanValue", "decimalValue", "integerValue", "string", 
      "comparisonOperator", "explainCommand", "subqueryExpression"
    };
  }
  ...
  public final DecimalValueContext decimalValue() throws RecognitionException {
    ...
    enterRule(_localctx, 52, RULE_decimalValue);
    try {
      enterOuterAlt(_localctx, 1);
      {
      setState(261);
  ...
  public final ExplainCommandContext explainCommand() throws RecognitionException {
    ...
    enterRule(_localctx, 60, RULE_explainCommand);
    try {
      enterOuterAlt(_localctx, 1);
      {
      setState(269);

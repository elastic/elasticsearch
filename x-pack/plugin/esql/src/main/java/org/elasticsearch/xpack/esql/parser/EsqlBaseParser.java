...
public class EsqlBaseParser extends ParserConfig {
  ...
  public static final int
    ...
    CAST_OP=36, COMMA=37, DESC=38, DOT=39, FALSE=40, FIRST=41, IN=42, IS=43, 
    LAST=44, LIKE=45, LP=46, NOT=47, NULL=48, NULLS=49, OR=50, PARAM=51, RLIKE=52, 
    RP=53, TRUE=54, EQ=55, CIEQ=56, NEQ=57, LT=58, LTE=59, GT=60, GTE=61, 
    PLUS=62, MINUS=63, ASTERISK=64, SLASH=65, PERCENT=66, MATCH=67, NAMED_OR_POSITIONAL_PARAM=68, 
    ...
    SHOW_WS=107, COLON=108, SETTING=109, SETTING_LINE_COMMENT=110, SETTTING_MULTILINE_COMMENT=111, 
    SETTING_WS=112, LOOKUP_LINE_COMMENT=113, LOOKUP_MULTILINE_COMMENT=114, 
    LOOKUP_WS=115, LOOKUP_FIELD_LINE_COMMENT=116, LOOKUP_FIELD_MULTILINE_COMMENT=117, 

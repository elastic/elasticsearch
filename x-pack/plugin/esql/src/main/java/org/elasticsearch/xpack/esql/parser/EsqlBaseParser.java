...
public class EsqlBaseParser extends ParserConfig {
  ...
  public static final int
    ...
    RULE_ipLookupCommand = 72, RULE_setCommand = 73, RULE_setField = 74, RULE_booleanExpression = 75, 
  ...
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "ipLookupCommand", "setCommand", "setField", "booleanExpression", "regexBooleanExpression", 
  ...
  public final IpLookupCommandContext ipLookupCommand() throws RecognitionException {
    ...
    enterRule(_localctx, 144, RULE_ipLookupCommand);
    try {
      enterOuterAlt(_localctx, 1);
      {
      setState(705);

...
public class EsqlBaseParser extends ParserConfig {
  ...
  public static final int
    ...
    WHERE=16, DEV_JOIN_LOOKUP=17, DEV_INLINESTATS=18, DEV_LOOKUP=19, DEV_METRICS=20, 
    ...
    LOOKUP_FIELD_MULTILINE_COMMENT=118, LOOKUP_FIELD_WS=119, JOIN_JOIN=120, 
    USING=121, JOIN_LINE_COMMENT=122, JOIN_MULTILINE_COMMENT=123, JOIN_WS=124, 
    METRICS_LINE_COMMENT=125, METRICS_MULTILINE_COMMENT=126, METRICS_WS=127, 
    CLOSING_METRICS_LINE_COMMENT=128, CLOSING_METRICS_MULTILINE_COMMENT=129, 
  ...
  private static String[] makeSymbolicNames() {
    return new String[] {
      ...
      "WHERE", "DEV_JOIN_LOOKUP", "DEV_INLINESTATS", "DEV_LOOKUP", "DEV_METRICS", 
      ...
      "JOIN_JOIN", "USING", "JOIN_LINE_COMMENT", "JOIN_MULTILINE_COMMENT", 
  ...
  public static class JoinCommandContext extends ParserRuleContext {
    public Token type;
    public TerminalNode JOIN_JOIN() { return getToken(EsqlBaseParser.JOIN_JOIN, 0); }

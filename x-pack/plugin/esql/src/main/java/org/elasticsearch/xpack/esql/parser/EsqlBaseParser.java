...
public class EsqlBaseParser extends ParserConfig {
  ...
  public static final int
    ...
    COMPLETION=7, DISSECT=8, EVAL=9, FUSE=10, GROK=11, LIMIT=12, RERANK=13, 
    ROW=14, SAMPLE=15, SORT=16, STATS=17, WHERE=18, FROM=19, TS=20, FORK=21, 
    ...
    FIRST=66, GROUP=67, IN=68, IS=69, KEY=70, LAST=71, LIKE=72, NOT=73, NULL=74, 
    NULLS=75, ON=76, OR=77, PARAM=78, RLIKE=79, SCORE=80, TRUE=81, WITH=82, 
    EQ=83, CIEQ=84, NEQ=85, LT=86, LTE=87, GT=88, GTE=89, PLUS=90, MINUS=91, 
    ASTERISK=92, SLASH=93, PERCENT=94, LEFT_BRACES=95, RIGHT_BRACES=96, DOUBLE_PARAMS=97, 
    NAMED_OR_POSITIONAL_PARAM=98, NAMED_OR_POSITIONAL_DOUBLE_PARAMS=99, OPENING_BRACKET=100, 
    CLOSING_BRACKET=101, LP=102, RP=103, UNQUOTED_IDENTIFIER=104, QUOTED_IDENTIFIER=105, 
    EXPR_LINE_COMMENT=106, EXPR_MULTILINE_COMMENT=107, EXPR_WS=108, METADATA=109, 
    UNQUOTED_SOURCE=110, FROM_LINE_COMMENT=111, FROM_MULTILINE_COMMENT=112, 
    FROM_WS=113, FORK_WS=114, FORK_LINE_COMMENT=115, FORK_MULTILINE_COMMENT=116, 
    INLINE_STATS=117, INLINE_LINE_COMMENT=118, INLINE_MULTILINE_COMMENT=119, 
    INLINE_WS=120, JOIN=121, USING=122, JOIN_LINE_COMMENT=123, JOIN_MULTILINE_COMMENT=124, 
    JOIN_WS=125, LOOKUP_LINE_COMMENT=126, LOOKUP_MULTILINE_COMMENT=127, LOOKUP_WS=128, 
    LOOKUP_FIELD_LINE_COMMENT=129, LOOKUP_FIELD_MULTILINE_COMMENT=130, LOOKUP_FIELD_WS=131, 
    MVEXPAND_LINE_COMMENT=132, MVEXPAND_MULTILINE_COMMENT=133, MVEXPAND_WS=134, 
    ID_PATTERN=135, PROJECT_LINE_COMMENT=136, PROJECT_MULTILINE_COMMENT=137, 
    PROJECT_WS=138, PROMQL_PARAMS_LINE_COMMENT=139, PROMQL_PARAMS_MULTILINE_COMMENT=140, 
    PROMQL_PARAMS_WS=141, PROMQL_QUERY_COMMENT=142, PROMQL_SINGLE_QUOTED_STRING=143, 
    PROMQL_OTHER_QUERY_CONTENT=144, AS=145, RENAME_LINE_COMMENT=146, RENAME_MULTILINE_COMMENT=147, 
    RENAME_WS=148, SET_LINE_COMMENT=149, SET_MULTILINE_COMMENT=150, SET_WS=151, 
    INFO=152, SHOW_LINE_COMMENT=153, SHOW_MULTILINE_COMMENT=154, SHOW_WS=155;
  public static final int
  ...
  private static String[] makeLiteralNames() {
    return new String[] {
      ...
      "'dissect'", "'eval'", "'fuse'", "'grok'", "'limit'", "'rerank'", "'row'", 
      "'sample'", "'sort'", null, "'where'", "'from'", "'ts'", "'fork'", "'inline'", 
      ...
      "','", "'desc'", "'.'", "'false'", "'first'", "'group'", "'in'", "'is'", 
      "'key'", "'last'", "'like'", "'not'", "'null'", "'nulls'", "'on'", "'or'", 
      "'?'", "'rlike'", "'score'", "'true'", "'with'", "'=='", "'=~'", "'!='", 
      "'<'", "'<='", "'>'", "'>='", "'+'", "'-'", "'*'", "'/'", "'%'", "'{'", 
      ...
      null, null, null, null, null, "'as'", null, null, null, null, null, null, 
      "'info'"
    };
  }
  ...
  private static String[] makeSymbolicNames() {
    return new String[] {
      ...
      "DEV_EXPLAIN", "COMPLETION", "DISSECT", "EVAL", "FUSE", "GROK", "LIMIT", 
      "RERANK", "ROW", "SAMPLE", "SORT", "STATS", "WHERE", "FROM", "TS", "FORK", 
      ...
      "SEMICOLON", "COMMA", "DESC", "DOT", "FALSE", "FIRST", "GROUP", "IN", 
      "IS", "KEY", "LAST", "LIKE", "NOT", "NULL", "NULLS", "ON", "OR", "PARAM", 
      "RLIKE", "SCORE", "TRUE", "WITH", "EQ", "CIEQ", "NEQ", "LT", "LTE", "GT", 
    ...
    try {
      ...
      case 1:
        ...
        do {
          ...
          _errHandler.sync(this);
          _la = _input.LA(1);
        } while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 6489687063040884736L) != 0) || ((((_la - 98)) & ~0x3f) == 0 && ((1L << (_la - 98)) & 123145302315217L) != 0) );
        setState(1000);
        match(RP);
        }
        break;
  ...
  public final PromqlParamNameContext promqlParamName() throws RecognitionException {
    ...
    try {
      ...
      setState(1022);
      _la = _input.LA(1);
      if ( !(((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & 13581167626289153L) != 0)) ) {
      _errHandler.recoverInline(this);
      }
      else {
        if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
  ...
  public final PromqlQueryContentContext promqlQueryContent() throws RecognitionException {
    ...
    try {
      ...
      setState(1036);
      _la = _input.LA(1);
      if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 6489687063040884736L) != 0) || ((((_la - 98)) & ~0x3f) == 0 && ((1L << (_la - 98)) & 123145302315201L) != 0)) ) {
      _errHandler.recoverInline(this);
      }
      else {
        if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
  ...
  public final PromqlIndexStringContext promqlIndexString() throws RecognitionException {
    ...
    try {
      ...
      setState(1070);
      _la = _input.LA(1);
      if ( !(((((_la - 52)) & ~0x3f) == 0 && ((1L << (_la - 52)) & 292733975779082241L) != 0)) ) {
      _errHandler.recoverInline(this);
      }
      else {
        if ( _input.LA(1)==Token.EOF ) matchedEOF = true;

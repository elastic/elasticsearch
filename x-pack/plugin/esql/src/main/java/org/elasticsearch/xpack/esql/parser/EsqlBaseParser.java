...
public class EsqlBaseParser extends Parser {
  ...
  public static final int
    ...
    RULE_identifierPattern = 23, RULE_namedParam = 24, RULE_constant = 25, 
    ...
    RULE_enrichCommand = 47, RULE_enrichWithClause = 48, RULE_setting = 49;
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "identifierPattern", "namedParam", "constant", "limitCommand", "sortCommand", 
  ...
  public static class NamedParamContext extends ParserRuleContext {
    public TerminalNode OPENING_CURLY_BRACKETS() { return getToken(EsqlBaseParser.OPENING_CURLY_BRACKETS, 0); }
    public TerminalNode UNQUOTED_IDENTIFIER() { return getToken(EsqlBaseParser.UNQUOTED_IDENTIFIER, 0); }
    public TerminalNode CLOSING_CURLY_BRACKETS() { return getToken(EsqlBaseParser.CLOSING_CURLY_BRACKETS, 0); }
    @SuppressWarnings("this-escape")
    ...
    @Override
    public void enterRule(ParseTreeListener listener) {
      if ( listener instanceof EsqlBaseParserListener ) ((EsqlBaseParserListener)listener).enterNamedParam(this);
    }
    @Override
    public void exitRule(ParseTreeListener listener) {
      if ( listener instanceof EsqlBaseParserListener ) ((EsqlBaseParserListener)listener).exitNamedParam(this);
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if ( visitor instanceof EsqlBaseParserVisitor ) return ((EsqlBaseParserVisitor<? extends T>)visitor).visitNamedParam(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public final NamedParamContext namedParam() throws RecognitionException {
    ...
    enterRule(_localctx, 48, RULE_namedParam);
    try {
      enterOuterAlt(_localctx, 1);
      {
      setState(324);
      match(OPENING_CURLY_BRACKETS);
      setState(325);
      match(UNQUOTED_IDENTIFIER);
      setState(326);
      match(CLOSING_CURLY_BRACKETS);
      }
    }
    catch (RecognitionException re) {
      _localctx.exception = re;
  ...
  public static class SettingContext extends ParserRuleContext {
    ...
    public TerminalNode CLOSING_BRACKET() { return getToken(EsqlBaseParser.CLOSING_BRACKET, 0); }
    public List<TerminalNode> SETTING() { return getTokens(EsqlBaseParser.SETTING); }
    public TerminalNode SETTING(int i) {
      return getToken(EsqlBaseParser.SETTING, i);
    }
    @SuppressWarnings("this-escape")
    ...
    @Override
    public void enterRule(ParseTreeListener listener) {
      if ( listener instanceof EsqlBaseParserListener ) ((EsqlBaseParserListener)listener).enterSetting(this);
    }
    @Override
    public void exitRule(ParseTreeListener listener) {
      if ( listener instanceof EsqlBaseParserListener ) ((EsqlBaseParserListener)listener).exitSetting(this);
    }
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if ( visitor instanceof EsqlBaseParserVisitor ) return ((EsqlBaseParserVisitor<? extends T>)visitor).visitSetting(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public final SettingContext setting() throws RecognitionException {
    ...
    enterRule(_localctx, 98, RULE_setting);
    try {
      enterOuterAlt(_localctx, 1);
      {
      setState(523);

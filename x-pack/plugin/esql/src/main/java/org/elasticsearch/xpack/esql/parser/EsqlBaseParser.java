...
public class EsqlBaseParser extends ParserConfig {
  ...
  public static final int
    LINE_COMMENT=1, MULTILINE_COMMENT=2, WS=3, ENRICH=4, DEV_CHANGE_POINT=5, 
    ...
    DROP=24, KEEP=25, RENAME=26, SHOW=27, UNKNOWN_CMD=28, ON=29, WITH=30, 
    ENRICH_POLICY_NAME=31, ENRICH_LINE_COMMENT=32, ENRICH_MULTILINE_COMMENT=33, 
    ENRICH_WS=34, ENRICH_FIELD_LINE_COMMENT=35, ENRICH_FIELD_MULTILINE_COMMENT=36, 
    ENRICH_FIELD_WS=37, SETTING=38, SETTING_LINE_COMMENT=39, SETTTING_MULTILINE_COMMENT=40, 
    SETTING_WS=41, CHANGE_POINT_LINE_COMMENT=42, CHANGE_POINT_MULTILINE_COMMENT=43, 
    CHANGE_POINT_WS=44, EXPLAIN_WS=45, EXPLAIN_LINE_COMMENT=46, EXPLAIN_MULTILINE_COMMENT=47, 
  ...
  private static String[] makeLiteralNames() {
    return new String[] {
      null, null, null, null, "'enrich'", null, "'explain'", "'dissect'", "'eval'", 
  ...
  private static String[] makeSymbolicNames() {
    return new String[] {
      null, "LINE_COMMENT", "MULTILINE_COMMENT", "WS", "ENRICH", "DEV_CHANGE_POINT", 
      ...
      "SETTTING_MULTILINE_COMMENT", "SETTING_WS", "CHANGE_POINT_LINE_COMMENT", 
      "CHANGE_POINT_MULTILINE_COMMENT", "CHANGE_POINT_WS", "EXPLAIN_WS", "EXPLAIN_LINE_COMMENT", 

...
public class EsqlBaseParser extends Parser {
  ...
  public static final int
    ...
    RULE_field = 13, RULE_fromCommand = 14, RULE_fromIdentifier = 15, RULE_metadata = 16, 
    RULE_metadataOption = 17, RULE_deprecated_metadata = 18, RULE_evalCommand = 19, 
    RULE_statsCommand = 20, RULE_inlinestatsCommand = 21, RULE_qualifiedName = 22, 
  ...
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "fromCommand", "fromIdentifier", "metadata", "metadataOption", "deprecated_metadata", 
  ...
  public final MetadataOptionContext metadataOption() throws RecognitionException {
    ...
    enterRule(_localctx, 34, RULE_metadataOption);
    try {
      int _alt;
      enterOuterAlt(_localctx, 1);
      {
  ...
  public final Deprecated_metadataContext deprecated_metadata() throws RecognitionException {
    ...
    enterRule(_localctx, 36, RULE_deprecated_metadata);
    try {
      enterOuterAlt(_localctx, 1);
      {
      setState(291);
  ...
  public final InlinestatsCommandContext inlinestatsCommand() throws RecognitionException {
    ...
    enterRule(_localctx, 42, RULE_inlinestatsCommand);
    try {
      enterOuterAlt(_localctx, 1);
      {
      setState(306);

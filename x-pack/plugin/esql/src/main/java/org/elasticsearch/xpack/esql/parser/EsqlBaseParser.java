...
public class EsqlBaseParser extends Parser {
  ...
  public static final int
    ...
    RULE_fromIdentifier = 20, RULE_qualifiedName = 21, RULE_identifier = 22, 
  ...
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "grouping", "fromIdentifier", "qualifiedName", "identifier", "identifierPattern", 
  ...
  public static class RenameClauseContext extends ParserRuleContext {
    public IdentifierContext oldName;
  ...
  public final RenameClauseContext renameClause() throws RecognitionException {
    ...
    try {
      ...
      {
      setState(422);
      ((RenameClauseContext)_localctx).oldName = identifier();
      setState(423);
      match(AS);
      setState(424);
  ...
  public static class EnrichCommandContext extends ParserRuleContext {
    ...
    public IdentifierPatternContext matchField;
  ...
  public final EnrichCommandContext enrichCommand() throws RecognitionException {
    ...
    try {
      ...
      case 1:
        ...
        match(ON);
        setState(487);
        ((EnrichCommandContext)_localctx).matchField = identifierPattern();
        }
        break;
      }
      setState(499);
  ...
  public static class EnrichWithClauseContext extends ParserRuleContext {
    public IdentifierPatternContext newName;
    public IdentifierPatternContext enrichField;
    public List<IdentifierPatternContext> identifierPattern() {
      return getRuleContexts(IdentifierPatternContext.class);
    }
    public IdentifierPatternContext identifierPattern(int i) {
  ...
  public final EnrichWithClauseContext enrichWithClause() throws RecognitionException {
    ...
    try {
      ...
      case 1:
        {
        setState(501);
        ((EnrichWithClauseContext)_localctx).newName = identifierPattern();
        setState(502);
        match(ASSIGN);
        }
        break;
      ...
      setState(506);
      ((EnrichWithClauseContext)_localctx).enrichField = identifierPattern();
      }
    }
    catch (RecognitionException re) {
      _localctx.exception = re;

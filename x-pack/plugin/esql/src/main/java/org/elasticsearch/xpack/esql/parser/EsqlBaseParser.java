...
public class EsqlBaseParser extends ParserConfig {
  ...
  public static final int
    ...
    ENRICH_POLICY_NAME=89, ENRICH_LINE_COMMENT=90, ENRICH_MULTILINE_COMMENT=91, 
    ENRICH_WS=92, ON=93, WITH=94, ENRICH_FIELD_LINE_COMMENT=95, ENRICH_FIELD_MULTILINE_COMMENT=96, 
  ...
  private static String[] makeLiteralNames() {
    return new String[] {
      ...
      null, null, "'on'", "'with'", null, null, null, null, null, null, "'info'", 
  ...
  private static String[] makeSymbolicNames() {
    return new String[] {
      ...
      "ENRICH_WS", "ON", "WITH", "ENRICH_FIELD_LINE_COMMENT", "ENRICH_FIELD_MULTILINE_COMMENT", 

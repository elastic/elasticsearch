...
public class EsqlBaseParser extends ParserConfig {
  ...
  public static final int
    ...
    RULE_setCommand = 72, RULE_setField = 73, RULE_mmrCommand = 74, RULE_booleanExpression = 75, 
  ...
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "setCommand", "setField", "mmrCommand", "booleanExpression", "regexBooleanExpression", 

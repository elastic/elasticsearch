...
public class EsqlBaseParser extends Parser {
  ...
  public static final int
    ...
    PLUS=62, MINUS=63, ASTERISK=64, SLASH=65, PERCENT=66, NAMED_OR_POSITIONAL_PARAM=67, 
    OPENING_BRACKET=68, CLOSING_BRACKET=69, UNQUOTED_IDENTIFIER=70, QUOTED_IDENTIFIER=71, 
    EXPR_LINE_COMMENT=72, EXPR_MULTILINE_COMMENT=73, EXPR_WS=74, METADATA=75, 
    FROM_LINE_COMMENT=76, FROM_MULTILINE_COMMENT=77, FROM_WS=78, ID_PATTERN=79, 
    PROJECT_LINE_COMMENT=80, PROJECT_MULTILINE_COMMENT=81, PROJECT_WS=82, 
    AS=83, RENAME_LINE_COMMENT=84, RENAME_MULTILINE_COMMENT=85, RENAME_WS=86, 
    ON=87, WITH=88, ENRICH_POLICY_NAME=89, ENRICH_LINE_COMMENT=90, ENRICH_MULTILINE_COMMENT=91, 
    ENRICH_WS=92, ENRICH_FIELD_LINE_COMMENT=93, ENRICH_FIELD_MULTILINE_COMMENT=94, 
    ENRICH_FIELD_WS=95, MVEXPAND_LINE_COMMENT=96, MVEXPAND_MULTILINE_COMMENT=97, 
    MVEXPAND_WS=98, INFO=99, SHOW_LINE_COMMENT=100, SHOW_MULTILINE_COMMENT=101, 
    SHOW_WS=102, FUNCTIONS=103, META_LINE_COMMENT=104, META_MULTILINE_COMMENT=105, 
    META_WS=106, COLON=107, SETTING=108, SETTING_LINE_COMMENT=109, SETTTING_MULTILINE_COMMENT=110, 
    SETTING_WS=111, METRICS_LINE_COMMENT=112, METRICS_MULTILINE_COMMENT=113, 
    METRICS_WS=114, CLOSING_METRICS_LINE_COMMENT=115, CLOSING_METRICS_MULTILINE_COMMENT=116, 
  ...
  public static final int
    ...
    RULE_params = 29, RULE_limitCommand = 30, RULE_sortCommand = 31, RULE_orderExpression = 32, 
  ...
  private static String[] makeLiteralNames() {
    return new String[] {
      ...
      "'nulls'", "'or'", "'?'", "'rlike'", "')'", "'true'", "'=='", "'=~'", 
      "'!='", "'<'", "'<='", "'>'", "'>='", "'+'", "'-'", "'*'", "'/'", "'%'", 
      null, null, "']'", null, null, null, null, null, "'metadata'", null, 

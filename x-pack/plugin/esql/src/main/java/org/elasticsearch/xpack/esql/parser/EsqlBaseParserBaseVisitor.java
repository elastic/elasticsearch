...
public class EsqlBaseParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements EsqlBaseParserVisitor<T> {
   ...
   * {@link #visitChildren} on {@code ctx}.</p>
   */
  @Override public T visitWhereMatchStringExpression(EsqlBaseParser.WhereMatchStringExpressionContext ctx) { return visitChildren(ctx); }
  /**
   * {@inheritDoc}
   *
   * <p>The default implementation returns the result of calling
   * {@link #visitChildren} on {@code ctx}.</p>
   */
  @Override public T visitWhereBooleanExpression(EsqlBaseParser.WhereBooleanExpressionContext ctx) { return visitChildren(ctx); }
  /**
   * {@inheritDoc}
   *
   * <p>The default implementation returns the result of calling

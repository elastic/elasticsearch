            ...
            if (idCtx.parameter() != null || idCtx.doubleParameter() != null) {
                ...
                if (exp instanceof Literal lit) {
                    if (lit.value() != null) {
                        ...
                        // Defined-but-null param: distinct from the missing-param sentinel ({@link Literal#NULL}),
                        // which already produces a parsing error from {@link #paramByNameOrPosition}.
                        throw new ParsingException(
                            src,

 ...
 */
public record QueryParam(String name, Object value, DataType type, boolean isIdentifier, boolean isIdentifierPattern) {
    ...
    public String toString() {
        return value + " [" + name + "][" + type + "][" + isIdentifier + "][" + isIdentifierPattern + "]";
    }

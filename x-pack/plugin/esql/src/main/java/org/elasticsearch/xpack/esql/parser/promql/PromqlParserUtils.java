...
public class PromqlParserUtils {
    ...
    /**
     * Quotes a string for exact literal matching in Lucene RegExp.
     * <p>
     * NB: Unless an approach with {@code String.replace()}
     * this version avoids allocation on a happy path, and it is very fast.
     */
    public static String quote(String value) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            // handle unicode supplementary chars

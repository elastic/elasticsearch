...
public record SettingsValidationContext(boolean crossProjectEnabled, boolean isSnapshot) {
    ...
    /**
     * Builds a context from a possibly-null {@link RemoteClusterService}. Null is tolerated for parser entry points that
     * run without a transport service (test fixtures, view parsing); in those cases cross-project is treated as disabled.
     */

...
public class UnionAll extends MergePlan {
     ...
     * {@link MergePlan#expressionsResolved()} during analysis - a 500 - so this collapse keeps the
     ...
     * branchless-wrapper behaviour and the {@code MergePlan.checkNonEmpty} verification that goes
     * with it.
     */
    @Override
    ...
    /**
     * Rejects a query whose {@link MergePlan}s nest deeper than {@code maxLevels}, the

...
public class Fuse extends UnaryPlan implements TelemetryAware {
    ...
    private final MapExpression fuseOptions;
    ...
    protected NodeInfo<? extends LogicalPlan> info() {
        return NodeInfo.create(this, Fuse::new, child(), score, discriminator, groupings, fuseType, fuseOptions);
    }

    @Override
    public UnaryPlan replaceChild(LogicalPlan newChild) {
        return new Fuse(source(), newChild, score, discriminator, groupings, fuseType, fuseOptions);
    }
    ...
    public MapExpression fuseOptions() {
        return fuseOptions;
    }

...
public interface EstimatesRowSize {
    ...
    static int estimateSize(DataType dataType) {
        ...
        return switch (elementType) {
            ...
            case DOC -> throw new UnsupportedOperationException("can't load a doc with field extraction");
            case DOUBLE -> Double.BYTES;
            case INT -> Integer.BYTES;
            case LONG -> Long.BYTES;
            case NULL -> 0;
            case UNKNOWN -> throw new UnsupportedOperationException("unknown can't be the result of field extraction");
        };
    }
}

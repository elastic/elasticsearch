...
public class TopNByExec extends UnaryExec implements EstimatesRowSize {
    ...
    public TopNByExec(
        ...
        this(source, child, order, limit, estimatedRowSize, groupings, Set.of(), null);
    }
    ...
    protected NodeInfo<TopNByExec> info() {
        return NodeInfo.create(this, TopNByExec::new, child(), order, limit, groupings, estimatedRowSize);
    }

    @Override
    public TopNByExec replaceChild(PhysicalPlan newChild) {
        return new TopNByExec(source(), newChild, order, limit, estimatedRowSize, groupings, docValuesAttributes, minCompetitive);
    }

    public TopNByExec withDocValuesAttributes(Set<Attribute> docValuesAttributes) {
        return new TopNByExec(source(), child(), order, limit, estimatedRowSize, groupings, docValuesAttributes, minCompetitive);
    }

    public TopNByExec withSortedInput() {
        return new TopNByExec(source(), child(), order, limit, estimatedRowSize, groupings, docValuesAttributes, minCompetitive);
    }

    public TopNByExec withNonSortedInput() {
        return new TopNByExec(source(), child(), order, limit, estimatedRowSize, groupings, docValuesAttributes, minCompetitive);
    }
    ...
    public TopNByExec withMinCompetitive(SharedMinCompetitive.Supplier minCompetitive) {
        return new TopNByExec(source(), child(), order, limit, estimatedRowSize, groupings, docValuesAttributes, minCompetitive);
    }
    ...
    public PhysicalPlan estimateRowSize(State state) {
        ...
        return Objects.equals(this.estimatedRowSize, size)
            ? this
            : new TopNByExec(source(), child(), order, limit, size, groupings, docValuesAttributes, minCompetitive);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), order, limit, estimatedRowSize, groupings, docValuesAttributes, minCompetitive);
    }

    ...
    private PhysicalOperation planTopN(TopNExec topNExec, LocalExecutionPlannerContext context) {
        ...
        for (int channel = 0; channel < inverse.size(); channel++) {
            ...
            encoders[channel] = switch (inverse.get(channel).type()) {
                ...
                case BOOLEAN, NULL, BYTE, SHORT, INTEGER, LONG, DOUBLE, FLOAT, COUNTER_FLOAT, HALF_FLOAT, DATETIME, DATE_NANOS, DATE_PERIOD,
                    TIME_DURATION, OBJECT, SCALED_FLOAT, UNSIGNED_LONG, DOC_DATA_TYPE, TSID_DATA_TYPE -> TopNEncoder.DEFAULT_SORTABLE;

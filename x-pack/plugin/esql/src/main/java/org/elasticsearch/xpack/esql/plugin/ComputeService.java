...
public class ComputeService {
    ...
    public void executePlan(
        ...
        Map<String, OriginalIndices> clusterToConcreteIndices = getIndices(physicalPlan, EsRelation::concreteIndicesByRemotes);
        Runnable cancelQueryOnFailure = cancelQueryOnFailure(rootTask);
        ...
        Map<String, OriginalIndices> clusterToOriginalIndices = getIndices(physicalPlan, EsRelation::originalIndicesByRemotes);

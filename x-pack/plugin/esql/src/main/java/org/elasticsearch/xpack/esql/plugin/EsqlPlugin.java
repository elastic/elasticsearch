...
public class EsqlPlugin extends Plugin implements ActionPlugin, ExtensiblePlugin, SearchPlugin {
     ...
     * — tracking the same heap- and CPU-scaled knob (memory-capped, ceiling 100, or the
    ...
    public List<ExecutorBuilder<?>> getExecutorBuilders(Settings settings) {
        ...
        return List.of(
            ...
            // ceiling 100, or the esql.external.max_concurrent_requests override) that also sizes the permit semaphore, so

...
import org.elasticsearch.xpack.esql.planner.mapper.preprocessor.MappingPreprocessorExecutor;
...
public class EsqlSession {
    ...
    private final MappingPreprocessorExecutor mappingPreprocessorExecutor;
    ...
    public EsqlSession(
        ...
        this.mappingPreprocessorExecutor = new MappingPreprocessorExecutor(services);
    }
    ...
    public void preMapping(
        ...
        mappingPreprocessorExecutor.execute(optimizedPlan, listener.delegateFailureAndWrap((l, p) -> {

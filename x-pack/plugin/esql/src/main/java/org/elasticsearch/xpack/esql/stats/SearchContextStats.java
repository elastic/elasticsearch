...
public class SearchContextStats implements SearchStats {
    ...
    private Boolean canPartitionByTsidPrefix;
    ...
    public boolean canPartitionByTsidPrefix() {
        if (canPartitionByTsidPrefix == null) {
            ...
            canPartitionByTsidPrefix = true;
        }
        return canPartitionByTsidPrefix;
    }
}

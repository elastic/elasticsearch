 ...
 *     it's compiler. So we're going to make a lot of mistakes when designing it.
 ...
 *     function and decide it should return the type of it's input field rather
 ...
 *     we cut a new major. We'll need to do that on every major.
 * </p>
 */

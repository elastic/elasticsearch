...
/**
 * Transport action for getting views via REST API with wildcard support.
 * This uses ViewResolutionService to resolve views from index patterns.
 */
public class TransportGetViewAction extends TransportLocalProjectMetadataAction<GetViewAction.Request, GetViewAction.Response> {
    ...
    protected void localClusterStateOperation(
        ...
        listener.onResponse(new GetViewAction.Response(result.views()));
    }

...
public class TestQueryRunner {
    private static final Logger LOGGER = LogManager.getLogger(TestQueryRunner.class);
    ...
    public TestQueryRunner(ThreadPool threadPool, Executor executor) {
    ...
    private PhysicalPlan physicalPlan(LogicalPlan parsed, IndexResolution indexResolution, EnrichResolution enrichPolicies) {
    ...
    public ActualResults executePlan(
        ...
        ExchangeSourceHandler exchangeSource = new ExchangeSourceHandler(ESTestCase.between(1, 64), executor);
        ...
        //
        PhysicalPlan physicalPlan = physicalPlan(parsedQuery, indexResolution, enrichPolicies);
        ...
        try {
            ...
            DriverRunner runner = new DriverRunner(threadPool.getThreadContext()) {
                ...
                protected void start(Driver driver, ActionListener<Void> driverListener) {
                    Driver.start(threadPool.getThreadContext(), executor, driver, ESTestCase.between(1, 1000), driverListener);
                }
            };

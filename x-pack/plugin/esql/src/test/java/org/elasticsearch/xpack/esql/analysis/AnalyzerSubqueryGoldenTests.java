...
public class AnalyzerSubqueryGoldenTests extends GoldenTestCase {
    ...
    // Fork inside subquery is covered in LogicalPlanOptimizerSubqueryTests and LogicalPlanOptimizerSubqueryGoldenTests
    ...
    public void testForkAfterUnionTypeConversionWithMvExpandInSubquery() {
        runGoldenTest("""
    ...
    public void testForkOutputUpdatedAfterDateNanosPromotionInSubquery() {
        runGoldenTest("""
    ...
    public void testForkOutputUpdatedAfterCounterPromotionInSubquery() {
        runGoldenTest("""

...
public class AnalyzerTests extends ESTestCase {
    ...
    public void testUnsupportedTypesInStats() {
        verifyUnsupported(
            ...
            """
                Found 6 problems
                line 2:12: argument of [avg(x)] must be [aggregate_metric_double, exponential_histogram or numeric except unsigned_long or counter types],\
                ...
                line 2:96: first argument of [percentile(x, 10)] must be [exponential_histogram or numeric except unsigned_long],\
                 found value [x] type [unsigned_long]
                line 2:115: argument of [sum(x)] must be [aggregate_metric_double, exponential_histogram or numeric except unsigned_long or counter types],\
                 found value [x] type [unsigned_long]"""
        );
        ...
        verifyUnsupported(
            ...
            """
                Found 5 problems
                line 2:10: argument of [avg(x)] must be [aggregate_metric_double, exponential_histogram or numeric except unsigned_long or counter types],\
                ...
                line 2:59: first argument of [percentile(x, 10)] must be [exponential_histogram or numeric except unsigned_long],\
                 found value [x] type [version]
                line 2:78: argument of [sum(x)] must be [aggregate_metric_double, exponential_histogram or numeric except unsigned_long or counter types],\
                 found value [x] type [version]"""
        );
    }

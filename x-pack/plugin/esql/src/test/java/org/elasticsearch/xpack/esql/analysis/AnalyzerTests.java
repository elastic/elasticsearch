...
public class AnalyzerTests extends ESTestCase {
    ...
    public void testAttributeResolution() {
        ...
        assertEquals(
            new Alias(EMPTY, "e", new FieldAttribute.FieldAttirbuteBuilder(EMPTY, "emp_no", idx.mapping().get("emp_no")).build()),
            eval.fields().get(0)
        );
    ...
    public void testResolveInsist_fieldDoesNotExist_createsUnmappedField() {
        ...
        var expectedAttribute = new FieldAttribute.FieldAttirbuteBuilder(Source.EMPTY, "foo", new PotentiallyUnmappedKeywordEsField("foo"))
            .build();

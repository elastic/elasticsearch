    ...
    public void testUnsupportedTypesInStats() {
        verifyUnsupported(
            ...
            "Found 8 problems\n"
                ...
                + "line 2:39: argument of [max(x)] must be [numeric except unsigned_long or datetime], "
                ...
                + "found value [x] type [unsigned_long]\n"
                + "line 2:88: argument of [min(x)] must be [numeric except unsigned_long or datetime], "
        ...
        verifyUnsupported(
            ...
            "Found 7 problems\n"
                ...
                + "line 2:18: argument of [max(x)] must be [numeric except unsigned_long or datetime], "
                ...
                + "line 2:67: argument of [min(x)] must be [numeric except unsigned_long or datetime], "

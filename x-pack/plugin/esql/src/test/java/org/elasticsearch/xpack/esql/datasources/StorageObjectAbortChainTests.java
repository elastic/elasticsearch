...
public class StorageObjectAbortChainTests extends ESTestCase {
    ...
    public void testAbortPropagatesThroughDecoratorChainWithoutDrain() throws IOException {
        ...
        StorageObject raw = drainSimulatingStorageObject(compressed, rawBytesConsumed, rawAborted);
     ...
     */
    private static StorageObject drainSimulatingStorageObject(byte[] bytes, AtomicLong bytesConsumed, AtomicBoolean aborted) {

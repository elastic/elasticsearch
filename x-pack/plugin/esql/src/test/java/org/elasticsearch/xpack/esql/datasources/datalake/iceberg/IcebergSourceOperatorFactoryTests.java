...
public class IcebergSourceOperatorFactoryTests extends ESTestCase {
    ...
    public void testFactoryConstruction() {
        ...
        org.elasticsearch.xpack.esql.datasources.s3.S3Configuration s3Config = org.elasticsearch.xpack.esql.datasources.s3.S3Configuration.fromFields("test-key", "test-secret", null, null);
        ...
        // Create factory
        org.elasticsearch.xpack.esql.datasources.datalake.iceberg.IcebergSourceOperatorFactory factory = new org.elasticsearch.xpack.esql.datasources.datalake.iceberg.IcebergSourceOperatorFactory(
            executor,
            tablePath,
            s3Config,
            sourceType,

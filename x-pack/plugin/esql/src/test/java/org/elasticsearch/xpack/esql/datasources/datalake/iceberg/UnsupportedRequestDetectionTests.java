...
public class UnsupportedRequestDetectionTests extends org.elasticsearch.xpack.esql.datasources.datalake.AbstractS3HttpFixtureTest {
    ...
    public void testUnsupportedOperationThrowsException() {
        ...
        assertTrue("Exception message should mention unsupported operation", 
            message.contains("unsupported S3 operation"));
        assertTrue("Exception message should mention gap in S3HttpHandler", 
            message.contains("gap in S3HttpHandler support"));
        assertTrue("Exception message should include the request method", 
            message.contains("POST"));
        assertTrue("Exception message should include the request path", 
            message.contains("/iceberg-test/invalid-path-without-warehouse"));

...
public class RequestFilterRewriterTests extends ESTestCase {
    ...
    private static final TransportVersion CURRENT = RequestFilterRewriter.ESQL_DATASET_REQUEST_FILTER_PATTERNS;
    ...
    public void testWhollyUnsupportedFilterFailsTheQuery() {
        ...
        VerificationException e = expectThrows(
            ...
            () -> RequestFilterRewriter.rewrite(relation, QueryBuilders.fuzzyQuery("a", "x"), CONFIG, CURRENT, false)
        );
    ...
    public void testUnsupportedClauseFailsTheQueryAcrossDatasets() {
        ...
        VerificationException e = expectThrows(
            VerificationException.class,
            () -> RequestFilterRewriter.rewrite(union, QueryBuilders.fuzzyQuery("a", "x"), CONFIG, CURRENT, false)
        );
        assertThat(e.getMessage(), containsString("[fuzzy]"));
    ...
    public void testPartialModeWhollyUnsupportedLeavesNodeUnwrappedWithWarning() {
        ExternalRelation relation = relation("ds", attr("a", DataType.INTEGER));
        LogicalPlan result = RequestFilterRewriter.rewrite(relation, QueryBuilders.fuzzyQuery("a", "x"), CONFIG, CURRENT, true);
    ...
    public void testPartialModeMultipleDatasetsWarnsAll() {
        ...
        RequestFilterRewriter.rewrite(union, QueryBuilders.fuzzyQuery("a", "x"), CONFIG, CURRENT, true);

...
public class SessionBasedLookupFromIndexOperatorStatusTests extends AbstractWireSerializingTestCase<
    SessionBasedLookupFromIndexOperator.Status> {
    @Override
    protected Writeable.Reader<SessionBasedLookupFromIndexOperator.Status> instanceReader() {
        return SessionBasedLookupFromIndexOperator.Status::new;
    }

    @Override
    protected SessionBasedLookupFromIndexOperator.Status createTestInstance() {
        return new SessionBasedLookupFromIndexOperator.Status(
    ...
    @Override
    protected SessionBasedLookupFromIndexOperator.Status mutateInstance(SessionBasedLookupFromIndexOperator.Status in) throws IOException {
    ...
    public void testToXContent() {
        var status = new SessionBasedLookupFromIndexOperator.Status(100, 50, TimeValue.timeValueNanos(10).nanos(), 120, 88, 800);

...
import static org.elasticsearch.xpack.esql.enrich.LookupFromIndexOperatorTests.LESS_THAN_VALUE;
import static org.elasticsearch.xpack.esql.enrich.LookupFromIndexOperatorTests.LOOKUP_SIZE;
...
public class StreamingLookupFromIndexOperatorTests extends OperatorTestCase {
    ...
    public void buildLookupIndex() throws IOException {
        ...
        LookupFromIndexOperatorTests.writeLookupIndex(random(), lookupIndexDirectory, operation, numberOfJoinColumns, LOOKUP_SIZE);
    }

    @Override
    protected SourceOperator simpleInput(BlockFactory blockFactory, int size) {
        return LookupFromIndexOperatorTests.createSimpleInput(blockFactory, size, numberOfJoinColumns, LOOKUP_SIZE);
    }

    @Override
    protected void assertSimpleOutput(List<Page> input, List<Page> results) {
        LookupFromIndexOperatorTests.assertLookupOutput(input, results, operation, numberOfJoinColumns);
    }
    ...
    private ThreadPool threadPool() {
        return LookupFromIndexOperatorTests.createTestThreadPool(getTestClass());
    }
    ...
    private AbstractLookupService.LookupShardContextFactory lookupShardContextFactory() {
        return LookupFromIndexOperatorTests.createLookupShardContextFactory(operation, numberOfJoinColumns, lookupIndexDirectory);
    }

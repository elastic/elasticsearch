...
public class InsensitiveEqualsTests extends ESTestCase {
    ...
    public void testFold() {
        ...
        assertFalse(insensitiveEquals(l("Foobar"), l("fo*")).fold());
    ...
    public void testProcess() {
        ...
        assertTrue(InsensitiveEquals.process(BytesRefs.toBytesRef("What is this?"), BytesRefs.toBytesRef("What is this?")));

        assertFalse(InsensitiveEquals.process(BytesRefs.toBytesRef("Foo"), BytesRefs.toBytesRef("fo*")));
        assertFalse(InsensitiveEquals.process(BytesRefs.toBytesRef("Foobar"), BytesRefs.toBytesRef("fo*")));

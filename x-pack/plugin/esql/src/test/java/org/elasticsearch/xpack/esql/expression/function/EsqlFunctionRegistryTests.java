    ...
    public void testRegisteredFunctionHaveTests() {
        ...
        assertMap(
            ...
            matchesList().item("org.elasticsearch.xpack.esql.expression.function.aggregate.AbsentOverTimeErrorTests is missing")
                ...
                .item("org.elasticsearch.xpack.esql.expression.function.aggregate.TopErrorTests is missing")
                ...
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.spatial.SpatialContainsErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.spatial.SpatialDisjointErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.spatial.SpatialIntersectsErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.spatial.SpatialWithinErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.spatial.StDistanceErrorTests is missing")
                ...
                .item("org.elasticsearch.xpack.esql.expression.function.vector.DotProductSerializationTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.DotProductTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.HammingErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.HammingSerializationTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.HammingTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.KnnErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.KnnSerializationTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.KnnTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.L1NormErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.L1NormSerializationTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.L1NormTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.L2NormErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.L2NormSerializationTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.vector.L2NormTests is missing")

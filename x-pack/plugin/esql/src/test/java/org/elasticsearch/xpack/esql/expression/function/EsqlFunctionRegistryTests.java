    ...
    public void testRegisteredFunctionHaveTests() {
        ...
        assertMap(
            ...
            matchesList().item("org.elasticsearch.xpack.esql.expression.function.aggregate.AbsentOverTimeErrorTests is missing")
                ...
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.date.RangeMaxErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.date.RangeMaxSerializationTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.date.RangeMinErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.date.RangeMinSerializationTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.date.RangeWithinSerializationTests is missing")

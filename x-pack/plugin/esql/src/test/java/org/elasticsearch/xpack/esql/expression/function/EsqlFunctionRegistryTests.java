    ...
    public void testRegisteredFunctionHaveTests() {
        ...
        assertMap(
            ...
            matchesList().item("org.elasticsearch.xpack.esql.expression.function.aggregate.AbsentOverTimeErrorTests is missing")
                ...
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.spatial.StDimensionErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.spatial.StGeometryTypeErrorTests is missing")
                .item("org.elasticsearch.xpack.esql.expression.function.scalar.spatial.StIsEmptyErrorTests is missing")

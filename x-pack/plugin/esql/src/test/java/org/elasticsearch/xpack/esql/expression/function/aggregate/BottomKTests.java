...
public class BottomKTests extends AbstractAggregationTestCase {
    public BottomKTests(@Name("TestCase") Supplier<TestCaseSupplier.TestCase> testCaseSupplier) {
    ...
    protected Expression build(Source source, List<Expression> args) {
        return new BottomK(source, args.get(0), args.get(1));
    }
    ...
    private static TestCaseSupplier makeSupplier(
        ...
        return new TestCaseSupplier(fieldSupplier.name() + ", " + limitCaseSupplier.name(), dataTypes, () -> {
            ...
            // BOTTOMK ranks ascending, like TOP(field, k, "ASC").
            ...
            // A limit of 1 surrogates through TOP into MIN and never runs the TOP code.
            String baseName = limit == 1 ? "Min" : "Top";

...
public class HistogramMergeOverTimeSerializationTests extends AbstractExpressionSerializationTests<HistogramMergeOverTime> {
    @Override
    protected HistogramMergeOverTime createTestInstance() {
    ...
    @Override
    protected HistogramMergeOverTime mutateInstance(HistogramMergeOverTime instance) throws IOException {
        Source source = randomSource();

...
public class LimitKErrorTests extends ErrorsForCasesWithoutExamplesTestCase {
    @Override
    protected List<TestCaseSupplier> cases() {
        return paramsToSuppliers(LimitKTests.parameters());
    }
    ...
    protected Matcher<String> expectedTypeErrorMatcher(List<Set<DataType>> validPerPosition, List<DataType> signature) {
        ...
        return equalTo(
            typeErrorMessage(
                ...
                (v, p) -> p == 1
                    ? "integer"
                    : "any type except counter types, dense_vector, aggregate_metric_double, tdigest, histogram, "

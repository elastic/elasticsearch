...
public class VaragsTestCaseBuilder {
    ...
    private TestCaseSupplier.TestCase stringCase(DataTypes dataType, int paramCount, boolean multivalued) {
    ...
    private String testCaseName(int count, boolean multivalued, DataTypes type) {
        return "("
    ...
    private List<DataTypes> dataTypes(int paramCount, DataTypes dataType) {

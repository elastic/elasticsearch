...
public class ToGeometryTests extends AbstractFunctionTestCase {
    public ToGeometryTests(@Name("TestCase") Supplier<TestCaseSupplier.TestCase> testCaseSupplier) {
    ...
    public static Iterable<Object[]> parameters() {
        ...
        final Function<String, String> evaluatorName = s -> "ToGeometry" + s + "Evaluator[field=" + attribute + "]";
        final List<TestCaseSupplier> suppliers = new ArrayList<>();

        TestCaseSupplier.forUnaryGeometry(suppliers, attribute, EsqlDataTypes.GEOMETRY, v -> v, List.of());
    ...
    protected Expression build(Source source, List<Expression> args) {
        return new ToGeometry(source, args.get(0));
    }
}

...
public class RangeMinTests extends AbstractScalarFunctionTestCase {
    ...
    public static Iterable<Object[]> parameters() {
        ...
        // Test with null from value
        suppliers.add(new TestCaseSupplier("null from value", List.of(DataType.DATE_RANGE), () -> {
            var range = new LongRangeBlockBuilder.LongRange(null, 2000L);
    ...
    protected Expression build(Source source, List<Expression> args) {
        return new RangeMin(source, args.get(0));
    }
}

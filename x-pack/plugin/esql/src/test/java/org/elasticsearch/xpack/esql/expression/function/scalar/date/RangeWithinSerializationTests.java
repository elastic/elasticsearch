...
public class RangeWithinSerializationTests extends AbstractExpressionSerializationTests<RangeWithin> {
    @Override
    protected RangeWithin createTestInstance() {
        Source source = randomSource();
        Expression left = randomChild();
        Expression right = randomChild();
        return new RangeWithin(source, left, right);
    }

    @Override
    protected RangeWithin mutateInstance(RangeWithin instance) throws IOException {

    ...
    private static TestCaseSupplier pointInRange(
        ...
        return new TestCaseSupplier(
            ...
            () -> new TestCaseSupplier.TestCase(
                ...
                "RangeWithinDateDateRangeEvaluator[date=Attribute[channel=0], range=Attribute[channel=1]]",
                DataType.BOOLEAN,
                equalTo(expected)
            )
        );
    ...
    private static TestCaseSupplier rangeWithinRange(String name, long aFrom, long aTo, long bFrom, long bTo, boolean expected) {
        return new TestCaseSupplier(
            ...
            () -> new TestCaseSupplier.TestCase(
                ...
                "RangeWithinDateRangeDateRangeEvaluator[left=Attribute[channel=0], right=Attribute[channel=1]]",
                DataType.BOOLEAN,
                equalTo(expected)
            )
        );

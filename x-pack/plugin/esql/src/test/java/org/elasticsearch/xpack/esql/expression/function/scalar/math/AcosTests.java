...
public class AcosTests extends AbstractFunctionTestCase {
    ...
    public static Iterable<Object[]> parameters() {
        List<TestCaseSupplier> suppliers = TestCaseSupplier.forUnaryCastingToDouble("AcosEvaluator", "val", Math::acos, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);

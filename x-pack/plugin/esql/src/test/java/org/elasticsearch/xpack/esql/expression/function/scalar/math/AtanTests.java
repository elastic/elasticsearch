...
public class AtanTests extends AbstractFunctionTestCase {
    ...
    public static Iterable<Object[]> parameters() {
        List<TestCaseSupplier> suppliers = TestCaseSupplier.forUnaryCastingToDouble("AtanEvaluator", "val", Math::atan, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);

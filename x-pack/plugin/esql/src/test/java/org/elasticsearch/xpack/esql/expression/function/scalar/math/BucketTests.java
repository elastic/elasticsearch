...
public class BucketTests extends AbstractFunctionTestCase {
    ...
    private static final DataTypes[] DATE_BOUNDS_TYPE = new DataTypes[] { DataTypes.DATETIME };

    private static void dateCases(List<TestCaseSupplier> suppliers, String name, LongSupplier date) {
        for (DataTypes fromType : DATE_BOUNDS_TYPE) {
            for (DataTypes toType : DATE_BOUNDS_TYPE) {
    ...
    private static TestCaseSupplier.TypedData dateBound(String name, DataTypes type, String date) {
        Object value;
    ...
    private static final DataTypes[] NUMBER_BOUNDS_TYPES = new DataTypes[] { DataTypes.INTEGER, DataTypes.LONG, DataTypes.DOUBLE };

    private static void numberCases(List<TestCaseSupplier> suppliers, String name, DataTypes numberType, Supplier<Number> number) {
        for (DataTypes fromType : NUMBER_BOUNDS_TYPES) {
            for (DataTypes toType : NUMBER_BOUNDS_TYPES) {
    ...
    private static TestCaseSupplier.TypedData numericBound(String name, DataTypes type, double value) {
        Number v;
    ...
    private static void numberCasesWithSpan(List<TestCaseSupplier> suppliers, String name, DataTypes numberType, Supplier<Number> number) {
    ...
    private static TestCaseSupplier.TypedData keywordDateLiteral(String name, DataTypes type, String date) {

...
public class FloorTests extends AbstractScalarFunctionTestCase {
    ...
    protected TestCase getSimpleTestCase() {
        ...
        return new TestCase(Source.EMPTY, typedData, equalTo(Math.floor(d)));
    }
    ...
    protected Matcher<Object> resultMatcher(List<Object> data, DataType dataType) {
        return equalTo(Math.floor(((Number) data.get(0)).doubleValue()));
    }

    @Override
    protected String expectedEvaluatorSimpleToString() {
        return "FloorDoubleEvaluator[val=Attribute[channel=0]]";
    }

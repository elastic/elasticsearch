...
public class SinhTests extends AbstractFunctionTestCase {
    ...
    public static Iterable<Object[]> parameters() {
        List<TestCaseSupplier> suppliers = TestCaseSupplier.forUnaryCastingToDouble("SinhEvaluator", "val", Math::sinh, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);

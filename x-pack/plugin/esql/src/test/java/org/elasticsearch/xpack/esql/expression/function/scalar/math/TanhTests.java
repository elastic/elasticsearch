...
public class TanhTests extends AbstractFunctionTestCase {
    ...
    public static Iterable<Object[]> parameters() {
        List<TestCaseSupplier> suppliers = TestCaseSupplier.forUnaryCastingToDouble("TanhEvaluator", "val", Math::tanh, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY);

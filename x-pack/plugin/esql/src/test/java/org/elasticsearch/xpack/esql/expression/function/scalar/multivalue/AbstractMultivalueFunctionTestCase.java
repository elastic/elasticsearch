...
public abstract class AbstractMultivalueFunctionTestCase extends AbstractFunctionTestCase {
    ...
    protected static void bytesRefs(
        ...
        String name,
        String evaluatorName,
        Function<DataTypes, DataTypes> expectedDataType,
        BiFunction<Integer, Stream<BytesRef>, Matcher<Object>> matcher
    ) {
        for (DataTypes type : new DataTypes[] { DataTypes.KEYWORD, DataTypes.TEXT, DataTypes.IP, DataTypes.VERSION }) {
    ...
    protected abstract DataTypes[] supportedTypes();

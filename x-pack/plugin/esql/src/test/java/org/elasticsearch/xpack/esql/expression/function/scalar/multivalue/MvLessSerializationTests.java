...
public class MvLessSerializationTests extends AbstractExpressionSerializationTests<MvLess> {
    @Override
    protected MvLess createTestInstance() {
        Source source = randomSource();
        return new MvLess(source, randomChild(), randomChild(), randomBoolean() ? null : randomOptions());
    }

    @Override
    protected MvLess mutateInstance(MvLess instance) throws IOException {
        ...
        return new MvLess(instance.source(), field, bound, options);
    }

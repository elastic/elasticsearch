...
import static org.elasticsearch.xpack.esql.expression.function.scalar.spatial.SpatialBinaryGeometryBlockProcessor.normalizeForOverlay;
...
public abstract class AbstractBinarySpatialGeometryFunctionTestCase extends AbstractScalarFunctionTestCase {
    ...
    private static BytesRef valueOf(BytesRef leftWkb, BytesRef rightWkb, BiFunction<Geometry, Geometry, Geometry> jtsOp) {
        ...
        try {
            Geometry leftGeom = normalizeForOverlay(UNSPECIFIED.wkbToJtsGeometry(leftWkb));
            Geometry rightGeom = normalizeForOverlay(UNSPECIFIED.wkbToJtsGeometry(rightWkb));

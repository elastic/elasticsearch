...
public class StSimplifyPreserveTopologyErrorTests extends ErrorsForCasesWithoutExamplesTestCase {
    @Override
    protected List<TestCaseSupplier> cases() {
        return paramsToSuppliers(StSimplifyPreserveTopologyTests.parameters());
    }

...
public class StXMinTests extends AbstractScalarFunctionTestCase {
    ...
    public static Iterable<Object[]> parameters() {
        String expectedEvaluator = "StXMinFromWKBEvaluator[field=Attribute[channel=0]]";
        final List<TestCaseSupplier> suppliers = new ArrayList<>();
        TestCaseSupplier.forUnaryGeoPoint(suppliers, expectedEvaluator, DOUBLE, StXMinTests::valueOf, List.of());
        TestCaseSupplier.forUnaryCartesianPoint(suppliers, expectedEvaluator, DOUBLE, StXMinTests::valueOf, List.of());
        TestCaseSupplier.forUnaryGeoShape(suppliers, expectedEvaluator, DOUBLE, StXMinTests::valueOf, List.of());
        TestCaseSupplier.forUnaryCartesianShape(suppliers, expectedEvaluator, DOUBLE, StXMinTests::valueOf, List.of());

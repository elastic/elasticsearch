        ...
        return parameterSuppliersFromTypedData(
            errorsForCasesWithoutExamples(
                anyNullIsNull(
                    true,
                    List.of(
                        new TestCaseSupplier("Substring basic test", List.of(DataTypes.KEYWORD, DataTypes.INTEGER, DataTypes.INTEGER), () -> {
                        ...
                        new TestCaseSupplier("Substring empty string", List.of(DataTypes.TEXT, DataTypes.INTEGER, DataTypes.INTEGER), () -> {
                            int start = between(1, 8);
                            int length = between(1, 10 - start);
                            return new TestCaseSupplier.TestCase(
                                List.of(

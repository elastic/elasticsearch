...
public class NotEqualsErrorTests extends ErrorsForCasesWithoutExamplesTestCase {
    ...
    private static final String TYPE_ERROR =
        "boolean, cartesian_point, cartesian_shape, date_nanos, datetime, double, geo_point, geo_shape, geohash, geohex, geotile, integer, "
            + "ip, keyword, long, text, unsigned_long or version";
}

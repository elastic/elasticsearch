...
public class NotEqualsTests extends AbstractScalarFunctionTestCase {
    ...
    public static Iterable<Object[]> parameters() {
        ...
        if (DataType.TDIGEST.supportedVersion().supportedLocally()) {
        ...
        if (DataType.EXPONENTIAL_HISTOGRAM.supportedVersion().supportedLocally()) {
            suppliers.add(
        ...
        // Histogram cases
        if (DataType.HISTOGRAM.supportedVersion().supportedLocally()) {

...
public class CompletionRequestIteratorTests extends ComputeTestCase {
    ...
    public void testIterateEmptyInput() throws Exception {
        ...
        try (CompletionRequestIterator requestIterator = new CompletionRequestIterator(inferenceId, inputBlock, Map.of(), randomTimeoutOrNull())) {
    ...
    public void testIterateWithNulls() throws Exception {
        ...
        try (CompletionRequestIterator requestIterator = new CompletionRequestIterator(inferenceId, inputBlock, Map.of(), timeout)) {
            ...
            // Expected position value counts: [1] - just prompt2
            assertTrue(requestIterator.hasNext());
            ...
            // Expected position value counts: [1]
            assertTrue(requestIterator.hasNext());
    ...
    public void testIterateWithAllNulls() throws Exception {
        ...
        try (CompletionRequestIterator requestIterator = new CompletionRequestIterator(inferenceId, inputBlock, Map.of(), randomTimeoutOrNull())) {
            ...
            assertThat(requestItem.positionValueCounts(), equalTo(new int[] { 0, 0, 0 }));
    ...
    private void assertIterate(int size) throws Exception {
        ...
        try (CompletionRequestIterator requestIterator = new CompletionRequestIterator(inferenceId, inputBlock, Map.of(), timeout)) {
            ...
            while (requestIterator.hasNext()) {
                ...
                // Verify position value counts is [1] for simple completion requests

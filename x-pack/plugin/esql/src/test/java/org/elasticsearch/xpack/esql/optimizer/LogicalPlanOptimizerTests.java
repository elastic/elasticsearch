...
public class LogicalPlanOptimizerTests extends AbstractLogicalPlanOptimizerTests {
     ...
     * Expected
     * <pre>{@code
     * Project[[emp_no{f}#277, first_name{r}#288, salary{f}#282]]
     * \_TopN[[Order[salary{f}#282,ASC,LAST], Order[first_name{r}#288,ASC,LAST]],1000[INTEGER],false]
     *   \_Filter[LIKE(first_name{r}#288, "R*", false)]
     *     \_MvExpand[first_name{f}#278,first_name{r}#288]
     *       \_Filter[gender{f}#279 == F[KEYWORD]]
     *         \_EsRelation[test][_meta_field{f}#283, emp_no{f}#277, first_name{f}#27..]
     * }</pre>
     */
    public void testRedundantSort_BeforeMvExpand_WithFilterOnExpandedField_ResultTruncationDefaultSize() {
        ...
        assertThat(filter1.condition(), instanceOf(WildcardLike.class));
     ...
     * Expected
     * <pre>{@code
     * Project[[emp_no{f}#58, first_name{r}#69, salary{f}#63]]
     * \_TopN[[Order[salary{f}#63,ASC,LAST], Order[first_name{r}#69,ASC,LAST]],15[INTEGER],false]
     *   \_Filter[LIKE(first_name{r}#69, "R*", false)]
     *     \_MvExpand[first_name{f}#59,first_name{r}#69]
     *       \_Filter[gender{f}#60 == F[KEYWORD]]
     *         \_EsRelation[test][_meta_field{f}#64, emp_no{f}#58, first_name{f}#59, ..]
     * }</pre>
     */
     ...
     * Expected
     * <pre>{@code
     * Project[[emp_no{f}#220, first_name{r}#231 AS x#212, salary{f}#225]]
     * \_TopN[[Order[salary{f}#225,ASC,LAST], Order[first_name{r}#231,ASC,LAST]],15[INTEGER],false]
     *   \_Filter[LIKE(first_name{r}#231, "A*", false)]
     *     \_MvExpand[first_name{f}#221,first_name{r}#231]
     *       \_Filter[gender{f}#222 == F[KEYWORD]]
     *         \_EsRelation[test][_meta_field{f}#226, emp_no{f}#220, first_name{f}#22..]
     * }</pre>
     */

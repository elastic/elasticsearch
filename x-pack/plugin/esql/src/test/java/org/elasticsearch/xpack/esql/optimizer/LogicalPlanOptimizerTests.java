...
public class LogicalPlanOptimizerTests extends ESTestCase {
    ...
    public void testBucketWithNonFoldingArgs() {
        assertThat(
            ...
            containsString(
                "second argument of [bucket(date, integer, \"2000-01-01\", \"2000-01-02\")] must be a constant, "
                    + "received [integer]"
            )
        );
        ...
        assertThat(
            ...
            containsString(
                "third argument of [bucket(date, 2, date, \"2000-01-02\")] must be a constant, "
                    + "received [date]"
            )
        );
        ...
        assertThat(
            ...
            containsString(
                "fourth argument of [bucket(date, 2, \"2000-01-02\", date)] must be a constant, "
                    + "received [date]"
            )
        );
        ...
        assertThat(
            ...
            containsString(
                "second argument of [bucket(integer, long, 4, 5)] must be a constant, "
                    + "received [long]"
            )
        );
        ...
        assertThat(
            ...
            containsString(
                "third argument of [bucket(integer, 3, long, 5)] must be a constant, "
                    + "received [long]"
            )
        );
        ...
        assertThat(
            ...
            containsString(
                "fourth argument of [bucket(integer, 3, 4, long)] must be a constant, "
                    + "received [long]"
            )
        );
    }

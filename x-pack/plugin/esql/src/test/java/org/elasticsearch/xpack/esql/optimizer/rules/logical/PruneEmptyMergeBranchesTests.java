...
public class PruneEmptyMergeBranchesTests extends AbstractLogicalPlanOptimizerTests {
    ...
    public void testOneEmptySubquery() {
        ...
        // The second subquery is removed and the singleton UnionAll is flattened. The Project preserves
        // the UnionAll output attributes expected by the parent plan.
     ...
     * {@code MergePlan.checkNonEmpty} is responsible for surfacing this as a clear failure

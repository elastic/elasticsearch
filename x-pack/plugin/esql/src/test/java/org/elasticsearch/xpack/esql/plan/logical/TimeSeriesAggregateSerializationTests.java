...
public class TimeSeriesAggregateSerializationTests extends AbstractLogicalPlanSerializationTests<TimeSeriesAggregate> {
    ...
    protected TimeSeriesAggregate createTestInstance() {
        ...
        boolean isBackwardBucketIntervalConvention = randomBoolean();
    ...
    protected TimeSeriesAggregate mutateInstance(TimeSeriesAggregate instance) throws IOException {
        ...
        boolean isBackwardBucketIntervalConvention = instance.isBackwardBucketIntervalConvention();
        switch (between(0, 4)) {
            ...
            case 4 -> isBackwardBucketIntervalConvention = randomValueOtherThan(isBackwardBucketIntervalConvention, () -> randomBoolean());
        }
        return new TimeSeriesAggregate(
            instance.source(),
            child,

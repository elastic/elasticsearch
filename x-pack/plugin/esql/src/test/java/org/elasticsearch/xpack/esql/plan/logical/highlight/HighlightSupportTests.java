...
public class HighlightSupportTests extends ESTestCase {
    ...
    public void testExtraAnalyzerNamesOfCollectsQuoteAnalyzers() {
        Expression query = new Or(
            EMPTY,
            queryString("fox", options("quote_analyzer", "english")),
            queryString("dog", options("quote_analyzer", "whitespace"))
        );
        assertThat(HighlightSupport.extraAnalyzerNamesOf(query), equalTo(Set.of("english", "whitespace")));
    }

    public void testExtraAnalyzerNamesOfEmptyWithoutQuoteAnalyzer() {
        assertTrue(HighlightSupport.extraAnalyzerNamesOf(match("title", "fox", null)).isEmpty());
    }
    ...
    public void testCollectImplicitQueryKeepsSingleExtraQuoteAnalyzer() {
        ...
        assertThat(implicitQuery.query(), equalTo(leaf));
        assertThat(implicitQuery.analyzerName(), equalTo("english"));
        assertThat(HighlightSupport.extraAnalyzerNamesOf(leaf), equalTo(Set.of("whitespace")));
    }
    ...
    public void testCollectImplicitQueryBorrowsMultipleDistinctQuoteAnalyzers() {
        ...
        assertThat(implicitQuery.query(), equalTo(leaf));
        assertNull(implicitQuery.analyzerName());
        assertThat(HighlightSupport.extraAnalyzerNamesOf(leaf), equalTo(Set.of("english", "whitespace")));
    }
    ...
    public void testFieldAnalyzersUsesCommandDefaultForUntouchedFields() {

...
public class EsqlWorkerThreadPoolTests extends ESTestCase {
    ...
    public void testDefaultThreadPoolSize() {
        ...
        // Only the esql_worker compute pool: blocking external reads run on it too, bounded by the per-scheme permit
        // semaphore in StorageProviderRegistry rather than a dedicated thread pool.

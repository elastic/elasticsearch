...
public class SingleValueQueryTests extends MapperServiceTestCase {
    ...
    /**
     * Warnings raised by the {@link SingleValueMatchQuery} nodes during a single test are written into this
     * context's per-driver sink (see {@link #warningsFor}); {@link #runCase} snapshots and asserts against it,
     * mirroring how warnings are actually propagated rather than reading the ambient response headers.
     */

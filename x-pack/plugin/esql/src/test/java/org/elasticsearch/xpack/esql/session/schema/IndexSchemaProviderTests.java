...
public class IndexSchemaProviderTests extends ESTestCase {
    ...
    public void testComputeLookupJoinIndexScope() {
        {
            ...
            assertThat(
                IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup", resolution),
        ...
        }
        {
            ...
            assertThat(IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup", resolution), equalTo(Set.of("remote")));
        }
        {
        ...
        }
        {
            ...
            var resolution = createIndexResolution("index");
            assertThat(
                IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup-1", resolution),
                equalTo(Set.of(RemoteClusterAware.LOCAL_CLUSTER_GROUP_KEY))
            );
            assertThat(
                IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup-2", resolution),
                equalTo(Set.of(RemoteClusterAware.LOCAL_CLUSTER_GROUP_KEY))
            );
        }
        {
            ...
            assertThat(
                IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup-0", resolution),
                equalTo(Set.of(RemoteClusterAware.LOCAL_CLUSTER_GROUP_KEY))
            );
            assertThat(IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup-1", resolution), equalTo(Set.of("remote-1")));
            assertThat(IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup-2", resolution), equalTo(Set.of("remote-2")));
            assertThat(
                IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup-3", resolution),
        ...
        }
        {
            ...
            assertThat(
                IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup", resolution),
                equalTo(Set.of("remote-1", "remote-2"))
            );
        }
    }
    ...
    /**
     * Exercises {@link IndexSchemaProvider#computeLookupJoinIndexScope} on mixed shapes that combine FROM subqueries, WHERE IN
    ...
    public void testComputeLookupJoinIndexScopeMixedSubqueries() {
...

        {
            ...
            assertThat(IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup", resolution), equalTo(Set.of("remote-1")));
        }
        {
            ...
            var plan = InSubqueryResolver.resolve(TEST_PARSER.parseQuery("""
                ...
                """));
            var resolution = createIndexResolution("remote-1:a", "remote-2:b", "remote-3:c");
            assertThat(IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup", resolution), equalTo(Set.of("remote-2")));
        }
        {
        ...
        }
        {
            ...
            assertThat(IndexSchemaProvider.computeLookupJoinIndexScope(plan, "lookup", resolution), equalTo(Set.of("remote-0")));
        }
        {

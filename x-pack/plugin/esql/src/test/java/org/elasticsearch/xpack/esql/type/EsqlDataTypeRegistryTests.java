...
public class EsqlDataTypeRegistryTests extends ESTestCase {
    ...
    public void testMergeSameMapping() {
        Map<String, EsField> oneMapping = loadMapping("mapping-basic.json");
        Map<String, EsField> sameMapping = loadMapping("mapping-basic.json");
    ...
    public void testMergeCompatibleMapping() {
        Map<String, EsField> basicMapping = loadMapping("mapping-basic.json");
        Map<String, EsField> numericMapping = loadMapping("mapping-numeric.json");
    ...
    public void testMergeIncompatibleCapabilities() {
        Map<String, EsField> basicMapping = loadMapping("mapping-basic.json");
        Map<String, EsField> incompatible = loadMapping("mapping-basic-nodocvalues.json");
    ...
    public void testMultiLevelObjectMappings() throws Exception {
        Map<String, EsField> dottedMapping = loadMapping("mapping-dotted-field.json");
    ...
    public void testMultiLevelNestedMappings() {
        Map<String, EsField> nestedMapping = loadMapping("mapping-nested.json");
    ...
    public void testMetaFieldsAreIgnored() {

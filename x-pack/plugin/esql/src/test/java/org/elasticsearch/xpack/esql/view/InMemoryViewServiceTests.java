...
public class InMemoryViewServiceTests extends AbstractStatementParserTests {
    ...
    /**
     * Reproduces https://github.com/elastic/esql-planning/issues/889:
     * when a view expands to a concrete index (e.g. {@code my-view = FROM source-index}) and the
    ...
    public void testViewAndAliasPointingToSameIndexProduceTwoCopies() {
        ...
        assertThat(((ViewUnionAll) compacted).children().size(), equalTo(2));
    }

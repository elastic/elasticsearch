...
public class Fleet extends Plugin implements SystemIndexPlugin {
    ...
    public List<RestHandler> getRestHandlers(RestHandlerParameters parameters) {
        return List.of(
            ...
            new RestFleetSearchAction(parameters.restController().getSearchUsageHolder()),
            new RestFleetMultiSearchAction(parameters.settings(), parameters.restController().getSearchUsageHolder()),

...
public class FrozenIndexTests extends ESSingleNodeTestCase {
    ...
    public void testSearchAndGetAPIsAreThrottled() throws IOException {
        ...
        // numRefreshes starts at numberOfShards because during shard recovery we go to the store
        // to fetch fieldInfos to keep track of non-empty fields for _field_caps

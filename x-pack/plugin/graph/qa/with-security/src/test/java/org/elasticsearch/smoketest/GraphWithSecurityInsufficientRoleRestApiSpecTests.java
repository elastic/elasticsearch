...
public class GraphWithSecurityInsufficientRoleRestApiSpecTests extends GraphWithSecurityRestApiSpecTests {

    public GraphWithSecurityInsufficientRoleRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class GraphWithSecurityInsufficientRoleRestTestsYaml extends GraphWithSecurityRestTestsYaml {

    public GraphWithSecurityInsufficientRoleRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

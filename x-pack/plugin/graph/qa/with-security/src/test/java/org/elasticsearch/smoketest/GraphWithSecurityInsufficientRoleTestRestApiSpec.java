...
public class GraphWithSecurityInsufficientRoleTestRestApiSpec extends GraphWithSecurityTestRestApiSpec {

    public GraphWithSecurityInsufficientRoleTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

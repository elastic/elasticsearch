...
public class TransportGraphExploreAction extends HandledTransportAction<GraphExploreRequest, GraphExploreResponse> {
    ...
    class AsyncGraphAction {
        ...
        synchronized void expand() {
            ...
            final SearchRequest searchRequest = new SearchRequest(request.indices()).types(request.types())
            ...
            client.search(searchRequest, new ActionListener.Delegating<SearchResponse, GraphExploreResponse>(listener) {
                @Override

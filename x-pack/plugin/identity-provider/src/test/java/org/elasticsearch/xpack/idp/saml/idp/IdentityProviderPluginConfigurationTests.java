...
public class IdentityProviderPluginConfigurationTests extends IdpSamlTestCase {
    ...
    public void testAllSettings() throws Exception{
        ...
        assertThat(idp.getSingleSignOnEndpoint(SAML2_REDIRECT_BINDING_URI), equalTo("https://idp.org/sso/redirect"));
        assertThat(idp.getSingleSignOnEndpoint(SAML2_POST_BINDING_URI), equalTo("https://idp.org/sso/post"));
        assertThat(idp.getSingleLogoutEndpoint(SAML2_REDIRECT_BINDING_URI), equalTo("https://idp.org/slo/redirect"));
        assertThat(idp.getSingleLogoutEndpoint(SAML2_POST_BINDING_URI), equalTo("https://idp.org/slo/post"));
    ...
    public void testInvalidSsoEndpoint() {
        ...
        assertThat(e.getMessage(), Matchers.containsString("Not a valid URI"));
    }

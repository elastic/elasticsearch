...
public class ChangePolicyforIndexIT extends ESRestTestCase {
    ...
    public void testChangePolicyForIndex() throws Exception {
        ...
        phases1.put("hot", new Phase("hot", TimeValue.ZERO,
            singletonMap(RolloverAction.NAME, new RolloverAction(null, null, null, 1L, null, null, null))));
        phases1.put(
            "warm",
            new Phase(
                "warm",
        ...
        phases2.put(
            ...
            new Phase("hot", TimeValue.ZERO,
                singletonMap(RolloverAction.NAME, new RolloverAction(null, null, null, 1000L, null, null, null)))
        );
        phases2.put(
            "warm",
            new Phase(

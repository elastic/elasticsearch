...
public class ChangePolicyforIndexIT extends ESRestTestCase {
    ...
    public void testChangePolicyForIndex() throws Exception {
        ...
        phases1.put("hot", new Phase("hot", TimeValue.ZERO, singletonMap(RolloverAction.NAME, new RolloverAction(null, null, null, 1L, 1L))));
        phases1.put(
            "warm",
            new Phase(
                "warm",
        ...
        phases2.put(
            "hot",
            new Phase("hot", TimeValue.ZERO, singletonMap(RolloverAction.NAME, new RolloverAction(null, null, null, 1000L, 1000L)))
        );
        phases2.put(
            "warm",
            new Phase(
    ...
    public void testILMHonoursTheCachedPhaseAfterPolicyUpdate() throws Exception {
        ...
        createNewSingletonPolicy(client(), policyName, "hot", new RolloverAction(null, null, null, 1L, 1L));

...
public class TimeseriesMoveToStepIT extends ESRestTestCase {
    ...
    public void testMoveToStepRereadsPolicy() throws Exception {
        createNewSingletonPolicy(
            ...
            policy,
            "hot",
            new RolloverAction(null, null, TimeValue.timeValueHours(1), null, null, null, null, null),
            TimeValue.ZERO
        );
        ...
        createNewSingletonPolicy(client(), policy, "hot", new RolloverAction(null, null, null, 1L, null, null, null, null), TimeValue.ZERO);

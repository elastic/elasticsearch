...
public class DownsampleActionIT extends ESRestTestCase {
    ...
    public void testRollupIndexInTheHotPhaseAfterRollover() throws Exception {
        ...
        createTemplateRequest.setJsonEntity(org.elasticsearch.core.Strings.format("""
            {
              "index_patterns": ["%s-*"],
              "settings": {
                "number_of_shards": %s,
    ...
    public void testTsdbDataStreams() throws Exception {
        ...
        createIndexTemplateRequest.setJsonEntity(org.elasticsearch.core.Strings.format(TEMPLATE, dataStream, policy));

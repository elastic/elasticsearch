...
public class SearchableSnapshotActionIT extends ESRestTestCase {
    ...
    public void testDeleteActionDeletesSearchableSnapshot() throws Exception {
        ...
        Map<String, LifecycleAction> coldActions = org.elasticsearch.core.Map.of(
    ...
    public void testCreateInvalidPolicy() {
        ResponseException exception = expectThrows(
            ...
            () -> createPolicy(
                ...
                new Phase("warm", TimeValue.ZERO, org.elasticsearch.core.Map.of(ForceMergeAction.NAME, new ForceMergeAction(1, null))),
    ...
    public void testUpdatePolicyToAddPhasesYieldsInvalidActionsToBeSkipped() throws Exception {
        ...
        createPolicy(
            ...
            new Phase(
                ...
                org.elasticsearch.core.Map.of(SetPriorityAction.NAME, new SetPriorityAction(999))
            ),
            null,
            null,
            null
    ...
    public void testResumingSearchableSnapshotFromFullToPartial() throws Exception {
        ...
        String policyFrozen = "policy-cold-frozen";
        createPolicy(
            client(),
            policyFrozen,
            null,
        ...
        createPolicy(
            ...
            new Phase("delete", TimeValue.ZERO, singletonMap(DeleteAction.NAME, new DeleteAction(true)))
        );
        assertBusy(() -> {
    ...
    public void testResumingSearchableSnapshotFromPartialToFull() throws Exception {
        ...
        String policyColdFrozen = "policy-cold-frozen";
        createPolicy(
            client(),
            policyColdFrozen,

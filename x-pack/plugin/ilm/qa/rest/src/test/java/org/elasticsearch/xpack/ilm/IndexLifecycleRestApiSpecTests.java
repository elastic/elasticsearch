...
public class IndexLifecycleRestApiSpecTests extends ESClientYamlSuiteTestCase {
    ...
    public IndexLifecycleRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

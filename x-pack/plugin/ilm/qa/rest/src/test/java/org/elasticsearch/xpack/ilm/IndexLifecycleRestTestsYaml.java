...
public class IndexLifecycleRestTestsYaml extends ESClientYamlSuiteTestCase {
    ...
    public IndexLifecycleRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

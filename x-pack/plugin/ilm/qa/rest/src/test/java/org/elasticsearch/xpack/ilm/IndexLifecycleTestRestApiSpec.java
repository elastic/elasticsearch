...
public class IndexLifecycleTestRestApiSpec extends ESClientYamlSuiteTestCase {
    ...
    public IndexLifecycleTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

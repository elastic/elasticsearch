...
public class OperationModeUpdateTask extends ClusterStateUpdateTask {
        ...
        return ClusterState.builder(currentState)
            .metadata(
                Metadata.builder(currentState.metadata())
                    .putCustom(LifecycleOperationMetadata.TYPE, new LifecycleOperationMetadata(newMode, currentILMMode(currentState)))
            )
            .build();
    }
    ...
    private ClusterState updateSLMState(final ClusterState currentState) {
        ...
        return ClusterState.builder(currentState)
            .metadata(
                Metadata.builder(currentState.metadata())
                    .putCustom(LifecycleOperationMetadata.TYPE, new LifecycleOperationMetadata(currentSLMMode(currentState), newMode))
            )
            .build();
    }

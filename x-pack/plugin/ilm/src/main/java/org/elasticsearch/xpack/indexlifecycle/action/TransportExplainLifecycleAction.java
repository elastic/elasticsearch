        ...
        for (String index : concreteIndices) {
            ...
            if (Strings.hasLength(policyName)) {
                indexResponse = IndexLifecycleExplainResponse.newManagedIndexResponse(index, policyName,
                        ...
                        LifecycleSettings.LIFECYCLE_NEXT_PHASE_SETTING.get(idxSettings),
                        LifecycleSettings.LIFECYCLE_NEXT_ACTION_SETTING.get(idxSettings),
                        LifecycleSettings.LIFECYCLE_NEXT_STEP_SETTING.get(idxSettings),

...
public class MetadataMigrateToDataTiersRoutingServiceTests extends ESTestCase {
    ...
    public void testMigrateIlmPolicyForIndexWithoutILMMetadata() {
        ...
        AllocateAction warmAllocateAction = new AllocateAction(
            null,
            null,
            org.elasticsearch.core.Map.of("data", "warm"),
            null,
    ...
    public void testAllocateActionDefinesRoutingRules() {
        assertThat(
            allocateActionDefinesRoutingRules(
                "data",
                new AllocateAction(null, null, org.elasticsearch.core.Map.of("data", "cold"), null, null)
            ),
            is(true)
        );
        assertThat(
            allocateActionDefinesRoutingRules(
                "data",
                new AllocateAction(null, null, null, org.elasticsearch.core.Map.of("data", "cold"), null)
            ),
            is(true)
        );
        assertThat(
            allocateActionDefinesRoutingRules(
                ...
                new AllocateAction(
                    null,
                    null,
                    org.elasticsearch.core.Map.of("another_attribute", "rack1"),
                    null,
        ...
        assertThat(
            allocateActionDefinesRoutingRules(
                "data",
                new AllocateAction(null, null, null, null, org.elasticsearch.core.Map.of("another_attribute", "cold"))
            ),
            is(false)
        );
    ...
    public void testMigrateToDataTiersRouting() {
        ...
        AllocateAction allocateActionWithOtherAttribute = new AllocateAction(
            0,
            null,
            null,
            null,
            org.elasticsearch.core.Map.of("other", "cold")
        );
        ...
        LifecyclePolicy policyToMigrate = new LifecyclePolicy(
            ...
            org.elasticsearch.core.Map.of(
                ...
                new Phase(
                    "warm",
                    TimeValue.ZERO,
                    org.elasticsearch.core.Map.of(allocateActionWithDataAttribute.getWriteableName(), allocateActionWithDataAttribute)
                )
            )
        );
        ...
        LifecyclePolicy shouldntBeMigratedPolicy = new LifecyclePolicy(
            ...
            org.elasticsearch.core.Map.of(
                ...
                new Phase(
                    "warm",
                    TimeValue.ZERO,
                    org.elasticsearch.core.Map.of(allocateActionWithOtherAttribute.getWriteableName(), allocateActionWithOtherAttribute)
                )
            )
        );
            ...
            ClusterState ilmStoppedState = ClusterState.builder(ClusterName.DEFAULT)
                .metadata(
                    Metadata.builder()
                        .putCustom(
                            IndexLifecycleMetadata.TYPE,
                            new IndexLifecycleMetadata(org.elasticsearch.core.Map.of(), OperationMode.STOPPED)
                        )
                )
                .build();
    ...
    public void testMigrateLegacyIndexTemplates() {
        ...
        IndexTemplateMetadata templateWithRequireRouting = new IndexTemplateMetadata(
            ...
            randomInt(),
            randomInt(),
            org.elasticsearch.core.List.of("test-*"),
    ...
    public void testMigrateIndexAndComponentTemplates() {
        ...
        ComposableIndexTemplate composableTemplateWithRequireRouting = new ComposableIndexTemplate(
            ...
            org.elasticsearch.core.List.of("component-template-without-custom-routing"),
            randomLong(),
            randomLong(),
            null
        );
        ...
        assertThat(migratedTemplates.migratedLegacyTemplates, is(org.elasticsearch.core.List.of("template-with-require-routing")));
        assertThat(
            migratedTemplates.migratedComposableTemplates,
            is(org.elasticsearch.core.List.of("composable-template-with-require-routing"))
        );
        assertThat(
            migratedTemplates.migratedComponentTemplates,
            is(org.elasticsearch.core.List.of("component-with-require-and-include-routing"))
        );
    }

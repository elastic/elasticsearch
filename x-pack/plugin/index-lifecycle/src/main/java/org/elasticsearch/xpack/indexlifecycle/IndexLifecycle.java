...
import org.elasticsearch.xpack.indexlifecycle.action.RestSetIndexPolicyAction;
...
import org.elasticsearch.xpack.indexlifecycle.action.TransportSetIndexPolicyAction;
...
public class IndexLifecycle extends Plugin implements ActionPlugin {
    ...
    public List<RestHandler> getRestHandlers(Settings settings, RestController restController, ClusterSettings clusterSettings,
        ...
        return Arrays.asList(
                ...
                new RestSetIndexPolicyAction(settings, restController),
    ...
    public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
        ...
        return Arrays.asList(
                ...
                new ActionHandler<>(SetIndexPolicyAction.INSTANCE, TransportSetIndexPolicyAction.class),

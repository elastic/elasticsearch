...
class IndicesWriteLoadTemplateRegistry extends IndexTemplateRegistry {
    public static final String ILM_POLICY_NAME = ".indices-write-load-distribution-ilm-policy";

    private static final List<LifecyclePolicy> LIFECYCLE_POLICIES = List.of(
        new LifecyclePolicyConfig(ILM_POLICY_NAME, "/indices-write-load-distribution-ilm-policy.json").load(

...
class IndicesWriteLoadStatsService extends AbstractLifecycleComponent {
    ...
    static final Setting<TimeValue> STORE_FREQUENCY_SETTING = Setting.timeSetting(
    ...
    static IndicesWriteLoadStatsService create(
    ...
    private void maybeScheduleSampling() {
        ...
        scheduledSampling = threadPool.schedule(this::collectWriteLoadSamples, samplingFrequency, WRITE_LOAD_COLLECTOR_THREAD_POOL_NAME);
    }

...
public class TransportInferenceActionProxy extends HandledTransportAction<InferenceActionProxy.Request, InferenceActionProxy.Response> {
    ...
    @Override
    protected void doExecute(Task task, InferenceActionProxy.Request request, ActionListener<InferenceActionProxy.Response> listener) {
        try {
    ...
    private void sendUnifiedCompletionRequest(InferenceActionProxy.Request request, ActionListener<InferenceActionProxy.Response> listener)
        throws IOException {
    ...
    private void sendInferenceActionRequest(InferenceActionProxy.Request request, ActionListener<InferenceActionProxy.Response> listener)
        throws IOException {

...
public class AnthropicErrorResponseEntity implements ErrorMessage {

    private final String errorMessage;

    private AnthropicErrorResponseEntity(String errorMessage) {
    ...
    public static AnthropicErrorResponseEntity fromResponse(HttpResult response) {
        try (
            ...
            if (error != null) {
                ...
                if (message != null) {
                    return new AnthropicErrorResponseEntity(message);
                }
            }
        } catch (Exception e) {
            // swallow the error

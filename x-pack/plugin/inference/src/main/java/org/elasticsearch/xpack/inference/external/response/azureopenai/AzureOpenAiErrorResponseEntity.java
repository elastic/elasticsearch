...
public class AzureOpenAiErrorResponseEntity implements ErrorMessage {

    private final String errorMessage;

    private AzureOpenAiErrorResponseEntity(String errorMessage) {
    ...
    public static AzureOpenAiErrorResponseEntity fromResponse(HttpResult response) {
        try (
            ...
            if (error != null) {
                ...
                if (message != null) {
                    return new AzureOpenAiErrorResponseEntity(message);
                }
            }
        } catch (Exception e) {
            // swallow the error

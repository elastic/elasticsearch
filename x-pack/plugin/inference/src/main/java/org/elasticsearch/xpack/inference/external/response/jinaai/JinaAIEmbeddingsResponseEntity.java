...
public class JinaAIEmbeddingsResponseEntity {
    ...
    private static final Map<String, CheckedFunction<XContentParser, InferenceServiceResults, IOException>> EMBEDDING_PARSERS = Map.of(
        ...
        JinaAIEmbeddingsResponseEntity::parseFloatEmbeddingsArray,
        toLowerCase(JinaAIEmbeddingType.INT8),
        JinaAIEmbeddingsResponseEntity::parseByteEmbeddingsArray
    );
    ...
    /**
     * //TODO(JoanFM): Edit the comments
     * Parses the Jina AI embed json response.
     * For a request like:
     *
     * <pre>
     * <code>
    ...
    private static InferenceServiceResults parseEmbeddingsObject(XContentParser parser) throws IOException {
        ...
        throw new IllegalStateException(
            Strings.format(
                "Failed to find a supported embedding type in the JinaAI embeddings response. Supported types are [%s]",
    ...
    private static InferenceServiceResults parseByteEmbeddingsArray(XContentParser parser) throws IOException {
        var embeddingList = parseList(parser, JinaAIEmbeddingsResponseEntity::parseByteArrayEntry);
    ...
    private static InferenceTextEmbeddingByteResults.InferenceByteEmbedding parseByteArrayEntry(XContentParser parser) throws IOException {
        ...
        List<Byte> embeddingValuesList = parseList(parser, JinaAIEmbeddingsResponseEntity::parseEmbeddingInt8Entry);
    ...
    private static InferenceServiceResults parseFloatEmbeddingsArray(XContentParser parser) throws IOException {
        var embeddingList = parseList(parser, JinaAIEmbeddingsResponseEntity::parseFloatArrayEntry);

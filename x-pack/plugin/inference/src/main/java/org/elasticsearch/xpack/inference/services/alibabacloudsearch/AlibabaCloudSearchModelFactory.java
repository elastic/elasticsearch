...
/**
 * Factory class for creating {@link AlibabaCloudSearchModel} instances based on task type.
 */
public class AlibabaCloudSearchModelFactory implements ModelFactory<AlibabaCloudSearchModel> {

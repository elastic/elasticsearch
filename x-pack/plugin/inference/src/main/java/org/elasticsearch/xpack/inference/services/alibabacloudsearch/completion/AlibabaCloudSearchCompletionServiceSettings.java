...
/**
 * Settings for the AlibabaCloud AI Search completion task. Wraps the {@link AlibabaCloudSearchServiceSettings} common to every
 * AlibabaCloud AI Search task; completion adds no settings of its own.
 */
public class AlibabaCloudSearchCompletionServiceSettings implements ServiceSettings {
    ...
    /**
     * Creates an {@link ObjectParser} for the AlibabaCloud AI Search completion service settings.
     *
    ...
    /**
     * Builds an {@link AlibabaCloudSearchCompletionServiceSettings} from the common AlibabaCloud AI Search fields, enforcing that the
     * required fields are present.
     */
    public static class Builder extends AlibabaCloudSearchServiceSettings.Builder<AlibabaCloudSearchCompletionServiceSettings> {

        @Override
        protected AlibabaCloudSearchCompletionServiceSettings build(AlibabaCloudSearchServiceSettings commonSettings) {
    ...
    public AlibabaCloudSearchCompletionServiceSettings(AlibabaCloudSearchServiceSettings commonSettings) {
    ...
    public AlibabaCloudSearchCompletionServiceSettings updateServiceSettings(Map<String, Object> serviceSettings) {
        try (var xParser = XContentHelper.mapToXContentParser(XContentParserConfiguration.EMPTY, serviceSettings)) {
            ...
            throw new ElasticsearchParseException("Failed to parse AlibabaCloud AI Search completion service settings update", e);
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        AlibabaCloudSearchCompletionServiceSettings that = (AlibabaCloudSearchCompletionServiceSettings) o;

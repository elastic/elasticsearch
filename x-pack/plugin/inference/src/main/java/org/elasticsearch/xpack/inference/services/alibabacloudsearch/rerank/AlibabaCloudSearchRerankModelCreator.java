...
/**
 * Creates {@link AlibabaCloudSearchRerankModel} instances from config maps
 * or {@link ModelConfigurations} and {@link ModelSecrets} objects.
 */
public class AlibabaCloudSearchRerankModelCreator implements ModelCreator<AlibabaCloudSearchRerankModel> {
    @Override
    public AlibabaCloudSearchRerankModel createFromMaps(
        String inferenceId,
        TaskType taskType,
        String service,

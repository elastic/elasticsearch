...
public class AnthropicChatCompletionResponseHandler extends AnthropicResponseHandler {
    ...
    public AnthropicChatCompletionResponseHandler(String requestType, boolean excludeReasoning) {
        this(requestType, AnthropicChatCompletionResponseEntity::fromResponse, excludeReasoning);
    }

    private AnthropicChatCompletionResponseHandler(String requestType, ResponseParser parseFunction, boolean excludeReasoning) {

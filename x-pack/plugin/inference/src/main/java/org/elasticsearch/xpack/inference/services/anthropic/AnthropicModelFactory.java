...
/**
 * Factory class for creating {@link AnthropicModel} instances based on task type.
 */
public class AnthropicModelFactory implements ModelFactory<AnthropicModel> {
    ...
    @Override
    public AnthropicModel createFromMaps(
        String inferenceId,
        TaskType taskType,
        String service,
    ...
    @Override
    public AnthropicModel createFromModelConfigurationsAndSecrets(ModelConfigurations config, ModelSecrets secrets) {

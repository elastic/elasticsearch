...
public class AzureAiStudioRerankModel extends AzureAiStudioModel {
    ...
    public static AzureAiStudioRerankModel of(AzureAiStudioModel model, Map<String, Object> taskSettings) {
        var modelAsRerankModel = (AzureAiStudioRerankModel) model;

        if (taskSettings == null || taskSettings.isEmpty()) {
            return modelAsRerankModel;
        }

        var requestTaskSettings = AzureAiStudioRerankRequestTaskSettings.fromMap(taskSettings);
        var taskSettingToUse = AzureAiStudioRerankTaskSettings.of(modelAsRerankModel.getTaskSettings(), requestTaskSettings);

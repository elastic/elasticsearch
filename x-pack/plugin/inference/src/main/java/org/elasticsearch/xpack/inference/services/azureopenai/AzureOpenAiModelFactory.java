...
import org.elasticsearch.xpack.inference.services.azureopenai.completion.AzureOpenAiCompletionModelCreator;
import org.elasticsearch.xpack.inference.services.azureopenai.embeddings.AzureOpenAiEmbeddingsModelCreator;

import java.util.Map;

/**
 * Factory class for creating {@link AzureOpenAiModel} instances based on task type.
 */
public class AzureOpenAiModelFactory implements ModelFactory<AzureOpenAiModel> {
    ...
    @Override
    public AzureOpenAiModel createFromMaps(
        String inferenceId,
        TaskType taskType,
        String service,
    ...
    @Override
    public AzureOpenAiModel createFromModelConfigurationsAndSecrets(ModelConfigurations config, ModelSecrets secrets) {

...
/**
 * HTTP request wrapper for FireworksAI rerank API calls.
 * Handles request construction, authentication, and serialization.
 */
public class FireworksAiRerankRequest implements Request {

    private static final Logger logger = LogManager.getLogger(FireworksAiRerankRequest.class);
    ...
    public FireworksAiRerankRequest(
        String query,

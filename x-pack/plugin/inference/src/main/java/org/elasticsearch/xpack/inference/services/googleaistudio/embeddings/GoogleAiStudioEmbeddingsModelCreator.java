...
/**
 * Creates {@link GoogleAiStudioEmbeddingsModel} instances from config maps
 * or {@link ModelConfigurations} and {@link ModelSecrets} objects.
 */
public class GoogleAiStudioEmbeddingsModelCreator implements ModelCreator<GoogleAiStudioEmbeddingsModel> {
    @Override

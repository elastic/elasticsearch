...
/**
 * Creates {@link GoogleVertexAiEmbeddingsModel} instances from config maps
 * or {@link ModelConfigurations} and {@link ModelSecrets} objects.
 */
public class GoogleVertexAiEmbeddingsModelCreator implements ModelCreator<GoogleVertexAiEmbeddingsModel> {
    @Override

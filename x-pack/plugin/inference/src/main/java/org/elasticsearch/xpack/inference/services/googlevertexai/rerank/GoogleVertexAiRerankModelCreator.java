...
/**
 * Creates {@link GoogleVertexAiRerankModel} instances from config maps
 * or {@link ModelConfigurations} and {@link ModelSecrets} objects.
 */
public class GoogleVertexAiRerankModelCreator implements ModelCreator<GoogleVertexAiRerankModel> {
    @Override
    public GoogleVertexAiRerankModel createFromMaps(
        ...
        return new GoogleVertexAiRerankModel(inferenceId, taskType, service, serviceSettings, taskSettings, secretSettings, context);
    }

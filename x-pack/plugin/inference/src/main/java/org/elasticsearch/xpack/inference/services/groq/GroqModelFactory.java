...
/**
 * Factory class for creating {@link GroqModel} instances based on task type.
 */
public class GroqModelFactory implements ModelFactory<GroqModel> {
    ...
    @Override
    public GroqModel createFromMaps(
        String inferenceId,
        TaskType taskType,
        String service,
    ...
    @Override
    public GroqModel createFromModelConfigurationsAndSecrets(ModelConfigurations config, ModelSecrets secrets) {

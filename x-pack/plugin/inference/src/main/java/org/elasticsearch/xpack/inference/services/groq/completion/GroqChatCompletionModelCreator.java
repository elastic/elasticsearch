...
/**
 * Creates {@link GroqChatCompletionModel} instances from config maps
 * or {@link ModelConfigurations} and {@link ModelSecrets} objects.
 */
public class GroqChatCompletionModelCreator implements ModelCreator<GroqChatCompletionModel> {
    @Override
    public GroqChatCompletionModel createFromMaps(
        ...
        return new GroqChatCompletionModel(inferenceId, taskType, service, serviceSettings, taskSettings, secretSettings, context);
    }

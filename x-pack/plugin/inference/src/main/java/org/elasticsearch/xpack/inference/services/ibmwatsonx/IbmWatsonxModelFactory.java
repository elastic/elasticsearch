...
/**
 * Factory class for creating {@link IbmWatsonxModel} instances based on task type.
 */
public class IbmWatsonxModelFactory implements ModelFactory<IbmWatsonxModel> {
    ...
    @Override
    public IbmWatsonxModel createFromMaps(
        String inferenceId,
        TaskType taskType,
        String service,
    ...
    @Override
    public IbmWatsonxModel createFromModelConfigurationsAndSecrets(ModelConfigurations config, ModelSecrets secrets) {

...
public class IbmWatsonxServiceSettings extends FilteredXContentObject implements ServiceSettings, IbmWatsonxRateLimitServiceSettings {

    public static final String NAME = "ibm_watsonx_service_settings";
    public static final String OLD_MODEL_ID_FIELD = "model";
    public static final String MODEL_ID = "model_id";
    private static final Logger logger = LogManager.getLogger(IbmWatsonxServiceSettings.class);
    public static final RateLimitSettings DEFAULT_RATE_LIMIT_SETTINGS = new RateLimitSettings(10_000);

    public static IbmWatsonxServiceSettings fromMap(Map<String, Object> map, ConfigurationParseContext context) {
        ...
        if (context == ConfigurationParseContext.REQUEST && oldModelId != null) {
            logger.info("The ibm watsonx [service_settings.model] field is deprecated. Please use [service_settings.model_id] instead.");
        }
        ...
        return new IbmWatsonxServiceSettings(uri, similarity, dims, maxInputTokens, modelId(oldModelId, modelId), rateLimitSettings);
    }
    ...
    public IbmWatsonxServiceSettings(
        @Nullable URI uri,
    ...
    public IbmWatsonxServiceSettings(StreamInput in) throws IOException {

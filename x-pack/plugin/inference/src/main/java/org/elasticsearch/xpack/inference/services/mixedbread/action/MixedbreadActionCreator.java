...
public class MixedbreadActionCreator implements MixedbreadActionVisitor {
    private static final ResponseHandler EMBEDDINGS_HANDLER = new MixedbreadEmbeddingsResponseHandler(
        MixedbreadUtils.EMBEDDINGS_REQUEST_TYPE,
    ...
    @Override
    public ExecutableAction create(MixedbreadEmbeddingsModel model, Map<String, Object> taskSettings) {
        var overriddenModel = MixedbreadEmbeddingsModel.of(model, taskSettings);
    ...
    public ExecutableAction create(MixedbreadRerankModel model, Map<String, Object> taskSettings) {
        ...
        var errorMessage = constructFailedToSendRequestMessage(MixedbreadUtils.RERANK_ERROR_PREFIX);
        return new SenderExecutableAction(sender, manager, errorMessage);
    }
}

...
import org.elasticsearch.xpack.inference.services.mixedbread.embeddings.MixedbreadEmbeddingsResponseHandler;
import org.elasticsearch.xpack.inference.services.mixedbread.request.MixedbreadEmbeddingsRequest;
...
import org.elasticsearch.xpack.inference.services.mixedbread.response.MixedbreadEmbeddingsResponseEntity;
...
public class MixedbreadActionCreator implements MixedbreadVisitor {
    ...
    private static final ResponseHandler EMBEDDINGS_HANDLER = new MixedbreadEmbeddingsResponseHandler(
        "mixedbread text embedding",
        MixedbreadEmbeddingsResponseEntity::fromResponse
    );
    ...
    private static final ResponseHandler RERANK_HANDLER = new MixedbreadRerankResponseHandler("mixedbread rerank", (request, response) -> {
        ...
        return MixedbreadRerankResponseEntity.fromResponse((MixedbreadRerankRequest) request, response);
    });
    ...
    @Override
    public ExecutableAction create(MixedbreadEmbeddingsModel model) {

 ...
 * {@link MixedbreadEmbeddingsModel} and {@link MixedbreadRerankModel}.
 */
public interface MixedbreadActionVisitor {
    /**
     * Creates an {@link ExecutableAction} for the given {@link MixedbreadEmbeddingsModel}.
     *
     ...
     */
    ExecutableAction create(MixedbreadEmbeddingsModel model, Map<String, Object> taskSettings);

    /**
     * Creates an {@link ExecutableAction} for the given {@link MixedbreadRerankModel}.
     *
     * @param model The model to create the action for.
     * @param taskSettings the task settings for the rerank model
     * @return An {@link ExecutableAction} for the given model.
     */

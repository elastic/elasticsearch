...
public interface MixedbreadVisitor {
    ExecutableAction create(MixedbreadEmbeddingsModel embeddingsModel);

    ExecutableAction create(MixedbreadRerankModel rerankModel, Map<String, Object> taskSettings);
}

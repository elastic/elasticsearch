...
import static org.elasticsearch.xpack.inference.services.mixedbread.request.MixedbreadEmbeddingsRequestEntity.MODEL_FIELD;
...
public record MixedbreadRerankRequestEntity(
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        } else if (taskSettings.topK() != null) {

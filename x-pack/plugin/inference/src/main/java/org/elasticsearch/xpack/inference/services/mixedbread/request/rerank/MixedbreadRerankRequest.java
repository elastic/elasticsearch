 ...
 * This class is responsible for creating a request to the Mixedbread rerank endpoint.
...
public class MixedbreadRerankRequest implements Request {
    ...
    /**
     * Constructor for creating a {@link MixedbreadRerankRequest} with specified parameters.
     *
     ...
     * @param model the Mixedbread rerank model configuration
     */

...
/**
 * Abstract base for OpenAI model creators, providing shared {@link ThreadPool} and {@link TokenCache} dependencies.
 */
public abstract class OpenAiModelCreator<M extends OpenAiModel> implements ModelCreator<M> {
    ...
    protected OpenAiModelCreator(ThreadPool threadPool, TokenCache tokenCache) {

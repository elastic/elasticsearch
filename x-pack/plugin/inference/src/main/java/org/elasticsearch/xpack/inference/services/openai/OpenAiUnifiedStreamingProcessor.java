...
public class OpenAiUnifiedStreamingProcessor extends DelegatingProcessor<
    ...
    public static Stream<UnifiedChatCompletionResults> parse(XContentParserConfiguration parserConfig, ServerSentEvent event)
        throws IOException {
    ...
    public static Stream<UnifiedChatCompletionResults> parse(XContentParserConfiguration parserConfig, String data) throws IOException {

...
public class TencentCloudChatCompletionRequestManager extends BaseRequestManager {
    ...
    private static final Logger logger = LogManager.getLogger(TencentCloudChatCompletionRequestManager.class);

    private static final ResponseHandler CHAT_COMPLETION = new OpenAiUnifiedChatCompletionResponseHandler(
        "tencentcloud chat completion",
        OpenAiChatCompletionResponseEntity::fromResponse
    );

    private static final ResponseHandler COMPLETION = new OpenAiChatCompletionResponseHandler(
    ...
    public TencentCloudChatCompletionRequestManager(TencentCloudChatCompletionModel model, ThreadPool threadPool) {
    ...
    private void execute(
        ...
        var request = new TencentCloudChatCompletionRequest(inferenceInputs, model);
    ...
    private void execute(
        ...
        var request = new TencentCloudChatCompletionRequest(unifiedInputs, model);

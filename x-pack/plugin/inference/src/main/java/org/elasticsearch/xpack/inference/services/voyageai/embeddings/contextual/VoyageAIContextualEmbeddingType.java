...
/**
 * Defines the type of embedding that the VoyageAI contextualized embeddings API should return for a request.
 *
 * <p>
 * <a href="https://docs.voyageai.com/reference/contextualized-embeddings-api">See api docs for details.</a>
 * </p>
 */
public enum VoyageAIContextualEmbeddingType {
    /**
    ...
    private static final Map<DenseVectorFieldMapper.ElementType, VoyageAIContextualEmbeddingType> ELEMENT_TYPE_TO_VOYAGE_EMBEDDING = Map.of(
    ...
    VoyageAIContextualEmbeddingType(DenseVectorFieldMapper.ElementType elementType, String requestString) {
    ...
    public static String toLowerCase(VoyageAIContextualEmbeddingType type) {
        return type.toString().toLowerCase(Locale.ROOT);
    }

    public static VoyageAIContextualEmbeddingType fromString(String name) {
        return valueOf(name.trim().toUpperCase(Locale.ROOT));
    }

    public static VoyageAIContextualEmbeddingType fromElementType(DenseVectorFieldMapper.ElementType elementType) {
        ...
        if (embedding == null) {
            ...
            throw new IllegalArgumentException(
                Strings.format(
                    "Element type [%s] does not map to a VoyageAI contextualized embedding value, must be one of [%s]",
                    elementType,

 ...
 * </p>
 */
public enum VoyageAIMultimodalEmbeddingType {
    /**
    ...
    private static final Map<DenseVectorFieldMapper.ElementType, VoyageAIMultimodalEmbeddingType> ELEMENT_TYPE_TO_VOYAGE_EMBEDDING = Map.of(
    ...
    VoyageAIMultimodalEmbeddingType(DenseVectorFieldMapper.ElementType elementType, String requestString) {
    ...
    public static String toLowerCase(VoyageAIMultimodalEmbeddingType type) {
        return type.toString().toLowerCase(Locale.ROOT);
    }

    public static VoyageAIMultimodalEmbeddingType fromString(String name) {
        return valueOf(name.trim().toUpperCase(Locale.ROOT));
    }

    public static VoyageAIMultimodalEmbeddingType fromElementType(DenseVectorFieldMapper.ElementType elementType) {

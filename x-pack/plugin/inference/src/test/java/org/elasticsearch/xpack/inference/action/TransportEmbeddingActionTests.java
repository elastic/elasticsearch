...
public class TransportEmbeddingActionTests extends BaseTransportInferenceActionTestCase<EmbeddingAction.Request> {
    ...
    @Override
    protected BaseTransportInferenceAction<EmbeddingAction.Request> createAction(
    ...
    @Override
    protected EmbeddingAction.Request createRequest() {
        return mock(EmbeddingAction.Request.class);
    }
    ...
    public void testMetricsAfterEmbeddingSuccess_withRequestTaskTypeAny() {
        mockInferenceEndpointRegistry(TaskType.EMBEDDING);

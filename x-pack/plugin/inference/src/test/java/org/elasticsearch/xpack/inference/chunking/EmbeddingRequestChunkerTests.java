...
public class EmbeddingRequestChunkerTests extends ESTestCase {
    ...
    public void testManyInputsMakeManyBatches() {
        ...
        assertThat(
            ChunkInferenceInput.convertToStrings(batches.get(1).batch().inputs()),
        ...
        assertThat(ChunkInferenceInput.convertToStrings(batches.get(3).batch().inputs()), contains("input 30"));

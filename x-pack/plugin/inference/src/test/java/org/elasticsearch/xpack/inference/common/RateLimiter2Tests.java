...
public abstract class RateLimiter2Tests extends ESTestCase {
    ...
    public void testMethod_First_CallDoesNotSleep() throws InterruptedException {
        ...
        validationMethod(res, sleeper, 1, 0);
    }
    ...
    public void testMethod_AcceptsMaxIntValue_WhenTokenRateIsLow() throws InterruptedException {
        ...
        validationMethod(res, sleeper, 1, (long) ((double) Integer.MAX_VALUE / tokensPerMicro));
    }

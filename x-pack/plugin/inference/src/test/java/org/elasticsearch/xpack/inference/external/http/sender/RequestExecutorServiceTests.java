...
public class RequestExecutorServiceTests extends ESTestCase {
    ...
    public void testQueueSize_IsOne() {
        var service = createRequestExecutorServiceWithMocks();
        service.execute(RequestManagerTests.createMock(), new EmbeddingsInput(List.of(), null), null, new PlainActionFuture<>());
    ...
    public void testExecute_CallsOnFailure_WhenRequestTimesOut() {
        ...
        var listener = new PlainActionFuture<InferenceServiceResults>();
        service.execute(RequestManagerTests.createMock(), new EmbeddingsInput(List.of(), null), TimeValue.timeValueNanos(1), listener);
    ...
    public void testExecute_PreservesThreadContext() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        service.execute(RequestManagerTests.createMock(requestSender), new EmbeddingsInput(List.of(), null), null, listener);
    ...
    public void testChangingCapacity_ToZero_SetsQueueCapacityToUnbounded() throws IOException, ExecutionException, InterruptedException,
        ...
        service.execute(requestManager, new EmbeddingsInput(List.of(), null), null, new PlainActionFuture<>());
        assertThat(service.queueSize(), is(1));

        PlainActionFuture<InferenceServiceResults> listener = new PlainActionFuture<>();
        service.execute(RequestManagerTests.createMock(requestSender, "id"), new EmbeddingsInput(List.of(), null), null, listener);
    ...
    public void testRemovesRateLimitGroup_AfterStaleDuration() {
        ...
        service.execute(requestManager2, new EmbeddingsInput(List.of(), null), null, listener);

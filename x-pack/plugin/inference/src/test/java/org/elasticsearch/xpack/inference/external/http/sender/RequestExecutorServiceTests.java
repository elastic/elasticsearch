...
public class RequestExecutorServiceTests extends ESTestCase {
    ...
    public void testWhenInflightRequestSemaphoreAllowsOnlyOneRequest_ThrowsOnSecondOne() throws ExecutionException, InterruptedException,
        TimeoutException {
        ...
        var thrownException = expectThrows(EsRejectedExecutionException.class, () -> listener.actionGet(TIMEOUT));
        assertThat(thrownException.getMessage(), is("Failed to process task for inference id [id]. Too many in flight inference requests"));

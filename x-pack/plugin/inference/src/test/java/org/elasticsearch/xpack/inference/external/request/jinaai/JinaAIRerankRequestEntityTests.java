...
import java.io.IOException;
 ...
 public class JinaAIRerankRequestEntityTests extends ESTestCase {
     ...
     public void testXContent_SingleRequest_WritesModelAndTopNIfDefined_ReturnDocuments() throws IOException {
     ...
     public void testXContent_MultipleRequests_WritesModelAndTopNIfDefined() throws IOException {
         var entity = new JinaAIRerankRequestEntity("query", List.of("abc", "def"), new JinaAIRerankTaskSettings(8, false), "model");

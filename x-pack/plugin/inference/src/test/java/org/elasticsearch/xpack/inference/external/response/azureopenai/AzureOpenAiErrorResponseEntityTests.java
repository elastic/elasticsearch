...
public class AzureOpenAiErrorResponseEntityTests extends ESTestCase {
    public void testFromResponse() {
        ...
        AzureOpenAiErrorResponseEntity errorMessage = AzureOpenAiErrorResponseEntity.fromResponse(

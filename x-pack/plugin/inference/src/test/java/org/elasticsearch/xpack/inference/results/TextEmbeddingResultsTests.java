...
public class TextEmbeddingResultsTests extends AbstractWireSerializingTestCase<TextEmbeddingFloatResults> {
    public static TextEmbeddingFloatResults createRandomResults() {
        ...
        List<TextEmbeddingFloatResults.FloatEmbedding> embeddingResults = new ArrayList<>(embeddings);
    ...
    private static TextEmbeddingFloatResults.FloatEmbedding createRandomEmbedding() {
        ...
        return new TextEmbeddingFloatResults.FloatEmbedding(floats);
    }

    public void testToXContent_CreatesTheRightFormatForASingleEmbedding() throws IOException {
        var entity = new TextEmbeddingFloatResults(List.of(new TextEmbeddingFloatResults.FloatEmbedding(new float[] { 0.1F })));
    ...
    public void testToXContent_CreatesTheRightFormatForMultipleEmbeddings() throws IOException {
        var entity = new TextEmbeddingFloatResults(
            List.of(
                new TextEmbeddingFloatResults.FloatEmbedding(new float[] { 0.1F }),
                new TextEmbeddingFloatResults.FloatEmbedding(new float[] { 0.2F })
            )
    ...
    public void testTransformToCoordinationFormat() {
        var results = new TextEmbeddingFloatResults(
            List.of(
                new TextEmbeddingFloatResults.FloatEmbedding(new float[] { 0.1F, 0.2F }),
                new TextEmbeddingFloatResults.FloatEmbedding(new float[] { 0.3F, 0.4F })
            )
    ...
    protected TextEmbeddingFloatResults mutateInstance(TextEmbeddingFloatResults instance) throws IOException {
        ...
        if (randomBoolean()) {
            ...
            List<TextEmbeddingFloatResults.FloatEmbedding> embeddings = new ArrayList<>(instance.embeddings());
    ...
    public static Map<String, Object> buildExpectationFloat(List<float[]> embeddings) {
        return Map.of(
            TextEmbeddingFloatResults.TEXT_EMBEDDING,
            embeddings.stream().map(TextEmbeddingFloatResults.FloatEmbedding::new).toList()
        );
    }

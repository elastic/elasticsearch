...
public class AlibabaCloudSearchServiceSettingsTests extends AbstractBWCWireSerializationTestCase<AlibabaCloudSearchServiceSettings> {
    ...
    public void testUpdateServiceSettings_AllFields_Success() {
        var serviceSettings = new AlibabaCloudSearchServiceSettings(
    ...
    public void testUpdateServiceSettings_EmptyMap_Success() throws URISyntaxException {
        var serviceSettings = new AlibabaCloudSearchServiceSettings(
            INITIAL_TEST_SERVICE_ID,
            INITIAL_TEST_HOST,
            INITIAL_TEST_WORKSPACE_NAME,
    ...
    public void testFromMap_Success() throws URISyntaxException {

...
public class AzureOpenAiServiceTests extends InferenceServiceTestCase {
    ...
    public void testParseRequestConfig_CreatesAnOpenAiEmbeddingsModel() throws IOException {
        try (var service = createAzureOpenAiService()) {
            ...
            service.parseRequestConfig(
                ...
                getRequestConfigMap(
                    AzureOpenAiEmbeddingsServiceSettingsTests.createEmbeddingsServiceSettingsMap(
                        RESOURCE_NAME_VALUE,
                        DEPLOYMENT_ID_VALUE,
                        API_VERSION_VALUE,
                        null,
    ...
    public void testParseRequestConfig_ThrowsWhenAnExtraKeyExistsInServiceSettingsMap() throws IOException {
        try (var service = createAzureOpenAiService()) {
            var serviceSettings = AzureOpenAiEmbeddingsServiceSettingsTests.createEmbeddingsServiceSettingsMap(
                RESOURCE_NAME_VALUE,
                DEPLOYMENT_ID_VALUE,
                API_VERSION_VALUE,
                null,
    ...
    public void testParsePersistedConfigWithSecrets_NotThrowWhenAnExtraKeyExistsInServiceSettings() throws IOException {
        try (var service = createAzureOpenAiService()) {
            var serviceSettingsMap = AzureOpenAiEmbeddingsServiceSettingsTests.createEmbeddingsServiceSettingsMap(
                RESOURCE_NAME_VALUE,
                DEPLOYMENT_ID_VALUE,
                API_VERSION_VALUE,
                100,

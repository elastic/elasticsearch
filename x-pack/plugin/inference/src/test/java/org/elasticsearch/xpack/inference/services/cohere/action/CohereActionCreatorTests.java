...
public class CohereActionCreatorTests extends ESTestCase {
    ...
    public void testCreate_CohereEmbeddingsModel() throws IOException {
        ...
        try (var sender = createSender(senderFactory)) {
            ...
            var overriddenTaskSettings = CohereEmbeddingsTaskSettingsTests.getTaskSettingsMap(InputType.SEARCH, Truncation.END);
    ...
    public void testCreate_CohereCompletionModel_WithModelSpecified() throws IOException {
        ...
        try (var sender = createSender(senderFactory)) {
            ...
            assertNull(webServer.requests().get(0).getUri().getQuery());
            assertThat(webServer.requests().get(0).getHeader(HttpHeaders.CONTENT_TYPE), is("application/json; charset=UTF-8"));

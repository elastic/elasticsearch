...
public class ElasticInferenceServiceChatCompletionModelTests extends ESTestCase {

    public void testOverridingModelId() {
        var originalModel = new ElasticInferenceServiceChatCompletionModel(
            "id",
            TaskType.COMPLETION,
            "elastic",
        ...
        var overriddenModel = ElasticInferenceServiceChatCompletionModel.of(originalModel, request);

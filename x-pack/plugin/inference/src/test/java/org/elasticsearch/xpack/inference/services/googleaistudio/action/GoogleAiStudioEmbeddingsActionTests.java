...
package org.elasticsearch.xpack.inference.services.googleaistudio.action;
...
public class GoogleAiStudioEmbeddingsActionTests extends ESTestCase {
    ...
    public void testExecute_ThrowsElasticsearchException_WhenSenderOnFailureIsCalled() {
        ...
        assertThat(thrownException.getMessage(), is("Failed to send Google AI Studio embeddings request. Cause: failed"));
    }
    ...
    private ExecutableAction createAction(String url, String apiKey, String modelName, Sender sender) {
        ...
        var requestManager = new GenericRequestManager<>(
            threadPool,
            model,
            GoogleAiStudioService.EMBEDDING_HANDLER,
        ...
        return new SenderExecutableAction(sender, requestManager, constructFailedToSendRequestMessage("Google AI Studio embeddings"));
    }

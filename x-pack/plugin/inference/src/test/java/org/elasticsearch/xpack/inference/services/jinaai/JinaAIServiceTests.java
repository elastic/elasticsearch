...
public class JinaAIServiceTests extends ESTestCase {
    ...
    public void testInfer_ThrowsErrorWhenModelIsNotJinaAIModel() throws IOException {
        ...
        try (var service = new JinaAIService(factory, createWithEmptySettings(threadPool), clusterService)) {
    ...
    private void testUpdateModelWithEmbeddingDetails_Successful(SimilarityMeasure similarityMeasure) throws IOException {
        ...
        try (var service = new JinaAIService(senderFactory, createWithEmptySettings(threadPool), clusterService)) {
    ...
    public void testDoesNotSupportsStreaming() throws IOException {
        try (var service = new JinaAIService(mock(), createWithEmptySettings(mock()),clusterService)) {
    ...
    private JinaAIService createJinaAIService() {
        return new JinaAIService(mock(HttpRequestSender.Factory.class), createWithEmptySettings(threadPool), clusterService);
    }

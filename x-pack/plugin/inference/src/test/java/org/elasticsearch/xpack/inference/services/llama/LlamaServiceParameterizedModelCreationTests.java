...
public class LlamaServiceParameterizedModelCreationTests extends AbstractInferenceServiceParameterizedModelCreationTests {
    public LlamaServiceParameterizedModelCreationTests(TestCase testCase) {

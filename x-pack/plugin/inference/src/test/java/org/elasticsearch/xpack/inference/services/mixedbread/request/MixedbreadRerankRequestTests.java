...
public class MixedbreadRerankRequestTests extends ESTestCase {
    ...
    public void testCreateRequest_WithAllFieldsSet() throws IOException {
        var request = createRequest(QUERY, INPUT, MODEL, TOP_K, TestUtils.RETURN_DOCUMENTS_FALSE);
        ...
        assertThat(requestMap.get("return_input"), is(TestUtils.RETURN_DOCUMENTS_FALSE));
        assertThat(requestMap.get("model"), is(MODEL));
    }
    ...
    private static MixedbreadRerankRequest createRequest(
        ...
        var rerankModel = MixedbreadRerankModelTests.createModel(modelId, TestUtils.API_KEY, null, null, null);

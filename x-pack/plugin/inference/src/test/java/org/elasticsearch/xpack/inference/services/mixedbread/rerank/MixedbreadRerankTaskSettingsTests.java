...
public class MixedbreadRerankTaskSettingsTests extends AbstractWireSerializingTestCase<MixedbreadRerankTaskSettings> {
    ...
    public void testUpdatedTaskSettings_WithEmptyMap_ReturnsSameSettings() {
        var initialSettings = new MixedbreadRerankTaskSettings(TOP_N, TestUtils.RETURN_DOCUMENTS_TRUE);
    ...
    public void testUpdatedTaskSettings_WithNewReturnDocuments_ReturnsUpdatedSettings() {
        var initialSettings = new MixedbreadRerankTaskSettings(TOP_N, TestUtils.RETURN_DOCUMENTS_TRUE);
        Map<String, Object> newSettings = Map.of(MixedbreadRerankTaskSettings.RETURN_DOCUMENTS, TestUtils.RETURN_DOCUMENTS_FALSE);
    ...
    public static Map<String, Object> getTaskSettingsMap(@Nullable Integer topN, @Nullable Boolean returnDocuments) {

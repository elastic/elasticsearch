...
public class NvidiaChatCompletionServiceSettingsTests extends AbstractBWCWireSerializationTestCase<NvidiaChatCompletionServiceSettings> {
    ...
    private static final URI DEFAULT_URI = URI.create("https://integrate.api.nvidia.com/v1/chat/completions");
    ...
    public void testFromMap_AllFields_CreatesSettingsCorrectly() {
        ...
        assertThat(
            serviceSettings,
            is(new NvidiaChatCompletionServiceSettings(TEST_MODEL_ID, TEST_URI, new RateLimitSettings(TEST_RATE_LIMIT)))
        );
    }
    ...
    public void testFromMap_OnlyMandatoryFields_UsesDefaultValues_Success() {
        ...
        assertThat(
            serviceSettings,
            is(new NvidiaChatCompletionServiceSettings(TEST_MODEL_ID, DEFAULT_URI, new RateLimitSettings(DEFAULT_RATE_LIMIT)))
        );
    }
    ...
    public void testUpdateServiceSettings_AllFields_OnlyMutableFieldsAreUpdated() {
        ...
        var originalServiceSettings = new NvidiaChatCompletionServiceSettings(
        ...
        assertThat(
            ...
            is(new NvidiaChatCompletionServiceSettings(INITIAL_TEST_MODEL_ID, INITIAL_TEST_URI, new RateLimitSettings(TEST_RATE_LIMIT)))
        );
    }
    ...
    public void testToXContent_WritesAllValues() throws IOException {
        var serviceSettings = new NvidiaChatCompletionServiceSettings(TEST_MODEL_ID, TEST_URI, new RateLimitSettings(TEST_RATE_LIMIT));

...
public class OpenShiftAiServiceBuildModelFromConfigAndSecretsTests extends AbstractBuildModelFromConfigAndSecretsTests {
    public OpenShiftAiServiceBuildModelFromConfigAndSecretsTests(TestCase testCase) {

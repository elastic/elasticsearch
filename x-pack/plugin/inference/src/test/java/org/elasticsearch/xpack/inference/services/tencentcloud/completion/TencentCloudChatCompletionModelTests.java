...
public class TencentCloudChatCompletionModelTests extends ESTestCase {
    ...
    public void testUri_UsesDefaultRegion() {
        var model = createModel(new TencentCloudChatCompletionServiceSettings("deepseek-v3", null, new RateLimitSettings(5)));
    ...
    public void testUri_UsesCustomRegion() {
        var model = createModel(new TencentCloudChatCompletionServiceSettings("deepseek-v3", "sh", new RateLimitSettings(5)));
    ...
    public void testModelIdAccessor() {
        var model = createModel(new TencentCloudChatCompletionServiceSettings("deepseek-r1", null, new RateLimitSettings(5)));
        assertThat(model.model(), is("deepseek-r1"));
        assertThat(model.getTaskType(), is(TaskType.CHAT_COMPLETION));
    }

    private static TencentCloudChatCompletionModel createModel(TencentCloudChatCompletionServiceSettings commonSettings) {

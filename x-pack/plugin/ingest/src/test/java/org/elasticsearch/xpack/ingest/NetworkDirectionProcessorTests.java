...
public class NetworkDirectionProcessorTests extends ESTestCase {
    ...
    public void testNoSource() throws Exception {
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> testNetworkDirectionProcessor(buildEvent(null), new String[]{"10.0.0.0/8"}));
        assertThat(e.getMessage(), containsString("unable to calculate network direction from document"));
    }

    public void testNoDestination() throws Exception {
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> testNetworkDirectionProcessor(buildEvent("192.168.1.1", null), new String[]{"10.0.0.0/8"}));
        assertThat(e.getMessage(), containsString("unable to calculate network direction from document"));
    }
    ...
    public void testInvalidSource() throws Exception {
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> testNetworkDirectionProcessor(buildEvent("invalid"), new String[]{"10.0.0.0/8"}));
        assertThat(e.getMessage(), containsString("'invalid' is not an IP string literal."));
    }

    public void testInvalidDestination() throws Exception {
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> testNetworkDirectionProcessor(buildEvent("192.168.1.1", "invalid"), new String[]{"10.0.0.0/8"}));
        assertThat(e.getMessage(), containsString("'invalid' is not an IP string literal."));
    }

    public void testInvalidNetwork() throws Exception {
        IllegalArgumentException e = expectThrows(IllegalArgumentException.class, () -> testNetworkDirectionProcessor(buildEvent("192.168.1.1", "192.168.1.1"), new String[]{"10.0.0.0/8", "invalid"}));
        assertThat(e.getMessage(), containsString("'invalid' is not an IP string literal."));
    }
    ...
    private void testNetworkDirectionProcessor(Map<String, Object> source, String[] internalNetworks, String expectedDirection) throws Exception {
        testNetworkDirectionProcessor(source, internalNetworks, expectedDirection, false);
    }

    private void testNetworkDirectionProcessor(Map<String, Object> source, String[] internalNetworks, String expectedDirection, boolean ignoreMissing)
        throws Exception {

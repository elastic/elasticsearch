...
/**
 * This class provides an empty implementation of {@link KqlBaseParserVisitor},
...
public class KqlBaseParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements KqlBaseParserVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitDefault(KqlBaseParser.DefaultContext ctx) { return visitChildren(ctx); }
}
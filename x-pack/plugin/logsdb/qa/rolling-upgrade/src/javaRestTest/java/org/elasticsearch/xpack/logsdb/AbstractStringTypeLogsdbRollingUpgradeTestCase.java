...
import static org.elasticsearch.xpack.logsdb.LogsdbIndexingRollingUpgradeIT.formatInstant;
...
public abstract class AbstractStringTypeLogsdbRollingUpgradeTestCase extends AbstractLogsdbRollingUpgradeTestCase {
    ...
    public void testIndexing() throws Exception {
        ...
        String firstBackingIndex = LogsdbIndexingRollingUpgradeIT.getWriteBackingIndex(client(), dataStreamName, 0);
    ...
    private void query() throws Exception {
        ...
        // verify values
        // for simplicity we only verify that these are not null, actual value matching is done by the search request

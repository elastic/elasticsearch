...
public class MatchOnlyTextLogsEnabledAfterUpgradeRollingUpgradeIT extends AbstractStringTypeLogsEnabledAfterUpgradeTestCase {

    public MatchOnlyTextLogsEnabledAfterUpgradeRollingUpgradeIT(String template, String testScenario) {

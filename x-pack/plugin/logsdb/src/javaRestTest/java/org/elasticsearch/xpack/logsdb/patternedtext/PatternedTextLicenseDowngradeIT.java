...
public class PatternedTextLicenseDowngradeIT extends DataStreamLicenseChangeTestCase {
    ...
    public void testLicenseDowngrade() throws IOException {
        ...
        {
            assertEquals("false", getSetting(client(), backingIndex0, "index.mapping.patterned_text_fallback_to_match_only_text"));
        ...
        {
            assertEquals("true", getSetting(client(), backingIndex1, "index.mapping.patterned_text_fallback_to_match_only_text"));

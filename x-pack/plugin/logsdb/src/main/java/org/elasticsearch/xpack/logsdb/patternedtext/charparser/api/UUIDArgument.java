...
public final class UUIDArgument extends ByteEncodedArgument {
    ...
    public UUIDArgument(String s, int startPosition, int length) {
        super(startPosition, length, 16);
        if (length == 36) {
            // UUID in standard format (e.g., "123e4567-e89b-12d3-a456-426614174000")
            UUID uuid = UUID.fromString(s.substring(startPosition, startPosition + length));

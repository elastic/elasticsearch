...
public class ConstantKeywordFieldMapperTests extends MapperTestCase {
    ...
    // Re-enable once ConstantKeywordFieldMapper supports columnar parsing.
    // public void testBatchParseAddsSyntheticSourceMarker() throws IOException {
    // MapperService ms = createSytheticSourceMapperService(fieldMapping(b -> b.field("type", "constant_keyword").field("value",
    // "foo")));
    ...
    // alongside them once ConstantKeywordFieldMapper supports columnar parsing.

...
public class InternalExponentialHistogram extends InternalMultiBucketAggregation<
    InternalExponentialHistogram,
    InternalExponentialHistogram.Bucket> implements Histogram, HistogramFactory {
    ...
    public static class Bucket extends InternalMultiBucketAggregation.InternalBucket implements Histogram.Bucket, KeyComparable<Bucket> {
        ...
        @Override
        public boolean equals(Object obj) {
            if (obj == null || obj.getClass() != InternalExponentialHistogram.Bucket.class) {
                return false;
            }
            InternalExponentialHistogram.Bucket that = (InternalExponentialHistogram.Bucket) obj;
        ...
        @Override
        public int compareKey(InternalExponentialHistogram.Bucket other) {
    ...
    @Override
    public InternalExponentialHistogram create(List<Bucket> buckets) {
        return new InternalExponentialHistogram(name, buckets, emptyBucketInfo, maxBuckets, currentScale, format, metadata);
    }
    ...
    public List<Bucket> reduceBuckets(List<InternalAggregation> aggregations, AggregationReduceContext reduceContext) {
        ...
        for (InternalAggregation aggregation : aggregations) {
            InternalExponentialHistogram histogram = (InternalExponentialHistogram) aggregation;

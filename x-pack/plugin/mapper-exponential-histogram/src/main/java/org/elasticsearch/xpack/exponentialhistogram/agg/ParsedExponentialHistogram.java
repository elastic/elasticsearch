...
public class ParsedExponentialHistogram extends ParsedMultiBucketAggregation<ParsedExponentialHistogram.ParsedBucket>
    implements
        Histogram {
    ...
    private static final ObjectParser<ParsedExponentialHistogram, Void> PARSER = new ObjectParser<>(
        ParsedExponentialHistogram.class.getSimpleName(),
        true,
        ParsedExponentialHistogram::new
    );
    static {
    ...
    public static ParsedExponentialHistogram fromXContent(XContentParser parser, String name) throws IOException {
        ParsedExponentialHistogram aggregation = PARSER.parse(parser, null);

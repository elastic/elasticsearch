...
public class UnsignedLongFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testTermQueryOnDocValuesOnlyFieldUsesDocValues() {
        ...
        assertEquals(
            SortedNumericDocValuesRangeQuery.newRangeQuery("my_unsigned_long", -9223372036854775808L, -9223372036854775808L),
            ft.termQuery(0, MOCK_CONTEXT)
        );
        assertEquals(
            SortedNumericDocValuesRangeQuery.newRangeQuery("my_unsigned_long", 9223372036854775807L, 9223372036854775807L),
    ...
    public void testRangeQueryOnDocValuesOnlyFieldUsesDocValues() {
        ...
        assertEquals(
            SortedNumericDocValuesRangeQuery.newRangeQuery("my_unsigned_long", -9223372036854775808L, 9223372036854775807L),

...
public class ReindexDataStreamAction extends ActionType<ReindexDataStreamAction.ReindexDataStreamResponse> {
     ...
     */
    public static Predicate<Index> getOldIndexVersionPredicate(ProjectMetadata project) {
        return index -> project.index(index).getCreationVersion().onOrBefore(MINIMUM_WRITEABLE_VERSION_AFTER_UPGRADE);
    }

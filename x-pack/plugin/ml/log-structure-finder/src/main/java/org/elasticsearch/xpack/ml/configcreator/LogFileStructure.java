...
/**
 * Stores the log file format determined by a {@link LogFileStructureFinder}.
 */
public class LogFileStructure implements ToXContentObject {
    ...
    public boolean equals(Object other) {
        ...
        LogFileStructure that = (LogFileStructure) other;

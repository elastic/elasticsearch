...
public class SemiColonSeparatedValuesLogFileStructureFinderFactoryTests extends LogFileStructureTestCase {

    private LogFileStructureFinderFactory factory = new SemiColonSeparatedValuesLogFileStructureFinderFactory();

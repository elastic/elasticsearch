...
public class LogFileStructureTests extends AbstractXContentTestCase<LogFileStructure> {

    protected LogFileStructure createTestInstance() {

        LogFileStructure.Format format = randomFrom(EnumSet.allOf(LogFileStructure.Format.class));

        LogFileStructure.Builder builder = new LogFileStructure.Builder(format);
    ...
    protected LogFileStructure doParseInstance(XContentParser parser) {
        return LogFileStructure.PARSER.apply(parser, null).build();
    }

...
public class MlWithSecurityInsufficientRoleRestApiSpecTests extends MlWithSecurityRestApiSpecTests {

    public MlWithSecurityInsufficientRoleRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

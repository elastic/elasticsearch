...
public class MlWithSecurityInsufficientRoleRestTestsYaml extends MlWithSecurityRestTestsYaml {

    public MlWithSecurityInsufficientRoleRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

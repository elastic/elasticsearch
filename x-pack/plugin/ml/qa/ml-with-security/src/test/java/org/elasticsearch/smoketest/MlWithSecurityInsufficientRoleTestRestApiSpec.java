...
public class MlWithSecurityInsufficientRoleTestRestApiSpec extends MlWithSecurityTestRestApiSpec {

    public MlWithSecurityInsufficientRoleTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

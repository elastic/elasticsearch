...
import org.elasticsearch.xpack.test.rest.XPackRestApiSpecTests;
...
public class MlWithSecurityRestApiSpecTests extends XPackRestApiSpecTests {

    private static final String TEST_ADMIN_USERNAME = "x_pack_rest_user";

    public MlWithSecurityRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

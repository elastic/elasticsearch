...
import org.elasticsearch.xpack.test.rest.XPackRestTestsYaml;
...
public class MlWithSecurityRestTestsYaml extends XPackRestTestsYaml {

    private static final String TEST_ADMIN_USERNAME = "x_pack_rest_user";

    public MlWithSecurityRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

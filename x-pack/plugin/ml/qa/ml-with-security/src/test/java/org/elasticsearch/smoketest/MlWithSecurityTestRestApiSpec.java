...
import org.elasticsearch.xpack.test.rest.XPackTestRestApiSpec;
...
public class MlWithSecurityTestRestApiSpec extends XPackTestRestApiSpec {

    private static final String TEST_ADMIN_USERNAME = "x_pack_rest_user";

    public MlWithSecurityTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

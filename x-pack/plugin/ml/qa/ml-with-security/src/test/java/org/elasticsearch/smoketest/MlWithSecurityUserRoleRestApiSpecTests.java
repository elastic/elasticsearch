...
public class MlWithSecurityUserRoleRestApiSpecTests extends MlWithSecurityRestApiSpecTests {
    ...
    public MlWithSecurityUserRoleRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);

...
public class MlWithSecurityUserRoleRestTestsYaml extends MlWithSecurityRestTestsYaml {
    ...
    public MlWithSecurityUserRoleRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);

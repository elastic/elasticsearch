...
public class MlWithSecurityUserRoleTestRestApiSpec extends MlWithSecurityTestRestApiSpec {
    ...
    public MlWithSecurityUserRoleTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);

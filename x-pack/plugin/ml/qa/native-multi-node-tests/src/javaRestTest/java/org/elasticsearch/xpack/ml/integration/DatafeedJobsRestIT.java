...
public class DatafeedJobsRestIT extends ESRestTestCase {
    ...
    private void addAirlineData() throws IOException {
        ...
        createEmptyAirlineDataRequest.setJsonEntity(
            """
             {"mappings":{"properties":{"time stamp":{"type":"date"},"airline":{"type":"keyword"},"responsetime":{"type":"float"}}}}
             """
        );
        ...
        createAirlineDataRequest.setJsonEntity(
            """
             {
               "mappings":{
                 "runtime": {"airline_lowercase_rt":{"type":"keyword","script":{"source":"emit(params._source.airline.toLowerCase())"}}
               },
               "properties":{
                 "time stamp":{"type":"date"},
                 "airline":{"type":"text","fields":{"text":{"type":"text"},"keyword":{"type":"keyword"}}},
            ...
            """
                {
                  "mappings": {
                      "properties": {
                         "timestamp": { "type":"date"},
                         "host": { "type":"text", "fields":{ "text":{"type":"text"},"keyword":{"type":"keyword"}}},
    ...
    public void testLookbackWithGeo() throws Exception {
        ...
        createGeoData.setJsonEntity(
            """
               {"mappings": {"properties": {"time": {"type":"date"},"location": {"type":"geo_point"}}}}
            """
        );
    ...
    public void testLookbackWithIndicesOptions() throws Exception {
        ...
        createGeoData.setJsonEntity(
            """
                {"mappings": {"properties": {"time": {"type":"date"},"value": {"type":"long"}}}, "settings": {"index.hidden": true}}
            """
        );
        client().performRequest(createGeoData);
    ...
    public void testLookbackWithPipelineBucketAgg() throws Exception {
        ...
        String aggregations = """
              {"buckets":{
                "date_histogram":{"field":"time stamp","fixed_interval":"15m"},
                "aggregations":{
                  "time stamp":{"max":{"field":"time stamp"}},
                  "airlines":{"terms":{"field":"airline.keyword","size":10}},
                  "percentile95_airlines_count":{"percentiles_bucket":{"buckets_path":"airlines._count", "percents": [95]}}
                 }
                }
              }
            """;
    ...
    public void testLookbackWithSingleBucketAgg() throws Exception {
        ...
        String aggregations = """
            {
              "time stamp":{
                "date_histogram":{"field":"time stamp","calendar_interval":"1h"},
                "aggregations":{
                  "time stamp":{"max":{"field":"time stamp"}},
    ...
    private Response createJobAndDataFeed(String jobId, String datafeedId) throws IOException {
        ...
        String aggregations = """
            {
              "buckets":{
                "date_histogram":{"field":"time stamp","fixed_interval":"3600000ms"},
                "aggregations":{"time stamp":{"max":{"field":"time stamp"}},"responsetime":{"avg":{"field":"responsetime"}}}
              }
            }
            """;

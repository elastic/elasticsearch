...
import org.elasticsearch.xpack.ml.action.TransportDataFrameAnalyticsInfoAction;
...
import org.elasticsearch.xpack.ml.rest.dataframe.RestDataFrameAnalyticsInfoAction;
...
public class MachineLearning extends Plugin implements ActionPlugin, AnalysisPlugin, IngestPlugin, PersistentTaskPlugin {
    ...
    public List<RestHandler> getRestHandlers(Settings settings, RestController restController, ClusterSettings clusterSettings,
        ...
        return Arrays.asList(
            ...
            new RestDataFrameAnalyticsInfoAction(restController),
    ...
    public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
        ...
        return Arrays.asList(
                ...
                new ActionHandler<>(DataFrameAnalyticsInfoAction.INSTANCE, TransportDataFrameAnalyticsInfoAction.class),

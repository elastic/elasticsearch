...
public class MachineLearning extends Plugin implements SystemIndexPlugin,
    ...
    static final long DEFAULT_MODEL_CIRCUIT_BREAKER_LIMIT = (long)((0.50) * JvmInfo.jvmInfo().getMem().getHeapMax().getBytes());
    static final double DEFAULT_MODEL_CIRCUIT_BREAKER_OVERHEAD = 1.0D;

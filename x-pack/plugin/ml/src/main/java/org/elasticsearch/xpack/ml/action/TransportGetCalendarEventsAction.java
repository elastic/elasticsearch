...
public class TransportGetCalendarEventsAction extends HandledTransportAction<GetCalendarEventsAction.Request,
    ...
    protected void doExecute(Task task, GetCalendarEventsAction.Request request,
        ...
        ActionListener<Boolean> calendarExistsListener = listener.wrap((l, r) -> {
                    ...
                    ActionListener<QueryPage<ScheduledEvent>> eventsListener = l.wrap((ll, events) ->
                            ll.onResponse(new GetCalendarEventsAction.Response(events)));
                    ...
                    if (request.getJobId() != null) {
                        ...
                        jobConfigProvider.getJob(request.getJobId(), ActionListener.wrap(
                                ...
                                jobNotFound -> {
                                    ...
                                    jobConfigProvider.groupExists(request.getJobId(), l.wrap((ll, groupExists) -> {
                                                if (groupExists) {
                                                    ...
                                                    ll.onFailure(ExceptionsHelper.missingJobException(request.getJobId()));
                                                }
                                            }
                                    ));
                                }
    ...
    private void checkCalendarExists(String[] calendarId, ActionListener<Boolean> listener) {
        ...
        jobResultsProvider.calendars(CalendarQueryBuilder.builder().calendarIdTokens(calendarId),
                listener.wrap((l, c) -> l.onResponse(true)));
    }
}

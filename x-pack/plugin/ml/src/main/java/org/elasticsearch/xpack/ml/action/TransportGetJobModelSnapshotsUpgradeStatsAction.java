...
public class TransportGetJobModelSnapshotsUpgradeStatsAction extends TransportMasterNodeReadAction<Request, Response> {
    ...
    protected void masterOperation(Task task, Request request, ClusterState state, ActionListener<Response> listener) {
        ...
        final PersistentTasksMetadataSection tasksInProgress = state.getMetadata().section(PersistentTasksMetadataSection.TYPE);
        final Collection<PersistentTasksMetadataSection.PersistentTask<?>> snapshotUpgrades = MlTasks.snapshotUpgradeTasks(tasksInProgress);

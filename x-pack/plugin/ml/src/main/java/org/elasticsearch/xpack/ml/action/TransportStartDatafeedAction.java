...
public class TransportStartDatafeedAction extends TransportMasterNodeAction<StartDatafeedAction.Request, NodeAcknowledgedResponse> {
    ...
    protected void masterOperation(
        ...
        ActionListener<PersistentTasksMetadataSection.PersistentTask<StartDatafeedAction.DatafeedParams>> waitForTaskListener =
            new ActionListener<>() {
                @Override
                public void onResponse(PersistentTasksMetadataSection.PersistentTask<StartDatafeedAction.DatafeedParams> persistentTask) {
    ...
    private void createDataExtractor(
        ...
        ActionListener<PersistentTasksMetadataSection.PersistentTask<StartDatafeedAction.DatafeedParams>> listener
    ) {
    ...
    private void cancelDatafeedStart(
        PersistentTasksMetadataSection.PersistentTask<StartDatafeedAction.DatafeedParams> persistentTask,
        Exception exception,
        ActionListener<NodeAcknowledgedResponse> listener
    ) {
     ...
     */
    private static class DatafeedPredicate implements Predicate<PersistentTasksMetadataSection.PersistentTask<?>> {
        ...
        public boolean test(PersistentTasksMetadataSection.PersistentTask<?> persistentTask) {
            ...
            if (assignment != null) {
                ...
                if (assignment.equals(PersistentTasksMetadataSection.INITIAL_ASSIGNMENT) == false && assignment.isAssigned() == false) {

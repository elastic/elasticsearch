...
public class RestSetUpgradeModeAction extends BaseRestHandler {
    ...
    public RestSetUpgradeModeAction(Settings settings, RestController controller) {
        super(settings);
        controller.registerHandler(POST, MachineLearning.BASE_PATH + "set_upgrade_mode", this);
        controller.registerHandler(POST, MachineLearning.V7_BASE_PATH + "set_upgrade_mode", this);
    }

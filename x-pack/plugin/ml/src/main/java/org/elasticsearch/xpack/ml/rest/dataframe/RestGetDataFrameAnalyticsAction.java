...
public class RestGetDataFrameAnalyticsAction extends BaseRestHandler {
    ...
    public Map<String, List<Method>> handledMethodsAndPaths() {
        return Collections.unmodifiableMap(MapBuilder.<String, List<Method>>newMapBuilder()
            .put(MachineLearning.BASE_PATH + "data_frame/analytics", singletonList(GET))
            .put(MachineLearning.BASE_PATH + "data_frame/analytics/{" + DataFrameAnalyticsConfig.ID.getPreferredName() + "}",
                singletonList(GET))
            .map());
    }

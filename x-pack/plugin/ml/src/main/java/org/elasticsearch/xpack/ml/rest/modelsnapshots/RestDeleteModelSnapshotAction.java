...
public class RestDeleteModelSnapshotAction extends BaseRestHandler {
    ...
    public List<ReplacedRoute> replacedRoutes() {
        ...
        return org.elasticsearch.common.collect.List.of(
            new ReplacedRoute(DELETE, BASE_PATH + "anomaly_detectors/{" + Job.ID + "}/model_snapshots/{" + SNAPSHOT_ID + "}",
                DELETE, PRE_V7_BASE_PATH + "anomaly_detectors/{" + Job.ID + "}/model_snapshots/{" + SNAPSHOT_ID + "}")
        );
    }

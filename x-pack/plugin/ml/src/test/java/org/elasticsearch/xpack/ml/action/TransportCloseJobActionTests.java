...
public class TransportCloseJobActionTests extends ESTestCase {
    ...
    public void testAddJobAccordingToState() {
        ...
        PersistentTasksMetadataSection.Builder taskBuilder = PersistentTasksMetadataSection.builder();
        ...
        PersistentTasksMetadataSection tasks = taskBuilder.build();
    ...
    public void testStopDatafeedsIfNecessary() {
        final PersistentTasksMetadataSection.Builder datafeedStartedTaskBuilder = PersistentTasksMetadataSection.builder();
        ...
        final PersistentTasksMetadataSection.Builder datafeedNotStartedTaskBuilder = PersistentTasksMetadataSection.builder();

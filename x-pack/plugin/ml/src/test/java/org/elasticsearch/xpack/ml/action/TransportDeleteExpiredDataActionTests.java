...
public class TransportDeleteExpiredDataActionTests extends ESTestCase {
    ...
    public void setup() {
        ...
        transportDeleteExpiredDataAction = new TransportDeleteExpiredDataAction(Settings.EMPTY, threadPool, ThreadPool.Names.SAME,
            transportService, new ActionFilters(Collections.emptySet()), indexNameExpressionResolver, client, clusterService,
            Clock.systemUTC());
    }

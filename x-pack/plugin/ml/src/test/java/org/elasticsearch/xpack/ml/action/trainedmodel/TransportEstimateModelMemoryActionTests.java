...
public class TransportEstimateModelMemoryActionTests extends ESTestCase {
    ...
    public void testCalculateDetectorRequirementBytes() {
        ...
        assertThat(TransportEstimateModelMemoryAction.calculateDetectorRequirementBytes(noSplit, 900, overallCardinality), is(49152L));

        Detector withByField = createDetector(function, "field", "buy", null, null);
        assertThat(
            TransportEstimateModelMemoryAction.calculateDetectorRequirementBytes(withByField, 900, overallCardinality),
            is(134 * 49152L)
        );

        Detector withPartitionField = createDetector(function, "field", null, null, "part");
        assertThat(
            TransportEstimateModelMemoryAction.calculateDetectorRequirementBytes(withPartitionField, 900, overallCardinality),
            is(100 * 49152L)
        );

        Detector withByAndPartitionFields = createDetector(function, "field", "buy", null, "part");
        assertThat(
            TransportEstimateModelMemoryAction.calculateDetectorRequirementBytes(withByAndPartitionFields, 900, overallCardinality),
            is((long) Math.ceil(200 / Math.sqrt(100) * 2 / 3) * 100 * 49152L)
        );
    }
    ...
    public void testCalculateInfluencerRequirementBytes() {
        ...
        assertThat(TransportEstimateModelMemoryAction.calculateInfluencerRequirementBytes(noInfluencers, maxBucketCardinality), is(0L));

        AnalysisConfig influencerAlsoPartitionField = createCountAnalysisConfig(null, "part", "part");
        assertThat(
            TransportEstimateModelMemoryAction.calculateInfluencerRequirementBytes(influencerAlsoPartitionField, maxBucketCardinality),
            is(0L)
        );

        AnalysisConfig influencerNotPartitionField = createCountAnalysisConfig(null, "part", "inf1");
        assertThat(
            TransportEstimateModelMemoryAction.calculateInfluencerRequirementBytes(influencerNotPartitionField, maxBucketCardinality),
            is(200 * TransportEstimateModelMemoryAction.BYTES_PER_INFLUENCER_VALUE)
        );

        AnalysisConfig otherInfluencerAsWellAsPartitionField = createCountAnalysisConfig(null, "part", "part", "inf1");
        assertThat(
            TransportEstimateModelMemoryAction.calculateInfluencerRequirementBytes(
                otherInfluencerAsWellAsPartitionField,
        ...
        assertThat(
            TransportEstimateModelMemoryAction.calculateInfluencerRequirementBytes(twoInfluencersNotPartitionField, maxBucketCardinality),
            is((200 + 300) * TransportEstimateModelMemoryAction.BYTES_PER_INFLUENCER_VALUE)
        );
    }
    ...
    public void testCalculateCategorizationRequirementBytesSimpleCategorization() {
        ...
        AnalysisConfig analysisConfig = createCountAnalysisConfig(randomAlphaOfLength(10), randomBoolean() ? "part" : null);
        assertThat(
            TransportEstimateModelMemoryAction.calculateCategorizationRequirementBytes(analysisConfig, overallCardinality),
            is(40L * 1024 * 1024)
        );
    }
    ...
    public void testCalculateCategorizationRequirementBytesPerPartitionCategorization() {
        ...
        AnalysisConfig analysisConfig = createCountAnalysisConfigBuilder(randomAlphaOfLength(10), "part")
            .setPerPartitionCategorizationConfig(new PerPartitionCategorizationConfig(true, isStopOnWarn))
            .build();
        assertThat(
            TransportEstimateModelMemoryAction.calculateCategorizationRequirementBytes(analysisConfig, overallCardinality),
    ...
    public void testRoundUpToNextMb() {
        ...
        assertThat(TransportEstimateModelMemoryAction.roundUpToNextMb(0), equalTo(ByteSizeValue.ofBytes(0)));
        assertThat(TransportEstimateModelMemoryAction.roundUpToNextMb(1), equalTo(ByteSizeValue.ofMb(1)));
        assertThat(TransportEstimateModelMemoryAction.roundUpToNextMb(randomIntBetween(1, 1024 * 1024)), equalTo(ByteSizeValue.ofMb(1)));
        assertThat(TransportEstimateModelMemoryAction.roundUpToNextMb(1024 * 1024), equalTo(ByteSizeValue.ofMb(1)));
        assertThat(TransportEstimateModelMemoryAction.roundUpToNextMb(1024 * 1024 + 1), equalTo(ByteSizeValue.ofMb(2)));
        assertThat(TransportEstimateModelMemoryAction.roundUpToNextMb(2 * 1024 * 1024), equalTo(ByteSizeValue.ofMb(2)));
        ...
        assertThat(
            TransportEstimateModelMemoryAction.roundUpToNextMb(Long.MAX_VALUE - randomIntBetween(0, 1000000)),
    ...
    public void testReducedCardinality() {
        ...
        assertThat(TransportEstimateModelMemoryAction.reducedCardinality(0, randomNonNegativeLong(), saneBucketSpan), closeTo(0.0, 1e-15));
        assertThat(
            TransportEstimateModelMemoryAction.reducedCardinality(cardinalityToReduce, 1, saneBucketSpan),
            closeTo(cardinalityToReduce, 1e-6)
        );
        assertThat(
            TransportEstimateModelMemoryAction.reducedCardinality(cardinalityToReduce, 1000, 900),
            closeTo(cardinalityToReduce / Math.sqrt(1000), cardinalityToReduce / 20.0)
        );
        assertThat(
            TransportEstimateModelMemoryAction.reducedCardinality(
                cardinalityToReduce,
        ...
        assertThat(
            TransportEstimateModelMemoryAction.reducedCardinality(cardinalityToReduce, 1000, 10000000),
    ...
    public void testAddNonNegativeLongsWithMaxValueCap() {
        ...
        assertThat(
            TransportEstimateModelMemoryAction.addNonNegativeLongsWithMaxValueCap(Long.MAX_VALUE, Long.MAX_VALUE),
            is(Long.MAX_VALUE)
        );
        assertThat(
            TransportEstimateModelMemoryAction.addNonNegativeLongsWithMaxValueCap(
                Long.MAX_VALUE - randomIntBetween(1, Integer.MAX_VALUE),
                Long.MAX_VALUE - randomIntBetween(1, Integer.MAX_VALUE)
            ),
            is(Long.MAX_VALUE)
        );
    ...
    public void testMultiplyNonNegativeLongsWithMaxValueCap() {
        ...
        assertThat(
            TransportEstimateModelMemoryAction.multiplyNonNegativeLongsWithMaxValueCap(Long.MAX_VALUE, Long.MAX_VALUE),
            is(Long.MAX_VALUE)
        );
        assertThat(
            TransportEstimateModelMemoryAction.multiplyNonNegativeLongsWithMaxValueCap(
                Long.MAX_VALUE,
                Math.max(1L, randomNonNegativeLong())
            ),
            is(Long.MAX_VALUE)
        );
        assertThat(
    ...
    public static AnalysisConfig createCountAnalysisConfig(
    ...
    public static AnalysisConfig.Builder createCountAnalysisConfigBuilder(
        String categorizationFieldName,
        String partitionFieldName,
        String... influencerFieldNames
    ) {

...
public class CategorizeTextAggregatorTests extends AggregatorTestCase {
    ...
    public void testCategorizationWithSubAggs() throws Exception {
        ...
        testCase(
            ...
            (InternalCategorizationAggregation result) -> {
                ...
                assertThat(result.getBuckets().get(0).getDocCount(), equalTo(6L));
                assertThat(result.getBuckets().get(0).getKeyAsString(), equalTo("Node started"));
                assertThat(((Max) result.getBuckets().get(0).getAggregations().get("max")).getValue(), equalTo(5.0));
                assertThat(((Min) result.getBuckets().get(0).getAggregations().get("min")).getValue(), equalTo(0.0));
                ...
                assertThat(((Max) result.getBuckets().get(1).getAggregations().get("max")).getValue(), equalTo(4.0));
                assertThat(((Min) result.getBuckets().get(1).getAggregations().get("min")).getValue(), equalTo(0.0));
    ...
    public void testCategorizationAsSubAgg() throws Exception {
        ...
        testCase(aggBuilder, new MatchAllDocsQuery(), CategorizeTextAggregatorTests::writeTestDocs, (InternalHistogram result) -> {
            ...
            assertThat(((Max) categorizationAggregation.getBuckets().get(0).getAggregations().get("max")).getValue(), equalTo(1.0));
            assertThat(((Min) categorizationAggregation.getBuckets().get(0).getAggregations().get("min")).getValue(), equalTo(0.0));
            ...
            assertThat(((Max) categorizationAggregation.getBuckets().get(1).getAggregations().get("max")).getValue(), equalTo(0.0));
            assertThat(((Min) categorizationAggregation.getBuckets().get(1).getAggregations().get("min")).getValue(), equalTo(0.0));
            ...
            assertThat(categorizationAggregation.getBuckets().get(0).getDocCount(), equalTo(2L));
            assertThat(categorizationAggregation.getBuckets().get(0).getKeyAsString(), equalTo("Node started"));
            assertThat(((Max) categorizationAggregation.getBuckets().get(0).getAggregations().get("max")).getValue(), equalTo(3.0));
            assertThat(((Min) categorizationAggregation.getBuckets().get(0).getAggregations().get("min")).getValue(), equalTo(2.0));
            ...
            assertThat(categorizationAggregation.getBuckets().get(0).getDocCount(), equalTo(2L));
            assertThat(categorizationAggregation.getBuckets().get(0).getKeyAsString(), equalTo("Node started"));
            assertThat(((Max) categorizationAggregation.getBuckets().get(0).getAggregations().get("max")).getValue(), equalTo(5.0));
            assertThat(((Min) categorizationAggregation.getBuckets().get(0).getAggregations().get("min")).getValue(), equalTo(4.0));
            ...
            assertThat(((Max) categorizationAggregation.getBuckets().get(1).getAggregations().get("max")).getValue(), equalTo(4.0));
            assertThat(((Min) categorizationAggregation.getBuckets().get(1).getAggregations().get("min")).getValue(), equalTo(4.0));

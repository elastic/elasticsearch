...
public class ExtractedFieldsTests extends ESTestCase {
    ...
    public void testApplyBooleanMapping_GivenDocValueField() {
        ...
        assertThat(mapped.value(hitTrue, new SourceSuppler(hitTrue)), equalTo(new Integer[] { 1 }));
        assertThat(mapped.value(hitFalse, new SourceSuppler(hitFalse)), equalTo(new Integer[] { 0 }));
    ...
    public void testApplyBooleanMapping_GivenSourceField() {
        ...
        assertThat(mapped.value(hitTrue, new SourceSuppler(hitTrue)), equalTo(new Integer[] { 1 }));
        assertThat(mapped.value(hitFalse, new SourceSuppler(hitFalse)), equalTo(new Integer[] { 0 }));
        assertThat(mapped.value(hitTrueArray, new SourceSuppler(hitTrueArray)), equalTo(new Integer[] { 1, 1 }));
        assertThat(mapped.value(hitFalseArray, new SourceSuppler(hitFalseArray)), equalTo(new Integer[] { 0, 0 }));

...
public class GeoShapeFieldTests extends ESTestCase {
    ...
    public void testObjectFormat() {
        ...
        assertThat(geo.value(hit, new SourceSuppler(hit)), equalTo(expected));
    ...
    public void testMissing() {
        ...
        assertThat(geo.value(hit, new SourceSuppler(hit)), equalTo(new Object[0]));
    }
    ...
    public void testArray() {
        ...
        IllegalStateException e = expectThrows(IllegalStateException.class, () -> geo.value(hit, new SourceSuppler(hit)));

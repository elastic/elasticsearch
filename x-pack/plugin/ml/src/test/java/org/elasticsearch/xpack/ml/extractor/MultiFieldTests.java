...
public class MultiFieldTests extends ESTestCase {
    ...
    public void testGivenSameSearchField() {
        ...
        try (var hitRef = ReleasableRef.of(hit)) {
            ...
            assertThat(field.value(hitRef.get(), new SourceSupplier(hitRef.get())), equalTo(new Integer[] { 2 }));
    ...
    public void testGivenDifferentSearchField() {
        ...
        try (var hitRef = ReleasableRef.of(hit)) {
            ...
            assertThat(field.value(hitRef.get(), new SourceSupplier(hitRef.get())), equalTo(new Integer[] { 1 }));
            assertThat(field.getName(), equalTo("a.b"));

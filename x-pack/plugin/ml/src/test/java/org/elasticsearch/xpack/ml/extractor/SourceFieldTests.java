...
public class SourceFieldTests extends ESTestCase {
    ...
    public void testSingleValue() {
        ...
        assertThat(field.value(hit, new SourceSuppler(hit)), equalTo(new String[] { "bar" }));
    ...
    public void testArray() {
        ...
        assertThat(field.value(hit, new SourceSuppler(hit)), equalTo(new String[] { "a", "b" }));
    ...
    public void testMissing() {
        ...
        assertThat(missing.value(hit, new SourceSuppler(hit)), equalTo(new Object[0]));
    }
    ...
    public void testValueGivenNested() {
        ...
        assertThat(nested.value(hit, new SourceSuppler(hit)), equalTo(new String[] { "bar" }));
    }

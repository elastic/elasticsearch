...
public class TimeFieldTests extends ESTestCase {
    ...
    public void testDocValueWithWholeMillisecondStringValue() {
        ...
        assertThat(timeField.value(hit, new SourceSuppler(hit)), equalTo(new Object[] { millis }));
    ...
    public void testUnknownFormat() {
        ...
        assertThat(
            expectThrows(IllegalStateException.class, () -> timeField.value(hit, new SourceSuppler(hit))).getMessage(),

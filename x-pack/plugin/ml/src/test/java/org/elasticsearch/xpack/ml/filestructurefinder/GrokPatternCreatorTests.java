...
import org.elasticsearch.xpack.ml.filestructurefinder.GrokPatternCreator.ValueOnlyGrokPatternCandidate;
...
public class GrokPatternCreatorTests extends FileStructureTestCase {
    ...
    public void testAppendBestGrokMatchForStringsGivenTimestampsAndLogLevels() {
        ...
        GrokPatternCreator grokPatternCreator = new GrokPatternCreator(explanation, snippets, null, null, Collections.emptyMap(),

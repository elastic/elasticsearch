...
public class NerProcessorTests extends ESTestCase {
    ...
    public void testProcessResults_GivenNoTokens() {
        ...
        var e = expectThrows(
            ...
            () -> processor.processResult(tokenization, new PyTorchInferenceResult(null, 0L))
        );
    ...
    public void testProcessResultsWithSpecialTokens() {
        ...
        try (
            ...
            NerResults result = (NerResults) processor.processResult(tokenization, new PyTorchInferenceResult(scores, 1L));

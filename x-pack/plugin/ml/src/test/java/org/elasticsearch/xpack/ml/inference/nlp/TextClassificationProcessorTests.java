...
public class TextClassificationProcessorTests extends ESTestCase {
    ...
    public void testInvalidResult() {
        {
            PyTorchInferenceResult torchResult = new PyTorchInferenceResult(new double[][][] {}, 0L);
            var e = expectThrows(
        ...
        {
            PyTorchInferenceResult torchResult = new PyTorchInferenceResult(new double[][][] { { { 1.0 } } }, 0L);
            var e = expectThrows(
                ElasticsearchStatusException.class,
                () -> TextClassificationProcessor.processResult(null, torchResult, randomInt(), List.of("a", "b"), randomAlphaOfLength(10))
            );

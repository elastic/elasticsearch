...
public class TextExpansionProcessorTests extends ESTestCase {
    ...
    public void testProcessResult() {
        ...
        assertEquals(new TextExpansionResults.QueryVector("e", 4.0f), weightedTokens.get(0));
        assertEquals(new TextExpansionResults.QueryVector("d", 3.0f), weightedTokens.get(1));
        assertEquals(new TextExpansionResults.QueryVector("b", 1.0f), weightedTokens.get(2));
    }
    ...
    public void testSanitiseVocab() {
        ...
        assertEquals(new TextExpansionResults.QueryVector("fff", 6.0f), weightedTokens.get(0));
        assertEquals(new TextExpansionResults.QueryVector("XXX", 5.0f), weightedTokens.get(1));
        assertEquals(new TextExpansionResults.QueryVector("YYY", 4.0f), weightedTokens.get(2));
        assertEquals(new TextExpansionResults.QueryVector("ccc", 3.0f), weightedTokens.get(3));
        assertEquals(new TextExpansionResults.QueryVector("bbb", 2.0f), weightedTokens.get(4));
        assertEquals(new TextExpansionResults.QueryVector("aaa", 1.0f), weightedTokens.get(5));
    }
    ...
    public void testSanitizeOutputTokens() {
        ...
        assertEquals(new TextExpansionResults.QueryVector("##__", 5.0f), weightedTokens.get(0));
        assertEquals(new TextExpansionResults.QueryVector("__", 4.0f), weightedTokens.get(1));
        assertEquals(new TextExpansionResults.QueryVector("cc", 3.0f), weightedTokens.get(2));
        assertEquals(new TextExpansionResults.QueryVector("bb", 2.0f), weightedTokens.get(3));
        assertEquals(new TextExpansionResults.QueryVector("aa", 1.0f), weightedTokens.get(4));
    }
    ...
    public void testChunking() {
        try (
            ...
            assertThat(chunkedResult.getChunks().get(0).queryVectors(), not(empty()));
            assertThat(chunkedResult.getChunks().get(1).queryVectors(), not(empty()));
        }
    }
}

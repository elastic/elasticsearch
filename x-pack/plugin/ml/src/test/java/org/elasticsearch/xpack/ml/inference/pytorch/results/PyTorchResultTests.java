...
public class PyTorchResultTests extends AbstractXContentTestCase<PyTorchResult> {
    ...
    protected PyTorchResult createTestInstance() {
        ...
        return switch (type) {
            case 0 -> new PyTorchResult(requestId, randomBoolean(), PyTorchInferenceResultTests.createRandom(), null, null, null);
            case 1 -> new PyTorchResult(requestId, null, null, ThreadSettingsTests.createRandom(), null, null);
            case 2 -> new PyTorchResult(requestId, null, null, null, AckResultTests.createRandom(), null);
            default -> new PyTorchResult(requestId, null, null, null, null, ErrorResultTests.createRandom());
        };
    }

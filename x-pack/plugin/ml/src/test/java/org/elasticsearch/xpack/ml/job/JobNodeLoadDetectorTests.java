...
public class JobNodeLoadDetectorTests extends ESTestCase {
    ...
    public void testNodeLoadDetection() {
        ...
        NodeLoadDetector.NodeLoad load = nodeLoadDetector.detectNodeLoad(cs.build(), true, nodes.get("_node_id1"), 10, 30, true);
        ...
        load = nodeLoadDetector.detectNodeLoad(cs.build(), true, nodes.get("_node_id2"), 5, 30, true);
        ...
        load = nodeLoadDetector.detectNodeLoad(cs.build(), true, nodes.get("_node_id3"), 5, 30, true);
        ...
        load = nodeLoadDetector.detectNodeLoad(cs.build(), true, nodes.get("_node_id4"), 5, 30, true);
        assertThat(load.getAssignedJobMemory(), equalTo(41943040L));
        assertThat(load.getNumAllocatingJobs(), equalTo(0L));
        assertThat(load.getNumAssignedJobs(), equalTo(1L));
        assertThat(load.getMaxJobs(), equalTo(5));
    ...
    public void testNodeLoadDetection_withBadMaxOpenJobsAttribute() {
        ...
        NodeLoadDetector.NodeLoad load = nodeLoadDetector.detectNodeLoad(cs.build(), false, nodes.get("_node_id1"), 10, 30, true);

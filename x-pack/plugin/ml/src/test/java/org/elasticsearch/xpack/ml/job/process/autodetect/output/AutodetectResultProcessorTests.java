...
public class AutodetectResultProcessorTests extends ESTestCase {
    ...
    public void testProcessResult_modelSnapshot() {
        ...
        ModelSnapshot modelSnapshot = new ModelSnapshot.Builder(JOB_ID)
            ...
            .setTimestamp(Date.from(Instant.ofEpochMilli(2000000000)))
            .setLatestResultTimeStamp(Date.from(Instant.ofEpochMilli(1200000000)))
        ...
        Annotation expectedAnnotation =
            new Annotation(
                ...
                XPackUser.NAME,
                Date.from(Instant.ofEpochMilli(1200000000)),
                Date.from(Instant.ofEpochMilli(1200000000)),
                JOB_ID,
                Date.from(CURRENT_TIME),
                XPackUser.NAME,

...
public class BucketTests extends AbstractSerializingTestCase<Bucket> {
    ...
    public Bucket createTestInstance(String jobId) {
        Bucket bucket = new Bucket(jobId, new Date(randomLongBetween(0, 3000000000000L)), randomNonNegativeLong());
        if (randomBoolean()) {
    ...
    public void testEquals_GivenDifferentClass() {
        Bucket bucket = new Bucket("foo", new Date(randomLongBetween(0, 3000000000000L)), randomNonNegativeLong());

...
public class JobTaskTests extends ESTestCase {
    ...
    public void testJobTaskMatcherMatch() {
        ...
        JobTask jobTask1 = new JobTask("ml-1", 0, "persistent", "", null, null, null, licenseState);
        JobTask jobTask2 = new JobTask("ml-2", 1, "persistent", "", null, null, null, licenseState);
    ...
    public void testKillJob() {
        JobTask jobTask = new JobTask("job-to-kill", 0, "persistent", "", null, null, null, licenseState);
    ...
    public void testCloseOrVacateTransitions() {
        ...
        JobTask jobTask = new JobTask("transition-test-task", 0, "persistent", "", null, null, null, licenseState);

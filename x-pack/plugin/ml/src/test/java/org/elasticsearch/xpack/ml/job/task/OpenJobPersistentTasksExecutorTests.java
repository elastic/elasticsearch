...
public class OpenJobPersistentTasksExecutorTests extends ESTestCase {
    ...
    public void testGetAssignment_GivenLazyJobAndNoGlobalLazyNodes() {
        ...
        params.setJob(job);
        PersistentTasksMetadataSection.Assignment assignment = executor.getAssignment(
            params,
    ...
    public static void addJobTask(String jobId, String nodeId, JobState jobState, PersistentTasksMetadataSection.Builder builder) {

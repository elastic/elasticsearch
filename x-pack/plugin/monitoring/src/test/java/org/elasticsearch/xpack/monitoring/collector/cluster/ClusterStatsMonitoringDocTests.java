...
public class ClusterStatsMonitoringDocTests extends BaseMonitoringDocTestCase<ClusterStatsMonitoringDoc> {
    ...
    public void testToXContent() throws IOException {
        ...
        doTestToXContent(expectedJson, RestApiVersion.current());
    }
    ...
    public void testToXContentV7() throws IOException {
        ...
        doTestToXContent(expectedJson, RestApiVersion.V_7);
    }

    private void doTestToXContent(String expectedJson, RestApiVersion version) throws IOException {
        ...
        try (XContentBuilder builder = XContentBuilder.builder(XContentType.JSON.xContent(), version)) {

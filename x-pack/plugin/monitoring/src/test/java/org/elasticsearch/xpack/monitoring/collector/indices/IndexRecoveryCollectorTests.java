...
public class IndexRecoveryCollectorTests extends BaseCollectorTestCase {
    ...
    public void testDoCollectThrowsTimeoutException() throws Exception {
        ...
        final RecoveryResponse recoveryResponse =
                new RecoveryResponse(randomInt(), randomInt(), randomInt(), emptyMap(),
                        singletonList(new DefaultShardOperationFailedException(
        ...
        assertWarnings(Level.WARN, "[xpack.monitoring.collection.index.recovery.timeout] setting was deprecated in Elasticsearch " +

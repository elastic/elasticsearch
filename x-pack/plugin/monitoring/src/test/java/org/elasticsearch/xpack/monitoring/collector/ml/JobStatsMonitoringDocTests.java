    ...
    public void testToXContent() throws IOException {
        ...
        final String expected = XContentHelper.reformatJson(
            "{"
                ...
                + "      \"job_id\": \"_job_id\","
                + "      \"bucket_count\": 100,"
                + "      \"total_bucket_processing_time_ms\": 2000,"
                + "      \"minimum_bucket_processing_time_ms\": 10,"
                + "      \"maximum_bucket_processing_time_ms\": 30,"
                + "      \"average_bucket_processing_time_ms\": 20,"
                + "      \"exponential_average_bucket_processing_time_ms\": 25,"
                + "      \"exponential_average_bucket_processing_time_per_hour_ms\": 50"
                + "    }"
                + "  }"
                + "}"
        );

...
public class BytesReferenceMonitoringDocTests extends BaseMonitoringDocTestCase<BytesReferenceMonitoringDoc> {
    ...
    @Override
    protected BytesReferenceMonitoringDoc createMonitoringDoc(
    ...
    public void testToXContent() throws IOException {
        ...
        final BytesReferenceMonitoringDoc document = new BytesReferenceMonitoringDoc(
            "_cluster",
            1502266739402L,
            1506593717631L,
            node,
    ...
    public void testEqualsAndHashcode() {
        final EqualsHashCodeTestUtils.CopyFunction<MonitoringDoc> copy = doc -> createMonitoringDoc(
            doc.getCluster(),
            doc.getTimestamp(),

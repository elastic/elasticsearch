...
public class ExportersTests extends ESTestCase {
    ...
    public void testHostsMustBeSetIfTypeIsHttp() {
        ...
        assertWarnings(
            Level.WARN,
            "[xpack.monitoring.exporters.example.type] setting was deprecated in Elasticsearch and will be "
    ...
    public void testIndexNameTimeFormatMustBeValid() {
        ...
        assertWarnings(
            Level.WARN,
            "[xpack.monitoring.exporters.example.index.name.time_format] setting was deprecated in Elasticsearch "
    ...
    public void testInitExportersSingleDisabled() throws Exception {
        ...
        assertWarnings(
            Level.WARN,
            "[xpack.monitoring.exporters._name.enabled] setting was deprecated in Elasticsearch and will be"
                + " removed in a future release! See the breaking changes documentation for the next major version."
        );
    }
    ...
    public void testSettingsUpdate() throws Exception {
        ...
        assertWarnings(
            ...
            new DeprecationWarning(
                Level.WARN,
                "[xpack.monitoring.exporters._name1.type] setting was deprecated in Elasticsearch and "
                    + "will be removed in a future release! See the breaking changes documentation for the next major version."
            ),
            new DeprecationWarning(
                Level.WARN,
                "[xpack.monitoring.exporters._name0.type] setting was deprecated in Elasticsearch and "
                    + "will be removed in a future release! See the breaking changes documentation for the next major version."
            ),
            new DeprecationWarning(
    ...
    public void testNoExporters() throws Exception {
        ...
        assertWarnings(
            Level.WARN,
            "[xpack.monitoring.exporters.explicitly_disabled.enabled] setting was deprecated in Elasticsearch "
                + "and will be removed in a future release! See the breaking changes documentation for the next major version."
        );
    }

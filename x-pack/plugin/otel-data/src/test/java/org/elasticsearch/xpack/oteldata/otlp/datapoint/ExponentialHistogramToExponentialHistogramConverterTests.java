    ...
    public static List<Object[]> testCases() {
        return List.of(
            ...
            new Object[] {
                ...
                newBuilder().setZeroCount(3).setZeroThreshold(2.2)
            ...
            new Object[] {
                ...
                newBuilder()
                    .setNegative(Buckets.newBuilder().setOffset(-2).addAllBucketCounts(List.of(0L, 0L, 7L, 0L)))
            ...
            new Object[] {
                "sum only",
                newBuilder().setSum(123.45)
                    .setPositive(Buckets.newBuilder().setOffset(0).addAllBucketCounts(List.of(7L))),
                "{\"scale\":0,\"positive\":{\"indices\":[0],\"counts\":[7]},\"sum\":123.45}"
            },
            new Object[] {
                "min only",
                newBuilder().setMin(-10.5)
                    .setNegative(Buckets.newBuilder().setOffset(-2).addAllBucketCounts(List.of(0L, 5L, 0L))),
                "{\"scale\":0,\"negative\":{\"indices\":[-1],\"counts\":[5]},\"min\":-10.5}"
            },
            new Object[] {
                "max only",
                newBuilder().setMax(99.9)
                    .setPositive(Buckets.newBuilder().setOffset(2).addAllBucketCounts(List.of(0L, 0L, 8L))),
                "{\"scale\":0,\"positive\":{\"indices\":[4],\"counts\":[8]},\"max\":99.9}"
            },
            new Object[] {
                "sum and min",
                newBuilder().setSum(10.0).setMin(-5.0)
            ...
            new Object[] {
                "sum, min, and max",
                newBuilder().setSum(100.0).setMin(-50.0).setMax(50.0)
            ...
            new Object[] {
                ...
                newBuilder().setSum(200.0).setMin(-100.0).setMax(100.0).setZeroCount(2).setZeroThreshold(1.5)

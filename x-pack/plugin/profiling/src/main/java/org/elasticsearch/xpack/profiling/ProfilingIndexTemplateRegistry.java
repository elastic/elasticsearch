...
public class ProfilingIndexTemplateRegistry extends IndexTemplateRegistry {
    ...
    private static final List<LifecyclePolicy> LIFECYCLE_POLICIES = List.of(
        new LifecyclePolicyConfig(
            "profiling-60-days",
            "/org/elasticsearch/xpack/profiling/ilm-policy/profiling-60-days.json",
    ...
    static {
        ...
        for (IndexTemplateConfig config : List.of(
            new IndexTemplateConfig(
                "profiling-events",
                "/org/elasticsearch/xpack/profiling/component-template/profiling-events.json",
            ...
            new IndexTemplateConfig(
                ...
                "/org/elasticsearch/xpack/profiling/component-template/profiling-executables.json",
                INDEX_TEMPLATE_VERSION,
                PROFILING_TEMPLATE_VERSION_VARIABLE,
            ...
            new IndexTemplateConfig(
                "profiling-ilm",
                "/org/elasticsearch/xpack/profiling/component-template/profiling-ilm.json",
                INDEX_TEMPLATE_VERSION,
                PROFILING_TEMPLATE_VERSION_VARIABLE
            ),
            new IndexTemplateConfig(
                "profiling-hot-tier",
                "/org/elasticsearch/xpack/profiling/component-template/profiling-hot-tier.json",
                INDEX_TEMPLATE_VERSION,
                PROFILING_TEMPLATE_VERSION_VARIABLE
            ),
            new IndexTemplateConfig(
                "profiling-metrics",
                "/org/elasticsearch/xpack/profiling/component-template/profiling-metrics.json",
                INDEX_TEMPLATE_VERSION,
                PROFILING_TEMPLATE_VERSION_VARIABLE,
            ...
            new IndexTemplateConfig(
                "profiling-hosts",
                "/org/elasticsearch/xpack/profiling/component-template/profiling-hosts.json",
                INDEX_TEMPLATE_VERSION,
                PROFILING_TEMPLATE_VERSION_VARIABLE,
            ...
            new IndexTemplateConfig(
                ...
                "/org/elasticsearch/xpack/profiling/component-template/profiling-stackframes.json",
                INDEX_TEMPLATE_VERSION,
                PROFILING_TEMPLATE_VERSION_VARIABLE,
            ...
            new IndexTemplateConfig(
                ...
                "/org/elasticsearch/xpack/profiling/component-template/profiling-stacktraces.json",
                INDEX_TEMPLATE_VERSION,
                PROFILING_TEMPLATE_VERSION_VARIABLE,
            ...
            new IndexTemplateConfig(
                "profiling-symbols",
                "/org/elasticsearch/xpack/profiling/component-template/profiling-symbols.json",
                INDEX_TEMPLATE_VERSION,
                PROFILING_TEMPLATE_VERSION_VARIABLE,
    ...
    private static final Map<String, ComposableIndexTemplate> COMPOSABLE_INDEX_TEMPLATE_CONFIGS = parseComposableTemplates(
        new IndexTemplateConfig(
            "profiling-events",
            "/org/elasticsearch/xpack/profiling/index-template/profiling-events.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE
        ),
        new IndexTemplateConfig(
            "profiling-metrics",
            "/org/elasticsearch/xpack/profiling/index-template/profiling-metrics.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE
        ),
        new IndexTemplateConfig(
            "profiling-hosts",
            "/org/elasticsearch/xpack/profiling/index-template/profiling-hosts.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE
        ),
        new IndexTemplateConfig(
            "profiling-executables",
            "/org/elasticsearch/xpack/profiling/index-template/profiling-executables.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE
        ),
        new IndexTemplateConfig(
            "profiling-stackframes",
            "/org/elasticsearch/xpack/profiling/index-template/profiling-stackframes.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE
        ),
        new IndexTemplateConfig(
            "profiling-stacktraces",
            "/org/elasticsearch/xpack/profiling/index-template/profiling-stacktraces.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE
        ),
        ...
        new IndexTemplateConfig(
            ...
            "/org/elasticsearch/xpack/profiling/index-template/profiling-returnpads-private.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE,
        ...
        new IndexTemplateConfig(
            ...
            "/org/elasticsearch/xpack/profiling/index-template/profiling-sq-executables.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE,
        ...
        new IndexTemplateConfig(
            ...
            "/org/elasticsearch/xpack/profiling/index-template/profiling-sq-leafframes.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE,
        ...
        new IndexTemplateConfig(
            ...
            "/org/elasticsearch/xpack/profiling/index-template/profiling-symbols-global.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE
        ),
        new IndexTemplateConfig(
            "profiling-symbols-private",
            "/org/elasticsearch/xpack/profiling/index-template/profiling-symbols-private.json",
            INDEX_TEMPLATE_VERSION,
            PROFILING_TEMPLATE_VERSION_VARIABLE
        )
    );

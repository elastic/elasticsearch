...
public final class DataTypeConverter {
    ...
    public static byte safeToByte(long x) {
        if (x > Byte.MAX_VALUE || x < Byte.MIN_VALUE) {
            throw new QlClientIllegalArgumentException("[{}] out of [byte] range", x);
        }
        return (byte) x;
    }
    ...
    public static short safeToShort(long x) {
        if (x > Short.MAX_VALUE || x < Short.MIN_VALUE) {
            throw new QlClientIllegalArgumentException("[{}] out of [short] range", x);
        }
        return (short) x;
    }
    ...
    public static int safeToInt(long x) {
        if (x > Integer.MAX_VALUE || x < Integer.MIN_VALUE) {
            throw new QlClientIllegalArgumentException("[{}] out of [integer] range", x);
        }
        return (int) x;
    }
    ...
    public static long safeDoubleToLong(double x) {
        if (x > Long.MAX_VALUE || x < Long.MIN_VALUE) {
            throw new QlClientIllegalArgumentException("[{}] out of [long] range", x);
        }
        return Math.round(x);
    }
    ...
    public static Long safeToLong(Number x) {
        try {
            ...
            throw new QlClientIllegalArgumentException(ae, "[{}] out of [long] range", x);
        }
    }

    public static BigInteger safeToUnsignedLong(Double x) {
        if (inUnsignedLongRange(x) == false) {
            throw new QlClientIllegalArgumentException("[{}] out of [unsigned_long] range", x);
        }
    ...
    public static boolean convertToBoolean(String val) {
        ...
        if (Booleans.isBoolean(lowVal) == false) {
            throw new QlClientIllegalArgumentException("cannot cast [{}] to [boolean]", val);
        }
    ...
    public static Object convert(Object value, DataType dataType) {
        ...
        if (converter == null) {
            throw new QlClientIllegalArgumentException(
    ...
    public enum DefaultConverter implements Converter {
        ...
        STRING_TO_IP(o -> {
            if (InetAddresses.isInetAddress(o.toString()) == false) {
                throw new QlClientIllegalArgumentException("[{}] is not a valid IPv4 or IPv6 address", o);
            }
            return o;
        }),
        ...
        public static Function<Object, Object> fromString(Function<String, Object> converter, String to) {
            return (Object value) -> {
                try {
                    ...
                    throw new QlClientIllegalArgumentException(e, "cannot cast [{}] to [{}]", value, to);
                } catch (DateTimeParseException | IllegalArgumentException e) {
                    throw new QlClientIllegalArgumentException(e, "cannot cast [{}] to [{}]: {}", value, to, e.getMessage());
                }
            };
        }

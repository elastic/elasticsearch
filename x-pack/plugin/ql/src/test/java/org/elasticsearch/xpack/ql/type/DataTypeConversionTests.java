...
import static org.elasticsearch.xpack.ql.type.DataTypeConversion.commonType;
...
public class DataTypeConversionTests extends ESTestCase {
    ...
    public void testConversionToDate() {
        ...
        {
            Exception e = expectThrows(QlIllegalArgumentException.class, () -> conversionFor(TIME, to));

...
public class DataTypeConversionTests extends ESTestCase {
    ...
    public void testConversionToLong() {
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(longPlus));
    ...
    public void testConversionToUnsignedLong() {
        DataType to = UNSIGNED_LONG;
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(ulmAsDouble));
            assertEquals("[" + ulmAsDouble + "] out of [unsigned_long] range", e.getMessage());

            Double nd = -Math.abs(randomDouble());
            e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(nd));
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(bi.negate()));
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(asDateTime(-l)));
        ...
        }
        {
            ...
            Exception e = expectThrows(
                ...
                () -> conversion.convert(BigInteger.ONE.negate().toString())
            );
            assertEquals("[-1] out of [unsigned_long] range", e.getMessage());
            e = expectThrows(
                QlClientIllegalArgumentException.class,
                () -> conversion.convert(UNSIGNED_LONG_MAX.add(BigInteger.ONE).toString())
            );
    ...
    public void testConversionToInt() {
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(bip));
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(asDateTime(Long.MAX_VALUE)));
            assertEquals("[" + Long.MAX_VALUE + "] out of [integer] range", e.getMessage());
        }
    }
    ...
    public void testConversionToShort() {
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(asDateTime(Integer.MAX_VALUE)));
            assertEquals("[" + Integer.MAX_VALUE + "] out of [short] range", e.getMessage());
        }
    }

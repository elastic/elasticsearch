...
public class RRFRankSingleShardIT extends ESSingleNodeTestCase {
    ...
    public void testTotalDocsSmallerThanSize() {
        ...
        KnnSearchBuilder knnSearch = new KnnSearchBuilder("vector", queryVector, 3, 3, 10f, null, null, null);
    ...
    public void testBM25AndKnn() {
        ...
        KnnSearchBuilder knnSearch = new KnnSearchBuilder("vector_asc", queryVector, 101, 1001, 10f, null, null, null);
        assertResponse(
    ...
    public void testMultipleOnlyKnn() {
        ...
        KnnSearchBuilder knnSearchAsc = new KnnSearchBuilder("vector_asc", queryVectorAsc, 51, 1001, 10f, null, null, null);
        KnnSearchBuilder knnSearchDesc = new KnnSearchBuilder("vector_desc", queryVectorDesc, 51, 1001, 10f, null, null, null);
        assertResponse(
            client().prepareSearch("nrd_index")
    ...
    public void testMultiBM25AndMultipleKnn() {
        float[] queryVectorAsc = { 500.0f };
        float[] queryVectorDesc = { 500.0f };
        KnnSearchBuilder knnSearchAsc = new KnnSearchBuilder("vector_asc", queryVectorAsc, 101, 1001, 10f, null, null, null);
        KnnSearchBuilder knnSearchDesc = new KnnSearchBuilder("vector_desc", queryVectorDesc, 101, 1001, 10f, null, null, null);
        assertResponse(
            client().prepareSearch("nrd_index")
                .setRankBuilder(new RRFRankBuilder(101, 1))
                .setTrackTotalHits(false)

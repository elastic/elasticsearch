...
public final class RepositoriesNodeStatsResponse extends BaseNodeResponse implements ToXContentFragment {

    final List<RepositoryStatsSnapshot> repositoryStatsSnapshots;

    public RepositoriesNodeStatsResponse(DiscoveryNode node, List<RepositoryStatsSnapshot> repositoryStatsSnapshots) {
        super(node);

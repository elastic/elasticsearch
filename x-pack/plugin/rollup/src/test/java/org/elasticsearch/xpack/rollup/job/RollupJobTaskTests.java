        ...
        try (var threadPool = createThreadPool()) {
            ...
            RollupJobTask task = new RollupJobTask(
                ...
                public void updatePersistentTaskState(
                    ...
                    ActionListener<PersistentTasksMetadataSection.PersistentTask<?>> listener
                ) {
                    ...
                    listener.onResponse(
                        new PersistentTasksMetadataSection.PersistentTask<>(
                            "foo",
                            RollupField.TASK_NAME,
                            job,
                            1,
                            new PersistentTasksMetadataSection.Assignment("foo", "foo")
                        )
                    );

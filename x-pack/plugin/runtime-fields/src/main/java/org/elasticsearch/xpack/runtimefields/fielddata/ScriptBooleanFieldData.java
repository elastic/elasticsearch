...
public final class ScriptBooleanFieldData extends IndexNumericFieldData {
    ...
    public static class Builder implements IndexFieldData.Builder {
        ...
        private final BooleanScript.LeafFactory leafFactory;

        public Builder(String name, BooleanScript.LeafFactory leafFactory) {
            this.name = name;
    ...
    private ScriptBooleanFieldData(String fieldName, BooleanScript.LeafFactory leafFactory) {

...
public final class ScriptDateFieldData extends IndexNumericFieldData {
    ...
    public static class Builder implements IndexFieldData.Builder {
        ...
        private final DateScript.LeafFactory leafFactory;

        public Builder(String name, DateScript.LeafFactory leafFactory) {
            this.name = name;
    ...
    private ScriptDateFieldData(String fieldName, DateScript.LeafFactory leafFactory) {

...
public final class ScriptDoubleFieldData extends IndexNumericFieldData {
    ...
    public static class Builder implements IndexFieldData.Builder {
        ...
        private final DoubleScript.LeafFactory leafFactory;

        public Builder(String name, DoubleScript.LeafFactory leafFactory) {
            this.name = name;
    ...
    DoubleScript.LeafFactory leafFactory;

    private ScriptDoubleFieldData(String fieldName, DoubleScript.LeafFactory leafFactory) {

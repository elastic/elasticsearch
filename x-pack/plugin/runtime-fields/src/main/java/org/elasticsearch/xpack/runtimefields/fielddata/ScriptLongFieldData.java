...
public final class ScriptLongFieldData extends IndexNumericFieldData {
    ...
    public static class Builder implements IndexFieldData.Builder {
        ...
        private final LongScript.LeafFactory leafFactory;

        public Builder(String name, LongScript.LeafFactory leafFactory) {
            this.name = name;
    ...
    private ScriptLongFieldData(String fieldName, LongScript.LeafFactory leafFactory) {

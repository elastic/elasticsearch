...
public final class ScriptIpMappedFieldType extends AbstractScriptMappedFieldType<IpScript.LeafFactory> {
    ScriptIpMappedFieldType(String name, Script script, IpScript.Factory scriptFactory, Map<String, String> meta) {

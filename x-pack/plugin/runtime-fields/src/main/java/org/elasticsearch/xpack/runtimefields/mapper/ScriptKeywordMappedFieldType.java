...
public final class ScriptKeywordMappedFieldType extends AbstractScriptMappedFieldType<StringScript.LeafFactory> {
    ScriptKeywordMappedFieldType(String name, Script script, StringScript.Factory scriptFactory, Map<String, String> meta) {

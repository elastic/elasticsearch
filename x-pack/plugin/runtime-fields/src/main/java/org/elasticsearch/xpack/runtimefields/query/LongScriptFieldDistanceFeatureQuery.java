...
public final class LongScriptFieldDistanceFeatureQuery extends AbstractScriptFieldQuery<AbstractLongScript> {
    ...
    public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost) throws IOException {
        return new Weight(this) {
            ...
            public Explanation explain(LeafReaderContext context, int doc) {
                AbstractLongScript script = scriptContextFunction().apply(context);
    ...
    private class DistanceScorer extends Scorer {
        ...
        protected DistanceScorer(Weight weight, AbstractLongScript script, int maxDoc, float boost) {
            super(weight);
            this.script = script;
    ...
    long minAbsoluteDistance(AbstractLongScript script) {
    ...
    long valueWithMinAbsoluteDistance(AbstractLongScript script) {
        long minDistance = Long.MAX_VALUE;

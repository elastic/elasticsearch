...
public class ConfigAdditionalNodes extends KeyStoreAwareCommand {
    ...
    public ConfigAdditionalNodes(BiFunction<Environment, String, CommandLineHttpClient> clientFunction) {
        super("Configures security so that this node can join an existing cluster");
        this.clientFunction = clientFunction;
    }

    public ConfigAdditionalNodes() {
        this(CommandLineHttpClient::new);
    }

    public static void main(String[] args) throws Exception {
        exit(new ConfigAdditionalNodes().main(args, Terminal.DEFAULT));
    }
    ...
    protected void execute(Terminal terminal, OptionSet options, Environment env) throws Exception {
        ...
        try (KeyStoreWrapper nodeKeystore = KeyStoreWrapper.bootstrap(env.configFile(), () -> {
            ...
            if (nodeKeystore.getSettingNames().contains("xpack.security.transport.ssl.keystore.secure_password")
                ...
                throw new UserException(
                    ExitCodes.CONFIG,
                    "Aborting auto configuration because the node keystore contains password and settings already"
                );
            }

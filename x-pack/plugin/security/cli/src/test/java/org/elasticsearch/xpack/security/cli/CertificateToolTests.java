...
public class CertificateToolTests extends ESTestCase {
    ...
    public void testGetCAInfo() throws Exception {
        ...
        assertThat(terminal.getOutput(), containsString("Generating certificates without providing a CA certificate is deprecated."));
    ...
    public void testCreateCaAndMultipleInstances() throws Exception {
        ...
        if (selfSigned) {
            ...
            assertEquals(node3x509Certificate.getIssuerX500Principal(), ((X509Certificate) certificateChain[1]).getSubjectX500Principal());
        }
    }
    ...
    private void checkTrust(KeyStore keyStore, char[] keyPassword, KeyStore trustStore, boolean trust) throws Exception {
        final X509ExtendedKeyManager keyManager = CertParsingUtils.keyManager(
            keyStore,
            keyPassword,

 ...
 * {@code ExtensiblePlugin.loadExtensions} are discovered by the security plugin and their handlers are invoked by the running
...
public class EncryptedDataHandlerProviderSpiIT extends ESRestTestCase {
    ...
    public static ElasticsearchCluster cluster = ElasticsearchCluster.local()
        ...
        .setting("xpack.security.encryption.key_rotation.interval", "1s")
        .setting("xpack.security.encryption.key_rotation.check_interval", "1s")
        .systemProperty("es.primary_encryption_key_feature_flag_enabled", "true")

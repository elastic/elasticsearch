...
public class RemoteClusterSecurityCssWithMixedRemotesRestIT extends AbstractRemoteClusterSecurityCcsWithMultipleRemotesRestIT {
    ...
    @Override
    protected void setupRolesOnClusters() throws IOException {

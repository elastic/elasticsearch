...
public class RemoteClusterSecuritySpecialUserIT extends AbstractRemoteClusterSecurityTestCase {
    ...
    public void testManagedServiceAccountCrossClusterSearch() throws Exception {
        configureRemoteCluster();

        final String roleName = "managed_ccs_shared_logs";
        final String namespace = "ccs_poc";
        ...
        try {
            ...
            final Request deleteManagedAccountRequest = new Request("DELETE", "/_security/service/" + namespace + "/" + service);
            assertOK(adminClient().performRequest(deleteManagedAccountRequest));

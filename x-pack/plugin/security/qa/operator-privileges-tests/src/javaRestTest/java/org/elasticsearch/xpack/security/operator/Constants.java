...
public class Constants {
    ...
    public static final Set<String> NON_OPERATOR_ACTIONS = Stream.of(
        ...
        "cluster:admin/xpack/security/user_managed_service_account/delete",
        "cluster:admin/xpack/security/user_managed_service_account/put",
        "cluster:admin/xpack/security/user_managed_service_account/token/create",
        "cluster:admin/xpack/security/user_managed_service_account/token/delete",
        ...
        "cluster:monitor/xpack/info/columnar",
        ...
        "cluster:monitor/xpack/usage/columnar",

...
public class FailureStoreSecurityRestIT extends ESRestTestCase {
    ...
    public void testFailureStoreAccess() throws Exception {
        ...
        }
        {
            ...
            for (var user : users) {
                switch (user) {
                    case DATA_ACCESS, FAILURE_STORE_ACCESS, FAILURE_INDEX_DATA_ACCESS, BACKING_INDEX_DATA_ACCESS,
                        FAILURE_INDEX_FAILURE_ACCESS, BACKING_INDEX_FAILURE_ACCESS:
                        expectSearchThrows(user, request, 403);
                        expectEsqlThrows(user, request, 403);
                        break;
        ...
        }
        {
            ...
            for (var user : users) {
                switch (user) {
                    case FAILURE_STORE_ACCESS, BACKING_INDEX_DATA_ACCESS, FAILURE_INDEX_DATA_ACCESS, BACKING_INDEX_FAILURE_ACCESS,
                        FAILURE_INDEX_FAILURE_ACCESS:
                        expectSearchThrows(user, request, 403);
                        expectEsqlThrows(user, request, 403);
                        break;
            ...
            for (var user : users) {
                switch (user) {
                    case FAILURE_STORE_ACCESS:
                        ...
                        break;
                    case BACKING_INDEX_DATA_ACCESS, BACKING_INDEX_FAILURE_ACCESS, FAILURE_INDEX_DATA_ACCESS, FAILURE_INDEX_FAILURE_ACCESS,
                        DATA_ACCESS, STAR_READ_ONLY_ACCESS:
                        expectSearchThrows(user, request, 403);
                        expectEsqlThrows(user, request, 403);
                        break;
                    case ADMIN_USER, BOTH_ACCESS:

...
public class DateMathExpressionIntegTests extends SecurityIntegTestCase {
    ...
    public void testDateMathExpressionsCanBeAuthorized() throws Exception {
        ...
        IndexResponse response = client.prepareIndex(expression, "type")
            .setSource("foo", "bar")
        ...
        MultiGetResponse multiGetResponse = client.prepareMultiGet().add(expression, "type", response.getId()).get();

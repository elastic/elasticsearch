...
public class FieldLevelSecurityTests extends SecurityIntegTestCase {
    ...
    public void testKnnSearch() throws IOException {
        ...
        KnnVectorQueryBuilder query = new KnnVectorQueryBuilder("vector", queryVector, 10, 10, 10f, null, null, null);
        ...
        KnnVectorQueryBuilder filterQuery1 = new KnnVectorQueryBuilder("vector", queryVector, 10, 10, 10f, null, null, null).addFilterQuery(
        ...
        KnnVectorQueryBuilder filterQuery2 = new KnnVectorQueryBuilder("vector", queryVector, 10, 10, 10f, null, null, null).addFilterQuery(

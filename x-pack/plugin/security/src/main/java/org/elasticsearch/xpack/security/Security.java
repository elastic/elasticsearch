...
import org.elasticsearch.xpack.security.action.saml.TransportSamlLogoutResponseAction;
...
import org.elasticsearch.xpack.security.rest.action.saml.RestSamlLogoutResponseAction;
...
public class Security extends Plugin implements SystemIndexPlugin, IngestPlugin, NetworkPlugin, ClusterPlugin,
    ...
    public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
        ...
        return Arrays.asList(
                ...
                new ActionHandler<>(SamlLogoutResponseAction.INSTANCE, TransportSamlLogoutResponseAction.class),

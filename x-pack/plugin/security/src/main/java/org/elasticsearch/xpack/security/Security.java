...
import org.elasticsearch.xpack.security.rest.action.saml.RestSamlVerifyLogoutAction;
...
public class Security extends Plugin implements SystemIndexPlugin, IngestPlugin, NetworkPlugin, ClusterPlugin,
    ...
    public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
        ...
        return Arrays.asList(
                ...
                new ActionHandler<>(SamlVerifyLogoutAction.INSTANCE, TransportSamlVerifyLogoutAction.class),

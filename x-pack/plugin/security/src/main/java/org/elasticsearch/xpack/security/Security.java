...
import org.elasticsearch.xpack.security.action.apikey.TransportSearchApiKeyAction;
...
import org.elasticsearch.xpack.security.rest.action.apikey.RestSearchApiKeyAction;
...
public class Security extends Plugin implements SystemIndexPlugin, IngestPlugin, NetworkPlugin, ClusterPlugin,
    ...
    public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
        ...
        return Arrays.asList(
                ...
                new ActionHandler<>(SearchApiKeyAction.INSTANCE, TransportSearchApiKeyAction.class),
    ...
    public List<RestHandler> getRestHandlers(Settings settings, RestController restController, ClusterSettings clusterSettings,
        ...
        return Arrays.asList(
                ...
                new RestSearchApiKeyAction(settings, getLicenseState()),

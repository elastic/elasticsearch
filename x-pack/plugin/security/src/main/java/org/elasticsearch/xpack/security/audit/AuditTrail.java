...
public interface AuditTrail {
    ...
    void anonymousAccessDenied(String requestId, HttpRequestLineAndHeaders request);

    void authenticationFailed(String requestId, HttpRequestLineAndHeaders request);
    ...
    void authenticationFailed(String requestId, AuthenticationToken token, HttpRequestLineAndHeaders request);
    ...
    void authenticationFailed(String requestId, String realm, AuthenticationToken token, HttpRequestLineAndHeaders request);
    ...
    void tamperedRequest(String requestId, HttpRequestLineAndHeaders request);

...
public class AuthorizationService {
    ...
    private void handleIndexActionAuthorizationResult(
        ...
        if (IndexPrivilege.CREATE_INDEX_MATCHER.test(action)) {
            ...
            authorizeModifyDataStreams(requestInfo, requestId, authzInfo, authzEngine, metadata, listener);
    ...
    private void authorizeModifyDataStreams(
        ...
        authzEngine.authorizeIndexAction(
            dsRequestInfo,
            authzInfo,
            ril -> ril.onResponse(new ResolvedIndices(dataStreamNames, Collections.emptyList())),
            metadata,
            wrapPreservingContext(
                new AuthorizationResultListener<>(
                    authorizationResult -> runRequestInterceptors(requestInfo, authzInfo, authorizationEngine, listener),
     ...
     */
    private static class DataStreamAuthorizationRequest extends TransportRequest implements IndicesRequest {

...
public class NativeRolesStore implements BiConsumer<Set<String>, ActionListener<RoleRetrievalResult>> {
        ...
        if (securityIndex.indexExists() == false) {
            ...
            securityIndex.checkIndexVersionThenExecute(listener::onFailure, () -> {
                ...
                try (ThreadContext.StoredContext ignore = stashWithOrigin(client.threadPool().getThreadContext(), SECURITY_ORIGIN)) {
                    SearchRequest request = client.prepareSearch(SecurityIndexManager.SECURITY_ALIAS_NAME)
            ...
            securityIndex.checkIndexVersionThenExecute(listener::onFailure, () -> {
                ...
                MultiGetRequest multiGetRequest = client.prepareMultiGet().add(SECURITY_ALIAS_NAME, ROLE_DOC_TYPE, roleIds).request();
    ...
    public void deleteRole(final DeleteRoleRequest deleteRoleRequest, final ActionListener<Boolean> listener) {
        ...
        if (frozenSecurityIndex.indexExists() == false) {
            ...
            securityIndex.checkIndexVersionThenExecute(listener::onFailure, () -> {
                DeleteRequest request = client.prepareDelete(SecurityIndexManager.SECURITY_ALIAS_NAME,
    ...
    void innerPutRole(final PutRoleRequest request, final RoleDescriptor role, final ActionListener<Boolean> listener) {
        securityIndex.prepareIndexIfNeededThenExecute(listener::onFailure, () -> {
            ...
            final IndexRequest indexRequest = client.prepareIndex(SECURITY_ALIAS_NAME, ROLE_DOC_TYPE, getIdForRole(role.getName()))
            ...
            securityIndex.checkIndexVersionThenExecute(listener::onFailure, () ->
                executeAsyncWithOrigin(client.threadPool().getThreadContext(), SECURITY_ORIGIN,
                    client.prepareMultiSearch()
                        .add(client.prepareSearch(SecurityIndexManager.SECURITY_ALIAS_NAME)
    ...
    private void executeGetRoleRequest(String role, ActionListener<GetResponse> listener) {
        securityIndex.checkIndexVersionThenExecute(listener::onFailure, () ->
            executeAsyncWithOrigin(client.threadPool().getThreadContext(), SECURITY_ORIGIN,
                    client.prepareGet(SECURITY_ALIAS_NAME,

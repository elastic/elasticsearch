...
public class RestGetRolesAction extends SecurityBaseRestHandler {
    ...
    public List<ReplacedRestApi> replacedMethodsAndPaths() {
        ...
        return Collections.unmodifiableList(Arrays.asList(
            new ReplacedRestApi(GET, "/_security/role/", GET, "/_xpack/security/role/", deprecationLogger),
            new ReplacedRestApi(GET, "/_security/role/{name}", GET, "/_xpack/security/role/{name}", deprecationLogger)
        ));
    }

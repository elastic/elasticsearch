...
public class RestPutRoleAction extends SecurityBaseRestHandler {
    ...
    public List<ReplacedRestApi> replacedMethodsAndPaths() {
        ...
        return Collections.unmodifiableList(Arrays.asList(
            new ReplacedRestApi(POST, "/_security/role/{name}", POST, "/_xpack/security/role/{name}", deprecationLogger),
            new ReplacedRestApi(PUT, "/_security/role/{name}", PUT, "/_xpack/security/role/{name}", deprecationLogger)
        ));
    }

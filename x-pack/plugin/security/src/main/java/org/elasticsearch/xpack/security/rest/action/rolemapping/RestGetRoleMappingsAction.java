...
public class RestGetRoleMappingsAction extends SecurityBaseRestHandler {
    ...
    public List<ReplacedRestApi> replacedMethodsAndPaths() {
        ...
        return Collections.unmodifiableList(Arrays.asList(
            new ReplacedRestApi(GET, "/_security/role_mapping/", GET, "/_xpack/security/role_mapping/", deprecationLogger),
            new ReplacedRestApi(GET, "/_security/role_mapping/{name}", GET, "/_xpack/security/role_mapping/{name}", deprecationLogger)
        ));
    }

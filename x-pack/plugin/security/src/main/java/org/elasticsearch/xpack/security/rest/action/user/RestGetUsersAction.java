...
public class RestGetUsersAction extends SecurityBaseRestHandler {
    ...
    public List<ReplacedRestApi> replacedMethodsAndPaths() {
        ...
        return Collections.unmodifiableList(Arrays.asList(
            new ReplacedRestApi(GET, "/_security/user/", GET, "/_xpack/security/user/", deprecationLogger),
            new ReplacedRestApi(GET, "/_security/user/{username}", GET, "/_xpack/security/user/{username}", deprecationLogger)
        ));
    }

    ...
    private AsyncSender interceptForAllRequests(AsyncSender sender) {
        return new AsyncSender() {
            ...
            public <T extends TransportResponse> void sendRequest(
                ...
                final boolean isRemoteConnection = remoteClusterTransportInterceptor.isRemoteClusterConnection(connection);
                if (isRemoteConnection || PreAuthorizationUtils.shouldRemoveParentAuthorizationFromThreadContext(action, securityContext)) {

...
public class IPFilter {
    ...
    public static final Map<String, Object> DISABLED_USAGE_STATS = new MapBuilder<String, Object>().put("http", false)
        .put("transport", false)
        .immutableMap();
    ...
    public boolean accept(String profile, InetSocketAddress peerAddress) {
        if (licenseState.isSecurityEnabled() == false || Security.IP_FILTERING_FEATURE.checkWithoutTracking(licenseState) == false) {
            return true;
        }

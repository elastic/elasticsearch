...
public class ClusterPrivilegeTests extends AbstractPrivilegeTestCase {
    ...
    public void testThatSnapshotAndRestore() throws Exception {
        ...
        assertAccessIsDenied("user_a", "GET", "/someindex/1");
        assertAccessIsDenied("user_b", "GET", "/someindex/1");
        assertAccessIsDenied("user_d", "GET", "/someindex/1");
        assertAccessIsAllowed("user_c", "GET", "/someindex/1");

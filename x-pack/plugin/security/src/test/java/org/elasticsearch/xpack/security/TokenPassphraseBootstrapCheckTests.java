...
public class TokenPassphraseBootstrapCheckTests extends ESTestCase {
    ...
    public void testTokenPassphraseCheck() throws Exception {
        assertFalse(new TokenPassphraseBootstrapCheck(Settings.EMPTY).check(new BootstrapContext(Settings.EMPTY, null)).isFailure());
        ...
        assertFalse(new TokenPassphraseBootstrapCheck(settings).check(new BootstrapContext(settings, null)).isFailure());
        ...
        assertTrue(new TokenPassphraseBootstrapCheck(settings).check(new BootstrapContext(settings, null)).isFailure());

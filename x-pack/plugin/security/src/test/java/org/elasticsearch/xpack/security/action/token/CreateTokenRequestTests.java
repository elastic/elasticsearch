...
public class CreateTokenRequestTests extends ESTestCase {
    ...
    public void testRequestValidation() {
        ...
        assertThat(ve.validationErrors().get(0), containsString("[kerberos, password, refresh_token]"));
    ...
    public void testRequestValidationKerberos() {
        CreateTokenRequest request = new CreateTokenRequest();
        ActionRequestValidationException ve = request.validate();
        assertNotNull(ve);
        assertEquals(1, ve.validationErrors().size());
        ...
        assertNotNull(ve);
        assertEquals(1, ve.validationErrors().size());
        assertThat(ve.validationErrors(), hasItem("kerberos ticket is missing"));

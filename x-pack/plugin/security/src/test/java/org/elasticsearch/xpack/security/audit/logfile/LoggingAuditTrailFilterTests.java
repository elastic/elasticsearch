...
public class LoggingAuditTrailFilterTests extends ESTestCase {
    ...
    public void testUsersFilter() throws Exception {
        ...
        auditTrail.authenticationSuccess(randomAlphaOfLength(8), unfilteredAuthentication, getHttpRequest());
        assertThat("AuthenticationSuccess rest request: unfiltered user is filtered out", logOutput.size(), is(1));
        logOutput.clear();
        threadContext.stashContext();

        auditTrail.authenticationSuccess(randomAlphaOfLength(8), filteredAuthentication, getHttpRequest());
    ...
    public void testRealmsFilter() throws Exception {
        ...
        // authentication Success
        auditTrail.authenticationSuccess(randomAlphaOfLength(8), createAuthentication(user, authUser, unfilteredRealm), getHttpRequest());
        assertThat("AuthenticationSuccess rest request: unfiltered realm is filtered out", logOutput.size(), is(1));
        logOutput.clear();
        threadContext.stashContext();

        auditTrail.authenticationSuccess(randomAlphaOfLength(8), createAuthentication(user, authUser, filteredRealm), getHttpRequest());
    ...
    public void testRolesFilter() throws Exception {
        ...
        // authentication Success
        auditTrail.authenticationSuccess(randomAlphaOfLength(8), authentication, getHttpRequest());
        if (filterMissingRoles) {
    ...
    public void testActionsFilter() throws Exception {
        ...
        // authentication Success
        auditTrail.authenticationSuccess(randomAlphaOfLength(8), createAuthentication(user, authUser, "realm"), getHttpRequest());
        if (filterMissingAction) {
    ...
    private HttpRequest getHttpRequest() throws IOException {
        ...
        return builder.build().getHttpRequest();
    }

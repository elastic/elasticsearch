...
public class TokenAuthIntegTests extends SecurityIntegTestCase {
    ...
    public void testExpiredTokensDeletedAfterExpiration() throws Exception {
        ...
        assertBusy(() -> {
            SearchResponse searchResponse = client.prepareSearch(SECURITY_MAIN_ALIAS)
        ...
        client.prepareUpdate(SECURITY_MAIN_ALIAS, SINGLE_MAPPING_NAME, docId.get())
        ...
        assertBusy(() -> {
            ...
            client.admin().indices().prepareRefresh(SECURITY_MAIN_ALIAS).get();
            SearchResponse searchResponse = client.prepareSearch(SECURITY_MAIN_ALIAS)
                    .setSource(SearchSourceBuilder.searchSource()
                        .query(QueryBuilders.termQuery("doc_type", "token")))
                    .setTerminateAfter(1)
    ...
    public void testRefreshingMultipleTimesFails() throws Exception {
        ...
        UpdateResponse updateResponse = client.prepareUpdate(SECURITY_MAIN_ALIAS, SINGLE_MAPPING_NAME, docId.get())

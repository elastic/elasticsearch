...
public class TokenAuthIntegTests extends SecurityIntegTestCase {
    ...
    public void testExpiredTokensDeletedAfterExpiration() throws Exception {
        ...
        assertBusy(() -> {
            SearchResponse searchResponse = client.prepareSearch(SystemIndicesNames.SECURITY_INDEX_NAME)
        ...
        client.prepareUpdate(SystemIndicesNames.SECURITY_INDEX_NAME, "doc", docId.get())
        ...
        assertBusy(() -> {
            ...
            client.admin().indices().prepareRefresh(SystemIndicesNames.SECURITY_INDEX_NAME).get();
            SearchResponse searchResponse = client.prepareSearch(SystemIndicesNames.SECURITY_INDEX_NAME)
                    .setSource(SearchSourceBuilder.searchSource()
                        .query(QueryBuilders.termQuery("doc_type", "token")))
                    .setTerminateAfter(1)

...
public class JwtHeaderValidatorTests extends ESTestCase {
    ...
    public void testValidHeader() throws ParseException {
        ...
        final SignedJWT jwt = prepareJwt(randomFrom(Map.of("alg", algorithm), Map.of("typ", "JWT", "alg", algorithm)));
    ...
    public void testInvalidTyp() throws ParseException {
        ...
        final SignedJWT jwt = prepareJwt(Map.of("typ", randomAlphaOfLengthBetween(4, 8), "alg", algorithm));
    ...
    public void testMismatchingAlgorithm() throws ParseException {
        ...
        final SignedJWT jwt = prepareJwt(Map.of("alg", algorithm));
        final ElasticsearchSecurityException e = expectThrows(ElasticsearchSecurityException.class, () -> validator.validate(jwt));
    ...
    private SignedJWT prepareJwt(Map<String, Object> m) throws ParseException {
        final JWSHeader jwsHeader = JWSHeader.parse(m);

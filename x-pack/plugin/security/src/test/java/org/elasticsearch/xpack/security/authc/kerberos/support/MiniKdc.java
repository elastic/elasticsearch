...
public class MiniKdc {
     ...
     * @param workDir
     *            working directory, it should be the build directory. Under this
     *            directory an ApacheDS working directory will be created, this
     ...
     *
     * @param keytabFile
     *            keytab file to add the created principals.
     * @param principals

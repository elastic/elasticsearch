...
public class SessionFactoryTests extends ESTestCase {
    ...
    public void testConnectionFactoryReturnsCorrectLDAPConnectionOptionsWithDefaultSettings() throws Exception {
        ...
        RealmConfig realmConfig = new RealmConfig(new RealmConfig.RealmIdentifier("ldap", "conn_settings"),
                environment.settings(), environment, new ThreadContext(Settings.EMPTY), Integer.MAX_VALUE);
    ...
    public void testConnectionFactoryReturnsCorrectLDAPConnectionOptions() throws Exception {
        ...
        RealmConfig realmConfig = new RealmConfig(realmId, settings, environment, new ThreadContext(settings), Integer.MAX_VALUE);
        ...
        settings = Settings.builder()
                ...
                .put("path.home", pathHome)
                .build();
        realmConfig = new RealmConfig(realmId, settings, environment, new ThreadContext(settings), Integer.MAX_VALUE);
    ...
    private SessionFactory createSessionFactory() {
        ...
        final RealmConfig realmConfig = new RealmConfig(realmIdentifier,
                Settings.builder()
                        ...
                        .put(global)
                        .build(),
                TestEnvironment.newEnvironment(global), new ThreadContext(Settings.EMPTY), Integer.MAX_VALUE);

...
public class HasherTests extends ESTestCase {
    ...
    public void testPBKDF2FamilySelfGenerated() throws Exception {
        ...
        testHasherSelfGenerated(Hasher.PBKDF2_APPROVED_ONLY);
        testHasherSelfGenerated(Hasher.PBKDF2_APPROVED_ONLY_1000);
        testHasherSelfGenerated(Hasher.PBKDF2_APPROVED_ONLY_10000);
        testHasherSelfGenerated(Hasher.PBKDF2_APPROVED_ONLY_50000);
        testHasherSelfGenerated(Hasher.PBKDF2_APPROVED_ONLY_100000);
        testHasherSelfGenerated(Hasher.PBKDF2_APPROVED_ONLY_500000);
        testHasherSelfGenerated(Hasher.PBKDF2_APPROVED_ONLY_1000000);
    }
    ...
    public void testResolve() {
        ...
        assertThat(Hasher.resolve("pbkdf2_approved_only"), sameInstance(Hasher.PBKDF2_APPROVED_ONLY));
        assertThat(Hasher.resolve("pbkdf2_approved_only_1000"), sameInstance(Hasher.PBKDF2_APPROVED_ONLY_1000));
        assertThat(Hasher.resolve("pbkdf2_approved_only_10000"), sameInstance(Hasher.PBKDF2_APPROVED_ONLY));
        assertThat(Hasher.resolve("pbkdf2_approved_only_50000"), sameInstance(Hasher.PBKDF2_APPROVED_ONLY_50000));
        assertThat(Hasher.resolve("pbkdf2_approved_only_100000"), sameInstance(Hasher.PBKDF2_APPROVED_ONLY_100000));
        assertThat(Hasher.resolve("pbkdf2_approved_only_500000"), sameInstance(Hasher.PBKDF2_APPROVED_ONLY_500000));
        assertThat(Hasher.resolve("pbkdf2_approved_only_1000000"), sameInstance(Hasher.PBKDF2_APPROVED_ONLY_1000000));
    ...
    public void testResolveFromHash() {
        ...
        assertThat(Hasher.resolveFromHash(
            "{PBKDF2_APPROVED_ONLY}1000$sTyix9e0zNINzq2aDZ+GD5+QlO94xVyf/bv4pWNhBxo=$4KuzGPy9HXnhY3ANHn8rcIRQuJHPB6cEtLwnOhDI5d4="
                .toCharArray()),
            sameInstance(Hasher.PBKDF2_APPROVED_ONLY_1000));
        assertThat(Hasher.resolveFromHash(
            "{PBKDF2_APPROVED_ONLY}10000$8M9+Ww0xkdY250CROEutsd8UP6CrJESw7ZAFu1NGORo=$ai0gxBPtHTfZU/nbNGwL5zjC+eo2/ANQM17L/tllVeo="
                .toCharArray()),
            sameInstance(Hasher.PBKDF2_APPROVED_ONLY));
        assertThat(Hasher.resolveFromHash(
            "{PBKDF2_APPROVED_ONLY}50000$uupwXiq8W0+jrLtC3/aqzuvyZlRarlmx1+CQGEnomlk=$by8q/+oRPPWwDE6an7B9/ndz7UZ1UQpaGY4CGurtPTI="
                .toCharArray()),
            sameInstance(Hasher.PBKDF2_APPROVED_ONLY_50000));
        assertThat(Hasher.resolveFromHash(
            "{PBKDF2_APPROVED_ONLY}100000$E9VqtV76PcrQuCZ6wOMMNvs4CMPcANTpzRw8Wjd24PU=$j56uKUvwbvmgQgNFkbV7SRQVZ2QOarokAgBeA8xcFD8="
                .toCharArray()),
            sameInstance(Hasher.PBKDF2_APPROVED_ONLY_100000));
        assertThat(Hasher.resolveFromHash(
            "{PBKDF2_APPROVED_ONLY}500000$4dpTEbu4jfjhDOjWY6xdsnxuQs4dg4QbNzZJ0Z1Tm4s=$Us/yrlCxVaW7mz0go1qIygFqGgcfUMgCZfIl2AvI4I8="
                .toCharArray()),
            sameInstance(Hasher.PBKDF2_APPROVED_ONLY_500000));
        assertThat(Hasher.resolveFromHash(
            "{PBKDF2_APPROVED_ONLY}1000000$eKeQvMztiIcqBynTNDFBseOBww3GBpHDZI6EPPVHYUw=$4587yrxUa02RZ1jeW1WOaMjRn5qT9iQ5/DIHk0nW2bE="
                .toCharArray()),
            sameInstance(Hasher.PBKDF2_APPROVED_ONLY_1000000));

...
public class ExpressionRoleMappingTests extends ESTestCase {
    ...
    public void testValidExpressionWithFixedRoleNames() throws Exception {
        ...
        final UserRoleMapper.UserData user1a = new UserRoleMapper.UserData(
            ...
            List.of(), Collections.singletonMap("active", true), realm
        );
        ...
        final UserRoleMapper.UserData user2 = new UserRoleMapper.UserData(
            ...
            List.of(), Collections.singletonMap("active", false), realm
        );
        ...
        final UserRoleMapper.UserData user4 = new UserRoleMapper.UserData(
                "peter.null", null, List.of(), Collections.singletonMap("active", true), realm
        );
        ...
        final UserRoleMapper.UserData userTony = new UserRoleMapper.UserData(
                "tony.stark", null, List.of("Audi R8 owners"), Collections.singletonMap("boss", true), realm
        );
        final UserRoleMapper.UserData userPepper = new UserRoleMapper.UserData(
                "pepper.potts", null, List.of("marvel", "cn=admins,dc=stark-enterprises,dc=com"), null, realm
        );
        final UserRoleMapper.UserData userMax = new UserRoleMapper.UserData(
                "max.rockatansky", null, List.of("bronze"), Collections.singletonMap("mad", true), realm
        );

...
public class AuthorizationServiceTests extends ESTestCase {
    ...
    public void setup() {
        ...
        fieldPermissionsCache = new FieldPermissionsCache(settings);
        ...
        authorizationService = new AuthorizationService(settings, rolesStore, clusterService, auditTrail,
                new DefaultAuthenticationFailureHandler(Collections.emptyMap()), threadPool, new AnonymousUser(settings), apiKeyService,
    ...
    public void testDoesNotUseRolesStoreForXPackUser() {
        ...
        verify(rolesStore, times(1)).roles(any(User.class), any(ActionListener.class));

...
public class AuthorizedIndicesTests extends ESTestCase {
    ...
    public void testAuthorizedIndicesUserWithoutRoles() {
        List<String> authorizedIndices =
            RBACEngine.resolveAuthorizedIndicesFromRole(Role.EMPTY, "", MetaData.EMPTY_META_DATA.getIndexSpaceLookup());
    ...
    public void testAuthorizedIndicesUserWithSomeRoles() {
        ...
        List<String> list =
            RBACEngine.resolveAuthorizedIndicesFromRole(roles, SearchAction.NAME, metaData.getIndexSpaceLookup());
    ...
    public void testAuthorizedIndicesUserWithSomeRolesEmptyMetaData() {
        ...
        List<String> authorizedIndices =
            RBACEngine.resolveAuthorizedIndicesFromRole(role, SearchAction.NAME, MetaData.EMPTY_META_DATA.getIndexSpaceLookup());
        assertTrue(authorizedIndices.isEmpty());
    }
    ...
    public void testSecurityIndicesAreRestrictedForDefaultRole() {
        ...
        List<String> authorizedIndices =
            RBACEngine.resolveAuthorizedIndicesFromRole(role, SearchAction.NAME, metaData.getIndexSpaceLookup());

...
//    @SuppressWarnings("unchecked")
    ...
    public void testDashIndicesAreAllowedInShardLevelRequests() {
        ...
        List<String> indices = defaultIndicesResolver.resolveIndicesAndAliases(SearchAction.NAME + "[s]", request)
                .getLocal();
    ...
    public void testWildcardsAreNotAllowedInShardLevelRequests() {
        ...
        IllegalArgumentException exception = expectThrows(
            ...
            () -> defaultIndicesResolver.resolveIndicesAndAliases(SearchAction.NAME + "[s]", request)
        );
        assertThat(
            exception,

...
public class IndicesAndAliasesResolverTests extends ESTestCase {
    ...
    public void setup() {
        ...
        Metadata metadata = Metadata.builder()
            ...
            .put(new DataStream(otherDataStreamName, createTimestampField("@timestamp"), Arrays.asList(dataStreamIndex3.getIndex())))
    ...
    public void testIndicesExists() {
        ...
        // indices exists api never throws exception due to missing indices, but only returns false instead.
        {
            ...
            assertNoIndices(request, resolveIndices(request, buildAuthorizedIndices(userNoIndices, IndicesExistsAction.NAME)));
        }

        {
            IndicesExistsRequest request = new IndicesExistsRequest("does_not_exist");

            assertNoIndices(request, resolveIndices(request, buildAuthorizedIndices(user, IndicesExistsAction.NAME)));
        }
        {

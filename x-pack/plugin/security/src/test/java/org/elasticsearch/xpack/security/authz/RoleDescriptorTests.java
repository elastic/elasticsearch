...
public class RoleDescriptorTests extends ESTestCase {
    ...
    public void testToXContent() throws Exception {
        ...
        final RenderableConditionalClusterPrivilege[] conditionalClusterPrivileges = {
            new ManageApplicationPrivileges(new LinkedHashSet<>(Arrays.asList("app01", "app02")))
        };
    ...
    public void testParse() throws Exception {
        ...
        final RenderableConditionalClusterPrivilege conditionalPrivilege = rd.getConditionalClusterPrivileges()[0];
        assertThat(conditionalPrivilege.getCategory(), equalTo(RenderableConditionalClusterPrivilege.Category.APPLICATION));

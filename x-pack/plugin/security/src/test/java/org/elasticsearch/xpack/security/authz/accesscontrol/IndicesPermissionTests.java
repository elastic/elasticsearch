...
public class IndicesPermissionTests extends ESTestCase {
    ...
    public void testAuthorize() {
        ...
        assertThat(permissions.getIndexPermissions("_index").getDocumentPermissions().getSingleSetOfRawQueries(), hasSize(1));
        assertThat(permissions.getIndexPermissions("_index").getDocumentPermissions().getSingleSetOfRawQueries(), equalTo(query));
        ...
        assertThat(permissions.getIndexPermissions("_index").getDocumentPermissions().getSingleSetOfRawQueries(), nullValue());
        ...
        assertThat(permissions.getIndexPermissions("_alias").getDocumentPermissions().getSingleSetOfRawQueries(), hasSize(1));
        assertThat(permissions.getIndexPermissions("_alias").getDocumentPermissions().getSingleSetOfRawQueries(), equalTo(query));
        ...
        assertFalse(permissions.getIndexPermissions("_index").getFieldPermissions().hasFieldLevelSecurity());
        assertThat(permissions.getIndexPermissions("_index").getDocumentPermissions().hasDocumentLevelPermissions(), is(true));
        assertThat(permissions.getIndexPermissions("_index").getDocumentPermissions().getSingleSetOfRawQueries(), hasSize(2));
        assertThat(permissions.getIndexPermissions("_index").getDocumentPermissions().getSingleSetOfRawQueries(), equalTo(bothQueries));
        ...
        assertThat(permissions.getIndexPermissions("_index_1").getDocumentPermissions().getSingleSetOfRawQueries(), hasSize(2));
        assertThat(permissions.getIndexPermissions("_index_1").getDocumentPermissions().getSingleSetOfRawQueries(), equalTo(bothQueries));

        assertThat(permissions.getIndexPermissions("_alias"), notNullValue());
        assertFalse(permissions.getIndexPermissions("_alias").getFieldPermissions().hasFieldLevelSecurity());
        assertThat(permissions.getIndexPermissions("_alias").getDocumentPermissions().hasDocumentLevelPermissions(), is(true));
        assertThat(permissions.getIndexPermissions("_alias").getDocumentPermissions().getSingleSetOfRawQueries(), hasSize(2));
        assertThat(permissions.getIndexPermissions("_alias").getDocumentPermissions().getSingleSetOfRawQueries(), equalTo(bothQueries));

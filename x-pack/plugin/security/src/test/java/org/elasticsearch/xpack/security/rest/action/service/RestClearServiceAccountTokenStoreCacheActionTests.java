...
public class RestClearServiceAccountTokenStoreCacheActionTests extends RestActionTestCase {
    ...
    public void testInnerPrepareRequestWithValidTokenNames() {
        ...
        final FakeRestRequest restRequest = new FakeRestRequest.Builder(NamedXContentRegistry.EMPTY).withMethod(RestRequest.Method.POST)
            .withPath(
                "/_security/service/"
                    ...
                    + service
                    + "/credential/token/"
                    + Strings.arrayToCommaDelimitedString(names)
                    + "/_clear_cache"
            )
            .build();
        ...
        final ClearSecurityCacheRequest clearSecurityCacheRequest = requestHolder.get();
        assertThat(
            Set.of(clearSecurityCacheRequest.keys()),
    ...
    public void testInnerPrepareRequestWillThrowErrorOnInvalidTokenNames() {
        final RestClearServiceAccountTokenStoreCacheAction restAction = new RestClearServiceAccountTokenStoreCacheAction(
            Settings.EMPTY,
            mock(XPackLicenseState.class)
        );
        final String[] names = randomArray(
            2,
            4,
            String[]::new,
        ...
        final FakeRestRequest fakeRestRequest = new FakeRestRequest.Builder(NamedXContentRegistry.EMPTY).withParams(
            Map.of(
                "namespace",
        ...
        final IllegalArgumentException e = expectThrows(
            ...
            () -> restAction.innerPrepareRequest(fakeRestRequest, mock(NodeClient.class))
        );

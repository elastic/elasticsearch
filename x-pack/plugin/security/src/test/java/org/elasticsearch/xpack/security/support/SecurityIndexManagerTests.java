...
public class SecurityIndexManagerTests extends ESTestCase {
    ...
    public void testIndexTemplateVersionMatching() throws Exception {
        ...
        assertFalse(SecurityIndexManager.checkTemplateExistsAndVersionMatches(SecurityIndexManager.SECURITY_MAIN_TEMPLATE_7, clusterState,
                logger, Version.V_7_0_0::after));
    }

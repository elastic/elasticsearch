...
public class SecurityServerTransportInterceptorTests extends ESTestCase {
    ...
    public void setUp() throws Exception {
        ...
        when(xPackLicenseState.isSecurityAllowed()).thenReturn(true);
    }
    ...
    public void testSendAsyncUserActionWhenUnlicensed() {
        ...
        when(xPackLicenseState.isSecurityAllowed()).thenReturn(false);
        ...
        verify(xPackLicenseState).isSecurityAllowed();
    ...
    public void testSendAsyncWithStateNotRecovered() {
        ...
        when(xPackLicenseState.isSecurityAllowed()).thenReturn(authAllowed);

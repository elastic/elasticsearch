...
public class ReservedSnapshotLifecycleStateServiceTests extends ESTestCase {
    ...
    public void testActionAddRemove() throws Exception {
        ...
        SnapshotLifecycleMetadata slmMetadata = updatedState.state().metadata().projectCustom(SnapshotLifecycleMetadata.TYPE);
        ...
        slmMetadata = updatedState.state().metadata().projectCustom(SnapshotLifecycleMetadata.TYPE);

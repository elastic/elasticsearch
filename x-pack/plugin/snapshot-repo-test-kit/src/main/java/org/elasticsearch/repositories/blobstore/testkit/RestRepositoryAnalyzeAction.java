...
public class RestRepositoryAnalyzeAction extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return Collections.singletonList(new Route(POST, "/_snapshot/{repository}/_analyze"));
    }
    ...
    public RestChannelConsumer prepareRequest(final RestRequest request, final NodeClient client) {
        ...
        return channel -> cancelClient.execute(
            ...
            new RestStatusToXContentListener<RepositoryAnalyzeAction.Response>(channel) {
                @Override

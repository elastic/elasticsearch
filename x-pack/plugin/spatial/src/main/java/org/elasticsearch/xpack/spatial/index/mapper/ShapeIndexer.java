...
public class ShapeIndexer implements AbstractGeometryFieldMapper.Indexer<Geometry, Geometry> {
    ...
    private class LuceneGeometryVisitor implements GeometryVisitor<Void, RuntimeException> {
        ...
        public Void visit(Line line) {
            addFields(XYShape.createIndexableFields(name, ShapeUtils.toLuceneLine(line)));
            return null;
        }
        ...
        public Void visit(Polygon polygon) {
            addFields(XYShape.createIndexableFields(name, ShapeUtils.toLucenePolygon(polygon)));
            return null;
        }

        @Override
        public Void visit(Rectangle r) {
            addFields(XYShape.createIndexableFields(name, ShapeUtils.toLucenePolygon(r)));
            return null;
        }

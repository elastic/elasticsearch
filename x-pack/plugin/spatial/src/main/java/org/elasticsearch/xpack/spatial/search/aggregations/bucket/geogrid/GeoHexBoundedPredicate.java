...
public class GeoHexBoundedPredicate {
    ...
    /** Check if the provided H3 cell intersects with the provided bounds. */
    public boolean validAddress(String address) {
        final H3LatLonGeom geometry = new H3LatLonGeom(address);
        return cellIntersectsBounds(geometry.toComponent2D());
    }

    /** Check if the provided H3 cell, after scaling, intersects with the provided bounds. */
    public boolean validAddress(String address, double scaleFactor) {
        final H3LatLonGeom.Scaled geometry = new H3LatLonGeom.Scaled(address, scaleFactor);
        return cellIntersectsBounds(geometry.toComponent2D());
    }
    ...
    static class H3LatLonGeom extends H3LatLonGeometry.Planar {
        ...
        static class Scaled extends H3LatLonGeometry.Planar.Scaled {

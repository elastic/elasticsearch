...
public abstract class ShapeBoundsAggregator<T extends SpatialPoint> extends MetricsAggregator {
    protected final ShapeValuesSource<?> valuesSource;
    ...
    public ShapeBoundsAggregator(
        ...
        this.valuesSource = valuesSourceConfig.hasValues() ? (ShapeValuesSource<?>) valuesSourceConfig.getValuesSource() : null;
    ...
    public LeafBucketCollector getLeafCollector(AggregationExecutionContext aggCtx, LeafBucketCollector sub) {
        ...
        ShapeValues<?> values = valuesSource.shapeValues(aggCtx.getLeafReaderContext());
        return new LeafBucketCollectorBase(sub, values) {
            ...
            public void collect(int doc, long bucket) throws IOException {
                if (values.advanceExact(doc)) {
                    ...
                    final ShapeValues.BoundingBox bounds = value.boundingBox();

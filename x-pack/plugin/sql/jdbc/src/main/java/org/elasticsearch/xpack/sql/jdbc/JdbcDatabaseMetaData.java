...
class JdbcDatabaseMetaData implements DatabaseMetaData, JdbcWrapper {
    ...
    private final EscapeWildcard escapeWildcards;
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern, String[] types) throws SQLException {
        ...
        ps.setString(1, catalog != null ? escapeStringPattern(catalog.trim(), EscapeWildcard.ALWAYS) : WILDCARD);
        ps.setString(2, tableNamePattern != null ? escapeStringPattern(tableNamePattern.trim(), escapeWildcards) : WILDCARD);
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern)
        ...
        ps.setString(2, tableNamePattern != null ? escapeStringPattern(tableNamePattern.trim(), escapeWildcards) : WILDCARD);
        ps.setString(3, columnNamePattern != null ? escapeStringPattern(columnNamePattern.trim(), escapeWildcards) : WILDCARD);
        return ps.executeQuery();
    }
    ...
    static String escapeStringPattern(String pattern, EscapeWildcard strategy) {
        if (StringUtils.hasText(pattern) == false || WILDCARD.equals(pattern) || "_".equals(pattern)) {
            return pattern;
        }
        ...
        switch (strategy) {
            case NEVER:
                return pattern;
            case ALWAYS:
                return pattern.replace(ESCAPE, ESCAPE + ESCAPE).replace("_", ESCAPE + "_").replace(WILDCARD, ESCAPE + WILDCARD);
            default:

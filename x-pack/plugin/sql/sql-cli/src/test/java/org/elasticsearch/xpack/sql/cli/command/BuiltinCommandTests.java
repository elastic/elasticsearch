...
public class BuiltinCommandTests extends SqlCliTestCase {
    ...
    public void testFetchSeparator() throws Exception {
        ...
        assertEquals("", cliSession.getConfiguration().getFetchSeparator());

        assertTrue(cliCommand.handle(testTerminal, cliSession, "fetch_separator = \"foo\""));
        assertEquals("foo", cliSession.getConfiguration().getFetchSeparator());
        ...
        assertEquals("bar", cliSession.getConfiguration().getFetchSeparator());
        ...
        assertEquals("baz", cliSession.getConfiguration().getFetchSeparator());
    ...
    public void testFetchSize() throws Exception {
        ...
        assertFalse(cliCommand.handle(testTerminal, cliSession, "fetch"));
        assertEquals(1000L, cliSession.getConfiguration().getFetchSize());
        ...
        assertEquals(10L, cliSession.getConfiguration().getFetchSize());
    ...
    public void testLenient() {
        ...
        assertEquals(false, cliSession.getConfiguration().isLenient());
        assertTrue(cliCommand.handle(testTerminal, cliSession, "lenient = true"));
        assertEquals(true, cliSession.getConfiguration().isLenient());

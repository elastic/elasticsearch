...
public class HttpClientRequestTests extends ESTestCase {
    ...
    private RawRequestMockWebServer webServer = new RawRequestMockWebServer();
    ...
    private void assertBinaryRequestForCLI(boolean isBinary, XContentType xContentType) throws URISyntaxException {
        ...
        try {
            ...
            // we are not really interested if there is an exception
        }
    ...
    private class RawRequestMockWebServer implements Closeable {

...
public final class Protocol {
    ...
    public static final String CLEAR_CURSOR_DEPRECATED_REST_ENDPOINT = "/_sql/close";
    public static final String SQL_QUERY_REST_ENDPOINT = "/_sql";
    public static final String SQL_QUERY_DEPRECATED_REST_ENDPOINT = "/_sql";
    public static final String SQL_STATS_REST_ENDPOINT = "/_sql/stats";
    public static final String SQL_STATS_DEPRECATED_REST_ENDPOINT = "/_sql/stats";
}

...
public class XContentBuilder implements Closeable, Flushable {
    ...
    protected XContentBuilder(XContentGenerator generator, OutputStream bos, RestApiVersion restApiVersion) throws IOException {
        this.bos = bos;
    ...
    public XContentBuilder(XContent xContent, OutputStream bos) throws IOException {
        this(xContent, bos, RestApiVersion.current());
    }

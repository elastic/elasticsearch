...
public abstract class Attribute extends NamedExpression {
    ...
    public Attribute(Location location, String name, String qualifier, Nullability nullability,
    ...
    protected abstract Attribute clone(Location location, String name, String qualifier, Nullability nullability,
                                       ExpressionId id, boolean synthetic);

...
public class LiteralAttribute extends TypedAttribute {
    ...
    public LiteralAttribute(Source source, String name, String qualifier, Nullability nullable, ExpressionId id, boolean synthetic,
    ...
    @Override
    protected LiteralAttribute clone(Source source, String name, String qualifier, Nullability nullable,

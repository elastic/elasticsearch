...
public abstract class TypedAttribute extends Attribute {
    ...
    protected TypedAttribute(Source source, String name, DataType dataType) {
        this(source, name, dataType, null, Nullability.TRUE, null, false);
    }

    protected TypedAttribute(Source source, String name, DataType dataType, String qualifier, Nullability nullable,

...
public class ScoreAttribute extends FunctionAttribute {
    ...
    public ScoreAttribute(Source source) {
        this(source, "SCORE()", DataType.FLOAT, null, Nullability.FALSE, null, false);
    }

    /**
     * Constructor for {@link #clone()}
     */
    private ScoreAttribute(Source source, String name, DataType dataType, String qualifier, Nullability nullable, ExpressionId id,
                           boolean synthetic) {

...
public class Insert extends ScalarFunction {
    ...
    protected TypeResolution resolveType() {
        ...
        TypeResolution startResolution = isNumeric(start, functionName(), ParamOrdinal.SECOND);
        if (startResolution.unresolved()) {
            return startResolution;
        }
        
        TypeResolution lengthResolution = isNumeric(length, functionName(), ParamOrdinal.THIRD);
        if (lengthResolution.unresolved()) {
            return lengthResolution;
        }
        
        return isStringAndExact(replacement, functionName(), ParamOrdinal.FOURTH);
    }

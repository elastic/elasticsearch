...
public class Locate extends ScalarFunction {
    ...
    protected TypeResolution resolveType() {
        ...
        TypeResolution patternResolution = isStringAndExact(pattern, functionName(), ParamOrdinal.FIRST);
        if (patternResolution.unresolved()) {
            return patternResolution;
        }
        
        TypeResolution sourceResolution = isStringAndExact(source, functionName(), ParamOrdinal.SECOND);
        if (sourceResolution.unresolved()) {
            return sourceResolution;
        }

        return start == null ? TypeResolution.TYPE_RESOLVED : isNumeric(start, functionName(), ParamOrdinal.THIRD);
    }

...
class SqlBaseParser extends Parser {
    ...
    public static final int T__0 = 1, T__1 = 2, ALL = 3, ANALYZE = 4, ANALYZED = 5, AND = 6, ANY = 7, AS = 8, ASC = 9, BETWEEN = 10, BY =
        11, CASE = 12, CAST = 13, CATALOG = 14, CATALOGS = 15, COLUMNS = 16, CONVERT = 17, CURRENT_DATE = 18, CURRENT_TIME = 19,
        CURRENT_TIMESTAMP = 20, DAY = 21, DAYS = 22, DEBUG = 23, DESC = 24, DESCRIBE = 25, DISTINCT = 26, ELSE = 27, END = 28, ESCAPE = 29,
        EXECUTABLE = 30, EXISTS = 31, EXPLAIN = 32, EXTRACT = 33, FALSE = 34, FIRST = 35, FOR = 36, FORMAT = 37, FROM = 38, FROZEN = 39,
        FULL = 40, FUNCTIONS = 41, GRAPHVIZ = 42, GROUP = 43, HAVING = 44, HOUR = 45, HOURS = 46, IN = 47, INCLUDE = 48, INNER = 49,
        INTERVAL = 50, IS = 51, JOIN = 52, LAST = 53, LEFT = 54, LIKE = 55, LIMIT = 56, MAPPED = 57, MATCH = 58, MINUTE = 59, MINUTES = 60,
        MONTH = 61, MONTHS = 62, NATURAL = 63, NOT = 64, NULL = 65, NULLS = 66, ON = 67, OPTIMIZED = 68, OR = 69, ORDER = 70, OUTER = 71,
        PARSED = 72, PHYSICAL = 73, PIVOT = 74, PLAN = 75, RIGHT = 76, RLIKE = 77, QUERY = 78, SCHEMAS = 79, SECOND = 80, SECONDS = 81,
        SELECT = 82, SHOW = 83, SYS = 84, TABLE = 85, TABLES = 86, TEXT = 87, THEN = 88, TRUE = 89, TO = 90, TOP = 91, TYPE = 92, TYPES =
            93, USING = 94, VERIFY = 95, WHEN = 96, WHERE = 97, WITH = 98, YEAR = 99, YEARS = 100, ESCAPE_ESC = 101, FUNCTION_ESC = 102,
        LIMIT_ESC = 103, DATE_ESC = 104, TIME_ESC = 105, TIMESTAMP_ESC = 106, GUID_ESC = 107, ESC_START = 108, ESC_END = 109, LP = 110, RP =
            111, EQ = 112, NULLEQ = 113, NEQ = 114, LT = 115, LTE = 116, GT = 117, GTE = 118, PLUS = 119, MINUS = 120, ASTERISK = 121,
    ...
    public static class ExplainContext extends StatementContext {
        ...
        public TerminalNode LP() {
            return getToken(SqlBaseParser.LP, 0);
        }

        public TerminalNode RP() {
            return getToken(SqlBaseParser.RP, 0);
        }
                            ...
                            while (((((_la - 37)) & ~0x3f) == 0 && ((1L << (_la - 37)) & 288230651029618689L) != 0)) {
                                {
                                    ...
                                    switch (_input.LA(1)) {
                                        case PLAN: {
                                            ...
                                            _la = _input.LA(1);
                                            if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & 144115189149597736L) != 0)
                                                || _la == OPTIMIZED
                                                || _la == PARSED)) {
        ...
        try {
            ...
            switch (getInterpreter().adaptivePredict(_input, 48, _ctx)) {
                case 1:
                    ...
                    _errHandler.sync(this);
                    _la = _input.LA(1);
                    if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3414897503504412720L) != 0)
                        || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -4359397265503551725L) != 0)
                        || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & 111L) != 0)) {
                        {
                            setState(359);
                            expression();
                            setState(364);
    ...
    public static class PivotClauseContext extends ParserRuleContext {
        ...
        public List<TerminalNode> LP() {
            return getTokens(SqlBaseParser.LP);
        }
        ...
        public List<TerminalNode> RP() {
            return getTokens(SqlBaseParser.RP);
        }
    ...
    public final NamedValueExpressionContext namedValueExpression() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3108652700925788464L) != 0)
                    || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & -4611686016086073615L) != 0)
            ...
            enterOuterAlt(_localctx, 1);
            {
                ...
                switch (getInterpreter().adaptivePredict(_input, 95, _ctx)) {
                    ...
                    case 5: {
                        ...
                        _errHandler.sync(this);
                        _la = _input.LA(1);
                        if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3108652700925788208L) != 0)
                            || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & -4611686016086073615L) != 0)
                            || _la == QUOTED_IDENTIFIER
                            || _la == BACKQUOTED_IDENTIFIER) {
                            {
    ...
    public final FunctionTemplateContext functionTemplate() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _errHandler.sync(this);
                _la = _input.LA(1);
                if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3414897503571521592L) != 0)
                    || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -4359397265503551725L) != 0)
                    || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & 111L) != 0)) {
                    {
                        setState(750);
    ...
    public final IntervalFieldContext intervalField() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(814);
                _la = _input.LA(1);
                if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & 8647016837673910272L) != 0)
                    || ((((_la - 80)) & ~0x3f) == 0 && ((1L << (_la - 80)) & 1572867L) != 0))) {
                    _errHandler.recoverInline(this);
                } else {
                    if (_input.LA(1) == Token.EOF) matchedEOF = true;
                    _errHandler.reportMatch(this);
    ...
    public final NonReservedContext nonReserved() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _la = _input.LA(1);
                if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & 3108652700925788208L) != 0)
                    || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 2341314289L) != 0))) {
                    _errHandler.recoverInline(this);
                } else {
                    if (_input.LA(1) == Token.EOF) matchedEOF = true;
                    _errHandler.reportMatch(this);
    ...
    public static final String _serializedATN = "\u0004\u0001\u008b\u036d\u0002\u0000\u0007\u0000\u0002\u0001\u0007\u0001"
        + "\u0002\u0002\u0007\u0002\u0002\u0003\u0007\u0003\u0002\u0004\u0007\u0004"
        + "\u0002\u0005\u0007\u0005\u0002\u0006\u0007\u0006\u0002\u0007\u0007\u0007"
        + "\u0002\b\u0007\b\u0002\t\u0007\t\u0002\n\u0007\n\u0002\u000b\u0007\u000b"
        + "\u0002\f\u0007\f\u0002\r\u0007\r\u0002\u000e\u0007\u000e\u0002\u000f\u0007"

...
import static org.elasticsearch.Version.V_7_12_0;
...
public final class VersionCompatibilityChecks {
    ...
    public static final SqlVersion INTRODUCING_ARRAY_TYPES = SqlVersion.fromId(V_7_12_0.id); // TODO: update to target release

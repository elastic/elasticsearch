...
public class SearchHitCursorTests extends AbstractSqlWireSerializingTestCase<SearchHitCursor> {
    public static SearchHitCursor randomScrollCursor() {
        ...
        return new SearchHitCursor(new byte[randomInt(256)], extractors, CompositeAggregationCursorTests.randomBitSet(extractorsSize),
    ...
    protected SearchHitCursor mutateInstance(SearchHitCursor instance) throws IOException {
        return new SearchHitCursor(instance.next(), instance.extractors(),
                randomValueOtherThan(instance.mask(), () -> CompositeAggregationCursorTests.randomBitSet(instance.extractors().size())),
                randomValueOtherThan(instance.limit(), () -> randomIntBetween(1, 1024)), !instance.includeFrozen(), instance.indices());
    }

...
public class FieldHitExtractorTests extends AbstractWireSerializingTestCase<FieldHitExtractor> {
    ...
    public static FieldHitExtractor randomFieldHitExtractor() {
        ...
        return new FieldHitExtractor(name, null, randomZone(), randomBoolean(), hitName);
    }
    ...
    public void testGetDate() {
        ...
        FieldHitExtractor extractor = new FieldHitExtractor("my_date_field", DataType.DATE, zoneId, true);
        assertEquals(DateUtils.of(millis, zoneId), extractor.extract(hit));
    }
    ...
    public void testToString() {
        assertEquals("hit.field@hit@Europe/Berlin",
            new FieldHitExtractor("hit.field", null, ZoneId.of("Europe/Berlin"), true, "hit").toString());
    }

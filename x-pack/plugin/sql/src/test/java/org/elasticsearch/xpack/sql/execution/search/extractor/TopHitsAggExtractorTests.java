...
public class TopHitsAggExtractorTests extends AbstractWireSerializingTestCase<TopHitsAggExtractor> {
    ...
    public void testZeroNullValue() {
        ...
        Aggregation agg = new InternalTopHits(extractor.name(), 0, 0, null, new SearchHits(null, 0, 0.0f), null, null);
    ...
    private SearchHits searchHitsOf(Object value) {
        return new SearchHits(new SearchHit[] {new SearchHit(1, "docId", null,
                Collections.singletonMap("topHitsAgg", new DocumentField("field", Collections.singletonList(value))))}, 10, 0.0f);
    }
}

...
public class DateDiffProcessorTests extends AbstractSqlWireSerializingTestCase<DateDiffProcessor> {
    ...
    public void testWithNulls() {
        assertNull(
            new DateDiff(Source.EMPTY, NULL, randomDatetimeLiteral(), randomDatetimeLiteral(), randomZone()).makePipe()
                .asProcessor()
                .process(null)
        );
        assertNull(
            new DateDiff(Source.EMPTY, l("days"), NULL, randomDatetimeLiteral(), randomZone()).makePipe().asProcessor().process(null)
        );
        assertNull(
            new DateDiff(Source.EMPTY, l("days"), randomDatetimeLiteral(), NULL, randomZone()).makePipe().asProcessor().process(null)
        );
        assertNull(new DateDiff(Source.EMPTY, NULL, NULL, NULL, randomZone()).makePipe().asProcessor().process(null));
    }
    ...
    public void testDiff() {
        ...
        assertEquals(1, new DateDiff(Source.EMPTY, l("years"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-1, new DateDiff(Source.EMPTY, l("year"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(2, new DateDiff(Source.EMPTY, l("yyyy"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-2, new DateDiff(Source.EMPTY, l("yy"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));
        ...
        assertEquals(24, new DateDiff(Source.EMPTY, l("mm"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-24, new DateDiff(Source.EMPTY, l("m"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));

        assertEquals(730, new DateDiff(Source.EMPTY, l("dayofyear"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-730, new DateDiff(Source.EMPTY, l("dy"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(730, new DateDiff(Source.EMPTY, l("y"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-730, new DateDiff(Source.EMPTY, l("y"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));

        assertEquals(730, new DateDiff(Source.EMPTY, l("day"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-730, new DateDiff(Source.EMPTY, l("days"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(730, new DateDiff(Source.EMPTY, l("dd"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-730, new DateDiff(Source.EMPTY, l("dd"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));

        assertEquals(104, new DateDiff(Source.EMPTY, l("week"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-104, new DateDiff(Source.EMPTY, l("weeks"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(104, new DateDiff(Source.EMPTY, l("wk"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-104, new DateDiff(Source.EMPTY, l("ww"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));

        assertEquals(730, new DateDiff(Source.EMPTY, l("weekday"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-730, new DateDiff(Source.EMPTY, l("weekdays"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(730, new DateDiff(Source.EMPTY, l("dw"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-730, new DateDiff(Source.EMPTY, l("dw"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));

        assertEquals(17542, new DateDiff(Source.EMPTY, l("hour"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-17542, new DateDiff(Source.EMPTY, l("hours"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(17542, new DateDiff(Source.EMPTY, l("hh"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-17542, new DateDiff(Source.EMPTY, l("hh"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));

        assertEquals(1052531, new DateDiff(Source.EMPTY, l("minute"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-1052531, new DateDiff(Source.EMPTY, l("minutes"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(1052531, new DateDiff(Source.EMPTY, l("mi"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-1052531, new DateDiff(Source.EMPTY, l("n"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));
        ...
        assertEquals(15049, new DateDiff(Source.EMPTY, l("second"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-15049, new DateDiff(Source.EMPTY, l("seconds"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(15049, new DateDiff(Source.EMPTY, l("ss"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-15049, new DateDiff(Source.EMPTY, l("s"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));

        assertEquals(15049864, new DateDiff(Source.EMPTY, l("millisecond"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-15049864, new DateDiff(Source.EMPTY, l("milliseconds"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(15049864, new DateDiff(Source.EMPTY, l("ms"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-15049864, new DateDiff(Source.EMPTY, l("ms"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));

        dt1 = l(dateTime(2020, 12, 31, 20, 22, 33, 123456789, ZoneId.of("Etc/GMT+5")));
        dt2 = l(dateTime(2021, 1, 1, 6, 33, 22, 987654321, ZoneId.of("Etc/GMT-5")));

        assertEquals(649864198, new DateDiff(Source.EMPTY, l("microsecond"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-649864198, new DateDiff(Source.EMPTY, l("microseconds"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(649864198, new DateDiff(Source.EMPTY, l("mcs"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-649864198, new DateDiff(Source.EMPTY, l("mcs"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));
        ...
        assertEquals(1864197532, new DateDiff(Source.EMPTY, l("nanosecond"), dt1, dt2, UTC).makePipe().asProcessor().process(null));
        assertEquals(-1864197532, new DateDiff(Source.EMPTY, l("nanoseconds"), dt2, dt1, UTC).makePipe().asProcessor().process(null));
        assertEquals(1864197532, new DateDiff(Source.EMPTY, l("ns"), dt1, dt2, zoneId).makePipe().asProcessor().process(null));
        assertEquals(-1864197532, new DateDiff(Source.EMPTY, l("ns"), dt2, dt1, zoneId).makePipe().asProcessor().process(null));
    }

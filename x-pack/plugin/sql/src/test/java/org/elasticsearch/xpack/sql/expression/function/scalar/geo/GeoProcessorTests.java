...
public class GeoProcessorTests extends AbstractWireSerializingTestCase<GeoProcessor> {
    ...
    public void testApplyGeometryType() throws Exception {
        ...
        assertEquals(
            "POLYGON",
            new GeoProcessor(GeoOperation.GEOMETRY_TYPE).process(new GeoShape("polygon ((3.0 1.0, 4.0 2.0, 4.0 3.0, 3.0 1.0))"))
        );
        assertEquals(
            "MULTILINESTRING",
            new GeoProcessor(GeoOperation.GEOMETRY_TYPE).process(new GeoShape("multilinestring ((3.0 1.0, 4.0 2.0), (2.0 1.0, 5.0 6.0))"))
        );
        assertEquals(
            "MULTIPOLYGON",
            new GeoProcessor(GeoOperation.GEOMETRY_TYPE).process(new GeoShape("multipolygon (((3.0 1.0, 4.0 2.0, 4.0 3.0, 3.0 1.0)))"))
        );
        assertEquals("ENVELOPE", new GeoProcessor(GeoOperation.GEOMETRY_TYPE).process(new GeoShape("bbox (10.0, 20.0, 40.0, 30.0)")));
        assertEquals(
            "GEOMETRYCOLLECTION",
            new GeoProcessor(GeoOperation.GEOMETRY_TYPE).process(new GeoShape("geometrycollection (point (20.0 10.0),point (1.0 2.0))"))
        );
    }
    ...
    public void testApplyGetXYZ() throws Exception {
        ...
        assertEquals(
            3.0,
            new GeoProcessor(GeoOperation.X).process(new GeoShape("multilinestring ((3.0 1.0, 4.0 2.0), (2.0 1.0, 5.0 6.0))"))
        );
        assertEquals(
            1.0,
            new GeoProcessor(GeoOperation.Y).process(new GeoShape("multilinestring ((3.0 1.0, 4.0 2.0), (2.0 1.0, 5.0 6.0))"))
        );
        ...
        assertEquals(
            20.0,
            new GeoProcessor(GeoOperation.X).process(new GeoShape("geometrycollection (point (20.0 10.0),point (1.0 2.0))"))
        );
        assertEquals(
            10.0,
            new GeoProcessor(GeoOperation.Y).process(new GeoShape("geometrycollection (point (20.0 10.0),point (1.0 2.0))"))
        );
    }
    ...
    public void testApplyGetXYZToPolygons() throws Exception {
        ...
        assertEquals(
            5.0,
            new GeoProcessor(GeoOperation.Z).process(new GeoShape("polygon ((3.0 1.0 5.0, 4.0 2.0 6.0, 4.0 3.0 7.0, 3.0 1.0 5.0))"))
        );

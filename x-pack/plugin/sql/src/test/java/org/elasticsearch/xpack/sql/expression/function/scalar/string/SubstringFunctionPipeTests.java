...
public class SubstringFunctionPipeTests extends AbstractNodeTestCase<SubstringFunctionPipe, Pipe> {
    ...
    public static SubstringFunctionPipe randomSubstringFunctionPipe() {
        return (SubstringFunctionPipe) (new Substring(randomSource(), randomStringLiteral(), randomIntLiteral(), randomIntLiteral())
            .makePipe());
    }
    ...
    public void testTransform() {
        ...
        SubstringFunctionPipe newB = new SubstringFunctionPipe(b1.source(), newExpression, b1.input(), b1.start(), b1.length());
        ...
        newB = new SubstringFunctionPipe(newLoc, b2.expression(), b2.input(), b2.start(), b2.length());
    ...
    protected SubstringFunctionPipe copy(SubstringFunctionPipe instance) {
        return new SubstringFunctionPipe(instance.source(), instance.expression(), instance.input(), instance.start(), instance.length());
    }
}

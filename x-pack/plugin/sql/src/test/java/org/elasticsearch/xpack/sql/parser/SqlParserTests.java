...
public class SqlParserTests extends ESTestCase {
    ...
    public void testUseBothTopAndLimitInvalid() {
        ...
        assertEquals("line 1:28: Cannot use both TOP and LIMIT in the same query", e.getMessage());
        ...
        assertEquals("line 1:82: Cannot use both TOP and LIMIT in the same query", e.getMessage());
    }

 ...
 * </ul>
 */
public class SqlNodeSubclassTests extends NodeSubclassTests {
    ...
    @Override
    protected boolean hasAtLeastTwoChildren(Class toBuildClass) {
    ...
    @Override
    protected Object pluggableMakeArg(Class toBuildClass, Class argClass) {

...
public class SqlDataTypeConverterTests extends ESTestCase {
    ...
    public void testConversionToLong() {
        DataType to = LONG;
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(Double.MAX_VALUE));
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("0xff"));
    ...
    public void testConversionToDate() {
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(tooLarge));
        ...
        }
        {
            ...
            e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("2020-02-"));
            assertEquals("cannot cast [2020-02-] to [date]: Text '2020-02-' could not be parsed at index 8", e.getMessage());
            e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("2020-"));
    ...
    public void testConversionToBoolean() {
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("10"));
            assertEquals("cannot cast [10] to [boolean]", e.getMessage());
            e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("-1"));
            assertEquals("cannot cast [-1] to [boolean]", e.getMessage());
            e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("0"));
            assertEquals("cannot cast [0] to [boolean]", e.getMessage());
            e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("blah"));
            assertEquals("cannot cast [blah] to [boolean]", e.getMessage());
            e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("Yes"));
            assertEquals("cannot cast [Yes] to [boolean]", e.getMessage());
            e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("nO"));
    ...
    public void testConversionToUnsignedLong() {
        DataType to = UNSIGNED_LONG;
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(zdtn));
    ...
    public void testConversionToInt() {
        DataType to = INTEGER;
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(Long.MAX_VALUE));
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(asDateOnly(Long.MAX_VALUE)));
        ...
        }
        {
            ...
            Exception e = expectThrows(
                QlClientIllegalArgumentException.class,
    ...
    public void testConversionToShort() {
        DataType to = SHORT;
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(Integer.MAX_VALUE));
        ...
        }
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(asDateOnly(123456789L)));
        ...
        }
        {
            ...
            Exception e1 = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(asTimeOnly(-123456789L)));
            assertEquals("[49343211] out of [short] range", e1.getMessage());
            Exception e2 = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(asTimeOnly(123456789L)));
    ...
    public void testConversionToByte() {
        DataType to = BYTE;
        {
            ...
            Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(Short.MAX_VALUE));
        ...
        }
        {
            ...
            Exception e1 = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert(asTimeOnly(-123L)));
    ...
    public void testStringToIp() {
        ...
        Exception e = expectThrows(QlClientIllegalArgumentException.class, () -> conversion.convert("10.1.1.300"));

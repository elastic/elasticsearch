...
public class StackTemplateRegistryTests extends ESTestCase {
    ...
    public void testSameOrHigherVersionTemplateNotUpgraded() {
        ...
        versions.put(StackTemplateRegistry.ECS_TSDB_DYNAMIC_MAPPINGS_COMPONENT_TEMPLATE_NAME, StackTemplateRegistry.REGISTRY_VERSION);
        ...
        versions.put(StackTemplateRegistry.SEMCONV_TO_ECS_MAPPINGS_COMPONENT_TEMPLATE_NAME, StackTemplateRegistry.REGISTRY_VERSION);
        ...
        versions.put(
            StackTemplateRegistry.ECS_TSDB_DYNAMIC_MAPPINGS_COMPONENT_TEMPLATE_NAME,
            StackTemplateRegistry.REGISTRY_VERSION + randomIntBetween(1, 1000)
        );
        versions.put(
            StackTemplateRegistry.LOGS_SETTINGS_COMPONENT_TEMPLATE_NAME,
        ...
        versions.put(
            StackTemplateRegistry.SEMCONV_TO_ECS_MAPPINGS_COMPONENT_TEMPLATE_NAME,
            StackTemplateRegistry.REGISTRY_VERSION + randomIntBetween(1, 1000)
        );
        versions.put(

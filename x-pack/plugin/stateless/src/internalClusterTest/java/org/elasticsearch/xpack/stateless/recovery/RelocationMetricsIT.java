...
public class RelocationMetricsIT extends AbstractStatelessPluginIntegTestCase {
    ...
    public void testRelocationPhaseMetricsRecorded() {
        ...
        assertHistogramRecorded(targetTelemetry, StatelessRelocationMetricsCollector.RELOCATION_INITIAL_FLUSH_TIME_METRIC_IN_SECONDS);
        assertHistogramRecorded(targetTelemetry, StatelessRelocationMetricsCollector.RELOCATION_ACQUIRE_PERMITS_TIME_METRIC_IN_SECONDS);
        assertHistogramRecorded(targetTelemetry, StatelessRelocationMetricsCollector.RELOCATION_SECOND_FLUSH_TIME_METRIC_IN_SECONDS);
        assertHistogramRecorded(targetTelemetry, StatelessRelocationMetricsCollector.RELOCATION_HANDOFF_TIME_METRIC_IN_SECONDS);
        assertHistogramRecorded(targetTelemetry, StatelessRelocationMetricsCollector.RELOCATION_TARGET_PRE_RECOVERY_TIME_METRIC_IN_SECONDS);
        assertHistogramRecorded(
            targetTelemetry,
            StatelessRelocationMetricsCollector.RELOCATION_TARGET_READ_INDEXING_SHARD_STATE_TIME_METRIC_IN_SECONDS
        );
        assertHistogramRecorded(targetTelemetry, StatelessRelocationMetricsCollector.RELOCATION_TARGET_OPEN_ENGINE_TIME_METRIC_IN_SECONDS);
    }

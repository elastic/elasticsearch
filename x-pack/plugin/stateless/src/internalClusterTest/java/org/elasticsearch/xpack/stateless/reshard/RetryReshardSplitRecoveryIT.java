 ...
 * mirrors that IT; Directory ACE is omitted because split targets are prepared via
 * object-store BCC setup, not {@code Store.createEmpty} / {@code addIndices} /
 * {@code bootstrapNewHistory}.
 * <p>
 * Cancellation is not covered: {@code RESHARD_SPLIT} recoveries throw
 * {@code ShardRecoveryNotCancellableException} from {@code TransportCancelRecoveriesAction}.
 */
@TestLogging(
    ...
    value = "org.elasticsearch.indices.cluster.IndicesClusterStateService:TRACE,"
        ...
        + "org.elasticsearch.xpack.stateless.reshard:TRACE,"

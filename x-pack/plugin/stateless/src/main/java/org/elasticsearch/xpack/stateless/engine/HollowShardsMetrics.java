...
public record HollowShardsMetrics(
    ...
    public static final HollowShardsMetrics NOOP = HollowShardsMetrics.from(MeterRegistry.NOOP);
    ...
    public static HollowShardsMetrics from(MeterRegistry meterRegistry) {

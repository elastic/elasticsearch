...
public class MetadataReadTimestampBackfillTests extends ESTestCase {
    ...
    public void testMergeCcKeepsMostRecent() {
        final var backfill = new MetadataReadTimestampBackfill(cacheService, cacheKey);
    ...
    public void testNullRangeContributesEvictFirst() {
        final var backfill = new MetadataReadTimestampBackfill(cacheService, cacheKey);
        backfill.mergeCc(0L, cc(1L, 50L, 50L, null));
        assertThat(backfill.mostRecentTimestamp(), equalTo(1L));
    }
    ...
    public void testFinalizeNoTimestampResolvesEvictFirst() {
        final var backfill = new MetadataReadTimestampBackfill(cacheService, cacheKey);
        backfill.mergeCc(0L, cc(1L, 50L, 50L, null)); // region 0 only

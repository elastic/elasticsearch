...
import org.elasticsearch.xpack.textstructure.rest.RestFindMessagesStructureAction;
...
import org.elasticsearch.xpack.textstructure.transport.TransportFindMessagesStructureAction;
...
public class TextStructurePlugin extends Plugin implements ActionPlugin {
    ...
    public List<RestHandler> getRestHandlers(
        ...
        return Arrays.asList(
            ...
            new RestFindMessagesStructureAction(),
    ...
    public List<ActionHandler<? extends ActionRequest, ? extends ActionResponse>> getActions() {
        return Arrays.asList(
            ...
            new ActionHandler<>(FindMessagesStructureAction.INSTANCE, TransportFindMessagesStructureAction.class),

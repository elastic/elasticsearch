...
public abstract class TextStructureTestCase extends ESTestCase {
    ...
    protected static final String NESTED_NDJSON_SAMPLE_DUPLICATE_KEYS = """
        {"host": {"id": 1, "category": "NETWORKING DEVICE", "double_nested": {"id": 11, "other_key": "other_value" }}, "timestamp": "1478261151445"}
        {"host": {"id": 2, "category": "COMPUTE NODE", "double_nested": {"id": 11, "other_key": "other_value"}}, "timestamp": "1478261151445"}
        """;

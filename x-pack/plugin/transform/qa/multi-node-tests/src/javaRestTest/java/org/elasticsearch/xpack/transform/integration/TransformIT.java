...
public class TransformIT extends TransformRestTestCase {
    ...
    public void testContinuousTransformUpdate() throws Exception {
        ...
        String update = org.elasticsearch.core.Strings.format("""
            {
    ...
    private void indexMoreDocs(long timestamp, long userId, String index) throws Exception {
        ...
        for (int i = 0; i < 25; i++) {
            bulkBuilder.append(org.elasticsearch.core.Strings.format("""
                {"create":{"_index":"%s"}}
                """, index));
            ...
            String source = org.elasticsearch.core.Strings.format("""

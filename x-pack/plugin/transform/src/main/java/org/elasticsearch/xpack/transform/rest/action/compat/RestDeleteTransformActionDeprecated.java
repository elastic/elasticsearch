...
public class RestDeleteTransformActionDeprecated extends BaseRestHandler {
    ...
    public List<DeprecatedRestApi> deprecatedHandledMethodsAndPaths() {
        return singletonList(new DeprecatedRestApi(TransformField.REST_BASE_PATH_TRANSFORMS_BY_ID_DEPRECATED,
            singletonList(DELETE), TransformMessages.REST_DEPRECATED_ENDPOINT, deprecationLogger));
    }

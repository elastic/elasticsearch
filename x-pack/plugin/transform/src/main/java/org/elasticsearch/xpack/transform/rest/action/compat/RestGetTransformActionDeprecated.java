...
public class RestGetTransformActionDeprecated extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return List.of(
            Route.deprecated(GET, TransformField.REST_BASE_PATH_TRANSFORMS_DEPRECATED, RestApiCompatibleVersion.V_7,
                TransformMessages.REST_DEPRECATED_ENDPOINT),
            Route.deprecated(GET, TransformField.REST_BASE_PATH_TRANSFORMS_BY_ID_DEPRECATED, RestApiCompatibleVersion.V_7,
                TransformMessages.REST_DEPRECATED_ENDPOINT)
        );
    }

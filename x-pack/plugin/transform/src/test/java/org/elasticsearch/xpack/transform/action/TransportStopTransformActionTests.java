...
public class TransportStopTransformActionTests extends ESTestCase {
    ...
    public void testTaskStateValidationWithNoTasks() {
        ...
        PersistentTasksMetadataSection.Builder pTasksBuilder = PersistentTasksMetadataSection.builder();
    ...
    public void testTaskStateValidationWithTransformTasks() {
        ...
        PersistentTasksMetadataSection.Builder pTasksBuilder = PersistentTasksMetadataSection.builder()
            .addTask(
                ...
                new PersistentTasksMetadataSection.Assignment("current-data-node-with-1-tasks", "")
            );
        ...
        pTasksBuilder.addTask(
            ...
            new PersistentTasksMetadataSection.Assignment("current-data-node-with-2-tasks", "")
        )
            .updateTaskState(
                "failed-task-2",
                new TransformState(
    ...
    private static Answer<?> withResponse() {
        return invocationOnMock -> {
            ...
            l.onResponse(new PersistentTaskResponse((PersistentTasksMetadataSection.PersistentTask<?>) null));
            return null;
        };
    }

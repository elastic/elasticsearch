...
public class DefaultCheckpointProviderTests extends ESTestCase {
    ...
    public void setUpMocks() {
        ...
        when(client.getRemoteClusterClient("remote-1", any())).thenReturn(remoteClient1);
        when(client.getRemoteClusterClient("remote-2", any())).thenReturn(remoteClient2);
        when(client.getRemoteClusterClient("remote-3", any())).thenReturn(remoteClient3);

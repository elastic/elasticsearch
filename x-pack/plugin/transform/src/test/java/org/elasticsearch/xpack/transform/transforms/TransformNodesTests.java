...
public class TransformNodesTests extends ESTestCase {
    ...
    public void testTransformNodes() {
        ...
        tasksBuilder.addTask(
            ...
            new PersistentTasksMetadataSection.Assignment(null, "awaiting reassignment after node loss")
        );
        tasksBuilder.addTask(
            transformIdBaz,
            TransformField.TASK_NAME,
    ...
    public void testGetAssignment() {
        ...
        PersistentTasksMetadataSection.Assignment assignment2 = new PersistentTasksMetadataSection.Assignment(

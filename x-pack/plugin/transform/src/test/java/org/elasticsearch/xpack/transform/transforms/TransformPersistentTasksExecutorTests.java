...
public class TransformPersistentTasksExecutorTests extends ESTestCase {
    ...
    public void testNodeVersionAssignment() {
        ...
        assertThat(
            executor.getAssignment(new TransformTaskParams("new-old-task-id", Version.V_7_5_0, null, true), cs.nodes().getAllNodes(), cs)
                .getExecutorNode(),
    ...
    public void testNodeAssignmentProblems() {
        ...
        assignment = executor.getAssignment(
            new TransformTaskParams("new-task-id", Version.V_7_7_0, null, false),
            cs.nodes().getAllNodes(),
            cs
        );
        assertNull(assignment.getExecutorNode());
    ...
    public void testDoNotSelectOldNodes() {
        ...
        assertThat(
            executor.getAssignment(new TransformTaskParams("new-old-task-id", Version.V_7_2_0, null, false), cs.nodes().getAllNodes(), cs)
                .getExecutorNode(),

...
public class AggregationResultUtilsTests extends ESTestCase {
    ...
    static {
        ...
        map.put(
                ...
                (p, c) -> ParsedSimpleValue.fromXContent(p, (String) c));
        map.put(
    ...
    public void testExtractCompositeAggregationResults() throws IOException {
        ...
        Collection<AggregationBuilder> aggregationBuilders =
                Collections.singletonList(AggregationBuilders.avg(aggName));
        ...
        Map<String, Object> input =
                asMap(
                        ...
                        asList(
                                asMap(
                                        KEY, asMap(targetField, "ID1"),
                                        aggTypedName, asMap("value", 42.33),
                                        DOC_COUNT, 8),
                                asMap(
                                        KEY, asMap(targetField, "ID2"),
                                        aggTypedName, asMap("value", 28.99),
                                        DOC_COUNT, 3),
                                asMap(
                                        KEY, asMap(targetField, "ID3"),
                                        aggTypedName, asMap("value", Double.NaN),
                                        DOC_COUNT, 0)));
    ...
    public void testExtractCompositeAggregationResultsMultiAggregations() throws IOException {
        ...
        Collection<AggregationBuilder> aggregationBuilders =
                asList(AggregationBuilders.avg(aggName), AggregationBuilders.max(aggName2));
                ...
                asMap(
                        ...
                        asList(
                                asMap(
                                        KEY, asMap(targetField, "ID1"),
                                        aggTypedName, asMap("value", 42.33),
                                        aggTypedName2, asMap("value", 9.9),
                                        DOC_COUNT, 111),
                                asMap(
                                        KEY, asMap(targetField, "ID2"),
                                        aggTypedName, asMap("value", 28.99),
                                        aggTypedName2, asMap("value", 222.33),
                                        DOC_COUNT, 88),
                                asMap(
                                        KEY, asMap(targetField, "ID3"),
                                        aggTypedName, asMap("value", 12.55),
                                        aggTypedName2, asMap("value", Double.NaN),
                                        DOC_COUNT, 1)));
    ...
    public void testExtractCompositeAggregationResultsMultiAggregationsAndTypes()
        ...
        Map<String, String> fieldTypeMap =
                asStringMap(
                        aggName, "double",
                        aggName2,
                                "keyword", // If the second aggregation was some non-numeric mapped
                        // field
                        targetField, "keyword",
                        targetField2, "keyword");
        executeTest(
    ...
    public void testExtractCompositeAggregationResultsWithDynamicType() throws IOException {
        ...
        Collection<AggregationBuilder> aggregationBuilders =
                asList(AggregationBuilders.scriptedMetric(aggName));
                                ...
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID1",
                                                        targetField2, "ID1_2"),
                                        aggTypedName, asMap("value", asMap("field", 123.0)),
                                        DOC_COUNT, 1),
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID1",
                                                        targetField2, "ID2_2"),
                                        aggTypedName, asMap("value", asMap("field", 1.0)),
                                        DOC_COUNT, 2),
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID2",
                                                        targetField2, "ID1_2"),
                                        aggTypedName, asMap("value", asMap("field", 2.13)),
                                        DOC_COUNT, 3),
                                asMap(
                                        KEY,
                                                asMap(
                                ...
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID1",
                                                        targetField2, "ID1_2"),
                                        aggTypedName, asMap("value", 123.0),
                                        pipelineAggTypedName, asMap("value", 123.0),
                                        DOC_COUNT, 1),
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID1",
                                                        targetField2, "ID2_2"),
                                        aggTypedName, asMap("value", 1.0),
                                        pipelineAggTypedName, asMap("value", 1.0),
                                        DOC_COUNT, 2),
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID2",
                                                        targetField2, "ID1_2"),
                                        aggTypedName, asMap("value", 2.13),
                                        pipelineAggTypedName, asMap("value", 2.13),
                                        DOC_COUNT, 3),
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID3",
                                                        targetField2, "ID2_2"),
                                        aggTypedName, asMap("value", 12.0),
                                        pipelineAggTypedName, asMap("value", Double.NaN),
                                        DOC_COUNT, 4)));
    ...
    public void testExtractCompositeAggregationResultsDocIDs() throws IOException {
        ...
        Map<String, Object> inputFirstRun =
                asMap(
                        "buckets",
                        asList(
                                asMap(
        ...
        Map<String, Object> inputSecondRun =
                asMap(
                        "buckets",
                        asList(
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID1",
                                                        targetField2, "ID1_2"),
                                        aggTypedName, asMap("value", 433.33),
                                        DOC_COUNT, 12),
                                asMap(
                                        KEY,
                                                asMap(
                                ...
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID2",
                                                        targetField2, "ID1_2"),
                                        aggTypedName, asMap("value", 21.99),
                                        DOC_COUNT, 2),
                                asMap(
                                        KEY,
                                                asMap(
                                                        targetField, "ID3",
                                                        targetField2, "ID2_2"),
                                        aggTypedName, asMap("value", 122.55),
                                        DOC_COUNT, 44)));
    ...
    public void testUpdateDocumentWithDuplicate() {
        ...
        AggregationResultUtils.AggregationExtractionException exception =
                expectThrows(
                        ...
                        () ->
                                AggregationResultUtils.updateDocument(
                                        document, "foo.bar.baz", 2000L));
        assertThat(
                exception.getMessage(),
                equalTo(
                        "duplicate key value pairs key [foo.bar.baz] old value [1000] duplicate value [2000]"));
    }
    ...
    private NumericMetricsAggregation.SingleValue createSingleMetricAgg(
            Double value, String valueAsString) {
    ...
    public void testSingleValueAggExtractor() {
        ...
        agg = createSingleMetricAgg(100.0, "one_hundred");
        assertThat(
                AggregationResultUtils.getExtractor(agg).value(agg, "string"),
                equalTo("one_hundred"));
    }
    ...
    public void testGeoCentroidAggExtractor() {
        ...
        assertThat(
                AggregationResultUtils.getExtractor(agg).value(agg, "geo_point"), is(nullValue()));
        ...
        assertThat(
                AggregationResultUtils.getExtractor(agg).value(agg, "geo_point"),
                equalTo("100.0, 101.0"));
    }
    ...
    public void testGeoBoundsAggExtractor() {
        ...
        assertThat(
                AggregationResultUtils.getExtractor(agg).value(agg, "geo_shape"), is(nullValue()));
        ...
        for (int i = 0; i < numberOfRuns; i++) {
            ...
            assertThat(
                    AggregationResultUtils.getExtractor(agg).value(agg, "geo_shape"),

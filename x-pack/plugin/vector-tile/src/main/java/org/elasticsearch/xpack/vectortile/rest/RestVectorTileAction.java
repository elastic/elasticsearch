...
public class RestVectorTileAction extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return org.elasticsearch.core.List.of(new Route(GET, "{index}/_mvt/{field}/{z}/{x}/{y}"));
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest restRequest, NodeClient client) throws IOException {
        ...
        return channel -> searchRequestBuilder.execute(new RestResponseListener<SearchResponse>(channel) {

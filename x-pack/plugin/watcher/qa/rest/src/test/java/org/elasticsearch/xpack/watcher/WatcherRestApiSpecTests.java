 ...
 */
public abstract class WatcherRestApiSpecTests extends ESClientYamlSuiteTestCase {
    public WatcherRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

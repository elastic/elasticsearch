 ...
 */
public abstract class WatcherRestTestsYaml extends ESClientYamlSuiteTestCase {
    public WatcherRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

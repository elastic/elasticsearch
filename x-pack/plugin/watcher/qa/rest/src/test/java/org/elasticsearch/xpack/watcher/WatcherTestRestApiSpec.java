 ...
 */
public abstract class WatcherTestRestApiSpec extends ESClientYamlSuiteTestCase {
    public WatcherTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

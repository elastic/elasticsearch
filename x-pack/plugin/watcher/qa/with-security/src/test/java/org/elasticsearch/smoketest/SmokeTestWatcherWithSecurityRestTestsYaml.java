...
import org.elasticsearch.xpack.watcher.WatcherRestTestsYaml;
import org.junit.Before;

import static org.elasticsearch.xpack.test.SecuritySettingsSourceField.basicAuthHeaderValue;

public class SmokeTestWatcherWithSecurityRestTestsYaml extends WatcherRestTestsYaml {

    private static final String TEST_ADMIN_USERNAME = "test_admin";
    private static final String TEST_ADMIN_PASSWORD = "x-pack-test-password";

    public SmokeTestWatcherWithSecurityRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class WatcherLifeCycleServiceTests extends ESTestCase {
    ...
    public void testNoLocalShards() {
        ...
        IndexMetadata indexMetadata = IndexMetadata.builder(Watch.INDEX)
            .settings(settings(Version.CURRENT, 1, 0).put(IndexMetadata.INDEX_FORMAT_SETTING.getKey(), 6))
            .build();
    ...
    public void testNonDataNode() {
        ...
        IndexMetadata.Builder indexMetadataBuilder = IndexMetadata.builder(Watch.INDEX).settings(settings(Version.CURRENT, 1, 0));
        ...
        IndexMetadata.Builder newIndexMetadataBuilder = IndexMetadata.builder(Watch.INDEX).settings(settings(Version.CURRENT, 1, 1));

    ...
    public void testSearchResultsVersusKeywordField() throws IOException {
        ...
        for (int i = 0; i < numSearches; i++) {
            ...
            case 1:
                ...
                int matchFlags = randomBoolean()? 0 : RegExp87.ASCII_CASE_INSENSITIVE;
                wildcardFieldQuery = wildcardFieldType.fieldType().regexpQuery(pattern, RegExp87.ALL, matchFlags, 20000, null, MOCK_QSC);
                keywordFieldQuery = keywordFieldType.fieldType().regexpQuery(pattern, RegExp87.ALL, matchFlags,20000, null, MOCK_QSC);
                break;
            case 2:

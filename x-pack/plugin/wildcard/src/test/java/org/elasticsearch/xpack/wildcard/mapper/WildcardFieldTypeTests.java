...
public class WildcardFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        MappedFieldType mapper = new WildcardFieldMapper.Builder("field", Integer.MAX_VALUE, IndexVersion.current()).build(
        ...
        MappedFieldType ignoreAboveMapper = new WildcardFieldMapper.Builder("field", Integer.MAX_VALUE, IndexVersion.current()).ignoreAbove(
            4
        ...
        MappedFieldType nullValueMapper = new WildcardFieldMapper.Builder("field", Integer.MAX_VALUE, IndexVersion.current()).nullValue(
            "NULL"
        ).build(MapperBuilderContext.root(false, false)).fieldType();

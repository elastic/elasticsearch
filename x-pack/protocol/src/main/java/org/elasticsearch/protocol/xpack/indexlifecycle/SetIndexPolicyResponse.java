...
public class SetIndexPolicyResponse extends ActionResponse implements ToXContentObject {
    ...
    public static final ConstructingObjectParser<SetIndexPolicyResponse, Void> PARSER = new ConstructingObjectParser<>(
        "change_policy_for_index_response", a -> new SetIndexPolicyResponse((List<String>) a[0]));
    static {
    ...
    public SetIndexPolicyResponse() {
    }

    public SetIndexPolicyResponse(List<String> failedIndexes) {
    ...
    public boolean equals(Object obj) {
        ...
        SetIndexPolicyResponse other = (SetIndexPolicyResponse) obj;

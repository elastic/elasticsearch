...
public class Detector implements ToXContentObject, Writeable {
    ...
    public static class Builder {
        ...
        public static void verifyFieldName(String field) throws ElasticsearchParseException {
            ...
            if (MachineLearningConstants.CONTROL_FIELD_NAME.equals(field)) {
                throw ExceptionsHelper.badRequestException(
                        Messages.getMessage(Messages.JOB_CONFIG_INVALID_FIELDNAME, field, MachineLearningConstants.CONTROL_FIELD_NAME));
            }
        }

...
public class PutJobResponseTests extends AbstractStreamableTestCase<PutJobResponse> {

    @Override
    protected PutJobResponse createTestInstance() {
        Job.Builder builder = buildJobBuilder(randomValidJobId());
        return new PutJobResponse(builder.build());
    }

    @Override
    protected PutJobResponse createBlankInstance() {

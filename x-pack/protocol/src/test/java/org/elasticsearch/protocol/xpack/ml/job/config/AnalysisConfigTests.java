...
public class AnalysisConfigTests extends AbstractSerializingTestCase<AnalysisConfig> {
    ...
    public void testVerify_GivenFieldIsControlField() {
        AnalysisConfig.Builder analysisConfig = createValidConfig();
        if (randomBoolean()) {
            analysisConfig.setSummaryCountFieldName(MachineLearningConstants.CONTROL_FIELD_NAME);
        } else {
            analysisConfig.setCategorizationFieldName(MachineLearningConstants.CONTROL_FIELD_NAME);
        }

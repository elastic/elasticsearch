...
public class CoreWithSecurityRestApiSpecTests extends ESClientYamlSuiteTestCase {
    ...
    public CoreWithSecurityRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class CoreWithSecurityRestTestsYaml extends ESClientYamlSuiteTestCase {
    ...
    public CoreWithSecurityRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

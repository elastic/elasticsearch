...
public class CoreWithSecurityTestRestApiSpec extends ESClientYamlSuiteTestCase {
    ...
    public CoreWithSecurityTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class ReindexWithSecurityRestTestsYaml extends ESClientYamlSuiteTestCase {
    private static final String USER = "test_admin";
    private static final String PASS = "x-pack-test-password";

    private static Path httpTrustStore;

    public ReindexWithSecurityRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }
    ...
    public static void findTrustStore( ) throws Exception {
        final URL resource = ReindexWithSecurityRestTestsYaml.class.getResource("/ssl/ca.p12");
        if (resource == null) {

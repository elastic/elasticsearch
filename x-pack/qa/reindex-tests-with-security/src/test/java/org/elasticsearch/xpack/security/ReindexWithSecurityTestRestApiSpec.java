...
public class ReindexWithSecurityTestRestApiSpec extends ESClientYamlSuiteTestCase {
    private static final String USER = "test_admin";
    private static final String PASS = "x-pack-test-password";

    private static Path httpTrustStore;

    public ReindexWithSecurityTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

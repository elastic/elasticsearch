...
public class RolesBackwardsCompatibilityIT extends AbstractXpackRollingUpgradeWithSecurityTestCase {
    ...
    public void testRolesWithDescription() throws Exception {
        ...
        if (isOldCluster()) {
            ...
            assertThat(updateException.getMessage(), containsString("failed to parse role [my-old-role]. unexpected field [description]"));
    ...
    public void testRolesWithManageRoles() throws Exception {
        assumeTrue(
            ...
            minimumTransportVersion().supports(TransportVersions.V_8_16_0) == false
        );
        if (isOldCluster()) {

...
public class UpgradeClusterClientYamlRestApiSpecTests extends ESClientYamlSuiteTestCase {
    ...
    public UpgradeClusterClientYamlRestApiSpecTests(ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

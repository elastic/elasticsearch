...
public class SmokeTestSecurityWithMustacheRestApiSpecTests extends ESClientYamlSuiteTestCase {
    ...
    public SmokeTestSecurityWithMustacheRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class SmokeTestSecurityWithMustacheRestTestsYaml extends ESClientYamlSuiteTestCase {
    ...
    public SmokeTestSecurityWithMustacheRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

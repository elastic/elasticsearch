...
public class SmokeTestSecurityWithMustacheTestRestApiSpec extends ESClientYamlSuiteTestCase {
    ...
    public SmokeTestSecurityWithMustacheTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

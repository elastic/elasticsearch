...
public class WatcherJiraRestApiSpecTests extends ESClientYamlSuiteTestCase {

    public WatcherJiraRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

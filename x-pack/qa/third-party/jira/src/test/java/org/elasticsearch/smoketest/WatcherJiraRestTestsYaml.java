...
public class WatcherJiraRestTestsYaml extends ESClientYamlSuiteTestCase {

    public WatcherJiraRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

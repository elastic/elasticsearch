...
public class WatcherJiraTestRestApiSpec extends ESClientYamlSuiteTestCase {

    public WatcherJiraTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

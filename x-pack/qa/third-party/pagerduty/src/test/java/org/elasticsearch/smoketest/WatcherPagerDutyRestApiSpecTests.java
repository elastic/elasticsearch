...
public class WatcherPagerDutyRestApiSpecTests extends ESClientYamlSuiteTestCase {

    public WatcherPagerDutyRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class WatcherPagerDutyRestTestsYaml extends ESClientYamlSuiteTestCase {

    public WatcherPagerDutyRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class WatcherPagerDutyTestRestApiSpec extends ESClientYamlSuiteTestCase {

    public WatcherPagerDutyTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

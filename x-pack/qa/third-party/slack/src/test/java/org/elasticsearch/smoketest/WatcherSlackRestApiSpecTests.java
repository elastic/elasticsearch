...
public class WatcherSlackRestApiSpecTests extends ESClientYamlSuiteTestCase {

    public WatcherSlackRestApiSpecTests(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

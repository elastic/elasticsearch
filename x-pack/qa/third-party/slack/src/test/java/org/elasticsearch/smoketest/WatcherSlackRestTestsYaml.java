...
public class WatcherSlackRestTestsYaml extends ESClientYamlSuiteTestCase {

    public WatcherSlackRestTestsYaml(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

...
public class WatcherSlackTestRestApiSpec extends ESClientYamlSuiteTestCase {

    public WatcherSlackTestRestApiSpec(@Name("yaml") ClientYamlTestCandidate testCandidate) {
        super(testCandidate);
    }

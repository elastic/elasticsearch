...
echo "jwt-realm-shared-secret" >/tmp/shared_secret
...
cat /tmp/shared_secret | ./elasticsearch-keystore add -x -f -v 'xpack.security.authc.realms.jwt.op-jwt.client_authentication.shared_secret'

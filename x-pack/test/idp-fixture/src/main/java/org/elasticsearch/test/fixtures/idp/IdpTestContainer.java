...
public final class IdpTestContainer extends DockerEnvironmentAwareTestContainer {
    ...
    public static final String DOCKER_BASE_IMAGE = "breskeby/test-fixture-idp:latest";
        ...
        super(
            new ImageFromDockerfile("es-idp-testfixture").withDockerfileFromBuilder(
                builder -> builder.from(DOCKER_BASE_IMAGE)
                    ...
                    // .run(
                    // "wget -q
                    // https://repo.maven.apache.org/maven2/org/eclipse/jetty/jetty-distribution/$jetty_version/jetty-distribution-$jetty_version.tar.gz"
                    ...
                    // .run(
                    // "wget -q
                    // https://shibboleth.net/downloads/identity-provider/archive/$idp_version/shibboleth-identity-provider-$idp_version.tar.gz"
                    ...
                    // .run(
                    // "wget -q
                    // https://repo.maven.apache.org/maven2/ch/qos/logback/logback-classic/$logback_version/logback-classic-$logback_version.jar"
                    ...
                    // .run(
                    // "wget -q
                    // https://repo.maven.apache.org/maven2/ch/qos/logback/logback-core/$logback_version/logback-core-$logback_version.jar"
                    ...
                    // .run(
                    // "wget -q
                    // https://repo.maven.apache.org/maven2/ch/qos/logback/logback-access/$logback_version/logback-access-$logback_version.jar"

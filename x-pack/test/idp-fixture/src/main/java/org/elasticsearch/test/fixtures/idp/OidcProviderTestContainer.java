...
public final class OidcProviderTestContainer extends DockerEnvironmentAwareTestContainer implements TestRule, CacheableTestFixture {
    ...
    public OidcProviderTestContainer(Network network) {
        super(
            new ImageFromDockerfile("es-oidc-provider-fixture", false)
    ...
    public void start() {
        super.start();
        copyFileToContainer(Transferable.of("op.issuer=http://127.0.0.1:" + getMappedPort(PORT) + "/c2id\n" +
            ...
            "op.authz.alwaysPromptForAuth=true"), "config/c2id/override.properties");
    }
